# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2-platforms/Platform/Spacemit/K1/Milk-V-Jupiter/Milk-V-Jupiter.dts"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/Platform/Spacemit/K1/Milk-V-Jupiter/MilkVJupiterDeviceTree/DEBUG/AutoGen.h" 1
# 16 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/Platform/Spacemit/K1/Milk-V-Jupiter/MilkVJupiterDeviceTree/DEBUG/AutoGen.h"
...
# 643 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdePkg/Include/Base.h"
...
# 17 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/Platform/Spacemit/K1/Milk-V-Jupiter/MilkVJupiterDeviceTree/DEBUG/AutoGen.h" 2




# 29 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/Platform/Spacemit/K1/Milk-V-Jupiter/MilkVJupiterDeviceTree/DEBUG/AutoGen.h"

# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2-platforms/Platform/Spacemit/K1/Milk-V-Jupiter/Milk-V-Jupiter.dts"
...
/ {
 compatible = "milkv,jupiter", "spacemit,k1-x";
 #address-cells = <0x02>;
 #size-cells = <0x02>;
 ...
 reserved-memory {
  ...
  mem@c0800000 {
   reg = <0x00 0xc0800000 0x00 0x40000>;
   da_base = <0x00>;
   no-map;
   phandle = <0x27>;
  };
  ...
  mem@30000000 {
   reg = <0x00 0x30000000 0x00 0x200000>;
   no-map;
  };

  vdev0vring0@30200000 {
   reg = <0x00 0x30200000 0x00 0x3000>;
   no-map;
   phandle = <0x28>;
  };

  vdev0vring1@30203000 {
   reg = <0x00 0x30203000 0x00 0x3000>;
   no-map;
   phandle = <0x29>;
  };
  ...
  vdev0buffer@30206000 {
   ...
   reg = <0x00 0x30206000 0x00 0xf6000>;
   no-map;
   phandle = <0x2a>;
  };

  rsc_table@302fc000 {
   reg = <0x00 0x302fc000 0x00 0x4000>;
   no-map;
   phandle = <0x2b>;
  };

  rcpu_mem_snapshots@30300000 {
   reg = <0x00 0x30300000 0x00 0x40000>;
   no-map;
   phandle = <0x2c>;
  };
 ...
 soc {
  ...
  pinctrl@d401e000 {
   ...
   reg = <0x00 0xd401e000 0x00 0x250 0x00 0xd4019800 0x00 0x10>;
   #address-cells = <0x01>;
   #size-cells = <0x01>;
   #pinctrl-cells = <0x02>;
   ...
   i2c6_0_grp {
    pinctrl-single,pins = <0x150 0x05 0xc040 0x1fc 0x05 0xc040>;
   };
   ...
   i2c7_grp {
    pinctrl-single,pins = <0x228 0x01 0xc040 0x22c 0x01 0xc040>;
    phandle = <0x34>;
   };
  ...
  spi@d4026000 {
   ...
   dmas = <0x21 0x13 0x01 0x21 0x12 0x01>;
   dma-names = "rx", "tx";
   power-domains = <0x20 0x00>;
   cpuidle,pm-runtime,sleep;
   interrupt-parent = <0x1e>;
  ...
  spi@d4026800 {
   ...
   k1x,ssp-id = <0x01>;
   k1x,ssp-clock-rate = <0x18cba80>;
   dmas = <0x21 0x15 0x01 0x21 0x14 0x01>;
   dma-names = "rx", "tx";
   power-domains = <0x20 0x00>;
   cpuidle,pm-runtime,sleep;
   interrupt-parent = <0x1e>;
  ...
  spi@d401c000 {
   compatible = "spacemit,k1x-spi";
   reg = <0x00 0xd401c000 0x00 0x30>;
   k1x,ssp-id = <0x03>;
   k1x,ssp-clock-rate = <0x18cba80>;
   k1x,ssp-disable-dma;
   dmas = <0x21 0x11 0x01 0x21 0x10 0x01>;
   dma-names = "rx", "tx";
   power-domains = <0x20 0x00>;
   cpuidle,pm-runtime,sleep;
   interrupt-parent = <0x1e>;
  ...
  usb3hub@0 {
   ...
   vbus-gpios = <0x30 0x61 0x00 0x30 0x7f 0x00>;
  };
  ...
  sdh@d4280800 {
   ...
   spacemit,rx_tuning_freq = <0x186a00>;
   spacemit,rx_tuning_limit = <0x32>;
  ...
  pcie@ca000000 {
   ...
   interrupt-map = <0x00 0x00 0x00 0x01 0x50 0x01 0x00 0x00 0x00 0x02 0x50 0x02 0x00 0x00 0x00 0x03 0x50 0x03 0x00 0x00 0x00 0x04 0x50 0x04>;
  ...
  pcie@ca400000 {
   ...
   #interrupt-cells = <0x01>;
   interrupt-map-mask = <0x00 0x00 0x00 0x07>;
   interrupt-map = <0x00 0x00 0x00 0x01 0x51 0x01 0x00 0x00 0x00 0x02 0x51 0x02 0x00 0x00 0x00 0x03 0x51 0x03 0x00 0x00 0x00 0x04 0x51 0x04>;
  ...
  pcie@ca800000 {
   ...
   #address-cells = <0x03>;
   #size-cells = <0x02>;
   ranges = <0x1000000 0x00 0xb7002000 0x00 0xb7002000 0x00 0x100000 0x42000000 0x00 0xa0000000 0x00 0xa0000000 0x00 0x10000000 0x2000000 0x00 0xb0000000 0x00 0xb0000000 0x00 0x7000000>;
   interconnects = <0x4f>;
   interconnect-names = "dma-mem";
   ...
   #interrupt-cells = <0x01>;
   interrupt-map-mask = <0x00 0x00 0x00 0x07>;
   interrupt-map = <0x00 0x00 0x00 0x01 0x53 0x01 0x00 0x00 0x00 0x02 0x53 0x02 0x00 0x00 0x00 0x03 0x53 0x03 0x00 0x00 0x00 0x04 0x53 0x04>;
  ...
  thermal-zones {
   ...
   top_thermal {
    ...
    cooling-maps {
     ...
     map0 {
      trip = <0x5b>;
      cooling-device = <0x5c 0x00 0x01>;
     };

     map1 {
      trip = <0x5d>;
      cooling-device = <0x5c 0x01 0x02>;
     };

     map2 {
      trip = <0x5e>;
      cooling-device = <0x5c 0x02 0x03>;
     };

     map3 {
      trip = <0x5f>;
      cooling-device = <0x5c 0x03 0x04>;
     };
    };
   };
  ...
  imggpu@cac00000 {
   ...
   interrupt-parent = <0x1e>;
   interrupts = <0x4b>;
   reg = <0x00 0xcac00000 0x00 0x100000>;
   reg-names = "rgxregs";
   clocks = <0x03 0x94>;
   clock-names = "gpu_clk";
   resets = <0x1d 0x52>;
  ...
  socinfo@0 {
   ...
   status = "okay";
   nvmem-cells = <0x63 0x64 0x65 0x66 0x67>;
  ...
  cam_sensor@0 {
   ...
   status = "okay";
   af_2v8-supply = <0x76>;
   avdd_2v8-supply = <0x77>;
   dovdd_1v8-supply = <0x78>;
   dvdd_1v2-supply = <0x79>;
 ...
 lcds {
  ...
  lcd_orisetech_ota7290b_mipi {
   ...
   initial-command = [39 01 f0 01 11 39 01 28 01 29];

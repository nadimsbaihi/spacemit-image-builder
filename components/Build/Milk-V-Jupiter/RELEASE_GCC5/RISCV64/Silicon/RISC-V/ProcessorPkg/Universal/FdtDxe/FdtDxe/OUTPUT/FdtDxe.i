# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2-platforms/Silicon/RISC-V/ProcessorPkg/Universal/FdtDxe/FdtDxe.c"
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/Silicon/RISC-V/ProcessorPkg/Universal/FdtDxe/FdtDxe//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/riscv64-linux-gnu/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/Silicon/RISC-V/ProcessorPkg/Universal/FdtDxe/FdtDxe/DEBUG/AutoGen.h" 1
# 16 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/Silicon/RISC-V/ProcessorPkg/Universal/FdtDxe/FdtDxe/DEBUG/AutoGen.h"
...
# 17 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/Silicon/RISC-V/ProcessorPkg/Universal/FdtDxe/FdtDxe/DEBUG/AutoGen.h" 2
...
# 18 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/Silicon/RISC-V/ProcessorPkg/Universal/FdtDxe/FdtDxe/DEBUG/AutoGen.h" 2

extern GUID gEfiCallerIdGuid;
extern GUID gEdkiiDscPlatformGuid;
extern CHAR8 *gEfiCallerBaseName;
# 30 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/Silicon/RISC-V/ProcessorPkg/Universal/FdtDxe/FdtDxe/DEBUG/AutoGen.h"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2-platforms/Silicon/RISC-V/ProcessorPkg/Universal/FdtDxe/FdtDxe.c"
# 14 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2-platforms/Silicon/RISC-V/ProcessorPkg/Universal/FdtDxe/FdtDxe.c"
...
# 15 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2-platforms/Silicon/RISC-V/ProcessorPkg/Universal/FdtDxe/FdtDxe.c" 2
...
# 16 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2-platforms/Silicon/RISC-V/ProcessorPkg/Universal/FdtDxe/FdtDxe.c" 2
...
# 17 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2-platforms/Silicon/RISC-V/ProcessorPkg/Universal/FdtDxe/FdtDxe.c" 2
...
# 18 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2-platforms/Silicon/RISC-V/ProcessorPkg/Universal/FdtDxe/FdtDxe.c" 2
...
# 20 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2-platforms/Silicon/RISC-V/ProcessorPkg/Universal/FdtDxe/FdtDxe.c" 2
# 30 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2-platforms/Silicon/RISC-V/ProcessorPkg/Universal/FdtDxe/FdtDxe.c"
EFI_STATUS
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Fixing up device tree with boot hart id: %d\n", BootingHartId); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))



      ;

  Size = ((fdt32_to_cpu(((const struct fdt_header *)(DtbBlob))->totalsize)));
  Err = fdt_open_into (DtbBlob, DtbBlob, Size + 32);
  if (Err < 0) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "Device Tree can't be expanded to accommodate new node\n", __FUNCTION__); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
...
# 70 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2-platforms/Silicon/RISC-V/ProcessorPkg/Universal/FdtDxe/FdtDxe.c"
EFI_STATUS
  ...
  )
{
  ...
  if (GuidHob == ((void *) 0)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "Failed to find RISC-V DTB Hob\n", __FUNCTION__); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
  ...
  DataInHob = (void *)*((UINTN *)(void *)(*(UINT8 **)&(GuidHob) + sizeof (EFI_HOB_GUID_TYPE)));
  DataSize = (UINT16)(((*(EFI_HOB_GENERIC_HEADER **)&(GuidHob))->HobLength) - sizeof (EFI_HOB_GUID_TYPE));

  Status = FixDtb (DataInHob, _gPcd_FixedAtBuild_PcdBootHartId);
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "%a: failed to install FDT configuration table\n", __FUNCTION__); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
...
# 122 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2-platforms/Silicon/RISC-V/ProcessorPkg/Universal/FdtDxe/FdtDxe.c"
EFI_STATUS

...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xa7d8f3f7, 0xd8a7, 0x47df, {0xb3, 0xec, 0x9E, 0x5A, 0x69, 0x3C, 0x38, 0x0C}};
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdBootHartId = _PCD_VALUE_PcdBootHartId;

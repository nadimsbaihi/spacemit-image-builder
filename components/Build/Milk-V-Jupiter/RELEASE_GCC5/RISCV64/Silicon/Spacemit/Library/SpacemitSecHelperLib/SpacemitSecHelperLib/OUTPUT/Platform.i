# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Library/SpacemitSecHelperLib/Platform.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Library/SpacemitSecHelperLib/Platform.c"
...
# 9 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Library/SpacemitSecHelperLib/Platform.c" 2
...
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Library/SpacemitSecHelperLib/Platform.c" 2
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Library/SpacemitSecHelperLib/Platform.c" 2
...
# 12 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Library/SpacemitSecHelperLib/Platform.c" 2
...
# 14 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Library/SpacemitSecHelperLib/Platform.c" 2
...
# 13 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/EmbeddedPkg/Include/libfdt_env.h"
...
# 14 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/EmbeddedPkg/Include/libfdt_env.h" 2
...
# 15 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Library/SpacemitSecHelperLib/Platform.c" 2
...
# 16 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Library/SpacemitSecHelperLib/Platform.c" 2
# 24 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Library/SpacemitSecHelperLib/Platform.c"
static
void
  ...
  )
{
  ...
  MemorySize = ((MemorySize) + (((0x00001000) - (MemorySize)) & ((0x00001000) - 1U)));
  BuildResourceDescriptorHob (
    0x00000001,
    0x00000001 |
    0x00000002 |
...
# 52 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Library/SpacemitSecHelperLib/Platform.c"
void
  ...
  )
{
  ...
  while (Node != -1) {
    ...
    if (Reg) {
      do { if (((BOOLEAN)(0==1))) { (void) (LenP == (2 * sizeof (UINT64))); } } while (((BOOLEAN)(0==1)));
  ...
  )
{
  ...
  if (DeviceTreeAddress == ((void *) 0)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "%a: Invalid FDT pointer\n", __func__); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    return ((RETURN_STATUS)(0x8000000000000000ULL | (3)));
  }

  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "%a: Build FDT HOB - FDT at address: 0x%x \n", __func__, DeviceTreeAddress); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  Base = DeviceTreeAddress;
  if (fdt_check_header (Base) != 0) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "%a: Corrupted DTB\n", __func__); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    return ((RETURN_STATUS)(0x8000000000000000ULL | (3)));
  }

  FdtSize = ((fdt32_to_cpu(((const struct fdt_header *)(Base))->totalsize)));
  FdtPages = (((FdtSize) >> 12) + (((FdtSize) & 0xFFF) ? 1 : 0));
  NewBase = AllocatePages (FdtPages);
  if (NewBase == ((void *) 0)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "%a: Could not allocate memory for DTB\n", __func__); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    return ((RETURN_STATUS)(0x8000000000000000ULL | (3)));
  }

  fdt_open_into (Base, NewBase, ((FdtPages) << 12));

  FdtHobData = BuildGuidHob (&gFdtHobGuid, sizeof *FdtHobData);
  if (FdtHobData == ((void *) 0)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "%a: Could not build FDT Hob\n", __func__); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    return ((RETURN_STATUS)(0x8000000000000000ULL | (3)));
  }

  *FdtHobData = (UINTN)NewBase;

  BuildFvHob (_gPcd_FixedAtBuild_PcdRiscVDxeFvBase, _gPcd_FixedAtBuild_PcdRiscVDxeFvSize);

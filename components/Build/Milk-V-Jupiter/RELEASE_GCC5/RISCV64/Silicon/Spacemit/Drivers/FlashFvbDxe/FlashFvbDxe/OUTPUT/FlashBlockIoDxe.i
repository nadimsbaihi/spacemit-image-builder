# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/FlashFvbDxe/FlashBlockIoDxe.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/FlashFvbDxe/FlashBlockIoDxe.c"
# 12 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/FlashFvbDxe/FlashBlockIoDxe.c"
...
# 13 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/FlashFvbDxe/FlashBlockIoDxe.c" 2
  ...
  )
{
  ...
  Instance = (((FV_FLASH_INSTANCE *) (void *) ((CHAR8 *) (This) - ((UINTN) __builtin_offsetof(FV_FLASH_INSTANCE, BlockIoProtocol))))->Signature != ((('v') | ('s' << 8)) | ((('p') | ('i' << 8)) << 16))) ? ((void *) 0) : ((FV_FLASH_INSTANCE *) (void *) ((CHAR8 *) (This) - ((UINTN) __builtin_offsetof(FV_FLASH_INSTANCE, BlockIoProtocol))));

  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000100)) { DebugPrint (0x00000100, "%a(MediaId=%d, Lba=%ld, BufferSize=0x%x bytes (%d kB), BufferPtr @ 0x%08x)\n", __func__, MediaId, Lba, BufferSizeInBytes, BufferSizeInBytes / 1024, Buffer); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))


          ;

  if ( !This->Media->MediaPresent ) {
    Status = ((RETURN_STATUS)(0x8000000000000000ULL | (12)));
  } else if ( This->Media->MediaId != MediaId ) {
    Status = ((RETURN_STATUS)(0x8000000000000000ULL | (13)));
  } else {

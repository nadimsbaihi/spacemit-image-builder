# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type01/MiscSystemManufacturerFunction.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type01/MiscSystemManufacturerFunction.c"
# 17 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type01/MiscSystemManufacturerFunction.c"
...
# 18 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type01/MiscSystemManufacturerFunction.c" 2
...
# 19 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type01/MiscSystemManufacturerFunction.c" 2
...
# 20 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type01/MiscSystemManufacturerFunction.c" 2
...
# 21 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type01/MiscSystemManufacturerFunction.c" 2
...
# 22 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type01/MiscSystemManufacturerFunction.c" 2
...
# 23 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type01/MiscSystemManufacturerFunction.c" 2
...
# 24 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type01/MiscSystemManufacturerFunction.c" 2
...
# 26 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type01/MiscSystemManufacturerFunction.c" 2
# 39 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type01/MiscSystemManufacturerFunction.c"
EFI_STATUS MiscSystemManufacturerFunction( void *RecordData, EFI_SMBIOS_PROTOCOL *Smbios ) {
  EFI_STATUS Status;
  ...
  pManufacturer = (CHAR16 *) LibPcdGetPtr(29U);
  if (StrLen (pManufacturer) > 0) {
    TokenToUpdate = 0x0005;
    HiiSetString (mSmbiosMiscHiiHandle, TokenToUpdate, pManufacturer, ((void *) 0));
  }

  pProductName = (CHAR16 *) LibPcdGetPtr(30U);
  if (StrLen (pProductName) > 0) {
    TokenToUpdate = 0x0006;
    HiiSetString (mSmbiosMiscHiiHandle, TokenToUpdate, pProductName, ((void *) 0));
  }

  pVersion = (CHAR16 *) LibPcdGetPtr(33U);
  if (StrLen (pVersion) > 0) {
    TokenToUpdate = 0x0007;
    HiiSetString (mSmbiosMiscHiiHandle, TokenToUpdate, pVersion, ((void *) 0));
  }

  pSerialNumber = (CHAR16 *) LibPcdGetPtr(32U);
  if (StrLen (pSerialNumber) > 0) {
    TokenToUpdate = 0x0008;
    HiiSetString (mSmbiosMiscHiiHandle, TokenToUpdate, pSerialNumber, ((void *) 0));
  }

  pSKUNumber = (CHAR16 *) LibPcdGetPtr(31U);
  if (StrLen (pSKUNumber) > 0) {
    TokenToUpdate = 0x0009;
    HiiSetString (mSmbiosMiscHiiHandle, TokenToUpdate, pSKUNumber, ((void *) 0));
  }

  pFamily = (CHAR16 *) LibPcdGetPtr(28U);
  if (StrLen (pFamily) > 0) {
    TokenToUpdate = 0x000A;
    HiiSetString (mSmbiosMiscHiiHandle, TokenToUpdate, pFamily, ((void *) 0));
  }

  TokenToGet = 0x0005;
  Manufacturer = HiiGetPackageString (&gEfiCallerIdGuid, TokenToGet, ((void *) 0));
  ManuStrLen = StrLen (Manufacturer);

  TokenToGet = 0x0006;
  ProductName = HiiGetPackageString (&gEfiCallerIdGuid, TokenToGet, ((void *) 0));
  ...
  TokenToGet = 0x0009;
  SKUNumber = HiiGetPackageString (&gEfiCallerIdGuid, TokenToGet, ((void *) 0));
  SKUNumStrLen = StrLen (SKUNumber);

  TokenToGet = 0x000A;
  Family = HiiGetPackageString (&gEfiCallerIdGuid, TokenToGet, ((void *) 0));
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "[%a]:[%dL] Smbios Type01 Table Log Failed! %r \n", __func__, 186, Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))

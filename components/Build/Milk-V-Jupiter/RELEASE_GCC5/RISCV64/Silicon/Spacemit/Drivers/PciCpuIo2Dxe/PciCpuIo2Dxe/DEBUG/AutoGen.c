...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x66A7515D, 0x5124, 0xCAD4, {0x0D, 0x26, 0xBF, 0x66, 0x1D, 0x1A, 0xBD, 0x73}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "PciCpuIo2Dxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT64 _gPcd_FixedAtBuild_PcdMaxIoPortAddress = _PCD_VALUE_PcdMaxIoPortAddress;

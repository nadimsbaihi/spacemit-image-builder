# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/SmbiosMiscEntryPoint.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/SmbiosMiscEntryPoint.c"
# 16 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/SmbiosMiscEntryPoint.c"
...
# 17 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/SmbiosMiscEntryPoint.c" 2
...
# 18 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/SmbiosMiscEntryPoint.c" 2
...
# 19 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/SmbiosMiscEntryPoint.c" 2
...
# 20 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/SmbiosMiscEntryPoint.c" 2
...
# 21 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/SmbiosMiscEntryPoint.c" 2
...
# 22 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/SmbiosMiscEntryPoint.c" 2
...
# 24 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/SmbiosMiscEntryPoint.c" 2

static EFI_HANDLE mSmbiosMiscImageHandle;
static EFI_SMBIOS_PROTOCOL *mSmbiosMiscSmbios = ((void *) 0);

EFI_HII_HANDLE mSmbiosMiscHiiHandle = ((void *) 0);
# 40 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/SmbiosMiscEntryPoint.c"
EFI_STATUS
  ...
  )
{
  ...
  if ((((RETURN_STATUS)(EfiStatus)) >= 0x8000000000000000ULL)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "Could not locate SMBIOS protocol.  %r\n", EfiStatus); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    return EfiStatus;
  }
  ...
  if (mSmbiosMiscHiiHandle == ((void *) 0)) {
  ...
  for (Index = 0; Index < mSmbiosMiscDataTableEntries; ++Index) {
    ...
    if (mSmbiosMiscDataTable[Index].Function != ((void *) 0)) {
      ...
      if ((((RETURN_STATUS)(EfiStatus)) >= 0x8000000000000000ULL)) {
        do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "Misc smbios store error.  Index=%d," "ReturnStatus=%r\n", Index, EfiStatus); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
...
# 114 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/SmbiosMiscEntryPoint.c"
EFI_STATUS
SmbiosMiscAddRecord (
  UINT8 *Buffer,
  EFI_SMBIOS_HANDLE *SmbiosHandle
...
# 150 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/SmbiosMiscEntryPoint.c"
static
UINTN
GetHandleCount (
  UINT8 SmbiosType
...
# 188 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/SmbiosMiscEntryPoint.c"
void
SmbiosMiscGetLinkTypeHandle (
  UINT8 SmbiosType,
  SMBIOS_HANDLE **HandleArray,
  UINTN *HandleCount
  )
{
  UINTN Index;
  ...
  *HandleArray = AllocateZeroPool (sizeof (SMBIOS_HANDLE) * (*HandleCount));
  if (*HandleArray == ((void *) 0)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "HandleArray allocate memory resource failed.\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    *HandleCount = 0;
    return;
  }

# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type02/MiscBaseBoardManufacturerFunction.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type02/MiscBaseBoardManufacturerFunction.c"
# 17 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type02/MiscBaseBoardManufacturerFunction.c"
...
# 18 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type02/MiscBaseBoardManufacturerFunction.c" 2
...
# 19 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type02/MiscBaseBoardManufacturerFunction.c" 2
...
# 20 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type02/MiscBaseBoardManufacturerFunction.c" 2
...
# 21 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type02/MiscBaseBoardManufacturerFunction.c" 2
...
# 22 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type02/MiscBaseBoardManufacturerFunction.c" 2
...
# 23 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type02/MiscBaseBoardManufacturerFunction.c" 2
...
# 24 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type02/MiscBaseBoardManufacturerFunction.c" 2

# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/SmbiosMisc.h" 1
# 18 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/SmbiosMisc.h"
...
extern EFI_GUID gEfiSmbiosProtocolGuid;
# 19 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/SmbiosMisc.h" 2





typedef EFI_STATUS ( SMBIOS_MISC_DATA_FUNCTION)(
  void *RecordData,
...
# 74 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/SmbiosMisc.h"
...
# 99 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/SmbiosMisc.h"
EFI_STATUS
SmbiosMiscAddRecord (
  UINT8 *Buffer,
  EFI_SMBIOS_HANDLE *SmbiosHandle
  );
# 113 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/SmbiosMisc.h"
void
...
# 26 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type02/MiscBaseBoardManufacturerFunction.c" 2
# 39 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type02/MiscBaseBoardManufacturerFunction.c"
EFI_STATUS MiscBaseBoardManufacturerFunction( void *RecordData, EFI_SMBIOS_PROTOCOL *Smbios ) {
  EFI_STATUS Status;
  ...
  HandleCount = 0;
  HandleArray = ((void *) 0);
  BaseBoardManufacturer = ((void *) 0);
  BaseBoardProductName = ((void *) 0);
  Version = ((void *) 0);
  SerialNumber = ((void *) 0);
  AssetTag = ((void *) 0);
  ChassisLocation = ((void *) 0);
  SmbiosRecord = ((void *) 0);




  if (RecordData == ((void *) 0)) {
    return ((RETURN_STATUS)(0x8000000000000000ULL | (2)));
  }

  InputData = (SMBIOS_TABLE_TYPE2 *) RecordData;

  pBaseBoardManufacturer = (CHAR16 *) LibPcdGetPtr(17U);
  if (StrLen (pBaseBoardManufacturer) > 0) {
    TokenToUpdate = 0x000B;
    HiiSetString (mSmbiosMiscHiiHandle, TokenToUpdate, pBaseBoardManufacturer, ((void *) 0));
  }

  pBaseBoardProductName = (CHAR16 *) LibPcdGetPtr(18U);
  if (StrLen (pBaseBoardProductName) > 0) {
    TokenToUpdate = 0x000C;
    HiiSetString (mSmbiosMiscHiiHandle, TokenToUpdate, pBaseBoardProductName, ((void *) 0));
  }

  pVersion = (CHAR16 *) LibPcdGetPtr(20U);
  if (StrLen (pVersion) > 0) {
    TokenToUpdate = 0x000D;
    HiiSetString (mSmbiosMiscHiiHandle, TokenToUpdate, pVersion, ((void *) 0));
  }

  pSerialNumber = (CHAR16 *) LibPcdGetPtr(19U);
  if (StrLen (pSerialNumber) > 0) {
    TokenToUpdate = 0x000E;
    HiiSetString (mSmbiosMiscHiiHandle, TokenToUpdate, pSerialNumber, ((void *) 0));
  }

  pAssetTag = (CHAR16 *) LibPcdGetPtr(15U);
  if (StrLen (pAssetTag) > 0) {
    TokenToUpdate = 0x000F;
    HiiSetString (mSmbiosMiscHiiHandle, TokenToUpdate, pAssetTag, ((void *) 0));
  }

  pChassisLocation = (CHAR16 *) LibPcdGetPtr(16U);
  if (StrLen (pChassisLocation) > 0) {
    TokenToUpdate = 0x0010;
    HiiSetString (mSmbiosMiscHiiHandle, TokenToUpdate, pChassisLocation, ((void *) 0));
  }

  TokenToGet = 0x000B;
  BaseBoardManufacturer = HiiGetPackageString (&gEfiCallerIdGuid, TokenToGet, ((void *) 0));
  ManuStrLen = StrLen (BaseBoardManufacturer);

  TokenToGet = 0x000C;
  BaseBoardProductName = HiiGetPackageString (&gEfiCallerIdGuid, TokenToGet, ((void *) 0));
  ProductNameStrLen = StrLen (BaseBoardProductName);

  TokenToGet = 0x000D;
  Version = HiiGetPackageString (&gEfiCallerIdGuid, TokenToGet, ((void *) 0));
  VerStrLen = StrLen (Version);

  TokenToGet = 0x000E;
  SerialNumber = HiiGetPackageString (&gEfiCallerIdGuid, TokenToGet, ((void *) 0));
  SerialNumStrLen = StrLen (SerialNumber);

  TokenToGet = 0x000F;
  AssetTag = HiiGetPackageString (&gEfiCallerIdGuid, TokenToGet, ((void *) 0));
  AssetTagStrLen = StrLen (AssetTag);

  TokenToGet = 0x0010;
  ChassisLocation = HiiGetPackageString (&gEfiCallerIdGuid, TokenToGet, ((void *) 0));
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (HandleCount < 2); } } while (((BOOLEAN)(0==1)));
  if (HandleCount > 0) {
  ...
  Status = SmbiosMiscAddRecord ((UINT8 *)SmbiosRecord, ((void *) 0));
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "[%a]:[%dL] Smbios Type02 Table Log Failed! %r \n", __func__, 205, Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
...
Exit:
  if (BaseBoardManufacturer != ((void *) 0)) {
    FreePool (BaseBoardManufacturer);
  }

  if (BaseBoardProductName != ((void *) 0)) {

# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type03/MiscChassisManufacturerFunction.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type03/MiscChassisManufacturerFunction.c"
# 16 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type03/MiscChassisManufacturerFunction.c"
...
# 17 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type03/MiscChassisManufacturerFunction.c" 2
...
# 18 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type03/MiscChassisManufacturerFunction.c" 2
...
# 19 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type03/MiscChassisManufacturerFunction.c" 2
...
# 20 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type03/MiscChassisManufacturerFunction.c" 2
...
# 21 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type03/MiscChassisManufacturerFunction.c" 2
...
# 22 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type03/MiscChassisManufacturerFunction.c" 2
...
# 23 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type03/MiscChassisManufacturerFunction.c" 2
...
# 25 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type03/MiscChassisManufacturerFunction.c" 2
# 38 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type03/MiscChassisManufacturerFunction.c"
EFI_STATUS MiscChassisManufacturerFunction( void *RecordData, EFI_SMBIOS_PROTOCOL *Smbios ) {
  EFI_STATUS Status;
  ...
  pManufacturer = (CHAR16 *) LibPcdGetPtr(23U);
  if (StrLen (pManufacturer) > 0) {
    TokenToUpdate = 0x0011;
    HiiSetString (mSmbiosMiscHiiHandle, TokenToUpdate, pManufacturer, ((void *) 0));
  }

  pVersion = (CHAR16 *) LibPcdGetPtr(27U);
  if (StrLen (pVersion) > 0) {
    TokenToUpdate = 0x0012;
    HiiSetString (mSmbiosMiscHiiHandle, TokenToUpdate, pVersion, ((void *) 0));
  }

  pSerialNumber = (CHAR16 *) LibPcdGetPtr(25U);
  if (StrLen (pSerialNumber) > 0) {
    TokenToUpdate = 0x0013;
    HiiSetString (mSmbiosMiscHiiHandle, TokenToUpdate, pSerialNumber, ((void *) 0));
  }

  pAssertTag = (CHAR16 *) LibPcdGetPtr(21U);
  if (StrLen (pAssertTag) > 0) {
    TokenToUpdate = 0x0014;
    HiiSetString (mSmbiosMiscHiiHandle, TokenToUpdate, pAssertTag, ((void *) 0));
  }

  pChassisSkuNumber = (CHAR16 *) LibPcdGetPtr(24U);
  if (StrLen (pChassisSkuNumber) > 0) {
    TokenToUpdate = 0x0015;
    HiiSetString (mSmbiosMiscHiiHandle, TokenToUpdate, pChassisSkuNumber, ((void *) 0));
  }
  ...
  TokenToGet = 0x0014;
  AssertTag = HiiGetPackageString (&gEfiCallerIdGuid, TokenToGet, ((void *) 0));
  AssertTagStrLen = StrLen (AssertTag);

  TokenToGet = 0x0015;
  ChassisSkuNumber = HiiGetPackageString (&gEfiCallerIdGuid, TokenToGet, ((void *) 0));
  ...
  SmbiosRecord->Type = LibPcdGet8(26U);
  SmbiosRecord->Height = LibPcdGet8(22U);
  ...
  *SkuNumberField = 5;
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "[%a]:[%dL] Smbios Type03 Table Log Failed! %r \n", __func__, 175, Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))

# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type00/MiscBiosVendorFunction.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type00/MiscBiosVendorFunction.c"
# 13 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type00/MiscBiosVendorFunction.c"
...
# 14 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type00/MiscBiosVendorFunction.c" 2
...
# 15 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type00/MiscBiosVendorFunction.c" 2
...
# 16 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type00/MiscBiosVendorFunction.c" 2
...
# 17 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type00/MiscBiosVendorFunction.c" 2
...
# 18 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type00/MiscBiosVendorFunction.c" 2
...
# 19 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type00/MiscBiosVendorFunction.c" 2
...
# 20 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type00/MiscBiosVendorFunction.c" 2
...
# 22 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type00/MiscBiosVendorFunction.c" 2
...
# 54 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type00/MiscBiosVendorFunction.c"
UINT8
...
{
  const CHAR8 *ReleaseDate = "Mar  5 2026";
  const CHAR8 *ReleaseTime = "14:11:31";
  UINTN i;
  ...
  )
{
  ...
  ReleaseDate = AllocateZeroPool ((sizeof (CHAR16)) * 64);
...
# 142 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type00/MiscBiosVendorFunction.c"
EFI_STATUS MiscBiosVendorFunction( void *RecordData, EFI_SMBIOS_PROTOCOL *Smbios ) {
  EFI_STATUS Status;
  ...
  pVendor = (CHAR16 *) LibPcdGetPtr(5U);
  if (StrLen (pVendor) > 0) {
    TokenToUpdate = 0x0002;
    HiiSetString (mSmbiosMiscHiiHandle, TokenToUpdate, pVendor, ((void *) 0));
  }

  pVersion = (CHAR16 *) LibPcdGetPtr(6U);
  if (StrLen (pVersion) > 0) {
    TokenToUpdate = 0x0003;
    HiiSetString (mSmbiosMiscHiiHandle, TokenToUpdate, pVersion, ((void *) 0));
  }

  pReleaseDate = (CHAR16 *) _gPcd_FixedAtBuild_PcdFirmwareReleaseDateString;
  if (StrLen (pReleaseDate) > 0) {
    TokenToUpdate = 0x0004;
    HiiSetString (mSmbiosMiscHiiHandle, TokenToUpdate, pReleaseDate, ((void *) 0));
  } else {
    pReleaseDate = GetBiosReleaseDate ();
    if (pReleaseDate != ((void *) 0)) {
      if (StrLen (pReleaseDate) > 0) {
        TokenToUpdate = 0x0004;
        HiiSetString (mSmbiosMiscHiiHandle, TokenToUpdate, pReleaseDate, ((void *) 0));
      }
  ...
  TokenToGet = 0x0002;
  Vendor = HiiGetPackageString (&gEfiCallerIdGuid, TokenToGet, ((void *) 0));
  ...
  TokenToGet = 0x0004;
  ReleaseDate = HiiGetPackageString (&gEfiCallerIdGuid, TokenToGet, ((void *) 0));
  ...
  if (BiosPhysicalSize < 0x01000000) {
    SmbiosRecord->BiosSize = Base2ToByteWith64KUnit (BiosPhysicalSize) - 1;
  } else {
    SmbiosRecord->BiosSize = 0xFF;
    if (BiosPhysicalSize < 0x0000000400000000ULL) {
      SmbiosRecord->ExtendedBiosSize.Size = BiosPhysicalSize / 0x00100000;
      SmbiosRecord->ExtendedBiosSize.Unit = 0;
    } else {
      SmbiosRecord->ExtendedBiosSize.Size = BiosPhysicalSize / 0x40000000;
      SmbiosRecord->ExtendedBiosSize.Unit = 1;
    }
  }

  SmbiosRecord->SystemBiosMajorRelease = (UINT8) ((LibPcdGet32(4U) >> 16) & 0xFF);
  SmbiosRecord->SystemBiosMinorRelease = (UINT8) (LibPcdGet32(4U) & 0xFF);

  SmbiosRecord->EmbeddedControllerFirmwareMajorRelease = (UINT8) ((LibPcdGet32(14U) >> 16) & 0xFF);
  SmbiosRecord->EmbeddedControllerFirmwareMinorRelease = (UINT8) (LibPcdGet32(14U) & 0xFF);
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "[%a]:[%dL] Smbios Type00 Table Log Failed! %r \n", __func__, 271, Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))

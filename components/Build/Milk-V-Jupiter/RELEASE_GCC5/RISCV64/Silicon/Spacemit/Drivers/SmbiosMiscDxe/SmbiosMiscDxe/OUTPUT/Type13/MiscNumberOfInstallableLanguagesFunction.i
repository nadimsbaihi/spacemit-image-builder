# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type13/MiscNumberOfInstallableLanguagesFunction.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type13/MiscNumberOfInstallableLanguagesFunction.c"
# 9 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type13/MiscNumberOfInstallableLanguagesFunction.c"
...
# 10 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type13/MiscNumberOfInstallableLanguagesFunction.c" 2
...
# 12 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type13/MiscNumberOfInstallableLanguagesFunction.c" 2
...
# 13 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type13/MiscNumberOfInstallableLanguagesFunction.c" 2
...
# 14 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type13/MiscNumberOfInstallableLanguagesFunction.c" 2
...
# 15 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type13/MiscNumberOfInstallableLanguagesFunction.c" 2
...
# 17 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type13/MiscNumberOfInstallableLanguagesFunction.c" 2
...
SMBIOS_LANG_INFO mSmbiosLangInfo[] = {
  { {"en-US", 0x0016, 0x001E }, ((BOOLEAN)(0==1)) },
  { {"zh-chs", 0x0027, 0x0026 }, ((BOOLEAN)(0==1)) },
  { {"zh-cht", 0x0018, 0x0020 }, ((BOOLEAN)(0==1)) },
  { {"fr-FR", 0x0017, 0x001F }, ((BOOLEAN)(0==1)) },
  { {"ja-JP", 0x0019, 0x0021 }, ((BOOLEAN)(0==1)) },
  { {"it-IT", 0x001A, 0x0022 }, ((BOOLEAN)(0==1)) },
  { {"es-ES", 0x001B, 0x0023 }, ((BOOLEAN)(0==1)) },
  { {"de-DE", 0x001C, 0x0024 }, ((BOOLEAN)(0==1)) },
  { {"pt-BR", 0x001D, 0x0025 }, ((BOOLEAN)(0==1)) }
};
# 48 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/SmbiosMiscDxe/Type13/MiscNumberOfInstallableLanguagesFunction.c"
EFI_STATUS MiscNumberOfInstallableLanguagesFunction( void *RecordData, EFI_SMBIOS_PROTOCOL *Smbios ) {
  EFI_STATUS Status;
  ...
  Status = GetEfiGlobalVariable2 (L"PlatformLangCodes", (void **) &LanguageString, ((void *) 0));
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    BufferSize = AsciiStrSize ((CHAR8 *) _gPcd_FixedAtBuild_PcdUefiVariableDefaultPlatformLangCodes);
    LanguageString = AllocateCopyPool (BufferSize, (CHAR8 *) _gPcd_FixedAtBuild_PcdUefiVariableDefaultPlatformLangCodes);
    if (LanguageString == ((void *) 0)) {
      Status = ((RETURN_STATUS)(0x8000000000000000ULL | (9)));
      goto _Exit;
    }
  }

  Status = GetEfiGlobalVariable2 (L"PlatformLang", (void **) &Languages, ((void *) 0));
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    BufferSize = AsciiStrSize ((CHAR8 *) _gPcd_FixedAtBuild_PcdUefiVariableDefaultPlatformLang);
    Languages = AllocateCopyPool (BufferSize, (CHAR8 *) _gPcd_FixedAtBuild_PcdUefiVariableDefaultPlatformLang);
    if (Languages == ((void *) 0)) {
      Status = ((RETURN_STATUS)(0x8000000000000000ULL | (9)));
      goto _Exit;
    }
  ...
  for (LangIdx = 0; LangIdx < BufferSize; LangIdx++) {
    if ((LanguageString[LangIdx] == ';') || (LanguageString[LangIdx] == '\0')) {
      ...
      for (StringIdx = 0; StringIdx < (sizeof (mSmbiosLangInfo) / sizeof ((mSmbiosLangInfo)[0])); StringIdx++) {
        if (!AsciiStrCmp (LangStr, mSmbiosLangInfo[StringIdx].LangString.LanguageSignature)) {
          mSmbiosLangInfo[StringIdx].LangInstalled = ((BOOLEAN)(1==1));
          if (InputData->Flags & 0x00000001) {
          ...
          Char16String = HiiGetPackageString (&gEfiCallerIdGuid, TokenToGet, ((void *) 0));
  ...
  for (StringIdx = 0; StringIdx < (sizeof (mSmbiosLangInfo) / sizeof ((mSmbiosLangInfo)[0])); StringIdx++) {
    if (mSmbiosLangInfo[StringIdx].LangInstalled == ((BOOLEAN)(1==1))) {
      if (SmbiosRecord->Flags & 0x00000001) {
        TokenToGet = mSmbiosLangInfo[StringIdx].LangString.InstallableLanguageAbbreviateString;
      } else {
        TokenToGet = mSmbiosLangInfo[StringIdx].LangString.InstallableLanguageLongString;
      }
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "[%a]:[%dL] Smbios Type13 Table Log Failed! %r \n", __func__, 172, Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))

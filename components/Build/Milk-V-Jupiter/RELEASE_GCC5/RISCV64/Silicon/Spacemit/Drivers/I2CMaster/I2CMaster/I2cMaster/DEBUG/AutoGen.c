...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x8CA0A6C6, 0x6B3D, 0x4C0C, {0xA1, 0xD1, 0x85, 0xF0, 0x5D, 0x8A, 0x7C, 0x92}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "I2cMasterDxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdI2cControllerConfigs[32] = {0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x02,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x20,0x01,0xd4,0x00,0x00,0x00,0x00,0xa0,0x86,0x01,0x00,0x01,0x00,0x00,0x00};
GLOBAL_REMOVE_IF_UNREFERENCED const UINTN _gPcd_FixedAtBuild_Size_PcdI2cControllerConfigs = 32;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdI2cSlaveConfig[4] = {0x01,0x00,0x02,0x50};
GLOBAL_REMOVE_IF_UNREFERENCED const UINTN _gPcd_FixedAtBuild_Size_PcdI2cSlaveConfig = 4;

...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x63B1DCD0, 0x16FA, 0x7118, {0xBF, 0x60, 0xE7, 0x36, 0xB1, 0xA4, 0xA8, 0x64}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SpacemitEepromDxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdEepromConfigs[6] = {0x01,0x00,0x02,0x50,0x01,0x08};
GLOBAL_REMOVE_IF_UNREFERENCED const UINTN _gPcd_FixedAtBuild_Size_PcdEepromConfigs = 6;

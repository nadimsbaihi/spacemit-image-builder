# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/MmcDxe/MmcBlockIo.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/MmcDxe/MmcBlockIo.c"
# 9 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/MmcDxe/MmcBlockIo.c"
...
# 10 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/MmcDxe/MmcBlockIo.c" 2
...
# 12 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Drivers/MmcDxe/MmcBlockIo.c" 2
  ...
  )
{
  ...
  if (MmcHostInstance->State != MmcHwInitializationState) {
    ...
    Status = MmcHost->SendCommand (MmcHost, (((13) & 0xFFFF) | (1 << 16)), CmdArg);
    if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "MmcGetCardStatus(MMC_CMD13): Error and Status = %r\n", Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
      return Status;
    }


    MmcHost->ReceiveResponse (MmcHost, 0, Response);
  ...
  )
{
  ...
  MmcHostInstance = (((MMC_HOST_INSTANCE *) (void *) ((CHAR8 *) (This) - ((UINTN) __builtin_offsetof(MMC_HOST_INSTANCE, BlockIo))))->Signature != ((('m') | ('m' << 8)) | ((('c') | ('h' << 8)) << 16))) ? ((void *) 0) : ((MMC_HOST_INSTANCE *) (void *) ((CHAR8 *) (This) - ((UINTN) __builtin_offsetof(MMC_HOST_INSTANCE, BlockIo))));

  if (MmcHostInstance->MmcHost == ((void *) 0)) {
  ...
  if (!MmcHostInstance->MmcHost->IsCardPresent (MmcHostInstance->MmcHost)) {
    MmcHostInstance->BlockIo.Media->MediaPresent = ((BOOLEAN)(0==1));
    MmcHostInstance->BlockIo.Media->LastBlock = 0;
    MmcHostInstance->BlockIo.Media->BlockSize = 512;
    MmcHostInstance->BlockIo.Media->ReadOnly = ((BOOLEAN)(0==1));
  ...
  )
{
  ...
  Status = MmcHost->SendCommand (MmcHost, (((12) & 0xFFFF) | (1 << 16)), 0);
  if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    MmcHost->ReceiveResponse (MmcHost, 0, Response);
  }
  ...
  )
{
  ...
  if (MmcHostInstance->CardInfo.CardType != EMMC_CARD) {
    ...
    if (MmcHostInstance->CardInfo.OCRData.AccessMode & 0x00000002) {
      CmdArg = Lba;
    } else {
    ...
    if ((MmcHostInstance->CardInfo.OCRData.AccessMode & 0x3) ==
        0x2)
    {
      CmdArg = Lba;
    } else {
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "%a(MMC_CMD%d): Error %r\n", __func__, Cmd, Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    return Status;
  }
  ...
  if (Transfer == 0) {
    ...
    if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00001000)) { DebugPrint (0x00001000, "%a(): Error Read Block Data and Status = %r\n", __func__, Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    ...
    if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "%a() : Error MmcProgrammingState\n", __func__); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
      return Status;
    }
  } else {
    ...
    if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00001000)) { DebugPrint (0x00001000, "%a(): Error Write Block Data and Status = %r\n", __func__, Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
      MmcStopTransmission (MmcHost);
      return Status;
    }
  }
  ...
  if (BufferSize > This->Media->BlockSize) {
    Status = MmcHost->SendCommand (MmcHost, (((12) & 0xFFFF) | (1 << 16)), 0);
    if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00001000)) { DebugPrint (0x00001000, "%a(): Error and Status:%r\n", __func__, Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    }
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "MmcIoBlocks() : Error MmcTransferState\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    return Status;
  }
  ...
  )
{
  ...
  BlockCount = 1;
  MmcHostInstance = (((MMC_HOST_INSTANCE *) (void *) ((CHAR8 *) (This) - ((UINTN) __builtin_offsetof(MMC_HOST_INSTANCE, BlockIo))))->Signature != ((('m') | ('m' << 8)) | ((('c') | ('h' << 8)) << 16))) ? ((void *) 0) : ((MMC_HOST_INSTANCE *) (void *) ((CHAR8 *) (This) - ((UINTN) __builtin_offsetof(MMC_HOST_INSTANCE, BlockIo))));
  do { if (((BOOLEAN)(0==1))) { (void) (MmcHostInstance != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
  MmcHost = MmcHostInstance->MmcHost;
  do { if (((BOOLEAN)(0==1))) { (void) (MmcHost); } } while (((BOOLEAN)(0==1)));

  if (This->Media->MediaId != MediaId) {
    return ((RETURN_STATUS)(0x8000000000000000ULL | (13)));
  }

  if ((MmcHost == ((void *) 0)) || (Buffer == ((void *) 0))) {
    return ((RETURN_STATUS)(0x8000000000000000ULL | (2)));
  }
  ...
  if ((MmcHost->Revision >= 0x00010002 && MmcHost->IsMultiBlock != ((void *) 0)) && MmcHost->IsMultiBlock (MmcHost)) {
  ...
  if ((Transfer == 1) && (This->Media->ReadOnly == ((BOOLEAN)(1==1)))) {
  ...
  while (BytesRemainingToBeTransfered > 0) {
    ...
    if (0 == Timeout) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "The Card is busy\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    ...
    if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "%a(): Failed to transfer block and Status:%r\n", __func__, Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    }
...
{
  return MmcIoBlocks (This, 0, MediaId, Lba, BufferSize, Buffer);
}
...
{
  return MmcIoBlocks (This, 1, MediaId, Lba, BufferSize, Buffer);
}

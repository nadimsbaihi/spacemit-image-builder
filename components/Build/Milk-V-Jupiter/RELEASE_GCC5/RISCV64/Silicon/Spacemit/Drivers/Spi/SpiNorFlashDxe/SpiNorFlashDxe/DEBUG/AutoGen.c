...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x187ead2e, 0xdcd8, 0x4d49, {0x85, 0xbc, 0x23, 0xa8, 0x3e, 0x07, 0xae, 0x65}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SpiNorFlashDxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdSpiFlashSoftReset = _PCD_VALUE_PcdSpiFlashSoftReset;

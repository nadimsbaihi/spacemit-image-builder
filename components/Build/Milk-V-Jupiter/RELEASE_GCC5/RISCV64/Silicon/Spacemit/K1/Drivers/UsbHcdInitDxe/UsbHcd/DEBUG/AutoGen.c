...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x196e7c2a, 0x37b2, 0x4b85, {0x86, 0x83, 0x71, 0x85, 0x88, 0x95, 0x24, 0x49}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "UsbHcdDxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gSpacemitK1TokenSpaceGuid = {0xbf8e77b8, 0xfbaf, 0x409f, {0x8b, 0xb4, 0xc9, 0xf2, 0xa0, 0x06, 0xe0, 0xf0}};
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT64 _gPcd_FixedAtBuild_PcdSpacemitAPMURegBase = _PCD_VALUE_PcdSpacemitAPMURegBase;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT64 _gPcd_FixedAtBuild_PcdSpacemitMPMURegBase = _PCD_VALUE_PcdSpacemitMPMURegBase;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT64 _gPcd_FixedAtBuild_PcdSpacemitMFPRRegBase = _PCD_VALUE_PcdSpacemitMFPRRegBase;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT64 _gPcd_FixedAtBuild_PcdUsb0BaseAddr = _PCD_VALUE_PcdUsb0BaseAddr;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT64 _gPcd_FixedAtBuild_PcdUsb0PhyBaseAddr = _PCD_VALUE_PcdUsb0PhyBaseAddr;
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdUsb0Enable = _PCD_VALUE_PcdUsb0Enable;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT64 _gPcd_FixedAtBuild_PcdUsb1BaseAddr = _PCD_VALUE_PcdUsb1BaseAddr;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT64 _gPcd_FixedAtBuild_PcdUsb1PhyBaseAddr = _PCD_VALUE_PcdUsb1PhyBaseAddr;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT64 _gPcd_FixedAtBuild_PcdUsb3BaseAddr = _PCD_VALUE_PcdUsb3BaseAddr;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT64 _gPcd_FixedAtBuild_PcdUsb2PhyBaseAddr = _PCD_VALUE_PcdUsb2PhyBaseAddr;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT64 _gPcd_FixedAtBuild_PcdUsb3PhyBaseAddr = _PCD_VALUE_PcdUsb3PhyBaseAddr;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT64 _gPcd_FixedAtBuild_PcdCombPhySelAddr = _PCD_VALUE_PcdCombPhySelAddr;
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdUsb1Enable = _PCD_VALUE_PcdUsb1Enable;
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdUsb2Enable = _PCD_VALUE_PcdUsb2Enable;
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdUsb3Enable = _PCD_VALUE_PcdUsb3Enable;
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdUsbHubEnable = _PCD_VALUE_PcdUsbHubEnable;

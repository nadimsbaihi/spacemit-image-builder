...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x24150afa, 0x3adb, 0x4beb, {0xb7, 0xba, 0xb7, 0x30, 0x82, 0x38, 0x3d, 0x7a}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SpacemitK1QspiDxe";
...
// Protocols
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gSpacemitSpiMasterProtocolGuid = {0xc37b64e7, 0x7352, 0x4560, {0xac, 0xc2, 0x68, 0xca, 0xdc, 0x13, 0xce, 0x67}};
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdQspiMaxFrequency = _PCD_VALUE_PcdQspiMaxFrequency;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdQspiRegBase = _PCD_VALUE_PcdQspiRegBase;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT64 _gPcd_FixedAtBuild_PcdSFMemMapBaseAddress = _PCD_VALUE_PcdSFMemMapBaseAddress;

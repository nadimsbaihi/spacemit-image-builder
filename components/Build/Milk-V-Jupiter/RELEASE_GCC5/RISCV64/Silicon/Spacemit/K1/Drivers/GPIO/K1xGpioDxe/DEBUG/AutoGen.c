...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x6C6E26DC, 0xCA1E, 0xB851, {0x5F, 0x72, 0x23, 0x1C, 0xD5, 0x05, 0x5C, 0x0F}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "K1xGpioDxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT64 _gPcd_FixedAtBuild_PcdSpacemitAPBClockRegBase = _PCD_VALUE_PcdSpacemitAPBClockRegBase;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT64 _gPcd_FixedAtBuild_PcdGpioControllerBase = _PCD_VALUE_PcdGpioControllerBase;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdGpioControllerCount = _PCD_VALUE_PcdGpioControllerCount;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdGpioPinCount = _PCD_VALUE_PcdGpioPinCount;

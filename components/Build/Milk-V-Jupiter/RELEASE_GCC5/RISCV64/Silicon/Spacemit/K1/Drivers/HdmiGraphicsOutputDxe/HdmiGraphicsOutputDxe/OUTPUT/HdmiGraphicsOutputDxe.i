# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/K1/Drivers/HdmiGraphicsOutputDxe/HdmiGraphicsOutputDxe.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/K1/Drivers/HdmiGraphicsOutputDxe/HdmiGraphicsOutputDxe.c"
# 12 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/K1/Drivers/HdmiGraphicsOutputDxe/HdmiGraphicsOutputDxe.c"
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/K1/Drivers/HdmiGraphicsOutputDxe/HdmiGraphicsOutputDxe.h" 1
# 12 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/K1/Drivers/HdmiGraphicsOutputDxe/HdmiGraphicsOutputDxe.h"
...
# 13 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/K1/Drivers/HdmiGraphicsOutputDxe/HdmiGraphicsOutputDxe.h" 2
...
# 14 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/K1/Drivers/HdmiGraphicsOutputDxe/HdmiGraphicsOutputDxe.h" 2
...
# 15 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/K1/Drivers/HdmiGraphicsOutputDxe/HdmiGraphicsOutputDxe.h" 2
...
# 16 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/K1/Drivers/HdmiGraphicsOutputDxe/HdmiGraphicsOutputDxe.h" 2
...
# 17 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/K1/Drivers/HdmiGraphicsOutputDxe/HdmiGraphicsOutputDxe.h" 2
...
extern EFI_GUID gEfiDevicePathToTextProtocolGuid;
# 19 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/K1/Drivers/HdmiGraphicsOutputDxe/HdmiGraphicsOutputDxe.h" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/EmbeddedPkg/Include/Protocol/EmbeddedExternalDevice.h" 1
# 20 "/home/kapoagaeming/spacemit-image-builder/components/edk2/EmbeddedPkg/Include/Protocol/EmbeddedExternalDevice.h"
...
( *EMBEDDED_EXTERNAL_DEVICE_READ)(
  EMBEDDED_EXTERNAL_DEVICE *This,
  UINTN Register,
  UINTN Length,
  void *Buffer
  )
# 52 "/home/kapoagaeming/spacemit-image-builder/components/edk2/EmbeddedPkg/Include/Protocol/EmbeddedExternalDevice.h"
;
...
# 81 "/home/kapoagaeming/spacemit-image-builder/components/edk2/EmbeddedPkg/Include/Protocol/EmbeddedExternalDevice.h"
;
...
extern EFI_GUID gEmbeddedExternalDeviceProtocolGuid;
# 20 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/K1/Drivers/HdmiGraphicsOutputDxe/HdmiGraphicsOutputDxe.h" 2


typedef struct {
  VENDOR_DEVICE_PATH Guid;
  EFI_DEVICE_PATH_PROTOCOL End;
} HDMI_GRAPHICS_DEVICE_PATH;
...
typedef struct {
  ...
  HDMI_GRAPHICS_DEVICE_PATH DevicePath;
...
# 13 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/K1/Drivers/HdmiGraphicsOutputDxe/HdmiGraphicsOutputDxe.c" 2
...
# 14 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/K1/Drivers/HdmiGraphicsOutputDxe/HdmiGraphicsOutputDxe.c" 2
...
# 16 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/K1/Drivers/HdmiGraphicsOutputDxe/HdmiGraphicsOutputDxe.c" 2
...
BOOLEAN mDisplayInitialized = ((BOOLEAN)(0==1));

GOP_MODE_DATA mGopMode[] = {
  { 1920, 1080 },
};

const HDMI_INSTANCE mHdmiTemplate = {
  ((('h') | ('d' << 8)) | ((('m') | ('i' << 8)) << 16)),
  ((void *) 0),
  {
  ...
  },
  {
    ...
    (sizeof (mGopMode) / sizeof ((mGopMode)[0])),
    0,
    ((void *) 0),
    0,
    0,
  ...
  )
{
  ...
  Status = HwInitializeDisplay (&FbAddress, &FbSize);
  if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    mDisplayInitialized = ((BOOLEAN)(1==1));
  }

  This->Mode->FrameBufferBase = FbAddress;
  ...
  )
{
  ...
  if ((ModeInfo == ((void *) 0)) || (SizeOfInfo == ((void *) 0)) || (ModeNumber >= This->Mode->MaxMode)) {
  ...
  Mode = &mGopMode[ModeNumber];

  *SizeOfInfo = sizeof (EFI_GRAPHICS_OUTPUT_MODE_INFORMATION);
  CopyMem (*ModeInfo, This->Mode->Info, *SizeOfInfo);
  (*ModeInfo)->HorizontalResolution = Mode->Width;
  (*ModeInfo)->VerticalResolution = Mode->Height;
  (*ModeInfo)->PixelsPerScanLine = Mode->Width;

  return (RETURN_STATUS)(0);
}
# 173 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/K1/Drivers/HdmiGraphicsOutputDxe/HdmiGraphicsOutputDxe.c"
EFI_STATUS
GopSetMode (
  EFI_GRAPHICS_OUTPUT_PROTOCOL *This,
  UINT32 ModeNumber
  )
{
  ...
  Mode = &mGopMode[ModeNumber];
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Setting mode %u from %u: %u x %u\n", ModeNumber, This->Mode->Mode, Mode->Width, Mode->Height); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
  ...
  This->Mode->FrameBufferSize = Mode->Width * Mode->Height * ((32) / 8);
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Reported FrameBufferSize is %u\n", This->Mode->FrameBufferSize); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));

  ClearScreen (This);
  return (RETURN_STATUS)(0);
}
# 231 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/K1/Drivers/HdmiGraphicsOutputDxe/HdmiGraphicsOutputDxe.c"
EFI_STATUS
  ...
  )
{
  ...
  switch (BltOperation) {
    case EfiBltVideoFill:
      ...
      for (I = 0; I < Height; I++) {
        VidBuf = ((UINT8*) ((UINTN)This->Mode->FrameBufferBase + (DestinationY + I) * This->Mode->Info->PixelsPerScanLine * ((32) / 8) + (DestinationX) * ((32) / 8)));

        SetMem32 (VidBuf, Width * ((32) / 8), *(UINT32 *)BltBuf);
      }
    ...
    case EfiBltVideoToBltBuffer:
      ...
      for (I = 0; I < Height; I++) {
        VidBuf = ((UINT8*) ((UINTN)This->Mode->FrameBufferBase + (SourceY + I) * This->Mode->Info->PixelsPerScanLine * ((32) / 8) + (SourceX) * ((32) / 8)));

        BltBuf = (UINT8 *)((UINTN)BltBuffer + (DestinationY + I) * Delta +
                           DestinationX * ((32) / 8));

        gBS->CopyMem ((void *)BltBuf, (void *)VidBuf, ((32) / 8) * Width);
      }
    ...
    case EfiBltBufferToVideo:
      ...
      for (I = 0; I < Height; I++) {
        ...
        gBS->CopyMem ((void *)VidBuf, (void *)BltBuf, Width * ((32) / 8));
      }
    ...
    case EfiBltVideoToVideo:
      for (I = 0; I < Height; I++) {
        VidBuf = ((UINT8*) ((UINTN)This->Mode->FrameBufferBase + (SourceY + I) * This->Mode->Info->PixelsPerScanLine * ((32) / 8) + (SourceX) * ((32) / 8)));
        VidBuf1 = ((UINT8*) ((UINTN)This->Mode->FrameBufferBase + (DestinationY + I) * This->Mode->Info->PixelsPerScanLine * ((32) / 8) + (DestinationX) * ((32) / 8)));

        gBS->CopyMem ((void *)VidBuf1, (void *)VidBuf, Width * ((32) / 8));
      }
...
HdmiInstanceContructor (
  HDMI_INSTANCE **NewInstance
  )
{
  HDMI_INSTANCE *Instance;

  Instance = AllocateCopyPool (sizeof (HDMI_INSTANCE), &mHdmiTemplate);
  if (Instance == ((void *) 0)) {
  ...
  )
{
  ...
  Status = HdmiInstanceContructor (&Instance);
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    return Status;
  }
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "GraphicsOutputDxeInitialize: Can not install the protocol. Exit Status=%r\n", Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));

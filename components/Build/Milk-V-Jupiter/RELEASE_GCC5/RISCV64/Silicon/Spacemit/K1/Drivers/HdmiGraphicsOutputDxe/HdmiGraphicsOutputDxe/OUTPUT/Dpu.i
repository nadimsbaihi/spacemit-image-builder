# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/K1/Drivers/HdmiGraphicsOutputDxe/Dpu.c"
# 1 "/home/kapoagaeming/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/Silicon/Spacemit/K1/Drivers/HdmiGraphicsOutputDxe/HdmiGraphicsOutputDxe//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/riscv64-linux-gnu/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/Silicon/Spacemit/K1/Drivers/HdmiGraphicsOutputDxe/HdmiGraphicsOutputDxe/DEBUG/AutoGen.h" 1
# 16 "/home/kapoagaeming/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/Silicon/Spacemit/K1/Drivers/HdmiGraphicsOutputDxe/HdmiGraphicsOutputDxe/DEBUG/AutoGen.h"
...
# 17 "/home/kapoagaeming/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/Silicon/Spacemit/K1/Drivers/HdmiGraphicsOutputDxe/HdmiGraphicsOutputDxe/DEBUG/AutoGen.h" 2
...
# 18 "/home/kapoagaeming/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/Silicon/Spacemit/K1/Drivers/HdmiGraphicsOutputDxe/HdmiGraphicsOutputDxe/DEBUG/AutoGen.h" 2

extern GUID gEfiCallerIdGuid;
extern GUID gEdkiiDscPlatformGuid;
extern CHAR8 *gEfiCallerBaseName;
# 30 "/home/kapoagaeming/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/Silicon/Spacemit/K1/Drivers/HdmiGraphicsOutputDxe/HdmiGraphicsOutputDxe/DEBUG/AutoGen.h"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/K1/Drivers/HdmiGraphicsOutputDxe/Dpu.c"
# 9 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/K1/Drivers/HdmiGraphicsOutputDxe/Dpu.c"
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/K1/Drivers/HdmiGraphicsOutputDxe/Display.h" 1
# 29 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/K1/Drivers/HdmiGraphicsOutputDxe/Display.h"
enum BIT_DEPTH {
  EIGHT_BPP = 0,
  TEN_BPP = 1,
  TWELVE_BPP = 2,
...
# 10 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/K1/Drivers/HdmiGraphicsOutputDxe/Dpu.c" 2
...
# 12 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/K1/Drivers/HdmiGraphicsOutputDxe/Dpu.c" 2
...
# 13 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/K1/Drivers/HdmiGraphicsOutputDxe/Dpu.c" 2
...
# 14 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/K1/Drivers/HdmiGraphicsOutputDxe/Dpu.c" 2
...
# 15 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/K1/Drivers/HdmiGraphicsOutputDxe/Dpu.c" 2
...
# 16 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/K1/Drivers/HdmiGraphicsOutputDxe/Dpu.c" 2
...
# 17 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/K1/Drivers/HdmiGraphicsOutputDxe/Dpu.c" 2
...
# 19 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/K1/Drivers/HdmiGraphicsOutputDxe/Dpu.c" 2
...
# 21 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/K1/Drivers/HdmiGraphicsOutputDxe/Dpu.c" 2
...
_DISPLAY_MODEINFO Hdmi1080pModeInfo = {
  .Name = "1920x1080-60",
  .Refresh = 60,
  .Xres = 1920,
  .Yres = 1080,
...
{
  MmioWrite32 ((0xc0440000ULL) + Offset, Val);
}

static void
HdmiDpuInit (
  _DISPLAY_MODEINFO *HdmiModeInfo,
  UINT64 FbBase
  )
{
  UINT32 Vsync, Hsync, Vbp, Vfp, Hbp, Hfp, Vsp, Hsp;
  UINT32 RegVal = 0;

  Vsync = HdmiModeInfo->VsyncLen & 0x3ff;
  Hsync = HdmiModeInfo->HsyncLen & 0x3ff;
  Vbp = HdmiModeInfo->UpperMargin & 0xfff;
  Vfp = HdmiModeInfo->LowerMargin & 0xfff;
  Hbp = HdmiModeInfo->LeftMargin & 0xfff;
  Hfp = HdmiModeInfo->RightMargin & 0xfff;
  Vsp = HdmiModeInfo->VsyncInvert ? 0 : 1;
  Hsp = HdmiModeInfo->HsyncInvert ? 0 : 1;

  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00400000)) { DebugPrint (0x00400000, "%a Vsync %d Hsync %d \n", __func__, Vsync, Hsync); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00400000)) { DebugPrint (0x00400000, "%a Vbp %d Vfp %d Vsp %d\n", __func__, Vbp, Vfp, Vsp); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00400000)) { DebugPrint (0x00400000, "%a Hbp %d Hfp %d Hsp %d\n", __func__, Hbp, Hfp, Hsp); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));

  HdmiDpuWrite (0xa1c, 0x2223);
  HdmiDpuWrite (0x18000, (HdmiModeInfo->Yres << 16) | HdmiModeInfo->Xres);
  HdmiDpuWrite (0x18018, 0x20);
  HdmiDpuWrite (0x1807c, 0x100);
  RegVal = (Hbp << 16) | Hfp;
  HdmiDpuWrite (0x18080, RegVal);
  RegVal = (Vbp << 16) | Vfp;
  HdmiDpuWrite (0x18084, RegVal);
  RegVal = (Vsp << 28) | (Vsync << 16) | (Hsp << 12) | (Hsync);
  HdmiDpuWrite (0x18088, RegVal);
  HdmiDpuWrite (0x1808c, (HdmiModeInfo->Yres << 16) | HdmiModeInfo->Xres);
  HdmiDpuWrite (0x18090, HdmiModeInfo->PixFmtOut);
  HdmiDpuWrite (0xd80, 0x202040);
  HdmiDpuWrite (0xda0, (UINT32)(FbBase & 0xffffffff));
  HdmiDpuWrite (0xda4, (UINT32)(FbBase >> 32));
  HdmiDpuWrite (0xdb8, HdmiModeInfo->Xres * 4);
  HdmiDpuWrite (0xdbc, (HdmiModeInfo->Yres << 16) | HdmiModeInfo->Xres);
  HdmiDpuWrite (0xdc0, 0x0);
  HdmiDpuWrite (0xdc4, ((HdmiModeInfo->Yres - 1) << 16) | (HdmiModeInfo->Xres - 1));
  HdmiDpuWrite (0xdf0, 0x4);

  HdmiDpuWrite (0x4c00, (HdmiModeInfo->Xres << 8) | 0x01);
  HdmiDpuWrite (0x4c04, HdmiModeInfo->Yres);
  HdmiDpuWrite (0x4c10, 0xff0000);
  HdmiDpuWrite (0x4c14, 0xff);
  HdmiDpuWrite (0x4c38, 0x7);
  HdmiDpuWrite (0x4c48, 0x0);
  HdmiDpuWrite (0x4c4c, (HdmiModeInfo->Xres - 1) << 16);
  HdmiDpuWrite (0x4c50, HdmiModeInfo->Yres - 1);
  HdmiDpuWrite (0x4c54, 0xff0000);

  HdmiDpuWrite (0x560, 0x40008);
  HdmiDpuWrite (0x588, 0x821);
  HdmiDpuWrite (0x56c, 0x1);
  HdmiDpuWrite (0x58c, 0x1);
}
...
{
  MapRegToGcdMmioSpace ((0xC0400500ULL), 0x00001000);
  MapRegToGcdMmioSpace ((0xc0440000ULL), 0x00001000);
  MapRegToGcdMmioSpace ((0xc0440000ULL) + 0x4000, 0x00001000);
  MapRegToGcdMmioSpace ((0xc0440000ULL) + 0x18000, 0x00001000);
  MapRegToGcdMmioSpace ((0xd4090000ULL), 0x00001000);
  ...
  )
{
  ...
  Pages = (((*FbSize) >> 12) + (((*FbSize) & 0xFFF) ? 1 : 0));
  Buffer = AllocatePages (Pages);
  if (((void *) 0) == Buffer) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "%a: failed to allocate %d pages memory for framebuffer\n", __func__, Pages); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
  ...
  BuffSize = ((Pages) << 12);
  Status = gDS->SetMemorySpaceAttributes ((UINTN)Buffer, BuffSize, 0x0000000000000002ULL);
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "%a: failed to set memory space attributes for region [0x%p+0x%Lx)\n", __func__, Buffer, BuffSize); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
  ...
  )
{
  ...
  RemoteDpuId = 1;
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00400000)) { DebugPrint (0x00400000, "RemoteDpuId  %d\n", RemoteDpuId); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));

  DpuId = DPU_MODE_HDMI;
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00400000)) { DebugPrint (0x00400000, "DpuId %d\n", DpuId); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));

  Bpix = (32);
  Xsize = 1920;
  Ysize = 1080;

  *FbSize = Xsize * Ysize * ((32) / 8);
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "display: %dx%d, fb = 0x%x, size = 0x%x\n", Xsize, Ysize, *FbBase, *FbSize); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))


          ;

  HdmiDpuInit (&Hdmi1080pModeInfo, (UINTN)*FbBase);

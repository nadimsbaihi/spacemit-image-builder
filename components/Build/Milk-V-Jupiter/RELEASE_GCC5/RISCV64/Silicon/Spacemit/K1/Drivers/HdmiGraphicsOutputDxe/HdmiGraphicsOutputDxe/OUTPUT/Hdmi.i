# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/K1/Drivers/HdmiGraphicsOutputDxe/Hdmi.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/K1/Drivers/HdmiGraphicsOutputDxe/Hdmi.c"
# 9 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/K1/Drivers/HdmiGraphicsOutputDxe/Hdmi.c"
...
# 10 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/K1/Drivers/HdmiGraphicsOutputDxe/Hdmi.c" 2
...
# 12 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/K1/Drivers/HdmiGraphicsOutputDxe/Hdmi.c" 2
...
# 13 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/K1/Drivers/HdmiGraphicsOutputDxe/Hdmi.c" 2
...
# 14 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/K1/Drivers/HdmiGraphicsOutputDxe/Hdmi.c" 2
...
# 15 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/K1/Drivers/HdmiGraphicsOutputDxe/Hdmi.c" 2
...
# 17 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/K1/Drivers/HdmiGraphicsOutputDxe/Hdmi.c" 2
# 25 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/K1/Drivers/HdmiGraphicsOutputDxe/Hdmi.c"
const UINT8 PLL9_BIT0_1[3] = { 0x0, 0x1, 0x2 };
...
{
  UINT32 TimeoutCount = TimeoutMs * 100;

  while (1) {
    if (Check == (MmioRead32 (Reg) & Mask)) {
      break;
    }
...
{
  return MmioRead32 ((0xC0400500ULL) + Offset);
}
...
{
  MmioWrite32 ((0xC0400500ULL) + Offset, Val);
}
...
{
  UINT32 TimeoutCount = TimeoutMs * 10;

  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00400000)) { DebugPrint (0x00400000, "%a() \n", __func__); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));

  do {
    if (HdmiGetPlugInStatus ()) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "%a() hdmi get hpd signal \n", __func__); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
      return (RETURN_STATUS)(0);
    }
  ...
  )
{
  ...
  if (BitClock < 425) {
    Ret = 3;
  } else if (BitClock < 850) {
    Ret = 2;
  } else if (BitClock < 1700) {
    Ret = 1;
  } else {
    Ret = 0;
  }
  ...
  )
{
  ...
  if (BitClock <= 337) {
    Ret = 0;
  } else if (BitClock < 425) {
    Ret = 1;
  } else if (BitClock < 675) {
    Ret = 0;
  } else if (BitClock < 850) {
    Ret = 1;
  } else if (BitClock < 1350) {
    Ret = 0;
  } else if (BitClock < 1700) {
    Ret = 1;
  } else {
...
{
  INT32 Value = BitClock * PowerOfTwo (Pll8Bit5_6 (BitClock, N)) / N;
  INT32 Ret;
...
{
  UINT64 IntPara = 1000000000;
  UINT64 Value = (PowerOfTwo (Pll8Bit5_6 (BitClock, N))) * BitClock * IntPara / (N * (Pll6Bit4_5 (BitClock, N) + 1) * RefClock);
  UINT64 Integer = (PowerOfTwo (Pll8Bit5_6 (BitClock, N))) * BitClock / (N * (Pll6Bit4_5 (BitClock, N) + 1) * RefClock) * IntPara;
  UINT64 Fraction = Value - Integer;
  BOOLEAN Negative = ((BOOLEAN)(0==1));
  INT32 Bit = 0;
  INT32 Frac20bit = 0;
  INT32 Pll2Reg = 0;
  INT32 Pll1Reg = 0;
  ...
  Negative = Fraction > 500000000 ? ((BOOLEAN)(1==1)) : ((BOOLEAN)(0==1));
  Fraction = Negative ? 1000000000 - Fraction : Fraction;
  *TntegerPart = Negative ? Integer / IntPara + 1 : Integer / IntPara;
  ...
  if (!Negative) {
    Pll2Reg = ((Frac20bit & 0xF0000) >> 16) | (1 << 5);
  } else {
    Frac20bit = (~Frac20bit + 1) & 0xfffff;
    Pll2Reg = 0x10 | ((Frac20bit & 0xF0000) >> 16) | (1 << 5);
  }

  Pll1Reg = (Frac20bit & 0xFF00) >> 8;
  Pll0Reg = Frac20bit & 0xFF;
  *HmdiE8Reg = (0x20 << 24) | (Pll2Reg << 16) | (Pll1Reg << 8) | Pll0Reg;
}
...
{
  INT32 pll9_reg = 0, pll8_reg = 0, pll7_reg = 0, pll6_reg = 0, pll5_reg = 0, pll4_reg = 0;
  INT32 N = 100;
  INT32 RefClock = 24;
  INT32 hdmi_ec_reg = 0;
  INT32 hdmi_f0_reg = 0;
  UINT32 hdmi_e8_reg = 0;

  INT32 BitClock = BitDepth == EIGHT_BPP ? PixelClock : PixelClock * 125 / 100;

  INT32 TntegerPart = 0;

  HdmiPllRegCal (BitClock, RefClock, N, &TntegerPart, &hdmi_e8_reg);

  pll9_reg = 2 << 2 | PLL9_BIT0_1[BitDepth];
  pll8_reg = (0 << 7) | (Pll8Bit5_6 (BitClock, N) << 5) | 1;
  pll7_reg = 0x50;
  pll6_reg = 0xD | (Pll6Bit4_5 (BitClock, N) << 4) | (2 << 6);
  pll5_reg = 0x40 | Pll5Bit0_2 (BitClock, N);



  pll4_reg = TntegerPart;

  hdmi_ec_reg = (pll7_reg << 24) | (pll6_reg << 16) | (pll5_reg << 8) | pll4_reg;
  hdmi_f0_reg = (pll9_reg << 8) | pll8_reg;

  HdmiRegWrite (0xe8, hdmi_e8_reg);
  HdmiRegWrite (0xec, hdmi_ec_reg);
  HdmiRegWrite (0xf0, hdmi_f0_reg);
}
  ...
  )
{
  ...
  RegVal = HdmiRegRead (Offset);
  RegVal &= ~(Mask << Shifts);
  RegVal |= (Value << Shifts);
  HdmiRegWrite (Offset, RegVal);
}
...
{
  UINT32 Value = 0;
  UINT32 PixelClock = 148500;
  UINT32 good_phase = 0x00;
  UINT32 bias_current = 0x01;
  UINT32 bias_risistor = 0x07;

  INT32 BitDepth = EIGHT_BPP;
  INT32 ColorDepth = BitDepth == EIGHT_BPP ? 4 : 5;


  HdmiRegWrite (0xe8, 0x20200000);
  HdmiRegWrite (0xec, 0x508d425a);
  HdmiRegWrite (0xf0, 0x861);

  HdmiRegWrite (0xe0, 0xAE5C410F);
  HdmiWriteBits (0xe0, bias_current, 0x03, 29);
  HdmiWriteBits (0xe0, bias_risistor, 0x0F, 18);
  HdmiWriteBits (0xe0, good_phase, 0x03, 14);

  Value = 0x0000000d | (ColorDepth << 4);
  HdmiRegWrite (0x34, Value);

  HdmiPllSet (PixelClock, BitDepth);
  HdmiRegWrite (0xe4, 0x00);
  HdmiRegWrite (0xe4, 0x03);
  Value = HdmiRegRead (0xe4);

  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00400000)) { DebugPrint (0x00400000, "%a() hdmi pll lock status 0x%x\n", __func__, Value); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));



  gBS->Stall (100);

  Value = 0x1C208000 | BitDepth;
  HdmiRegWrite (0x28, Value);
}
  ...
  )
{
  ...
  Val = MmioRead32 ((0xd4282800ULL) + 0x1B8);
  Val |= (1 << 9);
  MmioWrite32 ((0xd4282800ULL) + 0x1B8, Val);
  gBS->Stall (100);
  ...
  Val = MmioRead32 ((0xd4090000ULL) + 0x104);
  Val |= (1 << 4);
  MmioWrite32 ((0xd4090000ULL) + 0x104, Val);
  gBS->Stall (100);
  ...
  Ret = HdmiWaitStatus ((0xd4282800ULL) + 0x1B8, 1 << 29, 0, 10);
  if ((((RETURN_STATUS)(Ret)) >= 0x8000000000000000ULL)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "clk_set_rate mipi dsi mclk failed: %d\n", Ret); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  ...
  )
{
  ...
  Val = MmioRead32 ((0xd4282800ULL) + 0x3f4);
  Val |= (1 << 0);
  Val |= (1 << 4);
  MmioWrite32 ((0xd4282800ULL) + 0x3f4, Val);

  gBS->Stall (310);

  for (loop = 10000; loop >= 0; --loop) {
    Val = MmioRead32 ((0xd4282800ULL) + 0xf0);
    if (Val & (1 << 15)) {
      break;
    }
  ...
  if (loop < 0) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "power-on HDMI domain error\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    return ((RETURN_STATUS)(0x8000000000000000ULL | (16)));
  }
  ...
  )
{
  ...
  Ret = HdmiPowerOn ();
  if ((((RETURN_STATUS)(Ret)) >= 0x8000000000000000ULL)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "hdmi power on failed: %d", Ret); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    return ((RETURN_STATUS)(0x8000000000000000ULL | (7)));
  }

  Ret = HdmiClockInit ();
  if ((((RETURN_STATUS)(Ret)) >= 0x8000000000000000ULL)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "hdmi clock enable failed: %d", Ret); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    return ((RETURN_STATUS)(0x8000000000000000ULL | (7)));
  }

  Ret = HdmiPhyWaitForHpd (100);
  IsConnected = ((RETURN_STATUS)(0) == Ret);
  if (!IsConnected) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "HDMI cannot get HPD signal\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));

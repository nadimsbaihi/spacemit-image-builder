...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x3a53f6e2, 0x9154, 0x49c1, {0xab, 0x0d, 0xd9, 0x2f, 0xf5, 0xe4, 0xd7, 0x96}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "HdmiGraphicsDxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEmbeddedExternalDeviceProtocolGuid = { 0x735F8C64, 0xD696, 0x44D0, { 0xBD, 0xF2, 0x44, 0x7F, 0xD0, 0x5A, 0x54, 0x06 }};
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT64 _gPcd_FixedAtBuild_PcdSpacemitAPBSpareRegBase = _PCD_VALUE_PcdSpacemitAPBSpareRegBase;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT64 _gPcd_FixedAtBuild_PcdSpacemitHDMIRegBase = _PCD_VALUE_PcdSpacemitHDMIRegBase;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT64 _gPcd_FixedAtBuild_PcdSpacemitHDMIDpuRegBase = _PCD_VALUE_PcdSpacemitHDMIDpuRegBase;

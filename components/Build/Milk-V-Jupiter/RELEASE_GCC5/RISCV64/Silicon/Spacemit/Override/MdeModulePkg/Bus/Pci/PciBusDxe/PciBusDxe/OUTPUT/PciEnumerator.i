# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciEnumerator.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciEnumerator.c"
# 10 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciEnumerator.c"
...
# 11 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciEnumerator.c" 2
# 23 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciEnumerator.c"
EFI_STATUS
PciEnumerator (
  EFI_HANDLE Controller,
  EFI_HANDLE HostBridgeHandle
...
# 114 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciEnumerator.c"
EFI_STATUS
PciRootBridgeEnumerator (
  EFI_PCI_HOST_BRIDGE_RESOURCE_ALLOCATION_PROTOCOL *PciResAlloc,
  PCI_IO_DEVICE *RootBridgeDev
  )
{
  ...
  (ReportProgressCodeEnabled() && ((0x00000001) & 0x000000FF) == 0x00000001) ? ReportStatusCodeWithDevicePath(0x00000001,(0x02000000 | 0x00010000) | (0x1000 | 0x00000000),RootBridgeDev->DevicePath) : (ReportErrorCodeEnabled() && ((0x00000001) & 0x000000FF) == 0x00000002) ? ReportStatusCodeWithDevicePath(0x00000001,(0x02000000 | 0x00010000) | (0x1000 | 0x00000000),RootBridgeDev->DevicePath) : (ReportDebugCodeEnabled() && ((0x00000001) & 0x000000FF) == 0x00000003) ? ReportStatusCodeWithDevicePath(0x00000001,(0x02000000 | 0x00010000) | (0x1000 | 0x00000000),RootBridgeDev->DevicePath) : ((RETURN_STATUS)(0x8000000000000000ULL | (3)))
  ...
  if ((Configuration == ((void *) 0)) || (Configuration->Desc == 0x79)) {
  ...
  for (Configuration1 = Configuration; Configuration1->Desc != 0x79; Configuration1++) {
    Configuration2 = Configuration1;
    for (Configuration3 = Configuration1 + 1; Configuration3->Desc != 0x79; Configuration3++) {
...
# 279 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciEnumerator.c"
void
ProcessOptionRom (
  PCI_IO_DEVICE *Bridge,
  UINT64 RomBase,
...
# 324 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciEnumerator.c"
EFI_STATUS
PciAssignBusNumber (
  PCI_IO_DEVICE *Bridge,
  UINT8 StartBusNumber,
  ...
  *SubBusNumber = StartBusNumber;
  ...
  for (Device = 0; Device <= 31; Device++) {
    ...
    for (Func = 0; Func <= 7; Func++) {
      ...
      if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) &&
          ((((&Pci)->Hdr.HeaderType & 0x7f) == (0x01)) || (((&Pci)->Hdr.HeaderType & 0x7f) == (0x02))))
      {
...
# 472 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciEnumerator.c"
EFI_STATUS
DetermineRootBridgeAttributes (
  EFI_PCI_HOST_BRIDGE_RESOURCE_ALLOCATION_PROTOCOL *PciResAlloc,
  PCI_IO_DEVICE *RootBridgeDev
  )
{
  ...
  if ((Attributes & 1) != 0) {
    RootBridgeDev->Decodes |= 0x0010;
  }

  if ((Attributes & 2) != 0) {
    RootBridgeDev->Decodes |= 0x0020;
    RootBridgeDev->Decodes |= 0x0004;
  }

  RootBridgeDev->Decodes |= 0x0040;
  RootBridgeDev->Decodes |= 0x0002;
  RootBridgeDev->Decodes |= 0x0008;

  return (RETURN_STATUS)(0);
}
# 526 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciEnumerator.c"
UINT32
GetMaxOptionRomSize (
  PCI_IO_DEVICE *Bridge
  )
...
# 587 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciEnumerator.c"
EFI_STATUS
PciHostBridgeDeviceAttribute (
  EFI_PCI_HOST_BRIDGE_RESOURCE_ALLOCATION_PROTOCOL *PciResAlloc
  )
...
# 631 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciEnumerator.c"
void
GetResourceAllocationStatus (
  void *AcpiConfig,
  UINT64 *IoResStatus,
...
# 707 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciEnumerator.c"
EFI_STATUS
RejectPciDevice (
  PCI_IO_DEVICE *PciDevice
  )
{
  ...
  if ( (((&PciDevice->Pci)->Hdr.HeaderType & 0x7f) == (0x01)) &&
       (PciDevice->ResourcePaddingDescriptors != ((void *) 0)))
  {
  ...
  if ((((&PciDevice->Pci)->Hdr.HeaderType & 0x7f) == (0x01)) || (PciDevice->Parent == ((void *) 0))) {
    return ((RETURN_STATUS)(0x8000000000000000ULL | (21)));
  }

  if ((((&PciDevice->Pci)->Hdr.HeaderType & 0x7f) == (0x02))) {



    Bridge = PciDevice;
    while (Bridge->Parent != ((void *) 0)) {
...
# 779 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciEnumerator.c"
BOOLEAN
IsRejectiveDevice (
  PCI_RESOURCE_NODE *PciResNode
  )
{
  ...
  if ((((&Temp->Pci)->Hdr.HeaderType & 0x7f) == (0x01)) || (Temp->Parent == ((void *) 0))) {
    return ((BOOLEAN)(1==1));
  }
  ...
  if ((Temp->Parent != ((void *) 0)) && (Temp->BusNumber == 0)) {
    return ((BOOLEAN)(0==1));
  }
  ...
  if (((((&Temp->Pci)->Hdr.ClassCode[2] == (0x03)) && ((&Temp->Pci)->Hdr.ClassCode[1] == (0x00))) && ((&Temp->Pci)->Hdr.ClassCode[0] == (0x00)))) {
    return ((BOOLEAN)(0==1));
  }

  return ((BOOLEAN)(1==1));
}
# 828 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciEnumerator.c"
PCI_RESOURCE_NODE *
GetLargerConsumerDevice (
  PCI_RESOURCE_NODE *PciResNode1,
  PCI_RESOURCE_NODE *PciResNode2
...
{
  if (PciResNode2 == ((void *) 0)) {
    return PciResNode1;
  }

  if ( ((((&(PciResNode2->PciDev->Pci))->Hdr.HeaderType & 0x7f) == (0x01)) || (PciResNode2->PciDev->Parent == ((void *) 0)))
     && (PciResNode2->ResourceUsage != PciResUsagePadding))
  {
    return PciResNode1;
  }

  if (PciResNode1 == ((void *) 0)) {
    return PciResNode2;
  }
...
# 863 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciEnumerator.c"
PCI_RESOURCE_NODE *
GetMaxResourceConsumerDevice (
  PCI_RESOURCE_NODE *ResPool
  )
{
  ...
  while (CurrentLink != ((void *) 0) && CurrentLink != &ResPool->ChildList) {
    Temp = (((PCI_RESOURCE_NODE *) (void *) ((CHAR8 *) (CurrentLink) - ((UINTN) __builtin_offsetof(PCI_RESOURCE_NODE, Link))))->Signature != ((('p') | ('c' << 8)) | ((('r') | ('c' << 8)) << 16))) ? ((void *) 0) : ((PCI_RESOURCE_NODE *) (void *) ((CHAR8 *) (CurrentLink) - ((UINTN) __builtin_offsetof(PCI_RESOURCE_NODE, Link))));
    ...
    if ( ((((&(Temp->PciDev->Pci))->Hdr.HeaderType & 0x7f) == (0x01)) || (Temp->PciDev->Parent == ((void *) 0)))
...
# 917 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciEnumerator.c"
EFI_STATUS
PciHostBridgeAdjustAllocation (
  PCI_RESOURCE_NODE *IoPool,
  PCI_RESOURCE_NODE *Mem32Pool,
  ...
  )
{
  ...
  AllocationAjusted = ((BOOLEAN)(0==1));

  for (ResType = 0; ResType < 5; ResType++) {
    if (ResStatus[ResType] == 0x0000000000000000ULL) {
      continue;
    }

    if (ResStatus[ResType] == 0xFFFFFFFFFFFFFFFFULL) {
    ...
    if (Status == (RETURN_STATUS)(0)) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "PciBus: [%02x|%02x|%02x] was rejected due to resource confliction.\n", PciResNode->PciDev->BusNumber, PciResNode->PciDev->DeviceNumber, PciResNode->PciDev->FunctionNumber); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
...
# 1059 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciEnumerator.c"
EFI_STATUS
ConstructAcpiResourceRequestor (
  PCI_IO_DEVICE *Bridge,
  PCI_RESOURCE_NODE *IoNode,
...
# 1286 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciEnumerator.c"
void
GetResourceBase (
  void *Config,
  UINT64 *IoBase,
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (Config != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
  ...
  *PMem64Base = 0xFFFFFFFFFFFFFFFFULL;
  ...
  while (*Temp == 0x8A) {
    ...
    if (ResStatus == 0x0000000000000000ULL) {
      switch (Ptr->ResType) {
...
# 1376 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciEnumerator.c"
EFI_STATUS
PciBridgeEnumerator (
  PCI_IO_DEVICE *BridgeDev
  )
...
# 1435 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciEnumerator.c"
EFI_STATUS
PciBridgeResourceAllocator (
  PCI_IO_DEVICE *Bridge
  )
...
# 1591 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciEnumerator.c"
EFI_STATUS
GetResourceBaseFromBridge (
  PCI_IO_DEVICE *Bridge,
  UINT64 *IoBase,
  ...
  )
{
  ...
  *PMem64Base = gAllOne;
  ...
  if ((((&Bridge->Pci)->Hdr.HeaderType & 0x7f) == (0x01))) {
    if (Bridge->PciBar[2].Length > 0) {
      *IoBase = Bridge->PciBar[2].BaseAddress;
    }

    if (Bridge->PciBar[3].Length > 0) {
      *Mem32Base = Bridge->PciBar[3].BaseAddress;
    }

    if (Bridge->PciBar[4].Length > 0) {
      *PMem32Base = Bridge->PciBar[4].BaseAddress;
    }

    if (Bridge->PciBar[5].Length > 0) {
      *PMem64Base = Bridge->PciBar[5].BaseAddress;
    } else {
      *PMem64Base = gAllOne;
    }
  }

  if ((((&Bridge->Pci)->Hdr.HeaderType & 0x7f) == (0x02))) {
    if (Bridge->PciBar[3].Length > 0) {
      *IoBase = Bridge->PciBar[3].BaseAddress;
    } else {
      if (Bridge->PciBar[4].Length > 0) {
        *IoBase = Bridge->PciBar[4].BaseAddress;
      }
    }

    if (Bridge->PciBar[1].Length > 0) {
      if (Bridge->PciBar[1].BarType == PciBarTypePMem32) {
        *PMem32Base = Bridge->PciBar[1].BaseAddress;
      }

      if (Bridge->PciBar[1].BarType == PciBarTypeMem32) {
        *Mem32Base = Bridge->PciBar[1].BaseAddress;
      }
    }

    if (Bridge->PciBar[2].Length > 0) {
      if (Bridge->PciBar[2].BarType == PciBarTypePMem32) {
        *PMem32Base = Bridge->PciBar[2].BaseAddress;
      }

      if (Bridge->PciBar[2].BarType == PciBarTypeMem32) {
        *Mem32Base = Bridge->PciBar[2].BaseAddress;
      }
    }
  }
...
# 1728 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciEnumerator.c"
EFI_STATUS
NotifyPhase (
  EFI_PCI_HOST_BRIDGE_RESOURCE_ALLOCATION_PROTOCOL *PciResAlloc,
  EFI_PCI_HOST_BRIDGE_RESOURCE_ALLOCATION_PHASE Phase
  )
{
  ...
  HostBridgeHandle = ((void *) 0);
  RootBridgeHandle = ((void *) 0);
  if (gPciPlatformProtocol != ((void *) 0)) {
  ...
  } else if (gPciOverrideProtocol != ((void *) 0)) {
...
# 1857 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciEnumerator.c"
EFI_STATUS
PreprocessController (
  PCI_IO_DEVICE *Bridge,
  UINT8 Bus,
...
# 1993 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciEnumerator.c"
EFI_STATUS
  ...
  )
{
  ...
  if ((Controller == ((void *) 0)) || (NumberOfChildren == ((void *) 0))) {
    return ((RETURN_STATUS)(0x8000000000000000ULL | (2)));
  }
  ...
  Bridge = (((PCI_IO_DEVICE *) (void *) ((CHAR8 *) (PciIo) - ((UINTN) __builtin_offsetof(PCI_IO_DEVICE, PciIo))))->Signature != ((('p') | ('c' << 8)) | ((('i') | ('o' << 8)) << 16))) ? ((void *) 0) : ((PCI_IO_DEVICE *) (void *) ((CHAR8 *) (PciIo) - ((UINTN) __builtin_offsetof(PCI_IO_DEVICE, PciIo))));




  Temp = Bridge;
  while (Temp->Parent != ((void *) 0)) {
    Temp = Temp->Parent;
  }
  ...
  if (Operation == EfiPciHotPlugRequestAdd) {
    ...
    (ReportProgressCodeEnabled() && ((0x00000001) & 0x000000FF) == 0x00000001) ? ReportStatusCodeWithDevicePath(0x00000001,((0x02000000 | 0x00010000) | 0x00000006),Temp->DevicePath) : (ReportErrorCodeEnabled() && ((0x00000001) & 0x000000FF) == 0x00000002) ? ReportStatusCodeWithDevicePath(0x00000001,((0x02000000 | 0x00010000) | 0x00000006),Temp->DevicePath) : (ReportDebugCodeEnabled() && ((0x00000001) & 0x000000FF) == 0x00000003) ? ReportStatusCodeWithDevicePath(0x00000001,((0x02000000 | 0x00010000) | 0x00000006),Temp->DevicePath) : ((RETURN_STATUS)(0x8000000000000000ULL | (3)))



       ;

    if (NumberOfChildren != ((void *) 0)) {
      *NumberOfChildren = 0;
    }
...
# 2128 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciEnumerator.c"
BOOLEAN
SearchHostBridgeHandle (
  EFI_HANDLE RootBridgeHandle
  )
...
# 2174 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciEnumerator.c"
EFI_STATUS
AddHostBridgeEnumerator (
  EFI_HANDLE HostBridgeHandle
  )

# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciOptionRomSupport.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciOptionRomSupport.c"
# 9 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciOptionRomSupport.c"
...
# 10 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciOptionRomSupport.c" 2
# 31 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciOptionRomSupport.c"
EFI_STATUS
LocalLoadFile2 (
  PCI_IO_DEVICE *PciIoDevice,
  EFI_DEVICE_PATH_PROTOCOL *FilePath,
  ...
  )
{
  ...
  if ((EfiOpRomImageNode == ((void *) 0)) ||
      (DevicePathType (FilePath) != 0x04) ||
      (DevicePathSubType (FilePath) != 0x08) ||
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (Pcir->Signature == ((('P') | ('C' << 8)) | ((('I') | ('R' << 8)) << 16))); } } while (((BOOLEAN)(0==1)));

  if ((Pcir->CodeType == 0x03) &&
      (EfiRomHeader->EfiSignature == 0x0EF1) &&
      ((EfiRomHeader->EfiSubsystem == 11) ||
       (EfiRomHeader->EfiSubsystem == 12)) &&
      (EfiRomHeader->CompressionType <= 0x0001)
      )
  {
    ...
    if (EfiRomHeader->CompressionType != 0x0001) {



      if ((Buffer == ((void *) 0)) || (*BufferSize < ImageLength)) {
      ...
      *BufferSize = ImageLength;
      ...
      Status = gBS->LocateProtocol (&gEfiDecompressProtocolGuid, ((void *) 0), (void **)&Decompress);
      ...
      if ((Buffer == ((void *) 0)) || (*BufferSize < DestinationSize)) {
...
# 194 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciOptionRomSupport.c"
EFI_STATUS
  ...
  )
{
  ...
  PciIoDevice = (((PCI_IO_DEVICE *) (void *) ((CHAR8 *) (This) - ((UINTN) __builtin_offsetof(PCI_IO_DEVICE, LoadFile2))))->Signature != ((('p') | ('c' << 8)) | ((('i') | ('o' << 8)) << 16))) ? ((void *) 0) : ((PCI_IO_DEVICE *) (void *) ((CHAR8 *) (This) - ((UINTN) __builtin_offsetof(PCI_IO_DEVICE, LoadFile2))));
...
# 230 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciOptionRomSupport.c"
EFI_STATUS
GetOpRomInfo (
  PCI_IO_DEVICE *PciIoDevice
  )
...
# 257 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciOptionRomSupport.c"
  RomBarIndex = 0x30;
  ...
  AllOnes = 0xfffffffe;
  Address = (UINT64) ( (((UINTN) Bus) << 24) | (((UINTN) Device) << 16) | (((UINTN) Function) << 8) | (((UINTN) (RomBarIndex)) < 256 ? ((UINTN) (RomBarIndex)) : (UINT64) (LShiftU64 ((UINT64) (RomBarIndex), 32))));
...
# 319 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciOptionRomSupport.c"
BOOLEAN
ContainEfiImage (
  void *RomImage,
  UINT64 RomSize
  )
{
  ...
  do {
    ...
    if (RomPcir->Signature != ((('P') | ('C' << 8)) | ((('I') | ('R' << 8)) << 16))) {
      break;
    }

    if (RomPcir->CodeType == 0x03) {
      return ((BOOLEAN)(1==1));
    }
...
# 377 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciOptionRomSupport.c"
EFI_STATUS
LoadOpRomImage (
  PCI_IO_DEVICE *PciDevice,
  UINT64 RomBase
  )
{
  ...
  RomInMemory = ((void *) 0);
  CodeType = 0xFF;
# 413 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciOptionRomSupport.c"
  RomBarIndex = 0x30;
  ...
  RomDecode (PciDevice, RomBarIndex, RomBar, ((BOOLEAN)(1==1)));

  RomBarOffset = RomBar;
  RetStatus = ((RETURN_STATUS)(0x8000000000000000ULL | (14)));
  FirstCheck = ((BOOLEAN)(1==1));
  LegacyImageLength = 0;
  ...
  if ((RomImageSize > 0) && (CodeType == 0x00)) {
    RomImageSize = (((RomImageSize) > (LegacyImageLength)) ? (RomImageSize) : (LegacyImageLength));
  }

  if (RomImageSize > 0) {
    RetStatus = (RETURN_STATUS)(0);
    Image = AllocatePool ((UINT32)RomImageSize);
    if (Image == ((void *) 0)) {
      RomDecode (PciDevice, RomBarIndex, RomBar, ((BOOLEAN)(0==1)));
      FreePool (RomHeader);
      FreePool (RomPcir);
      return ((RETURN_STATUS)(0x8000000000000000ULL | (9)));
    }
  ...
  PciDevice->EmbeddedRom = ((BOOLEAN)(1==1));
...
# 581 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciOptionRomSupport.c"
void
RomDecode (
  PCI_IO_DEVICE *PciDevice,
  UINT8 RomBarIndex,
  ...
  )
{
  ...
  if (Enable) {
    ...
    ProgramUpstreamBridgeForRom (PciDevice, RomBar, ((BOOLEAN)(1==1)));




    PciOperateRegister (PciDevice, 0x00000002, 0x04, 3, ((void *) 0));
  } else {



    PciOperateRegister (PciDevice, 0x00000002, 0x04, 4, ((void *) 0));




    ProgramUpstreamBridgeForRom (PciDevice, RomBar, ((BOOLEAN)(0==1)));
...
# 650 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciOptionRomSupport.c"
EFI_STATUS
ProcessOpRomImage (
  PCI_IO_DEVICE *PciDevice
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (((EFI_PCI_EXPANSION_ROM_HEADER *)RomBarOffset)->Signature == 0xaa55); } } while (((BOOLEAN)(0==1)));
  ...
  do {
    ...
    if (EfiRomHeader->EfiSubsystem == 10) {
      goto NextImage;
    }
    ...
    EfiOpRomImageNode.Header.Type = 0x04;
    EfiOpRomImageNode.Header.SubType = 0x08;
    ...
    do { if (((BOOLEAN)(0==1))) { (void) (PciOptionRomImageDevicePath != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
    ...
    if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
      ...
      AddDriver (PciDevice, ((void *) 0), PciOptionRomImageDevicePath);
    } else {
      Status = gBS->StartImage (ImageHandle, ((void *) 0), ((void *) 0));
      if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {



        AddDriver (PciDevice, ImageHandle, ((void *) 0));
        PciRomAddImageMapping (
          ImageHandle,
          PciDevice->PciRootBridgeIo->SegmentNumber,
          PciDevice->BusNumber,

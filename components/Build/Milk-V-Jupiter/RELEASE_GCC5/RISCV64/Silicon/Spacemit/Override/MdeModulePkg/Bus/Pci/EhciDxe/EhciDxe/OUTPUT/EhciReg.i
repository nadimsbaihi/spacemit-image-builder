# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/EhciDxe/EhciReg.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/EhciDxe/EhciReg.c"
# 10 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/EhciDxe/EhciReg.c"
...
# 11 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/EhciDxe/EhciReg.c" 2
# 22 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/EhciDxe/EhciReg.c"
UINT32
EhcReadCapRegister (
  USB2_HC_DEV *Ehc,
  UINT32 Offset
  )
{
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "EhcReadCapRegister: Pci Io read error - %r at %d\n", Status, Offset); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    Data = 0xFFFF;
  }

  return Data;
}
# 58 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/EhciDxe/EhciReg.c"
UINT32
EhcReadDbgRegister (
  const USB2_HC_DEV *Ehc,
  UINT32 Offset
  )
{
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "EhcReadDbgRegister: Pci Io read error - %r at %d\n", Status, Offset); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    Data = 0xFFFF;
  }

  return Data;
}
# 103 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/EhciDxe/EhciReg.c"
BOOLEAN
EhcIsDebugPortInUse (
  const USB2_HC_DEV *Ehc,
  const UINT8 *PortNumber
  )
{
  ...
  if ((PortNumber != ((void *) 0)) && (*PortNumber != Ehc->DebugPortNum - 1)) {
  ...
  return (State & (0x00000400 | 0x40000000)) == (0x00000400 | 0x40000000);
}
# 146 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/EhciDxe/EhciReg.c"
UINT32
EhcReadOpReg (
  USB2_HC_DEV *Ehc,
  UINT32 Offset
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (Ehc->CapLen != 0); } } while (((BOOLEAN)(0==1)));
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "EhcReadOpReg: Pci Io Read error - %r at %d\n", Status, Offset); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    Data = 0xFFFF;
  }

  return Data;
}
# 182 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/EhciDxe/EhciReg.c"
void
EhcWriteOpReg (
  USB2_HC_DEV *Ehc,
  UINT32 Offset,
  ...
  )
{
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "EhcWriteOpReg: Pci Io Write error: %r at %d\n", Status, Offset); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  }
}
# 215 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/EhciDxe/EhciReg.c"
void
EhcSetOpRegBit (
  USB2_HC_DEV *Ehc,
  UINT32 Offset,
...
# 237 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/EhciDxe/EhciReg.c"
void
EhcClearOpRegBit (
  USB2_HC_DEV *Ehc,
  UINT32 Offset,
...
# 265 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/EhciDxe/EhciReg.c"
EFI_STATUS
EhcWaitOpRegBit (
  USB2_HC_DEV *Ehc,
  UINT32 Offset,
  ...
  )
{
  ...
  for (Index = 0; Index < Timeout / (1 * (1000 * 1)) + 1; Index++) {
    if ((((BOOLEAN)(((EhcReadOpReg ((Ehc), (Offset))) & ((Bit))) == ((Bit))))) == WaitToSet) {
...
# 294 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/EhciDxe/EhciReg.c"
void
EhcClearLegacySupport (
  USB2_HC_DEV *Ehc
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "EhcClearLegacySupport: called to clear legacy support\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
...
# 342 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/EhciDxe/EhciReg.c"
EFI_STATUS
EhcSetAndWaitDoorBell (
  USB2_HC_DEV *Ehc,
  UINT32 Timeout
  )
{
  ...
  EhcSetOpRegBit (Ehc, 0x0, 0x40);

  Status = EhcWaitOpRegBit (Ehc, 0x04, 0x20, ((BOOLEAN)(1==1)), Timeout);





  Data = EhcReadOpReg (Ehc, 0x04);
  Data &= ~0x003F;
  Data |= 0x20;

  EhcWriteOpReg (Ehc, 0x04, Data);

  return Status;
}
# 375 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/EhciDxe/EhciReg.c"
void
EhcAckAllInterrupt (
  USB2_HC_DEV *Ehc
  )
{
  EhcWriteOpReg (Ehc, 0x04, 0x003F);
}
# 394 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/EhciDxe/EhciReg.c"
EFI_STATUS
EhcEnablePeriodSchd (
  USB2_HC_DEV *Ehc,
  UINT32 Timeout
  )
{
  ...
  EhcSetOpRegBit (Ehc, 0x0, 0x10);

  Status = EhcWaitOpRegBit (Ehc, 0x04, 0x4000, ((BOOLEAN)(1==1)), Timeout);
  return Status;
}
# 418 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/EhciDxe/EhciReg.c"
EFI_STATUS
EhcEnableAsyncSchd (
  USB2_HC_DEV *Ehc,
  UINT32 Timeout
  )
{
  ...
  EhcSetOpRegBit (Ehc, 0x0, 0x20);

  Status = EhcWaitOpRegBit (Ehc, 0x04, 0x8000, ((BOOLEAN)(1==1)), Timeout);
  return Status;
}
# 441 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/EhciDxe/EhciReg.c"
BOOLEAN
EhcIsHalt (
  USB2_HC_DEV *Ehc
  )
{
  return (((BOOLEAN)(((EhcReadOpReg ((Ehc), (0x04))) & ((0x1000))) == ((0x1000)))));
}
# 458 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/EhciDxe/EhciReg.c"
BOOLEAN
EhcIsSysError (
  USB2_HC_DEV *Ehc
  )
{
  return (((BOOLEAN)(((EhcReadOpReg ((Ehc), (0x04))) & ((0x10))) == ((0x10)))));
}
# 476 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/EhciDxe/EhciReg.c"
EFI_STATUS
EhcResetHC (
  USB2_HC_DEV *Ehc,
  UINT32 Timeout
...
DoReset:
  Val = EhcReadOpReg(Ehc, 0x0);
  EhcWriteOpReg(Ehc, 0x0, (Val & ~0x01) | 0x02);
  ...
  if (Ehc->IsTDI) {
    ...
    Val |= (3 << 0);
    Val &= ~(1 << 2);
    EhcWriteOpReg(Ehc, 0x68, Val);
  }

  return Status;
}
# 531 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/EhciDxe/EhciReg.c"
EFI_STATUS
EhcHaltHC (
  USB2_HC_DEV *Ehc,
  UINT32 Timeout
  )
{
  ...
  EhcClearOpRegBit (Ehc, 0x0, 0x01);
  Status = EhcWaitOpRegBit (Ehc, 0x04, 0x1000, ((BOOLEAN)(1==1)), Timeout);
  return Status;
}
# 554 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/EhciDxe/EhciReg.c"
EFI_STATUS
EhcRunHC (
  USB2_HC_DEV *Ehc,
  UINT32 Timeout
  )
{
  ...
  EhcSetOpRegBit (Ehc, 0x0, 0x01);
  Status = EhcWaitOpRegBit (Ehc, 0x04, 0x1000, ((BOOLEAN)(0==1)), Timeout);
  return Status;
}
# 582 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/EhciDxe/EhciReg.c"
EFI_STATUS
EhcInitHC (
  USB2_HC_DEV *Ehc
  )
{
  ...
  UINT32 Index;
  UINT32 RegVal;
# 600 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/EhciDxe/EhciReg.c"
  ...
  EhcWriteOpReg (Ehc, 0x08, 0);




  RegVal = EhcReadOpReg(Ehc, 0x0);
  RegVal = ~((1 << 7) | 0x40 | (1 << 4) | (1 << 5) | 0x02);
  RegVal |= 0x01;
  EhcWriteOpReg(Ehc, 0x0, RegVal);



  if (Ehc->HcStructParams & 0x10) {
    for (Index = 0; Index < (UINT8)(Ehc->HcStructParams & 0x0F); Index++) {




      RegVal = EhcReadOpReg (Ehc, (UINT32)(0x44 + (4 * Index)));
      RegVal &= ~0x2A;
      RegVal |= 0x1000;
      EhcWriteOpReg (Ehc, (UINT32)(0x44 + (4 * Index)), RegVal);
    }
  }
  ...
  EhcSetOpRegBit (Ehc, 0x40, 0x01);

  Status = EhcEnablePeriodSchd (Ehc, (10 * (1000 * 1)));

  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "EhcInitHC: failed to enable period schedule\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    return Status;
  }

  Status = EhcEnableAsyncSchd (Ehc, (10 * (1000 * 1)));

  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "EhcInitHC: failed to enable async schedule\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    return Status;
  }

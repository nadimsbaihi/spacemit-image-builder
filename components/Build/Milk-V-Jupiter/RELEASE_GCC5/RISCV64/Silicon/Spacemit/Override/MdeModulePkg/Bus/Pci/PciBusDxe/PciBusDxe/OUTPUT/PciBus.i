# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciBus.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciBus.c"
# 16 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciBus.c"
...
# 17 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciBus.c" 2
...
EFI_HANDLE gPciHostBrigeHandles[0x0010];
EFI_INCOMPATIBLE_PCI_DEVICE_SUPPORT_PROTOCOL *gIncompatiblePciDeviceSupport = ((void *) 0);
UINTN gPciHostBridgeNumber = 0;
BOOLEAN gFullEnumeration = ((BOOLEAN)(1==1));
...
# 61 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciBus.c"
EFI_STATUS
...
# 119 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciBus.c"
EFI_STATUS
  ...
  )
{
  ...
  if (RemainingDevicePath != ((void *) 0)) {
    ...
    if (!IsDevicePathEnd (RemainingDevicePath)) {
      ...
      if ((Node.DevPath->Type != 0x01) ||
          (Node.DevPath->SubType != 0x01) ||
...
# 230 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciBus.c"
EFI_STATUS
  ...
  )
{
  ...
  if (_gPcd_FixedAtBuild_PcdPciDisableBusEnumeration) {
    gFullEnumeration = ((BOOLEAN)(0==1));
  } else {
    gFullEnumeration = (BOOLEAN)((SearchHostBridgeHandle (Controller) ? ((BOOLEAN)(0==1)) : ((BOOLEAN)(1==1))));
  }
  ...
  (ReportProgressCodeEnabled() && ((0x00000001) & 0x000000FF) == 0x00000001) ? ReportStatusCodeWithDevicePath(0x00000001,((0x02000000 | 0x00010000) | 0x00000000),ParentDevicePath) : (ReportErrorCodeEnabled() && ((0x00000001) & 0x000000FF) == 0x00000002) ? ReportStatusCodeWithDevicePath(0x00000001,((0x02000000 | 0x00010000) | 0x00000000),ParentDevicePath) : (ReportDebugCodeEnabled() && ((0x00000001) & 0x000000FF) == 0x00000003) ? ReportStatusCodeWithDevicePath(0x00000001,((0x02000000 | 0x00010000) | 0x00000000),ParentDevicePath) : ((RETURN_STATUS)(0x8000000000000000ULL | (3)))
...
# 400 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciBus.c"
EFI_STATUS
  ...
  )
{
  ...
  AllChildrenStopped = ((BOOLEAN)(1==1));
  ...
  for (Index = 0; Index < NumberOfChildren; Index++) {
    ...
    if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
      AllChildrenStopped = ((BOOLEAN)(0==1));
    }
  }

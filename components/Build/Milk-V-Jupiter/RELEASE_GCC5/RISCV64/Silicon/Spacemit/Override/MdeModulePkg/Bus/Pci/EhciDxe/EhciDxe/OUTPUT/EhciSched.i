# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/EhciDxe/EhciSched.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/EhciDxe/EhciSched.c"
# 11 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/EhciDxe/EhciSched.c"
...
# 12 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/EhciDxe/EhciSched.c" 2
# 22 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/EhciDxe/EhciSched.c"
EFI_STATUS
EhcCreateHelpQ (
  USB2_HC_DEV *Ehc
  )
{
  ...
  Qtd = EhcCreateQtd (Ehc, ((void *) 0), ((void *) 0), 0, 0x01, 0, 64);

  if (Qtd == ((void *) 0)) {
    return ((RETURN_STATUS)(0x8000000000000000ULL | (9)));
  }

  Qtd->QtdHw.Status = 0x40;
  ...
  QhHw = &Qh->QhHw;
  QhHw->HorizonLink = ((UINT32) ((((UINT32)(((UINTN)(PciAddr + ((UINTN) __builtin_offsetof(EHC_QH, QhHw)))) & 0XFFFFFFFF)) & 0xFFFFFFE0) | (0x02) | ((((BOOLEAN)(0==1))) ? 1 : 0)));
  QhHw->Status = 0x40;
  QhHw->ReclaimHead = 1;
  Qh->NextQh = Qh;
  Ehc->ReclaimHead = Qh;
...
# 101 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/EhciDxe/EhciSched.c"
EFI_STATUS
EhcInitSched (
  USB2_HC_DEV *Ehc
  )
{
  ...
  EFI_STATUS Status;
  EFI_PHYSICAL_ADDRESS PciAddr;
# 123 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/EhciDxe/EhciSched.c"
  PciIo = Ehc->PciIo;

  Bytes = 4096;
  Pages = (((Bytes) >> 12) + (((Bytes) & 0xFFF) ? 1 : 0));
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) || (Bytes != 4096)) {
  ...
  EhcWriteOpReg (Ehc, 0x14, ((UINT32)(((UINTN)(PhyAddr)) & 0XFFFFFFFF)));



  EhcWriteOpReg (Ehc, 0x10, ((UINT32)(RShiftU64((UINTN)(PhyAddr), 32) & 0XFFFFFFFF)));
  ...
  Ehc->MemPool = UsbHcInitMemPool (
                   PciIo,
                   Ehc->Support64BitDma,
                   ((UINT32)(RShiftU64((UINTN)(PhyAddr), 32) & 0XFFFFFFFF))
                   );

  if (Ehc->MemPool == ((void *) 0)) {
  ...
  Ehc->PeriodFrameHost = AllocateZeroPool (1024 * sizeof (UINTN));
  if (Ehc->PeriodFrameHost == ((void *) 0)) {
    Status = ((RETURN_STATUS)(0x8000000000000000ULL | (9)));
    goto ErrorExit;
  }
  ...
  for (Index = 0; Index < 1024; Index++) {
    ...
    ((UINT32 *)(Ehc->PeriodFrame))[Index] = ((UINT32) ((((UINT32)(((UINTN)(PciAddr)) & 0XFFFFFFFF)) & 0xFFFFFFE0) | (0x02) | ((((BOOLEAN)(0==1))) ? 1 : 0)));
  ...
  EhcWriteOpReg (Ehc, 0x18, ((UINT32)(((UINTN)(PciAddr)) & 0XFFFFFFFF)));
  return (RETURN_STATUS)(0);

ErrorExit:
  if (Ehc->PeriodOne != ((void *) 0)) {
    UsbHcFreeMem (Ehc->MemPool, Ehc->PeriodOne, sizeof (EHC_QH));
    Ehc->PeriodOne = ((void *) 0);
  }

  if (Ehc->ReclaimHead != ((void *) 0)) {
    UsbHcFreeMem (Ehc->MemPool, Ehc->ReclaimHead, sizeof (EHC_QH));
    Ehc->ReclaimHead = ((void *) 0);
  }

  if (Ehc->ShortReadStop != ((void *) 0)) {
    UsbHcFreeMem (Ehc->MemPool, Ehc->ShortReadStop, sizeof (EHC_QTD));
    Ehc->ShortReadStop = ((void *) 0);
  }
  ...
  )
{
  ...
  EhcWriteOpReg (Ehc, 0x14, 0);
  EhcWriteOpReg (Ehc, 0x18, 0);
  ...
  if (Ehc->PeriodFrame != ((void *) 0)) {
    PciIo = Ehc->PciIo;
    do { if (((BOOLEAN)(0==1))) { (void) (PciIo != ((void *) 0)); } } while (((BOOLEAN)(0==1)));

    PciIo->Unmap (PciIo, Ehc->PeriodFrameMap);

    PciIo->FreeBuffer (
             PciIo,
             (((0x00001000) >> 12) + (((0x00001000) & 0xFFF) ? 1 : 0)),
             Ehc->PeriodFrame
             );

    Ehc->PeriodFrame = ((void *) 0);
  }

  if (Ehc->PeriodFrameHost != ((void *) 0)) {
    FreePool (Ehc->PeriodFrameHost);
    Ehc->PeriodFrameHost = ((void *) 0);
  }
}
# 311 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/EhciDxe/EhciSched.c"
void
EhcLinkQhToAsync (
  USB2_HC_DEV *Ehc,
  EHC_QH *Qh
  )
{
  ...
  Qh->QhHw.HorizonLink = ((UINT32) ((((UINT32)(((UINTN)(PciAddr)) & 0XFFFFFFFF)) & 0xFFFFFFE0) | (0x02) | ((((BOOLEAN)(0==1))) ? 1 : 0)));
  PciAddr = UsbHcGetPciAddressForHostMem (Ehc->MemPool, Head->NextQh, sizeof (EHC_QH));
  Head->QhHw.HorizonLink = ((UINT32) ((((UINT32)(((UINTN)(PciAddr)) & 0XFFFFFFFF)) & 0xFFFFFFE0) | (0x02) | ((((BOOLEAN)(0==1))) ? 1 : 0)));
}
# 344 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/EhciDxe/EhciSched.c"
void
EhcUnlinkQhFromAsync (
  USB2_HC_DEV *Ehc,
  EHC_QH *Qh
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (Ehc->ReclaimHead->NextQh == Qh); } } while (((BOOLEAN)(0==1)));
  ...
  Status = EhcSetAndWaitDoorBell (Ehc, (10 * (1000 * 1)));

  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "EhcUnlinkQhFromAsync: Failed to synchronize with doorbell\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  }
}
# 388 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/EhciDxe/EhciSched.c"
void
EhcLinkQhToPeriod (
  USB2_HC_DEV *Ehc,
  EHC_QH *Qh
  )
{
  ...
  for (Index = 0; Index < 1024; Index += Qh->Interval) {




    do { if (((BOOLEAN)(0==1))) { (void) (!(((((UINT32 *)Ehc->PeriodFrame)[Index]) & 0x01) != 0)); } } while (((BOOLEAN)(0==1)));
    Next = (EHC_QH *)((UINTN *)Ehc->PeriodFrameHost)[Index];
    Prev = ((void *) 0);
# 418 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/EhciDxe/EhciSched.c"
    while (Next->Interval > Qh->Interval) {
      Prev = Next;
      Next = Next->NextQh;
    }

    do { if (((BOOLEAN)(0==1))) { (void) (Next != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
# 434 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/EhciDxe/EhciSched.c"
    if (Next == Qh) {
      continue;
    }
    ...
    if (Next->Interval == Qh->Interval) {
      ...
      do { if (((BOOLEAN)(0==1))) { (void) ((Index == 0) && (Qh->NextQh == ((void *) 0))); } } while (((BOOLEAN)(0==1)));
      ...
      PciAddr = UsbHcGetPciAddressForHostMem (Ehc->MemPool, Qh, sizeof (EHC_QH));
      Prev->QhHw.HorizonLink = ((UINT32) ((((UINT32)(((UINTN)(PciAddr)) & 0XFFFFFFFF)) & 0xFFFFFFE0) | (0x02) | ((((BOOLEAN)(0==1))) ? 1 : 0)));
      break;
    }
...
# 489 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/EhciDxe/EhciSched.c"
void
EhcUnlinkQhFromPeriod (
  USB2_HC_DEV *Ehc,
  EHC_QH *Qh
...
# 548 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/EhciDxe/EhciSched.c"
BOOLEAN
EhcCheckUrbResult (
  USB2_HC_DEV *Ehc,
  URB *Urb
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) ((Ehc != ((void *) 0)) && (Urb != ((void *) 0)) && (Urb->Qh != ((void *) 0))); } } while (((BOOLEAN)(0==1)));
  ...
  for(Entry = (&Urb->Qh->Qtds)->ForwardLink; Entry != (&Urb->Qh->Qtds); Entry = Entry->ForwardLink) {
    ...
    if (((BOOLEAN)(((State) & (0x40)) == (0x40)))) {
      ...
      if (((BOOLEAN)(((State) & (0x08)) == (0x08))) && (QtdHw->ErrCnt == 0)) {
        Urb->Result |= 0x40;
      }

      Finished = ((BOOLEAN)(1==1));
      goto ON_EXIT;
    } else if (((BOOLEAN)(((State) & (0x80)) == (0x80)))) {
      ...
      if ((QtdHw->TotalBytes != 0) && (QtdHw->Pid == 0x01)) {
        EhcDumpQh (Urb->Qh, "Short packet read", ((BOOLEAN)(0==1)));
        ...
        if (QtdHw->AltNext == ((UINT32) ((((UINT32)(((UINTN)((PciAddr))) & 0XFFFFFFFF)) & 0xFFFFFFE0) | (0) | (((((BOOLEAN)(0==1)))) ? 1 : 0)))) {
          do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00400000)) { DebugPrint (0x00400000, "EhcCheckUrbResult: Short packet read, break\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));

          Finished = ((BOOLEAN)(1==1));
          goto ON_EXIT;
        }

        do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00400000)) { DebugPrint (0x00400000, "EhcCheckUrbResult: Short packet read, continue\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
      }
    }
  }

ON_EXIT:
# 650 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/EhciDxe/EhciSched.c"
  Urb->DataToggle = (UINT8)Urb->Qh->QhHw.DataToggle;

  return Finished;
}
# 667 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/EhciDxe/EhciSched.c"
EFI_STATUS
EhcExecTransfer (
  USB2_HC_DEV *Ehc,
  URB *Urb,
  ...
  )
{
  ...
  if (!Finished) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00400000)) { DebugPrint (0x00400000, "EhcExecTransfer: transfer not finished in %dms\n", (UINT32)TimeOut); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    EhcDumpQh (Urb->Qh, ((void *) 0), ((BOOLEAN)(0==1)));

    Status = ((RETURN_STATUS)(0x8000000000000000ULL | (18)));
  } else if (Urb->Result != 0x00) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "EhcExecTransfer: transfer failed with %x\n", Urb->Result); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    EhcDumpQh (Urb->Qh, ((void *) 0), ((BOOLEAN)(0==1)));
...
# 732 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/EhciDxe/EhciSched.c"
EFI_STATUS
EhciDelAsyncIntTransfer (
  USB2_HC_DEV *Ehc,
  UINT8 DevAddr,
  ...
  )
{
  ...
  for(Entry = (&Ehc->AsyncIntTransfers)->ForwardLink, Next = Entry->ForwardLink; Entry != (&Ehc->AsyncIntTransfers); Entry = Next, Next = Entry->ForwardLink) {
...
# 818 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/EhciDxe/EhciSched.c"
URB *
EhciInsertAsyncIntTransfer (
  USB2_HC_DEV *Ehc,
  UINT8 DevAddr,
...
# 887 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/EhciDxe/EhciSched.c"
EFI_STATUS
EhcFlushAsyncIntMap (
  USB2_HC_DEV *Ehc,
  URB *Urb
...
# 936 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/EhciDxe/EhciSched.c"
void
...
# 970 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/EhciDxe/EhciSched.c"
      QtdHw = &Qtd->QtdHw;
      QtdHw->Status = 0x80;
      QtdHw->ErrCnt = 3;
      QtdHw->CurPage = 0;
      ...
      QtdHw->Page[0] = ((UINT32)(((UINTN)(PciAddr)) & 0XFFFFFFFF));
      QtdHw->PageHigh[0] = ((UINT32)(RShiftU64((UINTN)(PciAddr), 32) & 0XFFFFFFFF));
    }
    ...
    QhHw = &Urb->Qh->QhHw;
    QhHw->CurQtd = ((UINT32) ((((UINT32)(((UINTN)((0))) & 0XFFFFFFFF)) & 0xFFFFFFE0) | (0) | (((((BOOLEAN)(1==1)))) ? 1 : 0)));
    QhHw->AltQtd = 0;
    ...
    QhHw->NextQtd = ((UINT32) ((((UINT32)(((UINTN)((PciAddr))) & 0XFFFFFFFF)) & 0xFFFFFFE0) | (0) | (((((BOOLEAN)(0==1)))) ? 1 : 0)));
  }

  return;
}
# 1019 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/EhciDxe/EhciSched.c"
void
  ...
  )
{
  ...
  for(Entry = (&Ehc->AsyncIntTransfers)->ForwardLink, Next = Entry->ForwardLink; Entry != (&Ehc->AsyncIntTransfers); Entry = Next, Next = Entry->ForwardLink) {
    ...
    if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "EhcMonitorAsyncRequests: Fail to Flush AsyncInt Mapped Memeory\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    }
    ...
    EhcUpdateAsyncRequest (Ehc, Urb);
# 1095 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/EhciDxe/EhciSched.c"

# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciHostBridgeDxe/PciHostBridge.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciHostBridgeDxe/PciHostBridge.c"
# 10 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciHostBridgeDxe/PciHostBridge.c"
...
# 11 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciHostBridgeDxe/PciHostBridge.c" 2



EFI_CPU_IO2_PROTOCOL *mCpuIo;

 CHAR16 *mAcpiAddressSpaceTypeStr[] = {
  L"Mem", L"I/O", L"Bus"
};
 CHAR16 *mPciResourceTypeStr[] = {
...
# 36 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciHostBridgeDxe/PciHostBridge.c"
UINT64
GetTranslationByResourceType (
  PCI_ROOT_BRIDGE_INSTANCE *RootBridge,
  PCI_RESOURCE_TYPE ResourceType
...
# 94 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciHostBridgeDxe/PciHostBridge.c"
EFI_STATUS
  ...
  )
{
  ...
  IntersectionBase = (((Base) > (Descriptor->BaseAddress)) ? (Base) : (Descriptor->BaseAddress));
  IntersectionEnd = (((Base + Length) < (Descriptor->BaseAddress + Descriptor->Length)) ? (Base + Length) : (Descriptor->BaseAddress + Descriptor->Length))
  ...
  if (Descriptor->GcdIoType == EfiGcdIoTypeNonExistent) {
    ...
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) ? 0x80000000 : 0x00400000)) { DebugPrint ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) ? 0x80000000 : 0x00400000, "%a: %a: add [%Lx, %Lx): %r\n", gEfiCallerBaseName, __func__, IntersectionBase, IntersectionEnd, Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "%a: %a: desc [%Lx, %Lx) type %u conflicts with " "aperture [%Lx, %Lx)\n", gEfiCallerBaseName, __func__, Descriptor->BaseAddress, Descriptor->BaseAddress + Descriptor->Length, (UINT32)Descriptor->GcdIoType, Base, Base + Length); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
# 151 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciHostBridgeDxe/PciHostBridge.c"
      ;
  return ((RETURN_STATUS)(0x8000000000000000ULL | (2)));
}
# 165 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciHostBridgeDxe/PciHostBridge.c"
EFI_STATUS
AddIoSpace (
  UINT64 Base,
  UINT64 Length
  )
{
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "%a: %a: GetIoSpaceMap(): %r\n", gEfiCallerBaseName, __func__, Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
       ...
       CheckBase = Descriptor.BaseAddress + Descriptor.Length)
  {
    ...
    do { if (((BOOLEAN)(0==1))) { (void) (CheckStatus); } } while (((BOOLEAN)(0==1)));
    do { if (((BOOLEAN)(0==1))) { (void) (Descriptor.GcdIoType == EfiGcdIoTypeIo); } } while (((BOOLEAN)(0==1)));
  }
...
# 261 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciHostBridgeDxe/PciHostBridge.c"
EFI_STATUS
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "%a: %a: desc [%Lx, %Lx) type %u cap %Lx conflicts " "with aperture [%Lx, %Lx) cap %Lx\n", gEfiCallerBaseName, __func__, Descriptor->BaseAddress, Descriptor->BaseAddress + Descriptor->Length, (UINT32)Descriptor->GcdMemoryType, Descriptor->Capabilities, Base, Base + Length, Capabilities); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
# 324 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciHostBridgeDxe/PciHostBridge.c"
      ;
  return ((RETURN_STATUS)(0x8000000000000000ULL | (2)));
}
# 339 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciHostBridgeDxe/PciHostBridge.c"
EFI_STATUS
  ...
  )
{
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "%a: %a: GetMemorySpaceMap(): %r\n", gEfiCallerBaseName, __func__, Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
       ...
       CheckBase = Descriptor.BaseAddress + Descriptor.Length)
  {
    ...
    do { if (((BOOLEAN)(0==1))) { (void) (CheckStatus); } } while (((BOOLEAN)(0==1)));
    do { if (((BOOLEAN)(0==1))) { (void) (Descriptor.GcdMemoryType == EfiGcdMemoryTypeMemoryMappedIo); } } while (((BOOLEAN)(0==1)));
    do { if (((BOOLEAN)(0==1))) { (void) ((Descriptor.Capabilities & Capabilities) == Capabilities); } } while (((BOOLEAN)(0==1)));
  }
...
# 410 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciHostBridgeDxe/PciHostBridge.c"
void
  ...
  )
{
  ...
  Status = gBS->LocateProtocol (&gEdkiiIoMmuProtocolGuid, ((void *) 0), (void **)&mIoMmu);
  if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    gBS->CloseEvent (mIoMmuEvent);
  }
}
# 436 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciHostBridgeDxe/PciHostBridge.c"
EFI_STATUS
  ...
  )
{
  ...
  if ((RootBridges == ((void *) 0)) || (RootBridgeCount == 0)) {
  ...
  Status = gBS->LocateProtocol (&gEfiCpuArchProtocolGuid, ((void *) 0), (void**)&mCpu);
  do { if (((BOOLEAN)(0==1))) { (void) (Status); } } while (((BOOLEAN)(0==1)));
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (HostBridge != ((void *) 0)); } } while (((BOOLEAN)(0==1)));

  HostBridge->Signature = ((('p') | ('h' << 8)) | ((('b') | ('g' << 8)) << 16));
  HostBridge->CanRestarted = ((BOOLEAN)(1==1));
  InitializeListHead (&HostBridge->RootBridges);
  ResourceAssigned = ((BOOLEAN)(0==1));
  ...
  for (Index = 0; Index < RootBridgeCount; Index++) {
    ...
    if (Index == 0) {
      ...
      do { if (((BOOLEAN)(0==1))) { (void) (ResourceAssigned == RootBridges[Index].ResourceAssigned); } } while (((BOOLEAN)(0==1)));
    }
    ...
    if (RootBridges[Index].Io.Base <= RootBridges[Index].Io.Limit) {
      ...
      HostAddress = ((RootBridges[Index].Io.Base) - (RootBridges[Index].Io.Translation))
    ...
    for (MemApertureIndex = 0; MemApertureIndex < (sizeof (MemApertures) / sizeof ((MemApertures)[0])); MemApertureIndex++) {
      if (MemApertures[MemApertureIndex]->Base <= MemApertures[MemApertureIndex]->Limit) {
        ...
        HostAddress = ((MemApertures[MemApertureIndex]->Base) - (MemApertures[MemApertureIndex]->Translation))
        ...
        if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
          do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000002)) { DebugPrint (0x00000002, "PciHostBridge driver failed to set EFI_MEMORY_UC to MMIO aperture - %r.\n", Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
        }
  ...
  {
    RootBridge = (((PCI_ROOT_BRIDGE_INSTANCE *) (void *) ((CHAR8 *) (Link) - ((UINTN) __builtin_offsetof(PCI_ROOT_BRIDGE_INSTANCE, Link))))->Signature != ((('_') | ('p' << 8)) | ((('r') | ('b' << 8)) << 16))) ? ((void *) 0) : ((PCI_ROOT_BRIDGE_INSTANCE *) (void *) ((CHAR8 *) (Link) - ((UINTN) __builtin_offsetof(PCI_ROOT_BRIDGE_INSTANCE, Link))));
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (Resources != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "Call PciHostBridgeResourceConflict().\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  PciHostBridgeResourceConflict (HostBridge->Handle, Resources);
  FreePool (Resources);
}
# 759 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciHostBridgeDxe/PciHostBridge.c"
UINT64
AllocateResource (
  BOOLEAN Mmio,
  UINT64 Length,
...
# 779 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciHostBridgeDxe/PciHostBridge.c"
    BaseAddress = ((BaseAddress) + (((LShiftU64 (1, BitsOfAlignment)) - (BaseAddress)) & ((LShiftU64 (1, BitsOfAlignment)) - 1U)));
...
# 827 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciHostBridgeDxe/PciHostBridge.c"
EFI_STATUS
  ...
  )
{
  ...
  HostBridge = (((PCI_HOST_BRIDGE_INSTANCE *) (void *) ((CHAR8 *) (This) - ((UINTN) __builtin_offsetof(PCI_HOST_BRIDGE_INSTANCE, ResAlloc))))->Signature != ((('p') | ('h' << 8)) | ((('b') | ('g' << 8)) << 16))) ? ((void *) 0) : ((PCI_HOST_BRIDGE_INSTANCE *) (void *) ((CHAR8 *) (This) - ((UINTN) __builtin_offsetof(PCI_HOST_BRIDGE_INSTANCE, ResAlloc))));
  ...
  switch (Phase) {
    case EfiPciHostBridgeBeginEnumeration:
           ...
           )
      {
        ...
        for (Index = TypeIo; Index < TypeMax; Index++) {
          ...
          RootBridge->ResourceSubmitted = ((BOOLEAN)(0==1));
        }
      }
    ...
    case EfiPciHostBridgeBeginBusAllocation:
      ...
      HostBridge->CanRestarted = ((BOOLEAN)(0==1));
      break;
    ...
    case EfiPciHostBridgeAllocateResources:
      ...
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "PciHostBridge: NotifyPhase (AllocateResources)\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
      for (Link = GetFirstNode (&HostBridge->RootBridges)
           ; !IsNull (&HostBridge->RootBridges, Link)
           ; Link = GetNextNode (&HostBridge->RootBridges, Link)
           )
      {
        for (Index = TypeIo; Index < TypeBus; Index++) {
          ResNodeHandled[Index] = ((BOOLEAN)(0==1));
        }

        RootBridge = (((PCI_ROOT_BRIDGE_INSTANCE *) (void *) ((CHAR8 *) (Link) - ((UINTN) __builtin_offsetof(PCI_ROOT_BRIDGE_INSTANCE, Link))))->Signature != ((('_') | ('p' << 8)) | ((('r') | ('b' << 8)) << 16))) ? ((void *) 0) : ((PCI_ROOT_BRIDGE_INSTANCE *) (void *) ((CHAR8 *) (Link) - ((UINTN) __builtin_offsetof(PCI_ROOT_BRIDGE_INSTANCE, Link))));
        do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, " RootBridge: %s\n", RootBridge->DevicePathStr); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));

        for (Index1 = TypeIo; Index1 < TypeBus; Index1++) {
          if (RootBridge->ResAllocNode[Index1].Status == ResNone) {
            ResNodeHandled[Index1] = ((BOOLEAN)(1==1));
          } else {
            ...
            do { if (((BOOLEAN)(0==1))) { (void) (Index < TypeMax); } } while (((BOOLEAN)(0==1)));
            ResNodeHandled[Index] = ((BOOLEAN)(1==1));
            Alignment = RootBridge->ResAllocNode[Index].Alignment;
            BitsOfAlignment = LowBitSet64 (Alignment + 1);
            BaseAddress = ((UINT64)0xFFFFFFFFFFFFFFFFULL);
            ...
            if ((Translation & Alignment) != 0) {
              do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "[%a:%d] Translation %lx is not aligned to %lx!\n", __func__, 966, Translation, Alignment); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
                  ...
                  ;
              do { if (((BOOLEAN)(0==1))) { (void) ((Translation & Alignment) == 0); } } while (((BOOLEAN)(0==1)));
              ...
              ReturnStatus = ((RETURN_STATUS)(0x8000000000000000ULL | (9)));
              continue;
            }
            ...
            switch (Index) {
              case TypeIo:
                ...
                BaseAddress = AllocateResource (
                                ...
                                (((15) < (BitsOfAlignment)) ? (15) : (BitsOfAlignment)),
                                ((((RootBridge->Io.Base) + (((Alignment + 1) - (RootBridge->Io.Base)) & ((Alignment + 1) - 1U)))) - (RootBridge->Io.Translation))
              ...
              case TypeMem64:
                BaseAddress = AllocateResource (
                                ((BOOLEAN)(1==1)),
                                RootBridge->ResAllocNode[Index].Length,
                                (((63) < (BitsOfAlignment)) ? (63) : (BitsOfAlignment)),
                                ((((RootBridge->MemAbove4G.Base) + (((Alignment + 1) - (RootBridge->MemAbove4G.Base)) & ((Alignment + 1) - 1U)))) - (RootBridge->MemAbove4G.Translation))
                ...
                if (BaseAddress != ((UINT64)0xFFFFFFFFFFFFFFFFULL)) {
                  break;
                }
              ...
              case TypeMem32:
                BaseAddress = AllocateResource (
                                ((BOOLEAN)(1==1)),
                                RootBridge->ResAllocNode[Index].Length,
                                (((31) < (BitsOfAlignment)) ? (31) : (BitsOfAlignment)),
                                ((((RootBridge->Mem.Base) + (((Alignment + 1) - (RootBridge->Mem.Base)) & ((Alignment + 1) - 1U)))) - (RootBridge->Mem.Translation))
              ...
              case TypePMem64:
                BaseAddress = AllocateResource (
                                ...
                                RootBridge->ResAllocNode[Index].Length,
                                (((63) < (BitsOfAlignment)) ? (63) : (BitsOfAlignment)),
                                ((((RootBridge->PMemAbove4G.Base) + (((Alignment + 1) - (RootBridge->PMemAbove4G.Base)) & ((Alignment + 1) - 1U)))) - (RootBridge->PMemAbove4G.Translation))
              ...
              case TypePMem32:
                BaseAddress = AllocateResource (
                                ...
                                RootBridge->ResAllocNode[Index].Length,
                                (((31) < (BitsOfAlignment)) ? (31) : (BitsOfAlignment)),
                                ((((RootBridge->PMem.Base) + (((Alignment + 1) - (RootBridge->PMem.Base)) & ((Alignment + 1) - 1U)))) - (RootBridge->PMem.Translation))
            ...
            do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "  %s: Base/Length/Alignment = %lx/%lx/%lx - ", mPciResourceTypeStr[Index], BaseAddress, RootBridge->ResAllocNode[Index].Length, Alignment); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
            ...
            if (BaseAddress != ((UINT64)0xFFFFFFFFFFFFFFFFULL)) {
              ...
              do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Success\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
            } else {
              ReturnStatus = ((RETURN_STATUS)(0x8000000000000000ULL | (9)));
              do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "Out Of Resource!\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
            }
          }
        }
      }

      if (ReturnStatus == ((RETURN_STATUS)(0x8000000000000000ULL | (9)))) {
...
# 1219 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciHostBridgeDxe/PciHostBridge.c"
EFI_STATUS
  ...
  )
{
  ...
  if (RootBridgeHandle == ((void *) 0)) {
    return ((RETURN_STATUS)(0x8000000000000000ULL | (2)));
  }

  HostBridge = (((PCI_HOST_BRIDGE_INSTANCE *) (void *) ((CHAR8 *) (This) - ((UINTN) __builtin_offsetof(PCI_HOST_BRIDGE_INSTANCE, ResAlloc))))->Signature != ((('p') | ('h' << 8)) | ((('b') | ('g' << 8)) << 16))) ? ((void *) 0) : ((PCI_HOST_BRIDGE_INSTANCE *) (void *) ((CHAR8 *) (This) - ((UINTN) __builtin_offsetof(PCI_HOST_BRIDGE_INSTANCE, ResAlloc))));
  ReturnNext = (BOOLEAN)(*RootBridgeHandle == ((void *) 0));
  ...
  if (ReturnNext) {
    do { if (((BOOLEAN)(0==1))) { (void) (IsNull (&HostBridge->RootBridges, Link)); } } while (((BOOLEAN)(0==1)));
    return ((RETURN_STATUS)(0x8000000000000000ULL | (14)));
  } else {
    return ((RETURN_STATUS)(0x8000000000000000ULL | (2)));
  }
}
# 1276 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciHostBridgeDxe/PciHostBridge.c"
EFI_STATUS
...
# 1322 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciHostBridgeDxe/PciHostBridge.c"
EFI_STATUS
...
# 1389 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciHostBridgeDxe/PciHostBridge.c"
EFI_STATUS
...
# 1465 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciHostBridgeDxe/PciHostBridge.c"
EFI_STATUS
  ...
  )
{
       ...
       )
  {
    RootBridge = (((PCI_ROOT_BRIDGE_INSTANCE *) (void *) ((CHAR8 *) (Link) - ((UINTN) __builtin_offsetof(PCI_ROOT_BRIDGE_INSTANCE, Link))))->Signature != ((('_') | ('p' << 8)) | ((('r') | ('b' << 8)) << 16))) ? ((void *) 0) : ((PCI_ROOT_BRIDGE_INSTANCE *) (void *) ((CHAR8 *) (Link) - ((UINTN) __builtin_offsetof(PCI_ROOT_BRIDGE_INSTANCE, Link))));
    if (RootBridgeHandle == RootBridge->Handle) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "PciHostBridge: SubmitResources for %s\n", RootBridge->DevicePathStr); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));





      for (Descriptor = (EFI_ACPI_ADDRESS_SPACE_DESCRIPTOR *)Configuration; Descriptor->Desc == 0x8A; Descriptor++) {
        if (Descriptor->ResType > 0x02) {
          return ((RETURN_STATUS)(0x8000000000000000ULL | (2)));
        }

        do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, " %s: Granularity/SpecificFlag = %ld / %02x%s\n", mAcpiAddressSpaceTypeStr[Descriptor->ResType], Descriptor->AddrSpaceGranularity, Descriptor->SpecificFlag, (Descriptor->SpecificFlag & (3 << 1)) != 0 ? L" (Prefetchable)" : L""); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
            ...
            ;
        do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "      Length/Alignment = 0x%lx / 0x%lx\n", Descriptor->AddrLen, Descriptor->AddrRangeMax); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
        switch (Descriptor->ResType) {
          case 0x00:
            ...
            if ((Descriptor->AddrSpaceGranularity == 32) && (Descriptor->AddrLen >= 0x0000000100000000ULL)) {
              return ((RETURN_STATUS)(0x8000000000000000ULL | (2)));
            }
            ...
            if (((RootBridge->AllocationAttributes & 1) != 0) &&
                ((Descriptor->SpecificFlag & (3 << 1)) != 0)
                )
            {
              return ((RETURN_STATUS)(0x8000000000000000ULL | (2)));
            }
      ...
      for (Descriptor = (EFI_ACPI_ADDRESS_SPACE_DESCRIPTOR *)Configuration; Descriptor->Desc == 0x8A; Descriptor++) {
        if (Descriptor->ResType == 0x00) {
          if (Descriptor->AddrSpaceGranularity == 32) {
            if ((Descriptor->SpecificFlag & (3 << 1)) != 0) {
              Type = TypePMem32;
            } else {
              Type = TypeMem32;
            }
          } else {
            do { if (((BOOLEAN)(0==1))) { (void) (Descriptor->AddrSpaceGranularity == 64); } } while (((BOOLEAN)(0==1)));
            if ((Descriptor->SpecificFlag & (3 << 1)) != 0) {
              Type = TypePMem64;
            } else {
              Type = TypeMem64;
          ...
          do { if (((BOOLEAN)(0==1))) { (void) (Descriptor->ResType == 0x01); } } while (((BOOLEAN)(0==1)));
          Type = TypeIo;
        }
      ...
      RootBridge->ResourceSubmitted = ((BOOLEAN)(1==1));
      return (RETURN_STATUS)(0);
    }
  }
...
# 1604 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciHostBridgeDxe/PciHostBridge.c"
EFI_STATUS
    ...
    if (RootBridgeHandle == RootBridge->Handle) {
      ...
      for (Index = 0; Index < TypeBus; Index++) {
        ...
        if (ResStatus != ResNone) {
          ...
          Descriptor->AddrRangeMin = ((RootBridge->ResAllocNode[Index].Base) + (GetTranslationByResourceType (RootBridge, Index)))


                                        ;
          Descriptor->AddrRangeMax = 0;
          Descriptor->AddrTranslationOffset = (ResStatus == ResAllocated) ? 0x0000000000000000ULL : 0xFFFFFFFFFFFFFFFEULL;
...
# 1713 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciHostBridgeDxe/PciHostBridge.c"
EFI_STATUS

# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciCommand.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciCommand.c"
# 9 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciCommand.c"
...
# 10 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciCommand.c" 2
# 23 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciCommand.c"
EFI_STATUS
PciOperateRegister (
  PCI_IO_DEVICE *PciIoDevice,
  UINT16 Command,
...
# 80 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciCommand.c"
BOOLEAN
PciCapabilitySupport (
  PCI_IO_DEVICE *PciIoDevice
  )
{
  if ((PciIoDevice->Pci.Hdr.Status & 0x00000010) != 0) {
    return ((BOOLEAN)(1==1));
  }

  return ((BOOLEAN)(0==1));
}
# 105 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciCommand.c"
EFI_STATUS
LocateCapabilityRegBlock (
  PCI_IO_DEVICE *PciIoDevice,
  UINT8 CapId,
...
# 194 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciCommand.c"
EFI_STATUS
LocatePciExpressCapabilityRegBlock (
  PCI_IO_DEVICE *PciIoDevice,
  UINT16 CapId,
  ...
  )
{
  ...
  while (CapabilityPtr != 0) {
    ...
    if (CapabilityEntry == ((UINT32)0xFFFFFFFF)) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000002)) { DebugPrint (0x00000002, "%a: [%02x|%02x|%02x] failed to access config space at offset 0x%x\n", __func__, PciIoDevice->BusNumber, PciIoDevice->DeviceNumber, PciIoDevice->FunctionNumber, CapabilityPtr); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))

# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/NonDiscoverablePciDeviceDxe/NonDiscoverablePciDeviceDxe.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/NonDiscoverablePciDeviceDxe/NonDiscoverablePciDeviceDxe.c"
# 9 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/NonDiscoverablePciDeviceDxe/NonDiscoverablePciDeviceDxe.c"
...
# 10 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/NonDiscoverablePciDeviceDxe/NonDiscoverablePciDeviceDxe.c" 2
...
# 62 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/NonDiscoverablePciDeviceDxe/NonDiscoverablePciDeviceDxe.c"
static
EFI_STATUS
  ...
  )
{
  ...
  for (Idx = 0; Idx < (sizeof (SupportedNonDiscoverableDevices) / sizeof ((SupportedNonDiscoverableDevices)[0])); Idx++) {
  ...
  for (Desc = Device->Resources; Desc->Desc != 0x79;
...
# 139 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/NonDiscoverablePciDeviceDxe/NonDiscoverablePciDeviceDxe.c"
static
EFI_STATUS
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (mUniqueIdCounter < (32 * 256)); } } while (((BOOLEAN)(0==1)));
  if (mUniqueIdCounter >= (32 * 256)) {
...
# 220 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/NonDiscoverablePciDeviceDxe/NonDiscoverablePciDeviceDxe.c"
static
EFI_STATUS
  ...
  )
{
  ...
  Dev = (((NON_DISCOVERABLE_PCI_DEVICE *) (void *) ((CHAR8 *) (PciIo) - ((UINTN) __builtin_offsetof(NON_DISCOVERABLE_PCI_DEVICE, PciIo))))->Signature != ((('P') | ('P' << 8)) | ((('I') | ('D' << 8)) << 16))) ? ((void *) 0) : ((NON_DISCOVERABLE_PCI_DEVICE *) (void *) ((CHAR8 *) (PciIo) - ((UINTN) __builtin_offsetof(NON_DISCOVERABLE_PCI_DEVICE, PciIo))));
...
# 296 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/NonDiscoverablePciDeviceDxe/NonDiscoverablePciDeviceDxe.c"
EFI_STATUS

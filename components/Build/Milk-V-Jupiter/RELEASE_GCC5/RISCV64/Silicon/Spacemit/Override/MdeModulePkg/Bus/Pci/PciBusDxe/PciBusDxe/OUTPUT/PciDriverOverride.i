# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciDriverOverride.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciDriverOverride.c"
# 9 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciDriverOverride.c"
...
# 10 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciDriverOverride.c" 2
...
# 32 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciDriverOverride.c"
EFI_HANDLE
LocateImageHandle (
...
# 94 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciDriverOverride.c"
EFI_STATUS
  ...
  )
{
  ...
  Override = ((void *) 0);
  PciIoDevice = (((PCI_IO_DEVICE *) (void *) ((CHAR8 *) (This) - ((UINTN) __builtin_offsetof(PCI_IO_DEVICE, PciDriverOverride))))->Signature != ((('p') | ('c' << 8)) | ((('i') | ('o' << 8)) << 16))) ? ((void *) 0) : ((PCI_IO_DEVICE *) (void *) ((CHAR8 *) (This) - ((UINTN) __builtin_offsetof(PCI_IO_DEVICE, PciDriverOverride))));
  ReturnNext = (BOOLEAN)(*DriverImageHandle == ((void *) 0));
  ...
  {
    Override = (((PCI_DRIVER_OVERRIDE_LIST *) (void *) ((CHAR8 *) (Link) - ((UINTN) __builtin_offsetof(PCI_DRIVER_OVERRIDE_LIST, Link))))->Signature != ((('d') | ('r' << 8)) | ((('o') | ('v' << 8)) << 16))) ? ((void *) 0) : ((PCI_DRIVER_OVERRIDE_LIST *) (void *) ((CHAR8 *) (Link) - ((UINTN) __builtin_offsetof(PCI_DRIVER_OVERRIDE_LIST, Link))));

    if (ReturnNext) {
      if (Override->DriverImageHandle == ((void *) 0)) {
    ...
    if (*DriverImageHandle == Override->DriverImageHandle) {
      ReturnNext = ((BOOLEAN)(1==1));
    }
  }

  do { if (((BOOLEAN)(0==1))) { (void) (IsNull (&PciIoDevice->OptionRomDriverList, Link)); } } while (((BOOLEAN)(0==1)));
...
# 162 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciDriverOverride.c"
EFI_STATUS
AddDriver (
  PCI_IO_DEVICE *PciIoDevice,
  EFI_HANDLE DriverImageHandle,
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) ((DriverImageHandle == ((void *) 0)) || (DriverImagePath == ((void *) 0))); } } while (((BOOLEAN)(0==1)));

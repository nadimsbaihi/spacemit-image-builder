# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciLib.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciLib.c"
# 10 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciLib.c"
...
# 11 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciLib.c" 2
...
# 36 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciLib.c"
UINT16
PciGetMaxBusNumber (
  PCI_IO_DEVICE *Bridge
  )
{
  ...
  RootBridge = Bridge;
  while (RootBridge->Parent != ((void *) 0)) {
  ...
  while (BusNumberRanges->Desc != 0x79) {
  ...
  )
{
  ...
  if (!_gPcd_FixedAtBuild_PcdPciBusHotplugDeviceSupport) {
    return;
  }
  ...
  if (!gFullEnumeration) {
    ...
    (PciIoDevice->PciBar)[1].BaseAddress = (UINT64)(Address);
    (PciIoDevice->PciBar)[1].Length = 0x2000000;
    (PciIoDevice->PciBar)[1].BarType = PciBarTypeMem32;
    ...
    (PciIoDevice->PciBar)[2].BaseAddress = (UINT64)(Address);
    (PciIoDevice->PciBar)[2].Length = 0x2000000;
    (PciIoDevice->PciBar)[2].BarType = PciBarTypePMem32;
    ...
    (PciIoDevice->PciBar)[3].BaseAddress = (UINT64)(Address);
    (PciIoDevice->PciBar)[3].Length = 0x100;
    (PciIoDevice->PciBar)[3].BarType = PciBarTypeIo16;
    ...
    (PciIoDevice->PciBar)[4].BaseAddress = (UINT64)(Address);
    (PciIoDevice->PciBar)[4].Length = 0x100;
    (PciIoDevice->PciBar)[4].BarType = PciBarTypeIo16;
  }

  if ((gPciHotPlugInit != ((void *) 0)) && _gPcd_FixedAtBuild_PcdPciBusHotplugDeviceSupport) {
    GetResourcePaddingForHpb (PciIoDevice);
  }
}
# 150 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciLib.c"
void
RemoveRejectedPciDevices (
  EFI_HANDLE RootBridgeHandle,
  PCI_IO_DEVICE *Bridge
  )
{
  ...
  while (CurrentLink != ((void *) 0) && CurrentLink != &Bridge->ChildList) {
    ...
    if ((((&Temp->Pci)->Hdr.HeaderType & 0x7f) == (0x01))) {
...
void
DumpBridgeResource (
  PCI_RESOURCE_NODE *BridgeResource
  )
{
  LIST_ENTRY *Link;
  ...
  if ((BridgeResource != ((void *) 0)) && (BridgeResource->Length != 0)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Type = %s; Base = 0x%lx;\tLength = 0x%lx;\tAlignment = 0x%lx\n", mBarTypeStr[(((BridgeResource->ResType) < (PciBarTypeMaxType)) ? (BridgeResource->ResType) : (PciBarTypeMaxType))], BridgeResource->PciDev->PciBar[BridgeResource->Bar].BaseAddress, BridgeResource->Length, BridgeResource->Alignment); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
    ...
    {
      Resource = (((PCI_RESOURCE_NODE *) (void *) ((CHAR8 *) (Link) - ((UINTN) __builtin_offsetof(PCI_RESOURCE_NODE, Link))))->Signature != ((('p') | ('c' << 8)) | ((('r') | ('c' << 8)) << 16))) ? ((void *) 0) : ((PCI_RESOURCE_NODE *) (void *) ((CHAR8 *) (Link) - ((UINTN) __builtin_offsetof(PCI_RESOURCE_NODE, Link))));
      if (Resource->ResourceUsage == PciResUsageTypical) {
        Bar = Resource->Virtual ? Resource->PciDev->VfPciBar : Resource->PciDev->PciBar;
        do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "   Base = 0x%lx;\tLength = 0x%lx;\tAlignment = 0x%lx;\tOwner = %s [%02x|%02x|%02x:", Bar[Resource->Bar].BaseAddress, Resource->Length, Resource->Alignment, (((&Resource->PciDev->Pci)->Hdr.HeaderType & 0x7f) == (0x01)) ? L"PPB" : (((&Resource->PciDev->Pci)->Hdr.HeaderType & 0x7f) == (0x02)) ? L"P2C" : L"PCI", Resource->PciDev->BusNumber, Resource->PciDev->DeviceNumber, Resource->PciDev->FunctionNumber); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
# 244 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciLib.c"
            ;

        if ((!(((&Resource->PciDev->Pci)->Hdr.HeaderType & 0x7f) == (0x01)) && !(((&Resource->PciDev->Pci)->Hdr.HeaderType & 0x7f) == (0x02))) ||
            ((((&Resource->PciDev->Pci)->Hdr.HeaderType & 0x7f) == (0x01)) && (Resource->Bar < 2)) ||
            ((((&Resource->PciDev->Pci)->Hdr.HeaderType & 0x7f) == (0x02)) && (Resource->Bar < 1))
            )
        {



          do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "%02x]", Bar[Resource->Bar].Offset); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
        } else {



          do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "**]"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
        }
      } else {
        do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "   Base = Padding;\tLength = 0x%lx;\tAlignment = 0x%lx", Resource->Length, Resource->Alignment); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
      }

      if (BridgeResource->ResType != Resource->ResType) {
        do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "; Type = %s", mBarTypeStr[(((Resource->ResType) < (PciBarTypeMaxType)) ? (Resource->ResType) : (PciBarTypeMaxType))]); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
      }
...
# 283 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciLib.c"
UINTN
FindResourceNode (
...
# 320 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciLib.c"
void
DumpResourceMap (
  PCI_IO_DEVICE *Bridge,
  PCI_RESOURCE_NODE **Resources,
  UINTN ResourceCount
  )
{
  EFI_STATUS Status;
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "PciBus: Resource Map for "); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Bridge [%02x|%02x|%02x]\n", Bridge->BusNumber, Bridge->DeviceNumber, Bridge->FunctionNumber); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
    ...
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Root Bridge %s\n", Str != ((void *) 0) ? Str : L""); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    if (Str != ((void *) 0)) {
      FreePool (Str);
    }
  }
  ...
  {
    Device = (((PCI_IO_DEVICE *) (void *) ((CHAR8 *) (Link) - ((UINTN) __builtin_offsetof(PCI_IO_DEVICE, Link))))->Signature != ((('p') | ('c' << 8)) | ((('i') | ('o' << 8)) << 16))) ? ((void *) 0) : ((PCI_IO_DEVICE *) (void *) ((CHAR8 *) (Link) - ((UINTN) __builtin_offsetof(PCI_IO_DEVICE, Link))));
    if ((((&Device->Pci)->Hdr.HeaderType & 0x7f) == (0x01))) {
      ChildResourceCount = 0;
      for (Index = 0; Index < ResourceCount; Index++) {
        ChildResourceCount += FindResourceNode (Device, Resources[Index], ((void *) 0));
      }

      ChildResources = AllocatePool (sizeof (PCI_RESOURCE_NODE *) * ChildResourceCount);
      do { if (((BOOLEAN)(0==1))) { (void) (ChildResources != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
      ChildResourceCount = 0;
      for (Index = 0; Index < ResourceCount; Index++) {
...
# 404 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciLib.c"
BOOLEAN
  ...
  )
{
  ...
  while (CurrentLink != ((void *) 0) && CurrentLink != &RootBridgeDev->ChildList) {
    PciIoDevice = (((PCI_IO_DEVICE *) (void *) ((CHAR8 *) (CurrentLink) - ((UINTN) __builtin_offsetof(PCI_IO_DEVICE, Link))))->Signature != ((('p') | ('c' << 8)) | ((('i') | ('o' << 8)) << 16))) ? ((void *) 0) : ((PCI_IO_DEVICE *) (void *) ((CHAR8 *) (CurrentLink) - ((UINTN) __builtin_offsetof(PCI_IO_DEVICE, Link))));

    if ((((&PciIoDevice->Pci)->Hdr.HeaderType & 0x7f) == (0x01))) {
      if (AdjustPciDeviceBarSize (PciIoDevice)) {
        Adjusted = ((BOOLEAN)(1==1));
      }
    } else {
      if (PciIoDevice->ResizableBarOffset != 0) {
        do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "PciBus: [%02x|%02x|%02x] Adjust Pci Device Bar Size\n", PciIoDevice->BusNumber, PciIoDevice->DeviceNumber, PciIoDevice->FunctionNumber); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
...
# 468 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciLib.c"
EFI_STATUS
PciHostBridgeResourceAllocator (
  EFI_PCI_HOST_BRIDGE_RESOURCE_ALLOCATION_PROTOCOL *PciResAlloc
  )
{
  ...
  ResizableBarNeedAdjust = _gPcd_FixedAtBuild_PcdPcieResizableBarSupport;
  ...
  while (((BOOLEAN)(1==1))) {
    ...
    RootBridgeDev = ((void *) 0);
    RootBridgeHandle = 0;

    while (PciResAlloc->GetNextRootBridge (PciResAlloc, &RootBridgeHandle) == (RETURN_STATUS)(0)) {
...
# 540 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciLib.c"
      IoBridge = CreateResourceNode (
                   RootBridgeDev,
                   0,
                   _gPcd_FixedAtBuild_PcdPciBridgeIoAlignmentProbe ? 0x1FF : 0xFFF,
                   1,
                   PciBarTypeIo16,
                   PciResUsageTypical
                   );
      ...
      if (Status == (RETURN_STATUS)(0)) {
        ...
        do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "PciBus: HostBridge->SubmitResources() - %r\n", Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    ...
    do { if (((BOOLEAN)(0==1))) { (void) (RootBridgeDev != ((void *) 0)); } } while (((BOOLEAN)(0==1)));




    Status = NotifyPhase (PciResAlloc, EfiPciHostBridgeAllocateResources);
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "PciBus: HostBridge->NotifyPhase(AllocateResources) - %r\n", Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    if (!_gPcd_FixedAtBuild_PcdPciBusHotplugDeviceSupport) {
      ...
      IoResStatus = 0x0000000000000000ULL;
      Mem32ResStatus = 0x0000000000000000ULL;
      PMem32ResStatus = 0x0000000000000000ULL;
      Mem64ResStatus = 0x0000000000000000ULL;
      PMem64ResStatus = 0x0000000000000000ULL;
...
# 778 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciLib.c"
      ZeroMem (&AllocFailExtendedData, sizeof (AllocFailExtendedData));

      (ReportProgressCodeEnabled() && ((0x00000001) & 0x000000FF) == 0x00000001) ? ReportStatusCodeWithExtendedData(0x00000001,(0x02000000 | 0x00010000) | 0x00000009,(void *)&AllocFailExtendedData,sizeof (AllocFailExtendedData)) : (ReportErrorCodeEnabled() && ((0x00000001) & 0x000000FF) == 0x00000002) ? ReportStatusCodeWithExtendedData(0x00000001,(0x02000000 | 0x00010000) | 0x00000009,(void *)&AllocFailExtendedData,sizeof (AllocFailExtendedData)) : (ReportDebugCodeEnabled() && ((0x00000001) & 0x000000FF) == 0x00000003) ? ReportStatusCodeWithExtendedData(0x00000001,(0x02000000 | 0x00010000) | 0x00000009,(void *)&AllocFailExtendedData,sizeof (AllocFailExtendedData)) : ((RETURN_STATUS)(0x8000000000000000ULL | (3)))
...
# 837 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciLib.c"
  (ReportProgressCodeEnabled() && ((0x00000001) & 0x000000FF) == 0x00000001) ? ReportStatusCodeWithExtendedData(0x00000001,(0x02000000 | 0x00010000) | (0x1000 | 0x00000001),(void *)&HandleExtendedData,sizeof (HandleExtendedData)) : (ReportErrorCodeEnabled() && ((0x00000001) & 0x000000FF) == 0x00000002) ? ReportStatusCodeWithExtendedData(0x00000001,(0x02000000 | 0x00010000) | (0x1000 | 0x00000001),(void *)&HandleExtendedData,sizeof (HandleExtendedData)) : (ReportDebugCodeEnabled() && ((0x00000001) & 0x000000FF) == 0x00000003) ? ReportStatusCodeWithExtendedData(0x00000001,(0x02000000 | 0x00010000) | (0x1000 | 0x00000001),(void *)&HandleExtendedData,sizeof (HandleExtendedData)) : ((RETURN_STATUS)(0x8000000000000000ULL | (3)))
  ...
  while (PciResAlloc->GetNextRootBridge (PciResAlloc, &RootBridgeHandle) == (RETURN_STATUS)(0)) {
    ...
    do { if (((BOOLEAN)(0==1))) { (void) (IoBridge != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
    do { if (((BOOLEAN)(0==1))) { (void) (Mem32Bridge != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
    do { if (((BOOLEAN)(0==1))) { (void) (PMem32Bridge != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
    do { if (((BOOLEAN)(0==1))) { (void) (Mem64Bridge != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
    do { if (((BOOLEAN)(0==1))) { (void) (PMem64Bridge != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
...
# 958 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciLib.c"
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Process Option ROM: BAR Base/Length = %lx/%lx\n", RootBridgeDev->PciBar[0].BaseAddress, RootBridgeDev->PciBar[0].Length); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
    ...
    do { if (DebugCodeEnabled ()) { do { } while (((BOOLEAN)(0==1))); PCI_RESOURCE_NODE *Resources[5]; Resources[0] = IoBridge; Resources[1] = Mem32Bridge; Resources[2] = PMem32Bridge; Resources[3] = Mem64Bridge; Resources[4] = PMem64Bridge; DumpResourceMap (RootBridgeDev, Resources, (sizeof (Resources) / sizeof ((Resources)[0]))); } } while (((BOOLEAN)(0==1)))
...
# 1018 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciLib.c"
EFI_STATUS
PciAllocateBusNumber (
  PCI_IO_DEVICE *Bridge,
  UINT8 StartBusNumber,
...
# 1074 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciLib.c"
BOOLEAN
PciScanOnlyDevice0 (
  PCI_IO_DEVICE *Bridge
  )
{
  ...
  if (Bridge->IsPciExp && (Bridge->PciExpDevicePortType == 4 ||
                           Bridge->PciExpDevicePortType == 6 ||
                           Bridge->PciExpDevicePortType == 8)) {
    return ((BOOLEAN)(1==1));
  }

  return ((BOOLEAN)(0==1));
}
# 1113 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciLib.c"
EFI_STATUS
PciScanBus (
  PCI_IO_DEVICE *Bridge,
  UINT8 StartBusNumber,
  ...
  )
{
  ...
  BusRange = 0;
  BusPadding = ((BOOLEAN)(0==1));
  PciDevice = ((void *) 0);
  PciAddress = 0;
  IsAriEnabled = ((BOOLEAN)(0==1));
  ...
  for (Device = 0; Device <= 31; Device++) {
    ...
    for (Func = 0; Func <= 7; Func++) {
      ...
      if (((Device == 0) && (Func == 0)) && (PciDevice->IsAriEnabled)) {
        IsAriEnabled = ((BOOLEAN)(1==1));
      }

      if (PciDevice->IsAriEnabled != IsAriEnabled) {
        do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "ERROR: %02x:%02x:%02x device ARI Feature(%x) is not consistent with others Function\n", StartBusNumber, Device, Func, PciDevice->IsAriEnabled); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
      ...
      PciAddress = (UINT64) ( (((UINTN) StartBusNumber) << 24) | (((UINTN) Device) << 16) | (((UINTN) Func) << 8) | (((UINTN) (0)) < 256 ? ((UINTN) (0)) : (UINT64) (LShiftU64 ((UINT64) (0), 32))));
      ...
      if (_gPcd_FixedAtBuild_PcdPciBusHotplugDeviceSupport) {
        ...
        if (gPciHotPlugInit != ((void *) 0)) {



          if (IsRootPciHotPlugController (PciDevice->DevicePath, &HpIndex)) {
            gPciRootHpcData[HpIndex].Found = ((BOOLEAN)(1==1));
      ...
      if ((((&Pci)->Hdr.HeaderType & 0x7f) == (0x01)) || (((&Pci)->Hdr.HeaderType & 0x7f) == (0x02))) {
        ...
        if ((((&Pci)->Hdr.HeaderType & 0x7f) == (0x01))) {
          ...
          Address = (UINT64) ( (((UINTN) StartBusNumber) << 24) | (((UINTN) Device) << 16) | (((UINTN) Func) << 8) | (((UINTN) (0x1a)) < 256 ? ((UINTN) (0x1a)) : (UINT64) (LShiftU64 ((UINT64) (0x1a), 32))));
          Status = PciRootBridgeIo->Pci.Write (
                                            PciRootBridgeIo,
                                            EfiPciWidthUint8,
                                            Address,
        ...
        if (_gPcd_FixedAtBuild_PcdPciBusHotplugDeviceSupport && BusPadding) {
              ...
              ((State & 0x01) != 0))
          {
            ...
            *SubBusNumber = (((PaddedSubBus) > (*SubBusNumber)) ? (PaddedSubBus) : (*SubBusNumber));
          }
        }
        ...
        if (_gPcd_FixedAtBuild_PcdSrIovSupport && (PciDevice->SrIovCapabilityOffset != 0)) {
          if (TempReservedBusNum < PciDevice->ReservedBusNum) {
            ...
            if (Func == 0) {
              do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "PCI-IOV ScanBus - SubBusNumber - 0x%x\n", *SubBusNumber); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
            } else {
              do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "PCI-IOV ScanBus - SubBusNumber - 0x%x (Update)\n", *SubBusNumber); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
            }
          }
        }
      }
...
# 1464 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciLib.c"
EFI_STATUS
PciRootBridgeP2CProcess (
  PCI_IO_DEVICE *Bridge
  )
{
  ...
  while (CurrentLink != ((void *) 0) && CurrentLink != &Bridge->ChildList) {
    ...
    if ((((&Temp->Pci)->Hdr.HeaderType & 0x7f) == (0x02))) {
      if ((gPciHotPlugInit != ((void *) 0)) && Temp->Allocated && _gPcd_FixedAtBuild_PcdPciBusHotplugDeviceSupport) {



        (ReportProgressCodeEnabled() && ((0x00000001) & 0x000000FF) == 0x00000001) ? ReportStatusCodeWithDevicePath(0x00000001,(0x02000000 | 0x00010000) | (0x1000 | 0x00000002),Temp->DevicePath) : (ReportErrorCodeEnabled() && ((0x00000001) & 0x000000FF) == 0x00000002) ? ReportStatusCodeWithDevicePath(0x00000001,(0x02000000 | 0x00010000) | (0x1000 | 0x00000002),Temp->DevicePath) : (ReportDebugCodeEnabled() && ((0x00000001) & 0x000000FF) == 0x00000003) ? ReportStatusCodeWithDevicePath(0x00000001,(0x02000000 | 0x00010000) | (0x1000 | 0x00000002),Temp->DevicePath) : ((RETURN_STATUS)(0x8000000000000000ULL | (3)))



           ;

        PciAddress = (UINT64) ( (((UINTN) Temp->BusNumber) << 24) | (((UINTN) Temp->DeviceNumber) << 16) | (((UINTN) Temp->FunctionNumber) << 8) | (((UINTN) (0)) < 256 ? ((UINTN) (0)) : (UINT64) (LShiftU64 ((UINT64) (0), 32))));
        Status = gPciHotPlugInit->InitializeRootHpc (
                                        gPciHotPlugInit,
                                        Temp->DevicePath,
                                        PciAddress,
...
# 1533 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciLib.c"
EFI_STATUS
PciHostBridgeP2CProcess (
  EFI_PCI_HOST_BRIDGE_RESOURCE_ALLOCATION_PROTOCOL *PciResAlloc
  )
...
# 1578 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciLib.c"
EFI_STATUS
PciHostBridgeEnumerator (
  EFI_PCI_HOST_BRIDGE_RESOURCE_ALLOCATION_PROTOCOL *PciResAlloc
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "PCI Bus First Scanning\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  RootBridgeHandle = ((void *) 0);
  RootBridgeEnumerationStatus = (RETURN_STATUS)(0);
  while (PciResAlloc->GetNextRootBridge (PciResAlloc, &RootBridgeHandle) == (RETURN_STATUS)(0)) {
  ...
  if ((((RETURN_STATUS)(RootBridgeEnumerationStatus)) >= 0x8000000000000000ULL)) {
  ...
  if ((gPciHotPlugInit != ((void *) 0)) && _gPcd_FixedAtBuild_PcdPciBusHotplugDeviceSupport) {
    ...
    {
      RootBridgeDev = (((PCI_IO_DEVICE *) (void *) ((CHAR8 *) (Link) - ((UINTN) __builtin_offsetof(PCI_IO_DEVICE, Link))))->Signature != ((('p') | ('c' << 8)) | ((('i') | ('o' << 8)) << 16))) ? ((void *) 0) : ((PCI_IO_DEVICE *) (void *) ((CHAR8 *) (Link) - ((UINTN) __builtin_offsetof(PCI_IO_DEVICE, Link))));
    ...
    Status = AllRootHPCInitialized (1000000 * 15);

    if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "Some root HPC failed to initialize\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
      return Status;
    }
    ...
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "PCI Bus Second Scanning\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    RootBridgeHandle = ((void *) 0);
    while (PciResAlloc->GetNextRootBridge (PciResAlloc, &RootBridgeHandle) == (RETURN_STATUS)(0)) {
  ...
  while (PciResAlloc->GetNextRootBridge (PciResAlloc, &RootBridgeHandle) == (RETURN_STATUS)(0)) {
    ...
    Status = PciGetBusRange (&Descriptors, &MinBus, ((void *) 0), ((void *) 0));
...
# 1828 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciLib.c"
EFI_STATUS
PciProgramResizableBar (
  PCI_IO_DEVICE *PciIoDevice,
  PCI_RESIZABLE_BAR_OPERATION ResizableBarOp
  )
{
  ...
  EFI_STATUS Status;
  PCI_EXPRESS_EXTENDED_CAPABILITIES_RESIZABLE_BAR_ENTRY Entries[0x0006];

  do { if (((BOOLEAN)(0==1))) { (void) (PciIoDevice->ResizableBarOffset != 0); } } while (((BOOLEAN)(0==1)));

  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "   Programs Resizable BAR register, offset: 0x%08x, number: %d\n", PciIoDevice->ResizableBarOffset, PciIoDevice->ResizableBarNumber); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
  ...
  ResizableBarNumber = (((PciIoDevice->ResizableBarNumber) < (0x0006)) ? (PciIoDevice->ResizableBarNumber) : (0x0006));
...
# 1872 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Silicon/Spacemit/Override/MdeModulePkg/Bus/Pci/PciBusDxe/PciLib.c"
    ...
    if (ResizableBarOp == PciResizableBarMax) {
      ...
      do { if (((BOOLEAN)(0==1))) { (void) (ResizableBarOp == PciResizableBarMin); } } while (((BOOLEAN)(0==1)));
      Bit = LowBitSet64 (Capabilities);
    }

    do { if (((BOOLEAN)(0==1))) { (void) (Bit >= 0); } } while (((BOOLEAN)(0==1)));
    ...
    Offset = PciIoDevice->ResizableBarOffset + sizeof (PCI_EXPRESS_EXTENDED_CAPABILITIES_HEADER)
             ...
             + ((UINTN) __builtin_offsetof(PCI_EXPRESS_EXTENDED_CAPABILITIES_RESIZABLE_BAR_ENTRY, ResizableBarControl));

    Entries[Index].ResizableBarControl.Bits.BarSize = (UINT32)Bit;
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "   Resizable Bar: Offset = 0x%x, Bar Size Capability = 0x%016lx, New Bar Size = 0x%lx\n", ((UINTN) __builtin_offsetof(PCI_TYPE00, Device.Bar[Entries[Index].ResizableBarControl.Bits.BarIndex])), Capabilities, LShiftU64 (0x00100000, Bit)); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))

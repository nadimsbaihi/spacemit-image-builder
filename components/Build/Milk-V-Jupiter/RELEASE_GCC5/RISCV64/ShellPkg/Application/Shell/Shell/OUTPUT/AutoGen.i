# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/ShellPkg/Application/Shell/Shell/DEBUG/AutoGen.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/ShellPkg/Application/Shell/Shell/DEBUG/AutoGen.c"
# 9 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/ShellPkg/Application/Shell/Shell/DEBUG/AutoGen.c"
...
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/ShellPkg/Application/Shell/Shell/DEBUG/AutoGen.c" 2
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/ShellPkg/Application/Shell/Shell/DEBUG/AutoGen.c" 2
...
# 12 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/ShellPkg/Application/Shell/Shell/DEBUG/AutoGen.c" 2
...
# 13 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/ShellPkg/Application/Shell/Shell/DEBUG/AutoGen.c" 2

 GUID gEfiCallerIdGuid = {0x7C04A583, 0x9E3E, 0x4f1c, {0xAD, 0x65, 0xE0, 0x52, 0x68, 0xD0, 0xB4, 0xD1}};

 GUID gEdkiiDscPlatformGuid = {0xBECC2C86, 0x0329, 0x4876, {0x98, 0xB1, 0x57, 0xCC, 0x37, 0xB3, 0x3D, 0xF3}};

 CHAR8 *gEfiCallerBaseName = "Shell";
 ...
 EFI_GUID gShellSfHiiGuid = {0x63afaa11, 0xacd9, 0x46e1, {0x8b, 0xff, 0x61, 0x2e, 0xe5, 0xa5, 0x24, 0xc5} };
 EFI_GUID gShellEepromHiiGuid = {0xF75BF9A8, 0x839E, 0xFF56, {0xFE, 0x5A, 0xFF, 0xC5, 0x33, 0xA4, 0xD8, 0x17}};
 EFI_GUID gEfiHiiPlatformSetupFormsetGuid = { 0x93039971, 0x8545, 0x4b04, { 0xb4, 0x5e, 0x32, 0xeb, 0x83, 0x26, 0x04, 0x0e }};
 EFI_GUID gShellI2cHiiGuid = {0x7B5E10A5, 0xEE0F, 0xEF74, {0x33, 0xAB, 0x2C, 0x2F, 0x41, 0xB7, 0xA6, 0x80}};
 ...
 EFI_GUID gSpacemitSpiFlashProtocolGuid = {0x9b70b19b, 0x8a29, 0x4651, {0x90, 0x36, 0x2c, 0x6a, 0xae, 0xae, 0x9e, 0xe7}};
 EFI_GUID gSpacemitSpiMasterProtocolGuid = {0xc37b64e7, 0x7352, 0x4560, {0xac, 0xc2, 0x68, 0xca, 0xdc, 0x13, 0xce, 0x67}};
 EFI_GUID gSpacemitEepromProtocolGuid = {0x59fc3843, 0xd8d4, 0x40aa, {0xae, 0x07, 0x38, 0x96, 0x71, 0x38, 0x50, 0x00}};


 UINT64 _gPcd_SkuId_Array[] = {0x0};


 const UINT8 _gPcd_FixedAtBuild_PcdShellSupportLevel = 3U;
 const BOOLEAN _gPcd_FixedAtBuild_PcdShellSupportOldProtocols = 0U;
 const BOOLEAN _gPcd_FixedAtBuild_PcdShellRequireHiiPlatform = ((BOOLEAN)1U);
 const BOOLEAN _gPcd_FixedAtBuild_PcdShellSupportFrameworkHii = ((BOOLEAN)0U);
 const BOOLEAN _gPcd_FixedAtBuild_PcdShellPageBreakDefault = 0U;
 const BOOLEAN _gPcd_FixedAtBuild_PcdShellInsertModeDefault = 1U;
 const UINT8 _gPcd_FixedAtBuild_PcdShellScreenLogCount = 3U;
 const UINT32 _gPcd_FixedAtBuild_PcdShellPrintBufferSize = 16000U;
 const BOOLEAN _gPcd_FixedAtBuild_PcdShellForceConsole = ((BOOLEAN)0U);
 const UINT16 _gPcd_FixedAtBuild_PcdShellSupplier[7] = {69, 68, 75, 32, 73, 73, 0 };
 const UINTN _gPcd_FixedAtBuild_Size_PcdShellSupplier = 14;
 const UINT16 _gPcd_FixedAtBuild_PcdShellMaxHistoryCommandCount = 0x0020U;
 const UINT32 _gPcd_FixedAtBuild_PcdShellDefaultDelay = 5U;
...
extern const UINT8 _gPcd_FixedAtBuild_PcdDebugClearMemoryValue;
 ...
 const UINT8 _gPcd_FixedAtBuild_PcdDebugPropertyMask = 0xFFU;
...
extern const BOOLEAN _gPcd_FixedAtBuild_PcdUgaConsumeSupport;
 ...
 const UINT32 _gPcd_FixedAtBuild_PcdUefiLibMaxPrintBufferSize = 8000U;
extern const UINT32 _gPcd_FixedAtBuild_PcdUefiLibMaxPrintBufferSize;
 ...
 const UINT16 _gPcd_FixedAtBuild_PcdUefiFileHandleLibPrintBufferSize = 1536U;
extern const UINT16 _gPcd_FixedAtBuild_PcdUefiFileHandleLibPrintBufferSize;
 ...
 const UINT8 _gPcd_FixedAtBuild_PcdReportStatusCodePropertyMask = 0x07U;
...
extern const UINT8 _gPcd_FixedAtBuild_PcdPerformanceLibraryPropertyMask;
 ...
 const BOOLEAN _gPcd_FixedAtBuild_PcdValidateOrderedCollection = ((BOOLEAN)0U);
extern const BOOLEAN _gPcd_FixedAtBuild_PcdValidateOrderedCollection;
 ...
 const BOOLEAN _gPcd_FixedAtBuild_PcdShellLibAutoInitialize = 0U;
extern const BOOLEAN _gPcd_FixedAtBuild_PcdShellLibAutoInitialize;
 ...
 const BOOLEAN _gPcd_FixedAtBuild_PcdShellIncludeNtGuids = ((BOOLEAN)1U);
extern const BOOLEAN _gPcd_FixedAtBuild_PcdShellIncludeNtGuids;
 ...
 const BOOLEAN _gPcd_FixedAtBuild_PcdResetOnMemoryTypeInformationChange = 0U;
extern const BOOLEAN _gPcd_FixedAtBuild_PcdResetOnMemoryTypeInformationChange;
 ...
 const UINT32 _gPcd_FixedAtBuild_PcdProgressCodeOsLoaderLoad = 0x03058000U;
extern const UINT32 _gPcd_FixedAtBuild_PcdProgressCodeOsLoaderLoad;
 ...
 const UINT32 _gPcd_FixedAtBuild_PcdProgressCodeOsLoaderStart = 0x03058001U;
extern const UINT32 _gPcd_FixedAtBuild_PcdProgressCodeOsLoaderStart;
 ...
 const UINT32 _gPcd_FixedAtBuild_PcdErrorCodeSetVariable = 0x03058002U;
extern const UINT32 _gPcd_FixedAtBuild_PcdErrorCodeSetVariable;
 ...
 const UINT8 _gPcd_FixedAtBuild_PcdBootManagerMenuFile[16] = { 0x21, 0xaa, 0x2c, 0x46, 0x14, 0x76, 0x03, 0x45, 0x83, 0x6e, 0x8a, 0xb6, 0xf4, 0x66, 0x23, 0x31 };
extern const UINT8 _gPcd_FixedAtBuild_PcdBootManagerMenuFile[16];



 const UINTN _gPcd_FixedAtBuild_Size_PcdBootManagerMenuFile = 16;




 const UINT8 _gPcd_FixedAtBuild_PcdDriverHealthConfigureForm[16] = { 0xf4, 0xd9, 0x96, 0x42, 0xfc, 0xf6, 0xde, 0x4d, 0x86, 0x85, 0x8c, 0xe2, 0xd7, 0x9d, 0x90, 0xf0 };
extern const UINT8 _gPcd_FixedAtBuild_PcdDriverHealthConfigureForm[16];



 const UINTN _gPcd_FixedAtBuild_Size_PcdDriverHealthConfigureForm = 16;
 ...
 const UINT32 _gPcd_FixedAtBuild_PcdMaxRepairCount = 0x00U;
extern const UINT32 _gPcd_FixedAtBuild_PcdMaxRepairCount;
 ...
 const UINT8 _gPcd_FixedAtBuild_PcdShellMapNameLength = 50U;
extern const UINT8 _gPcd_FixedAtBuild_PcdShellMapNameLength;
 ...
 const BOOLEAN _gPcd_FixedAtBuild_PcdUsbExtendedDecode = 1U;
extern const BOOLEAN _gPcd_FixedAtBuild_PcdUsbExtendedDecode;
 ...
 const BOOLEAN _gPcd_FixedAtBuild_PcdShellDecodeIScsiMapNames = 0U;
extern const BOOLEAN _gPcd_FixedAtBuild_PcdShellDecodeIScsiMapNames;
 ...
 const UINT32 _gPcd_FixedAtBuild_PcdShellVendorExtendedDecode = 0U;
extern const UINT32 _gPcd_FixedAtBuild_PcdShellVendorExtendedDecode;
 ...
 const BOOLEAN _gPcd_FixedAtBuild_PcdEnforceSecureRngAlgorithms = 1U;
extern const BOOLEAN _gPcd_FixedAtBuild_PcdEnforceSecureRngAlgorithms;
 ...
 const UINT32 _gPcd_FixedAtBuild_PcdShellFileOperationSize = 0x1000U;
extern const UINT32 _gPcd_FixedAtBuild_PcdShellFileOperationSize;
 ...
 const UINT8 _gPcd_FixedAtBuild_PcdShellProfileMask = 0xFFU;
  ...
  )
{
  ...
  Status = ShellEepromLibConstructor (ImageHandle, SystemTable);
  do { if (((BOOLEAN)(0==1))) { (void) (Status); } } while (((BOOLEAN)(0==1)));

  Status = ShellI2cLibConstructor (ImageHandle, SystemTable);
  do { if (((BOOLEAN)(0==1))) { (void) (Status); } } while (((BOOLEAN)(0==1)));
  ...
  )
{
  ...
  Status = ShellI2cLibDestructor (ImageHandle, SystemTable);
  do { if (((BOOLEAN)(0==1))) { (void) (Status); } } while (((BOOLEAN)(0==1)));

  Status = ShellEepromLibDestructor (ImageHandle, SystemTable);
  do { if (((BOOLEAN)(0==1))) { (void) (Status); } } while (((BOOLEAN)(0==1)));

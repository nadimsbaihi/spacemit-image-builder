# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/ShellManParser.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/ShellManParser.c"
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/ShellManParser.c"
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/ShellManParser.c" 2
...
EFI_HII_HANDLE mShellManHiiHandle = ((void *) 0);
EFI_HANDLE mShellManDriverHandle = ((void *) 0);
...
# 52 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/ShellManParser.c"
CHAR16 *
...
# 107 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/ShellManParser.c"
CHAR16 *
GetManFileName (
  const CHAR16 *ManFileName
  )
...
# 158 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/ShellManParser.c"
EFI_STATUS
SearchPathForFile (
  const CHAR16 *FileName,
  SHELL_FILE_HANDLE *Handle
  )
{
  ...
  Status = EfiShellOpenFileByName (FullFileName, Handle, 0x0000000000000001ULL);
  FreePool (FullFileName);

  return (Status);
}
# 207 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/ShellManParser.c"
EFI_STATUS
ManFileFindSections (
  SHELL_FILE_HANDLE Handle,
  const CHAR16 *Sections,
  ...
  )
{
  ...
  for ( ; !ShellFileHandleEof (Handle); Size = 1024) {
    Status = ShellFileHandleReadLine (Handle, ReadLine, &Size, ((BOOLEAN)(1==1)), &Ascii);
    if (ReadLine[0] == L'#') {
    ...
    if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
      ...
      if ((*(SectionName + SectionLen) == 0x0000) || (*(SectionName + SectionLen) == L',')) {
        CurrentlyReading = ((BOOLEAN)(1==1));
      }
      ...
      do { if (((BOOLEAN)(0==1))) { (void) ((*HelpText == ((void *) 0) && *HelpSize == 0) || (*HelpText != ((void *) 0))); } } while (((BOOLEAN)(0==1)));
  ...
  FreePool (ReadLine);
  if (!Found && !(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    return (((RETURN_STATUS)(0x8000000000000000ULL | (14))));
  }

  return (Status);
}
# 336 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/ShellManParser.c"
BOOLEAN
IsTitleHeader (
  const CHAR16 *Command,
  CHAR16 *Line,
  ...
  )
{
  ...
  ReturnValue = ((BOOLEAN)(0==1));
  ReturnFound = ((BOOLEAN)(0==1));
  CommandIndex = 0;
  ...
  do {
    ...
    switch (State) {
      ...
      case CompareCommands:
        if ((*Line == L' ') || (*Line == L'\t')) {
          ReturnFound = ((BOOLEAN)(1==1));
          State = (BriefDesc == ((void *) 0)) ? Final : GetBriefDescription;
...
# 460 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/ShellManParser.c"
EFI_STATUS
  ...
  )
{
  ...
  if ( (Handle == ((void *) 0))
     || (Command == ((void *) 0))
     || ((BriefDesc != ((void *) 0)) && (BriefSize == ((void *) 0)))
        )
  {
    return (((RETURN_STATUS)(0x8000000000000000ULL | (2))));
  }
  ...
  for ( ; !ShellFileHandleEof (Handle); Size = 1024) {
    ...
    if (IsTitleHeader (Command+Start, ReadLine, BriefDesc, BriefSize, &Found)) {
      Status = Found ? (RETURN_STATUS)(0) : ((RETURN_STATUS)(0x8000000000000000ULL | (14)));
      break;
    }
  }
...
# 555 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/ShellManParser.c"
EFI_STATUS
ProcessManFile (
  const CHAR16 *ManFileName,
  const CHAR16 *Command,
  ...
  )
{
  ...
  Ascii = ((BOOLEAN)(0==1));
  CmdFileName = ((void *) 0);
  CmdFilePathName = ((void *) 0);
  CmdFileImgHandle = ((void *) 0);
  PackageListHeader = ((void *) 0);
  FileDevPath = ((void *) 0);
  DevPath = ((void *) 0);
  ...
  if (TempString != ((void *) 0)) {
    FileHandle = ConvertEfiFileProtocolToShellHandle (CreateFileInterfaceMem (((BOOLEAN)(1==1))), ((void *) 0));
    ...
    if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) && (HelpText != ((void *) 0))) {
    ...
    if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
      FileDevPath = FileDevicePath (((void *) 0), TempString);
      if (FileDevPath == ((void *) 0)) {
        Status = ((RETURN_STATUS)(0x8000000000000000ULL | (9)));
        goto Done;
      }
      ...
      Status = InternalOpenFileDevicePath (DevPath, &FileHandle, 0x0000000000000001ULL, 0);
      do { if ((FileDevPath) != ((void *) 0)) { FreePool((FileDevPath)); (FileDevPath) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
    ...
    if (CmdFilePathName == ((void *) 0)) {
      Status = ((RETURN_STATUS)(0x8000000000000000ULL | (14)));
      goto Done;
    }

    DevPath = ShellInfoObject.NewEfiShellProtocol->GetDevicePathFromFilePath (CmdFilePathName);
    Status = gBS->LoadImage (((BOOLEAN)(0==1)), gImageHandle, DevPath, ((void *) 0), 0, &CmdFileImgHandle);
    if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    ...
    do {
      ...
      if (BriefDesc != ((void *) 0)) {
        do { if ((*BriefDesc) != ((void *) 0)) { FreePool((*BriefDesc)); (*BriefDesc) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
      }

      TempString = HiiGetString (mShellManHiiHandle, (EFI_STRING_ID)StringIdWalker, ((void *) 0));
      if (TempString == ((void *) 0)) {
        Status = ((RETURN_STATUS)(0x8000000000000000ULL | (14)));
        goto Done;
      }
      ...
      StringIdWalker += 1;
    } while (StringIdWalker < 0xFFFF && TempString != ((void *) 0));
  }

Done:
  if (mShellManDriverHandle != ((void *) 0)) {
    gBS->UninstallProtocolInterface (
           mShellManDriverHandle,
           &gEfiDevicePathProtocolGuid,
           &mShellManHiiDevicePath
           );
    mShellManDriverHandle = ((void *) 0);
  }

  if (mShellManHiiHandle != ((void *) 0)) {
    HiiRemovePackages (mShellManHiiHandle);
    mShellManHiiHandle = ((void *) 0);
  }

  if (CmdFileImgHandle != ((void *) 0)) {
    Status = gBS->UnloadImage (CmdFileImgHandle);
  }

  do { if ((TempString) != ((void *) 0)) { FreePool((TempString)); (TempString) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
  do { if ((CmdFileName) != ((void *) 0)) { FreePool((CmdFileName)); (CmdFileName) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
  do { if ((CmdFilePathName) != ((void *) 0)) { FreePool((CmdFilePathName)); (CmdFilePathName) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
  do { if ((FileDevPath) != ((void *) 0)) { FreePool((FileDevPath)); (FileDevPath) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
  do { if ((DevPath) != ((void *) 0)) { FreePool((DevPath)); (DevPath) = ((void *) 0); } } while(((BOOLEAN)(0==1)));

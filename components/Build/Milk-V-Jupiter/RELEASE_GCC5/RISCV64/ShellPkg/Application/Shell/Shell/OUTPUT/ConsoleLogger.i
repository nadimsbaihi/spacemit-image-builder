# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/ConsoleLogger.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/ConsoleLogger.c"
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/ConsoleLogger.c"
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/ConsoleLogger.c" 2
# 25 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/ConsoleLogger.c"
EFI_STATUS
ConsoleLoggerInstall (
  const UINTN ScreensToSave,
  CONSOLE_LOGGER_PRIVATE_DATA **ConsoleInfo
  )
{
  ...
  (*ConsoleInfo)->HistoryMode.CursorVisible = ((BOOLEAN)(0==1));
  ...
  (*ConsoleInfo)->Enabled = ((BOOLEAN)(1==1));

  Status = ConsoleLoggerResetBuffers (*ConsoleInfo);
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    do { if (((*ConsoleInfo)) != ((void *) 0)) { FreePool(((*ConsoleInfo))); ((*ConsoleInfo)) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
    *ConsoleInfo = ((void *) 0);
    return (Status);
  }
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    do { if (((*ConsoleInfo)->Buffer) != ((void *) 0)) { FreePool(((*ConsoleInfo)->Buffer)); ((*ConsoleInfo)->Buffer) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
    do { if (((*ConsoleInfo)->Attributes) != ((void *) 0)) { FreePool(((*ConsoleInfo)->Attributes)); ((*ConsoleInfo)->Attributes) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
    do { if (((*ConsoleInfo)) != ((void *) 0)) { FreePool(((*ConsoleInfo))); ((*ConsoleInfo)) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
    *ConsoleInfo = ((void *) 0);
    return (Status);
  }
...
# 110 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/ConsoleLogger.c"
EFI_STATUS
ConsoleLoggerUninstall (
  CONSOLE_LOGGER_PRIVATE_DATA *ConsoleInfo
  )
{
  do { if (((BOOLEAN)(0==1))) { (void) (ConsoleInfo != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { (void) (ConsoleInfo->OldConOut != ((void *) 0)); } } while (((BOOLEAN)(0==1)));

  if (ConsoleInfo->Buffer != ((void *) 0)) {
    FreePool (ConsoleInfo->Buffer);
    do { if (DebugCodeEnabled ()) { do { } while (((BOOLEAN)(0==1))); ConsoleInfo->Buffer = ((void *) 0); } } while (((BOOLEAN)(0==1)))

       ;
    do { if (DebugCodeEnabled ()) { do { } while (((BOOLEAN)(0==1))); ConsoleInfo->BufferSize = 0; } } while (((BOOLEAN)(0==1)))

       ;
  }

  if (ConsoleInfo->Attributes != ((void *) 0)) {
    FreePool (ConsoleInfo->Attributes);
    do { if (DebugCodeEnabled ()) { do { } while (((BOOLEAN)(0==1))); ConsoleInfo->Attributes = ((void *) 0); } } while (((BOOLEAN)(0==1)))

       ;
    do { if (DebugCodeEnabled ()) { do { } while (((BOOLEAN)(0==1))); ConsoleInfo->AttribSize = 0; } } while (((BOOLEAN)(0==1)))
...
# 166 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/ConsoleLogger.c"
EFI_STATUS
ConsoleLoggerDisplayHistory (
  const BOOLEAN Forward,
  const UINTN Rows,
...
# 241 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/ConsoleLogger.c"
EFI_STATUS
ConsoleLoggerStopHistory (
  CONSOLE_LOGGER_PRIVATE_DATA *ConsoleInfo
  )
...
# 267 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/ConsoleLogger.c"
EFI_STATUS
UpdateDisplayFromHistory (
  CONSOLE_LOGGER_PRIVATE_DATA *ConsoleInfo
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (ConsoleInfo != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
  TempCharHolder = 0x0000;
  RetVal = (RETURN_STATUS)(0);
  OrigAttribute = ConsoleInfo->OldConOut->Mode->Attribute;




  ConsoleInfo->OldConOut->EnableCursor (ConsoleInfo->OldConOut, ((BOOLEAN)(0==1)));
        ...
        )
  {
    ...
    if (CurrentRow == (ConsoleInfo->RowsPerScreen-1)) {
      ...
      Screen[ConsoleInfo->ColsPerScreen - 1] = 0x0000;
    }
          ...
          )
    {
      if (Screen[Column] != 0x0000) {
        ...
        StringSegmentEndChar = 0x0000;
        for ( StringSegmentEnd = StringSegment
              ; *StringSegmentEnd != 0x0000
              ; StringSegmentEnd++,
              Column++
              )
        {
        ...
        if (StringSegmentEndChar != 0x0000) {
...
# 420 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/ConsoleLogger.c"
EFI_STATUS
  ...
  )
{
  ...
  ConsoleInfo = (((CONSOLE_LOGGER_PRIVATE_DATA *) (void *) ((CHAR8 *) (This) - ((UINTN) __builtin_offsetof(CONSOLE_LOGGER_PRIVATE_DATA, OurConOut))))->Signature != ((('c') | ('o' << 8)) | ((('P') | ('D' << 8)) << 16))) ? ((void *) 0) : ((CONSOLE_LOGGER_PRIVATE_DATA *) (void *) ((CHAR8 *) (This) - ((UINTN) __builtin_offsetof(CONSOLE_LOGGER_PRIVATE_DATA, OurConOut))));
...
# 459 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/ConsoleLogger.c"
EFI_STATUS
    ...
    switch (*Walker) {
      ...
      case (0x000A):
        if (ConsoleInfo->HistoryMode.CursorRow >= (INT32)((ConsoleInfo->RowsPerScreen * ConsoleInfo->ScreenCount)-1)) {
          ...
          do { if (((BOOLEAN)(0==1))) { (void) (ConsoleInfo->HistoryMode.CursorRow == (INT32)((ConsoleInfo->RowsPerScreen * ConsoleInfo->ScreenCount)-1)); } } while (((BOOLEAN)(0==1)));
          ...
          do { if (((BOOLEAN)(0==1))) { (void) (CopySize < ConsoleInfo->AttribSize); } } while (((BOOLEAN)(0==1)));
          CopyMem (
          ...
          do { if (((BOOLEAN)(0==1))) { (void) (CopySize < ConsoleInfo->BufferSize); } } while (((BOOLEAN)(0==1)));
          CopyMem (
            ConsoleInfo->Buffer,
          ...
          do { if (((BOOLEAN)(0==1))) { (void) (ConsoleInfo->OriginalStartRow == ConsoleInfo->CurrentStartRow); } } while (((BOOLEAN)(0==1)));
      ...
      default:
              ...
              )
        {
          ...
          do { if (((BOOLEAN)(0==1))) { (void) (PrintIndex + ConsoleInfo->HistoryMode.CursorRow < ConsoleInfo->BufferSize); } } while (((BOOLEAN)(0==1)));
          ConsoleInfo->Buffer[PrintIndex + (2*ConsoleInfo->HistoryMode.CursorRow)] = *Walker;
          do { if (((BOOLEAN)(0==1))) { (void) (PrintIndex < ConsoleInfo->AttribSize); } } while (((BOOLEAN)(0==1)));
...
# 621 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/ConsoleLogger.c"
EFI_STATUS
...
# 649 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/ConsoleLogger.c"
EFI_STATUS
  ...
  )
{
  ...
  Resp = ((void *) 0);
  do { if (((BOOLEAN)(0==1))) { (void) (ShellInfoObject.PageBreakEnabled); } } while (((BOOLEAN)(0==1)));
  ShellInfoObject.PageBreakEnabled = ((BOOLEAN)(0==1));
  Status = ShellPromptForResponseHii (ShellPromptResponseTypeQuitContinue, 0x0007, ShellInfoObject.HiiHandle, (void **)&Resp);
  ShellInfoObject.PageBreakEnabled = ((BOOLEAN)(1==1));
  do { if (((BOOLEAN)(0==1))) { (void) (Resp != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
  if (Resp == ((void *) 0)) {
  ...
  if (*Resp == ShellPromptResponseContinue) {
    ...
    FreePool (Resp);
    ShellInfoObject.ConsoleInfo->Enabled = ((BOOLEAN)(0==1));
...
# 712 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/ConsoleLogger.c"
EFI_STATUS
  ...
  )
{
  ...
  StringCopy = ((void *) 0);
  StringCopy = StrnCatGrow (&StringCopy, ((void *) 0), String, 0);
  if (StringCopy == ((void *) 0)) {
    return (((RETURN_STATUS)(0x8000000000000000ULL | (9))));
  }
        ...
        )
  {
    ...
    if ((ConsoleInfo->RowsPerScreen) -1 == ShellInfoObject.ConsoleInfo->RowCounter) {
      if ((((RETURN_STATUS)(ConsoleLoggerDoPageBreak ())) >= 0x8000000000000000ULL)) {



        do { if ((StringCopy) != ((void *) 0)) { FreePool((StringCopy)); (StringCopy) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
        return (((RETURN_STATUS)(0x8000000000000000ULL | (7))));
      }
    }
  }

  if ((LineStart != ((void *) 0)) && (*LineStart != 0x0000)) {
    ConsoleLoggerOutputStringSplit (LineStart, ConsoleInfo);
  }
...
# 860 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/ConsoleLogger.c"
EFI_STATUS
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (ShellInfoObject.ConsoleInfo == ConsoleInfo); } } while (((BOOLEAN)(0==1)));

  Status = gBS->HandleProtocol (gST->ConsoleInHandle, &gEfiSimpleTextInputExProtocolGuid, (void **)&TxtInEx);
  if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    while (ShellInfoObject.HaltOutput) {
      ShellInfoObject.HaltOutput = ((BOOLEAN)(0==1));
      ...
      if ((KeyData.Key.UnicodeChar == L's') && (KeyData.Key.ScanCode == 0x0000) &&
...
# 928 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/ConsoleLogger.c"
EFI_STATUS
...
# 958 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/ConsoleLogger.c"
EFI_STATUS
...
# 993 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/ConsoleLogger.c"
EFI_STATUS
...
# 1040 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/ConsoleLogger.c"
EFI_STATUS
...
# 1079 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/ConsoleLogger.c"
EFI_STATUS
...
# 1151 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/ConsoleLogger.c"
EFI_STATUS
...
# 1200 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/ConsoleLogger.c"
EFI_STATUS
...
# 1235 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/ConsoleLogger.c"
EFI_STATUS
ConsoleLoggerResetBuffers (
  CONSOLE_LOGGER_PRIVATE_DATA *ConsoleInfo
  )

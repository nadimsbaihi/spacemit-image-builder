# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/ShellEnvVar.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/ShellEnvVar.c"
# 9 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/ShellEnvVar.c"
...
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/ShellEnvVar.c" 2
...
# 28 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/ShellEnvVar.c"
EFI_STATUS
IsVolatileEnv (
  const CHAR16 *EnvVarName,
  BOOLEAN *Volatile
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (Volatile != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
  ...
  *Volatile = !(BOOLEAN)((Attribs & 0x00000001) == 0x00000001);
  return (RETURN_STATUS)(0);
}
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (List != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
  if (List == ((void *) 0)) {
    return;
  }
...
# 133 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/ShellEnvVar.c"
EFI_STATUS
GetEnvironmentVariableList (
  LIST_ENTRY *ListHead
  )
{
  ...
  *VariableName = 0x0000;
  ...
  while (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    ...
    if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) && CompareGuid (&Guid, &gShellVariableGuid)) {
      ...
      if (VarList == ((void *) 0)) {
        ...
        if (VarList->Val == ((void *) 0)) {
          do { if ((VarList) != ((void *) 0)) { FreePool((VarList)); (VarList) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
          Status = ((RETURN_STATUS)(0x8000000000000000ULL | (9)));
          break;
        }

        Status = (gRT->GetVariable((CHAR16*)VariableName, &gShellVariableGuid, &VarList->Atts, &ValSize, VarList->Val));
        if (Status == ((RETURN_STATUS)(0x8000000000000000ULL | (5)))) {
          ValBufferSize = ValSize > ValBufferSize * 2 ? ValSize : ValBufferSize * 2;
          do { if ((VarList->Val) != ((void *) 0)) { FreePool((VarList->Val)); (VarList->Val) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
...
# 253 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/ShellEnvVar.c"
EFI_STATUS
SetEnvironmentVariableList (
  LIST_ENTRY *ListHead
  )
{
  ...
  {
    if (Node->Key != ((void *) 0)) {
      Status = (gRT->SetVariable((CHAR16*)Node->Key, &gShellVariableGuid, 0, 0, ((void *) 0)));
    }
        ...
        )
  {
    ...
    if (Node->Atts & 0x00000001) {
      Status = (gRT->SetVariable((CHAR16*)Node->Key, &gShellVariableGuid, 0x00000001|0x00000002, Size, (void*)Node->Val));
    } else {
      Status = (gRT->SetVariable((CHAR16*)Node->Key, &gShellVariableGuid, 0x00000002, Size, (void*)Node->Val));
    }
...
# 321 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/ShellEnvVar.c"
EFI_STATUS
SetEnvironmentVariables (
  const CHAR16 **Environment
  )
{
        ...
        )
  {
    ...
    do { if (((BOOLEAN)(0==1))) { (void) (StrStr (CurrentString, L"=") != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
    ...
    if (Node->Key == ((void *) 0)) {
      do { if ((Node) != ((void *) 0)) { FreePool((Node)); (Node) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
      SetEnvironmentVariableList (&VarList->Link);
      return (((RETURN_STATUS)(0x8000000000000000ULL | (9))));
    }
    ...
    if (Node->Val == ((void *) 0)) {
      do { if ((Node->Key) != ((void *) 0)) { FreePool((Node->Key)); (Node->Key) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
      do { if ((Node) != ((void *) 0)) { FreePool((Node)); (Node) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
      SetEnvironmentVariableList (&VarList->Link);
      return (((RETURN_STATUS)(0x8000000000000000ULL | (9))));
    }

    Node->Atts = 0x00000002;

    if (VarList == ((void *) 0)) {
      VarList = AllocateZeroPool (sizeof (ENV_VAR_LIST));
      if (VarList == ((void *) 0)) {
        do { if ((Node->Key) != ((void *) 0)) { FreePool((Node->Key)); (Node->Key) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
        do { if ((Node->Val) != ((void *) 0)) { FreePool((Node->Val)); (Node->Val) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
        do { if ((Node) != ((void *) 0)) { FreePool((Node)); (Node) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
        return (((RETURN_STATUS)(0x8000000000000000ULL | (9))));
      }
...
# 425 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/ShellEnvVar.c"
EFI_STATUS
ShellFindEnvVarInList (
  const CHAR16 *Key,
  CHAR16 **Value,
  ...
  )
{
  ...
  if ((Key == ((void *) 0)) || (Value == ((void *) 0)) || (ValueSize == ((void *) 0))) {
  ...
  {
    if ((Node->Key != ((void *) 0)) && (StrCmp (Key, Node->Key) == 0)) {
...
# 471 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/ShellEnvVar.c"
EFI_STATUS
ShellAddEnvVarToList (
  const CHAR16 *Key,
  const CHAR16 *Value,
  ...
  )
{
  ...
  if ((Key == ((void *) 0)) || (Value == ((void *) 0)) || (ValueSize == 0)) {
    return ((RETURN_STATUS)(0x8000000000000000ULL | (2)));
  }
...
# 542 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/ShellEnvVar.c"
EFI_STATUS
ShellRemvoeEnvVarFromList (
  const CHAR16 *Key
  )

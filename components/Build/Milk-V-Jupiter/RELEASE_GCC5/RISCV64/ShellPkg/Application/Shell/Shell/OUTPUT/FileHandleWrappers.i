# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleWrappers.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleWrappers.c"
# 12 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleWrappers.c"
...
# 13 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleWrappers.c" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleInternal.h" 1
# 19 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleInternal.h"
void
MoveCursorBackward (
  UINTN LineLength,
  UINTN *Column,
...
# 34 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleInternal.h"
void
MoveCursorForward (
  UINTN LineLength,
  UINTN TotalRow,
...
# 51 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleInternal.h"
void
PrintCommandHistory (
  const UINTN TotalCols,
  const UINTN TotalRows,
  const UINTN StartColumn
  );
# 14 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleWrappers.c" 2
# 28 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleWrappers.c"
EFI_STATUS
...
# 48 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleWrappers.c"
EFI_STATUS
...
# 65 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleWrappers.c"
EFI_STATUS
...
# 83 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleWrappers.c"
EFI_STATUS
...
# 103 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleWrappers.c"
EFI_STATUS
...
# 125 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleWrappers.c"
EFI_STATUS
...
# 149 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleWrappers.c"
EFI_STATUS
...
# 177 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleWrappers.c"
EFI_STATUS
...
# 199 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleWrappers.c"
EFI_STATUS
...
# 219 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleWrappers.c"
EFI_STATUS
...
# 239 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleWrappers.c"
EFI_STATUS
...
# 259 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleWrappers.c"
EFI_STATUS
...
# 280 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleWrappers.c"
EFI_STATUS
...
# 300 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleWrappers.c"
EFI_STATUS
CreateTabCompletionList (
  const CHAR16 *InputString,
  const UINTN StringLen,
  const UINTN BufferSize,
  EFI_SHELL_FILE_INFO **TabCompletionList,
  UINTN *TabUpdatePos
  )
{
  BOOLEAN InQuotation;
  ...
  *TabUpdatePos = 0;
  ...
  if (StrStr (InputString + TabPos, L":") == ((void *) 0)) {



    Cwd = ShellInfoObject.NewEfiShellProtocol->GetCurDir (((void *) 0));
    if (Cwd != ((void *) 0)) {
  ...
  if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) && (FileList != ((void *) 0))) {
    ...
    for (FileInfo = (EFI_SHELL_FILE_INFO *)GetFirstNode (&FileList->Link); !IsNull (&FileList->Link, &FileInfo->Link); ) {
      if (((StrCmp (FileInfo->FileName, L".") == 0) || (StrCmp (FileInfo->FileName, L"..") == 0)) ||
          ((((InputString[0] == L'c') || (InputString[0] == L'C')) && ((InputString[1] == L'd') || (InputString[1] == L'D'))) &&
           (ShellIsDirectory (FileInfo->FullName) != (RETURN_STATUS)(0))))
      {
  ...
  if ((FileList != ((void *) 0)) && !IsListEmpty (&FileList->Link)) {
...
# 456 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleWrappers.c"
EFI_STATUS
  ...
  )
{
  ...
  InScrolling = ((BOOLEAN)(0==1));
  InTabScrolling = ((BOOLEAN)(0==1));
  Status = (RETURN_STATUS)(0);
  TabOutputStr = ((void *) 0);
  TabUpdatePos = 0;
  TabCompleteList = ((void *) 0);
  TabCurrent = ((void *) 0);
  ...
  do {
    ...
    if ((Key.UnicodeChar == 0) && ((Key.ScanCode == 0x0009) || (Key.ScanCode == 0x000A))) {
      if (Key.ScanCode == 0x0009) {
        ConsoleLoggerDisplayHistory (((BOOLEAN)(0==1)), 0, ShellInfoObject.ConsoleInfo);
      } else if (Key.ScanCode == 0x000A) {
        ConsoleLoggerDisplayHistory (((BOOLEAN)(1==1)), 0, ShellInfoObject.ConsoleInfo);
      }

      InScrolling = ((BOOLEAN)(1==1));
    } else {
      if (InScrolling) {
    ...
    if (InTabScrolling && (Key.UnicodeChar != 0x0009)) {
      if (TabCompleteList != ((void *) 0)) {
        ShellInfoObject.NewEfiShellProtocol->FreeFileList (&TabCompleteList);
        do { if (DebugCodeEnabled ()) { do { } while (((BOOLEAN)(0==1))); TabCompleteList = ((void *) 0); } } while (((BOOLEAN)(0==1)))
    ...
    switch (Key.UnicodeChar) {
      ...
      case 0x0009:
        ...
        if (InTabScrolling) {
          ...
          do { if (((BOOLEAN)(0==1))) { (void) (TabCompleteList != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
          if (TabCurrent == ((void *) 0)) {
    ...
    if (InTabScrolling) {
      ...
      if (TabOutputStr == ((void *) 0)) {
        Status = ((RETURN_STATUS)(0x8000000000000000ULL | (9)));
      }
    }

    if (InTabScrolling && (TabOutputStr != ((void *) 0))) {
      ...
      CurrentString[TabUpdatePos + OutputLength] = 0x0000;
    ...
    if (NewPos != (BUFFER_LIST *)(&ShellInfoObject.ViewingSettings.CommandHistory)) {
      ...
      CurrentString[OutputLength] = 0x0000;
    ...
    if (Update != (UINTN)-1) {
      ...
      if (Delete != 0) {
        SetMem (CurrentString + StringLen, Delete * sizeof (CHAR16), 0x0000);
      }
      ...
      if ((Key.UnicodeChar != 0x0008) && !((Key.UnicodeChar == 0) && (Key.ScanCode == 0x0008))) {
...
# 899 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleWrappers.c"
  ...
  if ((CurrentString != ((void *) 0)) && (StrLen (CurrentString) > 0)) {
...
# 1046 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleWrappers.c"
EFI_STATUS
  ...
  )
{
  ...
  Status = (gRT->GetVariable((CHAR16*)((EFI_FILE_PROTOCOL_ENVIRONMENT *)This)->Name, &gShellVariableGuid, 0, &NewSize, NewBuffer));
  ...
  if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) && (NewBuffer != ((void *) 0))) {
    if (TotalSize / sizeof (CHAR16) >= 3) {
      if ((((CHAR16 *)NewBuffer)[TotalSize / sizeof (CHAR16) - 2] == 0x000A) &&
          (((CHAR16 *)NewBuffer)[TotalSize / sizeof (CHAR16) - 3] == 0x000D)
          )
      {
        ((CHAR16 *)NewBuffer)[TotalSize / sizeof (CHAR16) - 3] = 0x0000;
      ...
      if (Volatile) {
        Status = (gRT->SetVariable((CHAR16*)((EFI_FILE_PROTOCOL_ENVIRONMENT *)This)->Name, &gShellVariableGuid, 0x00000002, TotalSize - sizeof (CHAR16), (void*)NewBuffer))
        ...
        Status = (gRT->SetVariable((CHAR16*)((EFI_FILE_PROTOCOL_ENVIRONMENT *)This)->Name, &gShellVariableGuid, 0x00000001|0x00000002, TotalSize - sizeof (CHAR16), (void*)NewBuffer))
  ...
  do { if ((NewBuffer) != ((void *) 0)) { FreePool((NewBuffer)); (NewBuffer) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
  FreePool ((EFI_FILE_PROTOCOL_ENVIRONMENT *)This);
  return (Status);
}
# 1143 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleWrappers.c"
EFI_STATUS
...
{
  (gRT->SetVariable((CHAR16*)((EFI_FILE_PROTOCOL_ENVIRONMENT *)This)->Name, &gShellVariableGuid, 0, 0, ((void *) 0)));
  return (FileInterfaceEnvClose (This));
}
# 1162 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleWrappers.c"
EFI_STATUS
  ...
  )
{
  ...
  *BufferSize = *BufferSize / sizeof (CHAR16) * sizeof (CHAR16);
  ...
  Status = (gRT->GetVariable((CHAR16*)((EFI_FILE_PROTOCOL_ENVIRONMENT *)This)->Name, &gShellVariableGuid, 0, BufferSize, Buffer))
...
# 1208 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleWrappers.c"
EFI_STATUS
  ...
  )
{
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) && (Status != ((RETURN_STATUS)(0x8000000000000000ULL | (14))))) {
    FreePool (NewBuffer);
    return Status;
  }
...
# 1284 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleWrappers.c"
EFI_STATUS
...
# 1358 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleWrappers.c"
EFI_FILE_PROTOCOL *
CreateFileInterfaceEnv (
  const CHAR16 *EnvName
  )
{
  ...
  EnvFileInterface->Revision = 0x00010000;
...
# 1421 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleWrappers.c"
void
MoveCursorBackward (
  UINTN LineLength,
  UINTN *Column,
...
# 1452 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleWrappers.c"
void
MoveCursorForward (
  UINTN LineLength,
  UINTN TotalRow,
...
# 1483 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleWrappers.c"
void
PrintCommandHistory (
  const UINTN TotalCols,
  const UINTN TotalRows,
...
# 1557 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleWrappers.c"
EFI_STATUS
...
# 1580 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleWrappers.c"
EFI_STATUS
...
# 1609 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleWrappers.c"
EFI_STATUS
...
# 1651 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleWrappers.c"
EFI_STATUS
  ...
  )
{
  ...
  if (MemFile->Unicode) {
    ...
    if ((UINTN)(MemFile->Position + (*BufferSize)) > (UINTN)(MemFile->BufferSize)) {
      MemFile->Buffer = ReallocatePool ((UINTN)(MemFile->BufferSize), (UINTN)(MemFile->BufferSize) + (*BufferSize) + 1024, MemFile->Buffer);
      if (MemFile->Buffer == ((void *) 0)) {
        return ((RETURN_STATUS)(0x8000000000000000ULL | (9)));
      }

      MemFile->BufferSize += (*BufferSize) + 1024;
    }
    ...
    if ((UINTN)(MemFile->Position + AsciiStrSize (AsciiBuffer)) > (UINTN)(MemFile->BufferSize)) {
      MemFile->Buffer = ReallocatePool ((UINTN)(MemFile->BufferSize), (UINTN)(MemFile->BufferSize) + AsciiStrSize (AsciiBuffer) + 1024, MemFile->Buffer);
      if (MemFile->Buffer == ((void *) 0)) {
        FreePool (AsciiBuffer);
        return ((RETURN_STATUS)(0x8000000000000000ULL | (9)));
      }

      MemFile->BufferSize += AsciiStrSize (AsciiBuffer) + 1024;
    }
...
# 1717 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleWrappers.c"
EFI_STATUS
...
# 1746 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleWrappers.c"
EFI_STATUS
...
{
  do { if ((((EFI_FILE_PROTOCOL_MEM *)This)->Buffer) != ((void *) 0)) { FreePool((((EFI_FILE_PROTOCOL_MEM *)This)->Buffer)); (((EFI_FILE_PROTOCOL_MEM *)This)->Buffer) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
  do { if ((This) != ((void *) 0)) { FreePool((This)); (This) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
  return ((RETURN_STATUS)(0));
}
# 1766 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleWrappers.c"
EFI_FILE_PROTOCOL *
CreateFileInterfaceMem (
  const BOOLEAN Unicode
  )
{
  ...
  FileInterface->Revision = 0x00010000;
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (FileInterface->Buffer == ((void *) 0)); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { (void) (FileInterface->BufferSize == 0); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { (void) (FileInterface->Position == 0); } } while (((BOOLEAN)(0==1)));

  if (Unicode) {
    FileInterface->Buffer = AllocateZeroPool (sizeof (gUnicodeFileTag));
    if (FileInterface->Buffer == ((void *) 0)) {
      FreePool (FileInterface);
      return ((void *) 0);
    }

    *((CHAR16 *)(FileInterface->Buffer)) = (CHAR16) (0xfeff);
...
# 1842 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleWrappers.c"
EFI_STATUS
...
# 1862 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleWrappers.c"
EFI_STATUS
...
# 1890 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleWrappers.c"
EFI_STATUS
...
# 1919 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleWrappers.c"
EFI_STATUS
...
# 1946 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleWrappers.c"
EFI_STATUS
...
# 1969 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleWrappers.c"
EFI_STATUS
  ...
  )
{
  ...
  if (((EFI_FILE_PROTOCOL_FILE *)This)->Unicode) {
    ...
    *BufferSize = *BufferSize / sizeof (CHAR16) * sizeof (CHAR16);
    ...
    if (AsciiStrBuffer == ((void *) 0)) {
      return ((RETURN_STATUS)(0x8000000000000000ULL | (9)));
    }

    UscStrBuffer = AllocateZeroPool ((Size + 1) * sizeof (CHAR16));
    if (UscStrBuffer == ((void *) 0)) {
      do { if ((AsciiStrBuffer) != ((void *) 0)) { FreePool((AsciiStrBuffer)); (AsciiStrBuffer) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
      return ((RETURN_STATUS)(0x8000000000000000ULL | (9)));
    }
    ...
    do { if ((AsciiStrBuffer) != ((void *) 0)) { FreePool((AsciiStrBuffer)); (AsciiStrBuffer) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
    do { if ((UscStrBuffer) != ((void *) 0)) { FreePool((UscStrBuffer)); (UscStrBuffer) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
    return Status;
  }
}
# 2058 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleWrappers.c"
EFI_STATUS
...
# 2080 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleWrappers.c"
EFI_STATUS
...
# 2100 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleWrappers.c"
EFI_STATUS
...
# 2125 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleWrappers.c"
EFI_STATUS
...
# 2170 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Application/Shell/FileHandleWrappers.c"
EFI_FILE_PROTOCOL *
CreateFileInterfaceFile (
  const EFI_FILE_PROTOCOL *Template,
  const BOOLEAN Unicode

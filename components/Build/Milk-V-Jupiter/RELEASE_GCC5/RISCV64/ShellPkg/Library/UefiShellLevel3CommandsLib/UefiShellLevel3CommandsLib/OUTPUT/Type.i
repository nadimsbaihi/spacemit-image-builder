# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/Type.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/Type.c"
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/Type.c"
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/Type.c" 2
# 26 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/Type.c"
EFI_STATUS
TypeFileByHandle (
  SHELL_FILE_HANDLE Handle,
  BOOLEAN Ascii,
  ...
  )
{
  ...
  while (ReadSize == ((UINTN)_gPcd_FixedAtBuild_PcdShellFileOperationSize)) {
  ...
  )
{
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    if ((Status == ((RETURN_STATUS)(0x8000000000000000ULL | (10)))) && (ProblemParam != ((void *) 0))) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0005, gShellLevel3HiiHandle, L"type", ProblemParam);
    ...
    if (AsciiMode && UnicodeMode) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0004, gShellLevel3HiiHandle, L"type", L"-a & -u");
      ShellStatus = SHELL_INVALID_PARAMETER;
    } else if (ShellCommandLineGetRawValue (Package, 1) == ((void *) 0)) {



      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0003, gShellLevel3HiiHandle, L"type");
      ShellStatus = SHELL_INVALID_PARAMETER;
    } else {
      ...
      {
        Status = ShellOpenFileMetaArg ((CHAR16 *)Param, 0x0000000000000001ULL, &FileList);
        if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x000B, gShellLevel3HiiHandle, L"type", (CHAR16 *)Param);
        ...
        if (ShellStatus == SHELL_SUCCESS) {
          ...
          if ((FileList == ((void *) 0)) || IsListEmpty (&FileList->Link)) {
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x000C, gShellLevel3HiiHandle, L"type", Param);
            continue;
          } else {
                  ...
                  )
            {
              ...
              if ((((RETURN_STATUS)(Node->Status)) >= 0x8000000000000000ULL)) {
                ShellPrintHiiEx (-1, -1, ((void *) 0), 0x000B, gShellLevel3HiiHandle, L"type", Node->FileName);
                ShellStatus = SHELL_NOT_FOUND;
                continue;
              }
              ...
              if (FileHandleIsDirectory (Node->Handle) == (RETURN_STATUS)(0)) {
                ShellPrintHiiEx (-1, -1, ((void *) 0), 0x000D, gShellLevel3HiiHandle, L"type", Node->FileName);
                ShellStatus = SHELL_NOT_FOUND;
                continue;
              }
              ...
              if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
                ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0010, gShellLevel3HiiHandle, L"type", Node->FileName);
                ShellStatus = SHELL_INVALID_PARAMETER;
              }

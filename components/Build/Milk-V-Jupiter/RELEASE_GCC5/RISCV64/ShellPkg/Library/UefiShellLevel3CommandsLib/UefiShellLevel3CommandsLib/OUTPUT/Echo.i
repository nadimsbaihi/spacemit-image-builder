# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/Echo.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/Echo.c"
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/Echo.c"
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/Echo.c" 2
  ...
  )
{
  ...
  Status = ShellCommandLineParseEx (ParamList, &Package, &ProblemParam, ((BOOLEAN)(1==1)), ((BOOLEAN)(1==1)));
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    if ((Status == ((RETURN_STATUS)(0x8000000000000000ULL | (10)))) && (ProblemParam != ((void *) 0))) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0005, gShellLevel3HiiHandle, L"echo", ProblemParam);
    ...
    if (ShellCommandLineGetFlag (Package, L"-on")) {
      ...
      ShellCommandSetEchoState (((BOOLEAN)(1==1)));
      ...
      if (ShellCommandGetEchoState ()) {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0015, gShellLevel3HiiHandle);
      } else {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0016, gShellLevel3HiiHandle);
      }
    } else {
            ...
            )
      {
        ...
        if (ShellCommandLineGetRawValue (Package, ParamCount+1) != ((void *) 0)) {
          StrnCatGrow (&PrintString, &Size, L" ", 0);
        }
      }

      ShellPrintEx (-1, -1, L"%s\r\n", PrintString);
      do { if ((PrintString) != ((void *) 0)) { FreePool((PrintString)); (PrintString) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
    }

# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/Touch.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/Touch.c"
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/Touch.c"
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/Touch.c" 2
# 22 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/Touch.c"
EFI_STATUS
TouchFileByHandle (
  SHELL_FILE_HANDLE Handle
  )
{
  ...
  Status = gRT->GetTime (&FileInfo->ModificationTime, ((void *) 0));
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0005, gShellLevel3HiiHandle, L"gRT->GetTime", Status);
...
# 61 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/Touch.c"
EFI_STATUS
DoTouchByHandle (
  const CHAR16 *Name,
  CHAR16 *FS,
  ...
  )
{
  ...
  if (FS == ((void *) 0)) {
    FS = StrnCatGrow (&FS, ((void *) 0), Name, 0);
    if (FS != ((void *) 0)) {
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x000B, gShellLevel3HiiHandle, L"touch", Name);
    return (Status);
  }
  ...
  if ((FileHandleIsDirectory (Handle) == (RETURN_STATUS)(0)) && Rec) {



    if ((((RETURN_STATUS)(gEfiShellProtocol->FindFilesInDir (Handle, &FileList))) >= 0x8000000000000000ULL)) {
    ...
    for (Walker = (EFI_SHELL_FILE_INFO *)GetFirstNode (&FileList->Link)
         ; FileList != ((void *) 0) && !IsNull (&FileList->Link, &Walker->Link) && !(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)
         ...
         )
    {
            ...
            )
      {
        ...
        Status = gEfiShellProtocol->OpenFileByName (Walker->FullName, &Walker->Handle, 0x0000000000000001ULL|0x0000000000000002ULL);
        if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x000B, gShellLevel3HiiHandle, L"touch", Walker->FullName);
          Status = ((RETURN_STATUS)(0x8000000000000000ULL | (15)));
        } else {
          Status = DoTouchByHandle (Walker->FullName, FS, Walker->Handle, ((BOOLEAN)(1==1)));
          gEfiShellProtocol->CloseFile (Walker->Handle);
          Walker->Handle = ((void *) 0);
        }
      }
    }
    ...
    if ((FileList != ((void *) 0)) && (((RETURN_STATUS)(gEfiShellProtocol->FreeFileList (&FileList))) >= 0x8000000000000000ULL)) {
      Status = ((RETURN_STATUS)(0x8000000000000000ULL | (2)));
    }
  }
  ...
  )
{
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    if ((Status == ((RETURN_STATUS)(0x8000000000000000ULL | (10)))) && (ProblemParam != ((void *) 0))) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0005, gShellLevel3HiiHandle, L"touch", ProblemParam);
    ...
    if (ShellCommandLineGetRawValue (Package, 1) == ((void *) 0)) {
      ...
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0003, gShellLevel3HiiHandle, L"touch");
      ShellStatus = SHELL_INVALID_PARAMETER;
    } else {
      ...
      {
        Status = ShellOpenFileMetaArg ((CHAR16 *)Param, 0x0000000000000001ULL|0x0000000000000002ULL, &FileList);
        if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0004, gShellLevel3HiiHandle, L"touch", (CHAR16 *)Param);
        ...
        if (ShellStatus == SHELL_SUCCESS) {
          ...
          if ((FileList == ((void *) 0)) || IsListEmpty (&FileList->Link)) {
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x000C, gShellLevel3HiiHandle, L"touch", Param);
            continue;
          } else {
                  ...
                  )
            {
              ...
              if ((((RETURN_STATUS)(Node->Status)) >= 0x8000000000000000ULL)) {
                ShellPrintHiiEx (-1, -1, ((void *) 0), 0x000B, gShellLevel3HiiHandle, L"touch", Node->FileName);
                ShellStatus = SHELL_NOT_FOUND;
                continue;
              }

              Status = DoTouchByHandle (Node->FullName, ((void *) 0), Node->Handle, ShellCommandLineGetFlag (Package, L"-r"));
              if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) && (Status != ((RETURN_STATUS)(0x8000000000000000ULL | (15))))) {
                ShellPrintHiiEx (-1, -1, ((void *) 0), 0x000B, gShellLevel3HiiHandle, L"touch", Node->FileName);
                ShellStatus = SHELL_NOT_FOUND;
              }
            }

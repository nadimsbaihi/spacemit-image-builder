# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/Cls.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/Cls.c"
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/Cls.c"
...
# 12 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/Cls.c" 2
  ...
  )
{
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    if ((Status == ((RETURN_STATUS)(0x8000000000000000ULL | (10)))) && (ProblemParam != ((void *) 0))) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0005, gShellLevel3HiiHandle, L"cls", ProblemParam);
    ...
    if (ShellCommandLineGetFlag (Package, L"-?")) {
      ...
      if (ShellCommandLineGetCount (Package) > 1) {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0002, gShellLevel3HiiHandle, L"cls");
        ShellStatus = SHELL_INVALID_PARAMETER;
      } else {
        Background = (gST->ConOut->Mode->Attribute >> 4) & 0x7;
        Foreground = gST->ConOut->Mode->Attribute & 0x0F;
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x000E, gShellLevel3HiiHandle, L"cls");
        ShellPrintHiiEx (
          -1,
          -1,
          ((void *) 0),
      ...
      if ((BackColorStr == ((void *) 0)) && (ForeColorStr == ((void *) 0))) {
          ...
          if ((ShellStrToUintn (BackColorStr) > 7) || (StrLen (BackColorStr) > 1) || (!ShellIsDecimalDigitCharacter (*BackColorStr))) {
            ...
            switch (ShellStrToUintn (BackColorStr)) {
              ...
              case 2:
                ...
                break;
              case 3:
                Background = (0x10 | 0x20);
                break;
              case 4:
                Background = 0x40;
                break;
              case 5:
                Background = (0x10 | 0x40);
                break;
              case 6:
                Background = (0x20 | 0x40);
                break;
              case 7:
                Background = (0x10 | 0x20 | 0x40);
                break;
            }

            if (ForeColorStr != ((void *) 0)) {
              if ((ShellStrToUintn (ForeColorStr) > 15) || (StrLen (ForeColorStr) > 2) || (!ShellIsDecimalDigitCharacter (*ForeColorStr))) {
                ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0004, gShellLevel3HiiHandle, L"cls", ForeColorStr);
                ShellStatus = SHELL_INVALID_PARAMETER;
              } else {
                switch (ShellStrToUintn (ForeColorStr)) {
                  ...
                  case 2:
                    ...
                    break;
                  case 3:
                    Foreground = (0x01 | 0x02);
                    break;
                  case 4:
                    Foreground = 0x04;
                    break;
                  case 5:
                    Foreground = (0x01 | 0x04);
                    break;
                  case 6:
                    Foreground = (0x02 | 0x04);
                    break;
                  case 7:
                    Foreground = (0x01 | 0x02 | 0x04);
                    break;
                  case 8:
                    Foreground = (0x00 | 0x08);
                    break;
                  case 9:
                    Foreground = (0x01 | 0x08);
                    break;
                  case 10:
                    Foreground = (0x02 | 0x08);
                    break;
                  case 11:
                    Foreground = ((0x01 | 0x02) | 0x08);
                    break;
                  case 12:
                    Foreground = (0x04 | 0x08);
                    break;
                  case 13:
                    Foreground = ((0x01 | 0x04) | 0x08);
                    break;
                  case 14:
                    Foreground = ((0x02 | 0x04) | 0x08);
                    break;
                  case 15:
                    Foreground = (0x01 | 0x02 | 0x04 | 0x08);
                    break;
                }
              }
            } else {

# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/UefiShellLevel3CommandsLib.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/UefiShellLevel3CommandsLib.c"
# 9 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/UefiShellLevel3CommandsLib.c"
...
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/UefiShellLevel3CommandsLib.c" 2

const CHAR16 gShellLevel3FileName[] = L"ShellCommands";
EFI_HII_HANDLE gShellLevel3HiiHandle = ((void *) 0);
...
# 39 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/UefiShellLevel3CommandsLib.c"
EFI_STATUS
  ...
  )
{
  ...
  gShellLevel3HiiHandle = HiiAddPackages (&gShellLevel3HiiGuid, gImageHandle, UefiShellLevel3CommandsLibStrings, ((void *) 0));
  if (gShellLevel3HiiHandle == ((void *) 0)) {
  ...
  ShellCommandRegisterCommandName (L"type", ShellCommandRunType, ShellCommandGetManFileNameLevel3, 3, L"", ((BOOLEAN)(1==1)), gShellLevel3HiiHandle, 0x0027);
  ShellCommandRegisterCommandName (L"touch", ShellCommandRunTouch, ShellCommandGetManFileNameLevel3, 3, L"", ((BOOLEAN)(1==1)), gShellLevel3HiiHandle, 0x0026);
  ShellCommandRegisterCommandName (L"ver", ShellCommandRunVer, ShellCommandGetManFileNameLevel3, 3, L"", ((BOOLEAN)(1==1)), gShellLevel3HiiHandle, 0x0028);
  ShellCommandRegisterCommandName (L"alias", ShellCommandRunAlias, ShellCommandGetManFileNameLevel3, 3, L"", ((BOOLEAN)(1==1)), gShellLevel3HiiHandle, 0x0021);
  ShellCommandRegisterCommandName (L"cls", ShellCommandRunCls, ShellCommandGetManFileNameLevel3, 3, L"", ((BOOLEAN)(1==1)), gShellLevel3HiiHandle, 0x0022);
  ShellCommandRegisterCommandName (L"echo", ShellCommandRunEcho, ShellCommandGetManFileNameLevel3, 3, L"", ((BOOLEAN)(0==1)), gShellLevel3HiiHandle, 0x0023);
  ShellCommandRegisterCommandName (L"pause", ShellCommandRunPause, ShellCommandGetManFileNameLevel3, 3, L"", ((BOOLEAN)(1==1)), gShellLevel3HiiHandle, 0x0025);
  ShellCommandRegisterCommandName (L"getmtc", ShellCommandRunGetMtc, ShellCommandGetManFileNameLevel3, 3, L"", ((BOOLEAN)(1==1)), gShellLevel3HiiHandle, 0x0024);
  ShellCommandRegisterCommandName (L"help", ShellCommandRunHelp, ShellCommandGetManFileNameLevel3, 3, L"", ((BOOLEAN)(1==1)), gShellLevel3HiiHandle, 0x0020);

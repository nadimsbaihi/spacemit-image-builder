# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/Ver.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/Ver.c"
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/Ver.c"
...
# 12 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/Ver.c" 2
  ...
  )
{
  ...
  Level = _gPcd_FixedAtBuild_PcdShellSupportLevel;
  ProblemParam = ((void *) 0);
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    if ((Status == ((RETURN_STATUS)(0x8000000000000000ULL | (10)))) && (ProblemParam != ((void *) 0))) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0005, gShellLevel3HiiHandle, L"ver", ProblemParam);
    ...
    if (ShellCommandLineGetRawValue (Package, 1) != ((void *) 0)) {
      ...
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0002, gShellLevel3HiiHandle, L"ver");
      ShellStatus = SHELL_INVALID_PARAMETER;
    } else {
      if (ShellCommandLineGetFlag (Package, L"-s")) {
        if (ShellCommandLineGetFlag (Package, L"-terse") || ShellCommandLineGetFlag (Package, L"-t")) {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x000A, gShellLevel3HiiHandle, L"ver", L"-t or -terse", L"-s");
          ShellStatus = SHELL_INVALID_PARAMETER;
        } else {
          ShellPrintHiiEx (
            0,

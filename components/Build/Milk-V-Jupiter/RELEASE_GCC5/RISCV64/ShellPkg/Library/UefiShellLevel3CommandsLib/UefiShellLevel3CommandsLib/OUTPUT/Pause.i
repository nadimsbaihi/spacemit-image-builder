# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/Pause.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/Pause.c"
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/Pause.c"
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/Pause.c" 2
  ...
  )
{
  ...
  if (!gEfiShellProtocol->BatchIsActive ()) {
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x000F, gShellLevel3HiiHandle, L"pause");
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    if ((Status == ((RETURN_STATUS)(0x8000000000000000ULL | (10)))) && (ProblemParam != ((void *) 0))) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0005, gShellLevel3HiiHandle, L"pause", ProblemParam);
    ...
    if (ShellCommandLineGetFlag (Package, L"-?")) {
      ...
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0002, gShellLevel3HiiHandle, L"pause");
      ShellStatus = SHELL_INVALID_PARAMETER;
    } else {
      if (!ShellCommandLineGetFlag (Package, L"-q")) {
        Status = ShellPromptForResponseHii (ShellPromptResponseTypeQuitContinue, 0x0017, gShellLevel3HiiHandle, (void **)&Resp);
      } else {
        Status = ShellPromptForResponse (ShellPromptResponseTypeQuitContinue, ((void *) 0), (void **)&Resp);
      }

      if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) || (Resp == ((void *) 0)) || (*Resp == ShellPromptResponseQuit)) {
        ShellCommandRegisterExit (((BOOLEAN)(1==1)), 0);

...
.Ltext0:
	...
	.file 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/ShellPkg/Library/UefiShellLevel3CommandsLib/UefiShellLevel3CommandsLib" "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/Alias.c"
	.section	.rodata
	.align	3
.LC0:
	.string	"a"
	...
	.string	"s"
	.zero	2
	.section	.text.PrintSingleShellAlias,"ax",@progbits
	.align	1
	.globl	PrintSingleShellAlias
	.type	PrintSingleShellAlias, @function
PrintSingleShellAlias:
.LFB0:
	.file 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/Alias.c"
	.loc 1 26 1
	.cfi_startproc
	addi	sp,sp,-64
...
.L3:
	...
	.cfi_endproc
.LFE0:
	.size	PrintSingleShellAlias, .-PrintSingleShellAlias
	.section	.rodata
	.align	3
.LC1:
	.string	";"
	.zero	2
	.section	.text.PrintAllShellAlias,"ax",@progbits
	.align	1
	.globl	PrintAllShellAlias
	.type	PrintAllShellAlias, @function
PrintAllShellAlias:
.LFB1:
	.loc 1 57 1
	.cfi_startproc
...
.L9:
	...
	call	StrSize@plt
	mv	a5,a0
	.loc 1 67 11 is_stmt 0 discriminator 1
	mv	a0,a5
...
.L10:
	...
	.cfi_endproc
.LFE1:
	.size	PrintAllShellAlias, .-PrintAllShellAlias
	.section	.text.ShellLevel3CommandsLibSetAlias,"ax",@progbits
	.align	1
	.globl	ShellLevel3CommandsLibSetAlias
	.type	ShellLevel3CommandsLibSetAlias, @function
...
.L16:
	...
	.cfi_endproc
.LFE2:
	.size	ShellLevel3CommandsLibSetAlias, .-ShellLevel3CommandsLibSetAlias
	.section	.rodata
	.align	3
.LC2:
	.string	"-"
...
ParamList:
	...
	.word	7
	.zero	4
	.section	.text.ShellCommandRunAlias,"ax",@progbits
	.align	1
	.globl	ShellCommandRunAlias
	.type	ShellCommandRunAlias, @function
...
.LFB3:
	...
	addi	a5,a5,10
	bne	a4,a5,.L22
	.loc 1 188 86 discriminator 1
	ld	a5,-104(s0)
	.loc 1 188 69 discriminator 1
	beq	a5,zero,.L22
	.loc 1 189 7
	la	a5,gShellLevel3HiiHandle
	ld	a4,0(a5)
...
.L21:
	...
	call	StrSize@plt
	mv	a5,a0
	.loc 1 203 21 is_stmt 0 discriminator 1
	ld	a1,-72(s0)
	mv	a0,a5
...
.L24:
	...
	call	StrSize@plt
	mv	a5,a0
	.loc 1 211 70 discriminator 1
	addi	a5,a5,-2
	.loc 1 211 9 discriminator 1
	mv	a2,a5
	mv	a1,s1
	ld	a0,-48(s0)
	call	CopyMem@plt
...
.L27:
	...
	ld	a1,-64(s0)
	ld	a0,-48(s0)
	call	ShellLevel3CommandsLibSetAlias
	mv	a5,a0
	sw	a5,-36(s0)
	.loc 1 234 11
	j	.L31
...
.L43:
	...
	.cfi_endproc
.LFE3:
	.size	ShellCommandRunAlias, .-ShellCommandRunAlias
	.text
.Letext0:
	...
	.file 14 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/UefiShellLevel3CommandsLib.h"
...
.LASF26:
	.string	"Data4"
.LASF460:
	.string	"ShellLevel3CommandsLibSetAlias"
.LASF33:
	.string	"EFI_EVENT"
.LASF399:
	.string	"ReadFile"
...
.LASF0:
	.string	"/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/Alias.c"

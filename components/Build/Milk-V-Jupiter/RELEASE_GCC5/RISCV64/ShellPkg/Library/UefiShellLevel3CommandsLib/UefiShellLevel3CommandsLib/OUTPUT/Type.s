...
.Ltext0:
	...
	.file 0 "/home/kapoagaeming/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/ShellPkg/Library/UefiShellLevel3CommandsLib/UefiShellLevel3CommandsLib" "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/Type.c"
	.section	.rodata
	.align	3
.LC0:
	.string	"\r"
...
.LC1:
	...
	.string	"c"
	.zero	2
	.section	.text.TypeFileByHandle,"ax",@progbits
	.align	1
	.globl	TypeFileByHandle
	.type	TypeFileByHandle, @function
TypeFileByHandle:
.LFB0:
	.file 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/Type.c"
	.loc 1 32 1
	.cfi_startproc
	addi	sp,sp,-96
...
.L33:
	...
	.cfi_endproc
.LFE0:
	.size	TypeFileByHandle, .-TypeFileByHandle
	.section	.rodata
	.align	3
.LC2:
	.string	"-"
...
.LC6:
	...
	.string	"u"
	.zero	2
	.section	.text.ShellCommandRunType,"ax",@progbits
	.align	1
	.globl	ShellCommandRunType
	.type	ShellCommandRunType, @function
ShellCommandRunType:
.LFB1:
	.loc 1 178 1
	.cfi_startproc
	...
	addi	a5,a5,10
	bne	a4,a5,.L40
	.loc 1 209 86 discriminator 1
	ld	a5,-80(s0)
	.loc 1 209 69 discriminator 1
	beq	a5,zero,.L40
	.loc 1 210 7
...
.L45:
	...
	.loc 1 261 14
	beq	a5,zero,.L47
	.loc 1 261 67 discriminator 2
	ld	a5,-88(s0)
	.loc 1 261 45 discriminator 2
	mv	a0,a5
	call	IsListEmpty@plt
	mv	a5,a0
	.loc 1 261 42 discriminator 3
	beq	a5,zero,.L48
.L47:
	.loc 1 262 13
	la	a5,gShellLevel3HiiHandle
...
.L50:
	...
	call	IsNull@plt
	mv	a5,a0
	.loc 1 269 60 discriminator 1
	bne	a5,zero,.L46
	.loc 1 269 64 discriminator 2
	call	ShellGetExecutionBreakFlag@plt
	mv	a5,a0
	.loc 1 269 60 discriminator 3
	beq	a5,zero,.L55
	j	.L46
.L61:
	.loc 1 274 17
...
.L60:
	...
	.cfi_endproc
.LFE1:
	.size	ShellCommandRunType, .-ShellCommandRunType
	.text
.Letext0:
	...
	.file 15 "/home/kapoagaeming/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/ShellPkg/Library/UefiShellLevel3CommandsLib/UefiShellLevel3CommandsLib/DEBUG/AutoGen.h"
	.file 16 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdePkg/Include/Library/FileHandleLib.h"
	.file 17 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/UefiShellLevel3CommandsLib.h"
...
.LASF0:
	.string	"/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/Type.c"

# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/Alias.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/Alias.c"
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/Alias.c"
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/Alias.c" 2
# 22 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/Alias.c"
SHELL_STATUS
  ...
  )
{
  ...
  if (ConstAliasVal == ((void *) 0)) {
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0004, gShellLevel3HiiHandle, L"alias", Alias);
    ...
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x001D, gShellLevel3HiiHandle, !Volatile ? L' ' : L'*', Alias, ConstAliasVal);
  }
  ...
  )
{
  ...
  ConstAllAliasList = gEfiShellProtocol->GetAlias (((void *) 0), ((void *) 0));
  if (ConstAllAliasList == ((void *) 0)) {
...
# 111 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/Alias.c"
SHELL_STATUS
  ...
  )
{
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    if (Status == ((RETURN_STATUS)(0x8000000000000000ULL | (15)))) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0006, gShellLevel3HiiHandle, L"alias");
      ShellStatus = SHELL_ACCESS_DENIED;
    } else if (Status == ((RETURN_STATUS)(0x8000000000000000ULL | (14)))) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0007, gShellLevel3HiiHandle, L"alias", Command);
      ShellStatus = SHELL_NOT_FOUND;
    } else {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0008, gShellLevel3HiiHandle, L"alias", Status);
  ...
  )
{
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    if ((Status == ((RETURN_STATUS)(0x8000000000000000ULL | (10)))) && (ProblemParam != ((void *) 0))) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0005, gShellLevel3HiiHandle, L"alias", ProblemParam);
    ...
    if (!DeleteFlag && !VolatileFlag) {
      switch (ShellCommandLineGetCount (Package)) {
        ...
        case 3:
          ...
          ShellStatus = ShellLevel3CommandsLibSetAlias (CleanParam2, Param1, ((BOOLEAN)(0==1)), VolatileFlag);
          break;
        default:
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0002, gShellLevel3HiiHandle, L"alias");
          ShellStatus = SHELL_INVALID_PARAMETER;
      }
    } else if (DeleteFlag) {
      if (VolatileFlag || (ShellCommandLineGetCount (Package) > 1)) {
        ...
        if (ParamStrD == ((void *) 0)) {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0003, gShellLevel3HiiHandle, L"alias");
          ShellStatus = SHELL_INVALID_PARAMETER;
        } else {



          ShellStatus = ShellLevel3CommandsLibSetAlias (ParamStrD, ((void *) 0), ((BOOLEAN)(1==1)), ((BOOLEAN)(0==1)));
        }
      }
    } else {
      ...
      do { if (((BOOLEAN)(0==1))) { (void) (VolatileFlag); } } while (((BOOLEAN)(0==1)));
      do { if (((BOOLEAN)(0==1))) { (void) (!DeleteFlag); } } while (((BOOLEAN)(0==1)));
      switch (ShellCommandLineGetCount (Package)) {
        case 1:
        case 2:
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0003, gShellLevel3HiiHandle, L"alias");
  ...
  do { if ((CleanParam2) != ((void *) 0)) { FreePool((CleanParam2)); (CleanParam2) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
  return (ShellStatus);
}

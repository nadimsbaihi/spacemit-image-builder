...
.Ltext0:
	...
	.file 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/ShellPkg/Library/UefiShellLevel3CommandsLib/UefiShellLevel3CommandsLib" "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/Cls.c"
	.section	.rodata
	.align	3
.LC0:
	.string	"-"
...
.LC2:
	...
	.string	"?"
	.zero	2
	.section	.text.ShellCommandRunCls,"ax",@progbits
	.align	1
	.globl	ShellCommandRunCls
	.type	ShellCommandRunCls, @function
ShellCommandRunCls:
.LFB0:
	.file 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/Cls.c"
	.loc 1 30 1
	.cfi_startproc
	addi	sp,sp,-96
	...
	addi	a5,a5,10
	bne	a4,a5,.L3
	.loc 1 59 86 discriminator 1
	ld	a5,-80(s0)
	.loc 1 59 69 discriminator 1
	beq	a5,zero,.L3
	.loc 1 60 7
...
.L7:
	...
	mv	a4,a0
	.loc 1 108 14 discriminator 1
	li	a5,7
	bgtu	a4,a5,.L8
	.loc 1 108 56 discriminator 2
	ld	a0,-56(s0)
	call	StrLen@plt
	mv	a4,a0
	.loc 1 108 52 discriminator 3
	li	a5,1
	bgtu	a4,a5,.L8
	.loc 1 108 88 discriminator 4
	ld	a5,-56(s0)
	lhu	a5,0(a5)
	mv	a0,a5
	call	ShellIsDecimalDigitCharacter@plt
	mv	a5,a0
	.loc 1 108 83 discriminator 5
	bne	a5,zero,.L9
.L8:
	.loc 1 109 13
	la	a5,gShellLevel3HiiHandle
...
.L11:
	...
	call	ShellStrToUintn@plt
	mv	a4,a0
	.loc 1 140 18 discriminator 1
	li	a5,15
	bgtu	a4,a5,.L20
	.loc 1 140 61 discriminator 2
	ld	a0,-64(s0)
	call	StrLen@plt
	mv	a4,a0
	.loc 1 140 57 discriminator 3
	li	a5,2
	bgtu	a4,a5,.L20
	.loc 1 140 93 discriminator 4
	ld	a5,-64(s0)
	lhu	a5,0(a5)
	mv	a0,a5
	call	ShellIsDecimalDigitCharacter@plt
	mv	a5,a0
	.loc 1 140 88 discriminator 5
	bne	a5,zero,.L21
.L20:
	.loc 1 141 17
	la	a5,gShellLevel3HiiHandle
...
.L3:
	...
	.cfi_endproc
.LFE0:
	.size	ShellCommandRunCls, .-ShellCommandRunCls
	.text
.Letext0:
	...
	.file 16 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/UefiShellLevel3CommandsLib.h"
...
.LASF0:
	.string	"/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/Cls.c"

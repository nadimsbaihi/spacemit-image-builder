...
.Ltext0:
	...
	.file 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/ShellPkg/Library/UefiShellLevel3CommandsLib/UefiShellLevel3CommandsLib" "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/Echo.c"
	.section	.rodata
	.align	3
.LC0:
	.string	"-"
...
.LC5:
	...
	.string	"\n"
	.zero	2
	.section	.text.ShellCommandRunEcho,"ax",@progbits
	.align	1
	.globl	ShellCommandRunEcho
	.type	ShellCommandRunEcho, @function
ShellCommandRunEcho:
.LFB0:
	.file 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/Echo.c"
	.loc 1 32 1
	.cfi_startproc
	addi	sp,sp,-96
	...
	addi	a5,a5,10
	bne	a4,a5,.L3
	.loc 1 57 86 discriminator 1
	ld	a5,-56(s0)
	.loc 1 57 69 discriminator 1
	beq	a5,zero,.L3
	.loc 1 58 7
...
.L11:
	...
	call	ShellCommandLineGetRawValue@plt
	mv	a2,a0
	.loc 1 100 9 is_stmt 0 discriminator 1
	addi	a4,s0,-64
	addi	a5,s0,-72
	li	a3,0
	mv	a1,a4
...
.L3:
	...
	.cfi_endproc
.LFE0:
	.size	ShellCommandRunEcho, .-ShellCommandRunEcho
	.text
.Letext0:
...
.LASF0:
	.string	"/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel3CommandsLib/Echo.c"
.LASF1:

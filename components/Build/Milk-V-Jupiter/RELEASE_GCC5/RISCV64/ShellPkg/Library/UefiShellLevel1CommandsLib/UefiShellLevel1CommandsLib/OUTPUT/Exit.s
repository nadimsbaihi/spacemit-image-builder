...
.Ltext0:
	...
	.file 0 "/home/kapoagaeming/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/ShellPkg/Library/UefiShellLevel1CommandsLib/UefiShellLevel1CommandsLib" "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel1CommandsLib/Exit.c"
	.section	.rodata
	.align	3
.LC0:
	.string	"/"
...
.LC1:
	...
	.string	"t"
	.zero	2
	.section	.text.ShellCommandRunExit,"ax",@progbits
	.align	1
	.globl	ShellCommandRunExit
	.type	ShellCommandRunExit, @function
ShellCommandRunExit:
.LFB0:
	.file 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel1CommandsLib/Exit.c"
	.loc 1 29 1
	.cfi_startproc
	addi	sp,sp,-80
	...
	addi	a5,a5,10
	bne	a4,a5,.L3
	.loc 1 53 86 discriminator 1
	ld	a5,-56(s0)
	.loc 1 53 69 discriminator 1
	beq	a5,zero,.L3
	.loc 1 54 7
...
.LVL0:
	...
	mv	a5,a0
	.loc 1 74 81 discriminator 4
	beq	a5,zero,.L7
	.loc 1 74 81 is_stmt 0 discriminator 5
	li	a5,1
	.loc 1 74 81
	j	.L8
.L7:
	.loc 1 74 81 discriminator 6
	li	a5,0
.L8:
	.loc 1 74 9 is_stmt 1 discriminator 8
	andi	a5,a5,0xff
	ld	a4,-64(s0)
	mv	a1,a4
	mv	a0,a5
...
.LVL1:
	...
	beq	a5,zero,.L9
	.loc 1 81 82 discriminator 2
	ld	a5,-48(s0)
	lla	a1,.LC0
	mv	a0,a5
	call	ShellCommandLineGetFlag@plt
	mv	a5,a0
	.loc 1 81 79 discriminator 4
	beq	a5,zero,.L9
	.loc 1 81 79 is_stmt 0 discriminator 5
	li	a5,1
	.loc 1 81 79
	j	.L10
.L9:
	.loc 1 81 79 discriminator 6
	li	a5,0
.L10:
	.loc 1 81 7 is_stmt 1 discriminator 8
	andi	a5,a5,0xff
	li	a1,0
	mv	a0,a5
	call	ShellCommandRegisterExit@plt
...
.L3:
	...
	.cfi_endproc
.LFE0:
	.size	ShellCommandRunExit, .-ShellCommandRunExit
	.text
.Letext0:
	...
	.file 14 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel1CommandsLib/UefiShellLevel1CommandsLib.h"
...
.LASF0:
	.string	"/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel1CommandsLib/Exit.c"

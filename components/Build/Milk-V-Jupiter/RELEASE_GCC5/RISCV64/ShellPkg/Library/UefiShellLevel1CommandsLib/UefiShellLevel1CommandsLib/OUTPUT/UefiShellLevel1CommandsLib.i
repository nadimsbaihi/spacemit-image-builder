# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel1CommandsLib/UefiShellLevel1CommandsLib.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel1CommandsLib/UefiShellLevel1CommandsLib.c"
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel1CommandsLib/UefiShellLevel1CommandsLib.c"
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel1CommandsLib/UefiShellLevel1CommandsLib.c" 2

static const CHAR16 mFileName[] = L"ShellCommands";
EFI_HII_HANDLE gShellLevel1HiiHandle = ((void *) 0);
...
# 40 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel1CommandsLib/UefiShellLevel1CommandsLib.c"
EFI_STATUS
  ...
  )
{
  ...
  gShellLevel1HiiHandle = HiiAddPackages (&gShellLevel1HiiGuid, gImageHandle, UefiShellLevel1CommandsLibStrings, ((void *) 0));
  if (gShellLevel1HiiHandle == ((void *) 0)) {
  ...
  ShellCommandRegisterCommandName (L"stall", ShellCommandRunStall, ShellCommandGetManFileNameLevel1, 1, L"", ((BOOLEAN)(0==1)), gShellLevel1HiiHandle, (EFI_STRING_ID)(_gPcd_FixedAtBuild_PcdShellSupportLevel < 3 ? 0 : 0x0018));
  ShellCommandRegisterCommandName (L"for", ShellCommandRunFor, ShellCommandGetManFileNameLevel1, 1, L"", ((BOOLEAN)(0==1)), gShellLevel1HiiHandle, (EFI_STRING_ID)(_gPcd_FixedAtBuild_PcdShellSupportLevel < 3 ? 0 : 0x0011));
  ShellCommandRegisterCommandName (L"goto", ShellCommandRunGoto, ShellCommandGetManFileNameLevel1, 1, L"", ((BOOLEAN)(0==1)), gShellLevel1HiiHandle, (EFI_STRING_ID)(_gPcd_FixedAtBuild_PcdShellSupportLevel < 3 ? 0 : 0x0013));
  ShellCommandRegisterCommandName (L"if", ShellCommandRunIf, ShellCommandGetManFileNameLevel1, 1, L"", ((BOOLEAN)(0==1)), gShellLevel1HiiHandle, (EFI_STRING_ID)(_gPcd_FixedAtBuild_PcdShellSupportLevel < 3 ? 0 : 0x0015));
  ShellCommandRegisterCommandName (L"shift", ShellCommandRunShift, ShellCommandGetManFileNameLevel1, 1, L"", ((BOOLEAN)(0==1)), gShellLevel1HiiHandle, (EFI_STRING_ID)(_gPcd_FixedAtBuild_PcdShellSupportLevel < 3 ? 0 : 0x0016));
  ShellCommandRegisterCommandName (L"exit", ShellCommandRunExit, ShellCommandGetManFileNameLevel1, 1, L"", ((BOOLEAN)(1==1)), gShellLevel1HiiHandle, (EFI_STRING_ID)(_gPcd_FixedAtBuild_PcdShellSupportLevel < 3 ? 0 : 0x0010));
  ShellCommandRegisterCommandName (L"else", ShellCommandRunElse, ShellCommandGetManFileNameLevel1, 1, L"", ((BOOLEAN)(0==1)), gShellLevel1HiiHandle, (EFI_STRING_ID)(_gPcd_FixedAtBuild_PcdShellSupportLevel < 3 ? 0 : 0x0017));
  ShellCommandRegisterCommandName (L"endif", ShellCommandRunEndIf, ShellCommandGetManFileNameLevel1, 1, L"", ((BOOLEAN)(0==1)), gShellLevel1HiiHandle, (EFI_STRING_ID)(_gPcd_FixedAtBuild_PcdShellSupportLevel < 3 ? 0 : 0x0014));
  ShellCommandRegisterCommandName (L"endfor", ShellCommandRunEndFor, ShellCommandGetManFileNameLevel1, 1, L"", ((BOOLEAN)(0==1)), gShellLevel1HiiHandle, (EFI_STRING_ID)(_gPcd_FixedAtBuild_PcdShellSupportLevel < 3 ? 0 : 0x0012));
...
# 118 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel1CommandsLib/UefiShellLevel1CommandsLib.c"
BOOLEAN
TestNodeForMove (
  const LIST_MANIP_FUNC Function,
  const CHAR16 *DecrementerTag,
  ...
  const BOOLEAN MovePast,
  const BOOLEAN FindOnly,
  const SCRIPT_COMMAND_LIST *CommandNode,
  UINTN *TargetCount
  )
{
  BOOLEAN Found;
...
# 249 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel1CommandsLib/UefiShellLevel1CommandsLib.c"
BOOLEAN
MoveToTag (
  const LIST_MANIP_FUNC Function,
  const CHAR16 *DecrementerTag,
  ...
  )
{
  ...
  for (CommandNode = (SCRIPT_COMMAND_LIST *)(*Function)(&ScriptFile->CommandList, &ScriptFile->CurrentCommand->Link), Found = ((BOOLEAN)(0==1))
  ...
  if (WrapAroundScript && !Found) {
    for (CommandNode = (SCRIPT_COMMAND_LIST *)GetFirstNode (&ScriptFile->CommandList), Found = ((BOOLEAN)(0==1))

# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel1CommandsLib/Shift.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel1CommandsLib/Shift.c"
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel1CommandsLib/Shift.c"
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel1CommandsLib/Shift.c" 2
  ...
  )
{
  ...
  if (!gEfiShellProtocol->BatchIsActive ()) {
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0002, gShellLevel1HiiHandle, L"shift");
  ...
  if (CurrentScriptFile->Argc < 2) {
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0006, gShellLevel1HiiHandle, L"shift");
    return (SHELL_UNSUPPORTED);
  }

  for (LoopVar = 0; LoopVar < CurrentScriptFile->Argc; LoopVar++) {
    if (LoopVar == 0) {
      do { if ((CurrentScriptFile->Argv[LoopVar]) != ((void *) 0)) { FreePool((CurrentScriptFile->Argv[LoopVar])); (CurrentScriptFile->Argv[LoopVar]) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
    }

    if (LoopVar < CurrentScriptFile->Argc -1) {
      CurrentScriptFile->Argv[LoopVar] = CurrentScriptFile->Argv[LoopVar+1];
    } else {
      CurrentScriptFile->Argv[LoopVar] = ((void *) 0);
    }
  }

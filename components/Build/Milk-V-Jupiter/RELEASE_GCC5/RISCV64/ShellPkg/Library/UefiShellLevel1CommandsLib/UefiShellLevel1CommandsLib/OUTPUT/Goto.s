...
.Ltext0:
	...
	.file 0 "/home/kapoagaeming/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/ShellPkg/Library/UefiShellLevel1CommandsLib/UefiShellLevel1CommandsLib" "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel1CommandsLib/Goto.c"
	.section	.rodata
	.align	3
.LC0:
	.string	"G"
...
.LC4:
	...
	.string	"r"
	.zero	2
	.section	.text.ShellCommandRunGoto,"ax",@progbits
	.align	1
	.globl	ShellCommandRunGoto
	.type	ShellCommandRunGoto, @function
ShellCommandRunGoto:
.LFB0:
	.file 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel1CommandsLib/Goto.c"
	.loc 1 24 1
	.cfi_startproc
	addi	sp,sp,-112
...
.L2:
	...
	addi	a5,a5,10
	bne	a4,a5,.L5
	.loc 1 55 86 discriminator 1
	ld	a5,-72(s0)
	.loc 1 55 69 discriminator 1
	beq	a5,zero,.L5
	.loc 1 56 7
	la	a5,gShellLevel1HiiHandle
	ld	a4,0(a5)
...
.L8:
	...
	call	ShellCommandLineGetRawValue@plt
	mv	a2,a0
	.loc 1 73 23 is_stmt 0 discriminator 1
	addi	a4,s0,-88
	addi	a5,s0,-80
	li	a3,0
	mv	a1,a4
	...
	call	StrnCatGrow@plt
	mv	a5,a0
	.loc 1 73 21 is_stmt 1 discriminator 2
	sd	a5,-80(s0)
	.loc 1 74 25
	ld	a5,-80(s0)
	.loc 1 74 10
...
.L9:
	...
	mv	a4,a0
	.loc 1 82 12 is_stmt 0 discriminator 1
	li	a7,1
	li	a6,0
	li	a5,0
	mv	a3,s1
	...
	call	MoveToTag@plt
	mv	a5,a0
	.loc 1 82 10 is_stmt 1 discriminator 2
	bne	a5,zero,.L10
	.loc 1 83 29
	call	ShellCommandGetCurrentScriptFile@plt
	sd	a0,-56(s0)
	...
	j	.L12
.L11:
	.loc 1 84 9 is_stmt 0 discriminator 1
	li	a5,0
.L12:
...
.L13:
	...
	.cfi_endproc
.LFE0:
	.size	ShellCommandRunGoto, .-ShellCommandRunGoto
	.text
.Letext0:
	...
	.file 13 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Include/Library/ShellCommandLib.h"
	.file 14 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Include/Library/ShellLib.h"
	.file 15 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel1CommandsLib/UefiShellLevel1CommandsLib.h"
...
.LASF0:
	.string	"/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel1CommandsLib/Goto.c"

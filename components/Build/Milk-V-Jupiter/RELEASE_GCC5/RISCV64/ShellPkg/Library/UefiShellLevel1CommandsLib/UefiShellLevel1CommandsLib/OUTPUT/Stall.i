# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel1CommandsLib/Stall.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel1CommandsLib/Stall.c"
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel1CommandsLib/Stall.c"
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel1CommandsLib/Stall.c" 2
  ...
  )
{
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    if ((Status == ((RETURN_STATUS)(0x8000000000000000ULL | (10)))) && (ProblemParam != ((void *) 0))) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0003, gShellLevel1HiiHandle, L"stall", ProblemParam);
    ...
    if (ShellCommandLineGetRawValue (Package, 2) != ((void *) 0)) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0007, gShellLevel1HiiHandle, L"stall");
      ShellStatus = SHELL_INVALID_PARAMETER;
    } else if (ShellCommandLineGetRawValue (Package, 1) == ((void *) 0)) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0006, gShellLevel1HiiHandle, L"stall");
      ShellStatus = SHELL_INVALID_PARAMETER;
    } else {
      Status = ShellConvertStringToUint64 (ShellCommandLineGetRawValue (Package, 1), &Intermediate, ((BOOLEAN)(0==1)), ((BOOLEAN)(0==1)));
      if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) || (((UINT64)(UINTN)(Intermediate)) != Intermediate)) {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0008, gShellLevel1HiiHandle, L"stall", ShellCommandLineGetRawValue (Package, 1));
        ShellStatus = SHELL_INVALID_PARAMETER;
      } else {
        Status = gBS->Stall ((UINTN)Intermediate);
        if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x000F, gShellLevel1HiiHandle, L"stall");

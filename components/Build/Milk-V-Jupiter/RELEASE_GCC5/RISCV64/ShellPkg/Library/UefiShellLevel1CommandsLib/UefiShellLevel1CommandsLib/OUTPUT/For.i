# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel1CommandsLib/For.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel1CommandsLib/For.c"
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel1CommandsLib/For.c"
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel1CommandsLib/For.c" 2
...
# 12 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel1CommandsLib/For.c" 2
# 21 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel1CommandsLib/For.c"
BOOLEAN
ShellIsValidForNumber (
  const CHAR16 *Number
  )
{
  if ((Number == ((void *) 0)) || (*Number == 0x0000)) {
    return (((BOOLEAN)(0==1)));
  }
  ...
  if (StrLen (Number) >= 7) {
    if ((StrStr (Number, L" ") == ((void *) 0)) || (((StrStr (Number, L" ") != ((void *) 0)) && ((StrStr (Number, L" ") - Number) >= 7)))) {
      return (((BOOLEAN)(0==1)));
    }
  }
  ...
  )
{
  ...
  if (!gEfiShellProtocol->BatchIsActive ()) {
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0002, gShellLevel1HiiHandle, L"endfor");
    return (SHELL_UNSUPPORTED);
  }

  if (gEfiShellParametersProtocol->Argc > 1) {
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0007, gShellLevel1HiiHandle, L"endfor");
    return (SHELL_INVALID_PARAMETER);
  }

  Found = MoveToTag (GetPreviousNode, L"for", L"endfor", ((void *) 0), ShellCommandGetCurrentScriptFile (), ((BOOLEAN)(0==1)), ((BOOLEAN)(0==1)), ((BOOLEAN)(0==1)));
...
# 126 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel1CommandsLib/For.c"
EFI_STATUS
  ...
  )
{
  ...
  for ( Node = (ALIAS_LIST *)GetFirstNode (List), Found = ((BOOLEAN)(0==1))
        ...
        )
  {
    ...
    if (StrCmp (Node->Alias, Alias) == 0) {
      ...
      Node->CommandString = ((void *) 0);
      Node->CommandString = StrnCatGrow (&Node->CommandString, ((void *) 0), CommandString, 0);
      Found = ((BOOLEAN)(1==1));
      break;
    }
  }
  ...
  if (!Found) {
    ...
    do { if (((BOOLEAN)(0==1))) { (void) (Node->Alias == ((void *) 0)); } } while (((BOOLEAN)(0==1)));
    Node->Alias = StrnCatGrow (&Node->Alias, ((void *) 0), Alias, 0);
    do { if (((BOOLEAN)(0==1))) { (void) (Node->CommandString == ((void *) 0)); } } while (((BOOLEAN)(0==1)));
    Node->CommandString = StrnCatGrow (&Node->CommandString, ((void *) 0), CommandString, 0);
...
# 185 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel1CommandsLib/For.c"
BOOLEAN
...
# 266 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel1CommandsLib/For.c"
UINTN
ReturnUintn (
  const CHAR16 *String
  )
{
  ...
  if (!(((RETURN_STATUS)(ShellConvertStringToUint64 (String, &RetVal, ((BOOLEAN)(0==1)), ((BOOLEAN)(1==1))))) >= 0x8000000000000000ULL)) {
    return ((UINTN)RetVal);
  }
  ...
  )
{
  ...
  if (!gEfiShellProtocol->BatchIsActive ()) {
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0002, gShellLevel1HiiHandle, L"for");
    return (SHELL_UNSUPPORTED);
  }

  if (gEfiShellParametersProtocol->Argc < 4) {
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0006, gShellLevel1HiiHandle, L"for");
    return (SHELL_INVALID_PARAMETER);
  }

  CurrentScriptFile = ShellCommandGetCurrentScriptFile ();
  if (CurrentScriptFile == ((void *) 0)) {
    do { if (((BOOLEAN)(0==1))) { (void) (CurrentScriptFile != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
    return (SHELL_INVALID_PARAMETER);
  }

  if ((CurrentScriptFile->CurrentCommand != ((void *) 0)) && (CurrentScriptFile->CurrentCommand->Data == ((void *) 0))) {
    FirstPass = ((BOOLEAN)(1==1));




    if (!MoveToTag (GetNextNode, L"endfor", L"for", ((void *) 0), CurrentScriptFile, ((BOOLEAN)(1==1)), ((BOOLEAN)(1==1)), ((BOOLEAN)(0==1)))) {
      ShellPrintHiiEx (
        -1,
        -1,
        ((void *) 0),
    ...
    if ( (gEfiShellParametersProtocol->Argv[1][0] != L'%') || (gEfiShellParametersProtocol->Argv[1][2] != 0x0000)
       || !( ((gEfiShellParametersProtocol->Argv[1][1] >= L'a') && (gEfiShellParametersProtocol->Argv[1][1] <= L'z'))
           || ((gEfiShellParametersProtocol->Argv[1][1] >= L'A') && (gEfiShellParametersProtocol->Argv[1][1] <= L'Z')))
          )
    {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0005, gShellLevel1HiiHandle, gEfiShellParametersProtocol->Argv[1]);
      return (SHELL_INVALID_PARAMETER);
    }
                             ...
                             ) == 0)
    {
      for (LoopVar = 0x3; LoopVar < gEfiShellParametersProtocol->Argc; LoopVar++) {
        do { if (((BOOLEAN)(0==1))) { (void) ((ArgSet == ((void *) 0) && ArgSize == 0) || (ArgSet != ((void *) 0))); } } while (((BOOLEAN)(0==1)));
        if ( (StrStr (gEfiShellParametersProtocol->Argv[LoopVar], L"*") != ((void *) 0))
           || (StrStr (gEfiShellParametersProtocol->Argv[LoopVar], L"?") != ((void *) 0))
           || (StrStr (gEfiShellParametersProtocol->Argv[LoopVar], L"[") != ((void *) 0))
           || (StrStr (gEfiShellParametersProtocol->Argv[LoopVar], L"]") != ((void *) 0)))
        {
          FileList = ((void *) 0);
          Status = ShellOpenFileMetaArg ((CHAR16 *)gEfiShellParametersProtocol->Argv[LoopVar], 0x0000000000000001ULL, &FileList);
      ...
      if (ArgSet == ((void *) 0)) {
        ...
        if (InternalIsAliasOnList (Info->ReplacementName, &CurrentScriptFile->SubstList)) {
          Info->RemoveSubstAlias = ((BOOLEAN)(0==1));
        } else {
          Info->RemoveSubstAlias = ((BOOLEAN)(1==1));
        }
      ...
      if (ArgSet == ((void *) 0)) {
        ...
        if (ArgSetWalker[0] != L'(') {
          ...
          if (TempSpot != ((void *) 0)) {
            ...
            if (*(TempString) != 0x0000) {
              while (TempString != ((void *) 0) && *TempString == L' ') {
                TempString++;
              }
          ...
          if (TempSpot == ((void *) 0)) {
            ...
            *TempSpot = 0x0000;
            ArgSetWalker++;
            while (ArgSetWalker != ((void *) 0) && ArgSetWalker[0] == L' ') {
              ArgSetWalker++;
            }
            ...
            if (!ShellIsValidForNumber (ArgSetWalker)) {
              ...
              if ((ArgSetWalker == ((void *) 0)) || (*ArgSetWalker == 0x0000) || !ShellIsValidForNumber (ArgSetWalker)) {
                ShellPrintHiiEx (
                  -1,
                  -1,
                  ((void *) 0),
                ...
                if ((ArgSetWalker != ((void *) 0)) && (*ArgSetWalker != 0x0000)) {
                  if ((ArgSetWalker == ((void *) 0)) || (*ArgSetWalker == 0x0000) || !ShellIsValidForNumber (ArgSetWalker)) {
                    ShellPrintHiiEx (
                      -1,
                      -1,
                    ...
                    if (*ArgSetWalker == L')') {
                      do { if (((BOOLEAN)(0==1))) { (void) (Info->Step == 1 || Info->Step == -1); } } while (((BOOLEAN)(0==1)));
                    } else {
                      if (ArgSetWalker[0] == L'-') {
                      ...
                      if (StrStr (ArgSetWalker, L" ") != ((void *) 0)) {
                        ShellPrintHiiEx (
                          -1,
                          -1,
                          ((void *) 0),
        ...
        if (CurrentScriptFile->CurrentCommand != ((void *) 0)) {
          CurrentScriptFile->CurrentCommand->Data = Info;
        }
      }
    } else {
    ...
    do { if (((BOOLEAN)(0==1))) { (void) (ArgSetWalker == ((void *) 0)); } } while (((BOOLEAN)(0==1)));
    do { if (((BOOLEAN)(0==1))) { (void) (ArgSet == ((void *) 0)); } } while (((BOOLEAN)(0==1)));
  }

  if ((CurrentScriptFile != ((void *) 0)) && (CurrentScriptFile->CurrentCommand != ((void *) 0))) {
    ...
    if (CurrentScriptFile->CurrentCommand->Reset) {
      ...
      FirstPass = ((BOOLEAN)(1==1));
      CurrentScriptFile->CurrentCommand->Reset = ((BOOLEAN)(0==1));
    }
  } else {
  ...
  if (ShellStatus == SHELL_SUCCESS) {
    do { if (((BOOLEAN)(0==1))) { (void) (Info != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
    if (Info->Step != 0) {
      ...
      if (TempString == ((void *) 0)) {
        do { if ((ArgSet) != ((void *) 0)) { FreePool((ArgSet)); (ArgSet) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
      ...
      if (((Info->Step > 0) && (Info->Current > Info->End)) || ((Info->Step < 0) && (Info->Current < Info->End))) {
        CurrentScriptFile->CurrentCommand->Data = ((void *) 0);



        if (!MoveToTag (GetNextNode, L"endfor", L"for", ((void *) 0), CurrentScriptFile, ((BOOLEAN)(1==1)), ((BOOLEAN)(0==1)), ((BOOLEAN)(0==1)))) {
          ShellPrintHiiEx (
            -1,
            -1,
            ((void *) 0),
      ...
      do { if (((BOOLEAN)(0==1))) { (void) (Info->Set != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
      if ((Info->CurrentValue != ((void *) 0)) && (*Info->CurrentValue != 0x0000)) {
        ...
        TempString = StrnCatGrow (&TempString, ((void *) 0), Info->CurrentValue, 0);
        if (TempString == ((void *) 0)) {
          ShellStatus = SHELL_OUT_OF_RESOURCES;
        } else {
          ...
          while (TempString[StrLen (TempString)-1] == L'\"') {
            TempString[StrLen (TempString)-1] = 0x0000;
          }

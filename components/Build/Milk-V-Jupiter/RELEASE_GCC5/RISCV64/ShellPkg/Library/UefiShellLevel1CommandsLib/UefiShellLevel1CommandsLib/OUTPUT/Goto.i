# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel1CommandsLib/Goto.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel1CommandsLib/Goto.c"
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel1CommandsLib/Goto.c"
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel1CommandsLib/Goto.c" 2
  ...
  )
{
  ...
  if (!gEfiShellProtocol->BatchIsActive ()) {
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0002, gShellLevel1HiiHandle, L"Goto");
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    if ((Status == ((RETURN_STATUS)(0x8000000000000000ULL | (10)))) && (ProblemParam != ((void *) 0))) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0003, gShellLevel1HiiHandle, L"goto", ProblemParam);
    ...
    if (ShellCommandLineGetRawValue (Package, 2) != ((void *) 0)) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0007, gShellLevel1HiiHandle, L"goto");
      ShellStatus = SHELL_INVALID_PARAMETER;
    } else if (ShellCommandLineGetRawValue (Package, 1) == ((void *) 0)) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0006, gShellLevel1HiiHandle, L"goto");
      ShellStatus = SHELL_INVALID_PARAMETER;
    } else {
      Size = 0;
      do { if (((BOOLEAN)(0==1))) { (void) ((CompareString == ((void *) 0) && Size == 0) || (CompareString != ((void *) 0))); } } while (((BOOLEAN)(0==1)));
      ...
      if (!MoveToTag (GetNextNode, L"endfor", L"for", CompareString, ShellCommandGetCurrentScriptFile (), ((BOOLEAN)(0==1)), ((BOOLEAN)(0==1)), ((BOOLEAN)(1==1)))) {

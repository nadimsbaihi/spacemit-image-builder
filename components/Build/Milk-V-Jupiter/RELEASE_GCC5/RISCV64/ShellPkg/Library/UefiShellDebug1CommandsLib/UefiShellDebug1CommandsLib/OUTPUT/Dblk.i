# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Dblk.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Dblk.c"
# 10 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Dblk.c"
...
# 11 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Dblk.c" 2
...
extern EFI_GUID gEfiBlockIoProtocolGuid;
# 12 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Dblk.c" 2
# 22 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Dblk.c"
SHELL_STATUS
DisplayTheBlocks (
  ...
  )
{
  ...
  Status = gBS->OpenProtocol (BlockIoHandle, &gEfiBlockIoProtocolGuid, (void **)&BlockIo, gImageHandle, ((void *) 0), 0x00000002);
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    return (SHELL_NOT_FOUND);
  }
  ...
  if (BufferSize > 0) {
    ...
    Buffer = ((void *) ((((UINTN)(OriginalBuffer)) + ((((BlockIo->Media->IoAlign)) - ((UINTN)(OriginalBuffer))) & (((BlockIo->Media->IoAlign)) - 1U)))));
  } else {
  ...
  if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) && (Buffer != ((void *) 0))) {
    ...
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x023C, gShellDebug1HiiHandle, L"dblk", L"BlockIo");
    ShellStatus = SHELL_DEVICE_ERROR;
  }

  if (OriginalBuffer != ((void *) 0)) {
    FreePool (OriginalBuffer);
  }

  gBS->CloseProtocol (BlockIoHandle, &gEfiBlockIoProtocolGuid, gImageHandle, ((void *) 0));
  return (ShellStatus);
}
  ...
  )
{
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    if ((Status == ((RETURN_STATUS)(0x8000000000000000ULL | (10)))) && (ProblemParam != ((void *) 0))) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0224, gShellDebug1HiiHandle, L"dblk", ProblemParam);
    ...
    if (ShellCommandLineGetCount (Package) > 4) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0229, gShellDebug1HiiHandle, L"dblk");
      ShellStatus = SHELL_INVALID_PARAMETER;
    } else if (ShellCommandLineGetCount (Package) < 2) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0228, gShellDebug1HiiHandle, L"dblk");
      ShellStatus = SHELL_INVALID_PARAMETER;
    } else {
      ...
      if (LbaString == ((void *) 0)) {
        ...
        if (!ShellIsHexOrDecimalNumber (LbaString, ((BOOLEAN)(1==1)), ((BOOLEAN)(0==1)))) {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x022C, gShellDebug1HiiHandle, L"dblk", LbaString);
          ShellStatus = SHELL_INVALID_PARAMETER;
        }

        if ((((RETURN_STATUS)(ShellConvertStringToUint64 (LbaString, &Lba, ((BOOLEAN)(1==1)), ((BOOLEAN)(0==1))))) >= 0x8000000000000000ULL)) {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x022C, gShellDebug1HiiHandle, L"dblk", LbaString);
          ShellStatus = SHELL_INVALID_PARAMETER;
        }
      }

      if (BlockCountString == ((void *) 0)) {
        BlockCount = 1;
      } else {
        if (!ShellIsHexOrDecimalNumber (BlockCountString, ((BOOLEAN)(1==1)), ((BOOLEAN)(0==1)))) {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x022C, gShellDebug1HiiHandle, L"dblk", BlockCountString);
          ShellStatus = SHELL_INVALID_PARAMETER;
        }

        if (!(((RETURN_STATUS)(ShellConvertStringToUint64 (BlockCountString, &BlockCount, ((BOOLEAN)(1==1)), ((BOOLEAN)(0==1))))) >= 0x8000000000000000ULL)) {
          if (BlockCount > 0x10) {
            BlockCount = 0x10;
      ...
      if (ShellStatus == SHELL_SUCCESS) {
        ...
        if ((BlockName == ((void *) 0)) || (gEfiShellProtocol->GetDevicePathFromMap (BlockName) == ((void *) 0))) {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x022C, gShellDebug1HiiHandle, L"dblk", BlockName);
          ShellStatus = SHELL_INVALID_PARAMETER;
        } else {
          DevPath = (EFI_DEVICE_PATH_PROTOCOL *)gEfiShellProtocol->GetDevicePathFromMap (BlockName);
          if (gBS->LocateDevicePath (&gEfiBlockIoProtocolGuid, &DevPath, ((void *) 0)) == ((RETURN_STATUS)(0x8000000000000000ULL | (14)))) {
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0230, gShellDebug1HiiHandle, L"dblk", BlockName, L"BlockIo");
            ShellStatus = SHELL_INVALID_PARAMETER;
          } else {

...
.Ltext0:
	...
	.file 0 "/home/kapoagaeming/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/ShellPkg/Library/UefiShellDebug1CommandsLib/UefiShellDebug1CommandsLib" "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/SetSize.c"
	.section	.rodata
	.align	3
.LC0:
	.string	"s"
	...
	.string	"e"
	.zero	2
	.section	.text.ShellCommandRunSetSize,"ax",@progbits
	.align	1
	.globl	ShellCommandRunSetSize
	.type	ShellCommandRunSetSize, @function
ShellCommandRunSetSize:
.LFB0:
	.file 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/SetSize.c"
	.loc 1 24 1
	.cfi_startproc
	addi	sp,sp,-112
...
.L17:
	...
	call	ShellCommandLineGetRawValue@plt
	mv	a4,a0
	.loc 1 79 16 is_stmt 0 discriminator 1
	addi	a5,s0,-96
	li	a3,0
	li	a2,3
	mv	a1,a5
	...
	mv	a0,a5
	call	ShellCommandLineGetRawValue@plt
	.loc 1 81 18 is_stmt 0 discriminator 1
	addi	a4,s0,-96
	li	a3,0
	li	a5,-1
	slli	a5,a5,63
...
.L14:
	...
	call	ShellCommandLineGetRawValue@plt
	mv	a5,a0
	.loc 1 97 11 is_stmt 0 discriminator 1
	mv	a6,a5
	lla	a5,.LC0
	mv	a4,s1
	li	a3,574
...
.L8:
	...
	call	ShellCommandLineGetCount@plt
	mv	a4,a0
	.loc 1 78 68 discriminator 3
	ld	a5,-64(s0)
	bgeu	a5,a4,.L13
	.loc 1 78 68 is_stmt 0 discriminator 4
	lw	a5,-44(s0)
	sext.w	a5,a5
	beq	a5,zero,.L17
.L13:
...
.L3:
	...
	.cfi_endproc
.LFE0:
	.size	ShellCommandRunSetSize, .-ShellCommandRunSetSize
	.text
.Letext0:
	...
	.file 15 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdePkg/Include/Library/FileHandleLib.h"
...
.LASF0:
	.string	"/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/SetSize.c"

# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/EfiCompress.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/EfiCompress.c"
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/EfiCompress.c"
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/EfiCompress.c" 2
...
# 12 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/EfiCompress.c" 2
  ...
  )
{
  ...
  OutBuffer = ((void *) 0);
  InShellFileHandle = ((void *) 0);
  OutShellFileHandle = ((void *) 0);
  InBuffer = ((void *) 0);
  Package = ((void *) 0);
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    if ((Status == ((RETURN_STATUS)(0x8000000000000000ULL | (10)))) && (ProblemParam != ((void *) 0))) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0224, gShellDebug1HiiHandle, L"eficompress", ProblemParam);
    ...
    if (ShellCommandLineGetCount (Package) > 3) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0229, gShellDebug1HiiHandle, L"eficompress");
      ShellStatus = SHELL_INVALID_PARAMETER;
    } else if (ShellCommandLineGetCount (Package) < 3) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0228, gShellDebug1HiiHandle, L"eficompress");
      ShellStatus = SHELL_INVALID_PARAMETER;
    } else {
      TempParam = ShellCommandLineGetRawValue (Package, 1);
      if (TempParam == ((void *) 0)) {
        do { if (((BOOLEAN)(0==1))) { (void) (TempParam != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x022C, gShellDebug1HiiHandle, L"eficompress");
        ShellStatus = SHELL_INVALID_PARAMETER;
        goto Exit;
      }
      ...
      if ((InFileName == ((void *) 0)) || (OutFileName == ((void *) 0))) {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0237, gShellDebug1HiiHandle, L"eficompress", TempParam);
        ShellStatus = SHELL_NOT_FOUND;
      } else {
        if (ShellIsDirectory (InFileName) == (RETURN_STATUS)(0)) {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0238, gShellDebug1HiiHandle, L"eficompress", InFileName);
          ShellStatus = SHELL_INVALID_PARAMETER;
        }

        if (ShellIsDirectory (OutFileName) == (RETURN_STATUS)(0)) {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0238, gShellDebug1HiiHandle, L"eficompress", OutFileName);
          ShellStatus = SHELL_INVALID_PARAMETER;
        }

        if (ShellStatus == SHELL_SUCCESS) {
          Status = ShellOpenFileByName (InFileName, &InShellFileHandle, 0x0000000000000001ULL, 0);
          if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0231, gShellDebug1HiiHandle, L"eficompress", ShellCommandLineGetRawValue (Package, 1));
            ShellStatus = SHELL_NOT_FOUND;
          }

          Status = ShellOpenFileByName (OutFileName, &OutShellFileHandle, 0x0000000000000001ULL|0x0000000000000002ULL|0x8000000000000000ULL, 0);
          if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0231, gShellDebug1HiiHandle, L"eficompress", ShellCommandLineGetRawValue (Package, 2));
            ShellStatus = SHELL_NOT_FOUND;
          }
        }
        ...
        if (ShellStatus == SHELL_SUCCESS) {
          ...
          if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0252, gShellDebug1HiiHandle, Status);
            ...
            if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
              ShellPrintHiiEx (-1, -1, ((void *) 0), 0x023B, gShellDebug1HiiHandle, L"eficompress", OutFileName);
...
Exit:
  if ((ShellStatus != SHELL_SUCCESS) && (Package != ((void *) 0))) {
    ShellCommandLineFreeVarList (Package);
  }

  if (InShellFileHandle != ((void *) 0)) {
    gEfiShellProtocol->CloseFile (InShellFileHandle);
  }

  if (OutShellFileHandle != ((void *) 0)) {

# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/DmpStore.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/DmpStore.c"
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/DmpStore.c"
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/DmpStore.c" 2
...
# 38 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/DmpStore.c"
CHAR16 *
GetAttrType (
  const UINT32 Atts
  )
{
  ...
  if ((RetString != ((void *) 0)) && (RetString[0] == L'+')) {
    CopyMem (RetString, RetString + 1, StrSize (RetString + 1));
  }

  return RetString;
}
# 92 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/DmpStore.c"
CHAR16 *
BinaryToHexString (
  void *Buffer,
  UINTN BufferSize,
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) ((BufferSize * 2 + 1) * sizeof (CHAR16) <= HexStringSize); } } while (((BOOLEAN)(0==1)));
...
# 132 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/DmpStore.c"
SHELL_STATUS
  ...
  )
{
  ...
  while (Position < FileSize) {
    ...
    if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) || (BufferSize != sizeof (NameSize))) {
    ...
    if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) || (BufferSize != sizeof (DataSize))) {
      ShellStatus = SHELL_VOLUME_CORRUPTED;
      break;
    }
    ...
    if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) || (BufferSize != RemainingSize)) {
      ShellStatus = SHELL_VOLUME_CORRUPTED;
      FreePool (Buffer);
      break;
    }
    ...
    *((UINT32 *)Buffer + 1) = DataSize;
    ...
    Variable->Signature = ((('_') | ('d' << 8)) | ((('s') | ('s' << 8)) << 16));
  ...
  if ((Position != FileSize) || (ShellStatus != SHELL_SUCCESS)) {
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x031A, gShellDebug1HiiHandle, L"dmpstore");
  ...
  {
    Variable = (((DMP_STORE_VARIABLE *) (void *) ((CHAR8 *) (Link) - ((UINTN) __builtin_offsetof(DMP_STORE_VARIABLE, Link))))->Signature != ((('_') | ('d' << 8)) | ((('s') | ('s' << 8)) << 16))) ? ((void *) 0) : ((DMP_STORE_VARIABLE *) (void *) ((CHAR8 *) (Link) - ((UINTN) __builtin_offsetof(DMP_STORE_VARIABLE, Link))));

    if (((Name == ((void *) 0)) || gUnicodeCollation->MetaiMatch (gUnicodeCollation, Variable->Name, (CHAR16 *)Name)) &&
        ((Guid == ((void *) 0)) || CompareGuid (&Variable->Guid, Guid))
        )
    {
      ...
      do { if ((Attributes) != ((void *) 0)) { FreePool((Attributes)); (Attributes) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
      ...
      *Found = ((BOOLEAN)(1==1));
      ...
      if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0319, gShellDebug1HiiHandle, L"dmpstore", Variable->Name, Status);
      }
    }
  }
...
# 313 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/DmpStore.c"
EFI_STATUS
...
# 416 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/DmpStore.c"
SHELL_STATUS
  ...
  )
{
  ...
  if (Status == ((RETURN_STATUS)(0x8000000000000000ULL | (5)))) {
    do { if ((FoundVarName) != ((void *) 0)) { FreePool((FoundVarName)); (FoundVarName) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
        ...
        )
  {
    ...
    *FoundOne = ((BOOLEAN)(1==1));
    ...
    if (Status == ((RETURN_STATUS)(0x8000000000000000ULL | (5)))) {
      do { if ((DataBuffer) != ((void *) 0)) { FreePool((DataBuffer)); (DataBuffer) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
    ...
    if (Type == DmpStoreDisplay) {
      if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) && (DataBuffer != ((void *) 0)) && (FoundVarName != ((void *) 0))) {
        ...
        do { if ((AttrString) != ((void *) 0)) { FreePool((AttrString)); (AttrString) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
      }
      ...
      SetStatus = gRT->SetVariable (FoundVarName, &FoundVarGuid, Atts, 0, ((void *) 0));
      if (StandardFormatOutput) {
        if (SetStatus == (RETURN_STATUS)(0)) {
          ShellPrintHiiEx (
            -1,
            -1,
            ((void *) 0),
  ...
  } else if (Status == ((RETURN_STATUS)(0x8000000000000000ULL | (26)))) {
...
# 670 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/DmpStore.c"
SHELL_STATUS
ProcessVariables (
  const CHAR16 *Name ,
  const EFI_GUID *Guid ,
  ...
  )
{
  ...
  if (StandardFormatOutput) {
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0235, gShellDebug1HiiHandle, L"dmpstore");
  }

  if (Type == DmpStoreLoad) {
    ShellStatus = LoadVariablesFromFile (FileHandle, Name, Guid, &Found);
  } else {
    ShellStatus = CascadeProcessVariables (Name, Guid, Type, FileHandle, ((void *) 0), FoundVarGuid, &Found, StandardFormatOutput);
  }

  if (!Found) {
    if (ShellStatus == SHELL_OUT_OF_RESOURCES) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x022F, gShellDebug1HiiHandle, L"dmpstore");
      return (ShellStatus);
    } else if ((Name != ((void *) 0)) && (Guid == ((void *) 0))) {
      if (StandardFormatOutput) {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0323, gShellDebug1HiiHandle, Name);
      } else {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0322, gShellDebug1HiiHandle, L"dmpstore", Name);
      }
    } else if ((Name != ((void *) 0)) && (Guid != ((void *) 0))) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0320, gShellDebug1HiiHandle, L"dmpstore", Guid, Name);
    } else if ((Name == ((void *) 0)) && (Guid == ((void *) 0))) {
      if (StandardFormatOutput) {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x031F, gShellDebug1HiiHandle);
      } else {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x031E, gShellDebug1HiiHandle, L"dmpstore");
      }
    } else if ((Name == ((void *) 0)) && (Guid != ((void *) 0))) {
      if (StandardFormatOutput) {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0325, gShellDebug1HiiHandle, Guid);
      } else {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0324, gShellDebug1HiiHandle, L"dmpstore", Guid);
      }
    }
  ...
  )
{
  ...
  StandardFormatOutput = ((BOOLEAN)(0==1));
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    if ((Status == ((RETURN_STATUS)(0x8000000000000000ULL | (10)))) && (ProblemParam != ((void *) 0))) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0224, gShellDebug1HiiHandle, L"dmpstore", ProblemParam);
    ...
    if (ShellCommandLineGetCount (Package) > 2) {
      ...
      if (!ShellCommandLineGetFlag (Package, L"-all")) {
        ...
        if (GuidStr != ((void *) 0)) {
          ...
          if ((((RETURN_STATUS)(RStatus)) >= 0x8000000000000000ULL) || (GuidStr[36] != L'\0')) {
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x022C, gShellDebug1HiiHandle, L"dmpstore", GuidStr);
            ShellStatus = SHELL_INVALID_PARAMETER;
          }
      ...
      if (ShellStatus == SHELL_SUCCESS) {
        if (ShellCommandLineGetFlag (Package, L"-s")) {
          ...
          if (File == ((void *) 0)) {
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0227, gShellDebug1HiiHandle, L"dmpstore", L"-s");
            ShellStatus = SHELL_INVALID_PARAMETER;
          } else {
            Status = ShellOpenFileByName (File, &FileHandle, 0x0000000000000002ULL | 0x0000000000000001ULL, 0);
            if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
              ...
              if (FileInfo == ((void *) 0)) {
                ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0231, gShellDebug1HiiHandle, L"dmpstore", File);
                Status = ((RETURN_STATUS)(0x8000000000000000ULL | (7)));
              } else {
                if ((FileInfo->Attribute & 0x0000000000000010ULL) == 0x0000000000000010ULL) {
                  ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0234, gShellDebug1HiiHandle, L"dmpstore", File);
                  Status = ((RETURN_STATUS)(0x8000000000000000ULL | (2)));
                } else {
                  Status = ShellDeleteFile (&FileHandle);
                  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
                    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0232, gShellDebug1HiiHandle, L"dmpstore", File);
                  }
                }
            ...
            if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
              Status = ShellOpenFileByName (File, &FileHandle, 0x8000000000000000ULL | 0x0000000000000002ULL | 0x0000000000000001ULL, 0);
              if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
                ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0231, gShellDebug1HiiHandle, L"dmpstore", File);
              }
            }
          ...
          if (File == ((void *) 0)) {
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0227, gShellDebug1HiiHandle, L"dmpstore", L"-l");
            ShellStatus = SHELL_INVALID_PARAMETER;
          } else {
            Status = ShellOpenFileByName (File, &FileHandle, 0x0000000000000001ULL, 0);
            if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
              ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0231, gShellDebug1HiiHandle, L"dmpstore", File);
              ShellStatus = SHELL_INVALID_PARAMETER;
            } else {
        ...
        if (ShellCommandLineGetFlag (Package, L"-sfo")) {
          StandardFormatOutput = ((BOOLEAN)(1==1));
        }
      }

      if (ShellStatus == SHELL_SUCCESS) {
        if (Type == DmpStoreSave) {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0317, gShellDebug1HiiHandle, File);
        } else if (Type == DmpStoreLoad) {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0318, gShellDebug1HiiHandle, File);
        }

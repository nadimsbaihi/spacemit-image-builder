# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Edit/Misc.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Edit/Misc.c"
# 9 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Edit/Misc.c"
...
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Edit/Misc.c" 2
# 20 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Edit/Misc.c"
EFI_EDITOR_LINE *
LineDup (
  EFI_EDITOR_LINE *Src
  )
{
  ...
  Dest->Buffer = CatSPrint (((void *) 0), L"%s", Src->Buffer);
  if (Dest->Buffer == ((void *) 0)) {
    FreePool (Dest);
    return ((void *) 0);
  }
  ...
  )
{
  ...
  do { if ((Src->Buffer) != ((void *) 0)) { FreePool((Src->Buffer)); (Src->Buffer) = ((void *) 0); } } while(((BOOLEAN)(0==1)));

...
.Ltext0:
	...
	.file 0 "/home/kapoagaeming/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/ShellPkg/Library/UefiShellDebug1CommandsLib/UefiShellDebug1CommandsLib" "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Edit/Edit.c"
	.section	.rodata
	.align	3
.LC0:
	.string	"e"
...
.LC5:
	.zero	2
	.section	.text.ShellCommandRunEdit,"ax",@progbits
	.align	1
	.globl	ShellCommandRunEdit
	.type	ShellCommandRunEdit, @function
ShellCommandRunEdit:
.LFB0:
	.file 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Edit/Edit.c"
	.loc 1 25 1
	.cfi_startproc
	addi	sp,sp,-112
...
.L11:
	.loc 1 109 13
	ld	a0,-64(s0)
	call	FileBufferSetFileName@plt
.L10:
	.loc 1 120 44
	la	a5,MainEditor
	ld	a5,0(a5)
	...
	blt	a5,zero,.L12
	.loc 1 122 11
	call	MainEditorRefresh@plt
	.loc 1 124 20
	call	MainEditorKeyInput@plt
	sd	a0,-24(s0)
.L12:
	.loc 1 127 12
	ld	a4,-24(s0)
	...
	mv	a5,a0
	.loc 1 131 20 is_stmt 0 discriminator 1
	mv	a2,a5
	lla	a1,.LC4
	li	a0,0
	call	CatSPrint@plt
...
.L14:
	...
	ld	a5,-32(s0)
	beq	a5,zero,.L5
	.loc 1 158 48 discriminator 1
	ld	a0,-32(s0)
	call	FreePool@plt
	.loc 1 158 77 discriminator 2
	sd	zero,-32(s0)
.L5:
	.loc 1 163 5
	ld	a5,-80(s0)
...
.L3:
	...
	.cfi_endproc
.LFE0:
	.size	ShellCommandRunEdit, .-ShellCommandRunEdit
	.text
.Letext0:
	...
	.file 18 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Edit/TextEditorTypes.h"
	.file 19 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Edit/TextEditor.h"
	...
	.file 22 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Edit/MainTextEditor.h"
	...
	.file 24 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Edit/FileBuffer.h"
	.file 25 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdePkg/Include/Library/MemoryAllocationLib.h"
	.file 26 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Include/Library/ShellCommandLib.h"
...
.LASF0:
	.string	"/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Edit/Edit.c"
.LASF1:

# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/LoadPciRom.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/LoadPciRom.c"
# 10 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/LoadPciRom.c"
...
# 11 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/LoadPciRom.c" 2
...
#pragma pack()
# 12 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/LoadPciRom.c" 2
...
#pragma pack()
# 13 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/LoadPciRom.c" 2
...
# 14 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/LoadPciRom.c" 2
...
# 15 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/LoadPciRom.c" 2
...
# 40 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/LoadPciRom.c"
EFI_STATUS
  ...
  )
{
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    if ((Status == ((RETURN_STATUS)(0x8000000000000000ULL | (10)))) && (ProblemParam != ((void *) 0))) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0224, gShellDebug1HiiHandle, L"loadpcirom", ProblemParam);
    ...
    if (ShellCommandLineGetCount (Package) < 2) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0228, gShellDebug1HiiHandle, L"loadpcirom");
      ShellStatus = SHELL_INVALID_PARAMETER;
    } else {
            ...
            )
      {
        ...
        if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0231, gShellDebug1HiiHandle, L"loadpcirom", Param);
          ShellStatus = SHELL_ACCESS_DENIED;
          break;
        }
      }

      if ((ShellStatus == SHELL_SUCCESS) && (FileList != ((void *) 0))) {
              ...
              )
        {
          if ((((RETURN_STATUS)(Node->Status)) >= 0x8000000000000000ULL)) {
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0231, gShellDebug1HiiHandle, L"loadpcirom", Node->FullName);
            ShellStatus = SHELL_INVALID_PARAMETER;
            continue;
          }

          if (FileHandleIsDirectory (Node->Handle) == (RETURN_STATUS)(0)) {
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0238, gShellDebug1HiiHandle, L"loadpcirom", Node->FullName);
            ShellStatus = SHELL_INVALID_PARAMETER;
            continue;
          }
          ...
          if (File1Buffer == ((void *) 0)) {
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x022F, gShellDebug1HiiHandle, L"loadpcirom");
          ...
          if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x023C, gShellDebug1HiiHandle, L"loadpcirom", Node->FullName);
            ShellStatus = SHELL_INVALID_PARAMETER;
          } else {
            ...
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x025F, gShellDebug1HiiHandle, Node->FullName, Status);
          }

          FreePool (File1Buffer);
        }
      } else if (ShellStatus == SHELL_SUCCESS) {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x023A, gShellDebug1HiiHandle, "loadpcirom");
...
# 202 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/LoadPciRom.c"
EFI_STATUS
LoadEfiDriversFromRomImage (
  void *RomBar,
  UINTN RomSize,
...

{
  ...
  do {
    ...
    if (EfiRomHeader->Signature != 0xaa55) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0260, gShellDebug1HiiHandle, L"loadpcirom", FileName, ImageIndex);
    ...
    if (Pcir->Signature != ((('P') | ('C' << 8)) | ((('I') | ('R' << 8)) << 16))) {
      break;
    }
         ...
         (EfiRomHeader->EfiSubsystem == 12)))
    {
      ...
      if ((InitializationSize <= ImageSize) && (ImageOffset < InitializationSize)) {
        ...
        DecompressedImageBuffer = ((void *) 0);




        SkipImage = ((BOOLEAN)(0==1));
        if (EfiRomHeader->CompressionType > 0x0001) {
          SkipImage = ((BOOLEAN)(1==1));
        }
        ...
        if (EfiRomHeader->CompressionType == 0x0001) {
          ...
          if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
            ...
            if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
              ...
              if (DecompressedImageBuffer == ((void *) 0)) {
                ShellPrintHiiEx (-1, -1, ((void *) 0), 0x022F, gShellDebug1HiiHandle, L"loadpcirom");
        ...
        if (!SkipImage) {
          ...
          FilePath = FileDevicePath (((void *) 0), RomFileName);
          if (FilePath == ((void *) 0)) {
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0261, gShellDebug1HiiHandle, L"loadpcirom", FileName, ImageIndex);
            do { if ((DecompressedImageBuffer) != ((void *) 0)) { FreePool((DecompressedImageBuffer)); (DecompressedImageBuffer) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
            return ((RETURN_STATUS)(0x8000000000000000ULL | (9)));
          }
          ...
          if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
            ...
            if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
              ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0262, gShellDebug1HiiHandle, L"loadpcirom", FileName, ImageIndex);

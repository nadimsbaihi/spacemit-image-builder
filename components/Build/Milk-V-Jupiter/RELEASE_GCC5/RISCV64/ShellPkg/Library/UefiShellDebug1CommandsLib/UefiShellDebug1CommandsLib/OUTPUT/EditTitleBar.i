# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/EditTitleBar.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/EditTitleBar.c"
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/EditTitleBar.c"
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/EditTitleBar.c" 2
...
# 12 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/EditTitleBar.c" 2

CHAR16 *Title = ((void *) 0);
# 23 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/EditTitleBar.c"
EFI_STATUS
MainTitleBarInit (
  const CHAR16 *Prompt
  )
{
  do { if ((Title) != ((void *) 0)) { FreePool((Title)); (Title) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
  if (Prompt == ((void *) 0)) {
    Title = CatSPrint (((void *) 0), L"");
  } else {



    Title = CatSPrint (((void *) 0), L"%s", Prompt);
  }
...
# 81 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/EditTitleBar.c"
EFI_STATUS
MainTitleBarRefresh (
  const CHAR16 *FileName ,
  const EDIT_FILE_TYPE FileType,

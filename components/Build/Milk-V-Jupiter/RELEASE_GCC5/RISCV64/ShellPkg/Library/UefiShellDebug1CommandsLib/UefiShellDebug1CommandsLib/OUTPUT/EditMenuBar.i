# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/EditMenuBar.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/EditMenuBar.c"
# 9 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/EditMenuBar.c"
...
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/EditMenuBar.c" 2
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/EditMenuBar.c" 2
...
# 12 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/EditMenuBar.c" 2
...
{
  do { if ((MenuItems) != ((void *) 0)) { FreePool((MenuItems)); (MenuItems) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
}
# 36 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/EditMenuBar.c"
EFI_STATUS
MenuBarInit (
  const EDITOR_MENU_ITEM *Items
  )
{
  ...
  for (NumItems = 0, ItemsWalker = Items; ItemsWalker != ((void *) 0) && ItemsWalker->Function != ((void *) 0); ItemsWalker++, NumItems++) {
  }
...
# 62 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/EditMenuBar.c"
EFI_STATUS
ControlHotKeyInit (
  MENU_ITEM_FUNCTION *Items
  )
...
# 79 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/EditMenuBar.c"
EFI_STATUS
MenuBarRefresh (
  const UINTN LastRow,
  const UINTN LastCol
  )
{
  ...
  for (Item = MenuItems; Item != ((void *) 0) && Item->Function != ((void *) 0); Item++) {
    NameString = HiiGetString (gShellDebug1HiiHandle, Item->NameToken, ((void *) 0));
    if (NameString == ((void *) 0)) {
      return ((RETURN_STATUS)(0x8000000000000000ULL | (2)));
    }

    Width = ((((StrLen (NameString) + 6)) > (20)) ? ((StrLen (NameString) + 6)) : (20));
    if (((Col + Width) > LastCol)) {
      Row++;
      Col = 1;
    }

    FunctionKeyString = HiiGetString (gShellDebug1HiiHandle, Item->FunctionKeyToken, ((void *) 0));
    if (FunctionKeyString == ((void *) 0)) {
      FreePool (NameString);
      return ((RETURN_STATUS)(0x8000000000000000ULL | (2)));
    }
...
# 145 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/EditMenuBar.c"
EFI_STATUS
MenuBarDispatchFunctionKey (
  const EFI_INPUT_KEY *Key
  )
...
# 174 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/EditMenuBar.c"
EFI_STATUS
MenuBarDispatchControlHotKey (
  const EFI_KEY_DATA *KeyData
  )
{
      ...
      (KeyData->KeyState.KeyShiftState == 0x80000000))
  {
    ...
    ControlIndex = KeyData->Key.UnicodeChar;
             ...
             ((KeyData->KeyState.KeyShiftState & (0x00000004 | 0x00000008)) != 0) &&
             ((KeyData->KeyState.KeyShiftState & ~(0x80000000 | 0x00000004 | 0x00000008)) == 0))
  {
  ...
  if ( (26 < ControlIndex)
     || (((void *) 0) == ControlBasedMenuFunctions[ControlIndex]))
  {

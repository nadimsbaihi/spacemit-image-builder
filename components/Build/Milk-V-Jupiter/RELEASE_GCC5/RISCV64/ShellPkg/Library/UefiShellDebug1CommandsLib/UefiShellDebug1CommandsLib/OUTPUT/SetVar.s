...
.Ltext0:
	...
	.file 0 "/home/kapoagaeming/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/ShellPkg/Library/UefiShellDebug1CommandsLib/UefiShellDebug1CommandsLib" "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/SetVar.c"
	.section	.rodata
	.align	3
.LC0:
	.string	"-"
...
ParamList:
	...
	.word	7
	.zero	4
	.section	.text.IsStringOfHexNibbles,"ax",@progbits
	.align	1
	.globl	IsStringOfHexNibbles
	.type	IsStringOfHexNibbles, @function
IsStringOfHexNibbles:
.LFB0:
	.file 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/SetVar.c"
	.loc 1 51 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L5:
	...
	lhu	a5,0(a5)
	mv	a0,a5
	call	ShellIsHexaDecimalDigitCharacter@plt
	mv	a5,a0
...
.L4:
	...
	.cfi_endproc
.LFE0:
	.size	IsStringOfHexNibbles, .-IsStringOfHexNibbles
	.section	.rodata
	.align	3
.LC4:
	.string	"-"
	.string	"-"
	.zero	2
	.section	.text.TestDataType,"ax",@progbits
	.align	1
	.globl	TestDataType
	.type	TestDataType, @function
TestDataType:
.LFB1:
	.loc 1 74 1
	.cfi_startproc
	...
	li	a5,120
	beq	a4,a5,.L8
	.loc 1 75 55 discriminator 2
	ld	a5,-24(s0)
	addi	a5,a5,2
	lhu	a5,0(a5)
	.loc 1 75 47 discriminator 2
	sext.w	a4,a5
	li	a5,88
	bne	a4,a5,.L7
.L8:
	...
	addi	a5,a5,4
	mv	a0,a5
	call	IsStringOfHexNibbles
	mv	a5,a0
	.loc 1 76 8 discriminator 1
	beq	a5,zero,.L9
	.loc 1 76 43 discriminator 2
	ld	a5,-24(s0)
	addi	a5,a5,4
	mv	a0,a5
	call	StrLen@plt
	mv	a4,a0
	.loc 1 76 39 discriminator 3
	li	a5,16
	bgtu	a4,a5,.L9
	.loc 1 77 14
	li	a5,0
...
.L7:
	...
	beq	a5,zero,.L12
	.loc 1 82 45 discriminator 2
	ld	a5,-24(s0)
	addi	a5,a5,2
	mv	a0,a5
	call	StrLen@plt
	mv	a5,a0
	.loc 1 82 63 discriminator 3
	andi	a5,a5,1
	.loc 1 82 41 discriminator 3
	bne	a5,zero,.L12
	.loc 1 83 14
	li	a5,1
	j	.L10
...
.L16:
	...
	beq	a5,zero,.L17
	.loc 1 95 39 discriminator 2
	ld	a0,-24(s0)
	call	StrLen@plt
	mv	a5,a0
	.loc 1 95 53 discriminator 3
	andi	a5,a5,1
...
.L10:
	...
	.cfi_endproc
.LFE1:
	.size	TestDataType, .-TestDataType
	.section	.rodata
	.align	3
.LC5:
	.string	"%s"
...
.LC6:
	...
	.string	"r"
	.zero	2
	.section	.text.ParseParameterData,"ax",@progbits
	.align	1
	.globl	ParseParameterData
	.type	ParseParameterData, @function
ParseParameterData:
.LFB2:
	.loc 1 122 1
	.cfi_startproc
...
.L31:
	...
	call	StrLen@plt
	mv	a5,a0
	.loc 1 176 7 is_stmt 0 discriminator 1
	ld	a3,-24(s0)
	ld	a2,-96(s0)
	mv	a1,a5
	ld	a0,-88(s0)
...
.L46:
	.loc 1 230 15
	ld	a0,-88(s0)
	call	ConvertTextToDevicePath@plt
	sd	a0,-56(s0)
	.loc 1 231 8
	ld	a5,-56(s0)
	bne	a5,zero,.L47
...
.L48:
	...
	ld	a5,-56(s0)
	beq	a5,zero,.L29
	.loc 1 245 43 discriminator 1
	ld	a0,-56(s0)
	call	FreePool@plt
	.loc 1 245 74 discriminator 2
	sd	zero,-56(s0)
	j	.L29
.L44:
	.loc 1 247 12
...
.L51:
	...
	.cfi_endproc
.LFE2:
	.size	ParseParameterData, .-ParseParameterData
	.section	.text.GetVariableDataFromParameter,"ax",@progbits
	.align	1
	.globl	GetVariableDataFromParameter
	.type	GetVariableDataFromParameter, @function
...
.LFB3:
	...
	ld	a5,-88(s0)
	beq	a5,zero,.L53
	.loc 1 282 36 discriminator 1
	ld	a5,-80(s0)
	beq	a5,zero,.L53
	.loc 1 282 68 discriminator 2
	ld	a0,-72(s0)
	call	ShellCommandLineGetCount@plt
	mv	a4,a0
	.loc 1 282 64 discriminator 3
	li	a5,2
	bgtu	a4,a5,.L54
.L53:
	.loc 1 283 12
...
.L70:
	...
	.cfi_endproc
.LFE3:
	.size	GetVariableDataFromParameter, .-GetVariableDataFromParameter
	.section	.rodata
	.align	3
.LC7:
	.string	"%"
...
.LC8:
	...
	.string	"\n"
	.zero	2
	.section	.text.ShellCommandRunSetVar,"ax",@progbits
	.align	1
	.globl	ShellCommandRunSetVar
	.type	ShellCommandRunSetVar, @function
...
.L73:
	...
	mv	a1,a4
	mv	a0,a5
	call	ShellCommandLineCheckDuplicate@plt
	mv	a5,a0
	.loc 1 397 13 discriminator 1
	beq	a5,zero,.L75
	.loc 1 398 5
	la	a5,gShellDebug1HiiHandle
	ld	a4,0(a5)
...
.L82:
	...
	j	.L101
.L102:
	.loc 1 424 81 discriminator 1
	ld	a5,-56(s0)
	addi	a5,a5,72
	lhu	a5,0(a5)
	.loc 1 424 67 discriminator 1
	beq	a5,zero,.L81
.L84:
	.loc 1 425 11
	la	a5,gShellDebug1HiiHandle
...
.L86:
	...
	.loc 1 446 12
	blt	a5,zero,.L88
	.loc 1 446 78 discriminator 1
	ld	a5,-112(s0)
	.loc 1 446 67 discriminator 1
	beq	a5,zero,.L88
	.loc 1 447 11
	la	a5,gShellDebug1HiiHandle
	ld	a4,0(a5)
...
.L92:
	...
	.loc 1 473 12
	blt	a5,zero,.L94
	.loc 1 473 77 discriminator 1
	ld	a5,-112(s0)
	.loc 1 473 66 discriminator 1
	bne	a5,zero,.L95
.L94:
	.loc 1 477 22
	sw	zero,-100(s0)
...
.L95:
	...
	.loc 1 492 17
	beq	a5,zero,.L98
	.loc 1 492 46 discriminator 1
	ld	a5,-112(s0)
	mv	a0,a5
	call	FreePool@plt
	.loc 1 492 75 discriminator 2
	sd	zero,-112(s0)
.L98:
	.loc 1 494 14
	sd	zero,-120(s0)
	...
	mv	a1,a4
	mv	a0,a5
	call	GetVariableDataFromParameter
	sd	a0,-24(s0)
	.loc 1 496 13
	ld	a5,-24(s0)
	.loc 1 496 12
...
.L101:
	...
	.cfi_endproc
.LFE4:
	.size	ShellCommandRunSetVar, .-ShellCommandRunSetVar
	.text
.Letext0:
	...
	.file 14 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/UefiShellDebug1CommandsLib.h"
...
.LASF356:
	.string	"StrLen"
.LASF373:
	.string	"GetVariableDataFromParameter"
.LASF283:
	.string	"StdErr"
.LASF207:
	.string	"CapsuleGuid"
...
.LASF0:
	.string	"/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/SetVar.c"
.LASF1:

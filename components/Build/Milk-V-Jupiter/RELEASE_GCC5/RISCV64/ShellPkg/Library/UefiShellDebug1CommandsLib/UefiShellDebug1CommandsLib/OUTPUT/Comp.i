# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Comp.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Comp.c"
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Comp.c"
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Comp.c" 2
...
# 45 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Comp.c"
void
PrintDifferentPoint (
  const CHAR16 *FileName,
  CHAR16 *FileTag,
  ...
  )
{
  ...
  if (BufferSize < DifferentBytes) {
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0242, gShellDebug1HiiHandle);
  }
...
# 97 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Comp.c"
static
void
FileBufferInit (
...
{
  FileBuffer->Allocated = _gPcd_FixedAtBuild_PcdShellFileOperationSize;
  FileBuffer->Data = AllocatePool (FileBuffer->Allocated);
  FileBuffer->Left = 0;
}
# 116 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Comp.c"
static
void
FileBufferUninit (
  FILE_BUFFER *FileBuffer
...
{
  do { if ((FileBuffer->Data) != ((void *) 0)) { FreePool((FileBuffer->Data)); (FileBuffer->Data) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
}
# 154 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Comp.c"
static
EFI_STATUS
FileBufferReadByte (
  SHELL_FILE_HANDLE FileHandle,
  ...
  )
{
  ...
  FileHandle1 = ((void *) 0);
  FileHandle2 = ((void *) 0);
  DataFromFile1 = ((void *) 0);
  DataFromFile2 = ((void *) 0);
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    if ((Status == ((RETURN_STATUS)(0x8000000000000000ULL | (10)))) && (ProblemParam != ((void *) 0))) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0224, gShellDebug1HiiHandle, L"comp", ProblemParam);
    ...
    if (ShellCommandLineGetCount (Package) > 3) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0229, gShellDebug1HiiHandle, L"comp");
      ShellStatus = SHELL_INVALID_PARAMETER;
    } else if (ShellCommandLineGetCount (Package) < 3) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0228, gShellDebug1HiiHandle, L"comp");
      ShellStatus = SHELL_INVALID_PARAMETER;
    } else {
      TempParam = ShellCommandLineGetRawValue (Package, 1);
      if (TempParam == ((void *) 0)) {
        do { if (((BOOLEAN)(0==1))) { (void) (TempParam != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x022C, gShellDebug1HiiHandle, L"comp", TempParam);
        ShellStatus = SHELL_INVALID_PARAMETER;
        goto Exit;
      }
      ...
      if (FileName1 == ((void *) 0)) {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0237, gShellDebug1HiiHandle, L"comp", TempParam);
        ShellStatus = SHELL_NOT_FOUND;
      } else {
        Status = ShellOpenFileByName (FileName1, &FileHandle1, 0x0000000000000001ULL, 0);
        if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0231, gShellDebug1HiiHandle, L"comp", TempParam);
          ShellStatus = SHELL_NOT_FOUND;
        }
      }
      ...
      if (FileName2 == ((void *) 0)) {
        ...
        Status = ShellOpenFileByName (FileName2, &FileHandle2, 0x0000000000000001ULL, 0);
        if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0231, gShellDebug1HiiHandle, L"comp", TempParam);
          ShellStatus = SHELL_NOT_FOUND;
        }
      ...
      if (ShellStatus == SHELL_SUCCESS) {
        ...
        if (ShellCommandLineGetFlag (Package, L"-n")) {
          ...
          if (TempParam == ((void *) 0)) {
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0227, gShellDebug1HiiHandle, L"comp", L"-n");
            ShellStatus = SHELL_INVALID_PARAMETER;
          } else {
            if (gUnicodeCollation->StriColl (gUnicodeCollation, (CHAR16 *)TempParam, L"all") == 0) {
              DifferentCount = ((UINTN)0xFFFFFFFFFFFFFFFFULL);
            } else {
              Status = ShellConvertStringToUint64 (TempParam, &DifferentCount, ((BOOLEAN)(0==1)), ((BOOLEAN)(1==1)));
              if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) || (DifferentCount == 0)) {
                ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0225, gShellDebug1HiiHandle, L"comp", TempParam, L"-n");
                ShellStatus = SHELL_INVALID_PARAMETER;
              }
            }
          }
        ...
        if (ShellCommandLineGetFlag (Package, L"-s")) {
          ...
          if (TempParam == ((void *) 0)) {
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0227, gShellDebug1HiiHandle, L"comp", L"-s");
            ShellStatus = SHELL_INVALID_PARAMETER;
          } else {
            Status = ShellConvertStringToUint64 (TempParam, &DifferentBytes, ((BOOLEAN)(0==1)), ((BOOLEAN)(1==1)));
            if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) || (DifferentBytes == 0)) {
              ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0225, gShellDebug1HiiHandle, L"comp", TempParam, L"-s");
              ShellStatus = SHELL_INVALID_PARAMETER;
            } else {
              if (DifferentBytes > (((Size1) > (Size2)) ? (Size1) : (Size2))) {
                DifferentBytes = (((Size1) > (Size2)) ? (Size1) : (Size2));
              }
            }
          }
        }
      ...
      if (ShellStatus == SHELL_SUCCESS) {
        ...
        if ((DataFromFile1 == ((void *) 0)) || (DataFromFile2 == ((void *) 0)) ||
            (FileBuffer1.Data == ((void *) 0)) || (FileBuffer2.Data == ((void *) 0)))
        {
          ShellStatus = SHELL_OUT_OF_RESOURCES;
          do { if ((DataFromFile1) != ((void *) 0)) { FreePool((DataFromFile1)); (DataFromFile1) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
          do { if ((DataFromFile2) != ((void *) 0)) { FreePool((DataFromFile2)); (DataFromFile2) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
      ...
      if (ShellStatus == SHELL_SUCCESS) {
        while ((UINT64)DiffPointNumber < DifferentCount) {
          ...
          {
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0241, gShellDebug1HiiHandle, ++DiffPointNumber);
            ...
            if (ReadStatus == OutOfDiffPoint) {
              ...
              for ( ; Index < (((InsertPosition1) > (InsertPosition2)) ? (InsertPosition1) : (InsertPosition2)); Index++) {
                if (DataFromFile1[Index] != DataFromFile2[Index]) {
                  ReadStatus = InDiffPoint;
        ...
        if (DiffPointNumber == 0) {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0244, gShellDebug1HiiHandle);
        } else {
          ShellStatus = SHELL_NOT_EQUAL;
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0243, gShellDebug1HiiHandle);
        }
      }
    }
...
Exit:
  do { if ((FileName1) != ((void *) 0)) { FreePool((FileName1)); (FileName1) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
  do { if ((FileName2) != ((void *) 0)) { FreePool((FileName2)); (FileName2) = ((void *) 0); } } while(((BOOLEAN)(0==1)));

  if (FileHandle1 != ((void *) 0)) {
    gEfiShellProtocol->CloseFile (FileHandle1);
  }

  if (FileHandle2 != ((void *) 0)) {

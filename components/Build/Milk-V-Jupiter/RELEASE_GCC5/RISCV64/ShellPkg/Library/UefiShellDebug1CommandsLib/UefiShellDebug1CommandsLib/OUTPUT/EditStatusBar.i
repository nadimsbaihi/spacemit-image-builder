# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/EditStatusBar.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/EditStatusBar.c"
# 9 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/EditStatusBar.c"
...
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/EditStatusBar.c" 2
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/EditStatusBar.c" 2

CHAR16 *StatusString;
BOOLEAN StatusBarNeedRefresh;
BOOLEAN StatusStringChanged;
# 23 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/EditStatusBar.c"
EFI_STATUS
StatusBarInit (
  void
  )
{
  ...
  StatusString = ((void *) 0);
  StatusBarNeedRefresh = ((BOOLEAN)(1==1));
  StatusStringChanged = ((BOOLEAN)(0==1));
  ...
  )
{
  ...
  do { if ((StatusString) != ((void *) 0)) { FreePool((StatusString)); (StatusString) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
}
...
# 78 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/EditStatusBar.c"
EFI_STATUS
StatusBarRefresh (
  BOOLEAN EditorFirst,
  UINTN LastRow,
  ...
  )
{
  ...
  StatusBarNeedRefresh = ((BOOLEAN)(0==1));
  StatusStringChanged = ((BOOLEAN)(0==1));

  return (RETURN_STATUS)(0);
}
# 172 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/EditStatusBar.c"
EFI_STATUS
StatusBarSetStatusString (
  CHAR16 *Str
  )
{
  StatusStringChanged = ((BOOLEAN)(1==1));




  do { if ((StatusString) != ((void *) 0)) { FreePool((StatusString)); (StatusString) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
  StatusString = CatSPrint (((void *) 0), L"%s", Str);
  if (StatusString == ((void *) 0)) {

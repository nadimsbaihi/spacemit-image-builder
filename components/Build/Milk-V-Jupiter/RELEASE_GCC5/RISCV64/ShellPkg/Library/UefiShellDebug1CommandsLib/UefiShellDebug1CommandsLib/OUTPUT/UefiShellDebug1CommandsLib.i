# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/UefiShellDebug1CommandsLib.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/UefiShellDebug1CommandsLib.c"
# 9 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/UefiShellDebug1CommandsLib.c"
...
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/UefiShellDebug1CommandsLib.c" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Include/Library/BcfgCommandLib.h" 1
# 24 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Include/Library/BcfgCommandLib.h"
EFI_STATUS
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/UefiShellDebug1CommandsLib.c" 2

static const CHAR16 mFileName[] = L"Debug1Commands";
EFI_HII_HANDLE gShellDebug1HiiHandle = ((void *) 0);
...
# 39 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/UefiShellDebug1CommandsLib.c"
EFI_STATUS
  ...
  )
{
  ...
  if ((_gPcd_FixedAtBuild_PcdShellProfileMask & 0x00000002) == 0) {
  ...
  gShellDebug1HiiHandle = HiiAddPackages (&gShellDebug1HiiGuid, gImageHandle, UefiShellDebug1CommandsLibStrings, ((void *) 0));
  if (gShellDebug1HiiHandle == ((void *) 0)) {
  ...
  ShellCommandRegisterCommandName (L"setsize", ShellCommandRunSetSize, ShellCommandGetManFileNameDebug1, 0, L"Debug1", ((BOOLEAN)(1==1)), gShellDebug1HiiHandle, 0x0328);
  ShellCommandRegisterCommandName (L"comp", ShellCommandRunComp, ShellCommandGetManFileNameDebug1, 0, L"Debug1", ((BOOLEAN)(1==1)), gShellDebug1HiiHandle, 0x0327);
  ShellCommandRegisterCommandName (L"mode", ShellCommandRunMode, ShellCommandGetManFileNameDebug1, 0, L"Debug1", ((BOOLEAN)(1==1)), gShellDebug1HiiHandle, 0x0329);
  ShellCommandRegisterCommandName (L"memmap", ShellCommandRunMemMap, ShellCommandGetManFileNameDebug1, 0, L"Debug1", ((BOOLEAN)(1==1)), gShellDebug1HiiHandle, 0x032A);
  ShellCommandRegisterCommandName (L"eficompress", ShellCommandRunEfiCompress, ShellCommandGetManFileNameDebug1, 0, L"Debug1", ((BOOLEAN)(1==1)), gShellDebug1HiiHandle, 0x032B);
  ShellCommandRegisterCommandName (L"efidecompress", ShellCommandRunEfiDecompress, ShellCommandGetManFileNameDebug1, 0, L"Debug1", ((BOOLEAN)(1==1)), gShellDebug1HiiHandle, 0x032C);
  ShellCommandRegisterCommandName (L"dmem", ShellCommandRunDmem, ShellCommandGetManFileNameDebug1, 0, L"Debug1", ((BOOLEAN)(1==1)), gShellDebug1HiiHandle, 0x032D);
  ShellCommandRegisterCommandName (L"loadpcirom", ShellCommandRunLoadPciRom, ShellCommandGetManFileNameDebug1, 0, L"Debug1", ((BOOLEAN)(1==1)), gShellDebug1HiiHandle, 0x032F);
  ShellCommandRegisterCommandName (L"mm", ShellCommandRunMm, ShellCommandGetManFileNameDebug1, 0, L"Debug1", ((BOOLEAN)(1==1)), gShellDebug1HiiHandle, 0x032E);
  ShellCommandRegisterCommandName (L"setvar", ShellCommandRunSetVar, ShellCommandGetManFileNameDebug1, 0, L"Debug1", ((BOOLEAN)(1==1)), gShellDebug1HiiHandle, 0x0330);
  ShellCommandRegisterCommandName (L"sermode", ShellCommandRunSerMode, ShellCommandGetManFileNameDebug1, 0, L"Debug1", ((BOOLEAN)(1==1)), gShellDebug1HiiHandle, 0x0331);
  ShellCommandRegisterCommandName (L"pci", ShellCommandRunPci, ShellCommandGetManFileNameDebug1, 0, L"Debug1", ((BOOLEAN)(1==1)), gShellDebug1HiiHandle, 0x0332);
  ShellCommandRegisterCommandName (L"smbiosview", ShellCommandRunSmbiosView, ShellCommandGetManFileNameDebug1, 0, L"Debug1", ((BOOLEAN)(1==1)), gShellDebug1HiiHandle, 0x0333);
  ShellCommandRegisterCommandName (L"dmpstore", ShellCommandRunDmpStore, ShellCommandGetManFileNameDebug1, 0, L"Debug1", ((BOOLEAN)(1==1)), gShellDebug1HiiHandle, 0x0334);
  ShellCommandRegisterCommandName (L"dblk", ShellCommandRunDblk, ShellCommandGetManFileNameDebug1, 0, L"Debug1", ((BOOLEAN)(1==1)), gShellDebug1HiiHandle, 0x0335);
  ShellCommandRegisterCommandName (L"edit", ShellCommandRunEdit, ShellCommandGetManFileNameDebug1, 0, L"Debug1", ((BOOLEAN)(1==1)), gShellDebug1HiiHandle, 0x0336);
  ShellCommandRegisterCommandName (L"hexedit", ShellCommandRunHexEdit, ShellCommandGetManFileNameDebug1, 0, L"Debug1", ((BOOLEAN)(1==1)), gShellDebug1HiiHandle, 0x0337);
...
# 120 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/UefiShellDebug1CommandsLib.c"
EFI_STATUS
GetSystemConfigurationTable (
  EFI_GUID *TableGuid,
  void **Table
...
# 147 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/UefiShellDebug1CommandsLib.c"
void
EditorClearLine (
  UINTN Row,
  UINTN LastCol,
  ...
  )
{
  ...
  Line[(sizeof (Line) / sizeof ((Line)[0])) - 1] = 0x0000;

  for (Col = 1; Col <= LastCol; Col += (sizeof (Line) / sizeof ((Line)[0])) - 1) {
    if (Col + (sizeof (Line) / sizeof ((Line)[0])) - 1 > LastCol) {
      if (Row == LastRow) {



        Line[(LastCol - 1) % ((sizeof (Line) / sizeof ((Line)[0])) - 1)] = 0x0000;
      } else {
        Line[LastCol % ((sizeof (Line) / sizeof ((Line)[0])) - 1)] = 0x0000;
      }
    }
...
# 195 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/UefiShellDebug1CommandsLib.c"
BOOLEAN
IsValidFileNameChar (
  const CHAR16 Ch
  )
...
# 218 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/UefiShellDebug1CommandsLib.c"
BOOLEAN
IsValidFileName (
  const CHAR16 *Name
  )
...
# 259 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/UefiShellDebug1CommandsLib.c"
CHAR16 *
EditGetDefaultFileName (
  const CHAR16 *Extension
  )
{
  ...
  do {
    FileNameTmp = CatSPrint (((void *) 0), L"NewFile%d.%s", Suffix, Extension);
    if (FileNameTmp == ((void *) 0)) {
      do { if (((BOOLEAN)(0==1))) { (void) (FileNameTmp != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
      return ((void *) 0);
    }
...
# 316 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/UefiShellDebug1CommandsLib.c"
EFI_STATUS
ReadFileIntoBuffer (
  const CHAR16 *FileName,
  void **Buffer,
  ...
  )
{
  ...
  if ((FileName == ((void *) 0)) || (Buffer == ((void *) 0)) || (ReadOnly == ((void *) 0))) {
  ...
  if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    do { if (((BOOLEAN)(0==1))) { (void) (CreateFile == ((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  ...
  if (!CreateFile) {
    ...
    FileHandle = ((void *) 0);
    if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
      do { if ((InternalBuffer) != ((void *) 0)) { FreePool((InternalBuffer)); (InternalBuffer) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
      return ((RETURN_STATUS)(0x8000000000000000ULL | (1)));
    }
  }

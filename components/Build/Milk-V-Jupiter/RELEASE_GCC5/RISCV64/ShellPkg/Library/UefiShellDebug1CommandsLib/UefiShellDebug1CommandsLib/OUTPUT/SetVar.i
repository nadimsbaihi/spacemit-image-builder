# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/SetVar.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/SetVar.c"
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/SetVar.c"
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/SetVar.c" 2
...
# 47 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/SetVar.c"
BOOLEAN
...
# 70 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/SetVar.c"
DATA_TYPE
TestDataType (
  const CHAR16 *Data
  )
...
# 116 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/SetVar.c"
EFI_STATUS
ParseParameterData (
  const CHAR16 *Data,
  void *Buffer,
  ...
  )
{
  ...
  if ((Data == ((void *) 0)) || (BufferSize == ((void *) 0))) {
  ...
  if (DataType == DataTypeHexNumber) {
    ...
    StrHexToUint64S (Data + 2, ((void *) 0), &HexNumber);
    ...
    if ((Buffer != ((void *) 0)) && (*BufferSize >= Size)) {
    ...
    *BufferSize = Size;
    ...
    do { if ((AsciiBuffer) != ((void *) 0)) { FreePool((AsciiBuffer)); (AsciiBuffer) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
    ...
    *BufferSize = Size;
    ...
    if (DevPath == ((void *) 0)) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0270, gShellDebug1HiiHandle, L"setvar");
...
# 264 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/SetVar.c"
EFI_STATUS
  ...
  )
{
  ...
  if ((BufferSize == ((void *) 0)) || (Buffer == ((void *) 0)) || (ShellCommandLineGetCount (Package) < 3)) {
    return ((RETURN_STATUS)(0x8000000000000000ULL | (2)));
  }
  ...
  for (Index = 2; Index < ShellCommandLineGetCount (Package); Index++) {
    ...
    if (TempData == ((void *) 0)) {
      do { if (((BOOLEAN)(0==1))) { (void) (TempData != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
      return ((RETURN_STATUS)(0x8000000000000000ULL | (2)));
    }

    if (TempData[0] != L'=') {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x022C, gShellDebug1HiiHandle, L"setvar", TempData);
      return ((RETURN_STATUS)(0x8000000000000000ULL | (2)));
    }

    TempData = TempData + 1;
    Size = 0;
    Status = ParseParameterData (TempData, ((void *) 0), &Size);
  ...
  )
{
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    if ((Status == ((RETURN_STATUS)(0x8000000000000000ULL | (10)))) && (ProblemParam != ((void *) 0))) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0224, gShellDebug1HiiHandle, L"setvar", ProblemParam);
      FreePool (ProblemParam);
      ShellStatus = SHELL_INVALID_PARAMETER;
    } else {
      do { if (((BOOLEAN)(0==1))) { (void) (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    }
  } else if (ShellCommandLineCheckDuplicate (Package, &ProblemParam) != (RETURN_STATUS)(0)) {
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0226, gShellDebug1HiiHandle, L"setvar", ProblemParam);
    FreePool (ProblemParam);
    ShellStatus = SHELL_INVALID_PARAMETER;
  } else {
    if (ShellCommandLineGetCount (Package) < 2) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0228, gShellDebug1HiiHandle, L"setvar");
      ShellStatus = SHELL_INVALID_PARAMETER;
    } else {
      ...
      if (!ShellCommandLineGetFlag (Package, L"-guid")) {
        ...
        if (StringGuid != ((void *) 0)) {
          RStatus = StrToGuid (StringGuid, &Guid);
        } else {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x022C, gShellDebug1HiiHandle, L"setvar", StringGuid);
          ShellCommandLineFreeVarList (Package);
          return SHELL_INVALID_PARAMETER;
        }

        if ((((RETURN_STATUS)(RStatus)) >= 0x8000000000000000ULL) || (StringGuid[36] != L'\0')) {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x022C, gShellDebug1HiiHandle, L"setvar", StringGuid);
          ShellStatus = SHELL_INVALID_PARAMETER;
        }
      }
      ...
      if (ShellCommandLineGetCount (Package) == 2) {
        ...
        if (Status == ((RETURN_STATUS)(0x8000000000000000ULL | (5)))) {
          ...
          if (Buffer == ((void *) 0)) {
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x022F, gShellDebug1HiiHandle, L"setvar");
            ShellCommandLineFreeVarList (Package);
        ...
        if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) && (Buffer != ((void *) 0))) {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x026D, gShellDebug1HiiHandle, &Guid, VariableName, Size);
          ...
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x026F, gShellDebug1HiiHandle, L"setvar", &Guid, VariableName);
        ...
        if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x026E, gShellDebug1HiiHandle, L"setvar", &Guid, VariableName);
          ShellStatus = SHELL_ACCESS_DENIED;
        } else {

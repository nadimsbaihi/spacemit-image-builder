...
.Ltext0:
	...
	.file 0 "/home/kapoagaeming/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/ShellPkg/Library/UefiShellDebug1CommandsLib/UefiShellDebug1CommandsLib" "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Mode.c"
	.section	.rodata
	.align	3
.LC0:
	.string	"m"
	...
	.string	"e"
	.zero	2
	.section	.text.ShellCommandRunMode,"ax",@progbits
	.align	1
	.globl	ShellCommandRunMode
	.type	ShellCommandRunMode, @function
ShellCommandRunMode:
.LFB0:
	.file 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Mode.c"
	.loc 1 24 1
	.cfi_startproc
	addi	sp,sp,-112
	...
	addi	a5,a5,10
	bne	a4,a5,.L3
	.loc 1 54 86 discriminator 1
	ld	a5,-80(s0)
	.loc 1 54 69 discriminator 1
	beq	a5,zero,.L3
	.loc 1 55 7
...
.L26:
	...
	nop
.L14:
	.loc 1 90 128 discriminator 2
	lw	a5,-28(s0)
	addiw	a5,a5,1
	sw	a5,-28(s0)
.L12:
	.loc 1 90 64 discriminator 1
	la	a5,gST
	ld	a5,0(a5)
	ld	a5,64(a5)
	.loc 1 90 72 discriminator 1
	ld	a5,72(a5)
	.loc 1 90 78 discriminator 1
	lw	a5,0(a5)
	.loc 1 90 88 discriminator 1
	lw	a4,-28(s0)
	sext.w	a4,a4
	bge	a4,a5,.L17
	.loc 1 90 88 is_stmt 0 discriminator 3
	lw	a5,-20(s0)
	sext.w	a5,a5
	beq	a5,zero,.L18
.L17:
	.loc 1 110 10 is_stmt 1
	lbu	a5,-21(s0)
	andi	a5,a5,0xff
	bne	a5,zero,.L5
	.loc 1 111 9
...
.LVL2:
	...
	sext.w	a4,a4
	bne	a4,a5,.L22
	.loc 1 125 9 is_stmt 0 discriminator 1
	li	a5,42
	j	.L23
.L22:
...
.L19:
	...
	ld	a5,0(a5)
	ld	a5,64(a5)
	.loc 1 119 72 discriminator 1
	ld	a5,72(a5)
	.loc 1 119 78 discriminator 1
	lw	a5,0(a5)
	.loc 1 119 88 discriminator 1
	lw	a4,-28(s0)
	sext.w	a4,a4
	bge	a4,a5,.L5
	.loc 1 119 88 is_stmt 0 discriminator 3
	lw	a5,-20(s0)
	sext.w	a5,a5
	beq	a5,zero,.L24
.L5:
...
.L3:
	...
	.cfi_endproc
.LFE0:
	.size	ShellCommandRunMode, .-ShellCommandRunMode
	.text
.Letext0:
	...
	.file 13 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/UefiShellDebug1CommandsLib.h"
...
.LASF0:
	.string	"/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Mode.c"

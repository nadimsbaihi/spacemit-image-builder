# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/EditInputBar.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/EditInputBar.c"
# 9 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/EditInputBar.c"
...
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/EditInputBar.c" 2
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/EditInputBar.c" 2
  ...
  )
{
  ...
  do { if ((mPrompt) != ((void *) 0)) { FreePool((mPrompt)); (mPrompt) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
  do { if ((mReturnString) != ((void *) 0)) { FreePool((mReturnString)); (mReturnString) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
  mPrompt = ((void *) 0);
  mReturnString = ((void *) 0);
}
# 57 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/EditInputBar.c"
void
InputBarPrintInput (
  UINTN LastColumn,
  UINTN LastRow
...
# 117 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/EditInputBar.c"
EFI_STATUS
InputBarRefresh (
  UINTN LastRow,
  UINTN LastColumn
  )
{
  ...
  ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0007, gShellDebug1HiiHandle, mPrompt);
  ...
  for ( ; ;) {
    ...
    if (KeyData.Key.ScanCode == 0x0017) {
      Size = 0;
    ...
    if ((KeyData.Key.UnicodeChar == 0x000A) || (KeyData.Key.UnicodeChar == 0x000D)) {
      break;
    } else if (KeyData.Key.UnicodeChar == 0x0008) {



      if (Size > 0) {
        Size--;
        mReturnString[Size] = 0x0000;
        if (!NoDisplay) {
...
# 266 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/EditInputBar.c"
EFI_STATUS
InputBarSetPrompt (
  const CHAR16 *Str
  )
{
  ...
  mPrompt = CatSPrint (((void *) 0), L"%s ", Str);
  if (mPrompt == ((void *) 0)) {
...
# 292 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/EditInputBar.c"
EFI_STATUS
InputBarSetStringSize (
  UINTN Size
  )

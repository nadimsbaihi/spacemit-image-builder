# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/SetSize.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/SetSize.c"
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/SetSize.c"
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/SetSize.c" 2
  ...
  )
{
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    if ((Status == ((RETURN_STATUS)(0x8000000000000000ULL | (10)))) && (ProblemParam != ((void *) 0))) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0224, gShellDebug1HiiHandle, L"setsize", ProblemParam);
    ...
    if (ShellCommandLineGetCount (Package) < 3) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0228, gShellDebug1HiiHandle, L"setsize");
      ShellStatus = SHELL_INVALID_PARAMETER;
      NewSize = 0;
    } else {
      Temp1 = ShellCommandLineGetRawValue (Package, 1);
      if (Temp1 == ((void *) 0)) {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x022C, gShellDebug1HiiHandle, L"setsize");
        ShellStatus = SHELL_INVALID_PARAMETER;
        NewSize = 0;
      } else if (!ShellIsHexOrDecimalNumber (Temp1, ((BOOLEAN)(0==1)), ((BOOLEAN)(0==1)))) {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0239, gShellDebug1HiiHandle, L"setsize");
        ShellStatus = SHELL_INVALID_PARAMETER;
        NewSize = 0;
      } else {
    ...
    for (LoopVar = 2; LoopVar < ShellCommandLineGetCount (Package) && ShellStatus == SHELL_SUCCESS; LoopVar++) {
      Status = ShellOpenFileByName (ShellCommandLineGetRawValue (Package, LoopVar), &FileHandle, 0x0000000000000001ULL|0x0000000000000002ULL, 0);
      if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
        Status = ShellOpenFileByName (ShellCommandLineGetRawValue (Package, LoopVar), &FileHandle, 0x0000000000000001ULL|0x0000000000000002ULL|0x8000000000000000ULL, 0);
      }

      if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) && (LoopVar == 2)) {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x023A, gShellDebug1HiiHandle, L"setsize");
        ShellStatus = SHELL_INVALID_PARAMETER;
      } else if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0231, gShellDebug1HiiHandle, L"setsize", ShellCommandLineGetRawValue (Package, LoopVar));
        ShellStatus = SHELL_INVALID_PARAMETER;
        break;
      } else {
        Status = FileHandleSetSize (FileHandle, NewSize);
        if (Status == ((RETURN_STATUS)(0x8000000000000000ULL | (11)))) {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x023D, gShellDebug1HiiHandle, L"setsize");
          ShellStatus = SHELL_VOLUME_FULL;
        } else if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x023E, gShellDebug1HiiHandle, L"setsize", ShellCommandLineGetRawValue (Package, LoopVar));
          ShellStatus = SHELL_INVALID_PARAMETER;
        } else {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x023F, gShellDebug1HiiHandle, ShellCommandLineGetRawValue (Package, LoopVar));
        }

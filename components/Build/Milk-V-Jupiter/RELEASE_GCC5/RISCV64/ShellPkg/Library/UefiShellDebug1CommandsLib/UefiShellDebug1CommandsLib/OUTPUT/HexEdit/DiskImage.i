# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/HexEdit/DiskImage.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/HexEdit/DiskImage.c"
# 9 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/HexEdit/DiskImage.c"
...
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/HexEdit/DiskImage.c" 2
...
extern EFI_GUID gEfiBlockIoProtocolGuid;
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/HexEdit/DiskImage.c" 2
...
# 62 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/HexEdit/DiskImage.c"
EFI_STATUS
HDiskImageBackup (
  void
  )
{
  ...
  do { if ((HDiskImageBackupVar.Name) != ((void *) 0)) { FreePool((HDiskImageBackupVar.Name)); (HDiskImageBackupVar.Name) = ((void *) 0); } } while(((BOOLEAN)(0==1)));

  HDiskImageBackupVar.Name = CatSPrint (((void *) 0), L"%s", HDiskImage.Name);
  if (HDiskImageBackupVar.Name == ((void *) 0)) {
...
{
  do { if ((HDiskImage.Name) != ((void *) 0)) { FreePool((HDiskImage.Name)); (HDiskImage.Name) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
  do { if ((HDiskImageBackupVar.Name) != ((void *) 0)) { FreePool((HDiskImageBackupVar.Name)); (HDiskImageBackupVar.Name) = ((void *) 0); } } while(((BOOLEAN)(0==1)));

  return (RETURN_STATUS)(0);
}
# 110 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/HexEdit/DiskImage.c"
EFI_STATUS
...
# 153 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/HexEdit/DiskImage.c"
EFI_STATUS
HDiskImageRead (
  const CHAR16 *DeviceName,
  UINTN Offset,
  ...
  )
{
  ...
  Status = gBS->OpenProtocol (Handle, &gEfiBlockIoProtocolGuid, (void **)&BlkIo, gImageHandle, ((void *) 0), 0x00000002);
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    StatusBarSetStatusString (L"Read Disk Failed");
    return Status;
  }
  ...
  if (!Recover) {
    Str = CatSPrint (((void *) 0), L"%d Lines Read", HBufferImage.NumLines);
    if (Str == ((void *) 0)) {
      StatusBarSetStatusString (L"Read Disk Failed");
      return ((RETURN_STATUS)(0x8000000000000000ULL | (9)));
    }
...
# 328 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/HexEdit/DiskImage.c"
EFI_STATUS
HDiskImageSave (
  CHAR16 *DeviceName,
  UINTN Offset,

# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/EfiDecompress.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/EfiDecompress.c"
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/EfiDecompress.c"
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/EfiDecompress.c" 2
...
# 12 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/EfiDecompress.c" 2
  ...
  )
{
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    if ((Status == ((RETURN_STATUS)(0x8000000000000000ULL | (10)))) && (ProblemParam != ((void *) 0))) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0224, gShellDebug1HiiHandle, L"efidecompress", ProblemParam);
    ...
    if (ShellCommandLineGetCount (Package) > 3) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0229, gShellDebug1HiiHandle, L"efidecompress");
      ShellStatus = SHELL_INVALID_PARAMETER;
    } else if (ShellCommandLineGetCount (Package) < 3) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0228, gShellDebug1HiiHandle, L"efidecompress");
      ShellStatus = SHELL_INVALID_PARAMETER;
    } else {
      TempParam = ShellCommandLineGetRawValue (Package, 1);
      if (TempParam == ((void *) 0)) {
        do { if (((BOOLEAN)(0==1))) { (void) (TempParam != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x022C, gShellDebug1HiiHandle, L"efidecompress");
        ShellStatus = SHELL_INVALID_PARAMETER;
        goto Done;
      }
      ...
      if ((InFileName == ((void *) 0)) || (OutFileName == ((void *) 0))) {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0237, gShellDebug1HiiHandle, L"efidecompress", TempParam);
        ShellStatus = SHELL_NOT_FOUND;
      } else {
        if (ShellIsDirectory (InFileName) == (RETURN_STATUS)(0)) {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0238, gShellDebug1HiiHandle, L"efidecompress", InFileName);
          ShellStatus = SHELL_INVALID_PARAMETER;
        }

        if (ShellIsDirectory (OutFileName) == (RETURN_STATUS)(0)) {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0238, gShellDebug1HiiHandle, L"efidecompress", OutFileName);
          ShellStatus = SHELL_INVALID_PARAMETER;
        }

        if (ShellStatus == SHELL_SUCCESS) {
          Status = ShellOpenFileByName (InFileName, &InFileHandle, 0x0000000000000001ULL, 0);
          if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0231, gShellDebug1HiiHandle, L"efidecompress", ShellCommandLineGetRawValue (Package, 1));
            ShellStatus = SHELL_NOT_FOUND;
          }
        }
        ...
        if (ShellStatus == SHELL_SUCCESS) {
          ...
          if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) || (OutSize == 0)) {
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0254, gShellDebug1HiiHandle, InFileName);
            ShellStatus = SHELL_NOT_FOUND;
          } else {
            Status = ShellOpenFileByName (OutFileName, &OutFileHandle, 0x0000000000000001ULL|0x0000000000000002ULL|0x8000000000000000ULL, 0);
            if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
              ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0236, gShellDebug1HiiHandle, ShellCommandLineGetRawValue (Package, 2), Status);
              ShellStatus = SHELL_NOT_FOUND;
            } else {
              OutBuffer = AllocateZeroPool (OutSize);
              ScratchBuffer = AllocateZeroPool (ScratchSize);
              if ((OutBuffer == ((void *) 0)) || (ScratchBuffer == ((void *) 0))) {
                Status = ((RETURN_STATUS)(0x8000000000000000ULL | (9)));
              } else {
          ...
          if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0253, gShellDebug1HiiHandle, Status);
            ShellStatus = ((Status == ((RETURN_STATUS)(0x8000000000000000ULL | (9)))) ? SHELL_OUT_OF_RESOURCES : SHELL_DEVICE_ERROR);
          } else {
            OutSizeTemp = OutSize;
            Status = gEfiShellProtocol->WriteFile (OutFileHandle, &OutSizeTemp, OutBuffer);
            OutSize = (UINT32)OutSizeTemp;
            if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
              ShellPrintHiiEx (-1, -1, ((void *) 0), 0x023B, gShellDebug1HiiHandle, L"efidecompress", OutFileName, Status);
...
Done:
  ...
  if (InFileHandle != ((void *) 0)) {
    gEfiShellProtocol->CloseFile (InFileHandle);
  }

  if (OutFileHandle != ((void *) 0)) {
    gEfiShellProtocol->CloseFile (OutFileHandle);
  }

  do { if ((InFileName) != ((void *) 0)) { FreePool((InFileName)); (InFileName) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
  do { if ((InBuffer) != ((void *) 0)) { FreePool((InBuffer)); (InBuffer) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
  do { if ((OutBuffer) != ((void *) 0)) { FreePool((OutBuffer)); (OutBuffer) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
  do { if ((ScratchBuffer) != ((void *) 0)) { FreePool((ScratchBuffer)); (ScratchBuffer) = ((void *) 0); } } while(((BOOLEAN)(0==1)));

# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Edit/Edit.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Edit/Edit.c"
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Edit/Edit.c"
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Edit/Edit.c" 2
...
# 13 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Edit/TextEditorTypes.h"
...
# 12 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Edit/Edit.c" 2
  ...
  )
{
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    if ((Status == ((RETURN_STATUS)(0x8000000000000000ULL | (10)))) && (ProblemParam != ((void *) 0))) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0224, gShellDebug1HiiHandle, L"edit", ProblemParam);
    ...
    if (ShellCommandLineGetCount (Package) > 2) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0229, gShellDebug1HiiHandle, L"edit");
      ShellStatus = SHELL_INVALID_PARAMETER;
    } else {
      Cwd = gEfiShellProtocol->GetCurDir (((void *) 0));
      if (Cwd == ((void *) 0)) {
        Cwd = ShellGetEnvironmentVariable (L"path");
        if (Cwd != ((void *) 0)) {
          Nfs = StrnCatGrow (&Nfs, ((void *) 0), Cwd+3, 0);
          if (Nfs != ((void *) 0)) {
            Spot = StrStr (Nfs, L";");
            if (Spot != ((void *) 0)) {
              *Spot = 0x0000;
            ...
            gEfiShellProtocol->SetCurDir (((void *) 0), Nfs);
            FreePool (Nfs);
          }
        }
      }
      ...
      if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
        ...
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x002A, gShellDebug1HiiHandle);
      } else {
        MainEditorBackup ();
        ...
        if (ShellCommandLineGetCount (Package) == 2) {
          ...
          if (TempParam == ((void *) 0)) {
            do { if (((BOOLEAN)(0==1))) { (void) (TempParam != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x022C, gShellDebug1HiiHandle, L"edit");
            ShellStatus = SHELL_INVALID_PARAMETER;
          } else {
        ...
        Status = FileBufferRead (MainEditor.FileBuffer->FileName, ((BOOLEAN)(0==1)));
        if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
          MainEditorRefresh ();
        ...
        if (Status != ((RETURN_STATUS)(0x8000000000000000ULL | (9)))) {
          ...
          Buffer = CatSPrint (((void *) 0), L"%s", StatusBarGetString ());
        }
        ...
        if (Status == (RETURN_STATUS)(0)) {
          ...
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x022F, gShellDebug1HiiHandle, L"edit");
        } else {
          if (Buffer != ((void *) 0)) {
            if (StrCmp (Buffer, L"") != 0) {
              ...
              ShellPrintHiiEx (-1, -1, ((void *) 0), 0x002B, gShellDebug1HiiHandle, Buffer);
            } else {
              ShellPrintHiiEx (-1, -1, ((void *) 0), 0x002C, gShellDebug1HiiHandle);
            }
          } else {
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x002C, gShellDebug1HiiHandle);
          }

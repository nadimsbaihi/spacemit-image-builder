# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Compress.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Compress.c"
# 15 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Compress.c"
...
# 16 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Compress.c" 2
...
# 17 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Compress.c" 2
...
# 18 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Compress.c" 2
...
# 19 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Compress.c" 2

# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Compress.h" 1
# 24 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Compress.h"
EFI_STATUS
Compress (
  void *SrcBuffer,
  UINT64 SrcSize,
...
# 21 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Compress.c" 2




typedef INT16 NODE;
# 65 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Compress.c"
void
PutDword (
  UINT32 Data
  );
...
static UINT8 *mBuf;
static UINT8 mCLen[(0xff + 256 + 2 - 3)];
static UINT8 mPTLen[(16 + 3)];
static UINT8 *mLen;
static INT16 mHeap[(0xff + 256 + 2 - 3) + 1];
...
static UINT16 mLeft[2 * (0xff + 256 + 2 - 3) - 1];
static UINT16 mRight[2 * (0xff + 256 + 2 - 3) - 1];
static UINT16 mCrcTable[0xff + 1];
static UINT16 mCFreq[2 * (0xff + 256 + 2 - 3) - 1];
static UINT16 mCCode[(0xff + 256 + 2 - 3)];
static UINT16 mPFreq[2 * (13 + 1) - 1];
static UINT16 mPTCode[(16 + 3)];
static UINT16 mTFreq[2 * (16 + 3) - 1];
  ...
  )
{
  ...
  for (LoopVar1 = 0; LoopVar1 <= 0xff; LoopVar1++) {
    LoopVar4 = LoopVar1;
    for (LoopVar2 = 0; LoopVar2 < 8; LoopVar2++) {
      if ((LoopVar4 & 1) != 0) {
        LoopVar4 = (LoopVar4 >> 1) ^ 0xA001;
      } else {
        LoopVar4 >>= 1;
      }
    }
...
{
  mText = AllocateZeroPool ((1U << 13) * 2 + 256);
  mLevel = AllocateZeroPool (((1U << 13) + 0xff + 1) * sizeof (*mLevel));
  mChildCount = AllocateZeroPool (((1U << 13) + 0xff + 1) * sizeof (*mChildCount));
  mPosition = AllocateZeroPool (((1U << 13) + 0xff + 1) * sizeof (*mPosition));
  mParent = AllocateZeroPool ((1U << 13) * 2 * sizeof (*mParent));
  mPrev = AllocateZeroPool ((1U << 13) * 2 * sizeof (*mPrev));
  mNext = AllocateZeroPool (((3 * (1U << 13) + ((1U << 13) / 512 + 1) * 0xff) + 1) * sizeof (*mNext));
...
{
  do { if ((mText) != ((void *) 0)) { FreePool((mText)); (mText) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
  do { if ((mLevel) != ((void *) 0)) { FreePool((mLevel)); (mLevel) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
  do { if ((mChildCount) != ((void *) 0)) { FreePool((mChildCount)); (mChildCount) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
  do { if ((mPosition) != ((void *) 0)) { FreePool((mPosition)); (mPosition) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
  do { if ((mParent) != ((void *) 0)) { FreePool((mParent)); (mParent) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
  do { if ((mPrev) != ((void *) 0)) { FreePool((mPrev)); (mPrev) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
  do { if ((mNext) != ((void *) 0)) { FreePool((mNext)); (mNext) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
  do { if ((mBuf) != ((void *) 0)) { FreePool((mBuf)); (mBuf) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
}
  ...
  )
{
  ...
  SetMem (mLevel + (1U << 13), (0xff + 1) * sizeof (UINT8), 1);
  SetMem (mPosition + (1U << 13), (0xff + 1) * sizeof (NODE), 0);

  SetMem (mParent + (1U << 13), (1U << 13) * sizeof (NODE), 0);

  mAvail = 1;
  for (LoopVar1 = 1; LoopVar1 < (1U << 13) - 1; LoopVar1++) {
    mNext[LoopVar1] = (NODE)(LoopVar1 + 1);
  }

  mNext[(1U << 13) - 1] = 0;
  SetMem (mNext + (1U << 13) * 2, ((3 * (1U << 13) + ((1U << 13) / 512 + 1) * 0xff) - (1U << 13) * 2 + 1) * sizeof (NODE), 0);
}
# 264 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Compress.c"
NODE
Child (
  NODE LoopVar6,
  UINT8 LoopVar5
  )
{
  ...
  LoopVar4 = mNext[((LoopVar6) + ((LoopVar5) << (13 - 9)) + (1U << 13) * 2)];
  mParent[0] = LoopVar6;
...
# 288 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Compress.c"
void
MakeChild (
  NODE LoopVar6,
  UINT8 LoopVar5,
  ...
  )
{
  ...
  LoopVar12 = (NODE)((LoopVar6) + ((LoopVar5) << (13 - 9)) + (1U << 13) * 2);
  ...
  )
{
  ...
  if (mMatchLen >= 4) {
    ...
    mMatchLen--;
    LoopVar4 = (NODE)((mMatchPos + 1) | (1U << 13));
    ...
    if (LoopVar10 < (1U << 13)) {
      mPosition[LoopVar10] = (NODE)(mPos | 0x8000U);
    }
  } else {



    LoopVar6 = (NODE)(mText[mPos] + (1U << 13));
  ...
  for ( ; ;) {
    if (LoopVar4 >= (1U << 13)) {
      ...
      mMatchPos = (NODE)(mPosition[LoopVar4] & ~0x8000U);
    }
  ...
  )
{
  ...
  LoopVar10 = (NODE)(mPosition[LoopVar4] & ~0x8000U);
  if (LoopVar10 >= mPos) {
    LoopVar10 -= (1U << 13);
  }
  ...
  while ((LoopVar9 & 0x8000U) != 0) {
    ...
    mPosition[LoopVar6] = (NODE)(LoopVar11 | (1U << 13));
    LoopVar6 = mParent[LoopVar6];
    LoopVar9 = mPosition[LoopVar6];
  }
  ...
  if (LoopVar6 < (1U << 13)) {
    ...
    mPosition[LoopVar6] = (NODE)(LoopVar11 | (1U << 13) | 0x8000U);
  }
...
# 565 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Compress.c"
INT32
FreadCrc (
  UINT8 *LoopVar7,
  INT32 LoopVar8
  )
{
  ...
  LoopVar1--;
  while (LoopVar1 >= 0) {
    mCrc = mCrcTable[(mCrc ^ (*LoopVar7++)) & 0xFF] ^ (mCrc >> 8);
    LoopVar1--;
  }

  return LoopVar8;
}
# 597 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Compress.c"
BOOLEAN
GetNextMatch (
  void
  )
{
  ...
  mPos++;
  if (mPos == (1U << 13) * 2) {
    Temp = AllocateZeroPool ((1U << 13) + 256);
    if (Temp == ((void *) 0)) {
      return (((BOOLEAN)(0==1)));
    }

    CopyMem (Temp, &mText[(1U << 13)], (1U << 13) + 256);
    CopyMem (&mText[0], Temp, (1U << 13) + 256);
    FreePool (Temp);
    LoopVar8 = FreadCrc (&mText[(1U << 13) + 256], (1U << 13));
    mRemainder += LoopVar8;
    mPos = (1U << 13);
  }
...
# 743 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Compress.c"
void
MakeCode (
  INT32 LoopVar8,
  UINT8 Len[],
...
# 773 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Compress.c"
INT32
MakeTree (
  INT32 NParm,
  UINT16 FreqParm[],
  ...
  )
{
  ...
  if (LoopVar8 < mBitCount) {
    ...
    if (LoopVar8 < 8) {
      mSubBitBuf = x << (mBitCount = 8 - LoopVar8);
    } else {
      Temp = (UINT8)(x >> (LoopVar8 - 8));
      if (mDst < mDstUpperLimit) {
        *mDst++ = Temp;
      }
      ...
      mSubBitBuf = x << (mBitCount = 2 * 8 - LoopVar8);
    }
  }
}
  ...
  )
{
  ...
  for (LoopVar1 = 0; LoopVar1 < (16 + 3); LoopVar1++) {
    mTFreq[LoopVar1] = 0;
  }

  LoopVar8 = (0xff + 256 + 2 - 3);
  ...
  while (LoopVar1 < LoopVar8) {
    ...
    if (LoopVar3 == 0) {
      ...
      do { if (((BOOLEAN)(0==1))) { (void) ((LoopVar3+2) < (2 * (16 + 3) - 1)); } } while (((BOOLEAN)(0==1)));
      mTFreq[LoopVar3 + 2]++;
    }
  }
}
# 990 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Compress.c"
void
WritePTLen (
  INT32 LoopVar8,
  INT32 nbit,
  ...
  )
{
  ...
  while (LoopVar1 < LoopVar8) {
    ...
    if (LoopVar3 == 0) {
      ...
      do { if (((BOOLEAN)(0==1))) { (void) ((LoopVar3+2) < (16 + 3)); } } while (((BOOLEAN)(0==1)));
  ...
  )
{
  ...
  Root = MakeTree ((0xff + 256 + 2 - 3), mCFreq, mCLen, mCCode);
  Size = mCFreq[Root];
  PutBits (16, Size);
  if (Root >= (0xff + 256 + 2 - 3)) {
    CountTFreq ();
    Root = MakeTree ((16 + 3), mTFreq, mPTLen, mPTCode);
    if (Root >= (16 + 3)) {
      WritePTLen ((16 + 3), 5, 3);
    } else {
      PutBits (5, 0);
  ...
  Root = MakeTree ((13 + 1), mPFreq, mPTLen, mPTCode);
  if (Root >= (13 + 1)) {
    WritePTLen ((13 + 1), 4, -1);
  } else {
    PutBits (4, 0);
  ...
  SetMem (mCFreq, (0xff + 256 + 2 - 3) * sizeof (UINT16), 0);
  SetMem (mPFreq, (13 + 1) * sizeof (UINT16), 0);
}
...
# 1179 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Compress.c"
void
CompressOutput (
  UINT32 LoopVar5,
  UINT32 LoopVar7
  )
{
  ...
  if (LoopVar5 >= (1U << 8)) {
    ...
    mBuf[mOutputPos++] = (UINT8)(LoopVar7 >> 8);
  ...
  )
{
  ...
  mRemainder = FreadCrc (&mText[(1U << 13)], (1U << 13) + 256);
  ...
  while (mRemainder > 0) {
    ...
    if ((mMatchLen > LastMatchLen) || (LastMatchLen < 3)) {
      ...
      CompressOutput (
        LastMatchLen + (0xff + 1 - 3),
        (mPos - LastMatchPos - 2) & ((1U << 13) - 1)
        );
      LastMatchLen--;
...
# 1323 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Compress.c"
EFI_STATUS
Compress (
  void *SrcBuffer,
  UINT64 SrcSize,

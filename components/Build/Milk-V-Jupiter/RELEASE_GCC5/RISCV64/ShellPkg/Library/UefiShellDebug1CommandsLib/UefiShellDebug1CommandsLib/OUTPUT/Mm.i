# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Mm.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Mm.c"
# 10 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Mm.c"
...
# 11 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Mm.c" 2
...
# 13 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Mm.c" 2

# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdePkg/Include/Protocol/DeviceIo.h" 1
# 20 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdePkg/Include/Protocol/DeviceIo.h"
typedef struct _EFI_DEVICE_IO_PROTOCOL EFI_DEVICE_IO_PROTOCOL;
# 30 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdePkg/Include/Protocol/DeviceIo.h"
...
# 68 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdePkg/Include/Protocol/DeviceIo.h"
typedef
EFI_STATUS
( *EFI_DEVICE_IO)(
...
# 97 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdePkg/Include/Protocol/DeviceIo.h"
typedef
EFI_STATUS
( *EFI_PCI_DEVICE_PATH)(
  EFI_DEVICE_IO_PROTOCOL *This,
...
# 144 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdePkg/Include/Protocol/DeviceIo.h"
typedef
EFI_STATUS
( *EFI_IO_MAP)(
  EFI_DEVICE_IO_PROTOCOL *This,
...
# 165 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdePkg/Include/Protocol/DeviceIo.h"
typedef
EFI_STATUS
( *EFI_IO_UNMAP)(
  EFI_DEVICE_IO_PROTOCOL *This,
...
# 189 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdePkg/Include/Protocol/DeviceIo.h"
typedef
EFI_STATUS
...
# 208 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdePkg/Include/Protocol/DeviceIo.h"
typedef
EFI_STATUS
( *EFI_IO_FLUSH)(
  EFI_DEVICE_IO_PROTOCOL *This
  );
# 227 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdePkg/Include/Protocol/DeviceIo.h"
typedef
EFI_STATUS
( *EFI_IO_FREE_BUFFER)(
  EFI_DEVICE_IO_PROTOCOL *This,
...
# 15 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Mm.c" 2
...
const UINT64 mShellMmMaxNumber[] = {
  0, ((UINT8)0xFF), ((UINT16)0xFFFF), 0, ((UINT32)0xFFFFFFFF), 0, 0, 0, ((UINT64)0xFFFFFFFFFFFFFFFFULL)
};
...
# 65 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Mm.c"
void
...
# 127 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Mm.c"
void
ShellMmAccess (
  ...
  )
{
  ...
  if (AccessType == ShellMmMemory) {
    ...
    RootBridgeIoMem = ((void *) 0);
    CpuIoMem = ((void *) 0);
    switch (AccessType) {
      case ShellMmPci:
      case ShellMmPciExpress:
        do { if (((BOOLEAN)(0==1))) { (void) (PciRootBridgeIo != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
        ...
        if (Read) {
          Status = PciRootBridgeIo->Pci.Read (
                                          ...
                                          (UINT64) ( (((UINTN) Bus) << 24) | (((UINTN) Device) << 16) | (((UINTN) Function) << 8) | (((UINTN) (Register)) < 256 ? ((UINTN) (Register)) : (UINT64) (LShiftU64 ((UINT64) (Register), 32)))),
                                          1,
                                          Buffer
                                          );
        } else {
    ...
    if (RootBridgeIoMem != ((void *) 0)) {
      Status = RootBridgeIoMem (PciRootBridgeIo, mShellMmRootBridgeIoWidth[Size], Address, 1, Buffer);
    }

    if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) && (CpuIoMem != ((void *) 0))) {
...
# 312 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Mm.c"
BOOLEAN
  ...
  )
{
  ...
  Status = gBS->LocateProtocol (&gEfiCpuIo2ProtocolGuid, ((void *) 0), (void **)CpuIo);
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    *CpuIo = ((void *) 0);
  }
  ...
  *PciRootBridgeIo = ((void *) 0);
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) || (HandleCount == 0) || (HandleBuffer == ((void *) 0))) {
    return ((BOOLEAN)(0==1));
  }
  ...
  if ((AccessType == ShellMmPci) || (AccessType == ShellMmPciExpress)) {
    ShellMmDecodePciAddress ((BOOLEAN)(AccessType == ShellMmPci), Address, &Segment, &Bus, ((void *) 0), ((void *) 0), ((void *) 0));
  }




  for (Index = 0; (Index < HandleCount) && (*PciRootBridgeIo == ((void *) 0)); Index++) {
        ...
        )
    {
      ...
      if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
        while (Descriptors->Desc != 0x79) {
          ...
          } else if ((((Descriptors->ResType == 0x01) && (AccessType == ShellMmIo)) ||
                      ((Descriptors->ResType == 0x00) && (AccessType == ShellMmMemoryMappedIo))
  ...
  )
{
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    if ((Status == ((RETURN_STATUS)(0x8000000000000000ULL | (10)))) && (ProblemParam != ((void *) 0))) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0224, gShellDebug1HiiHandle, L"mm", ProblemParam);
    ...
    if (ShellCommandLineGetCount (Package) < 2) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0228, gShellDebug1HiiHandle, L"mm");
      ShellStatus = SHELL_INVALID_PARAMETER;
      goto Done;
    } else if (ShellCommandLineGetCount (Package) > 3) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0229, gShellDebug1HiiHandle, L"mm");
      ShellStatus = SHELL_INVALID_PARAMETER;
      goto Done;
    } else if (ShellCommandLineGetFlag (Package, L"-w") && (ShellCommandLineGetValue (Package, L"-w") == ((void *) 0))) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0227, gShellDebug1HiiHandle, L"mm", L"-w");
      ShellStatus = SHELL_INVALID_PARAMETER;
      goto Done;
    } else {
    ...
    if ((Size != 1) && (Size != 2) && (Size != 4) && (Size != 8)) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0225, gShellDebug1HiiHandle, L"mm", Temp, L"-w");
      ShellStatus = SHELL_INVALID_PARAMETER;
      goto Done;
    }
    ...
    if (Temp == ((void *) 0)) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0224, gShellDebug1HiiHandle, L"mm", L"NULL");
      ShellStatus = SHELL_INVALID_PARAMETER;
      goto Done;
    }

    Status = ShellConvertStringToUint64 (Temp, &Address, ((BOOLEAN)(1==1)), ((BOOLEAN)(0==1)));
    if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x022C, gShellDebug1HiiHandle, L"mm", Temp);
      ShellStatus = SHELL_INVALID_PARAMETER;
      goto Done;
    }

    if ((Address & (Size - 1)) != 0) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0263, gShellDebug1HiiHandle, L"mm", Address);
      ShellStatus = SHELL_INVALID_PARAMETER;
      goto Done;
    }
    ...
    if ((AccessType == ShellMmPci) || (AccessType == ShellMmPciExpress)) {
      if (!HasPciRootBridgeIo) {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x022A, gShellDebug1HiiHandle, L"mm");
        ShellStatus = SHELL_NOT_FOUND;
        goto Done;
      }

      if (PciRootBridgeIo == ((void *) 0)) {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0264, gShellDebug1HiiHandle, L"mm", Address);
        ShellStatus = SHELL_INVALID_PARAMETER;
        goto Done;
      }
    }
    ...
    if (Temp != ((void *) 0)) {
      Status = ShellConvertStringToUint64 (Temp, &Value, ((BOOLEAN)(1==1)), ((BOOLEAN)(0==1)));
      if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x022C, gShellDebug1HiiHandle, L"mm", Temp);
        ShellStatus = SHELL_INVALID_PARAMETER;
        goto Done;
      ...
      ShellMmAccess (AccessType, PciRootBridgeIo, CpuIo, ((BOOLEAN)(0==1)), Address, Size, &Value);
      goto Done;
    }
    ...
    if (!Interactive) {
      if (!gEfiShellProtocol->BatchIsActive ()) {
        ShellPrintHiiEx (-1, -1, ((void *) 0), mShellMmAccessTypeStr[AccessType], gShellDebug1HiiHandle);
      }

      ShellMmAccess (AccessType, PciRootBridgeIo, CpuIo, ((BOOLEAN)(1==1)), Address, Size, &Buffer);

      if (!gEfiShellProtocol->BatchIsActive ()) {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x026A, gShellDebug1HiiHandle, Address);
      }

      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x026B, gShellDebug1HiiHandle, Size * 2, Buffer & mShellMmMaxNumber[Size]);
      ShellPrintEx (-1, -1, L"\r\n");
      goto Done;
    }
    ...
    do {
      ...
      ShellPromptForResponse (ShellPromptResponseTypeFreeform, ((void *) 0), (void **)&InputStr);
      ...
      if (InputStr != ((void *) 0)) {
        ...
        if (InputStr[Index] != 0x0000) {
          if ((InputStr[Index] == '.') || (InputStr[Index] == 'q') || (InputStr[Index] == 'Q')) {
            Complete = ((BOOLEAN)(1==1));
          } else if (!(((RETURN_STATUS)(ShellConvertStringToUint64 (InputStr + Index, &Buffer, ((BOOLEAN)(1==1)), ((BOOLEAN)(1==1))))) >= 0x8000000000000000ULL) &&
                     (Buffer <= mShellMmMaxNumber[Size])
                     )
          {
            ShellMmAccess (AccessType, PciRootBridgeIo, CpuIo, ((BOOLEAN)(0==1)), Address, Size, &Buffer);
          } else {
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x026C, gShellDebug1HiiHandle, L"mm");
            continue;
          }
        }
      }
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (ShellStatus == SHELL_SUCCESS); } } while (((BOOLEAN)(0==1)));

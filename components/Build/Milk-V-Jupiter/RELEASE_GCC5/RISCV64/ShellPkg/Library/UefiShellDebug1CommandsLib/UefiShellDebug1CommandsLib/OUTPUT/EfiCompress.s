...
.Ltext0:
	...
	.file 0 "/home/kapoagaeming/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/ShellPkg/Library/UefiShellDebug1CommandsLib/UefiShellDebug1CommandsLib" "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/EfiCompress.c"
	.section	.rodata
	.align	3
.LC0:
	.string	"e"
	...
	.string	"s"
	.zero	2
	.section	.text.ShellCommandRunEfiCompress,"ax",@progbits
	.align	1
	.globl	ShellCommandRunEfiCompress
	.type	ShellCommandRunEfiCompress, @function
ShellCommandRunEfiCompress:
.LFB0:
	.file 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/EfiCompress.c"
	.loc 1 25 1
	.cfi_startproc
	addi	sp,sp,-176
...
.L15:
	...
	j	.L5
.L18:
	.loc 1 144 25 is_stmt 0 discriminator 2
	li	a5,7
	sw	a5,-44(s0)
	j	.L5
.L17:
...
.L21:
	...
	ld	a5,-72(s0)
	beq	a5,zero,.L22
	.loc 1 173 44 discriminator 1
	ld	a0,-72(s0)
	call	FreePool@plt
	.loc 1 173 81 discriminator 2
	sd	zero,-72(s0)
.L22:
	.loc 1 174 11
	ld	a5,-64(s0)
...
.L24:
	...
	.cfi_endproc
.LFE0:
	.size	ShellCommandRunEfiCompress, .-ShellCommandRunEfiCompress
	.text
.Letext0:
	...
	.file 15 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Compress.h"
...
.LASF0:
	.string	"/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/EfiCompress.c"
.LASF1:

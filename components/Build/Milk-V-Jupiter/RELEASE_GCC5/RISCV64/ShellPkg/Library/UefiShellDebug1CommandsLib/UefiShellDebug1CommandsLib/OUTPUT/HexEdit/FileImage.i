# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/HexEdit/FileImage.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/HexEdit/FileImage.c"
# 9 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/HexEdit/FileImage.c"
...
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/HexEdit/FileImage.c" 2
...
# 63 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/HexEdit/FileImage.c"
EFI_STATUS
HFileImageBackup (
  void
  )
{
  do { if ((HFileImageBackupVar.FileName) != ((void *) 0)) { FreePool((HFileImageBackupVar.FileName)); (HFileImageBackupVar.FileName) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
  HFileImageBackupVar.FileName = CatSPrint (((void *) 0), L"%s", HFileImage.FileName);
  if (HFileImageBackupVar.FileName == ((void *) 0)) {
...
{
  do { if ((HFileImage.FileName) != ((void *) 0)) { FreePool((HFileImage.FileName)); (HFileImage.FileName) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
  do { if ((HFileImageBackupVar.FileName) != ((void *) 0)) { FreePool((HFileImageBackupVar.FileName)); (HFileImageBackupVar.FileName) = ((void *) 0); } } while(((BOOLEAN)(0==1)));

  return (RETURN_STATUS)(0);
}
# 101 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/HexEdit/FileImage.c"
EFI_STATUS
  ...
  )
{
  ...
  if (HFileImage.FileName == ((void *) 0)) {
    return ((RETURN_STATUS)(0x8000000000000000ULL | (9)));
  }

  return (RETURN_STATUS)(0);
}
# 136 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/HexEdit/FileImage.c"
EFI_STATUS
HFileImageRead (
  const CHAR16 *FileName,
  BOOLEAN Recover
  )
{
  ...
  Line = ((void *) 0);
# 160 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/HexEdit/FileImage.c"
  Status = ReadFileIntoBuffer (FileName, (void **)&Buffer, &HFileImage.Size, &HFileImage.ReadOnly);



  if (((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) || ((Buffer == ((void *) 0)) && (HFileImage.Size != 0))) {
    UnicodeBuffer = CatSPrint (((void *) 0), L"Read error on file %s: %r", FileName, Status);
  ...
  HBufferImage.HighBits = ((BOOLEAN)(1==1));
  HBufferImage.BufferPosition.Row = 1;
  HBufferImage.BufferPosition.Column = 1;
  HBufferImage.BufferType = FileTypeFileBuffer;

  if (!Recover) {
    UnicodeBuffer = CatSPrint (((void *) 0), L"%d Lines Read", HBufferImage.NumLines);
    if (UnicodeBuffer == ((void *) 0)) {
      do { if ((Buffer) != ((void *) 0)) { FreePool((Buffer)); (Buffer) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
      return ((RETURN_STATUS)(0x8000000000000000ULL | (9)));
    }
  ...
  if (HBufferImage.Lines != 0) {
    HBufferImage.CurrentLine = (((HEFI_EDITOR_LINE *) (void *) ((CHAR8 *) (HBufferImage.ListHead->ForwardLink) - ((UINTN) __builtin_offsetof(HEFI_EDITOR_LINE, Link))))->Signature != ((('e') | ('e' << 8)) | ((('l') | ('l' << 8)) << 16))) ? ((void *) 0) : ((HEFI_EDITOR_LINE *) (void *) ((CHAR8 *) (HBufferImage.ListHead->ForwardLink) - ((UINTN) __builtin_offsetof(HEFI_EDITOR_LINE, Link))));
  } else {
  ...
  HBufferImage.Modified = ((BOOLEAN)(0==1));
...
# 249 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/HexEdit/FileImage.c"
EFI_STATUS
HFileImageSave (
  CHAR16 *FileName
  )
{
  ...
  if ((HFileImage.FileName != ((void *) 0)) && (FileName != ((void *) 0)) && (StrCmp (FileName, HFileImage.FileName) == 0)) {



    if (ShellIsFile (FileName) == (RETURN_STATUS)(0)) {




      if (HBufferImage.Modified == ((BOOLEAN)(0==1))) {
        return (RETURN_STATUS)(0);
      }
      ...
      if (HFileImage.ReadOnly == ((BOOLEAN)(1==1))) {
  ...
  if (ShellIsDirectory (FileName) == (RETURN_STATUS)(0)) {
  ...
  if (((BufferTypeBackup != FileTypeFileBuffer) && (FileName != ((void *) 0))) ||
      ((FileName != ((void *) 0)) && (HFileImage.FileName != ((void *) 0)) && (StringNoCaseCompare (&FileName, &HFileImage.FileName) != 0)))
  {
  ...
  HFileImage.ReadOnly = ((BOOLEAN)(0==1));

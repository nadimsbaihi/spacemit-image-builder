# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/SerMode.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/SerMode.c"
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/SerMode.c"
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/SerMode.c" 2
...
# 13 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/SerMode.c" 2
# 25 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/SerMode.c"
SHELL_STATUS
DisplaySettings (
  UINTN HandleIdx,
  BOOLEAN HandleValid
  )
{
  ...
  Status = gBS->LocateHandleBuffer (ByProtocol, &gEfiSerialIoProtocolGuid, ((void *) 0), &NoHandles, &Handles);
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0271, gShellDebug1HiiHandle, L"sermode");
  ...
  if (Index == NoHandles) {
    if (((NoHandles != 0) && HandleValid) || (0 == NoHandles)) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0272, gShellDebug1HiiHandle, L"sermode");
      ShellStatus = SHELL_NOT_FOUND;
    }
  }
  ...
  )
{
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    if ((Status == ((RETURN_STATUS)(0x8000000000000000ULL | (10)))) && (ProblemParam != ((void *) 0))) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0224, gShellDebug1HiiHandle, L"sermode", ProblemParam);
    ...
    if ((ShellCommandLineGetCount (Package) < 6) && (ShellCommandLineGetCount (Package) > 2)) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0228, gShellDebug1HiiHandle, L"sermode");
      ShellStatus = SHELL_INVALID_PARAMETER;
    } else if (ShellCommandLineGetCount (Package) > 6) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0229, gShellDebug1HiiHandle, L"sermode");
      ShellStatus = SHELL_INVALID_PARAMETER;
    } else {
      Temp = ShellCommandLineGetRawValue (Package, 1);
      if (Temp != ((void *) 0)) {
        Status = ShellConvertStringToUint64 (Temp, &Intermediate, ((BOOLEAN)(1==1)), ((BOOLEAN)(0==1)));
        HandleIdx = (UINTN)Intermediate;
        Temp = ShellCommandLineGetRawValue (Package, 2);
        if (Temp == ((void *) 0)) {
          ShellStatus = DisplaySettings (HandleIdx, ((BOOLEAN)(1==1)));
          goto Done;
        }
      } else {
        ShellStatus = DisplaySettings (0, ((BOOLEAN)(0==1)));
        goto Done;
      }
      ...
      if ((Temp == ((void *) 0)) || (StrLen (Temp) > 1)) {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x022C, gShellDebug1HiiHandle, L"sermode", Temp);
        ShellStatus = SHELL_INVALID_PARAMETER;
      } else {
        switch (Temp[0]) {
          case 'd':
      ...
      if (Temp == ((void *) 0)) {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x022C, gShellDebug1HiiHandle, L"sermode");
        ShellStatus = SHELL_INVALID_PARAMETER;
        goto Done;
      }
        ...
        if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
          ...
          if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
            if (Status == ((RETURN_STATUS)(0x8000000000000000ULL | (2)))) {
              ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0277, gShellDebug1HiiHandle, L"sermode", ConvertHandleToHandleIndex (Handles[Index]));
              ShellStatus = SHELL_UNSUPPORTED;
            } else if (Status == ((RETURN_STATUS)(0x8000000000000000ULL | (7)))) {
              ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0278, gShellDebug1HiiHandle, L"sermode", ConvertHandleToHandleIndex (Handles[Index]));
              ShellStatus = SHELL_ACCESS_DENIED;
            } else {
              ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0275, gShellDebug1HiiHandle, L"sermode", ConvertHandleToHandleIndex (Handles[Index]));
              ShellStatus = SHELL_ACCESS_DENIED;
            }
          } else {
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0274, gShellDebug1HiiHandle, ConvertHandleToHandleIndex (Handles[Index]));
          }
  ...
  if ((ShellStatus == SHELL_SUCCESS) && (Index == NoHandles)) {
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0273, gShellDebug1HiiHandle, L"sermode", HandleIdx);
    ShellStatus = SHELL_INVALID_PARAMETER;
  }

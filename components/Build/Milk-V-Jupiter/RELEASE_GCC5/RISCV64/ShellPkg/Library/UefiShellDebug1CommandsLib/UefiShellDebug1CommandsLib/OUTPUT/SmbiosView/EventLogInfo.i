# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/SmbiosView/EventLogInfo.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/SmbiosView/EventLogInfo.c"
# 9 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/SmbiosView/EventLogInfo.c"
...
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/SmbiosView/EventLogInfo.c" 2
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/SmbiosView/EventLogInfo.c" 2
...
# 12 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/SmbiosView/EventLogInfo.c" 2
...
# 13 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/SmbiosView/EventLogInfo.c" 2
  ...
  )
{
  ...
  ShellPrintHiiEx (-1, -1, ((void *) 0), 0x004E, gShellDebug1HiiHandle);
  ...
  switch (Key) {
    case 0:
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x004F, gShellDebug1HiiHandle);
      break;

    case 1:
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0050, gShellDebug1HiiHandle);
      break;

    case 2:
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0051, gShellDebug1HiiHandle);
      break;

    case 3:
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0052, gShellDebug1HiiHandle);
      break;

    case 4:
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0053, gShellDebug1HiiHandle);
      break;

    default:
      if (Key <= 0x7f) {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0054, gShellDebug1HiiHandle);
      } else {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0055, gShellDebug1HiiHandle);
      }
  }
}
  ...
  )
{
  ...
  ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0056, gShellDebug1HiiHandle);
  do { if (Option == 0x00) { return ; } if (Option < 0x03) { Print (L"0x%x\n", Key); return ; } } while (0);;
  ...
  if ((Key & 0x01) != 0) {
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0057, gShellDebug1HiiHandle);
  } else {
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0057, gShellDebug1HiiHandle);
  }

  if ((Key & 0x02) != 0) {
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0058, gShellDebug1HiiHandle);
  } else {
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0059, gShellDebug1HiiHandle);
  }

  if ((Key & 0xFC) != 0) {
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x005A, gShellDebug1HiiHandle, Key & 0xFC);
  }
}
  ...
  )
{
  ...
  ShellPrintHiiEx (-1, -1, ((void *) 0), 0x005B, gShellDebug1HiiHandle);
  do { if (Option == 0x00) { return ; } if (Option < 0x03) { Print (L"0x%x\n", Key); return ; } } while (0);;
  ...
  if (Key == 0x00) {
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x005C, gShellDebug1HiiHandle);
  } else if (Key == 0x01) {
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x005D, gShellDebug1HiiHandle);
  } else if (Key <= 0x7f) {
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x005E, gShellDebug1HiiHandle);
  } else {
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x005F, gShellDebug1HiiHandle);
  }
}
...
{
  ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0060, gShellDebug1HiiHandle);
  do { if (Option == 0x00) { return ; } if (Option < 0x03) { Print (L"0x%x\n", Key); return ; } } while (0);;

  ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0061, gShellDebug1HiiHandle, Key & 0x7F);
  ...
  if ((Key & 0x80) != 0) {
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0062, gShellDebug1HiiHandle);
  } else {
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0063, gShellDebug1HiiHandle);
  }
}
  ...
  )
{
  ...
  ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0064, gShellDebug1HiiHandle);
  ...
  ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0066, gShellDebug1HiiHandle, Header->Metw);
  ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0067, gShellDebug1HiiHandle, Header->Meci);
  ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0068, gShellDebug1HiiHandle, Header->CMOSAddress);
  ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0069, gShellDebug1HiiHandle, Header->CMOSBitIndex);
  ShellPrintHiiEx (-1, -1, ((void *) 0), 0x006A, gShellDebug1HiiHandle, Header->StartingOffset);
  ShellPrintHiiEx (-1, -1, ((void *) 0), 0x006B, gShellDebug1HiiHandle, Header->ChecksumOffset);
  ShellPrintHiiEx (
    -1,
    -1,
    ((void *) 0),
  ...
  ShellPrintHiiEx (-1, -1, ((void *) 0), 0x006D, gShellDebug1HiiHandle, Header->HeaderRevision);
}
  ...
  )
{
  ...
  ShellPrintHiiEx (-1, -1, ((void *) 0), 0x006E, gShellDebug1HiiHandle);
  ...
  if (LogHeaderFormat == 0x00) {
    ...
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x006F, gShellDebug1HiiHandle);
  } else {
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x005F, gShellDebug1HiiHandle);
  }
}
  ...
  )
{
  ...
  DisplaySELVarDataFormatType (ElVdfType, 0x03);
  ...
  switch (ElVdfType) {
    case 0:
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0070, gShellDebug1HiiHandle);
      break;

    case 1:
      Word = (UINT16 *)(VarData + 1);
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0071, gShellDebug1HiiHandle);
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0072, gShellDebug1HiiHandle, *Word);
      break;

    case 2:
      Dword = (UINT32 *)(VarData + 1);
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0073, gShellDebug1HiiHandle, *Dword);
      break;
    ...
    case 4:
      Dword = (UINT32 *)(VarData + 1);
      DisplayPostResultsBitmapDw1 (*Dword, 0x03);
      Dword++;
      DisplayPostResultsBitmapDw2 (*Dword, 0x03);
      break;

    case 5:
      Dword = (UINT32 *)(VarData + 1);
      DisplaySELSysManagementTypes (*Dword, 0x03);
      break;
    ...
    default:
      if (ElVdfType <= 0x7F) {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0074, gShellDebug1HiiHandle);
      } else {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0075, gShellDebug1HiiHandle);
      }
  }
}
  ...
  )
{
  ...
  ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0076, gShellDebug1HiiHandle);
  ...
  while (Log != ((void *) 0) && Log->Type != 0xFF && Offset < LogAreaLength) {
    if (Log != ((void *) 0)) {



      DisplaySELTypes (Log->Type, 0x03);
      DisplaySELLogHeaderLen (Log->Length, 0x03);
      ...
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0077, gShellDebug1HiiHandle);
      if ((Log != ((void *) 0)) && (Log->Year >= 80) && (Log->Year <= 99)) {
        Print (L"19");
      } else if ((Log != ((void *) 0)) && (Log->Year <= 79)) {
        Print (L"20");
      } else {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0078, gShellDebug1HiiHandle);

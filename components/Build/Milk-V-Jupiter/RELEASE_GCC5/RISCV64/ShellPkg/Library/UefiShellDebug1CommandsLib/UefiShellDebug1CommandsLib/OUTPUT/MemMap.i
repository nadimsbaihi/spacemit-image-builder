# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/MemMap.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/MemMap.c"
# 14 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/MemMap.c"
...
# 45 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/MemMap.c" 2
...
# 59 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/MemMap.c"
void
AddMemoryLength (
  LIST_ENTRY *List,
  UINT32 Type,
  ...
  )
{
  ...
  for (Link = GetFirstNode (List); !IsNull (List, Link); Link = GetNextNode (List, Link)) {
    Entry = ((MEMORY_LENGTH_ENTRY *) (void *) ((CHAR8 *) (Link) - ((UINTN) __builtin_offsetof(MEMORY_LENGTH_ENTRY, Link))));
    if (Entry->Type >= Type) {
      break;
    }
  }

  if ((Entry != ((void *) 0)) && (Entry->Type == Type)) {
  ...
  )
{
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    if ((Status == ((RETURN_STATUS)(0x8000000000000000ULL | (10)))) && (ProblemParam != ((void *) 0))) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0224, gShellDebug1HiiHandle, L"memmap", ProblemParam);
    ...
    if (ShellCommandLineGetCount (Package) > 1) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0229, gShellDebug1HiiHandle, L"memmap");
      ShellStatus = SHELL_INVALID_PARAMETER;
    } else {
      ...
      if (Status == ((RETURN_STATUS)(0x8000000000000000ULL | (5)))) {
        ...
        if (Descriptors == ((void *) 0)) {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x022F, gShellDebug1HiiHandle, L"memmap");
      ...
      if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0249, gShellDebug1HiiHandle, L"memmap");
        ShellStatus = SHELL_ACCESS_DENIED;
      } else {
        do { if (((BOOLEAN)(0==1))) { (void) (Version == 1); } } while (((BOOLEAN)(0==1)));

        Sfo = ShellCommandLineGetFlag (Package, L"-sfo");
        if (!Sfo) {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x024A, gShellDebug1HiiHandle);
        } else {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0235, gShellDebug1HiiHandle, L"memmap");
        }

        for ( Walker = Descriptors
              ; (Walker < (EFI_MEMORY_DESCRIPTOR *)((UINT8 *)Descriptors + Size)) && (Walker != ((void *) 0))
              ; Walker = (EFI_MEMORY_DESCRIPTOR *)((UINT8 *)Walker + ItemSize)
              )
        {
          switch (Walker->Type) {
            case EfiReservedMemoryType:
              ShellPrintHiiEx (-1, -1, ((void *) 0), (EFI_STRING_ID)(!Sfo ? 0x024B : 0x0250), gShellDebug1HiiHandle, NameEfiReservedMemoryType, Walker->PhysicalStart, Walker->PhysicalStart+MultU64x64 (0x00001000, Walker->NumberOfPages)-1, Walker->NumberOfPages, Walker->Attribute);
              ReservedPages += Walker->NumberOfPages;
              break;
            case EfiLoaderCode:
              ShellPrintHiiEx (-1, -1, ((void *) 0), (EFI_STRING_ID)(!Sfo ? 0x024B : 0x0250), gShellDebug1HiiHandle, NameEfiLoaderCode, Walker->PhysicalStart, Walker->PhysicalStart+MultU64x64 (0x00001000, Walker->NumberOfPages)-1, Walker->NumberOfPages, Walker->Attribute);
              LoadCodePages += Walker->NumberOfPages;
              TotalPages += Walker->NumberOfPages;
              break;
            case EfiLoaderData:
              ShellPrintHiiEx (-1, -1, ((void *) 0), (EFI_STRING_ID)(!Sfo ? 0x024B : 0x0250), gShellDebug1HiiHandle, NameEfiLoaderData, Walker->PhysicalStart, Walker->PhysicalStart+MultU64x64 (0x00001000, Walker->NumberOfPages)-1, Walker->NumberOfPages, Walker->Attribute);
              LoadDataPages += Walker->NumberOfPages;
              TotalPages += Walker->NumberOfPages;
              break;
            case EfiBootServicesCode:
              ShellPrintHiiEx (-1, -1, ((void *) 0), (EFI_STRING_ID)(!Sfo ? 0x024B : 0x0250), gShellDebug1HiiHandle, !Sfo ? NameEfiBootServicesCodeShort : NameEfiBootServicesCode, Walker->PhysicalStart, Walker->PhysicalStart+MultU64x64 (0x00001000, Walker->NumberOfPages)-1, Walker->NumberOfPages, Walker->Attribute);
              BSCodePages += Walker->NumberOfPages;
              TotalPages += Walker->NumberOfPages;
              break;
            case EfiBootServicesData:
              ShellPrintHiiEx (-1, -1, ((void *) 0), (EFI_STRING_ID)(!Sfo ? 0x024B : 0x0250), gShellDebug1HiiHandle, !Sfo ? NameEfiBootServicesDataShort : NameEfiBootServicesData, Walker->PhysicalStart, Walker->PhysicalStart+MultU64x64 (0x00001000, Walker->NumberOfPages)-1, Walker->NumberOfPages, Walker->Attribute);
              BSDataPages += Walker->NumberOfPages;
              TotalPages += Walker->NumberOfPages;
              break;
            case EfiRuntimeServicesCode:
              ShellPrintHiiEx (-1, -1, ((void *) 0), (EFI_STRING_ID)(!Sfo ? 0x024B : 0x0250), gShellDebug1HiiHandle, !Sfo ? NameEfiRuntimeServicesCodeShort : NameEfiRuntimeServicesCode, Walker->PhysicalStart, Walker->PhysicalStart+MultU64x64 (0x00001000, Walker->NumberOfPages)-1, Walker->NumberOfPages, Walker->Attribute);
              RTCodePages += Walker->NumberOfPages;
              TotalPages += Walker->NumberOfPages;
              break;
            case EfiRuntimeServicesData:
              ShellPrintHiiEx (-1, -1, ((void *) 0), (EFI_STRING_ID)(!Sfo ? 0x024B : 0x0250), gShellDebug1HiiHandle, !Sfo ? NameEfiRuntimeServicesDataShort : NameEfiRuntimeServicesData, Walker->PhysicalStart, Walker->PhysicalStart+MultU64x64 (0x00001000, Walker->NumberOfPages)-1, Walker->NumberOfPages, Walker->Attribute);
              RTDataPages += Walker->NumberOfPages;
              TotalPages += Walker->NumberOfPages;
              break;
            case EfiConventionalMemory:
              ShellPrintHiiEx (-1, -1, ((void *) 0), (EFI_STRING_ID)(!Sfo ? 0x024B : 0x0250), gShellDebug1HiiHandle, NameEfiConventionalMemory, Walker->PhysicalStart, Walker->PhysicalStart+MultU64x64 (0x00001000, Walker->NumberOfPages)-1, Walker->NumberOfPages, Walker->Attribute);
              AvailPages += Walker->NumberOfPages;
              TotalPages += Walker->NumberOfPages;
              break;
            case EfiPersistentMemory:
              ShellPrintHiiEx (-1, -1, ((void *) 0), (EFI_STRING_ID)(!Sfo ? 0x024B : 0x0250), gShellDebug1HiiHandle, NameEfiPersistentMemory, Walker->PhysicalStart, Walker->PhysicalStart+MultU64x64 (0x00001000, Walker->NumberOfPages)-1, Walker->NumberOfPages, Walker->Attribute);
              PersistentPages += Walker->NumberOfPages;
              TotalPages += Walker->NumberOfPages;
              break;
            case EfiUnusableMemory:
              ShellPrintHiiEx (-1, -1, ((void *) 0), (EFI_STRING_ID)(!Sfo ? 0x024B : 0x0250), gShellDebug1HiiHandle, !Sfo ? NameEfiUnusableMemoryShort : NameEfiUnusableMemory, Walker->PhysicalStart, Walker->PhysicalStart+MultU64x64 (0x00001000, Walker->NumberOfPages)-1, Walker->NumberOfPages, Walker->Attribute);
              UnusableMemoryPages += Walker->NumberOfPages;
              break;
            case EfiACPIReclaimMemory:
              ShellPrintHiiEx (-1, -1, ((void *) 0), (EFI_STRING_ID)(!Sfo ? 0x024B : 0x0250), gShellDebug1HiiHandle, !Sfo ? NameEfiACPIReclaimMemoryShort : NameEfiACPIReclaimMemory, Walker->PhysicalStart, Walker->PhysicalStart+MultU64x64 (0x00001000, Walker->NumberOfPages)-1, Walker->NumberOfPages, Walker->Attribute);
              TotalPages += Walker->NumberOfPages;
              AcpiReclaimPages += Walker->NumberOfPages;
              break;
            case EfiACPIMemoryNVS:
              ShellPrintHiiEx (-1, -1, ((void *) 0), (EFI_STRING_ID)(!Sfo ? 0x024B : 0x0250), gShellDebug1HiiHandle, !Sfo ? NameEfiACPIMemoryNVSShort : NameEfiACPIMemoryNVS, Walker->PhysicalStart, Walker->PhysicalStart+MultU64x64 (0x00001000, Walker->NumberOfPages)-1, Walker->NumberOfPages, Walker->Attribute);
              TotalPages += Walker->NumberOfPages;
              AcpiNvsPages += Walker->NumberOfPages;
              break;
            case EfiMemoryMappedIO:
              ShellPrintHiiEx (-1, -1, ((void *) 0), (EFI_STRING_ID)(!Sfo ? 0x024B : 0x0250), gShellDebug1HiiHandle, !Sfo ? NameEfiMemoryMappedIOShort : NameEfiMemoryMappedIO, Walker->PhysicalStart, Walker->PhysicalStart+MultU64x64 (0x00001000, Walker->NumberOfPages)-1, Walker->NumberOfPages, Walker->Attribute);
              MmioSpacePages += Walker->NumberOfPages;
              break;
            case EfiMemoryMappedIOPortSpace:
              ShellPrintHiiEx (-1, -1, ((void *) 0), (EFI_STRING_ID)(!Sfo ? 0x024B : 0x0250), gShellDebug1HiiHandle, !Sfo ? NameEfiMemoryMappedIOPortSpaceShort : NameEfiMemoryMappedIOPortSpace, Walker->PhysicalStart, Walker->PhysicalStart+MultU64x64 (0x00001000, Walker->NumberOfPages)-1, Walker->NumberOfPages, Walker->Attribute);
              MmioPortPages += Walker->NumberOfPages;
              break;
            case EfiPalCode:
              ShellPrintHiiEx (-1, -1, ((void *) 0), (EFI_STRING_ID)(!Sfo ? 0x024B : 0x0250), gShellDebug1HiiHandle, NameEfiPalCode, Walker->PhysicalStart, Walker->PhysicalStart+MultU64x64 (0x00001000, Walker->NumberOfPages)-1, Walker->NumberOfPages, Walker->Attribute);
              TotalPages += Walker->NumberOfPages;
              PalCodePages += Walker->NumberOfPages;
              break;
            case EfiUnacceptedMemoryType:
              ShellPrintHiiEx (-1, -1, ((void *) 0), (EFI_STRING_ID)(!Sfo ? 0x024B : 0x0250), gShellDebug1HiiHandle, NameEfiUnacceptedMemoryType, Walker->PhysicalStart, Walker->PhysicalStart+MultU64x64 (0x00001000, Walker->NumberOfPages)-1, Walker->NumberOfPages, Walker->Attribute);
              TotalPages += Walker->NumberOfPages;
            ...
            default:
              ...
              if (!Sfo) {
                ShellPrintHiiEx (-1, -1, ((void *) 0), 0x024C, gShellDebug1HiiHandle, Walker->Type, Walker->PhysicalStart, Walker->PhysicalStart + MultU64x64 (0x00001000, Walker->NumberOfPages) - 1, Walker->NumberOfPages, Walker->Attribute);
              }
        ...
        ReservedPagesSize = MultU64x64 (0x00001000, ReservedPages);
        LoadCodePagesSize = MultU64x64 (0x00001000, LoadCodePages);
        LoadDataPagesSize = MultU64x64 (0x00001000, LoadDataPages);
        BSCodePagesSize = MultU64x64 (0x00001000, BSCodePages);
        BSDataPagesSize = MultU64x64 (0x00001000, BSDataPages);
        RTDataPagesSize = MultU64x64 (0x00001000, RTDataPages);
        RTCodePagesSize = MultU64x64 (0x00001000, RTCodePages);
        AvailPagesSize = MultU64x64 (0x00001000, AvailPages);
        TotalPagesSize = MultU64x64 (0x00001000, TotalPages);
        AcpiReclaimPagesSize = MultU64x64 (0x00001000, AcpiReclaimPages);
        AcpiNvsPagesSize = MultU64x64 (0x00001000, AcpiNvsPages);
        MmioSpacePagesSize = MultU64x64 (0x00001000, MmioSpacePages);
        MmioPortPagesSize = MultU64x64 (0x00001000, MmioPortPages);
        PalCodePagesSize = MultU64x64 (0x00001000, PalCodePages);
        UnacceptedPagesSize = MultU64x64 (0x00001000, UnacceptedPages);
        PersistentPagesSize = MultU64x64 (0x00001000, PersistentPages);
        UnusableMemoryPagesSize = MultU64x64 (0x00001000, UnusableMemoryPages);
        if (!Sfo) {
          ShellPrintHiiEx (
            -1,
            -1,
          ...
          for (Link = GetFirstNode (&MemoryList); !IsNull (&MemoryList, Link); Link = GetNextNode (&MemoryList, Link)) {
            ...
            ShellPrintHiiEx (
              ...
              Entry->Type,
              Entry->NumberOfPages,
              MultU64x64 (0x00001000, Entry->NumberOfPages)
              );
          }
          ...
          ShellPrintHiiEx (
            ...
            0x024F,
            gShellDebug1HiiHandle,
            DivU64x32 (MultU64x64 (0x00001000, TotalPages), 0x00100000),
            TotalPagesSize
            );
        } else {
          ShellPrintHiiEx (

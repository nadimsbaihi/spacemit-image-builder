# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Mode.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Mode.c"
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Mode.c"
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDebug1CommandsLib/Mode.c" 2
  ...
  )
{
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    if ((Status == ((RETURN_STATUS)(0x8000000000000000ULL | (10)))) && (ProblemParam != ((void *) 0))) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0224, gShellDebug1HiiHandle, L"mode", ProblemParam);
    ...
    if (ShellCommandLineGetCount (Package) > 3) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0229, gShellDebug1HiiHandle, L"mode");
      ShellStatus = SHELL_INVALID_PARAMETER;
    } else if (ShellCommandLineGetCount (Package) == 2) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0228, gShellDebug1HiiHandle, L"mode");
      ShellStatus = SHELL_INVALID_PARAMETER;
    } else if (ShellCommandLineGetCount (Package) == 3) {
      Temp = ShellCommandLineGetRawValue (Package, 1);
      if (Temp == ((void *) 0)) {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x022C, gShellDebug1HiiHandle, L"mode", Temp);
        ShellStatus = SHELL_INVALID_PARAMETER;
      } else if (!ShellIsHexOrDecimalNumber (Temp, ((BOOLEAN)(0==1)), ((BOOLEAN)(0==1)))) {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x022C, gShellDebug1HiiHandle, L"mode", Temp);
        ShellStatus = SHELL_INVALID_PARAMETER;
      }
      ...
      for (LoopVar = 0, Done = ((BOOLEAN)(0==1)); LoopVar < gST->ConOut->Mode->MaxMode && ShellStatus == SHELL_SUCCESS; LoopVar++) {
        ...
        if ((Col == NewCol) && (Row == NewRow)) {
          ...
          if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0245, gShellDebug1HiiHandle, L"mode");
      ...
      if (!Done) {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0246, gShellDebug1HiiHandle, L"mode");
        ShellStatus = SHELL_INVALID_PARAMETER;
      }
      ...
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0247, gShellDebug1HiiHandle);
      for (LoopVar = 0, Done = ((BOOLEAN)(0==1)); LoopVar < gST->ConOut->Mode->MaxMode && ShellStatus == SHELL_SUCCESS; LoopVar++) {
        Status = gST->ConOut->QueryMode (gST->ConOut, LoopVar, &Col, &Row);
        if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
          continue;
        ...
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0248, gShellDebug1HiiHandle, Col, Row, LoopVar == gST->ConOut->Mode->Mode ? L'*' : L' ');
      }
    }

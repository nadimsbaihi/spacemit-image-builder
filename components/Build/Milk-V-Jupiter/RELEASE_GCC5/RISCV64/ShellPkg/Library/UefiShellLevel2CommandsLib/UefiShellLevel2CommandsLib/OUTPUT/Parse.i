# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Parse.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Parse.c"
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Parse.c"
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Parse.c" 2
# 20 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Parse.c"
BOOLEAN
  ...
  )
{
  ...
  if (ShellOpenFileByName (L">i", &FileHandle, 0x0000000000000001ULL, 0) == (RETURN_STATUS)(0)) {
    ...
    if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) || (CharSize != sizeof (CHAR16))) {
      return ((BOOLEAN)(0==1));
    }
...
# 62 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Parse.c"
EFI_STRING
...
# 114 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Parse.c"
SHELL_STATUS
PerformParsing (
  const CHAR16 *FileName,
  const CHAR16 *TableName,
  const UINTN ColumnIndex,
  const UINTN TableNameInstance,
  const UINTN ShellCommandInstance,
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (TableName != ((void *) 0)); } } while (((BOOLEAN)(0==1)));

  ShellStatus = SHELL_SUCCESS;

  Status = ShellOpenFileByName (FileName, &FileHandle, 0x0000000000000001ULL, 0);
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x000F, gShellLevel2HiiHandle, L"parse", FileName);
    ShellStatus = SHELL_NOT_FOUND;
  } else if (!(((RETURN_STATUS)(FileHandleIsDirectory (FileHandle))) >= 0x8000000000000000ULL)) {
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0018, gShellLevel2HiiHandle, L"parse", FileName);
    ShellStatus = SHELL_NOT_FOUND;
  } else {
    for (LoopVariable = 0; LoopVariable < ShellCommandInstance && !ShellFileHandleEof (FileHandle);) {
      ...
      if ((TempLine == ((void *) 0)) || ((*TempLine == 0x0000) && StreamingUnicode)) {
        break;
      }
      ...
      do { if ((TempLine) != ((void *) 0)) { FreePool((TempLine)); (TempLine) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
    }
    ...
    if (LoopVariable == ShellCommandInstance) {
      ...
      while (1) {
        ...
        if (StrStr (TempLine, TableName) == TempLine) {
          ...
          {
            for (ColumnLoop = 1, ColumnPointer = TempLine; ColumnLoop < ColumnIndex && ColumnPointer != ((void *) 0) && *ColumnPointer != 0x0000; ColumnLoop++) {
              ColumnPointer = StrStr (ColumnPointer, L",\"");
              if ((ColumnPointer != ((void *) 0)) && (*ColumnPointer != 0x0000)) {
                ColumnPointer++;
              }
            }

            if (ColumnLoop == ColumnIndex) {
              if (ColumnPointer == ((void *) 0)) {
                ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0009, gShellLevel2HiiHandle, L"parse", L"Column Index");
                ...
                while (ColumnPointer != ((void *) 0) && *ColumnPointer != 0x0000 && ColumnPointer[0] == L' ') {
                  ColumnPointer++;
                }

                if ((ColumnPointer != ((void *) 0)) && (*ColumnPointer != 0x0000) && (ColumnPointer[0] == L'\"')) {
                  ColumnPointer++;
                }

                if ((ColumnPointer != ((void *) 0)) && (*ColumnPointer != 0x0000) && (ColumnPointer[StrLen (ColumnPointer) - 1] == L'\"')) {
                  ColumnPointer[StrLen (ColumnPointer) - 1] = 0x0000;
                }

                SfoString = HandleStringWithEscapeCharForParse (ColumnPointer);
                if (SfoString != ((void *) 0)) {
                  ShellPrintEx (-1, -1, L"%s\r\n", SfoString);
                  do { if ((SfoString) != ((void *) 0)) { FreePool((SfoString)); (SfoString) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
                }
              }
            }
          }
  ...
  )
{
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    if ((Status == ((RETURN_STATUS)(0x8000000000000000ULL | (10)))) && (ProblemParam != ((void *) 0))) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0006, gShellLevel2HiiHandle, L"parse", ProblemParam);
    ...
    {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0004, gShellLevel2HiiHandle, L"parse");
      ShellStatus = SHELL_INVALID_PARAMETER;
    } else if ((StreamingUnicode && (ShellCommandLineGetCount (Package) > 3)) ||
               (ShellCommandLineGetCount (Package) > 4))
    {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0003, gShellLevel2HiiHandle, L"parse");
      ShellStatus = SHELL_INVALID_PARAMETER;
    } else {
      if (StreamingUnicode) {
        FileName = L">i";
      ...
      if (ShellCommandLineGetValue (Package, L"-i") == ((void *) 0)) {
        TableNameInstance = (UINTN)-1;
      } else {
      ...
      if ((FileName != ((void *) 0)) && (TableName != ((void *) 0)) && (ColumnString != ((void *) 0))) {

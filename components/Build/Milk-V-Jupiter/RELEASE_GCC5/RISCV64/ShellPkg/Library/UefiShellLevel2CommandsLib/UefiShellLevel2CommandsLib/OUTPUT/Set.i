# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Set.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Set.c"
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Set.c"
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Set.c" 2
# 20 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Set.c"
SHELL_STATUS
  ...
  )
{
  ...
  ConstEnvNameList = gEfiShellProtocol->GetEnv (((void *) 0));
  if (ConstEnvNameList == ((void *) 0)) {
    return (SHELL_SUCCESS);
  }

  while (*ConstEnvNameList != 0x0000) {
    Value = gEfiShellProtocol->GetEnv (ConstEnvNameList);
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0023, gShellLevel2HiiHandle, ConstEnvNameList, Value);
  ...
  )
{
  ...
  Status = ShellCommandLineParseEx(SetParamList,&Package,&ProblemParam,((BOOLEAN)(1==1)),((BOOLEAN)(0==1)));
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    if ((Status == ((RETURN_STATUS)(0x8000000000000000ULL | (10)))) && (ProblemParam != ((void *) 0))) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0006, gShellLevel2HiiHandle, L"set", ProblemParam);
    ...
    if (ShellCommandLineGetFlag (Package, L"-?")) {
      ...
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0003, gShellLevel2HiiHandle, L"set");
      ShellStatus = SHELL_INVALID_PARAMETER;
    } else if ((ShellCommandLineGetRawValue (Package, 1) != ((void *) 0)) && ShellCommandLineGetFlag (Package, L"-d")) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0003, gShellLevel2HiiHandle, L"set");
      ShellStatus = SHELL_INVALID_PARAMETER;
      ...
      if (KeyName == ((void *) 0)) {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0009, gShellLevel2HiiHandle, L"set", L"-d");
        ShellStatus = SHELL_INVALID_PARAMETER;
      } else {
        Status = ShellSetEnvironmentVariable (KeyName, L"", ShellCommandLineGetFlag (Package, L"-v"));
        if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0025, gShellLevel2HiiHandle, L"set", KeyName);
      ...
      if ((KeyName != ((void *) 0)) && (Value != ((void *) 0))) {



        Status = ShellSetEnvironmentVariable (KeyName, Value, ShellCommandLineGetFlag (Package, L"-v"));
        if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0026, gShellLevel2HiiHandle, L"set", KeyName);
        ...
        if (KeyName != ((void *) 0)) {
          ...
          if (Value == ((void *) 0)) {
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0024, gShellLevel2HiiHandle, L"set", KeyName);
            ShellStatus = SHELL_SUCCESS;
          } else {
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0023, gShellLevel2HiiHandle, KeyName, Value);
            ShellStatus = SHELL_SUCCESS;
          }
        } else {
          do { if (((BOOLEAN)(0==1))) { (void) (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));

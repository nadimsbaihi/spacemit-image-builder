# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/MkDir.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/MkDir.c"
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/MkDir.c"
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/MkDir.c" 2
  ...
  )
{
  ...
  NewDirNameCopy = ((void *) 0);
  SplitName = ((void *) 0);
  SaveSplitChar = 0x0000;
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    if ((Status == ((RETURN_STATUS)(0x8000000000000000ULL | (10)))) && (ProblemParam != ((void *) 0))) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0006, gShellLevel2HiiHandle, L"mkdir", ProblemParam);
    ...
    if (ShellCommandLineGetRawValue (Package, 1) == ((void *) 0)) {
      ...
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0004, gShellLevel2HiiHandle, L"mkdir");
      ShellStatus = SHELL_INVALID_PARAMETER;
    } else {
            ...
            )
      {
        ...
        if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
          ...
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0034, gShellLevel2HiiHandle, NewDirName);
          ShellStatus = SHELL_INVALID_PARAMETER;
        } else {
          ...
          if (NewDirNameCopy == ((void *) 0)) {
            ShellStatus = SHELL_OUT_OF_RESOURCES;
            break;
          }

          SplitName = NewDirNameCopy;
          while (SplitName != ((void *) 0)) {
          ...
          if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0035, gShellLevel2HiiHandle, NewDirName);
            ShellStatus = SHELL_ACCESS_DENIED;
            break;
          }

          do { if ((NewDirNameCopy) != ((void *) 0)) { FreePool((NewDirNameCopy)); (NewDirNameCopy) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
        }
      }
    }
  }

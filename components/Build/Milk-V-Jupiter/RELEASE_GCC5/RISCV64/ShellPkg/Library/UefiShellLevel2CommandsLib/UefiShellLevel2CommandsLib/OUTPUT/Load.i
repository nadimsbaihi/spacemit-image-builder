# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Load.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Load.c"
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Load.c"
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Load.c" 2
# 25 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Load.c"
EFI_STATUS
ConnectAllEfi (
  void
  )
{
  ...
  for (Index = 0; Index < HandleCount; Index++) {
    Status = gBS->ConnectController (HandleBuffer[Index], ((void *) 0), ((void *) 0), ((BOOLEAN)(1==1)));
  }
...
# 70 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Load.c"
EFI_STATUS
LoadDriver (
  const CHAR16 *FileName,
  const BOOLEAN Connect
  )
{
  ...
  LoadedDriverImage = ((void *) 0);
  FilePath = ((void *) 0);
  LoadedDriverHandle = ((void *) 0);
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    ...
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0065, gShellLevel2HiiHandle, FileName, Status);
  } else {
    ...
    do { if (((BOOLEAN)(0==1))) { (void) (LoadedDriverImage != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
    ...
    {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0066, gShellLevel2HiiHandle, FileName);




      gBS->Exit (LoadedDriverHandle, ((RETURN_STATUS)(0x8000000000000000ULL | (2))), 0, ((void *) 0));
  ...
  if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    ...
    Status = gBS->StartImage (LoadedDriverHandle, ((void *) 0), ((void *) 0));
    if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0068, gShellLevel2HiiHandle, FileName, Status);
    } else {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0067, gShellLevel2HiiHandle, FileName, LoadedDriverImage->ImageBase, Status);
    }
  }

  if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) && Connect) {
  ...
  )
{
  ...
  Status = ShellCommandLineParseEx(LoadParamList,&Package,&ProblemParam,((BOOLEAN)(1==1)),((BOOLEAN)(0==1)));
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    if ((Status == ((RETURN_STATUS)(0x8000000000000000ULL | (10)))) && (ProblemParam != ((void *) 0))) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0006, gShellLevel2HiiHandle, L"load", ProblemParam);
    ...
    if (ShellCommandLineGetFlag (Package, L"-?")) {
      do { if (((BOOLEAN)(0==1))) { (void) (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    } else if (ShellCommandLineGetRawValue (Package, 1) == ((void *) 0)) {



      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0004, gShellLevel2HiiHandle, L"load");
      ShellStatus = SHELL_INVALID_PARAMETER;
    } else {
      for ( ParamCount = 1
            ; ShellCommandLineGetRawValue (Package, ParamCount) != ((void *) 0)
            ; ParamCount++
            )
      {
        Status = ShellOpenFileMetaArg ((CHAR16 *)ShellCommandLineGetRawValue (Package, ParamCount), 0x0000000000000001ULL, &ListHead);
        if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
                ...
                )
          {
            ...
            if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
              LoadDriver (Node->FullName, (BOOLEAN)(ShellCommandLineGetFlag (Package, L"-nc") == ((BOOLEAN)(0==1))));
            } else {
              Status = LoadDriver (Node->FullName, (BOOLEAN)(ShellCommandLineGetFlag (Package, L"-nc") == ((BOOLEAN)(0==1))));
            }
          }
          ...
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0012, gShellLevel2HiiHandle, L"load", (CHAR16 *)ShellCommandLineGetRawValue (Package, ParamCount));

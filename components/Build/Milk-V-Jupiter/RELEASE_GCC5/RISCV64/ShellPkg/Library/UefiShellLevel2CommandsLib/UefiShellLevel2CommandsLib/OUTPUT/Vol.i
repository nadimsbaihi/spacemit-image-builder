# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Vol.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Vol.c"
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Vol.c"
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Vol.c" 2
...
extern EFI_GUID gEfiFileSystemInfoGuid;
# 12 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Vol.c" 2
...
# 13 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Vol.c" 2
# 23 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Vol.c"
SHELL_STATUS
HandleVol (
  const CHAR16 *Path,
  ...
  )
{
  ...
  {
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0005, gShellLevel2HiiHandle, L"vol", Name);
  ...
  Status = gEfiShellProtocol->OpenFileByName (
                                Path,
                                &ShellFileHandle,
                                Name != ((void *) 0) ? 0x0000000000000001ULL|0x0000000000000002ULL : 0x0000000000000001ULL
                                );

  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) || (ShellFileHandle == ((void *) 0))) {
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x000F, gShellLevel2HiiHandle, L"vol", Path);
  ...
  if (Status == ((RETURN_STATUS)(0x8000000000000000ULL | (5)))) {
    ...
    if (SysInfo == ((void *) 0)) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0022, gShellLevel2HiiHandle, L"vol");
  ...
  if (Delete) {
    *((CHAR16 *)SysInfo->VolumeLabel) = 0x0000;
    SysInfo->Size = ((UINTN) __builtin_offsetof(EFI_FILE_SYSTEM_INFO, VolumeLabel)) + StrSize (SysInfo->VolumeLabel);
    ...
    if (SysInfo != ((void *) 0)) {
      ...
      SysInfo->Size = ((UINTN) __builtin_offsetof(EFI_FILE_SYSTEM_INFO, VolumeLabel)) + Size1;
      Status = EfiFpHandle->SetInfo (
                                     EfiFpHandle,
                                     &gEfiFileSystemInfoGuid,
                                     (UINTN)SysInfo->Size,
  ...
  if (Delete || (Name != ((void *) 0))) {
    if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0011, gShellLevel2HiiHandle, L"vol", Path);
  ...
  )
{
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    if ((Status == ((RETURN_STATUS)(0x8000000000000000ULL | (10)))) && (ProblemParam != ((void *) 0))) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0006, gShellLevel2HiiHandle, L"vol", ProblemParam);
    ...
    if (ShellCommandLineGetCount (Package) > 2) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0003, gShellLevel2HiiHandle, L"vol");
      ShellStatus = SHELL_INVALID_PARAMETER;
    } else {
      ...
      if (PathName == ((void *) 0)) {
        ...
        if (CurDir == ((void *) 0)) {
          ...
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0014, gShellLevel2HiiHandle, L"vol");
        } else {
          PathName = CurDir;
        }
      }
      ...
      if (PathName != ((void *) 0)) {
        ...
        if (DeleteMode && ShellCommandLineGetFlag (Package, L"-n")) {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x000E, gShellLevel2HiiHandle, L"vol", L"-d", L"-n");
          ShellStatus = SHELL_INVALID_PARAMETER;
        } else if (ShellCommandLineGetFlag (Package, L"-n") && (NewName == ((void *) 0))) {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0009, gShellLevel2HiiHandle, L"vol", L"-n");
          ShellStatus = SHELL_INVALID_PARAMETER;
        } else if ((NewName != ((void *) 0)) && (StrLen (NewName) > 11)) {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0007, gShellLevel2HiiHandle, L"vol", NewName, L"-n");
          ShellStatus = SHELL_INVALID_PARAMETER;

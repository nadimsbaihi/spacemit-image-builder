# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/UefiShellLevel2CommandsLib.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/UefiShellLevel2CommandsLib.c"
# 29 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/UefiShellLevel2CommandsLib.c"
...
# 30 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/UefiShellLevel2CommandsLib.c" 2

const CHAR16 mFileName[] = L"ShellCommands";
EFI_HII_HANDLE gShellLevel2HiiHandle = ((void *) 0);
...
# 59 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/UefiShellLevel2CommandsLib.c"
EFI_STATUS
  ...
  )
{
  ...
  gShellLevel2HiiHandle = HiiAddPackages (&gShellLevel2HiiGuid, gImageHandle, UefiShellLevel2CommandsLibStrings, ((void *) 0));
  if (gShellLevel2HiiHandle == ((void *) 0)) {
  ...
  ShellCommandRegisterCommandName (L"attrib", ShellCommandRunAttrib, ShellCommandGetManFileNameLevel2, 2, L"", ((BOOLEAN)(1==1)), gShellLevel2HiiHandle, 0x0087);
  ShellCommandRegisterCommandName (L"cd", ShellCommandRunCd, ShellCommandGetManFileNameLevel2, 2, L"", ((BOOLEAN)(1==1)), gShellLevel2HiiHandle, 0x0088);
  ShellCommandRegisterCommandName (L"cp", ShellCommandRunCp, ShellCommandGetManFileNameLevel2, 2, L"", ((BOOLEAN)(1==1)), gShellLevel2HiiHandle, 0x0089);
  ShellCommandRegisterCommandName (L"load", ShellCommandRunLoad, ShellCommandGetManFileNameLevel2, 2, L"", ((BOOLEAN)(1==1)), gShellLevel2HiiHandle, 0x0095);
  ShellCommandRegisterCommandName (L"map", ShellCommandRunMap, ShellCommandGetManFileNameLevel2, 2, L"", ((BOOLEAN)(1==1)), gShellLevel2HiiHandle, 0x008A);
  ShellCommandRegisterCommandName (L"mkdir", ShellCommandRunMkDir, ShellCommandGetManFileNameLevel2, 2, L"", ((BOOLEAN)(1==1)), gShellLevel2HiiHandle, 0x008B);
  ShellCommandRegisterCommandName (L"mv", ShellCommandRunMv, ShellCommandGetManFileNameLevel2, 2, L"", ((BOOLEAN)(1==1)), gShellLevel2HiiHandle, 0x008C);
  ShellCommandRegisterCommandName (L"parse", ShellCommandRunParse, ShellCommandGetManFileNameLevel2, 2, L"", ((BOOLEAN)(1==1)), gShellLevel2HiiHandle, 0x008D);
  ShellCommandRegisterCommandName (L"reset", ShellCommandRunReset, ShellCommandGetManFileNameLevel2, 2, L"", ((BOOLEAN)(1==1)), gShellLevel2HiiHandle, 0x008E);
  ShellCommandRegisterCommandName (L"set", ShellCommandRunSet, ShellCommandGetManFileNameLevel2, 2, L"", ((BOOLEAN)(0==1)), gShellLevel2HiiHandle, 0x0090);
  ShellCommandRegisterCommandName (L"ls", ShellCommandRunLs, ShellCommandGetManFileNameLevel2, 2, L"", ((BOOLEAN)(1==1)), gShellLevel2HiiHandle, 0x0094);
  ShellCommandRegisterCommandName (L"rm", ShellCommandRunRm, ShellCommandGetManFileNameLevel2, 2, L"", ((BOOLEAN)(1==1)), gShellLevel2HiiHandle, 0x008F);
  ShellCommandRegisterCommandName (L"vol", ShellCommandRunVol, ShellCommandGetManFileNameLevel2, 2, L"", ((BOOLEAN)(1==1)), gShellLevel2HiiHandle, 0x0096);
  ...
  if ((_gPcd_FixedAtBuild_PcdShellSupportLevel == 2) || (_gPcd_FixedAtBuild_PcdShellSupportLevel == 3)) {
    ShellCommandRegisterCommandName (L"date", ShellCommandRunDate, ShellCommandGetManFileNameLevel2, _gPcd_FixedAtBuild_PcdShellSupportLevel, L"", ((BOOLEAN)(1==1)), gShellLevel2HiiHandle, 0x0091);
    ShellCommandRegisterCommandName (L"time", ShellCommandRunTime, ShellCommandGetManFileNameLevel2, _gPcd_FixedAtBuild_PcdShellSupportLevel, L"", ((BOOLEAN)(1==1)), gShellLevel2HiiHandle, 0x0092);
    ShellCommandRegisterCommandName (L"timezone", ShellCommandRunTimeZone, ShellCommandGetManFileNameLevel2, _gPcd_FixedAtBuild_PcdShellSupportLevel, L"", ((BOOLEAN)(1==1)), gShellLevel2HiiHandle, 0x0093);
  } else {
    do { if (DebugCodeEnabled ()) { do { } while (((BOOLEAN)(0==1)));



    ShellCommandRegisterCommandName (L"l2date", ShellCommandRunDate, ShellCommandGetManFileNameLevel2, 2, L"", ((BOOLEAN)(1==1)), gShellLevel2HiiHandle, 0x0091);
    ShellCommandRegisterCommandName (L"l2time", ShellCommandRunTime, ShellCommandGetManFileNameLevel2, 2, L"", ((BOOLEAN)(1==1)), gShellLevel2HiiHandle, 0x0092);
    ShellCommandRegisterCommandName (L"l2timezone", ShellCommandRunTimeZone, ShellCommandGetManFileNameLevel2, 2, L"", ((BOOLEAN)(1==1)), gShellLevel2HiiHandle, 0x0093);
    } } while (((BOOLEAN)(0==1)));
  }

  return ((RETURN_STATUS)(0));
}
# 136 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/UefiShellLevel2CommandsLib.c"
EFI_STATUS
...
# 166 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/UefiShellLevel2CommandsLib.c"
CHAR16 *
GetFullyQualifiedPath (
  const CHAR16 *Path
  )
{
  ...
  if (StrStr (Path, L":") == ((void *) 0)) {
    CurDir = gEfiShellProtocol->GetCurDir (((void *) 0));
  ...
  if (PathToReturn == ((void *) 0)) {
    return ((void *) 0);
  }

  while (PathToReturn[StrLen (PathToReturn)-1] == L'*') {
    PathToReturn[StrLen (PathToReturn)-1] = 0x0000;
  }

  return (PathToReturn);
}
# 213 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/UefiShellLevel2CommandsLib.c"
EFI_STATUS
VerifyIntermediateDirectories (
  const CHAR16 *Path
  )
{
  ...
  PathCopy = ((void *) 0);
  PathCopy = StrnCatGrow (&PathCopy, ((void *) 0), Path, 0);
  FileHandle = ((void *) 0);
  ...
  for (TempSpot = &PathCopy[StrLen (PathCopy)-1]; *TempSpot != 0x0000 && *TempSpot != L'\\'; TempSpot = &PathCopy[StrLen (PathCopy)-1]) {
    *TempSpot = 0x0000;
  }
  ...
  if ((PathCopy != ((void *) 0)) && (*PathCopy != 0x0000)) {
    ...
    if (PathCopy[StrLen (PathCopy)-1] != L':') {
      if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
        Status = ShellOpenFileByName (PathCopy, &FileHandle, 0x0000000000000001ULL, 0);
  ...
  do { if ((PathCopy) != ((void *) 0)) { FreePool((PathCopy)); (PathCopy) = ((void *) 0); } } while(((BOOLEAN)(0==1)));

  return (Status);
}
# 271 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/UefiShellLevel2CommandsLib.c"
INTN
StrniCmp (
  const CHAR16 *Source,
  const CHAR16 *Target,
  ...
  )
{
  ...
  SourceLength = (((SourceLength) < (Count)) ? (SourceLength) : (Count));
  TargetLength = (((TargetLength) < (Count)) ? (TargetLength) : (Count));
  SourceCopy = AllocateCopyPool ((SourceLength + 1) * sizeof (CHAR16), Source);
  if (SourceCopy == ((void *) 0)) {
    return -1;
  }

  TargetCopy = AllocateCopyPool ((TargetLength + 1) * sizeof (CHAR16), Target);
  if (TargetCopy == ((void *) 0)) {
    FreePool (SourceCopy);
    return -1;
  }
...
# 321 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/UefiShellLevel2CommandsLib.c"
EFI_STATUS
ShellLevel2StripQuotes (
  const CHAR16 *OriginalString,
  CHAR16 **CleanString
  )
{
  ...
  *CleanString = AllocateCopyPool (StrSize (OriginalString), OriginalString);
  ...
  for (Walker = *CleanString; Walker != ((void *) 0) && *Walker != 0x0000;) {
    if (*Walker == L'\"') {

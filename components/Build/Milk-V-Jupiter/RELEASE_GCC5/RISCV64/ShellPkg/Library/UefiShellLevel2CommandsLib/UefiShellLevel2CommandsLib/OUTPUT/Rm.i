# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Rm.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Rm.c"
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Rm.c"
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Rm.c" 2

static const SHELL_PARAM_ITEM ParamList[] = {
  { L"-q", TypeFlag },
  { ((void *) 0), TypeMax }
};
# 25 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Rm.c"
BOOLEAN
IsDirectoryEmpty (
  SHELL_FILE_HANDLE FileHandle
  )
{
  ...
  for (Status = FileHandleFindFirstFile (FileHandle, &FileInfo)
       ; !NoFile && !(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)
...
# 65 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Rm.c"
SHELL_STATUS
CascadeDelete (
  EFI_SHELL_FILE_INFO *Node,
  const BOOLEAN Quiet
  )
{
  ...
  if ((Node->Info->Attribute & 0x0000000000000001ULL) == 0x0000000000000001ULL) {
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0079, gShellLevel2HiiHandle, L"rm", Node->FullName);
  ...
  if ((Node->Info->Attribute & 0x0000000000000010ULL) == 0x0000000000000010ULL) {
    if (!IsDirectoryEmpty (Node->Handle)) {
      if (!Quiet) {
        Status = ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0073, gShellLevel2HiiHandle, Node->FullName);
        ...
        if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) || (*Resp != ShellPromptResponseYes)) {
           ...
           )
      {
        ...
        Node2->Status = gEfiShellProtocol->OpenFileByName (Node2->FullName, &Node2->Handle, 0x0000000000000001ULL|0x0000000000000002ULL);
        if ((((RETURN_STATUS)(Node2->Status)) >= 0x8000000000000000ULL) && (StrStr (Node2->FileName, L":") == ((void *) 0))) {
          ...
          if (TempName == ((void *) 0)) {
            ...
            TempName[StrStr (TempName, L":")+1-TempName] = 0x0000;
        ...
        if (!(((RETURN_STATUS)(Node2->Status)) >= 0x8000000000000000ULL)) {
  ...
  if (!((StrCmp (Node->FileName, L".") == 0) || (StrCmp (Node->FileName, L"..") == 0))) {
    ...
    if (!Quiet) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0074, gShellLevel2HiiHandle, Node->FullName);
    }
  ...
  if (Status != (RETURN_STATUS)(0)) {
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0075, gShellLevel2HiiHandle, Status);
    return (SHELL_ACCESS_DENIED);
  } else {
    if (!Quiet) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0078, gShellLevel2HiiHandle);
    }

    return (SHELL_SUCCESS);
  }
}
# 205 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Rm.c"
BOOLEAN
IsValidDeleteTarget (
  const EFI_SHELL_FILE_INFO *List,
  const EFI_SHELL_FILE_INFO *Node,
  const LIST_ENTRY *Package
  )
{
  ...
  if ((Node == ((void *) 0)) || (Node->FullName == ((void *) 0))) {
    return (((BOOLEAN)(0==1)));
  }

  TempLocation = StrStr (Node->FullName, L":");
  if ((TempLocation == ((void *) 0)) || (StrLen (TempLocation) <= 2)) {
  ...
  TempLocation = ShellGetCurrentDir (((void *) 0));
  ...
  if (!(((RETURN_STATUS)(ShellIsDirectory (SearchString))) >= 0x8000000000000000ULL)) {
    SearchString = StrnCatGrow (&SearchString, &Size, L"\\", 0);
    SearchString = StrnCatGrow (&SearchString, &Size, L"*", 0);
  }

  if ((Pattern == ((void *) 0)) || (SearchString == ((void *) 0))) {
    RetVal = ((BOOLEAN)(0==1));
  } else {
    RetVal = ((BOOLEAN)(1==1));
...
Done:
  do { if ((Pattern) != ((void *) 0)) { FreePool((Pattern)); (Pattern) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
  ...
  )
{
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    if ((Status == ((RETURN_STATUS)(0x8000000000000000ULL | (10)))) && (ProblemParam != ((void *) 0))) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0006, gShellLevel2HiiHandle, L"rm", ProblemParam);
    ...
    if (ShellCommandLineGetRawValue (Package, 1) == ((void *) 0)) {
      ...
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0004, gShellLevel2HiiHandle, L"rm");
      ShellStatus = SHELL_INVALID_PARAMETER;
    } else {
      ...
      {
        Status = ShellOpenFileMetaArg ((CHAR16 *)Param, 0x0000000000000002ULL|0x0000000000000001ULL, &FileList);
        if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) || (FileList == ((void *) 0)) || IsListEmpty (&FileList->Link)) {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0012, gShellLevel2HiiHandle, L"rm", (CHAR16 *)Param);
      ...
      if (ShellStatus == SHELL_SUCCESS) {
              ...
              )
        {
          ...
          if ((((RETURN_STATUS)(Node->Status)) >= 0x8000000000000000ULL)) {
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0076, gShellLevel2HiiHandle, Node->Status);
            ShellStatus = SHELL_ACCESS_DENIED;
            break;
          }

          if (!IsValidDeleteTarget (FileList, Node, Package)) {
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0077, gShellLevel2HiiHandle, Node->FullName);
            ShellStatus = SHELL_INVALID_PARAMETER;
            break;
          }

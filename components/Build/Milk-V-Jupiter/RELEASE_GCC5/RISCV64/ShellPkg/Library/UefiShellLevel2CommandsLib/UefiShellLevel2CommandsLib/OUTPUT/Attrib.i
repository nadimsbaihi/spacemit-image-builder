# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Attrib.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Attrib.c"
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Attrib.c"
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Attrib.c" 2
  ...
  )
{
  ...
  Status = ShellCommandLineParseEx(AttribParamList,&Package,&ProblemParam,((BOOLEAN)(1==1)),((BOOLEAN)(0==1)));
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    if ((Status == ((RETURN_STATUS)(0x8000000000000000ULL | (10)))) && (ProblemParam != ((void *) 0))) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0006, gShellLevel2HiiHandle, L"attrib", ProblemParam);
    ...
    if (ShellCommandLineGetFlag (Package, L"-?")) {
      ...
      if (ShellCommandLineGetFlag (Package, L"+a")) {
        FileAttributesToAdd |= 0x0000000000000020ULL;
      }

      if (ShellCommandLineGetFlag (Package, L"-a")) {
        FileAttributesToRemove |= 0x0000000000000020ULL;
      }

      if (ShellCommandLineGetFlag (Package, L"+s")) {
        FileAttributesToAdd |= 0x0000000000000004ULL;
      }

      if (ShellCommandLineGetFlag (Package, L"-s")) {
        FileAttributesToRemove |= 0x0000000000000004ULL;
      }

      if (ShellCommandLineGetFlag (Package, L"+h")) {
        FileAttributesToAdd |= 0x0000000000000002ULL;
      }

      if (ShellCommandLineGetFlag (Package, L"-h")) {
        FileAttributesToRemove |= 0x0000000000000002ULL;
      }

      if (ShellCommandLineGetFlag (Package, L"+r")) {
        FileAttributesToAdd |= 0x0000000000000001ULL;
      }

      if (ShellCommandLineGetFlag (Package, L"-r")) {
        FileAttributesToRemove |= 0x0000000000000001ULL;
      }
      ...
      if ((FileAttributesToRemove == 0) && (FileAttributesToAdd == 0)) {
              ...
              )
        {
          ...
          if ((FileName == ((void *) 0)) && (ParamNumberCount == 1)) {
            FileName = (CHAR16 *)AllFiles;
          } else if (FileName == ((void *) 0)) {
            break;
          }

          do { if (((BOOLEAN)(0==1))) { (void) (ListOfFiles == ((void *) 0)); } } while (((BOOLEAN)(0==1)));
          Status = ShellOpenFileMetaArg ((CHAR16 *)FileName, 0x0000000000000001ULL, &ListOfFiles);
          if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x000F, gShellLevel2HiiHandle, L"attrib", ShellCommandLineGetRawValue (Package, ParamNumberCount));
                 ...
                 )
            {
              ShellPrintHiiEx (
                ...
                FileNode->Info->Attribute&0x0000000000000010ULL ? L'D' : L' ',
                FileNode->Info->Attribute&0x0000000000000020ULL ? L'A' : L' ',
                FileNode->Info->Attribute&0x0000000000000004ULL ? L'S' : L' ',
                FileNode->Info->Attribute&0x0000000000000002ULL ? L'H' : L' ',
                FileNode->Info->Attribute&0x0000000000000001ULL ? L'R' : L' ',
                FileNode->FileName
                );
            ...
            ListOfFiles = ((void *) 0);
            if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
              ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0010, gShellLevel2HiiHandle, L"attrib", ShellCommandLineGetRawValue (Package, ParamNumberCount));
              ShellStatus = SHELL_NOT_FOUND;
            }
          }
        }
        ...
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x000D, gShellLevel2HiiHandle, L"attrib");
        ShellStatus = SHELL_INVALID_PARAMETER;
      } else {
              ...
              )
        {
          ...
          if (FileName == ((void *) 0)) {
            ...
            if (ParamNumberCount == 1) {
              ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0004, gShellLevel2HiiHandle, L"attrib");
              ShellStatus = SHELL_INVALID_PARAMETER;
            }

            break;
          }
# 211 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Attrib.c"
          do { if (((BOOLEAN)(0==1))) { (void) (ListOfFiles == ((void *) 0)); } } while (((BOOLEAN)(0==1)));
          Status = ShellOpenFileMetaArg ((CHAR16 *)FileName, 0x0000000000000001ULL, &ListOfFiles);
          if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x000F, gShellLevel2HiiHandle, L"attrib", ShellCommandLineGetRawValue (Package, ParamNumberCount));
                 ...
                 )
            {
              ...
              if ((FileAttributesToRemove & 0x0000000000000001ULL) == 0x0000000000000001ULL) {
                ...
                if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
                  ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0011, gShellLevel2HiiHandle, L"attrib", ShellCommandLineGetRawValue (Package, ParamNumberCount));

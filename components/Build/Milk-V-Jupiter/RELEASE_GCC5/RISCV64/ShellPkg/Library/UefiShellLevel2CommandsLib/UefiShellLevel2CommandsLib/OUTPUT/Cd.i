# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Cd.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Cd.c"
# 12 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Cd.c"
...
# 13 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Cd.c" 2
# 28 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Cd.c"
EFI_STATUS
ReplaceDriveWithCwd (
  CHAR16 **FullPath,
  const CHAR16 *Cwd
  )
{
  ...
  if ((FullPath == ((void *) 0)) || (*FullPath == ((void *) 0))) {
    return (RETURN_STATUS)(0);
  }

  Splitter = StrStr (*FullPath, L":");
  do { if (((BOOLEAN)(0==1))) { (void) (Splitter != *FullPath); } } while (((BOOLEAN)(0==1)));

  if ((Splitter != ((void *) 0)) && (*(Splitter + 1) != L'\\') && (*(Splitter + 1) != L'/')) {
...
# 76 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Cd.c"
BOOLEAN
IsCurrentFileSystem (
...
# 120 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Cd.c"
EFI_STATUS
ExtractDriveAndPath (
  const CHAR16 *FullPath,
  CHAR16 **Drive,
    ...
    *Path = AllocateCopyPool (StrSize (FullPath), FullPath);
    ...
    if (*(Splitter + 1) == 0x0000) {
      ...
      *Drive = AllocateCopyPool ((Splitter - FullPath + 2) * sizeof (CHAR16), FullPath);
      ...
      (*Drive)[Splitter - FullPath + 1] = 0x0000;
  ...
  )
{
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    if ((Status == ((RETURN_STATUS)(0x8000000000000000ULL | (10)))) && (ProblemParam != ((void *) 0))) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0006, gShellLevel2HiiHandle, L"cd", ProblemParam);
  ...
  if (ShellCommandLineGetFlag (Package, L"-?")) {
    ...
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0003, gShellLevel2HiiHandle, L"cd");
    ShellStatus = SHELL_INVALID_PARAMETER;
  } else {
    ...
    if (Cwd == ((void *) 0)) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0014, gShellLevel2HiiHandle, L"cd");
      ...
      if (Param1 == ((void *) 0)) {
        ...
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0027, gShellLevel2HiiHandle, Cwd);
      } else {
        Param1Copy = CatSPrint (((void *) 0), L"%s", Param1, ((void *) 0));
        for (Walker = Param1Copy; Walker != ((void *) 0) && *Walker != 0x0000; Walker++) {
          if (*Walker == L'\"') {
            CopyMem (Walker, Walker + 1, StrSize (Walker) - sizeof (Walker[0]));
          }
        }

        if ((Param1Copy != ((void *) 0)) && IsCurrentFileSystem (Param1Copy, Cwd)) {
          Status = ReplaceDriveWithCwd (&Param1Copy, Cwd);
        } else {



          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0028, gShellLevel2HiiHandle, L"cd");
          Status = ((RETURN_STATUS)(0x8000000000000000ULL | (14)));
        }

        if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) && (Param1Copy != ((void *) 0))) {
        ...
        if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) && (Drive != ((void *) 0)) && (Path != ((void *) 0))) {
          if ((((RETURN_STATUS)(ShellIsDirectory (Param1Copy))) >= 0x8000000000000000ULL)) {
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0017, gShellLevel2HiiHandle, L"cd", Param1Copy);
            ShellStatus = SHELL_NOT_FOUND;
          } else {
            Status = gEfiShellProtocol->SetCurDir (Drive, Path + 1);
            if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
              ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0015, gShellLevel2HiiHandle, L"cd", Param1Copy);
              ShellStatus = SHELL_NOT_FOUND;
            }
          }
        }

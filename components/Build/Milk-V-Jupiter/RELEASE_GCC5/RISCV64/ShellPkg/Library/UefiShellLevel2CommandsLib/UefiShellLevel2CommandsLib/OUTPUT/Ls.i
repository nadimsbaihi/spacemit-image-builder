# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Ls.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Ls.c"
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Ls.c"
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Ls.c" 2
...
extern EFI_GUID gEfiFileSystemInfoGuid;
# 12 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Ls.c" 2
...
PrintSfoVolumeInfoTableEntry (
  const EFI_SHELL_FILE_INFO *TheList
  )
{
  EFI_STATUS Status;
  EFI_SHELL_FILE_INFO *Node;
  ...
  for ( Node = (EFI_SHELL_FILE_INFO *)GetFirstNode (&TheList->Link)
        ; !IsNull (&TheList->Link, &Node->Link) && Node->Handle == ((void *) 0)
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (SysInfo != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
  ShellPrintHiiEx (
    0,
  ...
  do { if ((SysInfo) != ((void *) 0)) { FreePool((SysInfo)); (SysInfo) = ((void *) 0); } } while(((BOOLEAN)(0==1)));

  return (Status);
}
# 163 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Ls.c"
void
PrintFileInformation (
  const BOOLEAN Sfo,
  const EFI_SHELL_FILE_INFO *TheNode,
  UINT64 *Files,
  UINT64 *Size,
  UINT64 *Dirs
  )
{
  do { if (((BOOLEAN)(0==1))) { (void) (Files != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { (void) (Size != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { (void) (Dirs != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { (void) (TheNode != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
  ...
  if (Sfo) {
    ...
    ShellPrintHiiEx (
      ...
      (TheNode->Info->Attribute & 0x0000000000000020ULL) != 0 ? L"a" : L"",
      (TheNode->Info->Attribute & 0x0000000000000010ULL) != 0 ? L"d" : L"",
      (TheNode->Info->Attribute & 0x0000000000000002ULL) != 0 ? L"h" : L"",
      (TheNode->Info->Attribute & 0x0000000000000001ULL) != 0 ? L"r" : L"",
      (TheNode->Info->Attribute & 0x0000000000000004ULL) != 0 ? L"s" : L"",
    ...
    ShellPrintHiiEx (
      ...
      (TheNode->Info->Attribute & 0x0000000000000010ULL) != 0 ? L"<DIR>" : L"",
      (TheNode->Info->Attribute & 0x0000000000000001ULL) != 0 ? L'r' : L' ',
      TheNode->Info->FileSize
      );
    if (TheNode->Info->Attribute & 0x0000000000000010ULL) {
      (*Dirs)++;
      ShellPrintHiiEx (
        -1,
        -1,
  ...
  )
{
  ...
  if (DirectoryName != ((void *) 0)) {
    ...
    do { if ((DirectoryName) != ((void *) 0)) { FreePool((DirectoryName)); (DirectoryName) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
  }
}
# 310 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Ls.c"
void
PrintNonSfoFooter (
  UINT64 Files,
  UINT64 Size,
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) ((Time->TimeZone >= -1440) && (Time->TimeZone <= 1440)); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { (void) ((LocalTimeZone >= -1440) && (LocalTimeZone <= 1440)); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { (void) ((Time->Month >= 1) && (Time->Month <= 12)); } } while (((BOOLEAN)(0==1)));
...
# 444 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Ls.c"
SHELL_STATUS
PrintLsOutput (
  const BOOLEAN Rec,
  const UINT64 Attribs,
  const BOOLEAN Sfo,
  const CHAR16 *RootPath,
  const CHAR16 *SearchString,
  BOOLEAN *Found,
  const UINTN Count,
  const INT16 TimeZone,
  const BOOLEAN ListUnfiltered
  )
{
  EFI_STATUS Status;
  EFI_SHELL_FILE_INFO *ListHead;
  ...
  Status = ShellOpenFileMetaArg ((CHAR16 *)CorrectedPath, 0x0000000000000001ULL, &ListHead);
  if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    if ((ListHead == ((void *) 0)) || IsListEmpty (&ListHead->Link)) {
      do { if ((CorrectedPath) != ((void *) 0)) { FreePool((CorrectedPath)); (CorrectedPath) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
          ...
          )
    {
      ...
      Status = gRT->GetTime (&LocalTime, ((void *) 0));
      if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) && (LocalTime.TimeZone != 0x07FF)) {
        if ((Node->Info->CreateTime.TimeZone != 0x07FF) &&
        ...
        if ((Node->Info->LastAccessTime.TimeZone != 0x07FF) &&
        ...
        if ((Node->Info->ModificationTime.TimeZone != 0x07FF) &&
      ...
      do { if (((BOOLEAN)(0==1))) { (void) ((Node->Info->Attribute & 0x0000000000000037ULL) == Node->Info->Attribute); } } while (((BOOLEAN)(0==1)));
      if (Attribs == 0) {



        if ( (Node->Info->Attribute & 0x0000000000000004ULL)
           || (Node->Info->Attribute & 0x0000000000000002ULL)
              )
        {
          continue;
        }
      } else if ((Attribs != 0x0000000000000037ULL) ||
                 (Count == 5))
      {
  ...
  if (Rec && (ShellStatus != SHELL_ABORTED)) {
    ...
    if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
            ...
            )
      {
        ...
        if ( ((Node->Info->Attribute & 0x0000000000000010ULL) == 0x0000000000000010ULL)
  ...
  )
{
  ...
  Status = ShellCommandLineParseEx(LsParamList,&Package,&ProblemParam,((BOOLEAN)(1==1)),((BOOLEAN)(0==1)));
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    if ((Status == ((RETURN_STATUS)(0x8000000000000000ULL | (10)))) && (ProblemParam != ((void *) 0))) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0006, gShellLevel2HiiHandle, L"ls", ProblemParam);
    ...
    if (ShellCommandLineGetCount (Package) > 2) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0003, gShellLevel2HiiHandle, L"ls");
      ShellStatus = SHELL_INVALID_PARAMETER;
    } else {
      ...
      if (ShellCommandLineGetFlag (Package, L"-a")) {
        for ( Attribs = ShellCommandLineGetValue (Package, L"-a")
              ; Attribs != ((void *) 0) && *Attribs != 0x0000 && ShellStatus == SHELL_SUCCESS
              ; Attribs++
              )
        {
          switch (*Attribs) {
            case L'a':
            case L'A':
              RequiredAttributes |= 0x0000000000000020ULL;
              Count++;
              continue;
            case L's':
            case L'S':
              RequiredAttributes |= 0x0000000000000004ULL;
              Count++;
              continue;
            case L'h':
            case L'H':
              RequiredAttributes |= 0x0000000000000002ULL;
              Count++;
              continue;
            case L'r':
            case L'R':
              RequiredAttributes |= 0x0000000000000001ULL;
              Count++;
              continue;
            case L'd':
            case L'D':
              RequiredAttributes |= 0x0000000000000010ULL;
              Count++;
              continue;
            default:
              ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0008, gShellLevel2HiiHandle, L"ls", ShellCommandLineGetValue (Package, L"-a"));
              ShellStatus = SHELL_INVALID_PARAMETER;
              break;
          }
        }
        ...
        if (RequiredAttributes == 0) {
          RequiredAttributes = 0x0000000000000037ULL;
        }
      }
      ...
      if (ShellStatus == SHELL_SUCCESS) {
        ...
        if (PathName == ((void *) 0)) {
          ...
          if (CurDir == ((void *) 0)) {
            ...
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0014, gShellLevel2HiiHandle, L"ls");
          }

          ListUnfiltered = ((BOOLEAN)(1==1));



          do { if (((BOOLEAN)(0==1))) { (void) (SearchString == ((void *) 0)); } } while (((BOOLEAN)(0==1)));
          do { if (((BOOLEAN)(0==1))) { (void) (FullPath == ((void *) 0)); } } while (((BOOLEAN)(0==1)));
          StrnCatGrow (&SearchString, ((void *) 0), L"*", 0);
          StrnCatGrow (&FullPath, ((void *) 0), CurDir, 0);
          Size = FullPath != ((void *) 0) ? StrSize (FullPath) : 0;
          StrnCatGrow (&FullPath, &Size, L"\\", 0);
        } else {
          if ((StrStr (PathName, L":") == ((void *) 0)) && (gEfiShellProtocol->GetCurDir (((void *) 0)) == ((void *) 0))) {
            ...
            do { if (((BOOLEAN)(0==1))) { (void) ((FullPath == ((void *) 0) && Size == 0) || (FullPath != ((void *) 0))); } } while (((BOOLEAN)(0==1)));
            if (StrStr (PathName, L":") == ((void *) 0)) {
              StrnCatGrow (&FullPath, &Size, gEfiShellProtocol->GetCurDir (((void *) 0)), 0);
              if (FullPath == ((void *) 0)) {
            ...
            if (ShellIsDirectory (PathName) == (RETURN_STATUS)(0)) {
              ...
              StrnCatGrow (&SearchString, ((void *) 0), FullPath, 0);
        ...
        if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x001D, gShellLevel2HiiHandle, L"ls", L"gRT->GetTime", Status);
        ...
        if (ShellStatus == SHELL_SUCCESS) {
          ...
          if (ShellStatus == SHELL_NOT_FOUND) {
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x006F, gShellLevel2HiiHandle, L"ls", FullPath);
          } else if (ShellStatus == SHELL_INVALID_PARAMETER) {
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0005, gShellLevel2HiiHandle, L"ls", FullPath);
  ...
  do { if ((SearchString) != ((void *) 0)) { FreePool((SearchString)); (SearchString) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
  do { if ((FullPath) != ((void *) 0)) { FreePool((FullPath)); (FullPath) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
  ShellCommandLineFreeVarList (Package);

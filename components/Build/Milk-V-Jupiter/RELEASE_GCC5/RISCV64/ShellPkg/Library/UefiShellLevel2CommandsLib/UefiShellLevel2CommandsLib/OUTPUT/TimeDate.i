# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/TimeDate.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/TimeDate.c"
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/TimeDate.c"
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/TimeDate.c" 2
# 24 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/TimeDate.c"
BOOLEAN
  ...
  )
{
  ...
  for ( ; String != ((void *) 0) && *String != 0x0000; String++) {
    if (*String == Char) {
      Count++;
      if (Count > Max) {
        return (((BOOLEAN)(0==1)));
...
# 88 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/TimeDate.c"
SHELL_STATUS
CheckAndSetDate (
  const CHAR16 *DateString
  )
{
  EFI_TIME TheTime;
  EFI_STATUS Status;
  ...
  if (!InternalIsTimeLikeString (DateString, L'/', 2, 2, ((BOOLEAN)(0==1)))) {
    return (SHELL_INVALID_PARAMETER);
  }

  Status = gRT->GetTime (&TheTime, ((void *) 0));
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x001D, gShellLevel2HiiHandle, L"date", L"gRT->GetTime", Status);
    return (SHELL_DEVICE_ERROR);
  }

  DateStringCopy = ((void *) 0);
  DateStringCopy = StrnCatGrow (&DateStringCopy, ((void *) 0), DateString, 0);
  if (DateStringCopy == ((void *) 0)) {
  ...
  Walker1 = Walker != ((void *) 0) ? StrStr (Walker, L"/") : ((void *) 0);
  if ((Walker1 != ((void *) 0)) && (*Walker1 == L'/')) {
    *Walker1 = 0x0000;
  }

  if ((Walker != ((void *) 0)) && (Walker[0] != 0x0000)) {
  ...
  )
{
  ...
  Status = ShellCommandLineParseEx(SfoParamList,&Package,&ProblemParam,((BOOLEAN)(1==1)),((BOOLEAN)(0==1)));
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    if ((Status == ((RETURN_STATUS)(0x8000000000000000ULL | (10)))) && (ProblemParam != ((void *) 0))) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0006, gShellLevel2HiiHandle, L"date", ProblemParam);
    ...
    if (ShellCommandLineGetFlag (Package, L"-?")) {
      do { if (((BOOLEAN)(0==1))) { (void) (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    } else if (ShellCommandLineGetRawValue (Package, 2) != ((void *) 0)) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0003, gShellLevel2HiiHandle, L"date");
      ShellStatus = SHELL_INVALID_PARAMETER;
    } else {
      ...
      if (ShellCommandLineGetRawValue (Package, 1) == ((void *) 0)) {
        ...
        if (ShellCommandLineGetFlag (Package, L"-sfo")) {
          ...
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0019, gShellLevel2HiiHandle, L"date");
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0037, gShellLevel2HiiHandle, TheTime.Day, TheTime.Month, TheTime.Year);
        } else {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0036, gShellLevel2HiiHandle, TheTime.Month, TheTime.Day, TheTime.Year);
        }
      } else {
        if (_gPcd_FixedAtBuild_PcdShellSupportLevel == 2) {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0003, gShellLevel2HiiHandle, L"date");
          ShellStatus = SHELL_INVALID_PARAMETER;
        } else {
          ...
          if (ShellStatus != SHELL_SUCCESS) {
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0005, gShellLevel2HiiHandle, L"date", Param1);
            ShellStatus = SHELL_INVALID_PARAMETER;
          }
        }
      }
...
# 309 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/TimeDate.c"
SHELL_STATUS
CheckAndSetTime (
  const CHAR16 *TimeString,
  const INT16 Tz,
  const UINT8 Daylight
  )
{
  EFI_TIME TheTime;
  EFI_STATUS Status;
  ...
  if ((TimeString != ((void *) 0)) && !InternalIsTimeLikeString (TimeString, L':', 1, 2, ((BOOLEAN)(0==1)))) {
    return (SHELL_INVALID_PARAMETER);
  }

  if ((Daylight != 0xFF) && ((Daylight & (0x02|0x01)) != Daylight)) {
    return (SHELL_INVALID_PARAMETER);
  }

  Status = gRT->GetTime (&TheTime, ((void *) 0));
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x001D, gShellLevel2HiiHandle, L"time", L"gRT->GetTime", Status);
    return (SHELL_DEVICE_ERROR);
  }

  if (TimeString != ((void *) 0)) {
    TimeStringCopy = ((void *) 0);
    TimeStringCopy = StrnCatGrow (&TimeStringCopy, ((void *) 0), TimeString, 0);
    Walker1 = TimeStringCopy;
    TheTime.Hour = 0xFF;
    TheTime.Minute = 0xFF;

    Walker2 = Walker1 != ((void *) 0) ? StrStr (Walker1, L":") : ((void *) 0);
    if ((Walker2 != ((void *) 0)) && (*Walker2 == L':')) {
      *Walker2 = 0x0000;
    }
    ...
    } else if (Walker2 == ((void *) 0)) {
      TheTime.Second = (UINT8)0;
    }

    if ((Walker1 != ((void *) 0)) && (Walker1[0] != 0x0000)) {
    ...
    do { if ((TimeStringCopy) != ((void *) 0)) { FreePool((TimeStringCopy)); (TimeStringCopy) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
  }

  if ((Tz >= -1440) && (Tz <= 1440)) {
# 383 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/TimeDate.c"
    TheTime.TimeZone = -Tz;
  } else if (Tz == 0x07FF) {
    TheTime.TimeZone = Tz;
  }
  ...
  )
{
  ...
  if (_gPcd_FixedAtBuild_PcdShellSupportLevel == 2) {
    Status = ShellCommandLineParseEx (TimeParamList2, &Package, &ProblemParam, ((BOOLEAN)(1==1)), ((BOOLEAN)(1==1)));
  } else {
    do { if (((BOOLEAN)(0==1))) { (void) (_gPcd_FixedAtBuild_PcdShellSupportLevel == 3); } } while (((BOOLEAN)(0==1)));
    Status = ShellCommandLineParseEx (TimeParamList3, &Package, &ProblemParam, ((BOOLEAN)(1==1)), ((BOOLEAN)(1==1)));
  }

  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    if ((Status == ((RETURN_STATUS)(0x8000000000000000ULL | (10)))) && (ProblemParam != ((void *) 0))) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0006, gShellLevel2HiiHandle, L"time", ProblemParam);
      FreePool (ProblemParam);
      ShellStatus = SHELL_INVALID_PARAMETER;
    } else {
      do { if (((BOOLEAN)(0==1))) { (void) (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    ...
    if (ShellCommandLineGetFlag (Package, L"-?")) {
      ...
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0003, gShellLevel2HiiHandle, L"time");
      ShellStatus = SHELL_INVALID_PARAMETER;
    } else {
         ...
         && !ShellCommandLineGetFlag (Package, L"-tz"))
      {
        ...
        if (TheTime.TimeZone == 0x07FF) {
          TzMinutes = 0;
        } else {
          TzMinutes = ((((TheTime.TimeZone) < 0) ? (-(TheTime.TimeZone)) : (TheTime.TimeZone))) % 60;
        }
        ...
        if (TheTime.TimeZone != 0x07FF) {
          ShellPrintHiiEx (
            ...
            (((((TheTime.TimeZone) < 0) ? (-(TheTime.TimeZone)) : (TheTime.TimeZone))) / 60),
            TzMinutes
            );
        } else {
          ShellPrintHiiEx (
        ...
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0013, gShellLevel2HiiHandle);
      } else if (ShellCommandLineGetFlag (Package, L"-d") && (ShellCommandLineGetValue (Package, L"-d") == ((void *) 0))) {
        if (TheTime.TimeZone == 0x07FF) {
          ShellPrintHiiEx (
            -1,
            -1,
        ...
        switch (TheTime.Daylight) {
          case 0:
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x003A, gShellLevel2HiiHandle);
            break;
          case 0x01:
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x003B, gShellLevel2HiiHandle);
            break;
          case 0x02:
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x003C, gShellLevel2HiiHandle);
            break;
          case 0x02|0x01:
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x003D, gShellLevel2HiiHandle);
            break;
          default:
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x001C, gShellLevel2HiiHandle, L"time", L"gRT->GetTime", L"TheTime.Daylight", TheTime.Daylight);
        }
      } else {
        if (_gPcd_FixedAtBuild_PcdShellSupportLevel == 2) {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0003, gShellLevel2HiiHandle, L"time");
          ...
          if ((TempLocation = ShellCommandLineGetValue (Package, L"-tz")) != ((void *) 0)) {
            ...
            if (!((Tz >= -1440) && (Tz <= 1440)) && (Tz != 0x07FF)) {
              ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0007, gShellLevel2HiiHandle, L"time", TempLocation, L"-tz");
              ShellStatus = SHELL_INVALID_PARAMETER;
            }
          } else {
          ...
          if (TempLocation != ((void *) 0)) {
            ...
            if ((Daylight != 0) && (Daylight != 1) && (Daylight != 3)) {
              ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0007, gShellLevel2HiiHandle, L"time", TempLocation, L"-d");
              ShellStatus = SHELL_INVALID_PARAMETER;
            }
          } else {
          ...
          if (ShellStatus == SHELL_SUCCESS) {
            ...
            if (ShellStatus != SHELL_SUCCESS) {
              ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0005, gShellLevel2HiiHandle, L"time", ShellCommandLineGetRawValue (Package, 1));
              ShellStatus = SHELL_INVALID_PARAMETER;
            }
          }
        }
...
# 719 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/TimeDate.c"
SHELL_STATUS
CheckAndSetTimeZone (
  const CHAR16 *TimeZoneString
  )
{
  EFI_TIME TheTime;
  EFI_STATUS Status;
  ...
  if (gUnicodeCollation->StriColl (gUnicodeCollation, (CHAR16 *)TimeZoneString, L"_local") == 0) {
    Status = gRT->GetTime (&TheTime, ((void *) 0));
    if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x001D, gShellLevel2HiiHandle, L"gRT->GetTime", Status);
      return (SHELL_DEVICE_ERROR);
    }

    TheTime.TimeZone = 0x07FF;
    Status = gRT->SetTime (&TheTime);
    if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
      return (SHELL_SUCCESS);
    }
  ...
  if ((TimeZoneString != ((void *) 0)) && !InternalIsTimeLikeString (TimeZoneString, L':', 1, 1, ((BOOLEAN)(1==1)))) {
    return (SHELL_INVALID_PARAMETER);
  }

  Status = gRT->GetTime (&TheTime, ((void *) 0));
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x001D, gShellLevel2HiiHandle, L"timezone", L"gRT->GetTime", Status);
    return (SHELL_DEVICE_ERROR);
  }

  TimeZoneCopy = ((void *) 0);
  TimeZoneCopy = StrnCatGrow (&TimeZoneCopy, ((void *) 0), TimeZoneString, 0);
  if (TimeZoneCopy == ((void *) 0)) {
    return (SHELL_OUT_OF_RESOURCES);
  }
  ...
  )
{
  ...
  if (_gPcd_FixedAtBuild_PcdShellSupportLevel == 2) {
    Status = ShellCommandLineParseEx(TimeZoneParamList2,&Package,&ProblemParam,((BOOLEAN)(1==1)),((BOOLEAN)(0==1)));
  } else {
    do { if (((BOOLEAN)(0==1))) { (void) (_gPcd_FixedAtBuild_PcdShellSupportLevel == 3); } } while (((BOOLEAN)(0==1)));
    Status = ShellCommandLineParseEx (TimeZoneParamList3, &Package, &ProblemParam, ((BOOLEAN)(1==1)), ((BOOLEAN)(1==1)));
  }

  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    if ((Status == ((RETURN_STATUS)(0x8000000000000000ULL | (10)))) && (ProblemParam != ((void *) 0))) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0006, gShellLevel2HiiHandle, L"timezone", ProblemParam);
      FreePool (ProblemParam);
      ShellStatus = SHELL_INVALID_PARAMETER;
    } else {
      do { if (((BOOLEAN)(0==1))) { (void) (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    ...
    if (ShellCommandLineGetCount (Package) > 1) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0003, gShellLevel2HiiHandle, L"timezone");
      ShellStatus = SHELL_INVALID_PARAMETER;
      ...
      if ((ShellCommandLineGetFlag (Package, L"-l")) || (ShellCommandLineGetFlag (Package, L"-f"))) {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0005, gShellLevel2HiiHandle, L"timezone", L"-l or -f");
        ShellStatus = SHELL_INVALID_PARAMETER;
      } else {
        do { if (((BOOLEAN)(0==1))) { (void) (_gPcd_FixedAtBuild_PcdShellSupportLevel == 3); } } while (((BOOLEAN)(0==1)));
        if (ShellCommandLineGetValue (Package, L"-s") == ((void *) 0)) {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0009, gShellLevel2HiiHandle, L"timezone", L"-s");
          ShellStatus = SHELL_INVALID_PARAMETER;
        } else {
          ...
          if (ShellStatus != SHELL_SUCCESS) {
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0005, gShellLevel2HiiHandle, L"timezone", ShellCommandLineGetValue (Package, L"-s"));
            ShellStatus = SHELL_INVALID_PARAMETER;
          }
        }
      }
      ...
      {
        ShellPrintHiiEx (-1, -1, ((void *) 0), TimeZoneList[LoopVar].StringId, gShellLevel2HiiHandle);
      }
    } else {
      ...
      if (TheTime.TimeZone != 0x07FF) {
        ...
        if (!Found) {
          ...
          if (ShellCommandLineGetFlag (Package, L"-f")) {
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0064, gShellLevel2HiiHandle);
          }
        }
      } else {
        ...
        if (ShellCommandLineGetFlag (Package, L"-f")) {
          ...
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0063, gShellLevel2HiiHandle);
        }
      }
    }
  }

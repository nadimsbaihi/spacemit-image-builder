# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Reset.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Reset.c"
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Reset.c"
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Reset.c" 2
  ...
  )
{
  ...
  Status = ShellCommandLineParseEx(ResetParamList,&Package,&ProblemParam,((BOOLEAN)(1==1)),((BOOLEAN)(0==1)));
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    if ((Status == ((RETURN_STATUS)(0x8000000000000000ULL | (10)))) && (ProblemParam != ((void *) 0))) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0006, gShellLevel2HiiHandle, L"reset", ProblemParam);
    ...
    if (ShellCommandLineGetFlag (Package, L"-?")) {
      ...
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0003, gShellLevel2HiiHandle, L"reset");
      ...
      if (ShellCommandLineGetFlag (Package, L"-fwui")) {
        ...
        if ((OsIndications & 0x0000000000000001) != 0) {
          DataSize = sizeof (OsIndications);
          Status = gRT->GetVariable (
                            L"OsIndications",
                            &gEfiGlobalVariableGuid,
          ...
          if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
            OsIndications = 0x0000000000000001;
          } else {
            OsIndications |= 0x0000000000000001;
          }
      ...
      if (ShellCommandLineGetFlag (Package, L"-w")) {
        if (ShellCommandLineGetFlag (Package, L"-s") || ShellCommandLineGetFlag (Package, L"-c")) {
          ...
          if (String != ((void *) 0)) {
            gRT->ResetSystem (EfiResetWarm, (RETURN_STATUS)(0), StrSize (String), (void *)String);
          } else {
        ...
        if (ShellCommandLineGetFlag (Package, L"-c")) {
          ...
          do { if (DebugCodeEnabled ()) { do { } while (((BOOLEAN)(0==1))); ShellPrintEx (-1, -1, L"Reset with %s (%d bytes)\n", String, String != ((void *) 0) ? StrSize (String) : 0); } } while (((BOOLEAN)(0==1)))

             ;
          if (String != ((void *) 0)) {
            gRT->ResetSystem (EfiResetShutdown, (RETURN_STATUS)(0), StrSize (String), (void *)String);
          } else {
            gRT->ResetSystem (EfiResetShutdown, (RETURN_STATUS)(0), 0, ((void *) 0));
          }
        }
      } else {
        ...
        if (String != ((void *) 0)) {
          gRT->ResetSystem (EfiResetCold, (RETURN_STATUS)(0), StrSize (String), (void *)String);
        } else {

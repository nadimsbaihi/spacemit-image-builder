...
.Ltext0:
	...
	.file 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/ShellPkg/Library/UefiShellLevel2CommandsLib/UefiShellLevel2CommandsLib" "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Reset.c"
	.section	.rodata
	.align	3
.LC0:
	.string	"-"
...
.LC3:
	...
	.string	"i"
	.zero	2
	.section	.data.rel.ro.local.ResetParamList,"aw"
	.align	3
	.type	ResetParamList, @object
	.size	ResetParamList, 80
ResetParamList:
	.dword	.LC0
	.word	1
	.zero	4
...
.LC8:
	...
	.string	"\n"
	.zero	2
	.section	.text.ShellCommandRunReset,"ax",@progbits
	.align	1
	.globl	ShellCommandRunReset
	.type	ShellCommandRunReset, @function
ShellCommandRunReset:
.LFB0:
	.file 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Reset.c"
	.loc 1 32 1
	.cfi_startproc
	addi	sp,sp,-112
	...
	addi	a5,a5,10
	bne	a4,a5,.L3
	.loc 1 56 86 discriminator 1
	ld	a5,-72(s0)
	.loc 1 56 69 discriminator 1
	beq	a5,zero,.L3
	.loc 1 57 7
...
.L6:
	...
	bne	a5,zero,.L12
	.loc 1 123 57 discriminator 2
	ld	a5,-64(s0)
	lla	a1,.LC2
	mv	a0,a5
	call	ShellCommandLineGetFlag@plt
	mv	a5,a0
	.loc 1 123 54 discriminator 3
	beq	a5,zero,.L13
.L12:
	.loc 1 124 11
	la	a5,gShellLevel2HiiHandle
...
.L17:
	...
	beq	a5,zero,.L18
	.loc 1 140 77 discriminator 2
	ld	a5,-56(s0)
	beq	a5,zero,.L19
	.loc 1 140 163 discriminator 3
	ld	a0,-56(s0)
	call	StrSize@plt
	mv	a5,a0
	j	.L20
.L19:
	.loc 1 140 77 discriminator 4
	li	a5,0
.L20:
	.loc 1 140 77 is_stmt 0 discriminator 7
	mv	a4,a5
	ld	a3,-56(s0)
	lla	a2,.LC8
	li	a1,-1
...
.L18:
	...
	call	StrSize@plt
	mv	a5,a0
	.loc 1 144 13 is_stmt 0 discriminator 1
	ld	a3,-56(s0)
	mv	a2,a5
	li	a1,0
	li	a0,2
...
.L16:
	...
	call	StrSize@plt
	mv	a5,a0
	.loc 1 155 11 is_stmt 0 discriminator 1
	ld	a3,-56(s0)
	mv	a2,a5
	li	a1,0
	li	a0,0
...
.L23:
	...
	.cfi_endproc
.LFE0:
	.size	ShellCommandRunReset, .-ShellCommandRunReset
	.text
.Letext0:
	...
	.file 17 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdePkg/Include/Library/DebugLib.h"
...
.LASF0:
	.string	"/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Reset.c"

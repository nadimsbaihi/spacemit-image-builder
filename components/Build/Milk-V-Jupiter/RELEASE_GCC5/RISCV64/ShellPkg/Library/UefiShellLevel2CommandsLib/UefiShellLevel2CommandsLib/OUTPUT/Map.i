# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Map.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Map.c"
# 12 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Map.c"
...
# 13 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Map.c" 2
...
# 15 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Map.c" 2
...
# 16 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Map.c" 2
...
# 17 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Map.c" 2
# 30 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Map.c"
BOOLEAN
IsNumberLetterOnly (
  const CHAR16 *String,
  const UINTN Len
  )
{
  ...
  for (Count = 0; Count < Len && String != ((void *) 0) && *String != 0x0000; String++, Count++) {
...
# 63 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Map.c"
BOOLEAN
SearchList (
  const CHAR16 *List,
  const CHAR16 *MetaTarget,
  CHAR16 **FullName ,
  const BOOLEAN Meta,
  const BOOLEAN SkipTrailingNumbers,
  const CHAR16 *Target
  ...
  )
{
  ...
  for (ListWalker = List, TempList = ((void *) 0)
       ; ListWalker != ((void *) 0) && *ListWalker != 0x0000
       ;
       )
  {
    TempList = StrnCatGrow (&TempList, ((void *) 0), ListWalker, 0);
    if (TempList == ((void *) 0)) {
      do { if (((BOOLEAN)(0==1))) { (void) (TempList != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
      return (((BOOLEAN)(0==1)));
    }
    ...
    while (SkipTrailingNumbers && (ShellIsDecimalDigitCharacter (TempList[StrLen (TempList)-1]) || TempList[StrLen (TempList)-1] == L':')) {
      TempList[StrLen (TempList)-1] = 0x0000;
    }

    ListWalker = StrStr (ListWalker, Target);
    while (ListWalker != ((void *) 0) && *ListWalker == *Target) {
      ListWalker++;
    }
...
# 139 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Map.c"
CHAR16 *
GetDeviceMediaType (
  EFI_DEVICE_PATH_PROTOCOL *DevicePath
  )
{
  ACPI_HID_DEVICE_PATH *Acpi;
# 153 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Map.c"
  if (((void *) 0) == DevicePath) {
    return HiiGetString (gShellLevel2HiiHandle, 0x0031, ((void *) 0));
  }
  ...
  for ( ; !IsDevicePathEndType (DevicePath); DevicePath = NextDevicePathNode (DevicePath)) {
    if (DevicePathType (DevicePath) == 0x04) {
      switch (DevicePathSubType (DevicePath)) {
        case 0x01:
          return HiiGetString (gShellLevel2HiiHandle, 0x0032, ((void *) 0));
        case 0x02:
          return HiiGetString (gShellLevel2HiiHandle, 0x0033, ((void *) 0));
      }
    } else if (DevicePathType (DevicePath) == 0x02) {
      Acpi = (ACPI_HID_DEVICE_PATH *)DevicePath;
      if (((Acpi->HID) >> 16) == 0x0604) {
        return HiiGetString (gShellLevel2HiiHandle, 0x0030, ((void *) 0));
      }
    }
  }
...
# 184 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Map.c"
BOOLEAN
IsRemoveableDevice (
  EFI_DEVICE_PATH_PROTOCOL *DevicePath
  )
...
# 222 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Map.c"
BOOLEAN
MappingListHasType (
  const CHAR16 *MapList,
  const CHAR16 *Specific,
  const CHAR16 *TypeString,
  const BOOLEAN Normal,
  const BOOLEAN Consist
  )
{
  CHAR16 *NewSpecific;
  ...
  if (Specific != ((void *) 0)) {
    ...
    if (SearchList (MapList, NewSpecific, ((void *) 0), ((BOOLEAN)(1==1)), ((BOOLEAN)(0==1)), L";")) {
      FreePool (NewSpecific);
      return (((BOOLEAN)(1==1)));
    }
  ...
  if ( Consist
     && (Specific == ((void *) 0))
     && ( SearchList (MapList, L"HD*", ((void *) 0), ((BOOLEAN)(1==1)), ((BOOLEAN)(1==1)), L";")
        || SearchList (MapList, L"CD*", ((void *) 0), ((BOOLEAN)(1==1)), ((BOOLEAN)(1==1)), L";")
        || SearchList (MapList, L"F*", ((void *) 0), ((BOOLEAN)(1==1)), ((BOOLEAN)(1==1)), L";")
        || SearchList (MapList, L"FP*", ((void *) 0), ((BOOLEAN)(1==1)), ((BOOLEAN)(1==1)), L";")))
  {
    return (((BOOLEAN)(1==1)));
  }
  ...
  if ( Normal
     && (Specific == ((void *) 0))
     && ( SearchList (MapList, L"FS", ((void *) 0), ((BOOLEAN)(0==1)), ((BOOLEAN)(1==1)), L";")
        || SearchList (MapList, L"BLK", ((void *) 0), ((BOOLEAN)(0==1)), ((BOOLEAN)(1==1)), L";")))
  {
    return (((BOOLEAN)(1==1)));
  }

  if ((TypeString != ((void *) 0)) && SearchList (MapList, TypeString, ((void *) 0), ((BOOLEAN)(1==1)), ((BOOLEAN)(1==1)), L";")) {
    return (((BOOLEAN)(1==1)));
  }

  return (((BOOLEAN)(0==1)));
}
# 303 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Map.c"
EFI_STATUS
  ...
  )
{
  ...
  if (Normal || !Consist) {
    ...
    SearchList (TempSpot, L"HD*", &CurrentName, ((BOOLEAN)(1==1)), ((BOOLEAN)(0==1)), L";");
    if (CurrentName == ((void *) 0)) {
      SearchList (TempSpot, L"CD*", &CurrentName, ((BOOLEAN)(1==1)), ((BOOLEAN)(0==1)), L";");
    }

    if (CurrentName == ((void *) 0)) {
      SearchList (TempSpot, L"FP*", &CurrentName, ((BOOLEAN)(1==1)), ((BOOLEAN)(0==1)), L";");
    }

    if (CurrentName == ((void *) 0)) {
      SearchList (TempSpot, L"F*", &CurrentName, ((BOOLEAN)(1==1)), ((BOOLEAN)(0==1)), L";");
    }
    ...
    if (CurrentName == ((void *) 0)) {
      ...
      if (Alias[StrLen (Alias)-1] == L';') {
        Alias[StrLen (Alias)-1] = 0x0000;
      }
    }
  }

  DevPathString = ConvertDevicePathToText (DevPath, ((BOOLEAN)(1==1)), ((BOOLEAN)(0==1)));
  ...
  if (!SFO) {
    ShellPrintHiiEx (
      ...
      CurrentName,
      Alias != ((void *) 0) ? Alias : (TempLen < StrLen (MapList) ? MapList + TempLen+1 : L""),
      DevPathString
      );
    if (Verbose) {
      ...
      if (((TypeString != ((void *) 0)) && (MediaType != ((void *) 0)) && (StrStr (TypeString, MediaType) != ((void *) 0))) || (TypeString == ((void *) 0))) {
      ...
      do { if ((MediaType) != ((void *) 0)) { FreePool((MediaType)); (MediaType) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
    }
  } else {
    ShellPrintHiiEx (
      -1,
  ...
  do { if ((DevPathString) != ((void *) 0)) { FreePool((DevPathString)); (DevPathString) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
  do { if ((CurrentName) != ((void *) 0)) { FreePool((CurrentName)); (CurrentName) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
  do { if ((Alias) != ((void *) 0)) { FreePool((Alias)); (Alias) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
  return (RETURN_STATUS)(0);
}
# 486 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Map.c"
EFI_STATUS
  ...
  )
{
  ...
  if (!SearchList (MapList, Specific, &CurrentName, ((BOOLEAN)(1==1)), ((BOOLEAN)(0==1)), L";")) {
    return (((RETURN_STATUS)(0x8000000000000000ULL | (14))));
  }

  return (gEfiShellProtocol->SetMap (((void *) 0), CurrentName));
}
...
# 539 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Map.c"
SHELL_STATUS
  ...
  )
{
  ...
  if (!Consist && !Normal && (Specific == ((void *) 0)) && (TypeString == ((void *) 0))) {
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0004, gShellLevel2HiiHandle, L"map");
  ...
  if (TypeString != ((void *) 0)) {
    ...
    if (StrnCmp (TypeString, Test, StrLen (Test)-1) != 0) {
      ...
      if (StrnCmp (TypeString, Test, StrLen (Test)-1) != 0) {
        Test = (CHAR16 *)Fp;
        if (StrnCmp (TypeString, Test, StrLen (Test)-1) != 0) {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0005, gShellLevel2HiiHandle, L"map", TypeString);
          return (SHELL_INVALID_PARAMETER);
        }
      } else if (Test == ((void *) 0)) {
        Test = (CHAR16 *)AnyF;
  ...
  if (Header) {
    ...
    if (!SFO) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x002C, gShellLevel2HiiHandle);
    } else {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0019, gShellLevel2HiiHandle, L"map");
    }
  }
  ...
  for ( LoopVar = 0, Found = ((BOOLEAN)(0==1))
        ; LoopVar < (BufferSize / sizeof (EFI_HANDLE)) && HandleBuffer != ((void *) 0)
        ; LoopVar++
        )
  {
  ...
  if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) && (HandleBuffer != ((void *) 0))) {
  ...
  if (!Found) {
    if (Specific != ((void *) 0)) {
      ShellPrintHiiEx (gST->ConOut->Mode->CursorColumn, gST->ConOut->Mode->CursorRow-1, ((void *) 0), 0x0029, gShellLevel2HiiHandle, L"map", Specific);
    } else {
      ShellPrintHiiEx (gST->ConOut->Mode->CursorColumn, gST->ConOut->Mode->CursorRow-1, ((void *) 0), 0x0028, gShellLevel2HiiHandle, L"map");
    }
  }

  return (SHELL_SUCCESS);
}
# 733 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Map.c"
SHELL_STATUS
  ...
  )
{
  ...
  if (TypeString == ((void *) 0)) {
    return (PerformMappingDisplay (Verbose, Consist, Normal, ((void *) 0), SFO, Specific, ((BOOLEAN)(1==1))));
  }

  ShellStatus = SHELL_SUCCESS;
  for (TypeWalker = TypeString; TypeWalker != ((void *) 0) && *TypeWalker != 0x0000;) {
...
# 787 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Map.c"
EFI_STATUS
...
# 933 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Map.c"
SHELL_STATUS
  ...
  )
{
  ...
  if (NewSName[StrLen (NewSName)-1] != L':') {
    ...
    if ((((RETURN_STATUS)(StrRetStatus)) >= 0x8000000000000000ULL)) {
      FreePool (NewSName);
      return ((SHELL_STATUS)(StrRetStatus & (~0x8000000000000000ULL)));
    }
  }
...
# 991 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Map.c"
SHELL_STATUS
  ...
  )
{
  ...
  Status = ShellCommandLineParseEx(MapParamList,&Package,&ProblemParam,((BOOLEAN)(1==1)),((BOOLEAN)(0==1)));
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    if ((Status == ((RETURN_STATUS)(0x8000000000000000ULL | (10)))) && (ProblemParam != ((void *) 0))) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0006, gShellLevel2HiiHandle, L"map", ProblemParam);
    ...
    if (ShellCommandLineGetFlag (Package, L"-?")) {
      do { if (((BOOLEAN)(0==1))) { (void) (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    } else if (ShellCommandLineGetRawValue (Package, 3) != ((void *) 0)) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0003, gShellLevel2HiiHandle, L"map");
      ShellStatus = SHELL_INVALID_PARAMETER;
    } else {
      ...
      if (ShellCommandLineGetFlag (Package, L"-d")) {
        ...
        {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x000D, gShellLevel2HiiHandle, L"map");
          ShellStatus = SHELL_INVALID_PARAMETER;
        } else {
          ...
          if (SName != ((void *) 0)) {
            ...
            if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
              if (Status == ((RETURN_STATUS)(0x8000000000000000ULL | (15)))) {
                ShellPrintHiiEx (-1, -1, ((void *) 0), 0x000A, gShellLevel2HiiHandle, L"map");
                ShellStatus = SHELL_ACCESS_DENIED;
              } else if (Status == ((RETURN_STATUS)(0x8000000000000000ULL | (14)))) {
                ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0029, gShellLevel2HiiHandle, L"map", SName);
                ShellStatus = SHELL_INVALID_PARAMETER;
              } else {
                ShellPrintHiiEx (-1, -1, ((void *) 0), 0x000C, gShellLevel2HiiHandle, L"map", Status);
                   ...
                   )
      {
                     ...
                     )
        {
          ...
          if (ShellIsHexOrDecimalNumber (Mapping, ((BOOLEAN)(1==1)), ((BOOLEAN)(0==1)))) {
            MapAsHandle = ConvertHandleIndexToHandle (ShellStrToUintn (Mapping));
          } else {
            MapAsHandle = ((void *) 0);
          }

          if ((MapAsHandle == ((void *) 0)) && (Mapping[StrLen (Mapping)-1] != L':')) {
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0005, gShellLevel2HiiHandle, L"map", Mapping);
            ShellStatus = SHELL_INVALID_PARAMETER;
          } else {
            TempStringLength = StrLen (SName);
            if (!IsNumberLetterOnly (SName, TempStringLength-((SName[TempStringLength-1] == L':') ? 1 : 0))) {
              ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0005, gShellLevel2HiiHandle, L"map", SName);
              ShellStatus = SHELL_INVALID_PARAMETER;
            }

            if (ShellStatus == SHELL_SUCCESS) {
              if (MapAsHandle != ((void *) 0)) {
              ...
              if (ShellStatus != SHELL_SUCCESS) {
                switch (ShellStatus) {
                  ...
                  case SHELL_DEVICE_ERROR:
                    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x002A, gShellLevel2HiiHandle, L"map", Mapping);
                    break;
                  default:
                    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x000C, gShellLevel2HiiHandle, L"map", ShellStatus|0x8000000000000000ULL);
                }
              } else {

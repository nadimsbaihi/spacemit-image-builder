# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Cp.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Cp.c"
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Cp.c"
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Cp.c" 2
...
extern EFI_GUID gEfiFileSystemInfoGuid;
# 12 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Cp.c" 2
...
# 13 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Cp.c" 2
# 31 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Cp.c"
SHELL_STATUS
ValidateAndCopyFiles (
  const EFI_SHELL_FILE_INFO *FileList,
  const CHAR16 *DestDir,
  BOOLEAN SilentMode,
  BOOLEAN RecursiveMode,
  void **Resp
  );
# 53 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Cp.c"
SHELL_STATUS
CopySingleFile (
  const CHAR16 *Source,
  const CHAR16 *Dest,
  ...
  )
{
  ...
  Response = *Resp;
  List = ((void *) 0);
  DestVolumeInfo = ((void *) 0);
  ShellStatus = SHELL_SUCCESS;

  ReadSize = _gPcd_FixedAtBuild_PcdShellFileOperationSize;
  ...
  if (ShellFileExists (Dest) == (RETURN_STATUS)(0)) {
    if ((Response == ((void *) 0)) && !SilentMode) {
      Status = ShellPromptForResponseHii (ShellPromptResponseTypeYesNoAllCancel, 0x001E, gShellLevel2HiiHandle, &Response);
    }
  ...
  if (ShellIsDirectory (Source) == (RETURN_STATUS)(0)) {
    Status = ShellCreateDirectory (Dest, &DestHandle);
    if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0085, gShellLevel2HiiHandle, CmdName, Dest);
    ...
    if (TempName != ((void *) 0)) {
      ShellOpenFileMetaArg ((CHAR16 *)TempName, 0x0000000000000001ULL, &List);
      *TempName = 0x0000;
      StrnCatGrow (&TempName, &Size, Dest, 0);
      StrnCatGrow (&TempName, &Size, L"\\", 0);
      ShellStatus = ValidateAndCopyFiles (List, TempName, SilentMode, ((BOOLEAN)(1==1)), Resp);
      ShellCloseFileMetaArg (&List);
      do { if ((TempName) != ((void *) 0)) { FreePool((TempName)); (TempName) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
      Size = 0;
    }
  } else {
    ...
    Status = ShellOpenFileByName (Dest, &DestHandle, 0x0000000000000001ULL|0x0000000000000002ULL|0x8000000000000000ULL, 0);
    if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0084, gShellLevel2HiiHandle, CmdName, Dest);
      return (SHELL_ACCESS_DENIED);
    }
    ...
    Status = ShellOpenFileByName (Source, &SourceHandle, 0x0000000000000001ULL, 0);
    if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0086, gShellLevel2HiiHandle, CmdName, Source);
      return (SHELL_ACCESS_DENIED);
    }
    ...
    if (Status == ((RETURN_STATUS)(0x8000000000000000ULL | (5)))) {
      ...
      if (DestVolumeInfo == ((void *) 0)) {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0022, gShellLevel2HiiHandle, L"cp");
    ...
    if ((DestVolumeInfo != ((void *) 0)) && (DestVolumeInfo->FreeSpace < SourceFileSize)) {



      do { if ((DestVolumeInfo) != ((void *) 0)) { FreePool((DestVolumeInfo)); (DestVolumeInfo) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x001F, gShellLevel2HiiHandle, CmdName);
      ...
      if (Buffer == ((void *) 0)) {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0022, gShellLevel2HiiHandle, CmdName);
        return SHELL_OUT_OF_RESOURCES;
      }

      while (ReadSize == _gPcd_FixedAtBuild_PcdShellFileOperationSize && !(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
        Status = ShellReadFile (SourceHandle, &ReadSize, Buffer);
        if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
          Status = ShellWriteFile (DestHandle, &ReadSize, Buffer);
          if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
            ShellStatus = (SHELL_STATUS)(Status & (~0x8000000000000000ULL));
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0021, gShellLevel2HiiHandle, CmdName, Dest);
            break;
          }
        } else {
          ShellStatus = (SHELL_STATUS)(Status & (~0x8000000000000000ULL));
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0020, gShellLevel2HiiHandle, CmdName, Source);
          break;
        }
      }
    }
...
Done:
  ...
  if (DestHandle != ((void *) 0)) {
    ShellCloseFile (&DestHandle);
    DestHandle = ((void *) 0);
  }

  if (SourceHandle != ((void *) 0)) {
...
# 300 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Cp.c"
SHELL_STATUS
ValidateAndCopyFiles (
  const EFI_SHELL_FILE_INFO *FileList,
  const CHAR16 *DestDir,
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (DestDir != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
  ...
  if ((((RETURN_STATUS)(ShellIsDirectory (CleanFilePathStr))) >= 0x8000000000000000ULL) && (FileList->Link.ForwardLink != FileList->Link.BackLink)) {



    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0017, gShellLevel2HiiHandle, L"cp", CleanFilePathStr);
       ...
       )
  {
    ...
    NewSize += (Cwd == ((void *) 0)) ? 0 : (StrSize (Cwd) + sizeof (CHAR16));
    if (NewSize > PathSize) {
      PathSize = NewSize;
    }
    ...
    if (!RecursiveMode && !(((RETURN_STATUS)(ShellIsDirectory (Node->FullName))) >= 0x8000000000000000ULL)) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x007F, gShellLevel2HiiHandle, L"cp");
      FreePool (CleanFilePathStr);
      return (SHELL_INVALID_PARAMETER);
    }
    ...
    if (!(((RETURN_STATUS)(ShellIsDirectory (Node->FullName))) >= 0x8000000000000000ULL) && (((RETURN_STATUS)(ShellIsDirectory (CleanFilePathStr))) >= 0x8000000000000000ULL)) {
  ...
  HiiOutput = HiiGetString (gShellLevel2HiiHandle, 0x007E, ((void *) 0));
  HiiResultOk = HiiGetString (gShellLevel2HiiHandle, 0x0016, ((void *) 0));
  DestPath = AllocateZeroPool (PathSize);

  if ((DestPath == ((void *) 0)) || (HiiOutput == ((void *) 0)) || (HiiResultOk == ((void *) 0))) {
       ...
       )
  {
    ...
    if ( (FileList->Link.ForwardLink == FileList->Link.BackLink)
       && (((RETURN_STATUS)(ShellIsDirectory (CleanFilePathStr))) >= 0x8000000000000000ULL)
          )
    {
      if (StrStr (CleanFilePathStr, L":") == ((void *) 0)) {
        ...
        if (Cwd != ((void *) 0)) {
          ...
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0015, gShellLevel2HiiHandle, L"cp", CleanFilePathStr);
          FreePool (CleanFilePathStr);
          return (SHELL_INVALID_PARAMETER);
        }
      ...
      if (CleanFilePathStr[0] == L'\\') {
      ...
      } else if (StrStr (CleanFilePathStr, L":") == ((void *) 0)) {
        if (Cwd != ((void *) 0)) {
          StrCpyS (DestPath, PathSize/sizeof (CHAR16), Cwd);
          StrCatS (DestPath, PathSize/sizeof (CHAR16), L"\\");
        } else {
        ...
        if ((CleanFilePathStr[StrLen (CleanFilePathStr)-1] != L'\\') && (Node->FileName[0] != L'\\')) {
          ...
          ((CHAR16 *)CleanFilePathStr)[StrLen (CleanFilePathStr)-1] = 0x0000;
        }
    ...
    if ((((RETURN_STATUS)(VerifyIntermediateDirectories (DestPath))) >= 0x8000000000000000ULL)) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0080, gShellLevel2HiiHandle, L"cp", DestPath);
      ShellStatus = SHELL_DEVICE_ERROR;
      break;
    }

    if ( !(((RETURN_STATUS)(ShellIsDirectory (Node->FullName))) >= 0x8000000000000000ULL)
       && !(((RETURN_STATUS)(ShellIsDirectory (DestPath))) >= 0x8000000000000000ULL)
       && (StrniCmp (Node->FullName, DestPath, StrLen (DestPath)) == 0)
          )
    {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0082, gShellLevel2HiiHandle, L"cp");
      ShellStatus = SHELL_INVALID_PARAMETER;
      break;
    }

    if (StringNoCaseCompare (&Node->FullName, &DestPath) == 0) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0081, gShellLevel2HiiHandle, L"cp");
      ShellStatus = SHELL_INVALID_PARAMETER;
      break;
    }

    if ( (StrniCmp (Node->FullName, DestPath, StrLen (Node->FullName)) == 0)
       && ((DestPath[StrLen (Node->FullName)] == 0x0000) || (DestPath[StrLen (Node->FullName)] == L'\\'))
          )
    {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0081, gShellLevel2HiiHandle, L"cp");
      ShellStatus = SHELL_INVALID_PARAMETER;
  ...
  if ((ShellStatus == SHELL_SUCCESS) && (Resp == ((void *) 0))) {
  ...
  do { if ((HiiOutput) != ((void *) 0)) { FreePool((HiiOutput)); (HiiOutput) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
  do { if ((HiiResultOk) != ((void *) 0)) { FreePool((HiiResultOk)); (HiiResultOk) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
  do { if ((CleanFilePathStr) != ((void *) 0)) { FreePool((CleanFilePathStr)); (CleanFilePathStr) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
  if (Resp == ((void *) 0)) {
...
# 599 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Cp.c"
SHELL_STATUS
  ...
  )
{
  ...
  ShellOpenFileMetaArg ((CHAR16 *)DestDir, 0x0000000000000001ULL, &List);
  if ((List != ((void *) 0)) && (List->Link.ForwardLink != List->Link.BackLink)) {
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x001A, gShellLevel2HiiHandle, L"cp", DestDir);
    ShellStatus = SHELL_INVALID_PARAMETER;
    ShellCloseFileMetaArg (&List);
  } else if (List != ((void *) 0)) {
    do { if (((BOOLEAN)(0==1))) { (void) (((EFI_SHELL_FILE_INFO *)List->Link.ForwardLink) != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
    do { if (((BOOLEAN)(0==1))) { (void) (((EFI_SHELL_FILE_INFO *)List->Link.ForwardLink)->FullName != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
    ...
    StrnCatGrow (&FullName, ((void *) 0), ((EFI_SHELL_FILE_INFO *)List->Link.ForwardLink)->FullName, 0);
    ShellCloseFileMetaArg (&List);
    if ((FileInfo->Attribute & 0x0000000000000001ULL) == 0) {
      ShellStatus = ValidateAndCopyFiles (FileList, FullName, SilentMode, RecursiveMode, ((void *) 0));
    } else {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0083, gShellLevel2HiiHandle, L"cp");
      ShellStatus = SHELL_ACCESS_DENIED;
    }
  } else {
    ShellCloseFileMetaArg (&List);
    ShellStatus = ValidateAndCopyFiles (FileList, DestDir, SilentMode, RecursiveMode, ((void *) 0));
  }

  do { if ((FileInfo) != ((void *) 0)) { FreePool((FileInfo)); (FileInfo) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
  do { if ((FullName) != ((void *) 0)) { FreePool((FullName)); (FullName) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
  return (ShellStatus);
}
  ...
  )
{
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    if ((Status == ((RETURN_STATUS)(0x8000000000000000ULL | (10)))) && (ProblemParam != ((void *) 0))) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0006, gShellLevel2HiiHandle, L"cp", ProblemParam);
    ...
    switch (ParamCount = ShellCommandLineGetCount (Package)) {
      ...
      case 1:
        ...
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0004, gShellLevel2HiiHandle, L"cp");
        ShellStatus = SHELL_INVALID_PARAMETER;
        break;
      case 2:
        ...
        Cwd = ShellGetCurrentDir (((void *) 0));
        if (Cwd == ((void *) 0)) {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0014, gShellLevel2HiiHandle, L"cp");
          ShellStatus = SHELL_INVALID_PARAMETER;
        } else {
          ...
          if ((FileList == ((void *) 0)) || IsListEmpty (&FileList->Link) || (((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0012, gShellLevel2HiiHandle, L"cp", ShellCommandLineGetRawValue (Package, 1));
      ...
      default:
        ...
        for (ParamCount--, LoopCounter = 1; LoopCounter < ParamCount && ShellStatus == SHELL_SUCCESS; LoopCounter++) {
          ...
          if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) || (FileList == ((void *) 0)) || IsListEmpty (&FileList->Link)) {
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0012, gShellLevel2HiiHandle, L"cp", ShellCommandLineGetRawValue (Package, LoopCounter));
            ShellStatus = SHELL_NOT_FOUND;
          }
        }
        ...
        if (ShellStatus != SHELL_SUCCESS) {
          ...
          if ((FileList != ((void *) 0)) && !IsListEmpty (&FileList->Link)) {
            ...
            if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) && (ShellStatus == SHELL_SUCCESS)) {
              ShellPrintHiiEx (-1, -1, ((void *) 0), 0x000B, gShellLevel2HiiHandle, L"cp", ShellCommandLineGetRawValue (Package, ParamCount), ShellStatus|0x8000000000000000ULL);
              ShellStatus = SHELL_ACCESS_DENIED;
            }
          }
        }

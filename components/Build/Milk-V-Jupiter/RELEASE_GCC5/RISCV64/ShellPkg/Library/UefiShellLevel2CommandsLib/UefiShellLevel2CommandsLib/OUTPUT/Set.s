...
.Ltext0:
	...
	.file 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/ShellPkg/Library/UefiShellLevel2CommandsLib/UefiShellLevel2CommandsLib" "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Set.c"
	.section	.text.PrintAllShellEnvVars,"ax",@progbits
	.align	1
	.globl	PrintAllShellEnvVars
	.type	PrintAllShellEnvVars, @function
PrintAllShellEnvVars:
.LFB0:
	.file 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Set.c"
	.loc 1 24 1
	.cfi_startproc
	addi	sp,sp,-32
...
.LVL1:
	...
	call	StrLen@plt
	mv	a5,a0
	.loc 1 36 50 discriminator 1
	addi	a5,a5,1
	.loc 1 36 22 discriminator 1
	slli	a5,a5,1
	ld	a4,-24(s0)
	add	a5,a4,a5
	sd	a5,-24(s0)
...
.L3:
	...
	.cfi_endproc
.LFE0:
	.size	PrintAllShellEnvVars, .-PrintAllShellEnvVars
	.section	.rodata
	.align	3
.LC0:
	.string	"-"
...
.LC1:
	...
	.string	"v"
	.zero	2
	.section	.data.rel.ro.local.SetParamList,"aw"
	.align	3
	.type	SetParamList, @object
	.size	SetParamList, 48
SetParamList:
	.dword	.LC0
	.word	1
	.zero	4
...
.LC4:
	.zero	2
	.section	.text.ShellCommandRunSet,"ax",@progbits
	.align	1
	.globl	ShellCommandRunSet
	.type	ShellCommandRunSet, @function
ShellCommandRunSet:
.LFB1:
	.loc 1 60 1
	.cfi_startproc
	...
	addi	a5,a5,10
	bne	a4,a5,.L8
	.loc 1 88 86 discriminator 1
	ld	a5,-64(s0)
	.loc 1 88 69 discriminator 1
	beq	a5,zero,.L8
	.loc 1 89 7
	la	a5,gShellLevel2HiiHandle
	ld	a4,0(a5)
...
.L10:
	...
	call	ShellCommandLineGetRawValue@plt
	mv	a5,a0
	.loc 1 104 15 discriminator 1
	beq	a5,zero,.L11
	.loc 1 104 78 discriminator 2
	ld	a5,-56(s0)
	lla	a1,.LC0
	mv	a0,a5
	call	ShellCommandLineGetFlag@plt
	mv	a5,a0
	.loc 1 104 75 discriminator 3
	beq	a5,zero,.L11
	.loc 1 105 7
	la	a5,gShellLevel2HiiHandle
	ld	a4,0(a5)
...
.L13:
	...
	call	ShellCommandLineGetFlag@plt
	mv	a5,a0
	.loc 1 116 18 is_stmt 0 discriminator 1
	mv	a2,a5
	lla	a1,.LC4
	ld	a0,-40(s0)
	call	ShellSetEnvironmentVariable@plt
	sd	a0,-32(s0)
	.loc 1 117 40 is_stmt 1
	ld	a5,-32(s0)
	.loc 1 117 12
	bge	a5,zero,.L8
	.loc 1 118 11
...
.L12:
	...
	call	ShellCommandLineGetRawValue@plt
	mv	a5,a0
	.loc 1 122 15 discriminator 1
	bne	a5,zero,.L14
	.loc 1 126 15
	call	PrintAllShellEnvVars
	mv	a5,a0
	j	.L18
.L14:
	.loc 1 131 17
	...
	call	ShellCommandLineGetFlag@plt
	mv	a5,a0
	.loc 1 137 18 is_stmt 0 discriminator 1
	mv	a2,a5
	ld	a1,-48(s0)
	ld	a0,-40(s0)
	call	ShellSetEnvironmentVariable@plt
...
.L18:
	...
	.cfi_endproc
.LFE1:
	.size	ShellCommandRunSet, .-ShellCommandRunSet
	.text
.Letext0:
...
.LASF0:
	.string	"/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellLevel2CommandsLib/Set.c"

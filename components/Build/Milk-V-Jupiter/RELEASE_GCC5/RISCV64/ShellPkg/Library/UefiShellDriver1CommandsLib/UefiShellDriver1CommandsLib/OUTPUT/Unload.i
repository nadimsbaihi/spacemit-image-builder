# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDriver1CommandsLib/Unload.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDriver1CommandsLib/Unload.c"
# 10 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDriver1CommandsLib/Unload.c"
...
# 11 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDriver1CommandsLib/Unload.c" 2
# 20 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDriver1CommandsLib/Unload.c"
EFI_STATUS
  ...
  )
{
  ...
  TheString = GetProtocolInformationDump (TheHandle, &gEfiLoadedImageProtocolGuid, ((BOOLEAN)(1==1)));
  if (TheString == ((void *) 0)) {
  ...
  do { if ((TheString) != ((void *) 0)) { FreePool((TheString)); (TheString) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
  ...
  )
{
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    if ((Status == ((RETURN_STATUS)(0x8000000000000000ULL | (10)))) && (ProblemParam != ((void *) 0))) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0002, gShellDriver1HiiHandle, L"unload", ProblemParam);
    ...
    if (ShellCommandLineGetCount (Package) > 2) {
      ...
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0006, gShellDriver1HiiHandle, L"unload");
      ShellStatus = SHELL_INVALID_PARAMETER;
    } else if (ShellCommandLineGetCount (Package) < 2) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0005, gShellDriver1HiiHandle, L"unload");
      ShellStatus = SHELL_INVALID_PARAMETER;
    } else {
      Param1 = ShellCommandLineGetRawValue (Package, 1);
      if (Param1 != ((void *) 0)) {
        Status = ShellConvertStringToUint64 (Param1, &Value, ((BOOLEAN)(1==1)), ((BOOLEAN)(0==1)));
        TheHandle = ConvertHandleIndexToHandle ((UINTN)Value);
      }

      if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) || (Param1 == ((void *) 0)) || (TheHandle == ((void *) 0))) {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0007, gShellDriver1HiiHandle, L"unload", Param1);
        ShellStatus = SHELL_INVALID_PARAMETER;
      } else {
        ...
        if (!ShellCommandLineGetFlag (Package, L"-n")) {
          Status = ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0052, gShellDriver1HiiHandle, (UINTN)TheHandle);
          Status = ShellPromptForResponse (ShellPromptResponseTypeYesNo, ((void *) 0), (void **)&Resp);
        }

        if (ShellCommandLineGetFlag (Package, L"-n") || ((Resp != ((void *) 0)) && (*Resp == ShellPromptResponseYes))) {
          Status = gBS->UnloadImage (TheHandle);
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0018, gShellDriver1HiiHandle, L"Unload", (UINTN)TheHandle, Status);
        }

        do { if ((Resp) != ((void *) 0)) { FreePool((Resp)); (Resp) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
      }
    }
  }

# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDriver1CommandsLib/Devices.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDriver1CommandsLib/Devices.c"
# 10 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDriver1CommandsLib/Devices.c"
...
# 11 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDriver1CommandsLib/Devices.c" 2
# 38 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDriver1CommandsLib/Devices.c"
EFI_STATUS
GetDeviceHandleInfo (
  ...
  )
{
  ...
  *Name = 0x0000;
  ...
  gEfiShellProtocol->GetDeviceName (TheHandle, 0x00000001|0x00000002, (CHAR8 *)Language, Name);

  Status = ParseHandleDatabaseForChildControllers (TheHandle, Children, ((void *) 0));

  Status = ParseHandleDatabaseByRelationship(((void *) 0), TheHandle, 0x00000200, Parents, ((void *) 0));
  if ( (Parents != ((void *) 0)) && (Children != ((void *) 0))) {
    if (*Parents == 0) {
      *Type = L'R';
    } else if (*Children > 0) {
      *Type = L'B';
  ...
  Status = ParseHandleDatabaseByRelationship(((void *) 0), TheHandle, 0x00000004|0x00000008, Devices, &HandleBuffer);
  if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) && (Devices != ((void *) 0)) && (HandleBuffer != ((void *) 0))) {
    for (Count = 0; Count < *Devices; Count++) {
      if (!(((RETURN_STATUS)(gBS->OpenProtocol (HandleBuffer[Count], &gEfiDriverConfigurationProtocolGuid, ((void *) 0), ((void *) 0), gImageHandle, 0x00000004))) >= 0x8000000000000000ULL)) {
        *Cfg = ((BOOLEAN)(1==1));
      }

      if (!(((RETURN_STATUS)(gBS->OpenProtocol (HandleBuffer[Count], &gEfiDriverDiagnosticsProtocolGuid, ((void *) 0), ((void *) 0), gImageHandle, 0x00000004))) >= 0x8000000000000000ULL)) {
        *Diag = ((BOOLEAN)(1==1));
      }

      if (!(((RETURN_STATUS)(gBS->OpenProtocol (HandleBuffer[Count], &gEfiDriverDiagnostics2ProtocolGuid, ((void *) 0), ((void *) 0), gImageHandle, 0x00000004))) >= 0x8000000000000000ULL)) {
        *Diag = ((BOOLEAN)(1==1));
      }
    }
  ...
  )
{
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    if ((Status == ((RETURN_STATUS)(0x8000000000000000ULL | (10)))) && (ProblemParam != ((void *) 0))) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0002, gShellDriver1HiiHandle, L"devices", ProblemParam);
    ...
    if (ShellCommandLineGetRawValue (Package, 1) != ((void *) 0)) {



      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0006, gShellDriver1HiiHandle, L"devices");
      ShellStatus = SHELL_INVALID_PARAMETER;
    } else {
      ...
      if (Lang != ((void *) 0)) {
        ...
        if (Language == ((void *) 0)) {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0012, gShellDriver1HiiHandle, L"devices");
        ...
        do { if (((BOOLEAN)(0==1))) { (void) (Language == ((void *) 0)); } } while (((BOOLEAN)(0==1)));
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0009, gShellDriver1HiiHandle, L"devices", L"-l");
        ShellCommandLineFreeVarList (Package);
      ...
      if (ShellCommandLineGetFlag (Package, L"-sfo")) {
        ShellPrintHiiEx (-1, -1, Language, 0x0014, gShellDriver1HiiHandle, L"devices");
        SfoFlag = ((BOOLEAN)(1==1));
      } else {
        ShellPrintHiiEx (-1, -1, Language, 0x0032, gShellDriver1HiiHandle);
      }




      HandleList = GetHandleListByProtocol (((void *) 0));
      do { if (((BOOLEAN)(0==1))) { (void) (HandleList != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
      for (HandleListWalker = HandleList
           ; HandleListWalker != ((void *) 0) && *HandleListWalker != ((void *) 0)
           ; HandleListWalker++
           )
      {
        ...
        if ((Name != ((void *) 0)) && ((Parents != 0) || (Devices != 0) || (Children != 0))) {
          ShellPrintHiiEx (
            -1,
            -1,
            Language,
            SfoFlag ? 0x0034 : 0x0033,

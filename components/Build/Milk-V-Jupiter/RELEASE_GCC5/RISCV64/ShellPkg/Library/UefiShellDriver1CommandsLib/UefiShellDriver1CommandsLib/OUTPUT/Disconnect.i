# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDriver1CommandsLib/Disconnect.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDriver1CommandsLib/Disconnect.c"
# 11 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDriver1CommandsLib/Disconnect.c"
...
# 12 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDriver1CommandsLib/Disconnect.c" 2
...
{
# 40 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDriver1CommandsLib/Disconnect.c"
  EFI_STATUS Status;
  ...
  )
{
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    if ((Status == ((RETURN_STATUS)(0x8000000000000000ULL | (10)))) && (ProblemParam != ((void *) 0))) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0002, gShellDriver1HiiHandle, L"disconnect", ProblemParam);
    ...
    if (ShellCommandLineGetFlag (Package, L"-r")) {
      if (ShellCommandLineGetCount (Package) > 1) {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0006, gShellDriver1HiiHandle, L"disconnect");
        ShellStatus = SHELL_INVALID_PARAMETER;
      } else if (ShellCommandLineGetCount (Package) < 1) {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0005, gShellDriver1HiiHandle, L"disconnect");
        ShellStatus = SHELL_INVALID_PARAMETER;
      } else {
      ...
      if (ShellCommandLineGetCount (Package) > 4) {
        ...
        if (Param1 && !(((RETURN_STATUS)(ShellConvertStringToUint64 (Param1, &Intermediate1, ((BOOLEAN)(1==1)), ((BOOLEAN)(0==1))))) >= 0x8000000000000000ULL)) {
          Handle1 = ConvertHandleIndexToHandle ((UINTN)Intermediate1);
        } else {
          Handle1 = ((void *) 0);
        }

        if (Param2 && !(((RETURN_STATUS)(ShellConvertStringToUint64 (Param2, &Intermediate2, ((BOOLEAN)(1==1)), ((BOOLEAN)(0==1))))) >= 0x8000000000000000ULL)) {
          Handle2 = ConvertHandleIndexToHandle ((UINTN)Intermediate2);
        } else {
          Handle2 = ((void *) 0);
        }

        if (Param3 && !(((RETURN_STATUS)(ShellConvertStringToUint64 (Param3, &Intermediate3, ((BOOLEAN)(1==1)), ((BOOLEAN)(0==1))))) >= 0x8000000000000000ULL)) {
        ...
        if ((Param1 != ((void *) 0)) && (Handle1 == ((void *) 0))) {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0007, gShellDriver1HiiHandle, L"disconnect", Param1);
          ShellStatus = SHELL_INVALID_PARAMETER;
        } else if ((Param2 != ((void *) 0)) && (Handle2 == ((void *) 0))) {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0007, gShellDriver1HiiHandle, L"disconnect", Param2);
          ShellStatus = SHELL_INVALID_PARAMETER;
        } else if ((Param3 != ((void *) 0)) && (Handle3 == ((void *) 0))) {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0007, gShellDriver1HiiHandle, L"disconnect", Param3);
          ShellStatus = SHELL_INVALID_PARAMETER;
        } else if ((Handle2 != ((void *) 0)) && (((RETURN_STATUS)(gBS->OpenProtocol (Handle2, &gEfiDriverBindingProtocolGuid, ((void *) 0), gImageHandle, ((void *) 0), 0x00000004))) >= 0x8000000000000000ULL)) {
          do { if (((BOOLEAN)(0==1))) { (void) (Param2 != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x000A, gShellDriver1HiiHandle, L"disconnect", ShellStrToUintn (Param2), L"driver handle");
          ShellStatus = SHELL_INVALID_PARAMETER;
        } else {
          do { if (((BOOLEAN)(0==1))) { (void) (Param1 != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
          Status = gBS->DisconnectController (Handle1, Handle2, Handle3);
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0019, gShellDriver1HiiHandle, L"Disconnect", (UINTN)Intermediate1, (UINTN)Intermediate2, (UINTN)Intermediate3, Status);
        }
      }
    }
  }

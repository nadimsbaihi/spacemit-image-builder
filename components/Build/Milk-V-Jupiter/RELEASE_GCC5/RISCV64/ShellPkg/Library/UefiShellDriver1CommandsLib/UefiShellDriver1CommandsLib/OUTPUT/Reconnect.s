...
.Ltext0:
	...
	.file 0 "/home/kapoagaeming/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/ShellPkg/Library/UefiShellDriver1CommandsLib/UefiShellDriver1CommandsLib" "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDriver1CommandsLib/Reconnect.c"
	.section	.rodata
	.align	3
.LC0:
	.string	"-"
...
.LC6:
	...
	.string	"t"
	.zero	2
	.section	.text.ConnectAllConsoles,"ax",@progbits
	.align	1
	.globl	ConnectAllConsoles
	.type	ConnectAllConsoles, @function
ConnectAllConsoles:
.LFB0:
	.file 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDriver1CommandsLib/Reconnect.c"
	.loc 1 26 1
	.cfi_startproc
	addi	sp,sp,-16
	...
	.cfi_endproc
.LFE0:
	.size	ConnectAllConsoles, .-ConnectAllConsoles
	.section	.rodata
	.align	3
.LC7:
	.string	"r"
	...
	.string	"t"
	.zero	2
	.section	.text.ShellCommandRunReconnect,"ax",@progbits
	.align	1
	.globl	ShellCommandRunReconnect
	.type	ShellCommandRunReconnect, @function
...
.L3:
	...
	ld	a1,-64(s0)
	ld	a0,-56(s0)
	call	ShellCommandRunDisconnect@plt
	mv	a5,a0
	sw	a5,-20(s0)
	.loc 1 80 8
	lw	a5,-20(s0)
	...
	beq	a5,zero,.L5
	.loc 1 82 9
	call	ConnectAllConsoles
.L5:
	.loc 1 85 21
	ld	a1,-64(s0)
	ld	a0,-56(s0)
	call	ShellCommandRunConnect@plt
	mv	a5,a0
	sw	a5,-20(s0)
.L4:
	.loc 1 89 16
	...
	.cfi_endproc
.LFE1:
	.size	ShellCommandRunReconnect, .-ShellCommandRunReconnect
	.text
.Letext0:
...
.LASF0:
	.string	"/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDriver1CommandsLib/Reconnect.c"

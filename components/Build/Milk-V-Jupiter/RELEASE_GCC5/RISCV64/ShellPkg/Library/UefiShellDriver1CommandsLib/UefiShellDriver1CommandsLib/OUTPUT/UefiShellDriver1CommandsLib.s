	.file	"UefiShellDriver1CommandsLib.c"
	.option pic
	.option norelax
...
mFileName:
	...
	.string	"s"
	.zero	2
	.globl	gShellDriver1HiiHandle
	.section	.bss.gShellDriver1HiiHandle,"aw",@nobits
	.align	3
	.type	gShellDriver1HiiHandle, @object
	.size	gShellDriver1HiiHandle, 8
gShellDriver1HiiHandle:
	.zero	8
	.globl	gInReconnect
	.section	.bss.gInReconnect,"aw",@nobits
	.type	gInReconnect, @object
	.size	gInReconnect, 1
gInReconnect:
	.zero	1
	.section	.text.ShellCommandGetManFileNameDriver1,"ax",@progbits
	.align	1
	.globl	ShellCommandGetManFileNameDriver1
	.type	ShellCommandGetManFileNameDriver1, @function
ShellCommandGetManFileNameDriver1:
.LFB0:
	.file 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDriver1CommandsLib/UefiShellDriver1CommandsLib.c"
	.loc 1 25 1
	.cfi_startproc
	addi	sp,sp,-16
	...
	.cfi_endproc
.LFE0:
	.size	ShellCommandGetManFileNameDriver1, .-ShellCommandGetManFileNameDriver1
	.section	.rodata
	.align	3
.LC0:
	.string	"D"
...
.LC11:
	...
	.string	"g"
	.zero	2
	.section	.text.UefiShellDriver1CommandsLibConstructor,"ax",@progbits
	.align	1
	.globl	UefiShellDriver1CommandsLibConstructor
	.type	UefiShellDriver1CommandsLibConstructor, @function
...
.L4:
	...
	ld	a5,0(a5)
	li	a3,0
	la	a2,UefiShellDriver1CommandsLibStrings
	mv	a1,a5
	la	a0,gShellDriver1HiiGuid
	call	HiiAddPackages@plt
	mv	a4,a0
	.loc 1 55 26 discriminator 1
	lla	a5,gShellDriver1HiiHandle
	sd	a4,0(a5)
	.loc 1 56 30
	lla	a5,gShellDriver1HiiHandle
	ld	a5,0(a5)
...
.L6:
	...
	lla	a4,.LC0
	li	a3,0
	lla	a2,ShellCommandGetManFileNameDriver1
	la	a1,ShellCommandRunConnect
	lla	a0,.LC1
	...
	li	a3,0
	lla	a2,ShellCommandGetManFileNameDriver1
	la	a1,ShellCommandRunDisconnect
	lla	a0,.LC4
	call	ShellCommandRegisterCommandName@plt
	.loc 1 67 3
	lla	a5,gShellDriver1HiiHandle
	...
	li	a3,0
	lla	a2,ShellCommandGetManFileNameDriver1
	la	a1,ShellCommandRunReconnect
	lla	a0,.LC5
	call	ShellCommandRegisterCommandName@plt
	.loc 1 68 3
	lla	a5,gShellDriver1HiiHandle
...
.L5:
	...
	.cfi_endproc
.LFE1:
	.size	UefiShellDriver1CommandsLibConstructor, .-UefiShellDriver1CommandsLibConstructor
	.section	.text.UefiShellDriver1CommandsLibDestructor,"ax",@progbits
	.align	1
	.globl	UefiShellDriver1CommandsLibDestructor
	.type	UefiShellDriver1CommandsLibDestructor, @function
...
.L8:
	...
	.cfi_endproc
.LFE2:
	.size	UefiShellDriver1CommandsLibDestructor, .-UefiShellDriver1CommandsLibDestructor
	.text
.Letext0:
	...
	.file 12 "/home/kapoagaeming/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/ShellPkg/Library/UefiShellDriver1CommandsLib/UefiShellDriver1CommandsLib/DEBUG/UefiShellDriver1CommandsLibStrDefs.h"
...
.LASF39:
	.string	"Nanosecond"
.LASF322:
	.string	"ShellCommandRunReconnect"
.LASF148:
...
.LASF138:
	.string	"TimerCancel"
.LASF336:
	.string	"ShellCommandGetManFileNameDriver1"
.LASF276:
	.string	"StdErr"
.LASF200:
	.string	"CapsuleGuid"
...
.LASF0:
	.string	"/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDriver1CommandsLib/UefiShellDriver1CommandsLib.c"
.LASF1:

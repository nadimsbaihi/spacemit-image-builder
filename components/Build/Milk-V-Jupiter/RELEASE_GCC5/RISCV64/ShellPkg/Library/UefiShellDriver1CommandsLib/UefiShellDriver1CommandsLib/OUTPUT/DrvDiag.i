# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDriver1CommandsLib/DrvDiag.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDriver1CommandsLib/DrvDiag.c"
# 10 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDriver1CommandsLib/DrvDiag.c"
...
# 11 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDriver1CommandsLib/DrvDiag.c" 2

static const EFI_GUID *DiagGuidList[] = { &gEfiDriverDiagnosticsProtocolGuid, &gEfiDriverDiagnostics2ProtocolGuid, ((void *) 0) };
...
# 38 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDriver1CommandsLib/DrvDiag.c"
EFI_STATUS
DoDiagnostics (
  const DRV_DIAG_TEST_MODE Mode,
  const CHAR8 *Lang,
  const BOOLEAN AllChilds,
  const EFI_HANDLE DriverHandle,
  const EFI_HANDLE ControllerHandle,
  const EFI_HANDLE ChildHandle
  )
{
  ...
  if (((ChildHandle != ((void *) 0)) && AllChilds) || (Mode >= TestModeMax)) {
    return (((RETURN_STATUS)(0x8000000000000000ULL | (2))));
  }

  DriverDiagnostics = ((void *) 0);
  DriverDiagnostics2 = ((void *) 0);
  Status = (RETURN_STATUS)(0);
  Status2 = (RETURN_STATUS)(0);
  DriverHandleList = ((void *) 0);
  ControllerHandleList = ((void *) 0);
  ChildHandleList = ((void *) 0);
  Language = ((void *) 0);
  OutBuffer = ((void *) 0);
  ErrorType = ((void *) 0);
  ...
  if (DriverHandle != ((void *) 0)) {
    ...
    if (DriverHandleList == ((void *) 0)) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x000C, gShellDriver1HiiHandle, L"drvdiag", L"gEfiDriverDiagnosticsProtocolGuid", &gEfiDriverDiagnosticsProtocolGuid);
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x000C, gShellDriver1HiiHandle, L"drvdiag", L"gEfiDriverDiagnostics2ProtocolGuid", &gEfiDriverDiagnostics2ProtocolGuid);
      return (((RETURN_STATUS)(0x8000000000000000ULL | (14))));
    }

    for (Walker = DriverHandleList; Walker != ((void *) 0) && *Walker != ((void *) 0); DriverHandleListCount++, Walker++) {
    }
  }

  if (ControllerHandle != ((void *) 0)) {
    ControllerHandleList = AllocateZeroPool (2*sizeof (EFI_HANDLE));
    if (ControllerHandleList == ((void *) 0)) {
      Status2 = ((RETURN_STATUS)(0x8000000000000000ULL | (9)));
      goto Done;
    }
  ...
  if (Mode == TestModeList) {
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0015, gShellDriver1HiiHandle);
  }
  ...
  {
    if (Mode == TestModeList) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0016, gShellDriver1HiiHandle, ConvertHandleToHandleIndex (DriverHandleList[DriverHandleListLoop]));
    }

    if (ControllerHandle == ((void *) 0)) {
      ParseHandleDatabaseByRelationship(DriverHandleList[DriverHandleListLoop], ((void *) 0), 0x00000400|0x00000100, &ControllerHandleListCount, &ControllerHandleList);
    }

    if ((ControllerHandleListCount == 0) || (ControllerHandleList == ((void *) 0))) {
      if (Mode == TestModeList) {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0017, gShellDriver1HiiHandle);
      }
    } else {
      if (Mode == TestModeList) {
        ShellPrintEx (-1, -1, L"\r\n");
      ...
      {
        if (AllChilds) {
          do { if (((BOOLEAN)(0==1))) { (void) (ChildHandleList == ((void *) 0)); } } while (((BOOLEAN)(0==1)));
          ParseHandleDatabaseByRelationship(DriverHandleList[DriverHandleListLoop], ControllerHandleList[ControllerHandleListLoop], 0x00000800|0x00000100, &ChildHandleListCount, &ChildHandleList)
        ...
        for (ChildHandleListLoop = 0
             ; (ChildHandleListLoop < ChildHandleListCount || ChildHandleList == ((void *) 0))
             ; ChildHandleListLoop++
             )
        {
          Found = ((BOOLEAN)(0==1));
          if (Mode != TestModeList) {
            if ((Lang == ((void *) 0)) || (Lang[2] == '-')) {
              ...
              if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) && (DriverDiagnostics2 != ((void *) 0))) {
                Language = GetBestLanguageForDriver (DriverDiagnostics2->SupportedLanguages, Lang, ((BOOLEAN)(0==1)));
                if (Language == ((void *) 0)) {
                  Status2 = ((RETURN_STATUS)(0x8000000000000000ULL | (14)));
                  goto Done;
                }
                ...
                Status = DriverDiagnostics2->RunDiagnostics (
                                               ...
                                               ChildHandleList == ((void *) 0) ? ((void *) 0) : ChildHandleList[ChildHandleListLoop],
            ...
            if (!Found && ((Lang == ((void *) 0)) || ((Lang != ((void *) 0)) && (Lang[2] != '-')))) {
              Status = gBS->OpenProtocol (
                              DriverHandleList[DriverHandleListLoop],
              ...
              if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
                Language = GetBestLanguageForDriver (DriverDiagnostics->SupportedLanguages, Lang, ((BOOLEAN)(0==1)));
                if (Language == ((void *) 0)) {
                  Status2 = ((RETURN_STATUS)(0x8000000000000000ULL | (14)));
                  goto Done;
                }
            ...
            ShellPrintHiiEx (
              ...
              HandleIndex1,
              HandleIndex2,
              ChildHandleList == ((void *) 0) ? 0 : ConvertHandleToHandleIndex (ChildHandleList[ChildHandleListLoop]),
              Status
              );
            if (OutBuffer != ((void *) 0)) {
              FreePool (OutBuffer);
        ...
        if (AllChilds) {
          do { if ((ChildHandleList) != ((void *) 0)) { FreePool((ChildHandleList)); (ChildHandleList) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
          ChildHandleList = ((void *) 0);
          ChildHandleListCount = 0;
        }
      }
      ...
      if (ControllerHandle == ((void *) 0)) {
        do { if ((ControllerHandleList) != ((void *) 0)) { FreePool((ControllerHandleList)); (ControllerHandleList) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
        ControllerHandleList = ((void *) 0);
        ControllerHandleListCount = 0;
      }
    }
...
Done:
  ...
  do { if ((DriverHandleList) != ((void *) 0)) { FreePool((DriverHandleList)); (DriverHandleList) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
  do { if ((ControllerHandleList) != ((void *) 0)) { FreePool((ControllerHandleList)); (ControllerHandleList) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
  do { if ((ChildHandleList) != ((void *) 0)) { FreePool((ChildHandleList)); (ChildHandleList) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
  do { if ((Language) != ((void *) 0)) { FreePool((Language)); (Language) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
  do { if ((OutBuffer) != ((void *) 0)) { FreePool((OutBuffer)); (OutBuffer) = ((void *) 0); } } while(((BOOLEAN)(0==1)));
  ...
  )
{
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    if ((Status == ((RETURN_STATUS)(0x8000000000000000ULL | (10)))) && (ProblemParam != ((void *) 0))) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0002, gShellDriver1HiiHandle, L"drvdiag", ProblemParam);
          ...
          )
    {
      ...
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0006, gShellDriver1HiiHandle, L"drvdiag");
      ShellStatus = SHELL_INVALID_PARAMETER;
    ...
    if (ShellCommandLineGetFlag (Package, L"-l") && (Lang == ((void *) 0))) {
      do { if (((BOOLEAN)(0==1))) { (void) (Language == ((void *) 0)); } } while (((BOOLEAN)(0==1)));
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0009, gShellDriver1HiiHandle, L"drvdiag", L"-l");
      ShellCommandLineFreeVarList (Package);
      return (SHELL_INVALID_PARAMETER);
    } else if (Lang != ((void *) 0)) {
      Language = AllocateZeroPool (StrSize (Lang));
      if (Language == ((void *) 0)) {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0012, gShellDriver1HiiHandle, L"drvdiag");
        ShellCommandLineFreeVarList (Package);
    ...
    if ((DriverHandleStr != ((void *) 0)) && !(((RETURN_STATUS)(ShellConvertStringToUint64 (DriverHandleStr, &Intermediate, ((BOOLEAN)(1==1)), ((BOOLEAN)(0==1))))) >= 0x8000000000000000ULL)) {
      Handle1 = ConvertHandleIndexToHandle ((UINTN)Intermediate);
    } else {
      Handle1 = ((void *) 0);
    }

    if ((ControllerHandleStr != ((void *) 0)) && !(((RETURN_STATUS)(ShellConvertStringToUint64 (ControllerHandleStr, &Intermediate, ((BOOLEAN)(1==1)), ((BOOLEAN)(0==1))))) >= 0x8000000000000000ULL)) {
      Handle2 = ConvertHandleIndexToHandle ((UINTN)Intermediate);
    } else {
      Handle2 = ((void *) 0);
    }

    if ((ChildHandleStr != ((void *) 0)) && !(((RETURN_STATUS)(ShellConvertStringToUint64 (ChildHandleStr, &Intermediate, ((BOOLEAN)(1==1)), ((BOOLEAN)(0==1))))) >= 0x8000000000000000ULL)) {
  ...
  if (ShellStatus == SHELL_SUCCESS) {
    ...
    } else if (Status == ((RETURN_STATUS)(0x8000000000000000ULL | (2)))) {
      ShellStatus = SHELL_INVALID_PARAMETER;

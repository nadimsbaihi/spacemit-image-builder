# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDriver1CommandsLib/UefiShellDriver1CommandsLib.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDriver1CommandsLib/UefiShellDriver1CommandsLib.c"
# 9 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDriver1CommandsLib/UefiShellDriver1CommandsLib.c"
...
# 10 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDriver1CommandsLib/UefiShellDriver1CommandsLib.c" 2

static const CHAR16 mFileName[] = L"Driver1Commands";
EFI_HII_HANDLE gShellDriver1HiiHandle = ((void *) 0);
BOOLEAN gInReconnect = ((BOOLEAN)(0==1));
...
# 38 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDriver1CommandsLib/UefiShellDriver1CommandsLib.c"
EFI_STATUS
  ...
  )
{
  ...
  if ((_gPcd_FixedAtBuild_PcdShellProfileMask & 0x00000001) == 0) {
  ...
  gShellDriver1HiiHandle = HiiAddPackages (&gShellDriver1HiiGuid, gImageHandle, UefiShellDriver1CommandsLibStrings, ((void *) 0));
  if (gShellDriver1HiiHandle == ((void *) 0)) {
  ...
  ShellCommandRegisterCommandName (L"connect", ShellCommandRunConnect, ShellCommandGetManFileNameDriver1, 0, L"Driver1", ((BOOLEAN)(1==1)), gShellDriver1HiiHandle, 0x005D);
  ShellCommandRegisterCommandName (L"devices", ShellCommandRunDevices, ShellCommandGetManFileNameDriver1, 0, L"Driver1", ((BOOLEAN)(1==1)), gShellDriver1HiiHandle, 0x005C);
  ShellCommandRegisterCommandName (L"openinfo", ShellCommandRunOpenInfo, ShellCommandGetManFileNameDriver1, 0, L"Driver1", ((BOOLEAN)(1==1)), gShellDriver1HiiHandle, 0x005E);
  ShellCommandRegisterCommandName (L"disconnect", ShellCommandRunDisconnect, ShellCommandGetManFileNameDriver1, 0, L"Driver1", ((BOOLEAN)(1==1)), gShellDriver1HiiHandle, 0x0059);
  ShellCommandRegisterCommandName (L"reconnect", ShellCommandRunReconnect, ShellCommandGetManFileNameDriver1, 0, L"Driver1", ((BOOLEAN)(1==1)), gShellDriver1HiiHandle, 0x0060);
  ShellCommandRegisterCommandName (L"unload", ShellCommandRunUnload, ShellCommandGetManFileNameDriver1, 0, L"Driver1", ((BOOLEAN)(1==1)), gShellDriver1HiiHandle, 0x0061);
  ShellCommandRegisterCommandName (L"drvdiag", ShellCommandRunDrvDiag, ShellCommandGetManFileNameDriver1, 0, L"Driver1", ((BOOLEAN)(1==1)), gShellDriver1HiiHandle, 0x005F);
  ShellCommandRegisterCommandName (L"dh", ShellCommandRunDh, ShellCommandGetManFileNameDriver1, 0, L"Driver1", ((BOOLEAN)(1==1)), gShellDriver1HiiHandle, 0x005A);
  ShellCommandRegisterCommandName (L"drivers", ShellCommandRunDrivers, ShellCommandGetManFileNameDriver1, 0, L"Driver1", ((BOOLEAN)(1==1)), gShellDriver1HiiHandle, 0x0058);
  ShellCommandRegisterCommandName (L"devtree", ShellCommandRunDevTree, ShellCommandGetManFileNameDriver1, 0, L"Driver1", ((BOOLEAN)(1==1)), gShellDriver1HiiHandle, 0x005B);
  ShellCommandRegisterCommandName (L"drvcfg", ShellCommandRunDrvCfg, ShellCommandGetManFileNameDriver1, 0, L"Driver1", ((BOOLEAN)(1==1)), gShellDriver1HiiHandle, 0x0057);

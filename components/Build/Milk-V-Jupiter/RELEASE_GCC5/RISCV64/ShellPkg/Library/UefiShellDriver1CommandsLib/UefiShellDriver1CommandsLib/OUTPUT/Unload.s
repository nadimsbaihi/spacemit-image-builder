...
.Ltext0:
	...
	.file 0 "/home/kapoagaeming/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/ShellPkg/Library/UefiShellDriver1CommandsLib/UefiShellDriver1CommandsLib" "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDriver1CommandsLib/Unload.c"
	.section	.rodata
	.align	3
.LC0:
	.string	"%"
	.string	"s"
	.zero	2
	.section	.text.DumpLoadedImageProtocolInfo,"ax",@progbits
	.align	1
	.globl	DumpLoadedImageProtocolInfo
	.type	DumpLoadedImageProtocolInfo, @function
DumpLoadedImageProtocolInfo:
.LFB0:
	.file 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDriver1CommandsLib/Unload.c"
	.loc 1 24 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L3:
	...
	.cfi_endproc
.LFE0:
	.size	DumpLoadedImageProtocolInfo, .-DumpLoadedImageProtocolInfo
	.section	.rodata
	.align	3
.LC1:
	.string	"-"
...
.LC5:
	...
	.string	"d"
	.zero	2
	.section	.text.ShellCommandRunUnload,"ax",@progbits
	.align	1
	.globl	ShellCommandRunUnload
	.type	ShellCommandRunUnload, @function
...
.L10:
	...
	.loc 1 109 10
	blt	a5,zero,.L11
	.loc 1 109 64 discriminator 1
	ld	a5,-48(s0)
	beq	a5,zero,.L11
	.loc 1 109 92 discriminator 2
	ld	a5,-40(s0)
	bne	a5,zero,.L12
.L11:
	.loc 1 110 9
...
.L12:
	...
	bne	a5,zero,.L13
	.loc 1 114 57 discriminator 2
	ld	a5,-56(s0)
	lla	a1,.LC3
	mv	a0,a5
	call	ShellCommandLineGetFlag@plt
	mv	a5,a0
	.loc 1 114 54 discriminator 3
	beq	a5,zero,.L14
.L13:
	.loc 1 115 11
	ld	a0,-40(s0)
	call	DumpLoadedImageProtocolInfo
.L14:
	.loc 1 118 14
	ld	a5,-56(s0)
	lla	a1,.LC1
...
.L15:
	...
	bne	a5,zero,.L16
	.loc 1 123 64 discriminator 2
	ld	a5,-72(s0)
	.loc 1 123 54 discriminator 2
	beq	a5,zero,.L17
	.loc 1 123 85 discriminator 3
	ld	a5,-72(s0)
	lw	a5,0(a5)
...
.L21:
	...
	.cfi_endproc
.LFE1:
	.size	ShellCommandRunUnload, .-ShellCommandRunUnload
	.text
.Letext0:
	...
	.file 14 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDriver1CommandsLib/UefiShellDriver1CommandsLib.h"
	.file 15 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Include/Library/HandleParsingLib.h"
...
.LASF356:
	.string	"ParamList"
.LASF369:
	.string	"DumpLoadedImageProtocolInfo"
.LASF266:
...
.LASF0:
	.string	"/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDriver1CommandsLib/Unload.c"
.LASF1:

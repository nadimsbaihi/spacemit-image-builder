# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDriver1CommandsLib/DevTree.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDriver1CommandsLib/DevTree.c"
# 10 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDriver1CommandsLib/DevTree.c"
...
# 11 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDriver1CommandsLib/DevTree.c" 2
...
# 30 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDriver1CommandsLib/DevTree.c"
SHELL_STATUS
DoDevTreeForHandle (
  const EFI_HANDLE TheHandle,
  const CHAR8 *Lang ,
  const BOOLEAN UseDevPaths,
  const UINTN IndentCharCount,
  const CHAR16 *HiiString
  )
{
  ...
  Name = ((void *) 0);
  ChildHandleBuffer = ((void *) 0);
  ChildCount = 0;

  do { if (((BOOLEAN)(0==1))) { (void) (TheHandle != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { (void) (HiiString != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
  ...
  gEfiShellProtocol->GetDeviceName ((EFI_HANDLE)TheHandle, !UseDevPaths ? 0x00000001|0x00000002 : 0x00000002, (CHAR8 *)Lang, &Name);
  ...
  )
{
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    if ((Status == ((RETURN_STATUS)(0x8000000000000000ULL | (10)))) && (ProblemParam != ((void *) 0))) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0002, gShellDriver1HiiHandle, L"devtree", ProblemParam);
    ...
    if (ShellCommandLineGetCount (Package) > 2) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0006, gShellDriver1HiiHandle, L"devtree");
    ...
    if (Lang != ((void *) 0)) {
      ...
      if (Language == ((void *) 0)) {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0012, gShellDriver1HiiHandle, L"devtree");
        ShellCommandLineFreeVarList (Package);
        return (SHELL_OUT_OF_RESOURCES);
      }
      ...
      do { if (((BOOLEAN)(0==1))) { (void) (Language == ((void *) 0)); } } while (((BOOLEAN)(0==1)));
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0009, gShellDriver1HiiHandle, L"devtree", L"-l");
      ShellCommandLineFreeVarList (Package);
      return (SHELL_INVALID_PARAMETER);
    }
    ...
    HiiString = HiiGetString (gShellDriver1HiiHandle, 0x0051, Language);
    ...
    if (Lang == ((void *) 0)) {
      for (LoopVar = 1; ; LoopVar++) {
        ...
        Status = ParseHandleDatabaseByRelationship(((void *) 0), TheHandle, 0x00000200, &ParentControllerHandleCount, &ParentControllerHandleBuffer)
      ...
      Status = ShellConvertStringToUint64 (Lang, &Intermediate, ((BOOLEAN)(1==1)), ((BOOLEAN)(0==1)));
      if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) || (ConvertHandleIndexToHandle ((UINTN)Intermediate) == ((void *) 0))) {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0007, gShellDriver1HiiHandle, L"devtree", Lang);
        ShellStatus = SHELL_INVALID_PARAMETER;
      } else {

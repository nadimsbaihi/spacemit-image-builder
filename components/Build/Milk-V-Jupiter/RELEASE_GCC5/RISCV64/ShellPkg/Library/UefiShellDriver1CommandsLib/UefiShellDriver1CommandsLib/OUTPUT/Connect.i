# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDriver1CommandsLib/Connect.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDriver1CommandsLib/Connect.c"
# 10 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDriver1CommandsLib/Connect.c"
...
# 11 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDriver1CommandsLib/Connect.c" 2
# 24 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDriver1CommandsLib/Connect.c"
EFI_STATUS
  ...
  )
{
  ...
  do {
    ...
    if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) && (Handle != ((void *) 0))) {
...
# 63 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDriver1CommandsLib/Connect.c"
EFI_STATUS
...
# 106 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDriver1CommandsLib/Connect.c"
EFI_STATUS
ConnectControllers (
  const EFI_HANDLE ControllerHandle ,
  const EFI_HANDLE DriverHandle ,
  const BOOLEAN Recursive,
  const BOOLEAN Output,
  const BOOLEAN AlwaysOutput
  )
{
  EFI_STATUS Status;
  EFI_STATUS Status2;
  ...
  if (ControllerHandle == ((void *) 0)) {
    ...
    for (HandleWalker = ControllerHandleList
         ; HandleWalker != ((void *) 0) && *HandleWalker != ((void *) 0)
         ; HandleWalker++
         )
    {
      Status = gBS->ConnectController (*HandleWalker, DriverHandleList, ((void *) 0), Recursive);
      if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
        Status2 = (RETURN_STATUS)(0);
      }

      if ((Output && !(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) || AlwaysOutput) {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0018, gShellDriver1HiiHandle, L"Connect", ConvertHandleToHandleIndex (*HandleWalker), Status);
      }
    }
  } else {
    Status = gBS->ConnectController (ControllerHandle, DriverHandleList, ((void *) 0), Recursive);
    if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
      Status2 = (RETURN_STATUS)(0);
    }

    if ((Output && !(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) || AlwaysOutput) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0018, gShellDriver1HiiHandle, L"Connect", ConvertHandleToHandleIndex (ControllerHandle), Status);
    }
  }
...
# 192 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDriver1CommandsLib/Connect.c"
EFI_STATUS
ShellConnectFromDevPaths (
  const CHAR16 *Key
  )
{
  ...
  Status = gRT->GetVariable ((CHAR16 *)Key, (EFI_GUID *)&gEfiGlobalVariableGuid, ((void *) 0), &Length, DevPath);
  ...
  do {
    ...
    if ((DevicePathType (Instance) == 0x03) &&
        ( (DevicePathSubType (Instance) == 0x0f)
        || (DevicePathSubType (Instance) == 0x10)
        ))
    {
...
# 353 "/home/kapoagaeming/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellDriver1CommandsLib/Connect.c"
EFI_STATUS
  ...
  )
{
  ...
  if ( ((Handle1 == ((void *) 0)) && (Handle2 != ((void *) 0)))
     || ((Handle1 != ((void *) 0)) && (Handle2 == ((void *) 0)))
        )
  {
    ...
    if (Handle1 == ((void *) 0)) {
      if ((((RETURN_STATUS)(gBS->OpenProtocol (Handle2, &gEfiDriverBindingProtocolGuid, ((void *) 0), ((void *) 0), gImageHandle, 0x00000004))) >= 0x8000000000000000ULL)) {
      ...
      if ((((RETURN_STATUS)(gBS->OpenProtocol (Handle1, &gEfiDriverBindingProtocolGuid, ((void *) 0), ((void *) 0), gImageHandle, 0x00000004))) >= 0x8000000000000000ULL)) {
  ...
  return (ConnectControllers (Handle1, Handle2, Recursive, Output, (BOOLEAN)(Handle2 != ((void *) 0) && Handle1 != ((void *) 0))));
}
  ...
  )
{
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    if ((Status == ((RETURN_STATUS)(0x8000000000000000ULL | (10)))) && (ProblemParam != ((void *) 0))) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0002, gShellDriver1HiiHandle, L"connect", ProblemParam);
          ...
          )
    {
      ...
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0006, gShellDriver1HiiHandle, L"connect");
      ShellStatus = SHELL_INVALID_PARAMETER;
      ...
      if (Param1 != ((void *) 0)) {
        Status = ShellConvertStringToUint64 (Param1, &Intermediate, ((BOOLEAN)(1==1)), ((BOOLEAN)(0==1)));
        if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0007, gShellDriver1HiiHandle, L"connect", Param1);
          ShellStatus = SHELL_INVALID_PARAMETER;
          if (Package != ((void *) 0)) {
      ...
      if (Param2 != ((void *) 0)) {
        Status = ShellConvertStringToUint64 (Param2, &Intermediate, ((BOOLEAN)(1==1)), ((BOOLEAN)(0==1)));
        if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
          Handle2 = ConvertHandleIndexToHandle ((UINTN)Intermediate);
        } else {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0007, gShellDriver1HiiHandle, L"connect", Param2);
          ShellStatus = SHELL_INVALID_PARAMETER;
        }
      } else {
        Handle2 = ((void *) 0);
      ...
      if (ShellStatus == SHELL_SUCCESS) {
        if ((Param1 != ((void *) 0)) && (Handle1 == ((void *) 0))) {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0007, gShellDriver1HiiHandle, L"connect", Param1);
          ShellStatus = SHELL_INVALID_PARAMETER;
        } else if ((Param2 != ((void *) 0)) && (Handle2 == ((void *) 0))) {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0007, gShellDriver1HiiHandle, L"connect", Param2);
          ShellStatus = SHELL_INVALID_PARAMETER;
        } else if ((Handle2 != ((void *) 0)) && (Handle1 != ((void *) 0)) && (((RETURN_STATUS)(gBS->OpenProtocol (Handle2, &gEfiDriverBindingProtocolGuid, ((void *) 0), gImageHandle, ((void *) 0), 0x00000004))) >= 0x8000000000000000ULL)) {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0007, gShellDriver1HiiHandle, L"connect", Param2);
          ShellStatus = SHELL_INVALID_PARAMETER;
        } else {
          Status = ConvertAndConnectControllers (Handle1, Handle2, ShellCommandLineGetFlag (Package, L"-r"), (BOOLEAN)(Count != 0));
          if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x001A, gShellDriver1HiiHandle);
            ShellStatus = SHELL_DEVICE_ERROR;
          }
        }
      }

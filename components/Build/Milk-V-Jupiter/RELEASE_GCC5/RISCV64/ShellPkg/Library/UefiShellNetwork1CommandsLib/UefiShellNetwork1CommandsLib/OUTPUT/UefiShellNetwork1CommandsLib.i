# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellNetwork1CommandsLib/UefiShellNetwork1CommandsLib.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellNetwork1CommandsLib/UefiShellNetwork1CommandsLib.c"
...
# 9 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellNetwork1CommandsLib/UefiShellNetwork1CommandsLib.c" 2

const CHAR16 gShellNetwork1FileName[] = L"ShellCommands";
EFI_HII_HANDLE gShellNetwork1HiiHandle = ((void *) 0);
...
# 38 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellNetwork1CommandsLib/UefiShellNetwork1CommandsLib.c"
EFI_STATUS
...
{
  gShellNetwork1HiiHandle = ((void *) 0);




  if ((_gPcd_FixedAtBuild_PcdShellProfileMask & 0x00000008) == 0) {
    return ((RETURN_STATUS)(0));
  }

  gShellNetwork1HiiHandle = HiiAddPackages (&gShellNetwork1HiiGuid, gImageHandle, UefiShellNetwork1CommandsLibStrings, ((void *) 0));
  if (gShellNetwork1HiiHandle == ((void *) 0)) {
  ...
  ShellCommandRegisterCommandName (L"ping", ShellCommandRunPing, ShellCommandGetManFileNameNetwork1, 0, L"network1", ((BOOLEAN)(1==1)), gShellNetwork1HiiHandle, 0x0033);
  ShellCommandRegisterCommandName (L"ifconfig", ShellCommandRunIfconfig, ShellCommandGetManFileNameNetwork1, 0, L"network1", ((BOOLEAN)(1==1)), gShellNetwork1HiiHandle, 0x0034);

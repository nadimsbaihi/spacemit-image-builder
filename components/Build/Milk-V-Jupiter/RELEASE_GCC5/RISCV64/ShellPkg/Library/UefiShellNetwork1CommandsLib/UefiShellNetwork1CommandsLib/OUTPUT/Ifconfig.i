# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellNetwork1CommandsLib/Ifconfig.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellNetwork1CommandsLib/Ifconfig.c"
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellNetwork1CommandsLib/Ifconfig.c"
...
# 12 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellNetwork1CommandsLib/Ifconfig.c" 2
...
# 156 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellNetwork1CommandsLib/Ifconfig.c"
ARG_LIST *
SplitStrToList (
  const CHAR16 *String,
  CHAR16 Separator
...
# 234 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellNetwork1CommandsLib/Ifconfig.c"
VAR_CHECK_CODE
IfConfigRetriveCheckListByName (
  VAR_CHECK_ITEM *CheckList,
  CHAR16 *Name,
  BOOLEAN Init
  )
{
  ...
  if (Arg.FlagStr == ((void *) 0)) {
    RtCode = VarCheckUnknown;
  }

  return RtCode;
}
# 294 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellNetwork1CommandsLib/Ifconfig.c"
void
...
{
  *((BOOLEAN *)Context) = ((BOOLEAN)(1==1));
}
# 311 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellNetwork1CommandsLib/Ifconfig.c"
void
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (Size <= 32); } } while (((BOOLEAN)(0==1)));

  for (Index = 0; Index < Size; Index++) {
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x002D, gShellNetwork1HiiHandle, Node[Index]);
    if (Index + 1 < Size) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0027, gShellNetwork1HiiHandle);
    }
  }

  ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0024, gShellNetwork1HiiHandle);
}
# 341 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellNetwork1CommandsLib/Ifconfig.c"
EFI_STATUS
  ...
  )
{
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) || (HandleNum == 0)) {
    return Status;
  }
  ...
  for (HandleIndex = 0; HandleIndex < HandleNum; HandleIndex++) {
    ...
    if ((IfName != ((void *) 0)) && (StrCmp (IfName, IfInfo->Name) != 0)) {
      FreePool (IfInfo);
      continue;
    }
    ...
    if ((Status != ((RETURN_STATUS)(0x8000000000000000ULL | (5)))) && (Status != ((RETURN_STATUS)(0x8000000000000000ULL | (14))))) {
      goto ON_ERROR;
    }
...
# 541 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellNetwork1CommandsLib/Ifconfig.c"
SHELL_STATUS
  ...
  )
{
  ...
  if (IsListEmpty (IfList)) {
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x001A, gShellNetwork1HiiHandle);
  }




  for(Entry = (IfList)->ForwardLink, Next = Entry->ForwardLink; Entry != (IfList); Entry = Next, Next = Entry->ForwardLink ) {
    IfCb = ((IFCONFIG_INTERFACE_CB *) (void *) ((CHAR8 *) (Entry) - ((UINTN) __builtin_offsetof(IFCONFIG_INTERFACE_CB, Link))));

    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0026, gShellNetwork1HiiHandle);




    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0028, gShellNetwork1HiiHandle, IfCb->IfInfo->Name);




    if ((RETURN_STATUS)(0) == NetLibDetectMediaWaitTimeout (IfCb->NicHandle, 0, &MediaStatus)) {
      if (MediaStatus != (RETURN_STATUS)(0)) {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0029, gShellNetwork1HiiHandle, L"Media disconnected");
      } else {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0029, gShellNetwork1HiiHandle, L"Media present");
      }
    } else {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0029, gShellNetwork1HiiHandle, L"Media state unknown");
    }
    ...
    if (IfCb->Policy == Ip4Config2PolicyDhcp) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x002A, gShellNetwork1HiiHandle);
    } else {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x002B, gShellNetwork1HiiHandle);
    }




    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x002C, gShellNetwork1HiiHandle);
    ...
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x002E, gShellNetwork1HiiHandle);
    ...
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x002F, gShellNetwork1HiiHandle);
    ...
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0030, gShellNetwork1HiiHandle);
    ...
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0021, gShellNetwork1HiiHandle, IfCb->IfInfo->RouteTableSize);

    for (Index = 0; Index < IfCb->IfInfo->RouteTableSize; Index++) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0022, gShellNetwork1HiiHandle, Index);
    ...
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0031, gShellNetwork1HiiHandle);
...
# 750 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellNetwork1CommandsLib/Ifconfig.c"
SHELL_STATUS
  ...
  )
{
  ...
  for(Entry = (IfList)->ForwardLink, Next = Entry->ForwardLink; Entry != (IfList); Entry = Next, Next = Entry->ForwardLink ) {
    ...
    if ((IfName != ((void *) 0)) && (StrCmp (IfName, IfCb->IfInfo->Name) == 0)) {
      ...
      if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0005, gShellNetwork1HiiHandle, L"ifconfig");
...
# 822 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellNetwork1CommandsLib/Ifconfig.c"
SHELL_STATUS
  ...
  )
{
  ...
  IfCb = ((IFCONFIG_INTERFACE_CB *) (void *) ((CHAR8 *) (IfList->ForwardLink) - ((UINTN) __builtin_offsetof(IFCONFIG_INTERFACE_CB, Link))));
  Status = (RETURN_STATUS)(0);
  ShellStatus = SHELL_SUCCESS;
  ...
  while (VarArg != ((void *) 0)) {
    ...
    if (VarCheckOk != CheckCode) {
      switch (CheckCode) {
        case VarCheckDuplicate:
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x001D, gShellNetwork1HiiHandle, VarArg->Arg);
          break;

        case VarCheckConflict:
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x001E, gShellNetwork1HiiHandle, VarArg->Arg);
          break;
        ...
        case VarCheckUnknown:
          ...
          if (StringNoCaseCompare (&VarArg->Arg, &TempString) == 0) {
            ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0016, gShellNetwork1HiiHandle, PermanentString);
            goto ON_EXIT;
          }
          ...
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x001F, gShellNetwork1HiiHandle, VarArg->Arg);
          break;
    ...
    if (StrCmp (VarArg->Arg, L"dhcp") == 0) {
      ...
      VarArg = VarArg->Next;
      if (VarArg == ((void *) 0)) {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0019, gShellNetwork1HiiHandle);
      ...
      if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x001B, gShellNetwork1HiiHandle, VarArg->Arg);
        ShellStatus = SHELL_INVALID_PARAMETER;
        goto ON_EXIT;
      }
      ...
      SubnetMask = SwapBytes32 (SubnetMask);
      TempGateway = SwapBytes32 (TempGateway);
      if ((SubnetMask != 0) &&
          (SubnetMask != 0xFFFFFFFFu) &&
          !NetIp4IsUnicast (TempGateway, SubnetMask))
      {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x001C, gShellNetwork1HiiHandle, VarArg->Arg);
        ShellStatus = SHELL_INVALID_PARAMETER;
        goto ON_EXIT;
      }
      ...
      if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0020, gShellNetwork1HiiHandle, Status);
        ShellStatus = SHELL_ACCESS_DENIED;
        goto ON_EXIT;
      }
      ...
      if (Status == ((RETURN_STATUS)(0x8000000000000000ULL | (6)))) {
        ...
        while ((((RETURN_STATUS)(gBS->CheckEvent (TimeOutEvt))) >= 0x8000000000000000ULL)) {
          if (IsAddressOk) {
            Status = (RETURN_STATUS)(0);
            break;
          }
      ...
      if (Dns == ((void *) 0)) {
        ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0007, gShellNetwork1HiiHandle, L"ifconfig");
      ...
      while (Tmp != ((void *) 0)) {
        ...
        if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
          ShellPrintHiiEx (-1, -1, ((void *) 0), 0x001B, gShellNetwork1HiiHandle, Tmp->Arg);
          ShellStatus = SHELL_INVALID_PARAMETER;
          goto ON_EXIT;
        }
...
# 1192 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellNetwork1CommandsLib/Ifconfig.c"
SHELL_STATUS
IfConfig (
  ...
  )
{
  ...
  if (Private->VarArg != ((void *) 0)) {
    FreeArgList (Private->VarArg);
  }

  if (Private->IfName != ((void *) 0)) {
  ...
  for(Entry = (&Private->IfList)->ForwardLink, NextEntry = Entry->ForwardLink; Entry != (&Private->IfList); Entry = NextEntry, NextEntry = Entry->ForwardLink ) {
    IfCb = ((IFCONFIG_INTERFACE_CB *) (void *) ((CHAR8 *) (Entry) - ((UINTN) __builtin_offsetof(IFCONFIG_INTERFACE_CB, Link))));

    RemoveEntryList (&IfCb->Link);

    if (IfCb->IfInfo != ((void *) 0)) {
...
# 1291 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/ShellPkg/Library/UefiShellNetwork1CommandsLib/Ifconfig.c"
SHELL_STATUS
  ...
  )
{
  ...
  Status = ShellCommandLineParseEx (mIfConfigCheckList, &ParamPackage, &ProblemParam, ((BOOLEAN)(1==1)), ((BOOLEAN)(0==1)));
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    if ((Status == ((RETURN_STATUS)(0x8000000000000000ULL | (10)))) && (ProblemParam != ((void *) 0))) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0004, gShellNetwork1HiiHandle, L"ifconfig", ProblemParam);
  ...
  if (ShellCommandLineGetFlag (ParamPackage, L"-c")) {
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0016, gShellNetwork1HiiHandle, L"-c");
    ShellStatus = SHELL_INVALID_PARAMETER;
    goto ON_EXIT;
  }
  ...
  {
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0017, gShellNetwork1HiiHandle);
    ShellStatus = SHELL_INVALID_PARAMETER;
    goto ON_EXIT;
  }
  ...
  {
    ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0006, gShellNetwork1HiiHandle, L"ifconfig");
    ShellStatus = SHELL_INVALID_PARAMETER;
    goto ON_EXIT;
  }
  ...
  if (ShellCommandLineGetFlag (ParamPackage, L"-s")) {
    ...
    if (ValueStr == ((void *) 0)) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0018, gShellNetwork1HiiHandle);
      ShellStatus = SHELL_INVALID_PARAMETER;
      goto ON_EXIT;
    }
    ...
    if ((Private->IfName == ((void *) 0)) || (Private->VarArg == ((void *) 0))) {
      ShellPrintHiiEx (-1, -1, ((void *) 0), 0x0019, gShellNetwork1HiiHandle);
      ShellStatus = SHELL_INVALID_PARAMETER;
      goto ON_EXIT;
    }

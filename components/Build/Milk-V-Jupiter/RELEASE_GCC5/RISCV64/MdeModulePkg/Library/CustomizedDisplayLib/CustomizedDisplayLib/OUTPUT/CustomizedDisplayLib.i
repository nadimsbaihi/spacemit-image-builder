# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/CustomizedDisplayLib/CustomizedDisplayLib.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/CustomizedDisplayLib/CustomizedDisplayLib.c"
# 9 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/CustomizedDisplayLib/CustomizedDisplayLib.c"
...
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/CustomizedDisplayLib/CustomizedDisplayLib.c" 2
...
UINT16 gClassOfVfr;
BOOLEAN gLibIsFirstForm = ((BOOLEAN)(1==1));
BANNER_DATA *gBannerData;

UINTN gFooterHeight;
# 53 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/CustomizedDisplayLib/CustomizedDisplayLib.c"
EFI_STATUS
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (FormData != ((void *) 0) && ScreenForStatement != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
  if ((FormData == ((void *) 0)) || (ScreenForStatement == ((void *) 0))) {
  ...
  ScreenForStatement->BottomRow = gScreenDimensions.BottomRow - 1 - gFooterHeight;
  if (gClassOfVfr == 0x0002) {
    ScreenForStatement->TopRow = gScreenDimensions.TopRow + 6;
  } else {
    ScreenForStatement->TopRow = gScreenDimensions.TopRow + 3;
  }

  ScreenForStatement->LeftColumn = gScreenDimensions.LeftColumn;
  ScreenForStatement->RightColumn = gScreenDimensions.RightColumn;

  if ((gLibIsFirstForm) || ((FormData->Attribute & 0x00000008) != 0)) {



    gST->ConOut->SetAttribute (gST->ConOut, (((0x01 | 0x02 | 0x04)) | ((0x00) << 4)));
    ClearLines (0, gScreenDimensions.RightColumn, 0, gScreenDimensions.BottomRow, 0x00);
    gLibIsFirstForm = ((BOOLEAN)(0==1));
  }
  ...
  UpdateStatusBar (2, FormData->SettingChangedFlag);

  return (RETURN_STATUS)(0);
}
# 125 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/CustomizedDisplayLib/CustomizedDisplayLib.c"
void
  ...
  )
{
  ...
  gST->ConOut->SetAttribute (gST->ConOut, (0x01 | 0x02 | 0x04) | 0x00);
  ...
  TopRowOfHelp = gScreenDimensions.BottomRow - 1 - gFooterHeight + 1;
  BottomRowOfHelp = gScreenDimensions.BottomRow - 1 - 2;
  ...
  if (Statement == ((void *) 0)) {
    ...
    PrintHotKeyHelpString (FormData, ((BOOLEAN)(1==1)));
  ...
  HexDisplay = ((BOOLEAN)(0==1));
  NumericOp = ((void *) 0);
  DateOp = ((void *) 0);
  TimeOp = ((void *) 0);
  if (Statement->OpCode->OpCode == 0x07) {
    NumericOp = (EFI_IFR_NUMERIC *)Statement->OpCode;
    HexDisplay = (NumericOp->Flags & 0x20) == 0x20;
  } else if (Statement->OpCode->OpCode == 0x1A) {
    DateOp = (EFI_IFR_DATE *)Statement->OpCode;
    HexDisplay = (DateOp->Flags & 0x20) == 0x20;
  } else if (Statement->OpCode->OpCode == 0x1B) {
    TimeOp = (EFI_IFR_TIME *)Statement->OpCode;
    HexDisplay = (TimeOp->Flags & 0x20) == 0x20;
  }
  ...
  switch (Statement->OpCode->OpCode) {
    ...
    case 0x1A:
      if (!Selected) {
            ...
            (Statement->OpCode->OpCode == 0x1B))
        {
          ...
          PrintAt (ColumnWidth1, StartColumnOfHelp, BottomRowOfHelp, L"%c%c%s", 0x2191, 0x2193, gMoveHighlight);
          if ((Statement->OpCode->OpCode == 0x07) && (NumericOp != ((void *) 0)) && (LibGetFieldFromNum (Statement->OpCode) != 0)) {
        ...
        PrintHotKeyHelpString (FormData, ((BOOLEAN)(0==1)));
        ...
        if (Statement->OpCode->OpCode == 0x23) {
    ...
    case 0x02:
      if (!Selected) {
        ...
        PrintAt (ColumnWidth1, StartColumnOfHelp, BottomRowOfHelp, L"%c%c%s", 0x2191, 0x2193, gMoveHighlight);
        if ((Statement->OpCode->OpCode != 0x03) && (Statement->OpCode->OpCode != 0x02)) {
        ...
        PrintHotKeyHelpString (FormData, ((BOOLEAN)(0==1)));
        if (Statement->OpCode->OpCode != 0x0F) {
...
# 354 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/CustomizedDisplayLib/CustomizedDisplayLib.c"
void
  ...
  )
{
  ...
  switch (MessageType) {
    case 1:
      if (State) {
        gST->ConOut->SetAttribute (gST->ConOut, 0x04 | 0x08);
        PrintStringAt (
    ...
    case 2:
      ...
      if (State) {
        gST->ConOut->SetAttribute (gST->ConOut, ((0x02 | 0x04) | 0x08) | 0x08);
        PrintStringAt (
...
# 422 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/CustomizedDisplayLib/CustomizedDisplayLib.c"
void
  ...
  )
{
  ...
  LargestString = 0;
  LineNum = 0;
  __builtin_va_start (Marker, Key);
  while ((String = ((sizeof (CHAR16 *) < sizeof (UINTN)) ? (CHAR16 *)(__builtin_va_arg (Marker, UINTN)) : (CHAR16 *)(__builtin_va_arg (Marker, CHAR16 *)))) != ((void *) 0)) {
    LineNum++;
  ...
  for (Index = Top; Index + 2 < Bottom; Index++, Count++) {
    String = ((sizeof (CHAR16 *) < sizeof (UINTN)) ? (CHAR16 *)(__builtin_va_arg (Marker, UINTN)) : (CHAR16 *)(__builtin_va_arg (Marker, CHAR16 *)));
    ...
    if (String[0] == 0x0000) {
      ...
      ClearLines (Start + 1, End - 1, Index + 1, Index + 1, (0x01 | 0x02 | 0x04) | 0x00);
      PrintStringAt (
  ...
  )
{
  ...
  do {
    CreateDialog (&Key, gLibEmptyString, gSaveChanges, gAreYouSure, gLibEmptyString, ((void *) 0));
  } while
  (
   (Key.ScanCode != 0x0017) &&
   ((Key.UnicodeChar | 0x20) != (NoResponse | 0x20)) &&
   ((Key.UnicodeChar | 0x20) != (YesResponse | 0x20))
  );

  if (Key.ScanCode == 0x0017) {
    return 0x00010000;
  } else if ((Key.UnicodeChar | 0x20) == (YesResponse | 0x20)) {
    return 0x00000004;
  } else {
    return 0x00000001;
  }
}
# 617 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/CustomizedDisplayLib/CustomizedDisplayLib.c"
BOOLEAN
...
{
  return gClassOfVfr == 0x0002 ? ((BOOLEAN)(0==1)) : ((BOOLEAN)(1==1));
}
# 637 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/CustomizedDisplayLib/CustomizedDisplayLib.c"
UINT64
...
# 661 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/CustomizedDisplayLib/CustomizedDisplayLib.c"
UINTN
...
# 684 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/CustomizedDisplayLib/CustomizedDisplayLib.c"
UINTN
...
# 707 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/CustomizedDisplayLib/CustomizedDisplayLib.c"
UINTN
...
# 728 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/CustomizedDisplayLib/CustomizedDisplayLib.c"
void
...
# 778 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/CustomizedDisplayLib/CustomizedDisplayLib.c"
UINT8
...
{
  return 0x04 | 0x08 | (0x10 | 0x20 | 0x40);
}
...
{
  return ((0x02 | 0x04) | 0x08) | 0x08 | (0x10 | 0x20 | 0x40);
}
...
{
  return (0x00 | 0x08) | (0x10 | 0x20 | 0x40);
}
...
{
  return _gPcd_FixedAtBuild_PcdBrowserFieldTextHighlightColor | _gPcd_FixedAtBuild_PcdBrowserFieldBackgroundHighlightColor;
}
...
{
  return _gPcd_FixedAtBuild_PcdBrowserFieldTextColor | (0x10 | 0x20 | 0x40);
}
...
{
  return _gPcd_FixedAtBuild_PcdBrowserSubtitleTextColor | (0x10 | 0x20 | 0x40);
}
  ...
  )
{
  ...
  gLibIsFirstForm = ((BOOLEAN)(1==1));
}
# 936 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/CustomizedDisplayLib/CustomizedDisplayLib.c"
EFI_STATUS
...
{
  mCDLStringPackHandle = HiiAddPackages (&gCustomizedDisplayLibGuid, ImageHandle, CustomizedDisplayLibStrings, ((void *) 0));
  do { if (((BOOLEAN)(0==1))) { (void) (mCDLStringPackHandle != ((void *) 0)); } } while (((BOOLEAN)(0==1)));

  InitializeLibStrings ();

  return (RETURN_STATUS)(0);
}
# 961 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/CustomizedDisplayLib/CustomizedDisplayLib.c"
EFI_STATUS

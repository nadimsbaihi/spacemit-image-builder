# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/LzmaCustomDecompressLib/Sdk/C/LzFind.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/LzmaCustomDecompressLib/Sdk/C/LzFind.c"
...
# 5 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/LzmaCustomDecompressLib/Sdk/C/LzFind.c" 2





# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/LzmaCustomDecompressLib/Sdk/C/LzFind.h" 1
...
# 8 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/LzmaCustomDecompressLib/Sdk/C/LzFind.h" 2
...
# 62 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/LzmaCustomDecompressLib/Sdk/C/LzFind.h"
int
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/LzmaCustomDecompressLib/Sdk/C/LzFind.c" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/LzmaCustomDecompressLib/Sdk/C/LzHash.h" 1
# 12 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/LzmaCustomDecompressLib/Sdk/C/LzFind.c" 2
# 21 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/LzmaCustomDecompressLib/Sdk/C/LzFind.c"
static void
LzInWindow_Free (
  CMatchFinder *p,
  ISzAllocPtr alloc
  ...
  )
{
  ...
  if (LzInWindow_Create (p, sizeReserv, alloc)) {
    ...
    p->matchMaxLen = matchMaxLen;
    {
      ...
      hs++;
      if (p->numHashBytes > 2) {
        p->fixedHashSize += (1 << 10);
      }

      if (p->numHashBytes > 3) {
        p->fixedHashSize += (1 << 16);
      }

      if (p->numHashBytes > 4) {
        p->fixedHashSize += (1 << 20);
      }
...
{
  return (p->pos - p->historySize - 1) & (~(UInt32)((1 << 10) - 1));
}
...
{
# 578 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/LzmaCustomDecompressLib/Sdk/C/LzFind.c"
...
# 749 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/LzmaCustomDecompressLib/Sdk/C/LzFind.c"
static void
MatchFinder_MovePos (
  CMatchFinder *p
  )
...
# 781 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/LzmaCustomDecompressLib/Sdk/C/LzFind.c"
static UInt32
  ...
  )
{
  ...
  unsigned lenLimit; UInt32 hv; const Byte *cur; UInt32 curMatch; lenLimit = (unsigned)p->lenLimit; { if (lenLimit < 2) { MatchFinder_MovePos(p); return 0; }} cur = p->buffer;
  hv = cur[0] | ((UInt32)cur[1] << 8);;
  curMatch = p->hash[hv];
  p->hash[hv] = p->pos;
  offset = 0;
  offset = (unsigned)(GetMatchesSpec1((UInt32)lenLimit, curMatch, p->pos, p->buffer, p->son, p->cyclicBufferPos, p->cyclicBufferSize, p->cutValue, distances + offset, (UInt32)1) - distances); ++p->cyclicBufferPos; p->buffer++; if (++p->pos == p->posLimit) MatchFinder_CheckLimits(p); return (UInt32)offset;;
}
  ...
  )
{
  ...
  unsigned lenLimit; UInt32 hv; const Byte *cur; UInt32 curMatch; lenLimit = (unsigned)p->lenLimit; { if (lenLimit < 3) { MatchFinder_MovePos(p); return 0; }} cur = p->buffer;
  hv = ((cur[2] | ((UInt32)cur[0] << 8)) ^ p->crc[cur[1]]) & 0xFFFF;;
  curMatch = p->hash[hv];
  p->hash[hv] = p->pos;
  offset = 0;
  offset = (unsigned)(GetMatchesSpec1((UInt32)lenLimit, curMatch, p->pos, p->buffer, p->son, p->cyclicBufferPos, p->cyclicBufferSize, p->cutValue, distances + offset, (UInt32)2) - distances); ++p->cyclicBufferPos; p->buffer++; if (++p->pos == p->posLimit) MatchFinder_CheckLimits(p); return (UInt32)offset;;
}
  ...
  )
{
  ...
  { UInt32 temp = p->crc[cur[0]] ^ cur[1]; h2 = temp & ((1 << 10) - 1); hv = (temp ^ ((UInt32)cur[2] << 8)) & p->hashMask; };
  ...
  if ((d2 < p->cyclicBufferSize) && (*(cur - d2) == *cur)) {
    { ptrdiff_t diff = (ptrdiff_t)0 - d2; const Byte *c = cur + maxLen; const Byte *lim = cur + lenLimit; for (; c != lim; c++) if (*(c + diff) != *c) break; maxLen = (unsigned)(c - cur); }
      distances[0] = (UInt32)maxLen;
    distances[1] = d2 - 1;
    offset = 2;
    if (maxLen == lenLimit) {
      SkipMatchesSpec ((UInt32)lenLimit, curMatch, p->pos, p->buffer, p->son, p->cyclicBufferPos, p->cyclicBufferSize, p->cutValue);
      ++p->cyclicBufferPos; p->buffer++; if (++p->pos == p->posLimit) MatchFinder_CheckLimits(p); return (UInt32)offset;;
    }
  }

  offset = (unsigned)(GetMatchesSpec1((UInt32)lenLimit, curMatch, p->pos, p->buffer, p->son, p->cyclicBufferPos, p->cyclicBufferSize, p->cutValue, distances + offset, (UInt32)maxLen) - distances); ++p->cyclicBufferPos; p->buffer++; if (++p->pos == p->posLimit) MatchFinder_CheckLimits(p); return (UInt32)offset;;
}
  ...
  )
{
  ...
  unsigned lenLimit; UInt32 hv; const Byte *cur; UInt32 curMatch; lenLimit = (unsigned)p->lenLimit; { if (lenLimit < 4) { MatchFinder_MovePos(p); return 0; }} cur = p->buffer;

  { UInt32 temp = p->crc[cur[0]] ^ cur[1]; h2 = temp & ((1 << 10) - 1); temp ^= ((UInt32)cur[2] << 8); h3 = temp & ((1 << 16) - 1); hv = (temp ^ (p->crc[cur[3]] << 5)) & p->hashMask; };
...
# 989 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/LzmaCustomDecompressLib/Sdk/C/LzFind.c"
static UInt32
...
# 1133 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/LzmaCustomDecompressLib/Sdk/C/LzFind.c"
UInt32
Hc3Zip_MatchFinder_GetMatches (
  CMatchFinder *p,
  UInt32 *distances
...
{
  do {
    unsigned lenLimit; UInt32 hv; const Byte *cur; UInt32 curMatch; lenLimit = (unsigned)p->lenLimit; { if (lenLimit < 2) { MatchFinder_MovePos(p); continue; }} cur = p->buffer;
    hv = cur[0] | ((UInt32)cur[1] << 8);;
    curMatch = p->hash[hv];
    p->hash[hv] = p->pos;
    SkipMatchesSpec((UInt32)lenLimit, curMatch, p->pos, p->buffer, p->son, p->cyclicBufferPos, p->cyclicBufferSize, p->cutValue); ++p->cyclicBufferPos; p->buffer++; if (++p->pos == p->posLimit) MatchFinder_CheckLimits(p);;
  } while (--num != 0);
}
...
{
  do {
    unsigned lenLimit; UInt32 hv; const Byte *cur; UInt32 curMatch; lenLimit = (unsigned)p->lenLimit; { if (lenLimit < 3) { MatchFinder_MovePos(p); continue; }} cur = p->buffer;
    hv = ((cur[2] | ((UInt32)cur[0] << 8)) ^ p->crc[cur[1]]) & 0xFFFF;;
    curMatch = p->hash[hv];
    p->hash[hv] = p->pos;
    SkipMatchesSpec((UInt32)lenLimit, curMatch, p->pos, p->buffer, p->son, p->cyclicBufferPos, p->cyclicBufferSize, p->cutValue); ++p->cyclicBufferPos; p->buffer++; if (++p->pos == p->posLimit) MatchFinder_CheckLimits(p);;
  ...
  )
{
  do {
    UInt32 h2, h3;
    UInt32 *hash;
    unsigned lenLimit; UInt32 hv; const Byte *cur; UInt32 curMatch; lenLimit = (unsigned)p->lenLimit; { if (lenLimit < 4) { MatchFinder_MovePos(p); continue; }} cur = p->buffer;
    { UInt32 temp = p->crc[cur[0]] ^ cur[1]; h2 = temp & ((1 << 10) - 1); temp ^= ((UInt32)cur[2] << 8); h3 = temp & ((1 << 16) - 1); hv = (temp ^ (p->crc[cur[3]] << 5)) & p->hashMask; };
    hash = p->hash;
    curMatch = (hash + ((1 << 10) + (1 << 16)))[hv];
    hash[h2] =
      (hash + ((1 << 10)))[h3] =
        (hash + ((1 << 10) + (1 << 16)))[hv] = p->pos;
    SkipMatchesSpec((UInt32)lenLimit, curMatch, p->pos, p->buffer, p->son, p->cyclicBufferPos, p->cyclicBufferSize, p->cutValue); ++p->cyclicBufferPos; p->buffer++; if (++p->pos == p->posLimit) MatchFinder_CheckLimits(p);;
  } while (--num != 0);
}
# 1244 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/LzmaCustomDecompressLib/Sdk/C/LzFind.c"
static void
...
# 1286 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/LzmaCustomDecompressLib/Sdk/C/LzFind.c"
void
Hc3Zip_MatchFinder_Skip (
  CMatchFinder *p,
  UInt32 num
...
# 1325 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/LzmaCustomDecompressLib/Sdk/C/LzFind.c"
...
# 1344 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/LzmaCustomDecompressLib/Sdk/C/LzFind.c"
}

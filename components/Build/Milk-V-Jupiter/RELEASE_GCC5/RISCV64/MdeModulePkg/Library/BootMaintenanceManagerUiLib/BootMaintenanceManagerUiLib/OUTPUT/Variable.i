# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/Variable.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/Variable.c"
# 9 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/Variable.c"
...
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/Variable.c" 2
# 20 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/Variable.c"
EFI_STATUS
Var_DelBootOption (
  void
  )
...
# 77 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/Variable.c"
EFI_STATUS
Var_DelDriverOption (
  void
  )
...
# 139 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/Variable.c"
EFI_STATUS
  ...
  )
{
  ...
  GetEfiGlobalVariable2 (ConsoleName, (void **)&ConDevicePath, ((void *) 0));
  if (ConDevicePath != ((void *) 0)) {
  ...
  for (Index = 0; Index < TerminalMenu.MenuNumber; Index++) {
        ...
        )
    {
      ...
      do { if (((BOOLEAN)(0==1))) { (void) (NewTerminalContext->TerminalType < ((sizeof (TerminalTypeGuid) / sizeof ((TerminalTypeGuid)[0])))); } } while (((BOOLEAN)(0==1)));
      CopyMem (
        &Vendor.Guid,
      ...
      do { if (((BOOLEAN)(0==1))) { (void) (TerminalDevicePath != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
      ChangeTerminalDevicePath (TerminalDevicePath, ((BOOLEAN)(1==1)));
      ConDevicePath = AppendDevicePathInstance (
                        ConDevicePath,
                        TerminalDevicePath
                        );
...
# 232 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/Variable.c"
EFI_STATUS
Var_UpdateConsoleInpOption (
  void
  )
{
  return Var_UpdateConsoleOption (L"ConIn", &ConsoleInpMenu, 0x1009);
}
# 247 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/Variable.c"
EFI_STATUS
Var_UpdateConsoleOutOption (
  void
  )
{
  return Var_UpdateConsoleOption (L"ConOut", &ConsoleOutMenu, 0x100A);
}
# 262 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/Variable.c"
EFI_STATUS
Var_UpdateErrorOutOption (
  void
  )
{
  return Var_UpdateConsoleOption (L"ErrOut", &ConsoleErrMenu, 0x100B);
}
# 288 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/Variable.c"
EFI_STATUS
Var_UpdateDriverOption (
  BMM_CALLBACK_DATA *CallbackData,
  EFI_HII_HANDLE HiiHandle,
  ...
  )
{
  ...
  OptionalDataExist = ((BOOLEAN)(0==1));
  OptionalDesData = ((void *) 0);
  OptionalDataSize = 0;
  ...
  if (*DescriptionData == 0x0000) {
    StrCpyS (DescriptionData, 100, DriverString);
  }

  if (*OptionalData != 0x0000) {
    OptionalDataExist = ((BOOLEAN)(1==1));
  ...
  NewMenuEntry->DisplayStringToken = HiiSetString (HiiHandle, 0, NewMenuEntry->DisplayString, ((void *) 0));
  NewMenuEntry->HelpStringToken = HiiSetString (HiiHandle, 0, NewMenuEntry->HelpString, ((void *) 0));
...
# 413 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/Variable.c"
EFI_STATUS
Var_UpdateBootOption (
  BMM_CALLBACK_DATA *CallbackData
  )
...
# 532 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/Variable.c"
EFI_STATUS
Var_UpdateBootNext (
  BMM_CALLBACK_DATA *CallbackData
  )
{
  ...
  for (Index = 0; Index < BootOptionMenu.MenuNumber; Index++) {
    ...
    NewLoadContext = (BM_LOAD_CONTEXT *)NewMenuEntry->VariableContext;
    NewLoadContext->IsBootNext = ((BOOLEAN)(0==1));
  }

  if (CurrentFakeNVMap->BootNext == (0xFFFF + 1)) {
    EfiLibDeleteVariable (L"BootNext", &gEfiGlobalVariableGuid);
    return (RETURN_STATUS)(0);
  }
  ...
  NewLoadContext->IsBootNext = ((BOOLEAN)(1==1));
  CallbackData->BmmOldFakeNVData.BootNext = CurrentFakeNVMap->BootNext;
  return Status;
}
# 589 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/Variable.c"
EFI_STATUS
Var_UpdateBootOrder (
  BMM_CALLBACK_DATA *CallbackData
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (BootOptionMenu.MenuNumber <= (sizeof (CallbackData->BmmFakeNvData.BootOptionOrder) / sizeof (CallbackData->BmmFakeNvData.BootOptionOrder[0]))); } } while (((BOOLEAN)(0==1)));
...
# 651 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/Variable.c"
EFI_STATUS
Var_UpdateDriverOrder (
  BMM_CALLBACK_DATA *CallbackData
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (DriverOptionMenu.MenuNumber <= (sizeof (CallbackData->BmmFakeNvData.DriverOptionOrder) / sizeof (CallbackData->BmmFakeNvData.DriverOptionOrder[0]))); } } while (((BOOLEAN)(0==1)));
  for (Index = 0; Index < DriverOptionMenu.MenuNumber; Index++) {
...
# 713 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/Variable.c"
EFI_STATUS
Var_UpdateConMode (
  BMM_CALLBACK_DATA *CallbackData
  )
{
  ...
  if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    Status = ((_gPcd_BinaryPatch_PcdSetupConOutColumn = (((UINT32)ModeInfo.Column))), (RETURN_STATUS)(0));
    if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
      Status = ((_gPcd_BinaryPatch_PcdSetupConOutRow = (((UINT32)ModeInfo.Row))), (RETURN_STATUS)(0));
    }
  }

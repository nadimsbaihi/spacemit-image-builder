# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/BootOption.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/BootOption.c"
# 13 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/BootOption.c"
...
# 14 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/BootOption.c" 2
# 25 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/BootOption.c"
void
  ...
  )
{
  ...
  Status = gBS->LocateProtocol (&gEdkiiFormBrowserEx2ProtocolGuid, ((void *) 0), (void **)&FormBrowserEx2);




  if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) && FormBrowserEx2->IsResetRequired ()) {
    StringBuffer1 = AllocateZeroPool (480 * sizeof (CHAR16));
    do { if (((BOOLEAN)(0==1))) { (void) (StringBuffer1 != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
    StringBuffer2 = AllocateZeroPool (480 * sizeof (CHAR16));
    do { if (((BOOLEAN)(0==1))) { (void) (StringBuffer2 != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
    StrCpyS (StringBuffer1, 480, L"Configuration changed. Reset to apply it Now.");
    StrCpyS (StringBuffer2, 480, L"Press ENTER to reset");



    do {
      CreatePopUp ((0x01 | 0x02 | 0x04) | 0x10, &Key, StringBuffer1, StringBuffer2, ((void *) 0));
    } while (Key.UnicodeChar != 0x000D);
...
# 74 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/BootOption.c"
BM_MENU_ENTRY *
BOpt_CreateMenuEntry (
  UINTN MenuType
  )
{
  ...
  if (MenuEntry->VariableContext == ((void *) 0)) {
    FreePool (MenuEntry);
    return ((void *) 0);
  }

  MenuEntry->Signature = ((('e') | ('n' << 8)) | ((('t') | ('r' << 8)) << 16));
  ...
  )
{
  ...
  switch (MenuEntry->ContextSelection) {
    case 0x0:
      ...
      if (LoadContext->OptionalData != ((void *) 0)) {
    ...
    case 0x2:
      ...
      if (!FileContext->IsRoot) {
        ...
        if (FileContext->FHandle != ((void *) 0)) {
          FileContext->FHandle->Close (FileContext->FHandle);
        }
      }

      if (FileContext->FileName != ((void *) 0)) {
        FreePool (FileContext->FileName);
      }

      if (FileContext->Info != ((void *) 0)) {
  ...
  if (MenuEntry->HelpString != ((void *) 0)) {
    FreePool (MenuEntry->HelpString);
  }

  FreePool (MenuEntry);
}
# 228 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/BootOption.c"
BM_MENU_ENTRY *
BOpt_GetMenuEntry (
  BM_MENU_OPTION *MenuOption,
  UINTN MenuNumber
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (MenuNumber < MenuOption->MenuNumber); } } while (((BOOLEAN)(0==1)));
  ...
  NewMenuEntry = (((BM_MENU_ENTRY *) (void *) ((CHAR8 *) (List) - ((UINTN) __builtin_offsetof(BM_MENU_ENTRY, Link))))->Signature != ((('e') | ('n' << 8)) | ((('t') | ('r' << 8)) << 16))) ? ((void *) 0) : ((BM_MENU_ENTRY *) (void *) ((CHAR8 *) (List) - ((UINTN) __builtin_offsetof(BM_MENU_ENTRY, Link))));
  ...
  )
{
  ...
  while (!IsListEmpty (&FreeMenu->Head)) {
    MenuEntry = (((BM_MENU_ENTRY *) (void *) ((CHAR8 *) (FreeMenu->Head.ForwardLink) - ((UINTN) __builtin_offsetof(BM_MENU_ENTRY, Link))))->Signature != ((('e') | ('n' << 8)) | ((('t') | ('r' << 8)) << 16))) ? ((void *) 0) : ((BM_MENU_ENTRY *) (void *) ((CHAR8 *) (FreeMenu->Head.ForwardLink) - ((UINTN) __builtin_offsetof(BM_MENU_ENTRY, Link))))
...
# 287 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/BootOption.c"
EFI_STATUS
BOpt_GetBootOptions (
  BMM_CALLBACK_DATA *CallbackData
  )
{
  ...
  BootOrderListSize = 0;
  BootNextSize = 0;
  BootOrderList = ((void *) 0);
  BootNext = ((void *) 0);
  LoadOptionFromVar = ((void *) 0);
  ...
  for (Index = 0; Index < BootOrderListSize / sizeof (UINT16); Index++) {
    ...
    if (((BootOption[Index].Attributes & 0x00000008) != 0) || ((BootOption[Index].Attributes & 0x00000001) == 0)) {
      continue;
    }
    ...
    if (BootNext != ((void *) 0)) {
      ...
      BootNextFlag = ((BOOLEAN)(0==1));
    }

    NewMenuEntry = BOpt_CreateMenuEntry (0x0);
    do { if (((BOOLEAN)(0==1))) { (void) (((void *) 0) != NewMenuEntry); } } while (((BOOLEAN)(0==1)));
    ...
    if ((0x05 == DevicePath->Type) && (0x01 == DevicePath->SubType)) {
      NewLoadContext->IsLegacy = ((BOOLEAN)(1==1));
    } else {
      NewLoadContext->IsLegacy = ((BOOLEAN)(0==1));
    }
    ...
    do { if (((BOOLEAN)(0==1))) { (void) (NewLoadContext->Description != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
    StrCpyS (NewLoadContext->Description, StrSize ((UINT16 *)LoadOptionPtr) / sizeof (UINT16), (UINT16 *)LoadOptionPtr);

    do { if (((BOOLEAN)(0==1))) { (void) (NewLoadContext->Description != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
    NewMenuEntry->DisplayString = NewLoadContext->Description;
    NewMenuEntry->DisplayStringToken = HiiSetString (CallbackData->BmmHiiHandle, 0, NewMenuEntry->DisplayString, ((void *) 0));

    LoadOptionPtr += StringSize;

    NewLoadContext->FilePathList = AllocateZeroPool (NewLoadContext->FilePathListLength);
    do { if (((BOOLEAN)(0==1))) { (void) (NewLoadContext->FilePathList != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
    CopyMem (
    ...
    NewMenuEntry->HelpStringToken = HiiSetString (CallbackData->BmmHiiHandle, 0, NewMenuEntry->HelpString, ((void *) 0));
    ...
    if (LoadOptionPtr < LoadOptionEnd) {
      ...
      do { if (((BOOLEAN)(0==1))) { (void) (NewLoadContext->OptionalData != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
      CopyMem (
...
# 491 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/BootOption.c"
EFI_STATUS
BOpt_FindDrivers (
  void
  )
{
  ...
  for (Index = 0; Index < NoDevicePathHandles; Index++) {
    ...
    NewMenuEntry = BOpt_CreateMenuEntry (0x3);
...
# 585 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/BootOption.c"
UINT16
BOpt_GetOptionNumber (
  CHAR16 *Type
  )
{
  ...
  for (OptionNumber = 0; ; OptionNumber++) {
    ...
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "Option = %s\n", StrTemp); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    GetEfiGlobalVariable2 (StrTemp, (void **)&OptionBuffer, &OptionSize);
    if (((void *) 0) == OptionBuffer) {
...
# 643 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/BootOption.c"
UINT16
BOpt_GetBootOptionNumber (
  void
  )
...
# 658 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/BootOption.c"
UINT16
BOpt_GetDriverOptionNumber (
  void
  )
...
# 677 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/BootOption.c"
EFI_STATUS
BOpt_GetDriverOptions (
  BMM_CALLBACK_DATA *CallbackData
  )
...
# 906 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/BootOption.c"
BOOLEAN
  ...
  )
{
  ...
  if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    ...
    BmmSetConsoleMode (((BOOLEAN)(0==1)));
    EfiBootManagerBoot (&BootOption);
    BmmSetConsoleMode (((BOOLEAN)(1==1)));
...
# 962 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/BootOption.c"
BOOLEAN
ReSendForm (
  EFI_DEVICE_PATH_PROTOCOL *FilePath,
  EFI_FORM_ID FormId
...
# 992 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/BootOption.c"
BOOLEAN
...
{
  return ReSendForm (FilePath, 0x1002);
}
# 1010 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/BootOption.c"
BOOLEAN
...
{
  return ReSendForm (FilePath, 0x100E);
}

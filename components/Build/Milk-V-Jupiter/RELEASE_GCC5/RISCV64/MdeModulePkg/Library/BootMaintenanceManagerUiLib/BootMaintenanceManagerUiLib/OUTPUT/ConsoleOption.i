# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/ConsoleOption.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/ConsoleOption.c"
# 9 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/ConsoleOption.c"
...
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/ConsoleOption.c" 2
# 24 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/ConsoleOption.c"
BOOLEAN
MatchDevicePaths (
...
# 70 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/ConsoleOption.c"
BOOLEAN
IsIsaSerialNode (
  ACPI_HID_DEVICE_PATH *Acpi
  )
{
  return (BOOLEAN)(
                   (DevicePathType (Acpi) == 0x02) &&
                   (DevicePathSubType (Acpi) == 0x01) &&
                   (ReadUnaligned32 (&Acpi->HID) == (((UINT32)((0x41d0) | ((0x0501)) << 16))))
                   );
}
# 90 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/ConsoleOption.c"
EFI_STATUS
UpdateComAttributeFromVariable (
  EFI_DEVICE_PATH_PROTOCOL *DevicePath
  );
# 107 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/ConsoleOption.c"
EFI_STATUS
ChangeTerminalDevicePath (
  EFI_DEVICE_PATH_PROTOCOL *DevicePath,
  BOOLEAN ChangeTerminal
  )
{
  ...
  while (!IsDevicePathEnd (Node)) {
    ...
    if ((DevicePathType (Node) == 0x03) && (DevicePathSubType (Node) == 0x0e)) {
      ...
      if (ChangeTerminal) {
        ...
        while (!IsDevicePathEnd (Node1)) {
          if ((DevicePathType (Node1) == 0x03) && (DevicePathSubType (Node1) == 0x0e)) {
...
# 221 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/ConsoleOption.c"
void
ChangeVariableDevicePath (
  EFI_DEVICE_PATH_PROTOCOL *DevicePath
  )
...
# 289 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/ConsoleOption.c"
BOOLEAN
RetrieveUartUid (
  EFI_HANDLE Handle,
  UINT32 *AcpiUid
  )
{
  ...
  for ( ; !IsDevicePathEnd (DevicePath); DevicePath = NextDevicePathNode (DevicePath)) {
    if ((DevicePathType (DevicePath) == 0x03) && (DevicePathSubType (DevicePath) == 0x0e)) {
      break;
    }
  ...
  if ((Acpi != ((void *) 0)) && IsIsaSerialNode (Acpi)) {
    if (AcpiUid != ((void *) 0)) {
...
# 389 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/ConsoleOption.c"
BOOLEAN
...
# 404 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/ConsoleOption.c"
EFI_STATUS
LocateSerialIo (
  void
  )
{
  ...
  for (Index = 0; Index < NoHandles; Index++) {
    ...
    if ((Acpi != ((void *) 0)) && IsIsaSerialNode (Acpi)) {
      NewMenuEntry = BOpt_CreateMenuEntry (0x5);
      ...
      if (((void *) 0) == NewMenuEntry->DisplayString) {
        NewMenuEntry->DisplayString = UiDevicePathToStr (DevicePath);
      }

      NewMenuEntry->HelpString = ((void *) 0);

      NewMenuEntry->DisplayStringToken = HiiSetString (mBmmCallbackInfo->BmmHiiHandle, 0, NewMenuEntry->DisplayString, ((void *) 0));
  ...
  GetEfiGlobalVariable2 (L"ConOut", (void **)&OutDevicePath, ((void *) 0));
  GetEfiGlobalVariable2 (L"ConIn", (void **)&InpDevicePath, ((void *) 0));
  GetEfiGlobalVariable2 (L"ErrOut", (void **)&ErrDevicePath, ((void *) 0));
  if (OutDevicePath != ((void *) 0)) {
    UpdateComAttributeFromVariable (OutDevicePath);
  }

  if (InpDevicePath != ((void *) 0)) {
    UpdateComAttributeFromVariable (InpDevicePath);
  }

  if (ErrDevicePath != ((void *) 0)) {
    UpdateComAttributeFromVariable (ErrDevicePath);
  }

  for (Index = 0; Index < TerminalMenu.MenuNumber; Index++) {
    NewMenuEntry = BOpt_GetMenuEntry (&TerminalMenu, Index);
    if (((void *) 0) == NewMenuEntry) {
    ...
    NewTerminalContext->IsConIn = ((BOOLEAN)(0==1));
    NewTerminalContext->IsConOut = ((BOOLEAN)(0==1));
    NewTerminalContext->IsStdErr = ((BOOLEAN)(0==1));

    Vendor.Header.Type = 0x03;
    Vendor.Header.SubType = 0x0a;
    ...
    for (Index2 = 0; Index2 < ((sizeof (TerminalTypeGuid) / sizeof ((TerminalTypeGuid)[0]))); Index2++) {
      ...
      if (NewMenuEntry->HelpString != ((void *) 0)) {
      ...
      if (MatchDevicePaths (OutDevicePath, NewDevicePath)) {
        NewTerminalContext->IsConOut = ((BOOLEAN)(1==1));
        NewTerminalContext->TerminalType = (UINT8)Index2;
      }

      if (MatchDevicePaths (InpDevicePath, NewDevicePath)) {
        NewTerminalContext->IsConIn = ((BOOLEAN)(1==1));
        NewTerminalContext->TerminalType = (UINT8)Index2;
      }

      if (MatchDevicePaths (ErrDevicePath, NewDevicePath)) {
        NewTerminalContext->IsStdErr = ((BOOLEAN)(1==1));
        NewTerminalContext->TerminalType = (UINT8)Index2;
      }
    }
  }
...
# 621 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/ConsoleOption.c"
EFI_STATUS
UpdateComAttributeFromVariable (
  EFI_DEVICE_PATH_PROTOCOL *DevicePath
  )
    ...
    while (!IsDevicePathEnd (Node)) {
      ...
      if ((DevicePathType (Node) == 0x03) && (DevicePathSubType (Node) == 0x0e)) {
        ...
        while (!IsDevicePathEnd (SerialNode)) {
          if ((DevicePathType (SerialNode) == 0x03) && (DevicePathSubType (SerialNode) == 0x0e)) {
...
# 746 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/ConsoleOption.c"
EFI_STATUS
GetConsoleMenu (
  UINTN ConsoleMenuType
  )
{
  EFI_DEVICE_PATH_PROTOCOL *DevicePath;
  ...
  DevicePath = ((void *) 0);
  AllDevicePath = ((void *) 0);
  AllCount = 0;
  switch (ConsoleMenuType) {
    case 0x6:
      ConsoleMenu = &ConsoleInpMenu;
      GetEfiGlobalVariable2 (L"ConIn", (void **)&DevicePath, ((void *) 0));
      GetEfiGlobalVariable2 (L"ConInDev", (void **)&AllDevicePath, ((void *) 0));
      break;

    case 0x7:
      ConsoleMenu = &ConsoleOutMenu;
      GetEfiGlobalVariable2 (L"ConOut", (void **)&DevicePath, ((void *) 0));
      GetEfiGlobalVariable2 (L"ConOutDev", (void **)&AllDevicePath, ((void *) 0));
      break;

    case 0x8:
      ConsoleMenu = &ConsoleErrMenu;
      GetEfiGlobalVariable2 (L"ErrOut", (void **)&DevicePath, ((void *) 0));
      GetEfiGlobalVariable2 (L"ErrOutDev", (void **)&AllDevicePath, ((void *) 0));
      break;
  ...
  for (Index = 0; Index < AllCount; Index++) {
    ...
    NewMenuEntry = BOpt_CreateMenuEntry (0x1);
    if (((void *) 0) == NewMenuEntry) {
      return ((RETURN_STATUS)(0x8000000000000000ULL | (9)));
    }
    ...
    do { if (((BOOLEAN)(0==1))) { (void) (NewConsoleContext->DevicePath != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
    ...
    if (((void *) 0) == NewMenuEntry->HelpString) {
      NewMenuEntry->HelpStringToken = NewMenuEntry->DisplayStringToken;
    } else {
      NewMenuEntry->HelpStringToken = HiiSetString (mBmmCallbackInfo->BmmHiiHandle, 0, NewMenuEntry->HelpString, ((void *) 0));
    }
...
# 899 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/ConsoleOption.c"
BOOLEAN
IsTerminalDevicePath (
  EFI_DEVICE_PATH_PROTOCOL *DevicePath,
  TYPE_OF_TERMINAL *Termi,
  ...
  )
{
  ...
  if ((Vendor == ((void *) 0)) ||
      (DevicePathType (Vendor) != 0x03) ||
      (DevicePathSubType (Vendor) != 0x0a) ||
      (Uart == ((void *) 0)))
  {
    return ((BOOLEAN)(0==1));
  }
  ...
  for (Index = 0; Index < (sizeof (TerminalTypeGuid) / sizeof ((TerminalTypeGuid)[0])); Index++) {
    if (CompareGuid (&Vendor->Guid, &TerminalTypeGuid[Index])) {
      *Termi = Index;
      IsTerminal = ((BOOLEAN)(1==1));
      break;
    }
  }

  if (Index == (sizeof (TerminalTypeGuid) / sizeof ((TerminalTypeGuid)[0]))) {
    IsTerminal = ((BOOLEAN)(0==1));
  }
  ...
  )
{
  ...
  CurrentCol = _gPcd_BinaryPatch_PcdSetupConOutColumn;
  CurrentRow = _gPcd_BinaryPatch_PcdSetupConOutRow;
...
# 1017 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/ConsoleOption.c"
void
GetConsoleInCheck (
  BMM_CALLBACK_DATA *CallbackData
  )
...
# 1055 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/ConsoleOption.c"
void
GetConsoleOutCheck (
  BMM_CALLBACK_DATA *CallbackData
  )
...
# 1092 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/ConsoleOption.c"
void
GetConsoleErrCheck (
  BMM_CALLBACK_DATA *CallbackData
  )
...
# 1129 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/BootMaintenanceManagerUiLib/ConsoleOption.c"
void
GetTerminalAttribute (
  BMM_CALLBACK_DATA *CallbackData
  )
{
  ...
  for (TerminalIndex = 0; ((TerminalIndex < TerminalMenu.MenuNumber) &&
                           (TerminalIndex < 100)); TerminalIndex++)
  {

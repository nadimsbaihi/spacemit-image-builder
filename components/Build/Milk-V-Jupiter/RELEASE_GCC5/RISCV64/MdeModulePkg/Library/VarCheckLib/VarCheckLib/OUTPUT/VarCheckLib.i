# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/VarCheckLib/VarCheckLib.c"
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/MdeModulePkg/Library/VarCheckLib/VarCheckLib//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/riscv64-linux-gnu/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/MdeModulePkg/Library/VarCheckLib/VarCheckLib/DEBUG/AutoGen.h" 1
# 16 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/MdeModulePkg/Library/VarCheckLib/VarCheckLib/DEBUG/AutoGen.h"
...
# 17 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/MdeModulePkg/Library/VarCheckLib/VarCheckLib/DEBUG/AutoGen.h" 2
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/VarCheckLib/VarCheckLib.c"
# 9 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/VarCheckLib/VarCheckLib.c"
...
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/VarCheckLib/VarCheckLib.c" 2
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/VarCheckLib/VarCheckLib.c" 2
...
# 12 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/VarCheckLib/VarCheckLib.c" 2
...
# 13 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/VarCheckLib/VarCheckLib.c" 2
...
# 14 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/VarCheckLib/VarCheckLib.c" 2
...
extern EFI_GUID gEfiGlobalVariableGuid;
# 16 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/VarCheckLib/VarCheckLib.c" 2
...
extern EFI_GUID gEfiHardwareErrorVariableGuid;
# 17 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/VarCheckLib/VarCheckLib.c" 2

BOOLEAN mVarCheckLibEndOfDxe = ((BOOLEAN)(0==1));



UINTN mVarCheckLibEndOfDxeCallbackCount = 0;
UINTN mVarCheckLibEndOfDxeCallbackMaxCount = 0;
VAR_CHECK_END_OF_DXE_CALLBACK *mVarCheckLibEndOfDxeCallback = ((void *) 0);

UINTN mVarCheckLibAddressPointerCount = 0;
UINTN mVarCheckLibAddressPointerMaxCount = 0;
void ***mVarCheckLibAddressPointer = ((void *) 0);

UINTN mNumberOfVarCheckHandler = 0;
UINTN mMaxNumberOfVarCheckHandler = 0;
VAR_CHECK_SET_VARIABLE_CHECK_HANDLER *mVarCheckHandlerTable = ((void *) 0);
...
VARIABLE_ENTRY_PROPERTY **mVarCheckVariableTable = ((void *) 0);
...
# 106 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/VarCheckLib/VarCheckLib.c"
BOOLEAN
...
# 125 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/VarCheckLib/VarCheckLib.c"
VAR_CHECK_VARIABLE_PROPERTY *
...
# 169 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/VarCheckLib/VarCheckLib.c"
VAR_CHECK_VARIABLE_PROPERTY *
...
# 203 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/VarCheckLib/VarCheckLib.c"
EFI_STATUS
...
# 262 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/VarCheckLib/VarCheckLib.c"
EFI_STATUS
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "VarCheckLibRegisterEndOfDxeCallback - 0x%x %r\n", Callback, Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));

  return Status;
}
# 302 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/VarCheckLib/VarCheckLib.c"
void ***
  ...
  )
{
  ...
  if (mVarCheckLibEndOfDxeCallback != ((void *) 0)) {
    ...
    mVarCheckLibEndOfDxeCallback = ((void *) 0);
  }

  mVarCheckLibEndOfDxe = ((BOOLEAN)(1==1));

  if (AddressPointerCount == ((void *) 0)) {
    if (mVarCheckLibAddressPointer != ((void *) 0)) {
      ...
      mVarCheckLibAddressPointer = ((void *) 0);
    }
  ...
  if (TempTable != ((void *) 0)) {
    ...
    do { if (((BOOLEAN)(0==1))) { (void) (mVarCheckLibAddressPointerCount == TotalCount); } } while (((BOOLEAN)(0==1)));
...
# 396 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/VarCheckLib/VarCheckLib.c"
EFI_STATUS
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "VarCheckLibRegisterAddressPointer - 0x%x %r\n", AddressPointer, Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));

  return Status;
}
# 438 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/VarCheckLib/VarCheckLib.c"
EFI_STATUS
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "VarCheckLibRegisterSetVariableCheckHandler - 0x%x %r\n", Handler, Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));

  return Status;
}
# 481 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/VarCheckLib/VarCheckLib.c"
EFI_STATUS
  ...
  )
{
  ...
  if ((Name == ((void *) 0)) || (Name[0] == 0) || (Guid == ((void *) 0))) {
    return ((RETURN_STATUS)(0x8000000000000000ULL | (2)));
  }

  if (VariableProperty == ((void *) 0)) {
    return ((RETURN_STATUS)(0x8000000000000000ULL | (2)));
  }

  if (VariableProperty->Revision != 0x0001) {
    return ((RETURN_STATUS)(0x8000000000000000ULL | (2)));
  }
  ...
  Property = VariablePropertyGetFunction (Name, Guid, ((BOOLEAN)(0==1)));
  if (Property != ((void *) 0)) {
...
# 556 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/VarCheckLib/VarCheckLib.c"
EFI_STATUS
  ...
  )
{
  ...
  Property = VariablePropertyGetFunction (Name, Guid, ((BOOLEAN)(1==1)));





  if ((Property != ((void *) 0)) && (Property->Revision == 0x0001)) {
...
# 605 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/VarCheckLib/VarCheckLib.c"
EFI_STATUS
  ...
  )
{
  ...
  Property = VariablePropertyGetFunction (VariableName, VendorGuid, ((BOOLEAN)(1==1)));
  ...
  if ((Property != ((void *) 0)) && (Property->Revision == 0x0001)) {
    if ((RequestSource != VarCheckFromTrusted) && ((Property->Property & 0x00000001) != 0)) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Variable Check ReadOnly variable fail %r - %g:%s\n", ((RETURN_STATUS)(0x8000000000000000ULL | (8))), VendorGuid, VariableName); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    ...
    if (!((((Attributes & 0x00000040) == 0) && (DataSize == 0)) || (Attributes == 0))) {
      ...
      if ((Property->Attributes != 0) && ((Attributes & (~0x00000040)) != Property->Attributes)) {
        do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Variable Check Attributes(0x%08x to 0x%08x) fail %r - %g:%s\n", Property->Attributes, Attributes, ((RETURN_STATUS)(0x8000000000000000ULL | (2))), VendorGuid, VariableName); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
        return ((RETURN_STATUS)(0x8000000000000000ULL | (2)));
      }

      if (DataSize != 0) {
        if ((DataSize < Property->MinSize) || (DataSize > Property->MaxSize)) {
          do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Variable Check DataSize fail(0x%x not in 0x%x - 0x%x) %r - %g:%s\n", DataSize, Property->MinSize, Property->MaxSize, ((RETURN_STATUS)(0x8000000000000000ULL | (2))), VendorGuid, VariableName); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
          return ((RETURN_STATUS)(0x8000000000000000ULL | (2)));
        }
      }
    }
  ...
  for (Index = 0; Index < mNumberOfVarCheckHandler; Index++) {
    ...
    if ((Status == ((RETURN_STATUS)(0x8000000000000000ULL | (8)))) && (RequestSource == VarCheckFromTrusted)) {
    ...
    if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Variable Check handler fail %r - %g:%s\n", Status, VendorGuid, VariableName); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
      return Status;
    }
  }

# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/DxeSecurityManagementLib/DxeSecurityManagementLib.c"
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/MdeModulePkg/Library/DxeSecurityManagementLib/DxeSecurityManagementLib//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/riscv64-linux-gnu/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/MdeModulePkg/Library/DxeSecurityManagementLib/DxeSecurityManagementLib/DEBUG/AutoGen.h" 1
# 16 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/MdeModulePkg/Library/DxeSecurityManagementLib/DxeSecurityManagementLib/DEBUG/AutoGen.h"
...
# 17 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/MdeModulePkg/Library/DxeSecurityManagementLib/DxeSecurityManagementLib/DEBUG/AutoGen.h" 2
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/DxeSecurityManagementLib/DxeSecurityManagementLib.c"
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/DxeSecurityManagementLib/DxeSecurityManagementLib.c"
...
extern EFI_GUID gEfiLoadFileProtocolGuid;
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/DxeSecurityManagementLib/DxeSecurityManagementLib.c" 2
...
# 12 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/DxeSecurityManagementLib/DxeSecurityManagementLib.c" 2
...
# 13 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/DxeSecurityManagementLib/DxeSecurityManagementLib.c" 2
...
# 14 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/DxeSecurityManagementLib/DxeSecurityManagementLib.c" 2
...
# 15 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/DxeSecurityManagementLib/DxeSecurityManagementLib.c" 2
...
# 16 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/DxeSecurityManagementLib/DxeSecurityManagementLib.c" 2
...
# 17 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/DxeSecurityManagementLib/DxeSecurityManagementLib.c" 2
# 29 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/DxeSecurityManagementLib/DxeSecurityManagementLib.c"
typedef struct {
  ...
  )
{
  ...
  mSecurityTable = ReallocatePool (
                     ...
                     (mMaxNumberOfSecurityHandler + 0x10) * sizeof (SECURITY_INFO),
                     mSecurityTable
                     );
  ...
  mMaxNumberOfSecurityHandler = mMaxNumberOfSecurityHandler + 0x10;
  return (RETURN_STATUS)(0);
}
# 94 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/DxeSecurityManagementLib/DxeSecurityManagementLib.c"
BOOLEAN
CheckAuthenticationOperation (
  UINT32 CurrentAuthOperation,
  UINT32 CheckAuthOperation
  )
{



  do { if (((BOOLEAN)(0==1))) { (void) ((CheckAuthOperation & ~((0x01 | 0x02 | 0x04) | 0x10 | 0x80000000)) == 0); } } while (((BOOLEAN)(0==1)));





  if ((CurrentAuthOperation & 0x04) == 0x04) {
    if (((CheckAuthOperation & 0x04) == 0x04) ||
        ((CheckAuthOperation & (0x01 | 0x02 | 0x04)) == 0x00))
    {
      return ((BOOLEAN)(1==1));
    } else {
      return ((BOOLEAN)(0==1));
...
# 140 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/DxeSecurityManagementLib/DxeSecurityManagementLib.c"
EFI_STATUS
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (SecurityHandler != ((void *) 0)); } } while (((BOOLEAN)(0==1)));




  do { if (((BOOLEAN)(0==1))) { (void) (CheckAuthenticationOperation (mCurrentAuthOperation, AuthenticationOperation)); } } while (((BOOLEAN)(0==1)));
...
# 209 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/DxeSecurityManagementLib/DxeSecurityManagementLib.c"
EFI_STATUS
  ...
  )
{
  ...
  for (Index = 0; Index < mNumberOfSecurityHandler; Index++) {
    if ((mSecurityTable[Index].SecurityOperation & 0x80000000) == 0x80000000) {
      ...
      if (FileBuffer == ((void *) 0)) {
        ...
        FileBuffer = GetFileBufferByFilePath (((BOOLEAN)(0==1)), FilePath, &FileSize, &AuthenticationStatus);
        if (FileBuffer == ((void *) 0)) {



          FileBuffer = GetFileBufferByFilePath (((BOOLEAN)(1==1)), FilePath, &FileSize, &AuthenticationStatus);
        }

        if ((FileBuffer != ((void *) 0)) && (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL))) {
  ...
  )
{
  ...
  mSecurity2Table = ReallocatePool (
                      ...
                      (mMaxNumberOfSecurity2Handler + 0x10) * sizeof (SECURITY2_INFO),
                      mSecurity2Table
                      );
  ...
  mMaxNumberOfSecurity2Handler = mMaxNumberOfSecurity2Handler + 0x10;
  return (RETURN_STATUS)(0);
}
# 344 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/DxeSecurityManagementLib/DxeSecurityManagementLib.c"
BOOLEAN
  ...
  )
{
  ...
  if (CheckAuthOperation == 0x00) {
    return ((BOOLEAN)(0==1));
  }

  if ((CheckAuthOperation & ~((0x01 | 0x02 | 0x04) |
                              (0x08 | 0x10) |
                              0x80000000)) != 0)
  {
    return ((BOOLEAN)(0==1));
  ...
  if ((CurrentAuthOperation & 0x04) == 0x04) {
    if (((CheckAuthOperation & 0x04) == 0x04) ||
        ((CheckAuthOperation & (0x01 | 0x02 | 0x04)) == 0))
    {
      return ((BOOLEAN)(1==1));
    } else {
      return ((BOOLEAN)(0==1));
...
# 399 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/DxeSecurityManagementLib/DxeSecurityManagementLib.c"
EFI_STATUS
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (Security2Handler != ((void *) 0)); } } while (((BOOLEAN)(0==1)));




  do { if (((BOOLEAN)(0==1))) { (void) (CheckAuthentication2Operation (mCurrentAuthOperation2, AuthenticationOperation)); } } while (((BOOLEAN)(0==1)));
...
# 478 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Library/DxeSecurityManagementLib/DxeSecurityManagementLib.c"
EFI_STATUS
  ...
  )
{
  ...
  if ((File == ((void *) 0)) && (FileBuffer == ((void *) 0))) {
    return ((RETURN_STATUS)(0x8000000000000000ULL | (2)));
  }
  ...
  for (Index = 0; Index < mNumberOfSecurity2Handler; Index++) {
    ...
    if (((FileBuffer != ((void *) 0)) && ((mSecurity2Table[Index].Security2Operation & (0x01 | 0x02 | 0x04)) != 0)) ||
        ((FileBuffer == ((void *) 0)) && ((mSecurity2Table[Index].Security2Operation & (0x08 | 0x10)) != 0)))
    {

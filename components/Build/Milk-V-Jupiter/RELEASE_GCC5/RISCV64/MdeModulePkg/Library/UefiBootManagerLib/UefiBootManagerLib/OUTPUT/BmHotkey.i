# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmHotkey.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmHotkey.c"
# 10 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmHotkey.c"
...
# 11 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmHotkey.c" 2




EFI_LOCK mBmHotkeyLock = {16, 4, EfiLockReleased };
LIST_ENTRY mBmHotkeyList = {&(mBmHotkeyList), &(mBmHotkeyList)};
EFI_EVENT mBmHotkeyTriggered = ((void *) 0);
BOOLEAN mBmHotkeyServiceStarted = ((BOOLEAN)(0==1));
...
EFI_BOOT_MANAGER_KEY_OPTION *mBmContinueKeyOption = ((void *) 0);
void *mBmTxtInExRegistration = ((void *) 0);
# 36 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmHotkey.c"
UINTN
BmSizeOfKeyOption (
  const EFI_BOOT_MANAGER_KEY_OPTION *KeyOption
  )
{
  return ((UINTN) __builtin_offsetof(EFI_BOOT_MANAGER_KEY_OPTION, Keys))
         + KeyOption->KeyData.Options.InputKeyCount * sizeof (EFI_INPUT_KEY);
}
# 55 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmHotkey.c"
BOOLEAN
BmIsKeyOptionValid (
  const EFI_BOOT_MANAGER_KEY_OPTION *KeyOption,
  UINTN KeyOptionSize
...
{
  UINT16 OptionName[sizeof ("PlatformRecovery####")];
  UINT8 *BootOption;
...
# 106 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmHotkey.c"
BOOLEAN
...
# 149 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmHotkey.c"
void
BmCollectKeyOptions (
  CHAR16 *Name,
  EFI_GUID *Guid,
  ...
  )
{
  ...
  if (BmIsKeyOptionVariable (Name, Guid, &OptionNumber)) {
    ...
    do { if (((BOOLEAN)(0==1))) { (void) (KeyOption != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
    if (BmIsKeyOptionValid (KeyOption, KeyOptionSize)) {
      ...
      do { if (((BOOLEAN)(0==1))) { (void) (Param->KeyOptions != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
...
# 201 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmHotkey.c"
EFI_BOOT_MANAGER_KEY_OPTION *
BmGetKeyOptions (
  UINTN *Count
  )
...
# 231 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmHotkey.c"
BOOLEAN
BmBitSet (
  UINT32 Value,
  UINT32 Bit
...
# 250 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmHotkey.c"
EFI_STATUS
  ...
  )
{
  ...
  while (KeyOption->KeyData.Options.InputKeyCount < sizeof (KeyOption->Keys) / sizeof (KeyOption->Keys[0])) {
    Key = ((sizeof (EFI_INPUT_KEY *) < sizeof (UINTN)) ? (EFI_INPUT_KEY *)(__builtin_va_arg (Args, UINTN)) : (EFI_INPUT_KEY *)(__builtin_va_arg (Args, EFI_INPUT_KEY *)));
    if (Key == ((void *) 0)) {
      break;
    }
...
# 349 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmHotkey.c"
EFI_STATUS
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "[Bds]BmHotkeyCallback: %04x:%04x\n", KeyData->Key.ScanCode, KeyData->Key.UnicodeChar); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  ...
  {
    Hotkey = (((BM_HOTKEY *) (void *) ((CHAR8 *) (Link) - ((UINTN) __builtin_offsetof(BM_HOTKEY, Link))))->Signature != ((('b') | ('m' << 8)) | ((('h') | ('k' << 8)) << 16))) ? ((void *) 0) : ((BM_HOTKEY *) (void *) ((CHAR8 *) (Link) - ((UINTN) __builtin_offsetof(BM_HOTKEY, Link))));




    do { if (((BOOLEAN)(0==1))) { (void) (Hotkey->WaitingKey < (sizeof (Hotkey->KeyData) / sizeof (Hotkey->KeyData[0]))); } } while (((BOOLEAN)(0==1)));
    HotkeyData = &Hotkey->KeyData[Hotkey->WaitingKey];
    if ((KeyData->Key.ScanCode == HotkeyData->Key.ScanCode) &&
        (KeyData->Key.UnicodeChar == HotkeyData->Key.UnicodeChar) &&
        (((KeyData->KeyState.KeyShiftState & 0x80000000) != 0) ?
         (KeyData->KeyState.KeyShiftState == HotkeyData->KeyState.KeyShiftState) : ((BOOLEAN)(1==1))
        )
        )
    {
      ...
      if (Hotkey->WaitingKey == Hotkey->CodeCount) {
        ...
        if (!Hotkey->IsContinue) {
          ...
          do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "[Bds]Hotkey for %s pressed - %r\n", OptionName, Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
          if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
            mBmHotkeyBootOption.OptionNumber = LoadOptionNumberUnassigned;
          }
        } else {
          do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "[Bds]Continue key pressed!\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
        }
      }
    } else {
...
# 449 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmHotkey.c"
EFI_HANDLE *
...
# 496 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmHotkey.c"
EFI_STATUS
  ...
  for (Index = 0; Index < HandleCount; Index++) {
    ...
    for (KeyIndex = 0; KeyIndex < Hotkey->CodeCount; KeyIndex++) {
      ...
      if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
        ...
        do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "[Bds]UnregisterKeyNotify: %04x/%04x %r\n", Hotkey->KeyData[KeyIndex].Key.ScanCode, Hotkey->KeyData[KeyIndex].Key.UnicodeChar, Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
      }
    }
  }
...
# 543 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmHotkey.c"
EFI_STATUS
  ...
  )
{
  ...
  for (Index = 0; Index < Hotkey->CodeCount; Index++) {
    ...
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "[Bds]RegisterKeyNotify: %04x/%04x %08x/%02x %r\n", Hotkey->KeyData[Index].Key.ScanCode, Hotkey->KeyData[Index].Key.UnicodeChar, Hotkey->KeyData[Index].KeyState.KeyShiftState, Hotkey->KeyData[Index].KeyState.KeyToggleState, Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
...
# 590 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmHotkey.c"
void
BmGenerateKeyShiftState (
  UINTN Depth,
  EFI_BOOT_MANAGER_KEY_OPTION *KeyOption,
  UINT32 KeyShiftState,
  UINT32 *KeyShiftStates,
  ...
  switch (Depth) {
    case 0:
      if (KeyOption->KeyData.Options.ShiftPressed) {
        BmGenerateKeyShiftState (Depth + 1, KeyOption, KeyShiftState | 0x00000001, KeyShiftStates, KeyShiftStateCount);
        BmGenerateKeyShiftState (Depth + 1, KeyOption, KeyShiftState | 0x00000002, KeyShiftStates, KeyShiftStateCount);
      } else {
    ...
    case 1:
      if (KeyOption->KeyData.Options.ControlPressed) {
        BmGenerateKeyShiftState (Depth + 1, KeyOption, KeyShiftState | 0x00000004, KeyShiftStates, KeyShiftStateCount);
        BmGenerateKeyShiftState (Depth + 1, KeyOption, KeyShiftState | 0x00000008, KeyShiftStates, KeyShiftStateCount);
      } else {
        BmGenerateKeyShiftState (Depth + 1, KeyOption, KeyShiftState, KeyShiftStates, KeyShiftStateCount);
      }
    ...
    case 2:
      if (KeyOption->KeyData.Options.AltPressed) {
        BmGenerateKeyShiftState (Depth + 1, KeyOption, KeyShiftState | 0x00000010, KeyShiftStates, KeyShiftStateCount);
        BmGenerateKeyShiftState (Depth + 1, KeyOption, KeyShiftState | 0x00000020, KeyShiftStates, KeyShiftStateCount);
      } else {
        BmGenerateKeyShiftState (Depth + 1, KeyOption, KeyShiftState, KeyShiftStates, KeyShiftStateCount);
      }
    ...
    case 3:
      if (KeyOption->KeyData.Options.LogoPressed) {
        BmGenerateKeyShiftState (Depth + 1, KeyOption, KeyShiftState | 0x00000040, KeyShiftStates, KeyShiftStateCount);
        BmGenerateKeyShiftState (Depth + 1, KeyOption, KeyShiftState | 0x00000080, KeyShiftStates, KeyShiftStateCount);
      } else {
        BmGenerateKeyShiftState (Depth + 1, KeyOption, KeyShiftState, KeyShiftStates, KeyShiftStateCount);
      }
    ...
    case 4:
      if (KeyOption->KeyData.Options.MenuPressed) {
        KeyShiftState |= 0x00000100;
      }

      if (KeyOption->KeyData.Options.SysReqPressed) {
        KeyShiftState |= 0x00000200;
      }
  ...
  )
{
  ...
  BmGenerateKeyShiftState (0, KeyOption, 0x80000000, KeyShiftStates, &KeyShiftStateCount);
  do { if (((BOOLEAN)(0==1))) { (void) (KeyShiftStateCount <= (sizeof (KeyShiftStates) / sizeof ((KeyShiftStates)[0]))); } } while (((BOOLEAN)(0==1)));
  ...
  for (Index = 0; Index < KeyShiftStateCount; Index++) {
    ...
    Hotkey->Signature = ((('b') | ('m' << 8)) | ((('h') | ('k' << 8)) << 16));
...
# 729 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmHotkey.c"
void
  ...
  )
{
  ...
  while (((BOOLEAN)(1==1))) {
    ...
    for (Link = GetFirstNode (&mBmHotkeyList); !IsNull (&mBmHotkeyList, Link); Link = GetNextNode (&mBmHotkeyList, Link)) {
      BmRegisterHotkeyNotify (TxtInEx, (((BM_HOTKEY *) (void *) ((CHAR8 *) (Link) - ((UINTN) __builtin_offsetof(BM_HOTKEY, Link))))->Signature != ((('b') | ('m' << 8)) | ((('h') | ('k' << 8)) << 16))) ? ((void *) 0) : ((BM_HOTKEY *) (void *) ((CHAR8 *) (Link) - ((UINTN) __builtin_offsetof(BM_HOTKEY, Link)))));
    }

    EfiReleaseLock (&mBmHotkeyLock);
  }
}
# 786 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmHotkey.c"
EFI_STATUS
BmFreeKeyOptions (
  EFI_BOOT_MANAGER_KEY_OPTION *KeyOptions,
  UINTN KeyOptionCount
...
# 811 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmHotkey.c"
EFI_STATUS
  ...
  )
{
  ...
  if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    ...
    do { if (((BOOLEAN)(0==1))) { (void) (mBmContinueKeyOption != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "[Bds]Stop Hotkey Service!\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
...
# 880 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmHotkey.c"
EFI_STATUS
  ...
  )
{
  ...
  GetEfiGlobalVariable2 (L"BootOptionSupport", (void **)&BootOptionSupport, ((void *) 0));
  if (BootOptionSupport != ((void *) 0)) {
    if ((*BootOptionSupport & 0x00000001) != 0) {
      mBmHotkeySupportCount = ((*BootOptionSupport & 0x00000300) >> LowBitSet32 (0x00000300));
    }
  ...
  if (mBmHotkeySupportCount == 0) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Bds: BootOptionSupport NV variable forbids starting the hotkey service.\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    return ((RETURN_STATUS)(0x8000000000000000ULL | (3)));
  }
  ...
  mBmHotkeyServiceStarted = ((BOOLEAN)(1==1));
  return Status;
}
# 970 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmHotkey.c"
EFI_STATUS
  ...
  )
{
  ...
  void *BootOption;
  UINTN BootOptionSize;
  CHAR16 BootOptionName[sizeof ("PlatformRecovery####")];
  EFI_BOOT_MANAGER_KEY_OPTION KeyOption;
  EFI_BOOT_MANAGER_KEY_OPTION *KeyOptions;
  UINTN KeyOptionCount;
  UINTN Index;
...
# 1087 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmHotkey.c"
EFI_STATUS
  ...
  )
{
  ...
  for (Link = GetFirstNode (&mBmHotkeyList); !IsNull (&mBmHotkeyList, Link); ) {
    ...
    for (Index = 0; Match && (Index < Hotkey->CodeCount); Index++) {
      ...
      if (
          (BmBitSet (ShiftState, 0x00000001 | 0x00000002) != KeyOption.KeyData.Options.ShiftPressed) ||
          (BmBitSet (ShiftState, 0x00000004 | 0x00000008) != KeyOption.KeyData.Options.ControlPressed) ||
          (BmBitSet (ShiftState, 0x00000010 | 0x00000020) != KeyOption.KeyData.Options.AltPressed) ||
          (BmBitSet (ShiftState, 0x00000040 | 0x00000080) != KeyOption.KeyData.Options.LogoPressed) ||
          (BmBitSet (ShiftState, 0x00000100) != KeyOption.KeyData.Options.MenuPressed) ||
          (BmBitSet (ShiftState, 0x00000200) != KeyOption.KeyData.Options.SysReqPressed) ||

# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmConnect.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmConnect.c"
# 9 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmConnect.c"
...
# 10 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmConnect.c" 2
# 18 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmConnect.c"
void
...
# 65 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmConnect.c"
void
...
# 106 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmConnect.c"
EFI_STATUS
...
# 172 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmConnect.c"
        Status = gBS->ConnectController (Handle, ((void *) 0), RemainingDevicePath, ((BOOLEAN)(0==1)));
        if (Status == ((RETURN_STATUS)(0x8000000000000000ULL | (14)))) {
          Status = (RETURN_STATUS)(0);
        }

        if (MatchingHandle != ((void *) 0)) {
  ...
  } while (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) && !IsDevicePathEnd (RemainingDevicePath));

  do { if (((BOOLEAN)(0==1))) { (void) ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) || IsDevicePathEnd (RemainingDevicePath)); } } while (((BOOLEAN)(0==1)));

  return Status;
}
# 200 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmConnect.c"
void
...
# 244 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmConnect.c"
EFI_STATUS
BmConnectUsbShortFormDevicePath (
  EFI_DEVICE_PATH_PROTOCOL *DevicePath
  )
{
  ...
  if ((DevicePathType (DevicePath) != 0x03) ||
      ((DevicePathSubType (DevicePath) != 0x0f) && (DevicePathSubType (DevicePath) != 0x10))
      )
  {
    return ((RETURN_STATUS)(0x8000000000000000ULL | (2)));
  }
  ...
  AtLeastOneConnected = ((BOOLEAN)(0==1));
    ...
    for (Index = 0; Index < HandleCount; Index++) {
      ...
      if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
            ...
            )
        {
          ...
          if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
            AtLeastOneConnected = ((BOOLEAN)(1==1));
          }
        }
      }
    }
  ...
  return AtLeastOneConnected ? (RETURN_STATUS)(0) : ((RETURN_STATUS)(0x8000000000000000ULL | (14)));
}

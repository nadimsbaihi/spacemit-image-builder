# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmBootDescription.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmBootDescription.c"
# 10 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmBootDescription.c"
...
# 11 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmBootDescription.c" 2
...
LIST_ENTRY mPlatformBootDescriptionHandlers = {&(mPlatformBootDescriptionHandlers), &(mPlatformBootDescriptionHandlers)};
# 98 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmBootDescription.c"
BM_BOOT_TYPE
BmDevicePathType (
  EFI_DEVICE_PATH_PROTOCOL *DevicePath
  )
{
  ...
  for (Node = DevicePath; !IsDevicePathEndType (Node); Node = NextDevicePathNode (Node)) {
    switch (DevicePathType (Node)) {
      case 0x02:
        if (((((ACPI_HID_DEVICE_PATH *)Node)->HID) >> 16) == 0x0604) {
      ...
      case 0x01:
        if (DevicePathSubType (Node) == 0x05) {
      ...
      case 0x03:
        ...
        do {
          NextNode = NextDevicePathNode (NextNode);
                 ...
                 (DevicePathType (NextNode) == 0x03) &&
                 (DevicePathSubType (NextNode) == 0x11)
                 );
...
# 220 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmBootDescription.c"
CHAR16 *
  ...
  )
{
  ...
  Count = IsMmc ? (sizeof (mMmcManufacturers) / sizeof ((mMmcManufacturers)[0]))
                : (sizeof (mSdManufacturers) / sizeof ((mSdManufacturers)[0]));
...
# 250 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmBootDescription.c"
CHAR16 *
...
# 288 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmBootDescription.c"
CHAR16 *
BmGetSdMmcDescription (
  CHAR16 *ManufacturerName,
  UINT8 *ProductName,
  UINT8 ProductNameLength,
  ...
  )
{
  ...
  DescSize = StrSize (ManufacturerName) - sizeof (CHAR16)
             + sizeof (CHAR16)
             + ProductNameLength * sizeof (CHAR16)
             + sizeof (CHAR16)
             + sizeof (UINT32) * 2 * sizeof (CHAR16)
             + sizeof (CHAR16)
             + StrSize (DeviceType);
...
# 339 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmBootDescription.c"
CHAR16 *
  ...
  )
{
      ...
      CompareGuid (&DiskInfo->Interface, &gEfiDiskInfoIdeInterfaceGuid))
  {
    ...
    if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
      ...
      do { if (((BOOLEAN)(0==1))) { (void) (Description != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
      ...
      do { if (((BOOLEAN)(0==1))) { (void) (Length == ModelNameLength + SerialNumberLength + 2); } } while (((BOOLEAN)(0==1)));
             ...
             CompareGuid (&DiskInfo->Interface, &gEfiDiskInfoUfsInterfaceGuid))
  {
    ...
    if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
      Description = AllocateZeroPool ((8 + 16 + 2) * sizeof (CHAR16));
      do { if (((BOOLEAN)(0==1))) { (void) (Description != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
      ...
      StrPtr = (CHAR8 *)(&InquiryData.Reserved_5_95[3]);
      Temp = StrPtr[8];
      StrPtr[8] = '\0';
      AsciiStrToUnicodeStrS (StrPtr, Description, 8 + 1);
      StrPtr[8] = Temp;
      ...
      StrPtr = (CHAR8 *)(&InquiryData.Reserved_5_95[11]);
      StrPtr[16] = '\0';
      AsciiStrToUnicodeStrS (StrPtr, Description + 8 + 1, 16 + 1);
    ...
    while (!IsDevicePathEnd (DevicePath) && (DevicePathType (DevicePath) != 0x03)) {
    ...
    if (DevicePathSubType (DevicePath) == 0x1A) {
      ...
      Description = BmGetSdMmcDescription (
                      BmGetSdMmcManufacturerName (SdCid.ManufacturerId, ((BOOLEAN)(0==1))),
                      SdCid.ProductName,
                      (sizeof (SdCid.ProductName) / sizeof ((SdCid.ProductName)[0])),
                      SdCid.ProductSerialNumber,
                      mBootDescSd
                      );
    } else if (DevicePathSubType (DevicePath) == 0x1D) {
      ...
      DevicePath = NextDevicePathNode (DevicePath);
      if (DevicePath->SubType == 0x05) {
        Description = BmGetEmmcTypeDescription ((CONTROLLER_DEVICE_PATH *)DevicePath);
      }

      Description = BmGetSdMmcDescription (
                      BmGetSdMmcManufacturerName (EmmcCid.ManufacturerId, ((BOOLEAN)(1==1))),
                      EmmcCid.ProductName,
                      (sizeof (EmmcCid.ProductName) / sizeof ((EmmcCid.ProductName)[0])),
...
# 503 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmBootDescription.c"
CHAR16 *
BmGetUsbDescription (
  EFI_HANDLE Handle
  )
...
# 607 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmBootDescription.c"
CHAR16 *
  ...
  )
{
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) || (DevicePath == ((void *) 0))) {
    return ((void *) 0);
  }
# 655 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmBootDescription.c"
  while (!IsDevicePathEnd (DevicePath) &&
         ((DevicePathType (DevicePath) != 0x03) ||
          (DevicePathSubType (DevicePath) != 0x0b))
         )
  {
    DevicePath = NextDevicePathNode (DevicePath);
  }
  ...
  if ((DevicePathType (DevicePath) == 0x03) &&
      (DevicePathSubType (DevicePath) == 0x14)
      )
  {
  ...
  if ((DevicePathType (DevicePath) == 0x03) &&
      (DevicePathSubType (DevicePath) == 0x1C)
      )
  {
    DevicePath = NextDevicePathNode (DevicePath);
  }
  ...
  if ((DevicePathType (DevicePath) == 0x03) &&
      ((DevicePathSubType (DevicePath) == 0x0c) ||
       (DevicePathSubType (DevicePath) == 0x0d))
      )
  {
    Ip = DevicePath;
    DevicePath = NextDevicePathNode (DevicePath);
  ...
  if ((DevicePathType (DevicePath) == 0x03) &&
      (DevicePathSubType (DevicePath) == 0x1F)
      )
  {
    DevicePath = NextDevicePathNode (DevicePath);
  }
  ...
  if ((DevicePathType (DevicePath) == 0x03) &&
      (DevicePathSubType (DevicePath) == 0x18)
      )
  {
    Uri = DevicePath;
    DevicePath = NextDevicePathNode (DevicePath);
  ...
  UnicodeSPrint (
    ...
    (Uri == ((void *) 0)) ? L"PXE" : L"HTTP",
    ((Ip == ((void *) 0)) || (DevicePathSubType (Ip) == 0x0c)) ? 4 : 6,
    ...
    (Vlan == ((void *) 0)) ? 0 : Vlan->VlanId
    );
  return Description;
}
# 764 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmBootDescription.c"
CHAR16 *
  ...
  )
{
  ...
  if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    ...
    while (!IsDevicePathEnd (DevicePathNode)) {
      if ((DevicePathNode->Type == 0x04) && (DevicePathNode->SubType == 0x04)) {
...
# 811 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmBootDescription.c"
CHAR16 *
  ...
  )
{
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) ||
      (DevicePathType (DevicePath.DevPath) != 0x03) ||
      (DevicePathSubType (DevicePath.DevPath) != 0x17))
  {
  ...
  CommandPacket.CommandTimeout = MultU64x32((UINT64)(5), 10000000);
  CommandPacket.QueueType = 0x00;
  ...
  Description = AllocateZeroPool (
                  ((sizeof (ControllerData.Mn) / sizeof ((ControllerData.Mn)[0])) + 1
                   + (sizeof (ControllerData.Sn) / sizeof ((ControllerData.Sn)[0])) + 1
                   + 38 + 1
                  ) * sizeof (CHAR16)
                  );
  if (Description != ((void *) 0)) {
    Char = Description;
    for (Index = 0; Index < (sizeof (ControllerData.Mn) / sizeof ((ControllerData.Mn)[0])); Index++) {
      *(Char++) = (CHAR16)ControllerData.Mn[Index];
    }

    *(Char++) = L' ';
    for (Index = 0; Index < (sizeof (ControllerData.Sn) / sizeof ((ControllerData.Sn)[0])); Index++) {
...
# 919 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmBootDescription.c"
CHAR16 *
...
# 985 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmBootDescription.c"
EFI_STATUS
  ...
  )
{
  ...
  {
    Entry = (((BM_BOOT_DESCRIPTION_ENTRY *) (void *) ((CHAR8 *) (Link) - ((UINTN) __builtin_offsetof(BM_BOOT_DESCRIPTION_ENTRY, Link))))->Signature != ((('b') | ('m' << 8)) | ((('d') | ('h' << 8)) << 16))) ? ((void *) 0) : ((BM_BOOT_DESCRIPTION_ENTRY *) (void *) ((CHAR8 *) (Link) - ((UINTN) __builtin_offsetof(BM_BOOT_DESCRIPTION_ENTRY, Link))));
  ...
  Entry->Signature = ((('b') | ('m' << 8)) | ((('d') | ('h' << 8)) << 16));
...
# 1032 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmBootDescription.c"
CHAR16 *
BmGetBootDescription (
  EFI_HANDLE Handle
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (DefaultDescription != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
...
# 1093 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmBootDescription.c"
void
BmMakeBootOptionDescriptionUnique (
  EFI_BOOT_MANAGER_LOAD_OPTION *BootOptions,
  UINTN BootOptionCount
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (Visited != ((void *) 0)); } } while (((BOOLEAN)(0==1)));

  for (Base = 0; Base < BootOptionCount; Base++) {
    if (!Visited[Base]) {
      MatchCount = 1;
      Visited[Base] = ((BOOLEAN)(1==1));

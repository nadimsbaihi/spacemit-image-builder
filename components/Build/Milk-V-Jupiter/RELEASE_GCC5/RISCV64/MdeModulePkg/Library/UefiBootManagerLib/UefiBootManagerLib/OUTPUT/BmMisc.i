# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmMisc.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmMisc.c"
# 10 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmMisc.c"
...
# 11 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmMisc.c" 2
# 25 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmMisc.c"
EFI_DEVICE_PATH_PROTOCOL *
BmDelPartMatchInstance (
  EFI_DEVICE_PATH_PROTOCOL *Multi,
  EFI_DEVICE_PATH_PROTOCOL *Single
  )
{
  ...
  NewDevicePath = ((void *) 0);
  TempNewDevicePath = ((void *) 0);

  if ((Multi == ((void *) 0)) || (Single == ((void *) 0))) {
    return Multi;
  }

  Instance = GetNextDevicePathInstance (&Multi, &InstanceSize);
  SingleDpSize = GetDevicePathSize (Single) - (sizeof (EFI_DEVICE_PATH_PROTOCOL));
  InstanceSize -= (sizeof (EFI_DEVICE_PATH_PROTOCOL));

  while (Instance != ((void *) 0)) {
    if (CompareMem (Instance, Single, (((SingleDpSize) < (InstanceSize)) ? (SingleDpSize) : (InstanceSize))) != 0) {
...
# 81 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmMisc.c"
BOOLEAN
BmMatchDevicePaths (
  EFI_DEVICE_PATH_PROTOCOL *Multi,
  EFI_DEVICE_PATH_PROTOCOL *Single
...
# 128 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmMisc.c"
void
BmSetMemoryTypeInformationVariable (
  BOOLEAN Boot
  )
{
  ...
  MemoryTypeInformationModified = ((BOOLEAN)(0==1));
  MemoryTypeInformationVariableExists = ((BOOLEAN)(0==1));
  ...
  if (BootMode != 0x04) {
    ...
    if (Status == ((RETURN_STATUS)(0x8000000000000000ULL | (5)))) {
      MemoryTypeInformationVariableExists = ((BOOLEAN)(1==1));
    }
  }
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) || (CurrentMemoryTypeInformation == ((void *) 0))) {
    return;
  }
  ...
  VariableSize = (UINT16)(((*(EFI_HOB_GENERIC_HEADER **)&(GuidHob))->HobLength) - sizeof (EFI_HOB_GUID_TYPE));
  PreviousMemoryTypeInformation = AllocateCopyPool (VariableSize, (void *)(*(UINT8 **)&(GuidHob) + sizeof (EFI_HOB_GUID_TYPE)));
  if (PreviousMemoryTypeInformation == ((void *) 0)) {
    return;
  }
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Memory  Previous  Current    Next   \n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, " Type    Pages     Pages     Pages  \n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  ...
  for (Index = 0; PreviousMemoryTypeInformation[Index].Type != EfiMaxMemoryType; Index++) {
    ...
    if (Next != Previous) {
      ...
      MemoryTypeInformationModified = ((BOOLEAN)(1==1));
    }

    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "  %02x    %08x  %08x  %08x\n", PreviousMemoryTypeInformation[Index].Type, Previous, Current, Next); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  }
  ...
  if (MemoryTypeInformationModified || !MemoryTypeInformationVariableExists) {
    ...
    if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
      ...
      if (MemoryTypeInformationModified) {
        do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Memory Type Information settings change.\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
        if (Boot && _gPcd_FixedAtBuild_PcdResetOnMemoryTypeInformationChange) {
          do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "...Warm Reset!!!\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
          gRT->ResetSystem (EfiResetWarm, (RETURN_STATUS)(0), 0, ((void *) 0));
        }
      }
    } else {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "Memory Type Information settings cannot be saved. OS S4 may fail!\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    }
  }

  FreePool (PreviousMemoryTypeInformation);
}
# 327 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmMisc.c"
EFI_STATUS
BmSetVariableAndReportStatusCodeOnError (
  CHAR16 *VariableName,
  EFI_GUID *VendorGuid,
  ...
  )
{
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    ...
    if (SetVariableStatus != ((void *) 0)) {
      ...
      (ReportProgressCodeEnabled() && ((0x00000002) & 0x000000FF) == 0x00000001) ? ReportStatusCodeEx(0x00000002,_gPcd_FixedAtBuild_PcdErrorCodeSetVariable,0,((void *) 0),&gEdkiiStatusCodeDataTypeVariableGuid,SetVariableStatus,sizeof (EDKII_SET_VARIABLE_STATUS) + NameSize + DataSize) : (ReportErrorCodeEnabled() && ((0x00000002) & 0x000000FF) == 0x00000002) ? ReportStatusCodeEx(0x00000002,_gPcd_FixedAtBuild_PcdErrorCodeSetVariable,0,((void *) 0),&gEdkiiStatusCodeDataTypeVariableGuid,SetVariableStatus,sizeof (EDKII_SET_VARIABLE_STATUS) + NameSize + DataSize) : (ReportDebugCodeEnabled() && ((0x00000002) & 0x000000FF) == 0x00000003) ? ReportStatusCodeEx(0x00000002,_gPcd_FixedAtBuild_PcdErrorCodeSetVariable,0,((void *) 0),&gEdkiiStatusCodeDataTypeVariableGuid,SetVariableStatus,sizeof (EDKII_SET_VARIABLE_STATUS) + NameSize + DataSize) : ((RETURN_STATUS)(0x8000000000000000ULL | (3)))
  ...
  )
{
  ...
  Str = ConvertDevicePathToText (DevicePath, ((BOOLEAN)(0==1)), ((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "%s", Str); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  if (Str != ((void *) 0)) {
    FreePool (Str);
  }
}
# 403 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmMisc.c"
UINTN
BmCharToUint (
  CHAR16 Char
  )
...
# 426 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmMisc.c"
EFI_STATUS
  ...
  for (Index = 0; Index < HandleCount; Index++) {
    ...
    for (ImageIndex = 0; ; ImageIndex++) {
      ...
      if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
        ...
        gBS->StartImage (ImageHandle, ((void *) 0), ((void *) 0));

# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmDriverHealth.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmDriverHealth.c"
# 11 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmDriverHealth.c"
...
# 12 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmDriverHealth.c" 2
...
# 38 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmDriverHealth.c"
CHAR16 *
BmGetControllerName (
  EFI_HANDLE DriverHealthHandle,
  EFI_HANDLE ControllerHandle,
  ...
  )
{
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    ...
    if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
      Iso639Language = ((BOOLEAN)(1==1));
    }
  }

  if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    GetEfiGlobalVariable2 (Iso639Language ? L"Lang" : L"PlatformLang", (void **)&LanguageVariable, ((void *) 0));
    BestLanguage = GetBestLanguage (
                     ComponentName->SupportedLanguages,
                     Iso639Language,
                     (LanguageVariable != ((void *) 0)) ? LanguageVariable : "",
                     Iso639Language ? "eng" : "en-US",
                     ((void *) 0)
                     );
    if (LanguageVariable != ((void *) 0)) {
  ...
  if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    ...
    return ConvertDevicePathToText (
             DevicePathFromHandle (ChildHandle != ((void *) 0) ? ChildHandle : ControllerHandle),
             ((BOOLEAN)(0==1)),
             ((BOOLEAN)(0==1))
             );
  }
  ...
  )
{
  ...
  if ((DriverHealthInfo->MessageList == ((void *) 0)) ||
      (DriverHealthInfo->MessageList[0].HiiHandle == ((void *) 0)))
  {
    return;
  }
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Controller: %s\n", ControllerName); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  Print (L"Controller: %s\n", ControllerName);
  for (Index = 0; DriverHealthInfo->MessageList[Index].HiiHandle != ((void *) 0); Index++) {
    String = HiiGetString (
    ...
    if (String != ((void *) 0)) {
      Print (L"  %s\n", String);
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "  %s\n", String); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
      FreePool (String);
    }
  }

  if (ControllerName != ((void *) 0)) {
    FreePool (ControllerName);
  }
}
# 164 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmDriverHealth.c"
EFI_STATUS
...
{
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "[BDS]RepairNotify: %d/%d\n", Value, Limit); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  Print (L"[BDS]RepairNotify: %d/%d\n", Value, Limit);

  return (RETURN_STATUS)(0);
}
# 191 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmDriverHealth.c"
EFI_STATUS
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (DriverHealthHandle != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
  ...
  if (ControllerHandle == ((void *) 0)) {
    ...
    Status = DriverHealth->GetHealthStatus (DriverHealth, ((void *) 0), ((void *) 0), &HealthStatus, ((void *) 0), ((void *) 0));
    if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) && (HealthStatus == EfiDriverHealthStatusHealthy)) {
      *DriverHealthInfo = ReallocatePool (
      ...
      do { if (((BOOLEAN)(0==1))) { (void) (*DriverHealthInfo != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
...
# 286 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmDriverHealth.c"
EFI_BOOT_MANAGER_DRIVER_HEALTH_INFO *
  ...
  )
{
  ...
  *Count = 0;
  DriverHealthInfo = ((void *) 0);
  Handles = ((void *) 0);
  DriverHealthHandles = ((void *) 0);
  NumHandles = 0;
  HandleCount = 0;
  ...
  if ((Status == ((RETURN_STATUS)(0x8000000000000000ULL | (14)))) || (NumHandles == 0)) {
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (Status); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { (void) (DriverHealthHandles != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
  ...
  for (DriverHealthIndex = 0; DriverHealthIndex < NumHandles; DriverHealthIndex++) {
    ...
    Status = BmGetSingleControllerHealthStatus (&DriverHealthInfo, Count, DriverHealthHandles[DriverHealthIndex], ((void *) 0), ((void *) 0));
    if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
      continue;
    }
    ...
    for (ControllerIndex = 0; ControllerIndex < HandleCount; ControllerIndex++) {
      Status = BmGetSingleControllerHealthStatus (&DriverHealthInfo, Count, DriverHealthHandles[DriverHealthIndex], Handles[ControllerIndex], ((void *) 0));
      if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
        continue;
      }
  ...
  if (DriverHealthHandles != ((void *) 0)) {
    FreePool (DriverHealthHandles);
  }

  return DriverHealthInfo;
}
# 404 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Library/UefiBootManagerLib/BmDriverHealth.c"
EFI_STATUS
  ...
  )
{
  ...
  for (Index = 0; Index < Count; Index++) {
    if (DriverHealthInfo[Index].MessageList != ((void *) 0)) {
  ...
  )
{
  ...
  if (IsZeroGuid ((void *)_gPcd_FixedAtBuild_PcdDriverHealthConfigureForm)) {
    return;
  }

  Status = gBS->LocateProtocol (&gEfiFormBrowser2ProtocolGuid, ((void *) 0), (void **)&FormBrowser2);
  do { if (((BOOLEAN)(0==1))) { (void) (Status); } } while (((BOOLEAN)(0==1)));

  MaxRepairCount = _gPcd_FixedAtBuild_PcdMaxRepairCount;
  RepairCount = 0;

  do {
    RepairRequired = ((BOOLEAN)(0==1));
    ConfigurationRequired = ((BOOLEAN)(0==1));
    ...
    for (Index = 0; Index < Count; Index++) {
      ...
      if (DriverHealthInfo[Index].HealthStatus == EfiDriverHealthStatusRepairRequired) {
        ...
        if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) && !ConfigurationRequired) {
          ...
          if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) && (HealthStatus == EfiDriverHealthStatusConfigurationRequired)) {
            ConfigurationRequired = ((BOOLEAN)(1==1));
          }
        }
      }
      ...
      if (HiiHandles != ((void *) 0)) {
        for (Index = 0; HiiHandles[Index] != ((void *) 0); Index++) {
          Status = FormBrowser2->SendForm (
                                   ...
                                   &HiiHandles[Index],
                                   1,
                                   (void *)_gPcd_FixedAtBuild_PcdDriverHealthConfigureForm,
                                   0,
                                   ((void *) 0),
                                   ((void *) 0)
                                   );
  ...
  for (Index = 0; Index < Count; Index++) {
    ...
    if (DriverHealthInfo[Index].HealthStatus == EfiDriverHealthStatusReconnectRequired) {
      Status = gBS->DisconnectController (DriverHealthInfo[Index].ControllerHandle, ((void *) 0), ((void *) 0));
      if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {



        RebootRequired = ((BOOLEAN)(1==1));
      } else {
        gBS->ConnectController (DriverHealthInfo[Index].ControllerHandle, ((void *) 0), ((void *) 0), ((BOOLEAN)(1==1)));
        ReconnectRequired = ((BOOLEAN)(1==1));
      }
    }
  ...
  for (Index = 0; Index < Count; Index++) {
    ...
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "%02d: %s - %s\n", Index, ControllerName, mBmHealthStatusText[DriverHealthInfo[Index].HealthStatus]); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
  ...
  if (ReconnectRequired) {
    if (ReconnectRepairCount < 10) {
      BmRepairAllControllers (ReconnectRepairCount + 1);
    } else {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "[%a:%d] Repair failed after %d retries.\n", __func__, 585, ReconnectRepairCount); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
  ...
  if (RebootRequired) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "[BDS] One of the Driver Health instances requires rebooting.\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    gRT->ResetSystem (EfiResetWarm, (RETURN_STATUS)(0), 0, ((void *) 0));
  }
}

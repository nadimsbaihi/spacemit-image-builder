# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/MdeModulePkg/Application/UiApp/UiApp/DEBUG/AutoGen.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/MdeModulePkg/Application/UiApp/UiApp/DEBUG/AutoGen.c"
# 9 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/MdeModulePkg/Application/UiApp/UiApp/DEBUG/AutoGen.c"
...
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/MdeModulePkg/Application/UiApp/UiApp/DEBUG/AutoGen.c" 2
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/MdeModulePkg/Application/UiApp/UiApp/DEBUG/AutoGen.c" 2
...
# 12 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/MdeModulePkg/Application/UiApp/UiApp/DEBUG/AutoGen.c" 2
...
# 13 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/MdeModulePkg/Application/UiApp/UiApp/DEBUG/AutoGen.c" 2

 GUID gEfiCallerIdGuid = {0x462CAA21, 0x7614, 0x4503, {0x83, 0x6E, 0x8A, 0xB6, 0xF4, 0x66, 0x23, 0x31}};

 GUID gEdkiiDscPlatformGuid = {0xBECC2C86, 0x0329, 0x4876, {0x98, 0xB1, 0x57, 0xCC, 0x37, 0xB3, 0x3D, 0xF3}};

 CHAR8 *gEfiCallerBaseName = "UiApp";
 ...
 EFI_GUID gPlatformManagerFormsetGuid = {0x2faa29ba, 0x0cf4, 0x4dcf, {0x86, 0x69, 0x4a, 0x44, 0x53, 0x2a, 0x69, 0x4f}};
 EFI_GUID gPlatformManagerEntryEventGuid = {0x9ce8ecb7, 0x0e87, 0x4ae0, {0x90, 0x66, 0xc1, 0x3d, 0xfa, 0xfb, 0x6d, 0x36}};
 EFI_GUID gPlatformManagerExitEventGuid = {0x8dca33d6, 0x13cb, 0x4272, {0x81, 0x67, 0xe9, 0x97, 0x97, 0x9f, 0xdd, 0x50}};
...
volatile UINT32 _gPcd_BinaryPatch_PcdSetupConOutColumn = ((UINT32)80U);
 UINTN _gPcd_BinaryPatch_Size_PcdSetupConOutColumn = 4;
volatile UINT32 _gPcd_BinaryPatch_PcdSetupConOutRow = ((UINT32)25U);
 UINTN _gPcd_BinaryPatch_Size_PcdSetupConOutRow = 4;
volatile UINT32 _gPcd_BinaryPatch_PcdSetupVideoHorizontalResolution = ((UINT32)800U);
 UINTN _gPcd_BinaryPatch_Size_PcdSetupVideoHorizontalResolution = 4;
volatile UINT32 _gPcd_BinaryPatch_PcdSetupVideoVerticalResolution = ((UINT32)600U);
 UINTN _gPcd_BinaryPatch_Size_PcdSetupVideoVerticalResolution = 4;
...
# 364 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/MdeModulePkg/Application/UiApp/UiApp/DEBUG/AutoGen.c"
RETURN_STATUS
  ...
  )
{
  ...
  Status = PlatformManagerUiLibConstructor (ImageHandle, SystemTable);
  do { if (((BOOLEAN)(0==1))) { (void) (Status); } } while (((BOOLEAN)(0==1)));
  ...
  )
{
  ...
  Status = PlatformManagerUiLibDestructor (ImageHandle, SystemTable);
  do { if (((BOOLEAN)(0==1))) { (void) (Status); } } while (((BOOLEAN)(0==1)));

# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/NvmExpressDxe/NvmExpressMediaSanitize.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/NvmExpressDxe/NvmExpressMediaSanitize.c"
# 16 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/NvmExpressDxe/NvmExpressMediaSanitize.c"
...
# 17 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/NvmExpressDxe/NvmExpressMediaSanitize.c" 2
# 51 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/NvmExpressDxe/NvmExpressMediaSanitize.c"
EFI_STATUS
NvmExpressFormatNvm (
  EFI_BLOCK_IO_PROTOCOL *This,
  UINT32 NamespaceId,
  ...
  )
{
  ...
  FormatNvmCdw10.Lbaf = LbaFormat & 0xF;
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    StatusField = (UINT16)((CommandPacket.NvmeCompletion->DW3 & 0xFFFF0000) >>
                           16);

    Sc = (StatusField & 0x1FE) >> 0x01;
    Sct = (StatusField & 0x0E00) >> 0x9;

    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "%a: NVMe FormatNVM admin command failed SCT = 0x%x, SC = 0x%x\n", __func__, Sct, Sc); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  } else {
...
# 195 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/NvmExpressDxe/NvmExpressMediaSanitize.c"
EFI_STATUS
NvmExpressSanitize (
  EFI_BLOCK_IO_PROTOCOL *This,
  UINT32 NamespaceId,
  ...
  )
{
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    ...
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "%a: NVMe Sanitize admin command failed SCT = 0x%x, SC = 0x%x\n", __func__, Sct, Sc); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
...
# 324 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/NvmExpressDxe/NvmExpressMediaSanitize.c"
EFI_STATUS
  ...
  )
{
  ...
  Device = (((NVME_DEVICE_PRIVATE_DATA *) (void *) ((CHAR8 *) (This) - ((UINTN) __builtin_offsetof(NVME_DEVICE_PRIVATE_DATA, MediaSanitize))))->Signature != ((('X') | ('S' << 8)) | ((('S') | ('D' << 8)) << 16))) ? ((void *) 0) : ((NVME_DEVICE_PRIVATE_DATA *) (void *) ((CHAR8 *) (This) - ((UINTN) __builtin_offsetof(NVME_DEVICE_PRIVATE_DATA, MediaSanitize))));
  Media = &Device->Media;
  SectorOffset = 0;
...
# 413 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/NvmExpressDxe/NvmExpressMediaSanitize.c"
EFI_STATUS
  ...
  )
{
  ...
  if (((PurgeAction & 0x00000001) == 0x00000001) && (SaniCap.Ows)) {
    SanitizeAction = 0x3;
  } else if (((PurgeAction & 0x00000002) == 0x00000002) && (SaniCap.Bes)) {
    SanitizeAction = 0x2;
  } else if (((PurgeAction & 0x00000004) == 0x00000004) && (SaniCap.Ces)) {
    SanitizeAction = 0x4;
  } else {
    SanitizeAction = 0x0;
  }

  if ((PurgeAction & 0x00000010) == 0x00000010) {
    NoDeallocate = 0x1;
  }
...
# 503 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/NvmExpressDxe/NvmExpressMediaSanitize.c"
EFI_STATUS
  ...
  )
{
  ...
  switch (SecureEraseAction) {
    case 0x1:
      SecureEraseSettings = 0x1;
      break;
    case 0x2:
      SecureEraseSettings = 0x2;
      break;
    case 0x0:
    default:
...
# 564 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/NvmExpressDxe/NvmExpressMediaSanitize.c"
  LbaSizeIsSupported = ((BOOLEAN)(0==1));
  for (FlbaIndex = 0; FlbaIndex < Device->NamespaceData.Nlbaf; FlbaIndex++) {
    if (Device->NamespaceData.LbaFormat[FlbaIndex].Lbads == LbaSize) {
      LbaSizeIsSupported = ((BOOLEAN)(1==1));
      break;
    }
  }

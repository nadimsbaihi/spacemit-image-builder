# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/XhciDxe/UsbHcMem.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/XhciDxe/UsbHcMem.c"
# 10 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/XhciDxe/UsbHcMem.c"
...
# 11 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/XhciDxe/UsbHcMem.c" 2
# 21 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/XhciDxe/UsbHcMem.c"
USBHC_MEM_BLOCK *
UsbHcAllocMemBlock (
  USBHC_MEM_POOL *Pool,
  UINTN Pages
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (64 * 8 <= 0x00001000); } } while (((BOOLEAN)(0==1)));

  Block->BufLen = ((Pages) << 12);
  Block->BitsLen = Block->BufLen / (64 * 8);
  Block->Bits = AllocateZeroPool (Block->BitsLen);

  if (Block->Bits == ((void *) 0)) {
    gBS->FreePool (Block);
    return ((void *) 0);
  }
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) || (Bytes != ((Pages) << 12))) {
    goto FREE_BUFFER;
  }
...
# 110 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/XhciDxe/UsbHcMem.c"
void
UsbHcFreeMemBlock (
  USBHC_MEM_POOL *Pool,
  USBHC_MEM_BLOCK *Block
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) ((Pool != ((void *) 0)) && (Block != ((void *) 0))); } } while (((BOOLEAN)(0==1)));
  ...
  PciIo->FreeBuffer (PciIo, (((Block->BufLen) >> 12) + (((Block->BufLen) & 0xFFF) ? 1 : 0)), Block->BufHost);

  gBS->FreePool (Block->Bits);
  gBS->FreePool (Block);
}
# 143 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/XhciDxe/UsbHcMem.c"
void *
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) ((Block != 0) && (Units != 0)); } } while (((BOOLEAN)(0==1)));

  StartByte = 0;
  StartBit = 0;
  Available = 0;
  AlignmentMask = ~((UINTN)0x00010000 - 1);
  ...
  for (Byte = 0, Bit = 0; Byte < Block->BitsLen;) {
    ...
    if (!((BOOLEAN)(((Block->Bits[Byte]) & ((UINTN)(1 << (Bit)))) == ((UINTN)(1 << (Bit)))))) {
      if (AllocationForRing && (Available != 0)) {
        MemUnitAddr = (UINTN)Block->BufHost + (Byte * 8 + Bit) * 64;
        if ((MemUnitAddr & AlignmentMask) != ((MemUnitAddr - 64) & AlignmentMask)) {
      ...
      do { (Bit)++; if ((Bit) > 7) { (Byte)++; (Bit) = 0; } } while (0);
    } else {
      do { (Bit)++; if ((Bit) > 7) { (Byte)++; (Bit) = 0; } } while (0);
  ...
  for (Count = 0; Count < Units; Count++) {
    do { if (((BOOLEAN)(0==1))) { (void) (!((BOOLEAN)(((Block->Bits[Byte]) & ((UINTN)(1 << (Bit)))) == ((UINTN)(1 << (Bit)))))); } } while (((BOOLEAN)(0==1)));

    Block->Bits[Byte] = (UINT8)(Block->Bits[Byte] | ((UINTN)(1 << (Bit))));
    do { (Bit)++; if ((Bit) > 7) { (Byte)++; (Bit) = 0; } } while (0);
  }

  return Block->BufHost + (StartByte * 8 + StartBit) * 64;
}
# 234 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/XhciDxe/UsbHcMem.c"
EFI_PHYSICAL_ADDRESS
UsbHcGetPciAddrForHostAddr (
  USBHC_MEM_POOL *Pool,
  void *Mem,
  ...
  )
{
  ...
  for (Block = Head; Block != ((void *) 0); Block = Block->Next) {
  ...
  do { if (((BOOLEAN)(0==1))) { (void) ((Block != ((void *) 0))); } } while (((BOOLEAN)(0==1)));
...
# 289 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/XhciDxe/UsbHcMem.c"
EFI_PHYSICAL_ADDRESS
UsbHcGetHostAddrForPciAddr (
  USBHC_MEM_POOL *Pool,
  void *Mem,
...
# 340 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/XhciDxe/UsbHcMem.c"
void
...
{
  do { if (((BOOLEAN)(0==1))) { (void) ((Head != ((void *) 0)) && (Block != ((void *) 0))); } } while (((BOOLEAN)(0==1)));
  Block->Next = Head->Next;
  Head->Next = Block;
}
# 360 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/XhciDxe/UsbHcMem.c"
BOOLEAN
...
# 383 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/XhciDxe/UsbHcMem.c"
void
UsbHcUnlinkMemBlock (
  USBHC_MEM_BLOCK *Head,
  USBHC_MEM_BLOCK *BlockToUnlink
  )
{
  USBHC_MEM_BLOCK *Block;

  do { if (((BOOLEAN)(0==1))) { (void) ((Head != ((void *) 0)) && (BlockToUnlink != ((void *) 0))); } } while (((BOOLEAN)(0==1)));

  for (Block = Head; Block != ((void *) 0); Block = Block->Next) {
    if (Block->Next == BlockToUnlink) {
      Block->Next = BlockToUnlink->Next;
      BlockToUnlink->Next = ((void *) 0);
      break;
    }
  }
}
# 411 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/XhciDxe/UsbHcMem.c"
USBHC_MEM_POOL *
UsbHcInitMemPool (
  EFI_PCI_IO_PROTOCOL *PciIo
  )
{
  ...
  Pool->PciIo = PciIo;
  Pool->Head = UsbHcAllocMemBlock (Pool, 16);
...
# 444 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/XhciDxe/UsbHcMem.c"
EFI_STATUS
UsbHcFreeMemPool (
  USBHC_MEM_POOL *Pool
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (Pool->Head != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
  ...
  for (Block = Pool->Head->Next; Block != ((void *) 0); Block = Pool->Head->Next) {
...
# 479 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/XhciDxe/UsbHcMem.c"
void *
UsbHcAllocateMem (
  USBHC_MEM_POOL *Pool,
  UINTN Size,
  ...
  )
{
  ...
  for (Block = Head; Block != ((void *) 0); Block = Block->Next) {
    Mem = UsbHcAllocMemFromBlock (Block, AllocSize / 64, AllocationForRing);
  ...
  if (AllocSize > ((16) << 12)) {
    Pages = (((AllocSize) >> 12) + (((AllocSize) & 0xFFF) ? 1 : 0)) + 1;
  } else {
    Pages = 16;
  }
  ...
  if (NewBlock == ((void *) 0)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "UsbHcAllocateMem: failed to allocate block\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    return ((void *) 0);
  }
  ...
  Mem = UsbHcAllocMemFromBlock (NewBlock, AllocSize / 64, AllocationForRing);
...
# 554 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/XhciDxe/UsbHcMem.c"
void
UsbHcFreeMem (
  USBHC_MEM_POOL *Pool,
  void *Mem,
  ...
  )
{
  ...
  for (Block = Head; Block != ((void *) 0); Block = Block->Next) {
    ...
    if ((Block->BufHost <= ToFree) && ((ToFree + AllocSize) <= (Block->BufHost + Block->BufLen))) {
      ...
      Byte = ((ToFree - Block->BufHost) / 64) / 8;
      Bit = ((ToFree - Block->BufHost) / 64) % 8;




      for (Count = 0; Count < (AllocSize / 64); Count++) {
        do { if (((BOOLEAN)(0==1))) { (void) (((BOOLEAN)(((Block->Bits[Byte]) & ((UINTN)(1 << (Bit)))) == ((UINTN)(1 << (Bit)))))); } } while (((BOOLEAN)(0==1)));
...
# 636 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/XhciDxe/UsbHcMem.c"
EFI_STATUS
UsbHcAllocateAlignedPages (
  EFI_PCI_IO_PROTOCOL *PciIo,
  UINTN Pages,
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) ((Alignment & (Alignment - 1)) == 0); } } while (((BOOLEAN)(0==1)));
  ...
  if (Alignment > 0x00001000) {
    ...
    do { if (((BOOLEAN)(0==1))) { (void) (RealPages > Pages); } } while (((BOOLEAN)(0==1)));
    ...
    Memory = (void *)(UINTN)(AlignedMemory + ((Pages) << 12));
...
# 757 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/XhciDxe/UsbHcMem.c"
void
UsbHcFreeAlignedPages (
  EFI_PCI_IO_PROTOCOL *PciIo,
  void *HostAddress,
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (Pages != 0); } } while (((BOOLEAN)(0==1)));

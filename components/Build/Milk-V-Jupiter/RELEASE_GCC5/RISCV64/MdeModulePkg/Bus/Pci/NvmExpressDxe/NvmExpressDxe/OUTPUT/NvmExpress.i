# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/NvmExpressDxe/NvmExpress.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/NvmExpressDxe/NvmExpress.c"
# 11 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/NvmExpressDxe/NvmExpress.c"
...
# 12 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/NvmExpressDxe/NvmExpress.c" 2
...
# 58 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/NvmExpressDxe/NvmExpress.c"
EFI_STATUS
  ...
  )
{
  ...
  if (NamespaceData->Ncap == 0) {
    ...
    Device->Signature = ((('X') | ('S' << 8)) | ((('S') | ('D' << 8)) << 16));
    ...
    Device->Media.RemovableMedia = ((BOOLEAN)(0==1));
    Device->Media.MediaPresent = ((BOOLEAN)(1==1));
    Device->Media.LogicalPartition = ((BOOLEAN)(0==1));
    Device->Media.ReadOnly = ((BOOLEAN)(0==1));
    Device->Media.WriteCaching = ((BOOLEAN)(0==1));
    ...
    if (NamespaceData->LbaFormat[LbaFmtIdx].Ms != 0) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "NVME IDENTIFY NAMESPACE [%d] Ms(%d) is not supported.\n", NamespaceId, NamespaceData->LbaFormat[LbaFmtIdx].Ms); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
    ...
    Device->BlockIo.Revision = 0x00020001;
    ...
    Device->MediaSanitize.Revision = 0x00010000;
    ...
    do { if (((BOOLEAN)(0==1))) { (void) (sizeof (Device->MediaSanitize.SanitizeCapabilities) == sizeof (Device->Controller->ControllerData->Sanicap)); } } while (((BOOLEAN)(0==1)))
    ...
    if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) && (DeviceHandle != ((void *) 0)) && IsDevicePathEnd (RemainingDevicePath)) {
    ...
    if ((Private->ControllerData->Oacs & 0x00000001) != 0) {
    ...
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, " == NVME IDENTIFY NAMESPACE [%d] DATA ==\n", NamespaceId); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "    NSZE        : 0x%lx\n", NamespaceData->Nsze); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "    NCAP        : 0x%lx\n", NamespaceData->Ncap); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "    NUSE        : 0x%lx\n", NamespaceData->Nuse); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "    LBAF0.LBADS : 0x%x\n", (NamespaceData->LbaFormat[0].Lbads)); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
...
Exit:
  ...
  if (NewDevicePathNode != ((void *) 0)) {
    FreePool (NewDevicePathNode);
  }

  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) && (Device != ((void *) 0)) && (Device->DevicePath != ((void *) 0))) {
    FreePool (Device->DevicePath);
  }

  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) && (Device != ((void *) 0))) {
    FreePool (Device);
  }

  return Status;
}
# 377 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/NvmExpressDxe/NvmExpress.c"
EFI_STATUS
...
# 426 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/NvmExpressDxe/NvmExpress.c"
EFI_STATUS
  ...
  )
{
  ...
  Device = (((NVME_DEVICE_PRIVATE_DATA *) (void *) ((CHAR8 *) (BlockIo) - ((UINTN) __builtin_offsetof(NVME_DEVICE_PRIVATE_DATA, BlockIo))))->Signature != ((('X') | ('S' << 8)) | ((('S') | ('D' << 8)) << 16))) ? ((void *) 0) : ((NVME_DEVICE_PRIVATE_DATA *) (void *) ((CHAR8 *) (BlockIo) - ((UINTN) __builtin_offsetof(NVME_DEVICE_PRIVATE_DATA, BlockIo))));
  ...
  if (Device->DevicePath != ((void *) 0)) {
    FreePool (Device->DevicePath);
  }

  if (Device->ControllerNameTable != ((void *) 0)) {
...
# 565 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/NvmExpressDxe/NvmExpress.c"
void
  ...
  )
{
       ...
       Link = NextLink)
  {
    ...
    if (Token->TransactionStatus != (RETURN_STATUS)(0)) {
    ...
    if (Status == ((RETURN_STATUS)(0x8000000000000000ULL | (6)))) {
      ...
      Token->TransactionStatus = ((RETURN_STATUS)(0x8000000000000000ULL | (7)));
  ...
  while (Cq->Pt != Private->Pt[QueueId]) {
    do { if (((BOOLEAN)(0==1))) { (void) (Cq->Sqid == QueueId); } } while (((BOOLEAN)(0==1)));

    HasNewItem = ((BOOLEAN)(1==1));
    ...
    if (Private->CqHdbl[QueueId].Cqh > (((255) < (Private->Cap.Mqes)) ? (255) : (Private->Cap.Mqes))) {
...
# 790 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/NvmExpressDxe/NvmExpress.c"
EFI_STATUS
  ...
  )
{
  ...
  if (RemainingDevicePath != ((void *) 0)) {
    ...
    if (!IsDevicePathEnd (RemainingDevicePath)) {
      ...
      if ((DevicePathNode.DevPath->Type != 0x03) ||
          (DevicePathNode.DevPath->SubType != 0x17) ||
  ...
  if ((ClassCode[0] != 0x02) || (ClassCode[1] != 0x08) || (ClassCode[2] != 0x01)) {
    Status = ((RETURN_STATUS)(0x8000000000000000ULL | (3)));
  }
...
# 944 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/NvmExpressDxe/NvmExpress.c"
EFI_STATUS
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "NvmExpressDriverBindingStart: start\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));

  Private = ((void *) 0);
  Passthru = ((void *) 0);
  ParentDevicePath = ((void *) 0);
  ...
  if (Status != ((RETURN_STATUS)(0x8000000000000000ULL | (20)))) {
    ...
    if (Private == ((void *) 0)) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "NvmExpressDriverBindingStart: allocating pool for Nvme Private Data failed!\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
      Status = ((RETURN_STATUS)(0x8000000000000000ULL | (9)));
      goto Exit;
    }
    ...
    if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000002)) { DebugPrint (0x00000002, "NvmExpressDriverBindingStart: failed to enable 64-bit DMA (%r)\n", Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    }
# 1042 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/NvmExpressDxe/NvmExpress.c"
    ...
    if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) || (Bytes != ((6) << 12))) {
      goto Exit;
    }

    Private->BufferPciAddr = (UINT8 *)(UINTN)MappedAddr;

    Private->Signature = ((('N') | ('V' << 8)) | ((('M') | ('E' << 8)) << 16));
    ...
    Private = (((NVME_CONTROLLER_PRIVATE_DATA *) (void *) ((CHAR8 *) (Passthru) - ((UINTN) __builtin_offsetof(NVME_CONTROLLER_PRIVATE_DATA, Passthru))))->Signature != ((('N') | ('V' << 8)) | ((('M') | ('E' << 8)) << 16))) ? ((void *) 0) : ((NVME_CONTROLLER_PRIVATE_DATA *) (void *) ((CHAR8 *) (Passthru) - ((UINTN) __builtin_offsetof(NVME_CONTROLLER_PRIVATE_DATA, Passthru))));
  }
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "NvmExpressDriverBindingStart: end successfully\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  return (RETURN_STATUS)(0);

Exit:
  if ((Private != ((void *) 0)) && (Private->Mapping != ((void *) 0))) {
    PciIo->Unmap (PciIo, Private->Mapping);
  }

  if ((Private != ((void *) 0)) && (Private->Buffer != ((void *) 0))) {
    PciIo->FreeBuffer (PciIo, 6, Private->Buffer);
  }

  if ((Private != ((void *) 0)) && (Private->ControllerData != ((void *) 0))) {
    FreePool (Private->ControllerData);
  }

  if (Private != ((void *) 0)) {
    if (Private->TimerEvent != ((void *) 0)) {
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "NvmExpressDriverBindingStart: end with %r\n", Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));

  return Status;
}
# 1234 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/NvmExpressDxe/NvmExpress.c"
EFI_STATUS
  ...
  )
{
  ...
  if (NumberOfChildren == 0) {
    ...
    if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
      ...
      if (Private->Mapping != ((void *) 0)) {
        Private->PciIo->Unmap (Private->PciIo, Private->Mapping);
      }

      if (Private->Buffer != ((void *) 0)) {
...
# 1349 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/NvmExpressDxe/NvmExpress.c"
EFI_STATUS
...
# 1419 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/NvmExpressDxe/NvmExpress.c"
...
# 1468 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/NvmExpressDxe/NvmExpress.c"
EFI_STATUS

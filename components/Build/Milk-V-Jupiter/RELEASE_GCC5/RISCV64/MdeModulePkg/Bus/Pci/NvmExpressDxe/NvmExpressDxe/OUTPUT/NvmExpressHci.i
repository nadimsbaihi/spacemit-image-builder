# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/NvmExpressDxe/NvmExpressHci.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/NvmExpressDxe/NvmExpressHci.c"
# 10 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/NvmExpressDxe/NvmExpressHci.c"
...
# 11 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/NvmExpressDxe/NvmExpressHci.c" 2
# 19 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/NvmExpressDxe/NvmExpressHci.c"
UINTN mNvmeControllerNumber = 0;
# 31 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/NvmExpressDxe/NvmExpressHci.c"
EFI_STATUS
...
# 69 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/NvmExpressDxe/NvmExpressHci.c"
EFI_STATUS
...
# 107 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/NvmExpressDxe/NvmExpressHci.c"
EFI_STATUS
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Cc.En: %d\n", Cc->En); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Cc.Css: %d\n", Cc->Css); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Cc.Mps: %d\n", Cc->Mps); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Cc.Ams: %d\n", Cc->Ams); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Cc.Shn: %d\n", Cc->Shn); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Cc.Iosqes: %d\n", Cc->Iosqes); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Cc.Iocqes: %d\n", Cc->Iocqes); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));

  return (RETURN_STATUS)(0);
}
# 153 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/NvmExpressDxe/NvmExpressHci.c"
EFI_STATUS
...
# 191 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/NvmExpressDxe/NvmExpressHci.c"
EFI_STATUS
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Aqa.Asqs: %d\n", Aqa->Asqs); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Aqa.Acqs: %d\n", Aqa->Acqs); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));

  return (RETURN_STATUS)(0);
}
# 232 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/NvmExpressDxe/NvmExpressHci.c"
EFI_STATUS
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Asq: %lx\n", *Asq); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));

  return (RETURN_STATUS)(0);
}
# 273 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/NvmExpressDxe/NvmExpressHci.c"
EFI_STATUS
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Acq: %lxh\n", *Acq); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));

  return (RETURN_STATUS)(0);
}
# 313 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/NvmExpressDxe/NvmExpressHci.c"
EFI_STATUS
  ...
  )
{
  ...
  if (Index == 0) {
    ...
    (ReportProgressCodeEnabled() && (((0x00000002 | 0x80000000)) & 0x000000FF) == 0x00000001) ? ReportStatusCode((0x00000002 | 0x80000000),((0x02000000 | 0x00070000) | 0x00000005)) : (ReportErrorCodeEnabled() && (((0x00000002 | 0x80000000)) & 0x000000FF) == 0x00000002) ? ReportStatusCode((0x00000002 | 0x80000000),((0x02000000 | 0x00070000) | 0x00000005)) : (ReportDebugCodeEnabled() && (((0x00000002 | 0x80000000)) & 0x000000FF) == 0x00000003) ? ReportStatusCode((0x00000002 | 0x80000000),((0x02000000 | 0x00070000) | 0x00000005)) : ((RETURN_STATUS)(0x8000000000000000ULL | (3)))


       ;
  }

  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "NVMe controller is disabled with status [%r].\n", Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  return Status;
}
# 392 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/NvmExpressDxe/NvmExpressHci.c"
EFI_STATUS
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "NVMe controller is enabled with status [%r].\n", Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));

Cleanup:
  EfiEventGroupSignal (&gNVMeEnableCompleteEventGroupGuid);
  return Status;
}
# 471 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/NvmExpressDxe/NvmExpressHci.c"
EFI_STATUS
NvmeIdentifyController (
  NVME_CONTROLLER_PRIVATE_DATA *Private,
  void *Buffer
...
# 526 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/NvmExpressDxe/NvmExpressHci.c"
EFI_STATUS
NvmeIdentifyNamespace (
  NVME_CONTROLLER_PRIVATE_DATA *Private,
  UINT32 NamespaceId,
  ...
  )
{
  ...
  CommandPacket.NvmeCmd->Flags = 0x04;
...
# 576 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/NvmExpressDxe/NvmExpressHci.c"
EFI_STATUS
  ...
  )
{
  ...
  Private->CreateIoQueue = ((BOOLEAN)(1==1));
  ...
  for (Index = 1; Index < 3; Index++) {
    ...
    Command.Cdw0.Opcode = 0x05;
    CommandPacket.TransferBuffer = Private->CqBufferPciAddr[Index];
    CommandPacket.TransferLength = 0x00001000;
    CommandPacket.CommandTimeout = MultU64x32((UINT64)(5), 10000000);
    CommandPacket.QueueType = 0x00;
    ...
    CommandPacket.NvmeCmd->Flags = 0x04 | 0x08;
  ...
  Private->CreateIoQueue = ((BOOLEAN)(0==1));

  return Status;
}
# 648 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/NvmExpressDxe/NvmExpressHci.c"
EFI_STATUS
...
# 722 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/NvmExpressDxe/NvmExpressHci.c"
EFI_STATUS
NvmeControllerInit (
  NVME_CONTROLLER_PRIVATE_DATA *Private
  )
{
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "NvmeControllerInit: failed to enable controller\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    return Status;
  }
  ...
  if ((Private->Cap.Css & 0x00000001) == 0) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "NvmeControllerInit: the controller doesn't support NVMe command set\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  ...
  do { if (((BOOLEAN)(0==1))) { (void) ((Private->Cap.Mpsmin + 12) <= 12); } } while (((BOOLEAN)(0==1)));
  ...
  Acq = (UINT64)(UINTN)(Private->BufferPciAddr + 0x00001000) & ~0xFFF;




  ZeroMem (Private->Buffer, ((6) << 12));
  Private->SqBuffer[0] = (NVME_SQ *)(UINTN)(Private->Buffer);
  Private->SqBufferPciAddr[0] = (NVME_SQ *)(UINTN)(Private->BufferPciAddr);
  Private->CqBuffer[0] = (NVME_CQ *)(UINTN)(Private->Buffer + 1 * 0x00001000);
  Private->CqBufferPciAddr[0] = (NVME_CQ *)(UINTN)(Private->BufferPciAddr + 1 * 0x00001000);
  Private->SqBuffer[1] = (NVME_SQ *)(UINTN)(Private->Buffer + 2 * 0x00001000);
  Private->SqBufferPciAddr[1] = (NVME_SQ *)(UINTN)(Private->BufferPciAddr + 2 * 0x00001000);
  Private->CqBuffer[1] = (NVME_CQ *)(UINTN)(Private->Buffer + 3 * 0x00001000);
  Private->CqBufferPciAddr[1] = (NVME_CQ *)(UINTN)(Private->BufferPciAddr + 3 * 0x00001000);
  Private->SqBuffer[2] = (NVME_SQ *)(UINTN)(Private->Buffer + 4 * 0x00001000);
  Private->SqBufferPciAddr[2] = (NVME_SQ *)(UINTN)(Private->BufferPciAddr + 4 * 0x00001000);
  Private->CqBuffer[2] = (NVME_CQ *)(UINTN)(Private->Buffer + 5 * 0x00001000);
  Private->CqBufferPciAddr[2] = (NVME_CQ *)(UINTN)(Private->BufferPciAddr + 5 * 0x00001000);

  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Private->Buffer = [%016X]\n", (UINT64)(UINTN)Private->Buffer); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Admin     Submission Queue size (Aqa.Asqs) = [%08X]\n", Aqa.Asqs); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Admin     Completion Queue size (Aqa.Acqs) = [%08X]\n", Aqa.Acqs); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Admin     Submission Queue (SqBuffer[0]) = [%016X]\n", Private->SqBuffer[0]); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Admin     Completion Queue (CqBuffer[0]) = [%016X]\n", Private->CqBuffer[0]); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Sync  I/O Submission Queue (SqBuffer[1]) = [%016X]\n", Private->SqBuffer[1]); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Sync  I/O Completion Queue (CqBuffer[1]) = [%016X]\n", Private->CqBuffer[1]); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Async I/O Submission Queue (SqBuffer[2]) = [%016X]\n", Private->SqBuffer[2]); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Async I/O Completion Queue (CqBuffer[2]) = [%016X]\n", Private->CqBuffer[2]); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  ...
  if (Private->ControllerData == ((void *) 0)) {
  ...
  Mn[40] = 0;
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, " == NVME IDENTIFY CONTROLLER DATA ==\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "    PCI VID   : 0x%x\n", Private->ControllerData->Vid); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "    PCI SSVID : 0x%x\n", Private->ControllerData->Ssvid); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "    SN        : %a\n", Sn); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "    MN        : %a\n", Mn); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "    FR        : 0x%x\n", *((UINT64 *)Private->ControllerData->Fr)); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "    TNVMCAP (high 8-byte) : 0x%lx\n", *((UINT64 *)(Private->ControllerData->Tnvmcap + 8))); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "    TNVMCAP (low 8-byte)  : 0x%lx\n", *((UINT64 *)Private->ControllerData->Tnvmcap)); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "    RAB       : 0x%x\n", Private->ControllerData->Rab); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "    IEEE      : 0x%x\n", *(UINT32 *)Private->ControllerData->Ieee_oui); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "    AERL      : 0x%x\n", Private->ControllerData->Aerl); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "    SQES      : 0x%x\n", Private->ControllerData->Sqes); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "    CQES      : 0x%x\n", Private->ControllerData->Cqes); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "    NN        : 0x%x\n", Private->ControllerData->Nn); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
...
# 954 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Pci/NvmExpressDxe/NvmExpressHci.c"
void
  ...
  )
{
  ...
  for (HandleIndex = 0; HandleIndex < HandleCount; HandleIndex++) {
    ...
    for (OpenInfoIndex = 0; OpenInfoIndex < OpenInfoCount; OpenInfoIndex++) {
      ...
      if (((OpenInfos[OpenInfoIndex].Attributes & 0x00000010) != 0) &&
          (OpenInfos[OpenInfoIndex].AgentHandle == gImageHandle))
      {
        ...
        Private = (((NVME_CONTROLLER_PRIVATE_DATA *) (void *) ((CHAR8 *) (NvmePassThru) - ((UINTN) __builtin_offsetof(NVME_CONTROLLER_PRIVATE_DATA, Passthru))))->Signature != ((('N') | ('V' << 8)) | ((('M') | ('E' << 8)) << 16))) ? ((void *) 0) : ((NVME_CONTROLLER_PRIVATE_DATA *) (void *) ((CHAR8 *) (NvmePassThru) - ((UINTN) __builtin_offsetof(NVME_CONTROLLER_PRIVATE_DATA, Passthru))));
        ...
        for (Index = 0; Index < 45 * 100; Index++) {
          Status = ReadNvmeControllerStatus (Private, &Csts);
          if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) && (Csts.Shst == 2)) {
            do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "NvmeShutdownController: shutdown processing is completed after %dms.\n", Index * 10); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
            break;
          }
        ...
        if (Index == 45 * 100) {
          do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "NvmeShutdownController: shutdown processing is timed out\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
        }
      }
    }
  }
  ...
  )
{
  ...
  if (mNvmeControllerNumber == 1) {
    Status = gBS->LocateProtocol (&gEfiResetNotificationProtocolGuid, ((void *) 0), (void **)&ResetNotify);
    if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
      ...
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000002)) { DebugPrint (0x00000002, "NVME: ResetNotification absent! Shutdown notification cannot be performed!\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    }
  }
}

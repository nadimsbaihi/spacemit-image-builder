# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbUtility.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbUtility.c"
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbUtility.c"
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbUtility.c" 2
...
# 56 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbUtility.c"
EFI_STATUS
UsbHcGetCapability (
  USB_BUS *UsbBus,
  UINT8 *MaxSpeed,
  ...
  )
{
  ...
  if (UsbBus->Usb2Hc != ((void *) 0)) {
    ...
    *MaxSpeed = 0x0000;
    *Is64BitCapable = (UINT8)((BOOLEAN)(0==1));
  }

  return Status;
}
# 94 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbUtility.c"
EFI_STATUS
UsbHcGetRootHubPortStatus (
  USB_BUS *UsbBus,
  UINT8 PortIndex,
...
# 123 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbUtility.c"
EFI_STATUS
UsbHcSetRootHubPortFeature (
  USB_BUS *UsbBus,
  UINT8 PortIndex,
...
# 152 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbUtility.c"
EFI_STATUS
UsbHcClearRootHubPortFeature (
  USB_BUS *UsbBus,
  UINT8 PortIndex,
...
# 189 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbUtility.c"
EFI_STATUS
UsbHcControlTransfer (
  USB_BUS *UsbBus,
  UINT8 DevAddr,
  ...
  )
{
  ...
  if (UsbBus->Usb2Hc != ((void *) 0)) {
    ...
    IsSlowDevice = (BOOLEAN)(0x0001 == DevSpeed);
...
# 262 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbUtility.c"
EFI_STATUS
UsbHcBulkTransfer (
  USB_BUS *UsbBus,
  UINT8 DevAddr,
...
# 334 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbUtility.c"
EFI_STATUS
UsbHcAsyncInterruptTransfer (
  USB_BUS *UsbBus,
  UINT8 DevAddr,
...
# 410 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbUtility.c"
EFI_STATUS
UsbHcSyncInterruptTransfer (
  USB_BUS *UsbBus,
  UINT8 DevAddr,
  ...
  )
{
  ...
  if (UsbBus->Usb2Hc != ((void *) 0)) {
    ...
    IsSlowDevice = (BOOLEAN)((0x0001 == DevSpeed) ? ((BOOLEAN)(1==1)) : ((BOOLEAN)(0==1)));
...
# 470 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbUtility.c"
EFI_STATUS
UsbOpenHostProtoByChild (
  USB_BUS *Bus,
  EFI_HANDLE Child
...
# 510 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbUtility.c"
void
UsbCloseHostProtoByChild (
  USB_BUS *Bus,
  EFI_HANDLE Child
...
# 541 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbUtility.c"
EFI_TPL
UsbGetCurrentTpl (
  void
  )
...
# 562 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbUtility.c"
EFI_DEVICE_PATH_PROTOCOL *
  ...
  )
{
  ...
  while ((!IsDevicePathEnd (UsbDevicePathBeginPtr)) &&
         ((UsbDevicePathBeginPtr->Type != 0x03) ||
          ( UsbDevicePathBeginPtr->SubType != 0x05 &&
             UsbDevicePathBeginPtr->SubType != 0x0f
          && UsbDevicePathBeginPtr->SubType != 0x10
          )))
  {
  ...
  while ((!IsDevicePathEnd (UsbDevicePathEndPtr)) &&
         (UsbDevicePathEndPtr->Type == 0x03) &&
         ( UsbDevicePathEndPtr->SubType == 0x05 ||
            UsbDevicePathEndPtr->SubType == 0x0f
         || UsbDevicePathEndPtr->SubType == 0x10
         ))
  {
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (UsbDevicePathPtr != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
...
# 634 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbUtility.c"
BOOLEAN
  ...
  )
{
  ...
  if ((UsbIoDPList == ((void *) 0)) || (UsbDP == ((void *) 0))) {
    return ((BOOLEAN)(0==1));
  }
  ...
  while (ListIndex != UsbIoDPList) {
    ListItem = (((DEVICE_PATH_LIST_ITEM *) (void *) ((CHAR8 *) (ListIndex) - ((UINTN) __builtin_offsetof(DEVICE_PATH_LIST_ITEM, Link))))->Signature != ((('d') | ('p' << 8)) | ((('l') | ('i' << 8)) << 16))) ? ((void *) 0) : ((DEVICE_PATH_LIST_ITEM *) (void *) ((CHAR8 *) (ListIndex) - ((UINTN) __builtin_offsetof(DEVICE_PATH_LIST_ITEM, Link))));



    do { if (((BOOLEAN)(0==1))) { (void) (ListItem->DevicePath != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
...
# 686 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbUtility.c"
EFI_STATUS
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (ListItem != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
  ListItem->Signature = ((('d') | ('p' << 8)) | ((('l') | ('i' << 8)) << 16));
...
# 730 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbUtility.c"
BOOLEAN

MatchUsbClass (
  USB_CLASS_DEVICE_PATH *UsbClassDevicePathPtr,
  USB_INTERFACE *UsbIf
  )
{
  USB_INTERFACE_DESC *IfDesc;
  ...
  if ((UsbClassDevicePathPtr->Header.Type != 0x03) ||
      (UsbClassDevicePathPtr->Header.SubType != 0x0f))
  {
  ...
  if ((ActIfDesc->InterfaceClass == 0x09) &&
      (ActIfDesc->InterfaceSubClass == 0x00))
  {
    return ((BOOLEAN)(1==1));
  }
...
# 809 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbUtility.c"
BOOLEAN
MatchUsbWwid (
  USB_WWID_DEVICE_PATH *UsbWWIDDevicePathPtr,
  USB_INTERFACE *UsbIf
  )
{
  USB_INTERFACE_DESC *IfDesc;
  ...
  if ((UsbWWIDDevicePathPtr->Header.Type != 0x03) ||
      (UsbWWIDDevicePathPtr->Header.SubType != 0x10))
  {
    do { if (((BOOLEAN)(0==1))) { (void) (0); } } while (((BOOLEAN)(0==1)));
    return ((BOOLEAN)(0==1));
  }
...
# 900 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbUtility.c"
EFI_STATUS
...
# 949 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbUtility.c"
EFI_STATUS
  ...
  )
{
  ...
  if ((RemainingDevicePath != ((void *) 0)) && !IsDevicePathEnd (RemainingDevicePath)) {
    if ((RemainingDevicePath->Type != 0x03) ||
        ( (RemainingDevicePath->SubType != 0x05) &&
           (RemainingDevicePath->SubType != 0x0f)
        && (RemainingDevicePath->SubType != 0x10)
        ))
    {
      return ((RETURN_STATUS)(0x8000000000000000ULL | (2)));
    }
  ...
  Bus = (((USB_BUS *) (void *) ((CHAR8 *) (UsbBusId) - ((UINTN) __builtin_offsetof(USB_BUS, BusId))))->Signature != ((('U') | ('S' << 8)) | ((('B') | ('B' << 8)) << 16))) ? ((void *) 0) : ((USB_BUS *) (void *) ((CHAR8 *) (UsbBusId) - ((UINTN) __builtin_offsetof(USB_BUS, BusId))));
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (DevicePathPtr != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
  Status = AddUsbDPToList (DevicePathPtr, &Bus->WantedUsbIoDPList);
  do { if (((BOOLEAN)(0==1))) { (void) (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)); } } while (((BOOLEAN)(0==1)));
  FreePool (DevicePathPtr);
  return (RETURN_STATUS)(0);
}
# 1020 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbUtility.c"
BOOLEAN
  ...
  )
{
  ...
  DoConvert = ((BOOLEAN)(0==1));
  WantedListIndex = WantedUsbIoDPListPtr->ForwardLink;
  while (WantedListIndex != WantedUsbIoDPListPtr) {
    WantedListItem = (((DEVICE_PATH_LIST_ITEM *) (void *) ((CHAR8 *) (WantedListIndex) - ((UINTN) __builtin_offsetof(DEVICE_PATH_LIST_ITEM, Link))))->Signature != ((('d') | ('p' << 8)) | ((('l') | ('i' << 8)) << 16))) ? ((void *) 0) : ((DEVICE_PATH_LIST_ITEM *) (void *) ((CHAR8 *) (WantedListIndex) - ((UINTN) __builtin_offsetof(DEVICE_PATH_LIST_ITEM, Link))));
    do { if (((BOOLEAN)(0==1))) { (void) (WantedListItem->DevicePath->Type == 0x03); } } while (((BOOLEAN)(0==1)));
...
# 1132 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbUtility.c"
EFI_STATUS
  ...
  )
{
  ...
  UsbIoHandleCount = 0;
  Status = gBS->LocateHandleBuffer (ByProtocol, &gEfiUsbIoProtocolGuid, ((void *) 0), &UsbIoHandleCount, &UsbIoBuffer);
  if ((Status == ((RETURN_STATUS)(0x8000000000000000ULL | (14)))) || (UsbIoHandleCount == 0)) {
    return (RETURN_STATUS)(0);
  }
  ...
  for (Index = 0; Index < UsbIoHandleCount; Index++) {
    ...
    if (UsbBusIsWantedUsbIO (Bus, UsbIf)) {
      if (!UsbIf->IsManaged) {
        ...
        do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "UsbBusRecursivelyConnectWantedUsbIo: TPL before connect is %d\n", (UINT32)UsbGetCurrentTpl ()); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
        ...
        do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "UsbBusRecursivelyConnectWantedUsbIo: TPL after connect is %d\n", (UINT32)UsbGetCurrentTpl ()); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
      }
    }
  }

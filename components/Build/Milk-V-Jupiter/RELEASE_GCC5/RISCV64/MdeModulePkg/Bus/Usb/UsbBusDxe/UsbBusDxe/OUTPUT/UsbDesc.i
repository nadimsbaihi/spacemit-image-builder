# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbDesc.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbDesc.c"
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbDesc.c"
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbDesc.c" 2
...
# 56 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbDesc.c"
void
UsbFreeConfigDesc (
  ...
  if (Config->Interfaces != ((void *) 0)) {
    ...
    for (Index = 0; Index < Config->Desc.NumInterfaces; Index++) {
      ...
      for (SetIndex = 0; SetIndex < Interface->NumOfSetting; SetIndex++) {
        if (Interface->Settings[SetIndex] != ((void *) 0)) {
  ...
  )
{
  ...
  if (DevDesc->Configs != ((void *) 0)) {
    for (Index = 0; Index < DevDesc->Desc.NumConfigurations; Index++) {
      if (DevDesc->Configs[Index] != ((void *) 0)) {
...
# 131 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbDesc.c"
void *
UsbCreateDesc (
  UINT8 *DescBuf,
  UINTN Len,
  ...
  )
{
  ...
  *Consumed = 0;
  ...
  if (Len <= sizeof (USB_DESC_HEAD)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "UsbCreateDesc: met mal-format descriptor, total length = %d!\n", Len); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    return ((void *) 0);
  }
  ...
  while (Offset < Len - sizeof (USB_DESC_HEAD)) {
    ...
    if (Head->Len == 0) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "UsbCreateDesc: met mal-format descriptor, Head->Len = 0!\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
      return ((void *) 0);
    }
    ...
    if (Head->Len > ((UINTN)0xFFFFFFFFFFFFFFFFULL) - Offset) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "UsbCreateDesc: met mal-format descriptor, Head->Len = %d!\n", Head->Len); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
      return ((void *) 0);
    }
  ...
  if (Len < Offset) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "UsbCreateDesc: met mal-format descriptor, Offset/Len = %d/%d!\n", Offset, Len); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    return ((void *) 0);
  }

  if ((Head->Type != Type) || (Head->Len < DescLen)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "UsbCreateDesc: descriptor cannot be found, Header(T/L) = %d/%d!\n", Head->Type, Head->Len); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    return ((void *) 0);
  }
...
# 251 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbDesc.c"
USB_INTERFACE_SETTING *
  ...
  )
{
  ...
  *Consumed = 0;
  ...
  if (Setting == ((void *) 0)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "UsbParseInterfaceDesc: failed to create interface descriptor\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    return ((void *) 0);
  }
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "UsbParseInterfaceDesc: interface %d(setting %d) has %d endpoints\n", Setting->Desc.InterfaceNumber, Setting->Desc.AlternateSetting, (UINT32)NumEp); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
  ...
  for (Index = 0; (Index < NumEp) && (Offset < Len); Index++) {
    ...
    if (Ep == ((void *) 0)) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "UsbParseInterfaceDesc: failed to create endpoint(index %d)\n", (UINT32)Index); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
      goto ON_ERROR;
    }
...
# 331 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbDesc.c"
USB_CONFIG_DESC *
UsbParseConfigDesc (
  UINT8 *DescBuf,
  UINTN Len
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (DescBuf != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "UsbParseConfigDesc: config %d has %d interfaces\n", Config->Desc.ConfigurationValue, (UINT32)NumIf); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
...
# 387 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbDesc.c"
  DescBuf += Consumed;
  Len -= Consumed;
  ...
  while (Len >= sizeof (EFI_USB_INTERFACE_DESCRIPTOR)) {
    ...
    if (Setting == ((void *) 0)) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "UsbParseConfigDesc: warning: failed to get interface setting, stop parsing now.\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
      break;
    } else if (Setting->Desc.InterfaceNumber >= NumIf) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "UsbParseConfigDesc: malformatted interface descriptor\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
...
# 450 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbDesc.c"
EFI_STATUS
UsbCtrlRequest (
  USB_DEVICE *UsbDev,
  EFI_USB_DATA_DIRECTION Direction,
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) ((UsbDev != ((void *) 0)) && (UsbDev->Bus != ((void *) 0))); } } while (((BOOLEAN)(0==1)));

  DevReq.RequestType = ((UINT8)((((Direction) == EfiUsbDataIn ? 0x01 : 0) << 7) | (Type) | (Target)));
...
# 509 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbDesc.c"
EFI_STATUS
UsbCtrlGetDesc (
  USB_DEVICE *UsbDev,
  UINTN DescType,
...
# 547 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbDesc.c"
EFI_STATUS
UsbGetMaxPacketSize0 (
  USB_DEVICE *UsbDev
  )
...
# 588 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbDesc.c"
EFI_STATUS
UsbGetDevDesc (
  USB_DEVICE *UsbDev
  )
...
# 632 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbDesc.c"
EFI_USB_STRING_DESCRIPTOR *
UsbGetOneString (
  USB_DEVICE *UsbDev,
  UINT8 Index,
  ...
  )
{
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) ||
      (Desc.Length < ((UINTN) __builtin_offsetof(EFI_USB_STRING_DESCRIPTOR, Length)) + sizeof (Desc.Length)) ||
      (Desc.Length % 2 != 0)
      )
  {
    return ((void *) 0);
...
# 690 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbDesc.c"
EFI_STATUS
UsbBuildLangTable (
  USB_DEVICE *UsbDev
  )
...
# 745 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbDesc.c"
  ...
  )
{
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "UsbGetOneConfig: failed to get descript length(%d) - %r\n", Desc.TotalLength, Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "UsbGetOneConfig: total length is %d\n", Desc.TotalLength); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));




  if (Desc.TotalLength < ((UINTN) __builtin_offsetof(EFI_USB_CONFIG_DESCRIPTOR, TotalLength)) + sizeof (Desc.TotalLength)) {
    return ((void *) 0);
  }
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "UsbGetOneConfig: failed to get full descript - %r\n", Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
...
# 810 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbDesc.c"
EFI_STATUS
UsbBuildDescTable (
  USB_DEVICE *UsbDev
  )
{
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "UsbBuildDescTable: failed to get device descriptor - %r\n", Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    return Status;
  }
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "UsbBuildDescTable: device has %d configures\n", NumConfig); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  ...
  for (Index = 0; Index < NumConfig; Index++) {
    ...
    if (Config == ((void *) 0)) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "UsbBuildDescTable: failed to get configure (index %d)\n", Index); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    ...
    if (ConfigDesc == ((void *) 0)) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "UsbBuildDescTable: failed to parse configure (index %d)\n", Index); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "UsbBuildDescTable: get language ID table - %r\n", Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  }

  return (RETURN_STATUS)(0);
}
# 910 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbDesc.c"
EFI_STATUS
UsbSetAddress (
  USB_DEVICE *UsbDev,
  UINT8 Address
...
# 945 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbDesc.c"
EFI_STATUS
UsbSetConfig (
  USB_DEVICE *UsbDev,
  UINT8 ConfigIndex
...
# 982 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbDesc.c"
EFI_STATUS
UsbIoClearFeature (
  EFI_USB_IO_PROTOCOL *UsbIo,
  UINTN Target,
  ...
  )
{
  ...
  DevReq.RequestType = ((UINT8)((((EfiUsbNoData) == EfiUsbDataIn ? 0x01 : 0) << 7) | (USB_REQ_TYPE_STANDARD) | (Target)));

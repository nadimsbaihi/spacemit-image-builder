# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbMassStorageDxe/UsbMassBoot.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbMassStorageDxe/UsbMassBoot.c"
# 10 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbMassStorageDxe/UsbMassBoot.c"
...
# 11 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbMassStorageDxe/UsbMassBoot.c" 2
# 25 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbMassStorageDxe/UsbMassBoot.c"
EFI_STATUS
UsbBootRequestSense (
  USB_MASS_DEVICE *UsbMass
  )
{
  ...
  SenseCmd.OpCode = 0x03;
  SenseCmd.Lun = (UINT8)(((UsbMass->Lun) << 5));
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) || (CmdResult != 0)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "UsbBootRequestSense: (%r) CmdResult=0x%x\n", Status, CmdResult); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  ...
  switch (((SenseData.SenseKey) & 0x0f)) {
    case 0x00:
      if (SenseData.Asc == 0x00) {



        Status = (RETURN_STATUS)(0);
      } else {
        Status = ((RETURN_STATUS)(0x8000000000000000ULL | (16)));
      }
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "UsbBootRequestSense: (%r) with error code (%x) sense key %x/%x/%x\n", Status, SenseData.ErrorCode, ((SenseData.SenseKey) & 0x0f), SenseData.Asc, SenseData.Ascq); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
...
# 169 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbMassStorageDxe/UsbMassBoot.c"
EFI_STATUS
UsbBootExecCmd (
  USB_MASS_DEVICE *UsbMass,
  void *Cmd,
  ...
  )
{
  ...
  if (Status == ((RETURN_STATUS)(0x8000000000000000ULL | (18)))) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "UsbBootExecCmd: %r to Exec 0x%x Cmd\n", Status, *(UINT8 *)Cmd); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  ...
  if ((CmdResult == 0) && !(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "UsbBootExecCmd: %r to Exec 0x%x Cmd (Result = %x)\n", Status, *(UINT8 *)Cmd, CmdResult); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  return UsbBootRequestSense (UsbMass);
}
# 238 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbMassStorageDxe/UsbMassBoot.c"
EFI_STATUS
  ...
  )
{
  ...
  Status = gBS->SetTimer (TimeoutEvt, TimerRelative, MultU64x32((UINT64)(60), 10000000));
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    goto EXIT;
  }
  ...
  while ((((RETURN_STATUS)(gBS->CheckEvent (TimeoutEvt))) >= 0x8000000000000000ULL)) {
    ...
    if ((Status == (RETURN_STATUS)(0)) || (Status == ((RETURN_STATUS)(0x8000000000000000ULL | (12))))) {
      break;
    }
...
EXIT:
  if (TimeoutEvt != ((void *) 0)) {
    gBS->CloseEvent (TimeoutEvt);
  }

  return Status;
}
# 321 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbMassStorageDxe/UsbMassBoot.c"
EFI_STATUS
UsbBootIsUnitReady (
  USB_MASS_DEVICE *UsbMass
  )
{
  ...
  TestCmd.OpCode = 0x00;
  TestCmd.Lun = (UINT8)(((UsbMass->Lun) << 5));
...
# 354 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbMassStorageDxe/UsbMassBoot.c"
EFI_STATUS
UsbBootInquiry (
  USB_MASS_DEVICE *UsbMass
  )
{
  ...
  InquiryCmd.OpCode = 0x12;
  InquiryCmd.Lun = (UINT8)(((UsbMass->Lun) << 5));
  ...
  UsbMass->Pdt = (UINT8)(((UsbMass->InquiryData.Pdt) & 0x1f));
  Media->RemovableMedia = (BOOLEAN)((((UsbMass->InquiryData.Removable) & 0x00000080) != 0));
...
# 414 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbMassStorageDxe/UsbMassBoot.c"
EFI_STATUS
  ...
  )
{
  ...
  Media->MediaPresent = ((BOOLEAN)(1==1));
...
# 495 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbMassStorageDxe/UsbMassBoot.c"
EFI_STATUS
UsbBootReadCapacity (
  USB_MASS_DEVICE *UsbMass
  )
{
  ...
  CapacityCmd.OpCode = 0x25;
  CapacityCmd.Lun = (UINT8)(((UsbMass->Lun) << 5));
  ...
  if (Media->LastBlock == 0xFFFFFFFF) {
    ...
    if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
      UsbMass->Cdb16Byte = ((BOOLEAN)(1==1));
    }
  }

  return Status;
}
# 563 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbMassStorageDxe/UsbMassBoot.c"
EFI_STATUS
UsbScsiModeSense (
  USB_MASS_DEVICE *UsbMass
  )
{
  ...
  ModeSenseCmd.OpCode = 0x1A;
  ModeSenseCmd.Lun = (UINT8)((UsbMass->Lun) << 5);
  ...
  if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    Media->ReadOnly = (BOOLEAN)((ModeParaHeader.DevicePara & 0x00000080) != 0);
  }

  return Status;
}
# 623 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbMassStorageDxe/UsbMassBoot.c"
EFI_STATUS
UsbBootGetParams (
  USB_MASS_DEVICE *UsbMass
  )
{
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "UsbBootGetParams: UsbBootInquiry (%r)\n", Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    return Status;
  }
  ...
  if ((UsbMass->Pdt != 0x00) &&
      ...
      (UsbMass->Pdt != 0x0E))
  {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "UsbBootGetParams: Found an unsupported peripheral type[%d]\n", UsbMass->Pdt); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  ...
  if ((UsbMass->Pdt == 0x05) || (UsbMass->Pdt == 0x07)) {



    UsbMass->OpticalStorage = ((BOOLEAN)(1==1));
...
# 681 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbMassStorageDxe/UsbMassBoot.c"
EFI_STATUS
UsbBootDetectMedia (
  USB_MASS_DEVICE *UsbMass
  )
{
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "UsbBootDetectMedia: UsbBootIsUnitReady (%r)\n", Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  }
# 709 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbMassStorageDxe/UsbMassBoot.c"
  if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    if ((UsbMass->Pdt != 0x05) && (CmdSet == 0x06)) {
    ...
    if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "UsbBootDetectMedia: UsbBootReadCapacity (%r)\n", Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    }
  }
  ...
  if ((Media->BlockSize == 0) || (Media->BlockSize > 0x00010000)) {
    return ((RETURN_STATUS)(0x8000000000000000ULL | (7)));
  }
# 749 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbMassStorageDxe/UsbMassBoot.c"
      ...
      (Media->LastBlock != OldMedia.LastBlock))
  {
    ...
    do { if (((BOOLEAN)(0==1))) { (void) (EfiGetCurrentTpl () == 8); } } while (((BOOLEAN)(0==1)));
    ...
    Status = Media->MediaPresent ? ((RETURN_STATUS)(0x8000000000000000ULL | (13))) : ((RETURN_STATUS)(0x8000000000000000ULL | (12)));
  }

  return Status;
}
# 809 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbMassStorageDxe/UsbMassBoot.c"
EFI_STATUS
UsbBootReadWriteBlocks (
  USB_MASS_DEVICE *UsbMass,
  BOOLEAN Write,
  ...
  )
{
  ...
  while (TotalBlock > 0) {
    ...
    Count = (UINT32)(((TotalBlock) < (CountMax)) ? (TotalBlock) : (CountMax));
    Count = (((((UINT16)0xFFFF)) < (Count)) ? (((UINT16)0xFFFF)) : (Count));
    ByteSize = Count * BlockSize;




    Timeout = (UINT32)(5 * (1000 * 1000));
    ...
    Cmd.OpCode = Write ? 0x2A : 0x28;
    Cmd.Lun = (UINT8)(((UsbMass->Lun) << 5));
    ...
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00001000)) { DebugPrint (0x00001000, "UsbBoot%sBlocks: LBA (0x%lx), Blk (0x%x)\n", Write ? L"Write" : L"Read", Lba, Count); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
...
# 895 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbMassStorageDxe/UsbMassBoot.c"
EFI_STATUS
UsbBootReadWriteBlocks16 (
  USB_MASS_DEVICE *UsbMass,
  BOOLEAN Write,
  ...
  )
{
  ...
  while (TotalBlock > 0) {
    ...
    Cmd[1] = (UINT8)((((UsbMass->Lun) << 5) & 0xE0));
    ...
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00001000)) { DebugPrint (0x00001000, "UsbBoot%sBlocks16: LBA (0x%lx), Blk (0x%x)\n", Write ? L"Write" : L"Read", Lba, Count); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
...
# 976 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbMassStorageDxe/UsbMassBoot.c"
EFI_STATUS
UsbClearEndpointStall (
  EFI_USB_IO_PROTOCOL *UsbIo,
  UINT8 EndpointAddr

# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbHub.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbHub.c"
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbHub.c"
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbHub.c" 2
# 19 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbHub.c"
USB_CHANGE_FEATURE_MAP mHubFeatureMap[] = {
  { 0x0001, EfiUsbPortConnectChange },
  { 0x0002, EfiUsbPortEnableChange },
  { 0x0004, EfiUsbPortSuspendChange },
  { 0x0008, EfiUsbPortOverCurrentChange },
  { 0x0010, EfiUsbPortResetChange }
};
...
# 51 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbHub.c"
EFI_STATUS
...
# 84 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbHub.c"
EFI_STATUS
...
# 118 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbHub.c"
EFI_STATUS
...
# 163 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbHub.c"
EFI_STATUS
UsbHubCtrlClearTTBuffer (
  USB_DEVICE *HubDev,
  UINT8 Port,
...
# 207 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbHub.c"
EFI_STATUS
...
# 246 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbHub.c"
EFI_STATUS
...
# 280 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbHub.c"
EFI_STATUS
...
# 321 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbHub.c"
EFI_STATUS
...
# 361 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbHub.c"
EFI_STATUS
UsbHubReadDesc (
  USB_DEVICE *HubDev,
...
# 394 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbHub.c"
EFI_STATUS
UsbHubAckHubStatus (
  USB_DEVICE *HubDev
  )
{
  ...
  if (((BOOLEAN)(((HubState.PortChangeStatus) & (0x01)) == (0x01)))) {
    UsbHubCtrlClearHubFeature (HubDev, 0);
  }

  if (((BOOLEAN)(((HubState.PortChangeStatus) & (0x02)) == (0x02)))) {
    UsbHubCtrlClearHubFeature (HubDev, 1);
  }

  return (RETURN_STATUS)(0);
}
# 428 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbHub.c"
BOOLEAN
UsbIsHubInterface (
  USB_INTERFACE *UsbIf
  )
{
  ...
  if ((Setting->InterfaceClass == 0x09) &&
      (Setting->InterfaceSubClass == 0x00))
  {
    return ((BOOLEAN)(1==1));
  }
...
# 464 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbHub.c"
EFI_STATUS
  ...
  )
{
  ...
  if (Result != 0x00) {
    ...
    if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "UsbOnHubInterrupt: failed to remove async transfer - %r\n", Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
      return Status;
    }
    ...
    if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "UsbOnHubInterrupt: failed to submit new async transfer - %r\n", Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    }
...
# 562 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbHub.c"
EFI_STATUS
UsbHubInit (
  USB_INTERFACE *HubIf
  )
{
  ...
  for (Index = 0; Index < NumEndpoints; Index++) {
    do { if (((BOOLEAN)(0==1))) { (void) ((Setting->Endpoints != ((void *) 0)) && (Setting->Endpoints[Index] != ((void *) 0))); } } while (((BOOLEAN)(0==1)));

    EpDesc = Setting->Endpoints[Index];

    if (((BOOLEAN)(((EpDesc->Desc.EndpointAddress) & (USB_ENDPOINT_DIR_IN)) == (USB_ENDPOINT_DIR_IN))) &&
        (((&EpDesc->Desc)->Attributes & USB_ENDPOINT_TYPE_MASK) == USB_ENDPOINT_INTERRUPT))
    {
      break;
    }
  }
  ...
  if (Index == NumEndpoints) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "UsbHubInit: no interrupt endpoint found for hub %d\n", HubDev->Address); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "UsbHubInit: failed to read HUB descriptor - %r\n", Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    return Status;
  }

  HubIf->NumOfPort = HubDesc->NumPorts;

  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "UsbHubInit: hub %d has %d ports\n", HubDev->Address, HubIf->NumOfPort); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  ...
  HubIf->IsHub = ((BOOLEAN)(1==1));
  HubIf->HubApi = &mUsbHubApi;
  HubIf->HubEp = EpDesc;

  if (HubIf->Device->Speed == 0x0003) {
    Depth = (UINT16)(HubIf->Device->Tier - 1);
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "UsbHubInit: Set Hub Depth as 0x%x\n", Depth); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    UsbHubCtrlSetHubDepth (HubIf->Device, Depth);

    for (Index = 0; Index < HubDesc->NumPorts; Index++) {
      UsbHubCtrlSetPortFeature (HubIf->Device, Index, 27);
    }
  } else {
    ...
    for (Index = 0; Index < HubDesc->NumPorts; Index++) {
      UsbHubCtrlSetPortFeature (HubIf->Device, Index, (EFI_USB_PORT_FEATURE)8);
    }
    ...
    if (HubDesc->PwrOn2PwrGood > 0) {
      gBS->Stall (HubDesc->PwrOn2PwrGood * (2 * 1000));
    }
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "UsbHubInit: failed to create signal for hub %d - %r\n", HubDev->Address, Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
...
# 686 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbHub.c"
  UsbIo = &HubIf->UsbIo;
  Status = UsbIo->UsbAsyncInterruptTransfer (
                    UsbIo,
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "UsbHubInit: failed to queue interrupt transfer for hub %d - %r\n", HubDev->Address, Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
    ...
    HubIf->HubNotify = ((void *) 0);

    return Status;
  }

  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "UsbHubInit: hub %d initialized\n", HubDev->Address); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  return Status;
}
# 729 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbHub.c"
EFI_STATUS
UsbHubGetPortStatus (
  USB_INTERFACE *HubIf,
  UINT8 Port,
...
# 750 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbHub.c"
void
  ...
  )
{
  ...
  for (Index = 0; Index < (sizeof (mHubFeatureMap) / sizeof ((mHubFeatureMap)[0])); Index++) {
    ...
    if (((BOOLEAN)(((PortState.PortChangeStatus) & (Map->ChangedBit)) == (Map->ChangedBit)))) {
      UsbHubCtrlClearPortFeature (HubIf->Device, Port, (UINT16)Map->Feature);
    }
  }
}
# 793 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbHub.c"
EFI_STATUS
...
# 818 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbHub.c"
EFI_STATUS
...
# 843 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbHub.c"
EFI_STATUS
UsbHubResetPort (
  USB_INTERFACE *HubIf,
  UINT8 Port
  )
{
  ...
  Status = UsbHubSetPortFeature (HubIf, Port, (EFI_USB_PORT_FEATURE)4);
  ...
  for (Index = 0; Index < 5000; Index++) {
    ...
    if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) &&
        ((BOOLEAN)(((PortState.PortChangeStatus) & (0x0010)) == (0x0010))))
    {
      gBS->Stall ((10 * 1000));
      return (RETURN_STATUS)(0);
    }
...
# 898 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbHub.c"
EFI_STATUS
UsbHubRelease (
  USB_INTERFACE *HubIf
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "UsbHubRelease: hub device %d released\n", HubIf->Device->Address); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  return (RETURN_STATUS)(0);
}
# 941 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbHub.c"
EFI_STATUS
UsbRootHubInit (
  USB_INTERFACE *HubIf
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "UsbRootHubInit: root hub %p - max speed %d, %d ports\n", HubIf, MaxSpeed, NumOfPort); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
...
# 1020 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbHub.c"
EFI_STATUS
...
# 1043 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbHub.c"
void
...
# 1086 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbHub.c"
EFI_STATUS
...
# 1111 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbHub.c"
EFI_STATUS
...
# 1138 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbHub.c"
EFI_STATUS
UsbRootHubResetPort (
  ...
  )
{
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "UsbRootHubResetPort: failed to start reset on port %d\n", Port); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    return Status;
  }
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "UsbRootHubResetPort: failed to clear reset on port %d\n", Port); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    return Status;
  }
  ...
  for (Index = 0; Index < 5000; Index++) {
    ...
    if (!((BOOLEAN)(((PortState.PortStatus) & (0x0010)) == (0x0010)))) {
      break;
    }
  ...
  if (Index == 5000) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "UsbRootHubResetPort: reset not finished in time on port %d\n", Port); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    return ((RETURN_STATUS)(0x8000000000000000ULL | (18)));
  }

  if (!((BOOLEAN)(((PortState.PortStatus) & (0x0002)) == (0x0002)))) {
    ...
    if (RootIf->MaxSpeed == 0x0002) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "UsbRootHubResetPort: release low/full speed device (%d) to UHCI\n", Port); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
      ...
      if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
        do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "UsbRootHubResetPort: failed to enable port %d for UHCI\n", Port); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
        return Status;
      }
...
# 1239 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbBusDxe/UsbHub.c"
EFI_STATUS
UsbRootHubRelease (
  USB_INTERFACE *HubIf
  )
{
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "UsbRootHubRelease: root hub released for hub %p\n", HubIf); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));

  gBS->SetTimer (HubIf->HubNotify, TimerCancel, (100 * 10000U));
  gBS->CloseEvent (HubIf->HubNotify);

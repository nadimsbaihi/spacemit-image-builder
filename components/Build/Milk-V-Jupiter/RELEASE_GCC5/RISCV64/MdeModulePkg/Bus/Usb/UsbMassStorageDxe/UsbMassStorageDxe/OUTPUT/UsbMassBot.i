# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbMassStorageDxe/UsbMassBot.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbMassStorageDxe/UsbMassBot.c"
# 10 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbMassStorageDxe/UsbMassBot.c"
...
# 11 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbMassStorageDxe/UsbMassBot.c" 2
...
# 39 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbMassStorageDxe/UsbMassBot.c"
EFI_STATUS
UsbBotInit (
  EFI_USB_IO_PROTOCOL *UsbIo,
  void **Context
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (UsbBot != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
  ...
  if (Interface->InterfaceProtocol != 0x50) {
  ...
  for (Index = 0; Index < Interface->NumEndpoints; Index++) {
    ...
    if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) || !(((EndPoint.Attributes) & (0x00000001 | 0x00000002)) == USB_ENDPOINT_BULK)) {
      continue;
    }

    if ((((EndPoint.EndpointAddress) & 0x00000080) == 0x00000080) &&
        (UsbBot->BulkInEndpoint == ((void *) 0)))
    {
      UsbBot->BulkInEndpoint = (EFI_USB_ENDPOINT_DESCRIPTOR *)(UsbBot + 1);
      CopyMem (UsbBot->BulkInEndpoint, &EndPoint, sizeof (EndPoint));
    }

    if ((((EndPoint.EndpointAddress) & 0x00000080) == 0) &&
        (UsbBot->BulkOutEndpoint == ((void *) 0)))
    {
  ...
  if ((UsbBot->BulkInEndpoint == ((void *) 0)) || (UsbBot->BulkOutEndpoint == ((void *) 0))) {
    Status = ((RETURN_STATUS)(0x8000000000000000ULL | (3)));
    goto ON_ERROR;
  }
...
# 146 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbMassStorageDxe/UsbMassBot.c"
EFI_STATUS
UsbBotSendCommand (
  USB_BOT_PROTOCOL *UsbBot,
  UINT8 *Cmd,
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) ((CmdLen > 0) && (CmdLen <= 16)); } } while (((BOOLEAN)(0==1)));
  ...
  Cbw.Flag = (UINT8)((DataDir == EfiUsbDataIn) ? 0x00000080 : 0);
  Cbw.Lun = Lun;
  Cbw.CmdLen = CmdLen;

  ZeroMem (Cbw.CmdBlock, 16);
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    if ((((Result) & (0x02)) != 0) && (DataDir == EfiUsbDataOut)) {




      UsbBotResetDevice (UsbBot, ((BOOLEAN)(0==1)));
...
# 226 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbMassStorageDxe/UsbMassBot.c"
EFI_STATUS
UsbBotDataTransfer (
  USB_BOT_PROTOCOL *UsbBot,
  EFI_USB_DATA_DIRECTION DataDir,
  ...
  )
{
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    if ((((Result) & (0x02)) != 0)) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "UsbBotDataTransfer: (%r)\n", Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "UsbBotDataTransfer: DataIn Stall\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
      UsbClearEndpointStall (UsbBot->UsbIo, Endpoint->EndpointAddress);
    } else if ((((Result) & (0x10)) != 0)) {
      Status = ((RETURN_STATUS)(0x8000000000000000ULL | (6)));
    } else {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "UsbBotDataTransfer: (%r)\n", Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    }
...
# 304 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbMassStorageDxe/UsbMassBot.c"
EFI_STATUS
UsbBotGetStatus (
  USB_BOT_PROTOCOL *UsbBot,
  UINT32 TransLen,
  ...
  *CmdStatus = 0x02;
  ...
  for (Index = 0; Index < 3; Index++) {
    ...
    if (Csw.Signature != 0x53425355) {
      ...
      Status = UsbBotResetDevice (UsbBot, ((BOOLEAN)(0==1)));
    } else if (Csw.CmdStatus == 0x02) {
...
# 392 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbMassStorageDxe/UsbMassBot.c"
EFI_STATUS
UsbBotExecCommand (
  void *Context,
  void *Cmd,
  ...
  )
{
  ...
  *CmdStatus = 1;
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "UsbBotExecCommand: UsbBotSendCommand (%r)\n", Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    return Status;
  }
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "UsbBotExecCommand: UsbBotGetStatus (%r)\n", Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    return Status;
  }
...
# 459 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbMassStorageDxe/UsbMassBot.c"
EFI_STATUS
UsbBotResetDevice (
  void *Context,
  BOOLEAN ExtendedVerification
...
# 535 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbMassStorageDxe/UsbMassBot.c"
EFI_STATUS
UsbBotGetMaxLun (
  void *Context,
  UINT8 *MaxLun
  )
{
  ...
  if ((Context == ((void *) 0)) || (MaxLun == ((void *) 0))) {
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) || (*MaxLun > 0x0F)) {
# 583 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbMassStorageDxe/UsbMassBot.c"
    *MaxLun = 0;
  }

  return (RETURN_STATUS)(0);
}
# 597 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbMassStorageDxe/UsbMassBot.c"
EFI_STATUS
UsbBotCleanUp (
  void *Context
  )

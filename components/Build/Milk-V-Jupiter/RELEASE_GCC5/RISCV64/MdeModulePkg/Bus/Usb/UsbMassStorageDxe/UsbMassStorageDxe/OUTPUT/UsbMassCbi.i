# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbMassStorageDxe/UsbMassCbi.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbMassStorageDxe/UsbMassCbi.c"
# 12 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbMassStorageDxe/UsbMassCbi.c"
...
# 13 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbMassStorageDxe/UsbMassCbi.c" 2
...
# 53 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbMassStorageDxe/UsbMassCbi.c"
EFI_STATUS
UsbCbiInit (
  EFI_USB_IO_PROTOCOL *UsbIo,
  void **Context
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (UsbCbi != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
  ...
  if ( (Interface->InterfaceProtocol != 0x00)
  ...
  for (Index = 0; Index < Interface->NumEndpoints; Index++) {
    ...
    if ((((EndPoint.Attributes) & (0x00000001 | 0x00000002)) == USB_ENDPOINT_BULK)) {



      if ((((EndPoint.EndpointAddress) & 0x00000080) == 0x00000080) &&
          (UsbCbi->BulkInEndpoint == ((void *) 0)))
      {
      ...
      if ((((EndPoint.EndpointAddress) & 0x00000080) == 0) &&
          (UsbCbi->BulkOutEndpoint == ((void *) 0)))
      {
        UsbCbi->BulkOutEndpoint = (EFI_USB_ENDPOINT_DESCRIPTOR *)(UsbCbi + 1) + 1;
        CopyMem (UsbCbi->BulkOutEndpoint, &EndPoint, sizeof (EndPoint));
      }
    } else if ((((EndPoint.Attributes) & (0x00000001 | 0x00000002)) == USB_ENDPOINT_INTERRUPT)) {



      if ((Interface->InterfaceProtocol == 0x00) &&
          (UsbCbi->InterruptEndpoint == ((void *) 0)))
      {
  ...
  if ((UsbCbi->BulkInEndpoint == ((void *) 0)) || (UsbCbi->BulkOutEndpoint == ((void *) 0))) {
    Status = ((RETURN_STATUS)(0x8000000000000000ULL | (3)));
    goto ON_ERROR;
  }

  if ((Interface->InterfaceProtocol == 0x00) && (UsbCbi->InterruptEndpoint == ((void *) 0))) {
    Status = ((RETURN_STATUS)(0x8000000000000000ULL | (3)));
    goto ON_ERROR;
  }
...
# 169 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbMassStorageDxe/UsbMassCbi.c"
EFI_STATUS
UsbCbiSendCommand (
  USB_CBI_PROTOCOL *UsbCbi,
  UINT8 *Cmd,
  ...
  )
{
  ...
  for (Retry = 0; Retry < 3; Retry++) {
    ...
    if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) && (TransStatus == 0x10)) {
      continue;
    }
...
# 246 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbMassStorageDxe/UsbMassCbi.c"
EFI_STATUS
UsbCbiDataTransfer (
  USB_CBI_PROTOCOL *UsbCbi,
  EFI_USB_DATA_DIRECTION DataDir,
  ...
  )
{
  ...
  while (Remain > 0) {
    ...
    if (Remain > (UINTN)16 * Endpoint->MaxPacketSize) {
      Increment = 16 * Endpoint->MaxPacketSize;
    } else {
      Increment = Remain;
    }
...
# 363 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbMassStorageDxe/UsbMassCbi.c"
EFI_STATUS
UsbCbiGetStatus (
  USB_CBI_PROTOCOL *UsbCbi,
  UINT32 Timeout,
...
# 425 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbMassStorageDxe/UsbMassCbi.c"
EFI_STATUS
UsbCbiExecCommand (
  void *Context,
  void *Cmd,
  ...
  )
{
  ...
  *CmdStatus = 0;
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    gBS->Stall (10 * 1000);
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "UsbCbiExecCommand: UsbCbiSendCommand (%r)\n", Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    return Status;
  }
  ...
  if (UsbCbi->InterruptEndpoint == ((void *) 0)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "UsbCbiExecCommand: UsbCbiDataTransfer (%r)\n", Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    return Status;
  }
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "UsbCbiExecCommand: UsbCbiGetStatus (%r)\n", Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    return Status;
  }

  if (UsbCbi->Interface.InterfaceSubClass == 0x04) {
    ...
    switch (Result.Value & 0x03) {
      ...
      case 0x02:
        ...
        UsbCbiResetDevice (UsbCbi, ((BOOLEAN)(0==1)));
...
# 541 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbMassStorageDxe/UsbMassCbi.c"
EFI_STATUS
UsbCbiResetDevice (
  void *Context,
  BOOLEAN ExtendedVerification
  )
{
  ...
  Status = UsbCbiSendCommand (UsbCbi, ResetCmd, 12, Timeout);
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
...
# 596 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Bus/Usb/UsbMassStorageDxe/UsbMassCbi.c"
EFI_STATUS
UsbCbiCleanUp (
  void *Context
  )

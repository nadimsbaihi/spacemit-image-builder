# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/MdeModulePkg/Core/Dxe/DxeMain/DEBUG/AutoGen.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/MdeModulePkg/Core/Dxe/DxeMain/DEBUG/AutoGen.c"
# 9 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/MdeModulePkg/Core/Dxe/DxeMain/DEBUG/AutoGen.c"
...
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/MdeModulePkg/Core/Dxe/DxeMain/DEBUG/AutoGen.c" 2
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/MdeModulePkg/Core/Dxe/DxeMain/DEBUG/AutoGen.c" 2

 GUID gEfiCallerIdGuid = {0xD6A2CB7F, 0x6A18, 0x4e2f, {0xB4, 0x3B, 0x99, 0x20, 0xA7, 0x33, 0x70, 0x0A}};

 GUID gEdkiiDscPlatformGuid = {0xBECC2C86, 0x0329, 0x4876, {0x98, 0xB1, 0x57, 0xCC, 0x37, 0xB3, 0x3D, 0xF3}};

 CHAR8 *gEfiCallerBaseName = "DxeCore";
...
volatile UINT32 _gPcd_BinaryPatch_PcdLoadFixAddressBootTimeCodePageNumber = ((UINT32)0U);
 UINTN _gPcd_BinaryPatch_Size_PcdLoadFixAddressBootTimeCodePageNumber = 4;
volatile UINT32 _gPcd_BinaryPatch_PcdLoadFixAddressRuntimeCodePageNumber = ((UINT32)0U);
 UINTN _gPcd_BinaryPatch_Size_PcdLoadFixAddressRuntimeCodePageNumber = 4;
 const UINT64 _gPcd_FixedAtBuild_PcdLoadModuleAtFixAddressEnable = 0ULL;
 const UINT64 _gPcd_FixedAtBuild_PcdMaxEfiSystemTablePointerAddress = 0x0ULL;
 const UINT64 _gPcd_FixedAtBuild_PcdMemoryProfileMemoryType = 0x0ULL;
 const UINT8 _gPcd_FixedAtBuild_PcdMemoryProfilePropertyMask = 0x0U;
 const UINT8 _gPcd_FixedAtBuild_PcdMemoryProfileDriverPath[1] = {0x0};
 const UINTN _gPcd_FixedAtBuild_Size_PcdMemoryProfileDriverPath = 1;
 const UINT32 _gPcd_FixedAtBuild_PcdImageProtectionPolicy = 0x00000002U;
 const UINT64 _gPcd_FixedAtBuild_PcdDxeNxMemoryProtectionPolicy = 0x0000000ULL;
 const UINT8 _gPcd_FixedAtBuild_PcdNullPointerDetectionPropertyMask = 0x0U;
 const UINT64 _gPcd_FixedAtBuild_PcdHeapGuardPageType = 0x0ULL;
 const UINT64 _gPcd_FixedAtBuild_PcdHeapGuardPoolType = 0x0ULL;
 const UINT8 _gPcd_FixedAtBuild_PcdHeapGuardPropertyMask = 0x0U;
 const BOOLEAN _gPcd_FixedAtBuild_PcdCpuStackGuard = 0U;
 const UINT32 _gPcd_FixedAtBuild_PcdFwVolDxeMaxEncapsulationDepth = 0x10U;
 const BOOLEAN _gPcd_FixedAtBuild_PcdImageLargeAddressLoad = 1U;
...
extern const UINT8 _gPcd_FixedAtBuild_PcdPerformanceLibraryPropertyMask;
 ...
 const BOOLEAN _gPcd_FixedAtBuild_PcdEdkiiFpdtStringRecordEnableOnly = 0U;
extern const BOOLEAN _gPcd_FixedAtBuild_PcdEdkiiFpdtStringRecordEnableOnly;
 ...
 const UINT32 _gPcd_FixedAtBuild_PcdExtFpdtBootRecordPadSize = 0x30000U;

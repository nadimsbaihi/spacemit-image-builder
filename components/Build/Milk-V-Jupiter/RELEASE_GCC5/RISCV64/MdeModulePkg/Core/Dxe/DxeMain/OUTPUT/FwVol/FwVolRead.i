# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/FwVol/FwVolRead.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/FwVol/FwVolRead.c"
# 9 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/FwVol/FwVolRead.c"
...
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/FwVol/FwVolRead.c" 2
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/FwVol/FwVolRead.c" 2
# 32 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/FwVol/FwVolRead.c"
UINT8 mFvAttributes[] = { 0, 4, 7, 9, 10, 12, 15, 16 };
UINT8 mFvAttributes2[] = { 17, 18, 19, 20, 21, 22, 23, 24 };
# 43 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/FwVol/FwVolRead.c"
  ...
  )
{
  ...
  DataAlignment = (UINT8)((FfsAttributes & 0x38) >> 3);
  do { if (((BOOLEAN)(0==1))) { (void) (DataAlignment < 8); } } while (((BOOLEAN)(0==1)));

  if ((FfsAttributes & 0x02) != 0) {
  ...
  if ((FfsAttributes & 0x04) == 0x04) {
    FileAttribute |= 0x00000100;
  }

  return FileAttribute;
}
# 113 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/FwVol/FwVolRead.c"
EFI_STATUS
  ...
  )
{
  ...
  FvDevice = (((FV_DEVICE *) (void *) ((CHAR8 *) (This) - ((UINTN) __builtin_offsetof(FV_DEVICE, Fv))))->Signature != ((('_') | ('F' << 8)) | ((('V') | ('2' << 8)) << 16))) ? ((void *) 0) : ((FV_DEVICE *) (void *) ((CHAR8 *) (This) - ((UINTN) __builtin_offsetof(FV_DEVICE, Fv))));
  ...
  if ((FvAttributes & 0x0000000000000004ULL) == 0) {
  ...
  *Attributes = FfsAttributes2FvFileAttributes (FfsFileHeader->Attributes);
  if ((FvDevice->FwVolHeader->Attributes & 0x00000400) == 0x00000400) {
  ...
  if ((((((EFI_FFS_FILE_HEADER *) (UINTN) FfsFileHeader)->Attributes) & 0x01) == 0x01)) {
    *Size = ((UINT32) (((EFI_FFS_FILE_HEADER2 *) (UINTN) FfsFileHeader)->ExtendedSize)) - sizeof (EFI_FFS_FILE_HEADER2);
  } else {
    *Size = ((UINT32) ( (((EFI_FFS_FILE_HEADER *) (UINTN) (FfsFileHeader))->Size[0] ) | (((EFI_FFS_FILE_HEADER *) (UINTN) (FfsFileHeader))->Size[1] << 8) | (((EFI_FFS_FILE_HEADER *) (UINTN) (FfsFileHeader))->Size[2] << 16))) - sizeof (EFI_FFS_FILE_HEADER);
  }

  return (RETURN_STATUS)(0);
}
# 266 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/FwVol/FwVolRead.c"
EFI_STATUS
  ...
  )
{
  ...
  if (FvDevice->IsMemoryMapped) {
    ...
    if (!FvDevice->LastKey->FileCached) {
      ...
      WholeFileSize = (((((EFI_FFS_FILE_HEADER *) (UINTN) FfsHeader)->Attributes) & 0x01) == 0x01) ? ((UINT32) (((EFI_FFS_FILE_HEADER2 *) (UINTN) FfsHeader)->ExtendedSize)) : ((UINT32) ( (((EFI_FFS_FILE_HEADER *) (UINTN) (FfsHeader))->Size[0] ) | (((EFI_FFS_FILE_HEADER *) (UINTN) (FfsHeader))->Size[1] << 8) | (((EFI_FFS_FILE_HEADER *) (UINTN) (FfsHeader))->Size[2] << 16)));
      ...
      FvDevice->LastKey->FileCached = ((BOOLEAN)(1==1));
    }
  }
...
# 430 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/FwVol/FwVolRead.c"
EFI_STATUS
  ...
  )
{
  ...
  if ((NameGuid == ((void *) 0)) || (Buffer == ((void *) 0))) {
    return ((RETURN_STATUS)(0x8000000000000000ULL | (2)));
  }
  ...
  if ((((((EFI_FFS_FILE_HEADER *) (UINTN) FfsEntry->FfsHeader)->Attributes) & 0x01) == 0x01)) {
  ...
  Status = GetSection (
             FfsEntry->StreamHandle,
             (SectionType == 0) ? ((void *) 0) : &SectionType,
             ((void *) 0),

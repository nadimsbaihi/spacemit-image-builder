# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Misc/DebugImageInfo.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Misc/DebugImageInfo.c"
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Misc/DebugImageInfo.c"
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Misc/DebugImageInfo.c" 2
...
EFI_SYSTEM_TABLE_POINTER *mDebugTable = ((void *) 0);
# 29 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Misc/DebugImageInfo.c"
void
CoreInitializeDebugImageInfoTable (
  void
  )
{
  ...
  Pages = (((sizeof (EFI_SYSTEM_TABLE_POINTER)) >> 12) + (((sizeof (EFI_SYSTEM_TABLE_POINTER)) & 0xFFF) ? 1 : 0));
  AlignmentMask = 0x00400000 - 1;
  RealPages = Pages + (((0x00400000) >> 12) + (((0x00400000) & 0xFFF) ? 1 : 0));
  ...
  Memory = _gPcd_FixedAtBuild_PcdMaxEfiSystemTablePointerAddress;
  if (Memory == 0) {
    Memory = 0xFFFFFFFFFFFFFFFFULL;
  }
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    if (_gPcd_FixedAtBuild_PcdMaxEfiSystemTablePointerAddress != 0) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Allocate memory for EFI_SYSTEM_TABLE_POINTER below PcdMaxEfiSystemTablePointerAddress failed.                           Retry to allocate memroy as close to the top of memory as feasible.\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
                                                                                                  ;
    }
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (mDebugTable != ((void *) 0)); } } while (((BOOLEAN)(0==1)));




  mDebugTable->Signature = (((('I') | ('B' << 8)) | ((('I') | (' ' << 8)) << 16)) | ((UINT64) (((('S') | ('Y' << 8)) | ((('S') | ('T' << 8)) << 16))) << 32));
...
# 141 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Misc/DebugImageInfo.c"
void
CoreUpdateDebugTableCrc32 (
  void
  )
...
# 161 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Misc/DebugImageInfo.c"
void
CoreNewDebugImageInfoEntry (
  UINT32 ImageInfoType,
  EFI_LOADED_IMAGE_PROTOCOL *LoadedImage,
  ...
  )
{
  ...
  mDebugInfoTableHeader.UpdateStatus |= 0x01;
  ...
  if (mDebugInfoTableHeader.TableSize < mMaxTableEntries) {
    ...
    Index = 0;
    while (Table[Index].NormalImage != ((void *) 0)) {
      Index++;
    }
    ...
    do { if (((BOOLEAN)(0==1))) { (void) (Index < mMaxTableEntries); } } while (((BOOLEAN)(0==1)));
  } else {



    TableSize = mMaxTableEntries * (sizeof (void *));
    NewTable = AllocateZeroPool (TableSize + 0x00001000);
    if (NewTable == ((void *) 0)) {
      mDebugInfoTableHeader.UpdateStatus &= ~0x01;
      return;
    }
    ...
    mMaxTableEntries += 0x00001000 / (sizeof (void *));
  }
  ...
  if (Table[Index].NormalImage != ((void *) 0)) {
    ...
    mDebugInfoTableHeader.UpdateStatus |= 0x02;
  }
  ...
  )
{
  ...
  for (Index = 0; Index < mMaxTableEntries; Index++) {
    if ((Table[Index].NormalImage != ((void *) 0)) && (Table[Index].NormalImage->ImageHandle == ImageHandle)) {




      CoreFreePool (Table[Index].NormalImage);
      Table[Index].NormalImage = ((void *) 0);

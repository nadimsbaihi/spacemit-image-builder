# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Page.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Page.c"
# 9 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Page.c"
...
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Page.c" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Imem.h" 1
# 17 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Imem.h"
typedef struct {
  UINTN Signature;
  LIST_ENTRY Link;
  BOOLEAN FromPages;
...
# 46 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Imem.h"
void *
...
# 61 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Imem.h"
void
CoreFreePoolPages (
  EFI_PHYSICAL_ADDRESS Memory,
  UINTN NumberOfPages
  );
# 78 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Imem.h"
void *
CoreAllocatePoolI (
  EFI_MEMORY_TYPE PoolType,
  UINTN Size,
...
# 96 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Imem.h"
EFI_STATUS
CoreFreePoolI (
  void *Buffer,
  EFI_MEMORY_TYPE *PoolType
...
# 139 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Imem.h"
EFI_STATUS
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Page.c" 2
...
# 12 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Page.c" 2
...
MEMORY_MAP mMapStack[6];
UINTN mFreeMapStack = 0;



LIST_ENTRY mFreeMemoryMapEntryList = {&(mFreeMemoryMapEntryList), &(mFreeMemoryMapEntryList)};
BOOLEAN mMemoryTypeInformationInitialized = ((BOOLEAN)(0==1));

EFI_MEMORY_TYPE_STATISTICS mMemoryTypeStatistics[EfiMaxMemoryType + 1] = {
  { 0, 0xFFFFFFFFFFFFULL, 0, 0, EfiMaxMemoryType, ((BOOLEAN)(1==1)), ((BOOLEAN)(0==1)) },
  { 0, 0xFFFFFFFFFFFFULL, 0, 0, EfiMaxMemoryType, ((BOOLEAN)(0==1)), ((BOOLEAN)(0==1)) },
  { 0, 0xFFFFFFFFFFFFULL, 0, 0, EfiMaxMemoryType, ((BOOLEAN)(0==1)), ((BOOLEAN)(0==1)) },
  { 0, 0xFFFFFFFFFFFFULL, 0, 0, EfiMaxMemoryType, ((BOOLEAN)(0==1)), ((BOOLEAN)(0==1)) },
  { 0, 0xFFFFFFFFFFFFULL, 0, 0, EfiMaxMemoryType, ((BOOLEAN)(0==1)), ((BOOLEAN)(0==1)) },
  { 0, 0xFFFFFFFFFFFFULL, 0, 0, EfiMaxMemoryType, ((BOOLEAN)(1==1)), ((BOOLEAN)(1==1)) },
  { 0, 0xFFFFFFFFFFFFULL, 0, 0, EfiMaxMemoryType, ((BOOLEAN)(1==1)), ((BOOLEAN)(1==1)) },
  { 0, 0xFFFFFFFFFFFFULL, 0, 0, EfiMaxMemoryType, ((BOOLEAN)(0==1)), ((BOOLEAN)(0==1)) },
  { 0, 0xFFFFFFFFFFFFULL, 0, 0, EfiMaxMemoryType, ((BOOLEAN)(0==1)), ((BOOLEAN)(0==1)) },
  { 0, 0xFFFFFFFFFFFFULL, 0, 0, EfiMaxMemoryType, ((BOOLEAN)(1==1)), ((BOOLEAN)(0==1)) },
...
EFI_PHYSICAL_ADDRESS mDefaultMaximumAddress = 0xFFFFFFFFFFFFULL;
EFI_PHYSICAL_ADDRESS mDefaultBaseAddress = 0xFFFFFFFFFFFFULL;
...
EFI_MEMORY_TYPE_INFORMATION gMemoryTypeInformation[EfiMaxMemoryType + 1] = {
 ...
 BOOLEAN gLoadFixedAddressCodeMemoryReady = ((BOOLEAN)(0==1));
...
# 156 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Page.c"
void
CoreAddRange (
  EFI_MEMORY_TYPE Type,
  EFI_PHYSICAL_ADDRESS Start,
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) ((Start & 0xFFF) == 0); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { (void) (End > Start); } } while (((BOOLEAN)(0==1)));

  ;

  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000020)) { DebugPrint (0x00000020, "AddRange: %lx-%lx to %d\n", Start, End, Type); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
# 183 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Page.c"
  if ((Type == EfiConventionalMemory) && (Start == 0) && (End >= 0x00001000 - 1)) {
    if ((_gPcd_FixedAtBuild_PcdNullPointerDetectionPropertyMask & 0x00000001) == 0) {
      SetMem ((void *)(UINTN)Start, 0x00001000, 0);
    }
  }
  ...
  mMemoryMapKey += 1;
# 203 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Page.c"
  CoreNotifySignalList (&gEfiEventMemoryMapChangeGuid);
# 213 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Page.c"
  Link = gMemoryMap.ForwardLink;
  while (Link != &gMemoryMap) {
    Entry = (((MEMORY_MAP *) (void *) ((CHAR8 *) (Link) - ((UINTN) __builtin_offsetof(MEMORY_MAP, Link))))->Signature != ((('m') | ('m' << 8)) | ((('a') | ('p' << 8)) << 16))) ? ((void *) 0) : ((MEMORY_MAP *) (void *) ((CHAR8 *) (Link) - ((UINTN) __builtin_offsetof(MEMORY_MAP, Link))));
  ...
  mMapStack[mMapDepth].Signature = ((('m') | ('m' << 8)) | ((('a') | ('p' << 8)) << 16));
  mMapStack[mMapDepth].FromPages = ((BOOLEAN)(0==1));
  ...
  mMapDepth += 1;
  do { if (((BOOLEAN)(0==1))) { (void) (mMapDepth < 6); } } while (((BOOLEAN)(0==1)));

  return;
}
# 267 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Page.c"
MEMORY_MAP *
  ...
  )
{
  ...
  if (IsListEmpty (&mFreeMemoryMapEntryList)) {
    ...
    FreeDescriptorEntries = CoreAllocatePoolPages (
                              EfiBootServicesData,
                              ((((0x1000)) >> 12) + ((((0x1000)) & 0xFFF) ? 1 : 0)),
                              (0x1000),
                              ((BOOLEAN)(0==1))
                              );
    if (FreeDescriptorEntries != ((void *) 0)) {



      for (Index = 0; Index < (0x1000) / sizeof (MEMORY_MAP); Index++) {
        FreeDescriptorEntries[Index].Signature = ((('m') | ('m' << 8)) | ((('a') | ('p' << 8)) << 16));
  ...
  Entry = (((MEMORY_MAP *) (void *) ((CHAR8 *) (mFreeMemoryMapEntryList.ForwardLink) - ((UINTN) __builtin_offsetof(MEMORY_MAP, Link))))->Signature != ((('m') | ('m' << 8)) | ((('a') | ('p' << 8)) << 16))) ? ((void *) 0) : ((MEMORY_MAP *) (void *) ((CHAR8 *) (mFreeMemoryMapEntryList.ForwardLink) - ((UINTN) __builtin_offsetof(MEMORY_MAP, Link))));
  RemoveEntryList (&Entry->Link);
  ...
  )
{
  ...
  while (mMapDepth != 0) {
    ...
    do { if (((BOOLEAN)(0==1))) { (void) (Entry); } } while (((BOOLEAN)(0==1)));
    ...
    if (mMapStack[mMapDepth].Link.ForwardLink != ((void *) 0)) {



      RemoveEntryList (&mMapStack[mMapDepth].Link);
      mMapStack[mMapDepth].Link.ForwardLink = ((void *) 0);

      CopyMem (Entry, &mMapStack[mMapDepth], sizeof (MEMORY_MAP));
      Entry->FromPages = ((BOOLEAN)(1==1));




      for (Link2 = gMemoryMap.ForwardLink; Link2 != &gMemoryMap; Link2 = Link2->ForwardLink) {
        Entry2 = (((MEMORY_MAP *) (void *) ((CHAR8 *) (Link2) - ((UINTN) __builtin_offsetof(MEMORY_MAP, Link))))->Signature != ((('m') | ('m' << 8)) | ((('a') | ('p' << 8)) << 16))) ? ((void *) 0) : ((MEMORY_MAP *) (void *) ((CHAR8 *) (Link2) - ((UINTN) __builtin_offsetof(MEMORY_MAP, Link))));
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000020)) { DebugPrint (0x00000020, "Promote the memory resource\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));

  CoreAcquireGcdMemoryLock ();

  Promoted = ((BOOLEAN)(0==1));
  ...
  while (Link != &mGcdMemorySpaceMap) {
    ...
    if ((Entry->GcdMemoryType == EfiGcdMemoryTypeReserved) &&
        (Entry->EndAddress < 0xFFFFFFFFFFFFULL) &&
        ((Entry->Capabilities & (0x0100000000000000ULL | 0x0200000000000000ULL | 0x0400000000000000ULL)) ==
         (0x0100000000000000ULL | 0x0200000000000000ULL)))
    {



      if ((Entry->Capabilities & 0x0000000000010000ULL) == 0x0000000000010000ULL) {
        Entry->GcdMemoryType = EfiGcdMemoryTypeMoreReliable;
      } else {
        Entry->GcdMemoryType = EfiGcdMemoryTypeSystemMemory;
      }

      Entry->Capabilities |= 0x0400000000000000ULL;
      ...
      CoreAddRange (
        ...
        Entry->BaseAddress,
        Entry->EndAddress,
        Entry->Capabilities & ~(0x0100000000000000ULL | 0x0200000000000000ULL | 0x0400000000000000ULL | 0x8000000000000000ULL)
        );
      CoreFreeMemoryMapStack ();

      Promoted = ((BOOLEAN)(1==1));
    }
  ...
  if (!Promoted) {
    ...
    if (Promoted) {
      if (!(((RETURN_STATUS)(CoreGetMemorySpaceDescriptor (StartAddress, &Descriptor))) >= 0x8000000000000000ULL)) {
        CoreAddRange (
          EfiConventionalMemory,
          StartAddress,
          EndAddress,
          Descriptor.Capabilities & ~(0x0100000000000000ULL | 0x0200000000000000ULL |
                                      0x0400000000000000ULL | 0x8000000000000000ULL)
          );
      }
    }
  }
  ...
  )
{
  ...
  if (!gLoadFixedAddressCodeMemoryReady) {
    RuntimeCodePageNumber = _gPcd_BinaryPatch_PcdLoadFixAddressRuntimeCodePageNumber;
    BootTimeCodePageNumber = _gPcd_BinaryPatch_PcdLoadFixAddressBootTimeCodePageNumber;
    RuntimeCodeBase = (EFI_PHYSICAL_ADDRESS)(gLoadModuleAtFixAddressConfigurationTable.DxeCodeTopAddress - ((RuntimeCodePageNumber) << 12));
    BootTimeCodeBase = (EFI_PHYSICAL_ADDRESS)(RuntimeCodeBase - ((BootTimeCodePageNumber) << 12));
    ...
    gLoadFixedAddressCodeMemoryReady = ((BOOLEAN)(1==1));
  }

  return;
}
# 546 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Page.c"
void
CoreSetMemoryTypeInformationRange (
  EFI_PHYSICAL_ADDRESS Start,
  UINT64 Length
  )
{
  ...
  if (mMemoryTypeInformationInitialized) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "%a: Ignored. Bins already set.\n", __func__); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    return;
  }
  ...
  for (Index = 0; gMemoryTypeInformation[Index].Type != EfiMaxMemoryType; Index++) {
    ...
    Size += ((gMemoryTypeInformation[Index].NumberOfPages) << 12);
  }
  ...
  for (Index = 0; gMemoryTypeInformation[Index].Type != EfiMaxMemoryType; Index++) {
    ...
    if (gMemoryTypeInformation[Index].NumberOfPages != 0) {
      ...
      Top -= ((gMemoryTypeInformation[Index].NumberOfPages) << 12);
  ...
  for (Type = (EFI_MEMORY_TYPE)0; Type < EfiMaxMemoryType; Type++) {
    ...
    if (mMemoryTypeStatistics[Type].MaximumAddress == 0xFFFFFFFFFFFFULL) {
      mMemoryTypeStatistics[Type].MaximumAddress = mDefaultMaximumAddress;
    }
  }

  mMemoryTypeInformationInitialized = ((BOOLEAN)(1==1));
}
# 652 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Page.c"
void
CoreAddMemoryDescriptor (
  EFI_MEMORY_TYPE Type,
  EFI_PHYSICAL_ADDRESS Start,
  ...
  )
{
  ...
  CoreAcquireMemoryLock ();
  End = Start + LShiftU64 (NumberOfPages, 12) - 1;
  ...
  for (Index = 0; gMemoryTypeInformation[Index].Type != EfiMaxMemoryType; Index++) {
    ...
    if (gMemoryTypeInformation[Index].NumberOfPages != 0) {
      ...
      if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
        ...
        for (FreeIndex = 0; FreeIndex < Index; FreeIndex++) {
          ...
          if (gMemoryTypeInformation[FreeIndex].NumberOfPages != 0) {
            ...
            mMemoryTypeStatistics[Type].MaximumAddress = 0xFFFFFFFFFFFFULL;
          }
        }
      ...
      mMemoryTypeStatistics[Type].MaximumAddress =
        mMemoryTypeStatistics[Type].BaseAddress +
        LShiftU64 (gMemoryTypeInformation[Index].NumberOfPages, 12) - 1;
...
# 831 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Page.c"
EFI_STATUS
CoreConvertPagesEx (
  UINT64 Start,
  UINT64 NumberOfPages,
  ...
  )
{
  ...
  Entry = ((void *) 0);
  NumberOfBytes = LShiftU64 (NumberOfPages, 12);
  End = Start + NumberOfBytes - 1;

  do { if (((BOOLEAN)(0==1))) { (void) (NumberOfPages); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { (void) ((Start & 0xFFF) == 0); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { (void) (End > Start); } } while (((BOOLEAN)(0==1)));
  ;
  do { if (((BOOLEAN)(0==1))) { (void) ((ChangingType == ((BOOLEAN)(0==1))) || (ChangingAttributes == ((BOOLEAN)(0==1)))); } } while (((BOOLEAN)(0==1)));

  if ((NumberOfPages == 0) || ((Start & 0xFFF) != 0) || (Start >= End)) {
  ...
  while (Start < End) {
    ...
    if (Link == &gMemoryMap) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000 | 0x00000020)) { DebugPrint (0x80000000 | 0x00000020, "ConvertPages: failed to find range %lx - %lx\n", Start, End); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    ...
    if (ChangingType && (NewType != EfiConventionalMemory)) {
      if (Entry->End < End) {
        do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000 | 0x00000020)) { DebugPrint (0x80000000 | 0x00000020, "ConvertPages: range %lx - %lx covers multiple entries\n", Start, End); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
        return ((RETURN_STATUS)(0x8000000000000000ULL | (14)));
      }
    }
    ...
    if (ChangingType) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000020)) { DebugPrint (0x00000020, "ConvertRange: %lx-%lx to type %d\n", Start, RangeEnd, NewType); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    }

    if (ChangingAttributes) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000020)) { DebugPrint (0x00000020, "ConvertRange: %lx-%lx to attr %lx\n", Start, RangeEnd, NewAttributes); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    }
    ...
    if (ChangingType) {
      ...
      if (!((NewType == EfiConventionalMemory) ? 1 : 0) ^ ((Entry->Type == EfiConventionalMemory) ? 1 : 0)) {
        do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000 | 0x00000020)) { DebugPrint (0x80000000 | 0x00000020, "ConvertPages: Incompatible memory types, "); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
        if (Entry->Type == EfiConventionalMemory) {
          do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000 | 0x00000020)) { DebugPrint (0x80000000 | 0x00000020, "the pages to free have been freed\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
        } else {
          do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000 | 0x00000020)) { DebugPrint (0x80000000 | 0x00000020, "the pages to allocate have been allocated\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
        }
    ...
    if (Entry->Start == Start) {
      ...
      Entry->End = Start - 1;
      do { if (((BOOLEAN)(0==1))) { (void) (Entry->Start < Entry->End); } } while (((BOOLEAN)(0==1)));
    ...
    if (!IsHeapGuardEnabled (0x00000010) ||
        !ChangingType ||
    ...
    if (ChangingType && (MemType == EfiConventionalMemory)) {
      ...
      if (Start == 0) {
        if (RangeEnd > 0x00001000) {
          do { if (DebugClearMemoryEnabled ()) { DebugClearMemory ((void *)(UINTN)0x00001000, (UINTN)(RangeEnd - 0x00001000 + 1)); } } while (((BOOLEAN)(0==1)));
        }
      } else {
        do { if (DebugClearMemoryEnabled ()) { DebugClearMemory ((void *)(UINTN)Start, (UINTN)(RangeEnd - Start + 1)); } } while (((BOOLEAN)(0==1)));
      }
    }
...
# 1079 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Page.c"
EFI_STATUS
CoreConvertPages (
  UINT64 Start,
  UINT64 NumberOfPages,
...
{
  return CoreConvertPagesEx (Start, NumberOfPages, ((BOOLEAN)(1==1)), NewType, ((BOOLEAN)(0==1)), 0);
}
# 1098 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Page.c"
void
CoreUpdateMemoryAttributes (
  EFI_PHYSICAL_ADDRESS Start,
  UINT64 NumberOfPages,
  ...
  )
{
  ...
  CoreConvertPagesEx (Start, NumberOfPages, ((BOOLEAN)(0==1)), (EFI_MEMORY_TYPE)0, ((BOOLEAN)(1==1)), NewAttributes);

  CoreReleaseMemoryLock ();
}
# 1130 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Page.c"
UINT64
CoreFindFreePagesI (
  UINT64 MaxAddress,
  UINT64 MinAddress,
  ...
  )
{
  ...
  if ((MaxAddress < 0xFFF) || (NumberOfPages == 0)) {
    return 0;
  }
  ...
  for (Link = gMemoryMap.ForwardLink; Link != &gMemoryMap; Link = Link->ForwardLink) {
    ...
    if ((Entry->Attribute & 0x0000000000040000ULL) != 0) {
      continue;
    }
...
# 1280 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Page.c"
UINT64
FindFreePages (
  UINT64 MaxAddress,
  UINT64 NoPages,
  ...
  if (MaxAddress >= mDefaultMaximumAddress) {
    ...
    if (Start != 0) {
      if (Start < mDefaultBaseAddress) {
        mDefaultBaseAddress = NeedGuard ? Start - 0x00001000 : Start;
      }
...
# 1379 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Page.c"
EFI_STATUS
...
# 1428 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Page.c"
  if (Alignment != 0x00001000) {
    NeedGuard = ((BOOLEAN)(0==1));
  }
  ...
  NumberOfPages += (((Alignment) >> 12) + (((Alignment) & 0xFFF) ? 1 : 0)) - 1;
  NumberOfPages &= ~((((Alignment) >> 12) + (((Alignment) & 0xFFF) ? 1 : 0)) - 1);
  ...
  MaxAddress = 0xFFFFFFFFFFFFULL;
# 1461 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Page.c"
  if (Type == AllocateAddress) {
    if ((NumberOfPages == 0) ||
        (NumberOfPages > RShiftU64 (MaxAddress, 12)))
    {
      return ((RETURN_STATUS)(0x8000000000000000ULL | (14)));
    }
...
# 1486 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Page.c"
...
# 1590 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Page.c"
EFI_STATUS
  ...
  )
{
  ...
  if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    CoreUpdateProfile (
      (EFI_PHYSICAL_ADDRESS)(UINTN)__builtin_return_address (0),
...
# 1643 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Page.c"
EFI_STATUS
...
# 1735 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Page.c"
EFI_STATUS
...
# 1782 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Page.c"
EFI_MEMORY_DESCRIPTOR *
  ...
  )
{
  ...
  for ( ; MemoryMap != MemoryMapDescriptor; MemoryMap = ((EFI_MEMORY_DESCRIPTOR *)((UINT8 *)(MemoryMap) + (DescriptorSize)))) {
    ...
    if (MemoryMap->PhysicalStart + (((UINTN)MemoryMap->NumberOfPages) << 12) == MemoryMapDescriptor->PhysicalStart) {
    ...
    if (MemoryMap->PhysicalStart - (((UINTN)MemoryMapDescriptor->NumberOfPages) << 12) == MemoryMapDescriptor->PhysicalStart) {
  ...
  return ((EFI_MEMORY_DESCRIPTOR *)((UINT8 *)(MemoryMapDescriptor) + (DescriptorSize)));
}
# 1879 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Page.c"
EFI_STATUS
  ...
  )
{
  ...
  for (Link = mGcdMemorySpaceMap.ForwardLink; Link != &mGcdMemorySpaceMap; Link = Link->ForwardLink) {
    GcdMapEntry = (((EFI_GCD_MAP_ENTRY *) (void *) ((CHAR8 *) (Link) - ((UINTN) __builtin_offsetof(EFI_GCD_MAP_ENTRY, Link))))->Signature != ((('g') | ('c' << 8)) | ((('d') | ('m' << 8)) << 16))) ? ((void *) 0) : ((EFI_GCD_MAP_ENTRY *) (void *) ((CHAR8 *) (Link) - ((UINTN) __builtin_offsetof(EFI_GCD_MAP_ENTRY, Link))));
    if ((GcdMapEntry->GcdMemoryType == EfiGcdMemoryTypePersistent) ||
        (GcdMapEntry->GcdMemoryType == EfiGcdMemoryTypeReserved) ||
        ((GcdMapEntry->GcdMemoryType == EfiGcdMemoryTypeMemoryMappedIo) &&
         ((GcdMapEntry->Attributes & 0x8000000000000000ULL) == 0x8000000000000000ULL)))
    {
      NumberOfEntries++;
    }
  }
  ...
  if (DescriptorSize != ((void *) 0)) {
    *DescriptorSize = Size;
  }

  if (DescriptorVersion != ((void *) 0)) {
    *DescriptorVersion = 1;
  }
  ...
  for (Link = gMemoryMap.ForwardLink; Link != &gMemoryMap; Link = Link->ForwardLink) {
    Entry = (((MEMORY_MAP *) (void *) ((CHAR8 *) (Link) - ((UINTN) __builtin_offsetof(MEMORY_MAP, Link))))->Signature != ((('m') | ('m' << 8)) | ((('a') | ('p' << 8)) << 16))) ? ((void *) 0) : ((MEMORY_MAP *) (void *) ((CHAR8 *) (Link) - ((UINTN) __builtin_offsetof(MEMORY_MAP, Link))));
    do { if (((BOOLEAN)(0==1))) { (void) (Entry->VirtualStart == 0); } } while (((BOOLEAN)(0==1)));
    ...
    MemoryMap->NumberOfPages = RShiftU64 (Entry->End - Entry->Start + 1, 12);
    ...
    if (MemoryMap->Type < EfiMaxMemoryType) {
      if (mMemoryTypeStatistics[MemoryMap->Type].Runtime) {
        MemoryMap->Attribute |= 0x8000000000000000ULL;
      }
    }
  ...
  for (Link = mGcdMemorySpaceMap.ForwardLink; ; Link = Link->ForwardLink) {
    ...
    if ((MergeGcdMapEntry.GcdMemoryType == EfiGcdMemoryTypeReserved) ||
        ((MergeGcdMapEntry.GcdMemoryType == EfiGcdMemoryTypeMemoryMappedIo) &&
         ((MergeGcdMapEntry.Attributes & 0x8000000000000000ULL) == 0x8000000000000000ULL)))
    {




      do { if (((BOOLEAN)(0==1))) { (void) ((MergeGcdMapEntry.BaseAddress & 0xFFF) == 0); } } while (((BOOLEAN)(0==1)));
      do { if (((BOOLEAN)(0==1))) { (void) (((MergeGcdMapEntry.EndAddress - MergeGcdMapEntry.BaseAddress + 1) & 0xFFF) == 0); } } while (((BOOLEAN)(0==1)));
      ...
      MemoryMap->NumberOfPages = RShiftU64 ((MergeGcdMapEntry.EndAddress - MergeGcdMapEntry.BaseAddress + 1), 12);
      MemoryMap->Attribute = (MergeGcdMapEntry.Attributes & ~0x4000000000000000ULL) |
                                 (MergeGcdMapEntry.Capabilities & ((0x0000000000000001ULL | 0x0000000000000002ULL | 0x0000000000000004ULL | 0x0000000000000008ULL | 0x0000000000000010ULL | 0x0000000000001000ULL) | ((0x0000000000002000ULL | 0x0000000000004000ULL | 0x0000000000020000ULL) | 0x0000000000040000ULL | 0x0000000000080000ULL)));

      if (MergeGcdMapEntry.GcdMemoryType == EfiGcdMemoryTypeReserved) {
        MemoryMap->Type = EfiReservedMemoryType;
      } else if (MergeGcdMapEntry.GcdMemoryType == EfiGcdMemoryTypeMemoryMappedIo) {
        if ((MergeGcdMapEntry.Attributes & 0x4000000000000000ULL) == 0x4000000000000000ULL) {
    ...
    if (MergeGcdMapEntry.GcdMemoryType == EfiGcdMemoryTypePersistent) {
      ...
      MemoryMap->VirtualStart = 0;
      MemoryMap->NumberOfPages = RShiftU64 ((MergeGcdMapEntry.EndAddress - MergeGcdMapEntry.BaseAddress + 1), 12);
      MemoryMap->Attribute = MergeGcdMapEntry.Attributes | 0x0000000000008000ULL |
                                 (MergeGcdMapEntry.Capabilities & ((0x0000000000000001ULL | 0x0000000000000002ULL | 0x0000000000000004ULL | 0x0000000000000008ULL | 0x0000000000000010ULL | 0x0000000000001000ULL) | ((0x0000000000002000ULL | 0x0000000000004000ULL | 0x0000000000020000ULL) | 0x0000000000040000ULL | 0x0000000000080000ULL)));
    ...
    if (MergeGcdMapEntry.GcdMemoryType == EfiGcdMemoryTypeUnaccepted) {
      ...
      MemoryMap->Attribute = MergeGcdMapEntry.Attributes |
                                 (MergeGcdMapEntry.Capabilities & (0x0000000000002000ULL | 0x0000000000001000ULL | 0x0000000000004000ULL | 0x0000000000020000ULL |
                                                                   0x0000000000000001ULL | 0x0000000000000010ULL | 0x0000000000000002ULL | 0x0000000000000004ULL | 0x0000000000000008ULL));
...
# 2150 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Page.c"
  MemoryMapEnd = MemoryMap;
  MemoryMap = MemoryMapStart;
  while (MemoryMap < MemoryMapEnd) {
    MemoryMap->Attribute &= ~(UINT64)(0x0000000000002000ULL | 0x0000000000004000ULL | 0x0000000000020000ULL);
...
Done:
  ...
  *MemoryMapSize = BufferSize;
  ...
  do { if (DebugCodeEnabled ()) { do { } while (((BOOLEAN)(0==1))); DumpGuardedMemoryBitmap (); } } while (((BOOLEAN)(0==1)))

     ;

  return Status;
}
# 2195 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Page.c"
void *
CoreAllocatePoolPages (
  EFI_MEMORY_TYPE PoolType,
  UINTN NumberOfPages,
  ...
  )
{
  ...
  if (Start == 0) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000 | 0x00000020)) { DebugPrint (0x80000000 | 0x00000020, "AllocatePoolPages: failed to allocate %d pages\n", (UINT32)NumberOfPages); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  } else {
    if (NeedGuard) {
...
# 2239 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Page.c"
void
CoreFreePoolPages (
  EFI_PHYSICAL_ADDRESS Memory,
  UINTN NumberOfPages
...
# 2259 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Page.c"
EFI_STATUS
CoreTerminateMemoryMap (
  UINTN MapKey
  )
    ...
    for (Link = gMemoryMap.ForwardLink; Link != &gMemoryMap; Link = Link->ForwardLink) {
      ...
      if (Entry->Type < EfiMaxMemoryType) {
        if (mMemoryTypeStatistics[Entry->Type].Runtime) {
          do { if (((BOOLEAN)(0==1))) { (void) (Entry->Type != EfiACPIReclaimMemory); } } while (((BOOLEAN)(0==1)));
          do { if (((BOOLEAN)(0==1))) { (void) (Entry->Type != EfiACPIMemoryNVS); } } while (((BOOLEAN)(0==1)));
          if ((Entry->Start & ((0x1000) - 1)) != 0) {
            do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000 | 0x00000020)) { DebugPrint (0x80000000 | 0x00000020, "ExitBootServices: A RUNTIME memory entry is not on a proper alignment.\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
            Status = ((RETURN_STATUS)(0x8000000000000000ULL | (2)));
            goto Done;
          }

          if (((Entry->End + 1) & ((0x1000) - 1)) != 0) {
            do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000 | 0x00000020)) { DebugPrint (0x80000000 | 0x00000020, "ExitBootServices: A RUNTIME memory entry is not on a proper alignment.\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
            Status = ((RETURN_STATUS)(0x8000000000000000ULL | (2)));
            goto Done;
          }
...
# 2307 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Page.c"
  } else {
    Status = ((RETURN_STATUS)(0x8000000000000000ULL | (2)));
  }

# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/MemoryProfileRecord.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/MemoryProfileRecord.c"
# 9 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/MemoryProfileRecord.c"
...
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/MemoryProfileRecord.c" 2
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/MemoryProfileRecord.c" 2
...
typedef struct {
 ...
 LIST_ENTRY mImageQueue = {&(mImageQueue), &(mImageQueue)};
 ...
 MEMORY_PROFILE_CONTEXT_DATA *mMemoryProfileContextPtr = ((void *) 0);

 EFI_LOCK mMemoryProfileLock = {16, 4, EfiLockReleased };
 BOOLEAN mMemoryProfileGettingStatus = ((BOOLEAN)(0==1));
 BOOLEAN mMemoryProfileRecordingEnable = ((BOOLEAN)(0==1));
 EFI_DEVICE_PATH_PROTOCOL *mMemoryProfileDriverPath;
 UINTN mMemoryProfileDriverPathSize;
# 79 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/MemoryProfileRecord.c"
EFI_STATUS
...
# 102 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/MemoryProfileRecord.c"
EFI_STATUS
...
# 126 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/MemoryProfileRecord.c"
EFI_STATUS
...
# 146 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/MemoryProfileRecord.c"
EFI_STATUS
...
# 163 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/MemoryProfileRecord.c"
EFI_STATUS
...
# 193 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/MemoryProfileRecord.c"
EFI_STATUS
...
# 259 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/MemoryProfileRecord.c"
UINT16
...
# 314 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/MemoryProfileRecord.c"
RETURN_STATUS
...
# 368 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/MemoryProfileRecord.c"
MEMORY_PROFILE_DRIVER_INFO_DATA *
BuildDriverInfo (
  ...
  )
{
  ...
  if (ImageBase != 0) {
    ...
    if (PdbString != ((void *) 0)) {
      ...
      PdbOccupiedSize = ((PdbSize) + (((sizeof (UINT64)) - ((PdbSize) & ((sizeof (UINT64)) - 1))) & ((sizeof (UINT64)) - 1)));
    }
  }
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (DriverInfoData != ((void *) 0)); } } while (((BOOLEAN)(0==1)));

  ZeroMem (DriverInfoData, sizeof (*DriverInfoData));

  DriverInfo = &DriverInfoData->DriverInfo;
  DriverInfoData->Signature = ((('M') | ('P' << 8)) | ((('D') | ('I' << 8)) << 16));
  DriverInfo->Header.Signature = ((('M') | ('P' << 8)) | ((('D') | ('I' << 8)) << 16));
  DriverInfo->Header.Length = (UINT16)(sizeof (MEMORY_PROFILE_DRIVER_INFO) + PdbOccupiedSize);
  DriverInfo->Header.Revision = 0x0003;
  if (FileName != ((void *) 0)) {
  ...
  if (PdbSize != 0) {
    ...
    DriverInfoData->PdbString = ((void *) 0);
  }
...
# 468 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/MemoryProfileRecord.c"
BOOLEAN
NeedRecordThisDriver (
  EFI_DEVICE_PATH_PROTOCOL *DriverFilePath
  )
{
  ...
  } while (DevicePathSubType (TmpDevicePath) != 0xFF);

  return ((BOOLEAN)(0==1));
}
# 529 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/MemoryProfileRecord.c"
BOOLEAN
RegisterDxeCore (
  void *HobStart,
  MEMORY_PROFILE_CONTEXT_DATA *ContextData
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (ContextData != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
  ...
  )
{
  ...
  if (!((_gPcd_FixedAtBuild_PcdMemoryProfilePropertyMask & 0x00000001) != 0)) {
    return;
  }
  ...
  mMemoryProfileGettingStatus = ((BOOLEAN)(0==1));
  if ((_gPcd_FixedAtBuild_PcdMemoryProfilePropertyMask & 0x00000080) != 0) {
    mMemoryProfileRecordingEnable = ((BOOLEAN)(0==1));
  } else {
    mMemoryProfileRecordingEnable = ((BOOLEAN)(1==1));
  }

  mMemoryProfileDriverPathSize = 1;
  mMemoryProfileDriverPath = AllocateCopyPool (mMemoryProfileDriverPathSize, (void *)_gPcd_FixedAtBuild_PcdMemoryProfileDriverPath);
  mMemoryProfileContextPtr = &mMemoryProfileContext;

  RegisterDxeCore (HobStart, &mMemoryProfileContext);

  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "MemoryProfileInit MemoryProfileContext - 0x%x\n", &mMemoryProfileContext); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
}
...
# 657 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/MemoryProfileRecord.c"
EFI_GUID *
...
# 693 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/MemoryProfileRecord.c"
EFI_STATUS
RegisterMemoryProfileImage (
  LOADED_IMAGE_PRIVATE_DATA *DriverEntry,
  EFI_FV_FILETYPE FileType
...
# 741 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/MemoryProfileRecord.c"
MEMORY_PROFILE_DRIVER_INFO_DATA *
  ...
  )
{
  ...
  {
    DriverInfoData = (((MEMORY_PROFILE_DRIVER_INFO_DATA *) (void *) ((CHAR8 *) (DriverLink) - ((UINTN) __builtin_offsetof(MEMORY_PROFILE_DRIVER_INFO_DATA, Link))))->Signature != ((('M') | ('P' << 8)) | ((('D') | ('I' << 8)) << 16))) ? ((void *) 0) : ((MEMORY_PROFILE_DRIVER_INFO_DATA *) (void *) ((CHAR8 *) (DriverLink) - ((UINTN) __builtin_offsetof(MEMORY_PROFILE_DRIVER_INFO_DATA, Link))))
...
# 787 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/MemoryProfileRecord.c"
MEMORY_PROFILE_DRIVER_INFO_DATA *
...
# 832 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/MemoryProfileRecord.c"
EFI_STATUS
UnregisterMemoryProfileImage (
  LOADED_IMAGE_PRIVATE_DATA *DriverEntry
  )
{
  ...
  if (DriverInfoData->DriverInfo.PeakUsage == 0) {
    ...
    CoreInternalFreePool (DriverInfoData, ((void *) 0));
  }

  return (RETURN_STATUS)(0);
}
# 912 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/MemoryProfileRecord.c"
BOOLEAN
  ...
  )
{
  ...
  if ((_gPcd_FixedAtBuild_PcdMemoryProfileMemoryType & TestBit) != 0) {
    return ((BOOLEAN)(1==1));
  } else {
    return ((BOOLEAN)(0==1));
  }
}
# 945 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/MemoryProfileRecord.c"
UINTN
...
# 975 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/MemoryProfileRecord.c"
EFI_STATUS
  ...
  )
{
  ...
  if (ActionString != ((void *) 0)) {
    ActionStringSize = AsciiStrSize (ActionString);
    ActionStringOccupiedSize = ((ActionStringSize) + (((sizeof (UINT64)) - ((ActionStringSize) & ((sizeof (UINT64)) - 1))) & ((sizeof (UINT64)) - 1)));
  }




  AllocInfoData = ((void *) 0);
  Status = CoreInternalAllocatePool (
                    EfiBootServicesData,
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (AllocInfoData != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
  ...
  AllocInfoData->Signature = ((('M') | ('P' << 8)) | ((('A') | ('I' << 8)) << 16));
  AllocInfo->Header.Signature = ((('M') | ('P' << 8)) | ((('A') | ('I' << 8)) << 16));
  AllocInfo->Header.Length = (UINT16)(sizeof (MEMORY_PROFILE_ALLOC_INFO) + ActionStringOccupiedSize);
  AllocInfo->Header.Revision = 0x0002;
  ...
  if (ActionString != ((void *) 0)) {
    ...
    AllocInfoData->ActionString = ((void *) 0);
  }
...
# 1105 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/MemoryProfileRecord.c"
MEMORY_PROFILE_ALLOC_INFO_DATA *
  ...
  )
{
  ...
  {
    AllocInfoData = (((MEMORY_PROFILE_ALLOC_INFO_DATA *) (void *) ((CHAR8 *) (AllocLink) - ((UINTN) __builtin_offsetof(MEMORY_PROFILE_ALLOC_INFO_DATA, Link))))->Signature != ((('M') | ('P' << 8)) | ((('A') | ('I' << 8)) << 16))) ? ((void *) 0) : ((MEMORY_PROFILE_ALLOC_INFO_DATA *) (void *) ((CHAR8 *) (AllocLink) - ((UINTN) __builtin_offsetof(MEMORY_PROFILE_ALLOC_INFO_DATA, Link))))
                       ...
                       ;
    AllocInfo = &AllocInfoData->AllocInfo;
    if ((AllocInfo->Action & 0xF) != BasicAction) {
      continue;
    }
...
# 1172 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/MemoryProfileRecord.c"
EFI_STATUS
  ...
  )
{
  ...
  DriverInfoData = GetMemoryProfileDriverInfoFromAddress (ContextData, CallerAddress);
# 1211 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/MemoryProfileRecord.c"
  Found = ((BOOLEAN)(0==1));
  AllocInfoData = ((void *) 0);
  do {
    if (DriverInfoData != ((void *) 0)) {
    ...
    if (AllocInfoData == ((void *) 0)) {
      ...
      for (DriverLink = DriverInfoList->ForwardLink;
           ...
           DriverLink = DriverLink->ForwardLink)
      {
        ThisDriverInfoData = (((MEMORY_PROFILE_DRIVER_INFO_DATA *) (void *) ((CHAR8 *) (DriverLink) - ((UINTN) __builtin_offsetof(MEMORY_PROFILE_DRIVER_INFO_DATA, Link))))->Signature != ((('M') | ('P' << 8)) | ((('D') | ('I' << 8)) << 16))) ? ((void *) 0) : ((MEMORY_PROFILE_DRIVER_INFO_DATA *) (void *) ((CHAR8 *) (DriverLink) - ((UINTN) __builtin_offsetof(MEMORY_PROFILE_DRIVER_INFO_DATA, Link))))
      ...
      if (AllocInfoData == ((void *) 0)) {
# 1273 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/MemoryProfileRecord.c"
        return (Found ? (RETURN_STATUS)(0) : ((RETURN_STATUS)(0x8000000000000000ULL | (14))));
      }
    }
    ...
    if (AllocInfo->Action == (AllocInfo->Action & 0xF)) {
    ...
    CoreInternalFreePool (AllocInfoData, ((void *) 0));
  } while (((BOOLEAN)(1==1)));
}
# 1355 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/MemoryProfileRecord.c"
EFI_STATUS
...
# 1437 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/MemoryProfileRecord.c"
UINTN
...
# 1579 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/MemoryProfileRecord.c"
EFI_STATUS
  ...
  )
{
  ...
  mMemoryProfileGettingStatus = ((BOOLEAN)(1==1));
...
# 1629 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/MemoryProfileRecord.c"
EFI_STATUS
...
# 1669 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/MemoryProfileRecord.c"
EFI_STATUS
...
# 1704 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/MemoryProfileRecord.c"
EFI_STATUS
...
# 1736 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/MemoryProfileRecord.c"
EFI_STATUS
...
# 1777 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/MemoryProfileRecord.c"
EFI_STATUS

# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Dispatcher/Dispatcher.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Dispatcher/Dispatcher.c"
# 34 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Dispatcher/Dispatcher.c"
...
# 35 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Dispatcher/Dispatcher.c" 2





LIST_ENTRY mDiscoveredList = {&(mDiscoveredList), &(mDiscoveredList)};





LIST_ENTRY mScheduledQueue = {&(mScheduledQueue), &(mScheduledQueue)};




LIST_ENTRY mFvHandleList = {&(mFvHandleList), &(mFvHandleList)};




EFI_LOCK mDispatcherLock = {31, 4, EfiLockReleased };




BOOLEAN gDispatcherRunning = ((BOOLEAN)(0==1));
...
# 102 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Dispatcher/Dispatcher.c"
void
CoreInsertOnScheduledQueueWhileProcessingBeforeAndAfter (
  EFI_CORE_DRIVER_ENTRY *InsertedDriverEntry
  );
# 124 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Dispatcher/Dispatcher.c"
void
...
# 144 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Dispatcher/Dispatcher.c"
EFI_DEVICE_PATH_PROTOCOL *
CoreFvToDevicePath (
  EFI_FIRMWARE_VOLUME2_PROTOCOL *Fv,
  EFI_HANDLE FvHandle,
...
# 172 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Dispatcher/Dispatcher.c"
EFI_STATUS
CoreAddToDriverList (
  EFI_FIRMWARE_VOLUME2_PROTOCOL *Fv,
  EFI_HANDLE FvHandle,
...
# 191 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Dispatcher/Dispatcher.c"
EFI_STATUS
...
# 234 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Dispatcher/Dispatcher.c"
EFI_STATUS
  ...
  )
{
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    if (Status == ((RETURN_STATUS)(0x8000000000000000ULL | (24)))) {



      DriverEntry->DepexProtocolError = ((BOOLEAN)(1==1));
    } else {



      DriverEntry->Depex = ((void *) 0);
      DriverEntry->Dependent = ((BOOLEAN)(1==1));
      DriverEntry->DepexProtocolError = ((BOOLEAN)(0==1));
    }
  } else {
...
# 299 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Dispatcher/Dispatcher.c"
EFI_STATUS
  ...
  )
{
  ...
  for (Link = mDiscoveredList.ForwardLink; Link != &mDiscoveredList; Link = Link->ForwardLink) {
    DriverEntry = (((EFI_CORE_DRIVER_ENTRY *) (void *) ((CHAR8 *) (Link) - ((UINTN) __builtin_offsetof(EFI_CORE_DRIVER_ENTRY, Link))))->Signature != ((('d') | ('r' << 8)) | ((('v') | ('r' << 8)) << 16))) ? ((void *) 0) : ((EFI_CORE_DRIVER_ENTRY *) (void *) ((CHAR8 *) (Link) - ((UINTN) __builtin_offsetof(EFI_CORE_DRIVER_ENTRY, Link))));
        ...
        CompareGuid (DriverName, &DriverEntry->FileName))
    {
      ...
      CoreAcquireDispatcherLock ();
      DriverEntry->Unrequested = ((BOOLEAN)(0==1));
      DriverEntry->Dependent = ((BOOLEAN)(1==1));
      CoreReleaseDispatcherLock ();

      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000080)) { DebugPrint (0x00000080, "Schedule FFS(%g) - EFI_SUCCESS\n", DriverName); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));

      return (RETURN_STATUS)(0);
    }
  }

  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000080)) { DebugPrint (0x00000080, "Schedule FFS(%g) - EFI_NOT_FOUND\n", DriverName); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));

  return ((RETURN_STATUS)(0x8000000000000000ULL | (14)));
}
# 349 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Dispatcher/Dispatcher.c"
EFI_STATUS
  ...
  )
{
  ...
  for (Link = mDiscoveredList.ForwardLink; Link != &mDiscoveredList; Link = Link->ForwardLink) {
        ...
        CompareGuid (DriverName, &DriverEntry->FileName))
    {
      ...
      CoreAcquireDispatcherLock ();
      DriverEntry->Untrusted = ((BOOLEAN)(0==1));
      DriverEntry->Scheduled = ((BOOLEAN)(1==1));
...
# 398 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Dispatcher/Dispatcher.c"
EFI_STATUS
  ...
  )
{
  ...
  do { if (LogPerformanceMeasurementEnabled (0x0040)) { LogPerformanceMeasurement (&gEfiCallerIdGuid, ((void *) 0), __func__ , 0, 0x30); } } while (((BOOLEAN)(0==1)));
  ...
  gDispatcherRunning = ((BOOLEAN)(1==1));
  ...
  ReturnStatus = ((RETURN_STATUS)(0x8000000000000000ULL | (14)));
  do {



    while (!IsListEmpty (&mScheduledQueue)) {
      DriverEntry = (((EFI_CORE_DRIVER_ENTRY *) (void *) ((CHAR8 *) (mScheduledQueue.ForwardLink) - ((UINTN) __builtin_offsetof(EFI_CORE_DRIVER_ENTRY, ScheduledLink))))->Signature != ((('d') | ('r' << 8)) | ((('v') | ('r' << 8)) << 16))) ? ((void *) 0) : ((EFI_CORE_DRIVER_ENTRY *) (void *) ((CHAR8 *) (mScheduledQueue.ForwardLink) - ((UINTN) __builtin_offsetof(EFI_CORE_DRIVER_ENTRY, ScheduledLink))))
      ...
      if ((DriverEntry->ImageHandle == ((void *) 0)) && !DriverEntry->IsFvImage) {
        do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Loading driver %g\n", &DriverEntry->FileName); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
        ...
        if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
          ...
          if (Status == ((RETURN_STATUS)(0x8000000000000000ULL | (26)))) {



            DriverEntry->Untrusted = ((BOOLEAN)(1==1));
          } else {
            ...
            DriverEntry->Initialized = ((BOOLEAN)(1==1));
          }

          DriverEntry->Scheduled = ((BOOLEAN)(0==1));
      ...
      if (DriverEntry->IsFvImage) {
        ...
        (ReportProgressCodeEnabled() && ((0x00000001) & 0x000000FF) == 0x00000001) ? ReportStatusCodeWithExtendedData(0x00000001,((0x03000000 | 0x00040000) | 0x00000002),&DriverEntry->ImageHandle,sizeof (DriverEntry->ImageHandle)) : (ReportErrorCodeEnabled() && ((0x00000001) & 0x000000FF) == 0x00000002) ? ReportStatusCodeWithExtendedData(0x00000001,((0x03000000 | 0x00040000) | 0x00000002),&DriverEntry->ImageHandle,sizeof (DriverEntry->ImageHandle)) : (ReportDebugCodeEnabled() && ((0x00000001) & 0x000000FF) == 0x00000003) ? ReportStatusCodeWithExtendedData(0x00000001,((0x03000000 | 0x00040000) | 0x00000002),&DriverEntry->ImageHandle,sizeof (DriverEntry->ImageHandle)) : ((RETURN_STATUS)(0x8000000000000000ULL | (3)))




           ;
        do { if (((BOOLEAN)(0==1))) { (void) (DriverEntry->ImageHandle != ((void *) 0)); } } while (((BOOLEAN)(0==1)));

        Status = CoreStartImage (DriverEntry->ImageHandle, ((void *) 0), ((void *) 0));

        (ReportProgressCodeEnabled() && ((0x00000001) & 0x000000FF) == 0x00000001) ? ReportStatusCodeWithExtendedData(0x00000001,((0x03000000 | 0x00040000) | 0x00000003),&DriverEntry->ImageHandle,sizeof (DriverEntry->ImageHandle)) : (ReportErrorCodeEnabled() && ((0x00000001) & 0x000000FF) == 0x00000002) ? ReportStatusCodeWithExtendedData(0x00000001,((0x03000000 | 0x00040000) | 0x00000003),&DriverEntry->ImageHandle,sizeof (DriverEntry->ImageHandle)) : (ReportDebugCodeEnabled() && ((0x00000001) & 0x000000FF) == 0x00000003) ? ReportStatusCodeWithExtendedData(0x00000001,((0x03000000 | 0x00040000) | 0x00000003),&DriverEntry->ImageHandle,sizeof (DriverEntry->ImageHandle)) : ((RETURN_STATUS)(0x8000000000000000ULL | (3)))
    ...
    for (Link = mDiscoveredList.ForwardLink; Link != &mDiscoveredList; Link = Link->ForwardLink) {
      ...
      if (DriverEntry->Dependent) {
        if (CoreIsSchedulable (DriverEntry)) {
          ...
          ReadyToRun = ((BOOLEAN)(1==1));
        }
      } else {
        if (DriverEntry->Unrequested) {
          do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000080)) { DebugPrint (0x00000080, "Evaluate DXE DEPEX for FFS(%g)\n", &DriverEntry->FileName); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
          do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000080)) { DebugPrint (0x00000080, "  SOR                                             = Not Requested\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
          do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000080)) { DebugPrint (0x00000080, "  RESULT = FALSE\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
        }
      }
    }
  } while (ReadyToRun);
  ...
  gDispatcherRunning = ((BOOLEAN)(0==1));

  do { if (LogPerformanceMeasurementEnabled (0x0040)) { LogPerformanceMeasurement (&gEfiCallerIdGuid, ((void *) 0), __func__ , 0, 0x31); } } while (((BOOLEAN)(0==1)));

  return ReturnStatus;
}
# 592 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Dispatcher/Dispatcher.c"
void
CoreInsertOnScheduledQueueWhileProcessingBeforeAndAfter (
  EFI_CORE_DRIVER_ENTRY *InsertedDriverEntry
  )
{
  ...
  for (Link = mDiscoveredList.ForwardLink; Link != &mDiscoveredList; Link = Link->ForwardLink) {
    ...
    if (DriverEntry->Before && DriverEntry->Dependent && (DriverEntry != InsertedDriverEntry)) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000080)) { DebugPrint (0x00000080, "Evaluate DXE DEPEX for FFS(%g)\n", &DriverEntry->FileName); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000080)) { DebugPrint (0x00000080, "  BEFORE FFS(%g) = ", &DriverEntry->BeforeAfterGuid); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
      if (CompareGuid (&InsertedDriverEntry->FileName, &DriverEntry->BeforeAfterGuid)) {



        do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000080)) { DebugPrint (0x00000080, "TRUE\n  END\n  RESULT = TRUE\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
        CoreInsertOnScheduledQueueWhileProcessingBeforeAndAfter (DriverEntry);
      } else {
        do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000080)) { DebugPrint (0x00000080, "FALSE\n  END\n  RESULT = FALSE\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
      }
    }
  }
  ...
  InsertedDriverEntry->Dependent = ((BOOLEAN)(0==1));
  InsertedDriverEntry->Scheduled = ((BOOLEAN)(1==1));
  ...
  for (Link = mDiscoveredList.ForwardLink; Link != &mDiscoveredList; Link = Link->ForwardLink) {
    ...
    if (DriverEntry->After && DriverEntry->Dependent && (DriverEntry != InsertedDriverEntry)) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000080)) { DebugPrint (0x00000080, "Evaluate DXE DEPEX for FFS(%g)\n", &DriverEntry->FileName); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000080)) { DebugPrint (0x00000080, "  AFTER FFS(%g) = ", &DriverEntry->BeforeAfterGuid); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
      if (CompareGuid (&InsertedDriverEntry->FileName, &DriverEntry->BeforeAfterGuid)) {
...
# 661 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Dispatcher/Dispatcher.c"
BOOLEAN
FvHasBeenProcessed (
  EFI_HANDLE FvHandle
  )
{
  ...
  for (Link = mFvHandleList.ForwardLink; Link != &mFvHandleList; Link = Link->ForwardLink) {
    KnownHandle = (((KNOWN_HANDLE *) (void *) ((CHAR8 *) (Link) - ((UINTN) __builtin_offsetof(KNOWN_HANDLE, Link))))->Signature != ((('k') | ('n' << 8)) | ((('o') | ('w' << 8)) << 16))) ? ((void *) 0) : ((KNOWN_HANDLE *) (void *) ((CHAR8 *) (Link) - ((UINTN) __builtin_offsetof(KNOWN_HANDLE, Link))));
...
# 691 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Dispatcher/Dispatcher.c"
KNOWN_HANDLE *
FvIsBeingProcessed (
  EFI_HANDLE FvHandle
  )
{
  ...
  FvNameGuidIsFound = ((BOOLEAN)(0==1));
  Status = CoreHandleProtocol (FvHandle, &gEfiFirmwareVolumeBlockProtocolGuid, (void **)&Fvb);
  if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {



    do { if (((BOOLEAN)(0==1))) { (void) (Fvb != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
    Status = GetFwVolHeader (Fvb, &FwVolHeader);
    if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
      do { if (((BOOLEAN)(0==1))) { (void) (FwVolHeader != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
  ...
  if (FvNameGuidIsFound) {
    ...
    for (Link = mFvHandleList.ForwardLink; Link != &mFvHandleList; Link = Link->ForwardLink) {
      ...
      if (CompareGuid (&FvNameGuid, &KnownHandle->FvNameGuid)) {
        do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "FvImage on FvHandle %p and %p has the same FvNameGuid %g.\n", FvHandle, KnownHandle->Handle, &FvNameGuid); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
        return ((void *) 0);
      }
    }
  }
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (KnownHandle != ((void *) 0)); } } while (((BOOLEAN)(0==1)));

  KnownHandle->Signature = ((('k') | ('n' << 8)) | ((('o') | ('w' << 8)) << 16));
...
# 801 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Dispatcher/Dispatcher.c"
EFI_DEVICE_PATH_PROTOCOL *
CoreFvToDevicePath (
  EFI_FIRMWARE_VOLUME2_PROTOCOL *Fv,
  EFI_HANDLE FvHandle,
...
# 855 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Dispatcher/Dispatcher.c"
EFI_STATUS
CoreAddToDriverList (
  EFI_FIRMWARE_VOLUME2_PROTOCOL *Fv,
  EFI_HANDLE FvHandle,
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (DriverEntry != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
  if (Type == 0x0B) {
    DriverEntry->IsFvImage = ((BOOLEAN)(1==1));
  }

  DriverEntry->Signature = ((('d') | ('r' << 8)) | ((('v') | ('r' << 8)) << 16));
...
# 904 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Dispatcher/Dispatcher.c"
BOOLEAN
FvFoundInHobFv2 (
  const EFI_GUID *FvNameGuid,
  const EFI_GUID *DriverName
  )
{
  ...
  while ((HobFv2.Raw = GetNextHob (0x0009, HobFv2.Raw)) != ((void *) 0)) {
    ...
    HobFv2.Raw = (void *)(*(UINT8 **)&(HobFv2) + ((*(EFI_HOB_GENERIC_HEADER **)&(HobFv2))->HobLength));
  }

  return ((BOOLEAN)(0==1));
}
# 944 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Dispatcher/Dispatcher.c"
BOOLEAN
GetFvUsedSize (
  EFI_FIRMWARE_VOLUME_HEADER *FvHeader,
  UINT32 *FvUsedSize,
  ...
  )
{
  ...
  if (ExtHeaderOffset != 0) {
    ...
    while ((UINTN)ExtEntryList < ((UINTN)ExtHeader + ReadUnaligned32 (&ExtHeader->ExtHeaderSize))) {
      if (ReadUnaligned16 (&ExtEntryList->ExtEntryType) == 0x03) {
        ...
        *FvUsedSize = ReadUnaligned32 (&ExtEntryUsedSize->UsedSize);
        if ((ReadUnaligned32 (&FvHeader->Attributes) & 0x00000800) != 0) {
          *EraseByte = 0xFF;
        } else {
          *EraseByte = 0;
        }

        do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "FV at 0x%x has 0x%x used size, and erase byte is 0x%02x\n", FvHeader, *FvUsedSize, *EraseByte); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
...
# 1005 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Dispatcher/Dispatcher.c"
EFI_STATUS
CoreProcessFvImageFile (
  EFI_FIRMWARE_VOLUME2_PROTOCOL *Fv,
  EFI_HANDLE FvHandle,
  ...
  )
{
  ...
  do {
    ...
    if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
      ...
      if ((ReadUnaligned32 (&FvHeader->Attributes) & 0x80000000) != 0x80000000) {



        FvAlignment = 1 << ((ReadUnaligned32 (&FvHeader->Attributes) & 0x001F0000) >> 16);
        ...
        do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "%a() FV at 0x%x, FvAlignment required is 0x%x\n", __func__, FvHeader, FvAlignment); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
        ...
        if ((UINTN)FvHeader % FvAlignment != 0) {
          ...
          AlignedBuffer = AllocateAlignedPages ((((BufferSize) >> 12) + (((BufferSize) & 0xFFF) ? 1 : 0)), (UINTN)FvAlignment);
          if (AlignedBuffer == ((void *) 0)) {
            FreePool (Buffer);
    ...
    if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
      ...
      if (AlignedBuffer != ((void *) 0)) {
        FreeAlignedPages (AlignedBuffer, (((BufferSize) >> 12) + (((BufferSize) & 0xFFF) ? 1 : 0)));
      }
...
# 1197 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Dispatcher/Dispatcher.c"
void
  ...
  )
{
  ...
  while (((BOOLEAN)(1==1))) {
    ...
    if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) || (Fv == ((void *) 0))) {
    ...
    for (Index = 0; Index < sizeof (mDxeFileTypes) / sizeof (EFI_FV_FILETYPE); Index++) {
      ...
      do {
        ...
        if (!(((RETURN_STATUS)(GetNextFileStatus)) >= 0x8000000000000000ULL)) {
          if (Type == 0x05) {



            if (gDxeCoreLoadedImage->FilePath == ((void *) 0)) {
      ...
      } while (!(((RETURN_STATUS)(GetNextFileStatus)) >= 0x8000000000000000ULL));
    }
    ...
    for (Index = 0; Index < AprioriEntryCount; Index++) {
      for (Link = mDiscoveredList.ForwardLink; Link != &mDiscoveredList; Link = Link->ForwardLink) {
        ...
        {
          CoreAcquireDispatcherLock ();
          DriverEntry->Dependent = ((BOOLEAN)(0==1));
          DriverEntry->Scheduled = ((BOOLEAN)(1==1));
          InsertTailList (&mScheduledQueue, &DriverEntry->ScheduledLink);
          CoreReleaseDispatcherLock ();
          do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000080)) { DebugPrint (0x00000080, "Evaluate DXE DEPEX for FFS(%g)\n", &DriverEntry->FileName); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
          do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000080)) { DebugPrint (0x00000080, "  RESULT = TRUE (Apriori)\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
          break;
        }
      }
    }
...
# 1470 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Dispatcher/Dispatcher.c"
void
CoreDisplayDiscoveredNotDispatched (
  void
  )
{
  ...
  for (Link = mDiscoveredList.ForwardLink; Link != &mDiscoveredList; Link = Link->ForwardLink) {
    DriverEntry = (((EFI_CORE_DRIVER_ENTRY *) (void *) ((CHAR8 *) (Link) - ((UINTN) __builtin_offsetof(EFI_CORE_DRIVER_ENTRY, Link))))->Signature != ((('d') | ('r' << 8)) | ((('v') | ('r' << 8)) << 16))) ? ((void *) 0) : ((EFI_CORE_DRIVER_ENTRY *) (void *) ((CHAR8 *) (Link) - ((UINTN) __builtin_offsetof(EFI_CORE_DRIVER_ENTRY, Link))));
    if (DriverEntry->Dependent) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000004)) { DebugPrint (0x00000004, "Driver %g was discovered but not loaded!!\n", &DriverEntry->FileName); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    }
  }
}

# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Dispatcher/Dependency.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Dispatcher/Dependency.c"
# 13 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Dispatcher/Dependency.c"
...
# 14 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Dispatcher/Dependency.c" 2




BOOLEAN *mDepexEvaluationStack = ((void *) 0);
BOOLEAN *mDepexEvaluationStackEnd = ((void *) 0);
BOOLEAN *mDepexEvaluationStackPointer = ((void *) 0);
# 33 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Dispatcher/Dependency.c"
EFI_STATUS
GrowDepexStack (
  void
  )
{
  ...
  Size = 0x1000;
  if (mDepexEvaluationStack != ((void *) 0)) {
...
# 86 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Dispatcher/Dependency.c"
EFI_STATUS
PushBool (
  BOOLEAN Value
  )
...
# 124 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Dispatcher/Dependency.c"
EFI_STATUS
PopBool (
  BOOLEAN *Value
  )
...
# 156 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Dispatcher/Dependency.c"
EFI_STATUS
CorePreProcessDepex (
  EFI_CORE_DRIVER_ENTRY *DriverEntry
  )
{
  ...
  if (*Iterator == 0x09) {
    DriverEntry->Unrequested = ((BOOLEAN)(1==1));
  } else {
    DriverEntry->Dependent = ((BOOLEAN)(1==1));
  }

  if (*Iterator == 0x00) {
    DriverEntry->Before = ((BOOLEAN)(1==1));
  } else if (*Iterator == 0x01) {
    DriverEntry->After = ((BOOLEAN)(1==1));
  }
...
# 196 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Dispatcher/Dependency.c"
BOOLEAN
CoreIsSchedulable (
  EFI_CORE_DRIVER_ENTRY *DriverEntry
  )
{
  ...
  Operator = ((BOOLEAN)(0==1));
  Operator2 = ((BOOLEAN)(0==1));
  ...
  if (DriverEntry->Depex == ((void *) 0)) {



    Status = CoreAllEfiServicesAvailable ();
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000080)) { DebugPrint (0x00000080, "  All UEFI Services Available                     = "); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
  ...
  while (((BOOLEAN)(1==1))) {
    ...
    if (((UINTN)Iterator - (UINTN)DriverEntry->Depex) >= DriverEntry->DepexSize) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000080)) { DebugPrint (0x00000080, "  RESULT = FALSE (Attempt to fetch past end of depex)\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
      return ((BOOLEAN)(0==1));
    }
    ...
    switch (*Iterator) {
      ...
      case 0x01:
        ...
        do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000080)) { DebugPrint (0x00000080, "  RESULT = FALSE (Unexpected BEFORE or AFTER opcode)\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
      ...
      case 0x09:
        ...
        if (Iterator != DriverEntry->Depex) {
          do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000080)) { DebugPrint (0x00000080, "  SOR\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
          do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000080)) { DebugPrint (0x00000080, "  RESULT = FALSE (Unexpected SOR opcode)\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
          return ((BOOLEAN)(0==1));
        }

        do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000080)) { DebugPrint (0x00000080, "  SOR                                             = Requested\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
      ...
      case 0x02:
        ...
        Status = CoreLocateProtocol (&DriverGuid, ((void *) 0), &Interface);

        if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
          do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000080)) { DebugPrint (0x00000080, "  PUSH GUID(%g) = FALSE\n", &DriverGuid); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
          Status = PushBool (((BOOLEAN)(0==1)));
        } else {
          do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000080)) { DebugPrint (0x00000080, "  PUSH GUID(%g) = TRUE\n", &DriverGuid); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
          *Iterator = 0xff;
          Status = PushBool (((BOOLEAN)(1==1)));
        }

        if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
          do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000080)) { DebugPrint (0x00000080, "  RESULT = FALSE (Unexpected error)\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
          return ((BOOLEAN)(0==1));
        }
      ...
      case 0x03:
        do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000080)) { DebugPrint (0x00000080, "  AND\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
      ...
      case 0x04:
        do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000080)) { DebugPrint (0x00000080, "  OR\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
        Status = PopBool (&Operator);
        if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
          do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000080)) { DebugPrint (0x00000080, "  RESULT = FALSE (Unexpected error)\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
          return ((BOOLEAN)(0==1));
      ...
      case 0x05:
        do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000080)) { DebugPrint (0x00000080, "  NOT\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
        Status = PopBool (&Operator);
        if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
          do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000080)) { DebugPrint (0x00000080, "  RESULT = FALSE (Unexpected error)\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
          return ((BOOLEAN)(0==1));
      ...
      case 0x08:
        do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000080)) { DebugPrint (0x00000080, "  END\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
        Status = PopBool (&Operator);
        if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
          do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000080)) { DebugPrint (0x00000080, "  RESULT = FALSE (Unexpected error)\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
          return ((BOOLEAN)(0==1));
        ...
        do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000080)) { DebugPrint (0x00000080, "  RESULT = %a\n", Operator ? "TRUE" : "FALSE"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
        return Operator;
      ...
      default:
        do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000080)) { DebugPrint (0x00000080, "  RESULT = FALSE (Unknown opcode)\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
        goto Done;
    }
# 428 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Dispatcher/Dependency.c"
    Iterator++;
  }

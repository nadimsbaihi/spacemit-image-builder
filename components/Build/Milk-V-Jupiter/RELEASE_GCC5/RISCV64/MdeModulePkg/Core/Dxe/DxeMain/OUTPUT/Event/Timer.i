# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Event/Timer.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Event/Timer.c"
# 9 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Event/Timer.c"
...
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Event/Timer.c" 2
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Event/Timer.c" 2





LIST_ENTRY mEfiTimerList = {&(mEfiTimerList), &(mEfiTimerList)};
EFI_LOCK mEfiTimerLock = {31 - 1, 4, EfiLockReleased };
EFI_EVENT mEfiCheckTimerEvent = ((void *) 0);

EFI_LOCK mEfiSystemTimeLock = {31, 4, EfiLockReleased };
UINT64 mEfiSystemTime = 0;
# 34 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Event/Timer.c"
void
  ...
  )
{
  ...
  for (Link = mEfiTimerList.ForwardLink; Link != &mEfiTimerList; Link = Link->ForwardLink) {
    Event2 = (((IEVENT *) (void *) ((CHAR8 *) (Link) - ((UINTN) __builtin_offsetof(IEVENT, Timer.Link))))->Signature != ((('e') | ('v' << 8)) | ((('n') | ('t' << 8)) << 16))) ? ((void *) 0) : ((IEVENT *) (void *) ((CHAR8 *) (Link) - ((UINTN) __builtin_offsetof(IEVENT, Timer.Link))));
...
# 92 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Event/Timer.c"
void
  ...
  )
{
  ...
  while (!IsListEmpty (&mEfiTimerList)) {
    Event = (((IEVENT *) (void *) ((CHAR8 *) (mEfiTimerList.ForwardLink) - ((UINTN) __builtin_offsetof(IEVENT, Timer.Link))))->Signature != ((('e') | ('v' << 8)) | ((('n') | ('t' << 8)) << 16))) ? ((void *) 0) : ((IEVENT *) (void *) ((CHAR8 *) (mEfiTimerList.ForwardLink) - ((UINTN) __builtin_offsetof(IEVENT, Timer.Link))));
    ...
    Event->Timer.Link.ForwardLink = ((void *) 0);
...
# 186 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Event/Timer.c"
void
...
# 234 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Event/Timer.c"
EFI_STATUS
  ...
  )
{
  ...
  if (((UINT32)Type > TimerRelative) || ((Event->Type & 0x80000000) == 0)) {
    return ((RETURN_STATUS)(0x8000000000000000ULL | (2)));
  }
  ...
  if (Event->Timer.Link.ForwardLink != ((void *) 0)) {
    RemoveEntryList (&Event->Timer.Link);
    Event->Timer.Link.ForwardLink = ((void *) 0);
  }

# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/FwVol/FwVol.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/FwVol/FwVol.c"
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/FwVol/FwVol.c"
...
# 12 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/FwVol/FwVol.c" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/FwVol/FwVolDriver.h" 1
# 18 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/FwVol/FwVolDriver.h"
typedef struct {
  LIST_ENTRY Link;
...
# 57 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/FwVol/FwVolDriver.h"
EFI_STATUS
...
# 74 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/FwVol/FwVolDriver.h"
EFI_STATUS
...
# 127 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/FwVol/FwVolDriver.h"
EFI_STATUS
...
# 178 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/FwVol/FwVolDriver.h"
EFI_STATUS
...
# 218 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/FwVol/FwVolDriver.h"
EFI_STATUS
...
# 251 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/FwVol/FwVolDriver.h"
EFI_STATUS
...
# 273 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/FwVol/FwVolDriver.h"
EFI_STATUS
...
# 295 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/FwVol/FwVolDriver.h"
EFI_STATUS
...
# 315 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/FwVol/FwVolDriver.h"
BOOLEAN
IsBufferErased (
  UINT8 ErasePolarity,
  void *InBuffer,
...
# 331 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/FwVol/FwVolDriver.h"
EFI_FFS_FILE_STATE
GetFileState (
  UINT8 ErasePolarity,
  EFI_FFS_FILE_HEADER *FfsHeader
  );
# 346 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/FwVol/FwVolDriver.h"
void
SetFileState (
  UINT8 State,
  EFI_FFS_FILE_HEADER *FfsHeader
  );
# 363 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/FwVol/FwVolDriver.h"
BOOLEAN
IsValidFfsHeader (
  UINT8 ErasePolarity,
  EFI_FFS_FILE_HEADER *FfsHeader,
...
# 381 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/FwVol/FwVolDriver.h"
BOOLEAN
IsValidFfsFile (
  UINT8 ErasePolarity,
  EFI_FFS_FILE_HEADER *FfsHeader
  );
# 13 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/FwVol/FwVol.c" 2
...
# 68 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/FwVol/FwVol.c"
EFI_STATUS
ReadFvbData (
  EFI_FIRMWARE_VOLUME_BLOCK_PROTOCOL *Fvb,
  EFI_LBA *StartLba,
  ...
  )
{
  ...
  } else if (Status != ((RETURN_STATUS)(0x8000000000000000ULL | (4)))) {
...
# 174 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/FwVol/FwVol.c"
EFI_STATUS
GetFwVolHeader (
  EFI_FIRMWARE_VOLUME_BLOCK_PROTOCOL *Fvb,
  EFI_FIRMWARE_VOLUME_HEADER **FwVolHeader
  )
{
  ...
  if (TempFvh.Signature != ((('_') | ('F' << 8)) | ((('V') | ('H' << 8)) << 16))) {
  ...
  )
{
  ...
  while (&FfsFileEntry->Link != &FvDevice->FfsFileListHeader) {
    ...
    if (FfsFileEntry->StreamHandle != 0) {
      ...
      CloseSectionStream (FfsFileEntry->StreamHandle, ((BOOLEAN)(0==1)));
    }
...
# 309 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/FwVol/FwVol.c"
EFI_STATUS
FvCheck (
  FV_DEVICE *FvDevice
  )
{
  ...
  FileCached = ((BOOLEAN)(0==1));
  CacheFfsHeader = ((void *) 0);
  ...
  if ((FvbAttributes & 0x00000400) != 0) {
    FvDevice->IsMemoryMapped = ((BOOLEAN)(1==1));
    ...
    FvDevice->IsMemoryMapped = ((BOOLEAN)(0==1));
    FvDevice->CachedFv = AllocatePool (Size);

    if (FvDevice->CachedFv == ((void *) 0)) {
      return ((RETURN_STATUS)(0x8000000000000000ULL | (9)));
    }
  }
  ...
  FfsHeader = (EFI_FFS_FILE_HEADER *)((void *) ((((UINTN)(FfsHeader)) + ((((8)) - ((UINTN)(FfsHeader))) & (((8)) - 1U)))));
  ...
  while (((UINTN)FfsHeader >= (UINTN)FvDevice->CachedFv) && ((UINTN)FfsHeader <= (UINTN)((UINTN)TopFvAddress - sizeof (EFI_FFS_FILE_HEADER)))) {
    ...
    if (!IsValidFfsHeader (FvDevice->ErasePolarity, FfsHeader, &FileState)) {
      if ((FileState == 0x20) ||
          (FileState == 0x01))
      {
        if ((((((EFI_FFS_FILE_HEADER *) (UINTN) FfsHeader)->Attributes) & 0x01) == 0x01)) {
          if (!FvDevice->IsFfs3Fv) {
            do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "Found a FFS3 formatted file: %g in a non-FFS3 formatted FV.\n", &FfsHeader->Name); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
          }
        ...
        Status = ((RETURN_STATUS)(0x8000000000000000ULL | (10)));
        goto Done;
      }
    }

    CacheFfsHeader = FfsHeader;
    if ((CacheFfsHeader->Attributes & 0x40) == 0x40) {
      if (FvDevice->IsMemoryMapped) {
        ...
        WholeFileSize = (((((EFI_FFS_FILE_HEADER *) (UINTN) CacheFfsHeader)->Attributes) & 0x01) == 0x01) ? ((UINT32) (((EFI_FFS_FILE_HEADER2 *) (UINTN) CacheFfsHeader)->ExtendedSize)) : ((UINT32) ( (((EFI_FFS_FILE_HEADER *) (UINTN) (CacheFfsHeader))->Size[0] ) | (((EFI_FFS_FILE_HEADER *) (UINTN) (CacheFfsHeader))->Size[1] << 8) | (((EFI_FFS_FILE_HEADER *) (UINTN) (CacheFfsHeader))->Size[2] << 16)));
        CacheFfsHeader = AllocateCopyPool (WholeFileSize, CacheFfsHeader);
        if (CacheFfsHeader == ((void *) 0)) {
          Status = ((RETURN_STATUS)(0x8000000000000000ULL | (9)));
          goto Done;
        }

        FileCached = ((BOOLEAN)(1==1));
      }
    }
    ...
    if ((((((EFI_FFS_FILE_HEADER *) (UINTN) CacheFfsHeader)->Attributes) & 0x01) == 0x01)) {
      do { if (((BOOLEAN)(0==1))) { (void) (((UINT32) (((EFI_FFS_FILE_HEADER2 *) (UINTN) CacheFfsHeader)->ExtendedSize)) > 0x00FFFFFF); } } while (((BOOLEAN)(0==1)));
      if (!FvDevice->IsFfs3Fv) {
        do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "Found a FFS3 formatted file: %g in a non-FFS3 formatted FV.\n", &CacheFfsHeader->Name); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
        FfsHeader = (EFI_FFS_FILE_HEADER *)((UINT8 *)FfsHeader + ((UINT32) (((EFI_FFS_FILE_HEADER2 *) (UINTN) CacheFfsHeader)->ExtendedSize)));
    ...
    if ((((((EFI_FFS_FILE_HEADER *) (UINTN) CacheFfsHeader)->Attributes) & 0x01) == 0x01)) {
      ...
      FfsHeader = (EFI_FFS_FILE_HEADER *)((UINT8 *)FfsHeader + ((UINT32) ( (((EFI_FFS_FILE_HEADER *) (UINTN) (CacheFfsHeader))->Size[0] ) | (((EFI_FFS_FILE_HEADER *) (UINTN) (CacheFfsHeader))->Size[1] << 8) | (((EFI_FFS_FILE_HEADER *) (UINTN) (CacheFfsHeader))->Size[2] << 16))));
    }
...
# 577 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/FwVol/FwVol.c"
void
  ...
  )
{
  ...
  for ( ; ;) {
    ...
    if (((RETURN_STATUS)(0x8000000000000000ULL | (14))) == Status) {
      break;
    }
    ...
    if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
      ...
      FvDevice = ((FV_DEVICE *) (void *) ((CHAR8 *) (Fv) - ((UINTN) __builtin_offsetof(FV_DEVICE, Fv))));
      if (FvDevice->Signature == ((('_') | ('F' << 8)) | ((('V') | ('2' << 8)) << 16))) {
      ...
      if (!(((RETURN_STATUS)(FvCheck (FvDevice))) >= 0x8000000000000000ULL)) {
...
# 710 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/FwVol/FwVol.c"
EFI_STATUS

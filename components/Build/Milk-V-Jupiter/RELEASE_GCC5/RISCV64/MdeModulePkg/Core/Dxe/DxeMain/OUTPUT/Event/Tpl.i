# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Event/Tpl.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Event/Tpl.c"
# 9 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Event/Tpl.c"
...
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Event/Tpl.c" 2
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Event/Tpl.c" 2
  ...
  )
{
  ...
  if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) && !InSmm) {
    gCpu->EnableInterrupt (gCpu);
  }
}
# 55 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Event/Tpl.c"
EFI_TPL
  ...
  )
{
  ...
  if (OldTpl > NewTpl) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "FATAL ERROR - RaiseTpl with OldTpl(0x%x) > NewTpl(0x%x)\n", OldTpl, NewTpl); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    do { if (((BOOLEAN)(0==1))) { (void) (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  }

  do { if (((BOOLEAN)(0==1))) { (void) (((NewTpl) <= 31)); } } while (((BOOLEAN)(0==1)));




  if ((NewTpl >= 31) && (OldTpl < 31)) {
    CoreSetInterruptState (((BOOLEAN)(0==1)));
  }
...
# 93 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Event/Tpl.c"
void
  ...
  )
{
  ...
  OldTpl = gEfiCurrentTpl;
  if (NewTpl > OldTpl) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "FATAL ERROR - RestoreTpl with NewTpl(0x%x) > OldTpl(0x%x)\n", NewTpl, OldTpl); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    do { if (((BOOLEAN)(0==1))) { (void) (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  }
  ...
  while (gEventPending != 0) {
    ...
    if (gEfiCurrentTpl < 31) {
      CoreSetInterruptState (((BOOLEAN)(1==1)));
    }

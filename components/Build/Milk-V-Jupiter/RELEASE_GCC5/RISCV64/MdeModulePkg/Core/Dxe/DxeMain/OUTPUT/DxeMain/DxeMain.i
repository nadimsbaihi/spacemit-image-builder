# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/DxeMain/DxeMain.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/DxeMain/DxeMain.c"
# 9 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/DxeMain/DxeMain.c"
...
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/DxeMain/DxeMain.c" 2




EFI_HANDLE mDecompressHandle = ((void *) 0);




EFI_SECURITY_ARCH_PROTOCOL *gSecurity = ((void *) 0);
EFI_SECURITY2_ARCH_PROTOCOL *gSecurity2 = ((void *) 0);
EFI_CPU_ARCH_PROTOCOL *gCpu = ((void *) 0);
EFI_METRONOME_ARCH_PROTOCOL *gMetronome = ((void *) 0);
EFI_TIMER_ARCH_PROTOCOL *gTimer = ((void *) 0);
EFI_BDS_ARCH_PROTOCOL *gBds = ((void *) 0);
EFI_WATCHDOG_TIMER_ARCH_PROTOCOL *gWatchdogTimer = ((void *) 0);




EFI_SMM_BASE2_PROTOCOL *gSmmBase2 = ((void *) 0);
...
EFI_BOOT_SERVICES mBootServices = {
  {
    (((('B') | ('O' << 8)) | ((('O') | ('T' << 8)) << 16)) | ((UINT64) (((('S') | ('E' << 8)) | ((('R') | ('V' << 8)) << 16))) << 32)),
    ((2 << 16) | (70)),
  ...
  (EFI_FREE_PAGES)CoreFreePages,
  (EFI_GET_MEMORY_MAP)CoreGetMemoryMap,
  (EFI_ALLOCATE_POOL)CoreAllocatePool,
  (EFI_FREE_POOL)CoreFreePool,
  ...
  (EFI_REINSTALL_PROTOCOL_INTERFACE)CoreReinstallProtocolInterface,
  (EFI_UNINSTALL_PROTOCOL_INTERFACE)CoreUninstallProtocolInterface,
  (EFI_HANDLE_PROTOCOL)CoreHandleProtocol,
  (void *)((void *) 0),
  (EFI_REGISTER_PROTOCOL_NOTIFY)CoreRegisterProtocolNotify,
  (EFI_LOCATE_HANDLE)CoreLocateHandle,
  (EFI_LOCATE_DEVICE_PATH)CoreLocateDevicePath,
  (EFI_INSTALL_CONFIGURATION_TABLE)CoreInstallConfigurationTable,
  (EFI_IMAGE_LOAD)CoreLoadImage,
  (EFI_IMAGE_START)CoreStartImage,
  (EFI_EXIT)CoreExit,
  (EFI_IMAGE_UNLOAD)CoreUnloadImage,
  (EFI_EXIT_BOOT_SERVICES)CoreExitBootServices,
  (EFI_GET_NEXT_MONOTONIC_COUNT)CoreEfiNotAvailableYetArg1,
  (EFI_STALL)CoreStall,
  (EFI_SET_WATCHDOG_TIMER)CoreSetWatchdogTimer,
  (EFI_CONNECT_CONTROLLER)CoreConnectController,
  (EFI_DISCONNECT_CONTROLLER)CoreDisconnectController,
  (EFI_OPEN_PROTOCOL)CoreOpenProtocol,
  (EFI_CLOSE_PROTOCOL)CoreCloseProtocol,
  (EFI_OPEN_PROTOCOL_INFORMATION)CoreOpenProtocolInformation,
  (EFI_PROTOCOLS_PER_HANDLE)CoreProtocolsPerHandle,
  (EFI_LOCATE_HANDLE_BUFFER)CoreLocateHandleBuffer,
  (EFI_LOCATE_PROTOCOL)CoreLocateProtocol,
  (EFI_INSTALL_MULTIPLE_PROTOCOL_INTERFACES)CoreInstallMultipleProtocolInterfaces,
  (EFI_UNINSTALL_MULTIPLE_PROTOCOL_INTERFACES)CoreUninstallMultipleProtocolInterfaces,
  (EFI_CALCULATE_CRC32)CoreEfiNotAvailableYetArg3,
  (EFI_COPY_MEM)CopyMem,
  (EFI_SET_MEM)SetMem,
...
EFI_DXE_SERVICES mDxeServices = {
  ...
  (EFI_ADD_MEMORY_SPACE)CoreAddMemorySpace,
  (EFI_ALLOCATE_MEMORY_SPACE)CoreAllocateMemorySpace,
  (EFI_FREE_MEMORY_SPACE)CoreFreeMemorySpace,
  (EFI_REMOVE_MEMORY_SPACE)CoreRemoveMemorySpace,
  (EFI_GET_MEMORY_SPACE_DESCRIPTOR)CoreGetMemorySpaceDescriptor,
  (EFI_SET_MEMORY_SPACE_ATTRIBUTES)CoreSetMemorySpaceAttributes,
  (EFI_GET_MEMORY_SPACE_MAP)CoreGetMemorySpaceMap,
  (EFI_ADD_IO_SPACE)CoreAddIoSpace,
  (EFI_ALLOCATE_IO_SPACE)CoreAllocateIoSpace,
  (EFI_FREE_IO_SPACE)CoreFreeIoSpace,
  (EFI_REMOVE_IO_SPACE)CoreRemoveIoSpace,
  (EFI_GET_IO_SPACE_DESCRIPTOR)CoreGetIoSpaceDescriptor,
  (EFI_GET_IO_SPACE_MAP)CoreGetIoSpaceMap,
  (EFI_DISPATCH)CoreDispatcher,
  (EFI_SCHEDULE)CoreSchedule,
  (EFI_TRUST)CoreTrust,
  (EFI_PROCESS_FIRMWARE_VOLUME)CoreProcessFirmwareVolume,
  (EFI_SET_MEMORY_SPACE_CAPABILITIES)CoreSetMemorySpaceCapabilities,
};

EFI_SYSTEM_TABLE mEfiSystemTableTemplate = {
  {
    (((('I') | ('B' << 8)) | ((('I') | (' ' << 8)) << 16)) | ((UINT64) (((('S') | ('Y' << 8)) | ((('S') | ('T' << 8)) << 16))) << 32)),
    ((2 << 16) | (70)),
...
EFI_RUNTIME_SERVICES mEfiRuntimeServicesTableTemplate = {
  {
    (((('R') | ('U' << 8)) | ((('N') | ('T' << 8)) << 16)) | ((UINT64) (((('S') | ('E' << 8)) | ((('R') | ('V' << 8)) << 16))) << 32)),
    ((2 << 16) | (70)),
    sizeof (EFI_RUNTIME_SERVICES),
    0,
    0
  },
  (EFI_GET_TIME)CoreEfiNotAvailableYetArg2,
  (EFI_SET_TIME)CoreEfiNotAvailableYetArg1,
  (EFI_GET_WAKEUP_TIME)CoreEfiNotAvailableYetArg3,
  (EFI_SET_WAKEUP_TIME)CoreEfiNotAvailableYetArg2,
  (EFI_SET_VIRTUAL_ADDRESS_MAP)CoreEfiNotAvailableYetArg4,
  (EFI_CONVERT_POINTER)CoreEfiNotAvailableYetArg2,
  (EFI_GET_VARIABLE)CoreEfiNotAvailableYetArg5,
  (EFI_GET_NEXT_VARIABLE_NAME)CoreEfiNotAvailableYetArg3,
  (EFI_SET_VARIABLE)CoreEfiNotAvailableYetArg5,
  (EFI_GET_NEXT_HIGH_MONO_COUNT)CoreEfiNotAvailableYetArg1,
  (EFI_RESET_SYSTEM)CoreEfiNotAvailableYetArg4,
  (EFI_UPDATE_CAPSULE)CoreEfiNotAvailableYetArg3,
  (EFI_QUERY_CAPSULE_CAPABILITIES)CoreEfiNotAvailableYetArg4,
  (EFI_QUERY_VARIABLE_INFO)CoreEfiNotAvailableYetArg4
};

EFI_RUNTIME_ARCH_PROTOCOL gRuntimeTemplate = {
  {&(gRuntimeTemplate.ImageHead), &(gRuntimeTemplate.ImageHead)},
  {&(gRuntimeTemplate.EventHead), &(gRuntimeTemplate.EventHead)},
...
EFI_SYSTEM_TABLE *gDxeCoreST = ((void *) 0);
...
EFI_HANDLE gDxeCoreImageHandle = ((void *) 0);

BOOLEAN gMemoryMapTerminated = ((BOOLEAN)(0==1));

static BOOLEAN mExitBootServicesCalled = ((BOOLEAN)(0==1));
...
# 233 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/DxeMain/DxeMain.c"
void
  ...
  )
{
  ...
  VectorInfoList = ((void *) 0);
  GuidHob = GetNextGuidHob (&gEfiVectorHandoffInfoPpiGuid, HobStart);
  if (GuidHob != ((void *) 0)) {
    VectorInfoList = (EFI_VECTOR_HANDOFF_INFO *)((void *)(*(UINT8 **)&(GuidHob) + sizeof (EFI_HOB_GUID_TYPE)));
  }
  ...
  if (_gPcd_FixedAtBuild_PcdCpuStackGuard) {
    Status = InitializeSeparateExceptionStacks (((void *) 0), ((void *) 0));
    do { if (((BOOLEAN)(0==1))) { (void) (Status); } } while (((BOOLEAN)(0==1)));
  }
  ...
  InitializeDebugAgent (3, HobStart, ((void *) 0));
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (gDxeCoreST != ((void *) 0)); } } while (((BOOLEAN)(0==1)));

  gDxeCoreRT = AllocateRuntimeCopyPool (sizeof (EFI_RUNTIME_SERVICES), &mEfiRuntimeServicesTableTemplate);
  do { if (((BOOLEAN)(0==1))) { (void) (gDxeCoreRT != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
  ...
  do { if (LogPerformanceMeasurementEnabled (0x0040)) { LogPerformanceMeasurement (&gEfiCallerIdGuid, ((void *) 0), "PEI", 0, 0x51); } } while (((BOOLEAN)(0==1)));
  do { if (LogPerformanceMeasurementEnabled (0x0040)) { LogPerformanceMeasurement (&gEfiCallerIdGuid, ((void *) 0), "DXE", 0, 0x50); } } while (((BOOLEAN)(0==1)));
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "%a: MemoryBaseAddress=0x%Lx MemoryLength=0x%Lx\n", __func__, MemoryBaseAddress, MemoryLength); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
  ...
  (ReportProgressCodeEnabled() && ((0x00000001) & 0x000000FF) == 0x00000001) ? ReportStatusCode(0x00000001,((0x03000000 | 0x00040000) | (0x1000 | 0x00000000))) : (ReportErrorCodeEnabled() && ((0x00000001) & 0x000000FF) == 0x00000002) ? ReportStatusCode(0x00000001,((0x03000000 | 0x00040000) | (0x1000 | 0x00000000))) : (ReportDebugCodeEnabled() && ((0x00000001) & 0x000000FF) == 0x00000003) ? ReportStatusCode(0x00000001,((0x03000000 | 0x00040000) | (0x1000 | 0x00000000))) : ((RETURN_STATUS)(0x8000000000000000ULL | (3)))
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040 | 0x00000004)) { DebugPrint (0x00000040 | 0x00000004, "HOBLIST address in DXE = 0x%p\n", HobStart); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  ...
  for (Hob.Raw = HobStart; !(((*(EFI_HOB_GENERIC_HEADER **)&(Hob))->HobType) == (UINT16)0xFFFF); Hob.Raw = (void *)(*(UINT8 **)&(Hob) + ((*(EFI_HOB_GENERIC_HEADER **)&(Hob))->HobLength))) {
    if (((*(EFI_HOB_GENERIC_HEADER **)&(Hob))->HobType) == 0x0002) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040 | 0x00000004)) { DebugPrint (0x00000040 | 0x00000004, "Memory Allocation 0x%08x 0x%0lx - 0x%0lx\n", Hob.MemoryAllocation->AllocDescriptor.MemoryType, Hob.MemoryAllocation->AllocDescriptor.MemoryBaseAddress, Hob.MemoryAllocation->AllocDescriptor.MemoryBaseAddress + Hob.MemoryAllocation->AllocDescriptor.MemoryLength - 1); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
  ...
  for (Hob.Raw = HobStart; !(((*(EFI_HOB_GENERIC_HEADER **)&(Hob))->HobType) == (UINT16)0xFFFF); Hob.Raw = (void *)(*(UINT8 **)&(Hob) + ((*(EFI_HOB_GENERIC_HEADER **)&(Hob))->HobLength))) {
    if (((*(EFI_HOB_GENERIC_HEADER **)&(Hob))->HobType) == 0x0005) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040 | 0x00000004)) { DebugPrint (0x00000040 | 0x00000004, "FV Hob            0x%0lx - 0x%0lx\n", Hob.FirmwareVolume->BaseAddress, Hob.FirmwareVolume->BaseAddress + Hob.FirmwareVolume->Length - 1); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))




          ;
    } else if (((*(EFI_HOB_GENERIC_HEADER **)&(Hob))->HobType) == 0x0009) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040 | 0x00000004)) { DebugPrint (0x00000040 | 0x00000004, "FV2 Hob           0x%0lx - 0x%0lx\n", Hob.FirmwareVolume2->BaseAddress, Hob.FirmwareVolume2->BaseAddress + Hob.FirmwareVolume2->Length - 1); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))




          ;
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040 | 0x00000004)) { DebugPrint (0x00000040 | 0x00000004, "                  %g - %g\n", &Hob.FirmwareVolume2->FvName, &Hob.FirmwareVolume2->FileName); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))




          ;
    } else if (((*(EFI_HOB_GENERIC_HEADER **)&(Hob))->HobType) == 0x000C) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040 | 0x00000004)) { DebugPrint (0x00000040 | 0x00000004, "FV3 Hob           0x%0lx - 0x%0lx - 0x%x - 0x%x\n", Hob.FirmwareVolume3->BaseAddress, Hob.FirmwareVolume3->BaseAddress + Hob.FirmwareVolume3->Length - 1, Hob.FirmwareVolume3->AuthenticationStatus, Hob.FirmwareVolume3->ExtractedFv); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
      ...
      if (Hob.FirmwareVolume3->ExtractedFv) {
        do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040 | 0x00000004)) { DebugPrint (0x00000040 | 0x00000004, "                  %g - %g\n", &Hob.FirmwareVolume3->FvName, &Hob.FirmwareVolume3->FileName); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
  ...
  InitializeDebugAgent (14, HobStart, ((void *) 0));
  ...
  if (GuidHob != ((void *) 0)) {
    ...
    Index = 1;
    while (VectorInfo->Attribute != 0x80000000) {
      VectorInfo++;
      Index++;
    }

    VectorInfo = AllocateCopyPool (sizeof (EFI_VECTOR_HANDOFF_INFO) * Index, (void *)VectorInfoList);
    do { if (((BOOLEAN)(0==1))) { (void) (VectorInfo != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
    Status = CoreInstallConfigurationTable (&gEfiVectorHandoffTableGuid, (void *)VectorInfo);
    do { if (((BOOLEAN)(0==1))) { (void) (Status); } } while (((BOOLEAN)(0==1)));
  }
# 511 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/DxeMain/DxeMain.c"
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    ...
    (ReportProgressCodeEnabled() && ((0x00000002 | 0x80000000) & 0x000000FF) == 0x00000001) ? ReportStatusCode(0x00000002 | 0x80000000,((0x03000000 | 0x00040000) | (0x1000 | 0x00000000))) : (ReportErrorCodeEnabled() && ((0x00000002 | 0x80000000) & 0x000000FF) == 0x00000002) ? ReportStatusCode(0x00000002 | 0x80000000,((0x03000000 | 0x00040000) | (0x1000 | 0x00000000))) : (ReportDebugCodeEnabled() && ((0x00000002 | 0x80000000) & 0x000000FF) == 0x00000003) ? ReportStatusCode(0x00000002 | 0x80000000,((0x03000000 | 0x00040000) | (0x1000 | 0x00000000))) : ((RETURN_STATUS)(0x8000000000000000ULL | (3)))
  ...
  (ReportProgressCodeEnabled() && ((0x00000001) & 0x000000FF) == 0x00000001) ? ReportStatusCode(0x00000001,((0x03000000 | 0x00040000) | (0x1000 | 0x00000001))) : (ReportErrorCodeEnabled() && ((0x00000001) & 0x000000FF) == 0x00000002) ? ReportStatusCode(0x00000001,((0x03000000 | 0x00040000) | (0x1000 | 0x00000001))) : (ReportDebugCodeEnabled() && ((0x00000001) & 0x000000FF) == 0x00000003) ? ReportStatusCode(0x00000001,((0x03000000 | 0x00040000) | (0x1000 | 0x00000001))) : ((RETURN_STATUS)(0x8000000000000000ULL | (3)))
...
# 613 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/DxeMain/DxeMain.c"
EFI_STATUS
  ...
  )
{
  ...
  return (0x8000000000000000ULL | (0x8000000000000000ULL >> 2) | 2);
}
# 637 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/DxeMain/DxeMain.c"
EFI_STATUS
...
# 663 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/DxeMain/DxeMain.c"
EFI_STATUS
...
# 691 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/DxeMain/DxeMain.c"
EFI_STATUS
...
# 721 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/DxeMain/DxeMain.c"
EFI_STATUS
...
# 747 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/DxeMain/DxeMain.c"
void
CalculateEfiHdrCrc (
  EFI_TABLE_HEADER *Hdr
  )
...
# 775 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/DxeMain/DxeMain.c"
EFI_STATUS
  ...
  )
{
  ...
  if (!mExitBootServicesCalled) {
    ...
    mExitBootServicesCalled = ((BOOLEAN)(1==1));
  }
  ...
  gMemoryMapTerminated = ((BOOLEAN)(1==1));
  ...
  (ReportProgressCodeEnabled() && ((0x00000001) & 0x000000FF) == 0x00000001) ? ReportStatusCode(0x00000001,((0x03000000 | 0x00100000) | (0x1000 | 0x00000019))) : (ReportErrorCodeEnabled() && ((0x00000001) & 0x000000FF) == 0x00000002) ? ReportStatusCode(0x00000001,((0x03000000 | 0x00100000) | (0x1000 | 0x00000019))) : (ReportDebugCodeEnabled() && ((0x00000001) & 0x000000FF) == 0x00000003) ? ReportStatusCode(0x00000001,((0x03000000 | 0x00100000) | (0x1000 | 0x00000019))) : ((RETURN_STATUS)(0x8000000000000000ULL | (3)))
  ...
  SaveAndSetDebugTimerInterrupt (((BOOLEAN)(0==1)));
  ...
  gDxeCoreST->BootServices = ((void *) 0);
  gDxeCoreST->ConIn = ((void *) 0);
  gDxeCoreST->ConsoleInHandle = ((void *) 0);
  gDxeCoreST->ConOut = ((void *) 0);
  gDxeCoreST->ConsoleOutHandle = ((void *) 0);
  gDxeCoreST->StdErr = ((void *) 0);
  gDxeCoreST->StandardErrorHandle = ((void *) 0);
  ...
  gRuntime->AtRuntime = ((BOOLEAN)(1==1));

  return Status;
}
# 906 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/DxeMain/DxeMain.c"
EFI_STATUS
...
{
  if ((Source == ((void *) 0)) || (DestinationSize == ((void *) 0)) || (ScratchSize == ((void *) 0))) {
    return ((RETURN_STATUS)(0x8000000000000000ULL | (2)));
  }

  return UefiDecompressGetInfo (Source, SourceSize, DestinationSize, ScratchSize);
}
# 957 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/DxeMain/DxeMain.c"
EFI_STATUS
  ...
  )
{
  ...
  if ((Source == ((void *) 0)) || (Destination == ((void *) 0)) || (Scratch == ((void *) 0))) {
    return ((RETURN_STATUS)(0x8000000000000000ULL | (2)));
  }

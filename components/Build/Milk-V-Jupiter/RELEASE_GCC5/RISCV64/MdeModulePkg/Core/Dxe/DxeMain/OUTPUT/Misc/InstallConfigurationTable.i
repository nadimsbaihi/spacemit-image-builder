# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Misc/InstallConfigurationTable.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Misc/InstallConfigurationTable.c"
# 9 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Misc/InstallConfigurationTable.c"
...
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Misc/InstallConfigurationTable.c" 2



UINTN mSystemTableAllocateSize = 0;
# 30 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Misc/InstallConfigurationTable.c"
EFI_STATUS
  ...
  )
{
  ...
  if (Index < gDxeCoreST->NumberOfTableEntries) {
    ...
    if ((Index * sizeof (EFI_CONFIGURATION_TABLE)) >= mSystemTableAllocateSize) {
      ...
      mSystemTableAllocateSize += (0x10 * sizeof (EFI_CONFIGURATION_TABLE));
      EfiConfigurationTable = AllocateRuntimePool (mSystemTableAllocateSize);
      if (EfiConfigurationTable == ((void *) 0)) {
      ...
      if (gDxeCoreST->ConfigurationTable != ((void *) 0)) {
...
# 142 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Misc/InstallConfigurationTable.c"

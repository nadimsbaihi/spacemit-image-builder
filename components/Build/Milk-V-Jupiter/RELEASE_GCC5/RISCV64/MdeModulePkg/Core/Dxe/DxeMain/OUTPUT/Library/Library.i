# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Library/Library.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Library/Library.c"
# 9 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Library/Library.c"
...
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Library/Library.c" 2
# 28 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Library/Library.c"
EFI_STATUS
CoreAcquireLockOrFail (
  EFI_LOCK *Lock
  )
{
  do { if (((BOOLEAN)(0==1))) { (void) (Lock != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { (void) (Lock->Lock != EfiLockUninitialized); } } while (((BOOLEAN)(0==1)));
...
# 58 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Library/Library.c"
void
CoreAcquireLock (
  EFI_LOCK *Lock
  )
{
  do { if (((BOOLEAN)(0==1))) { (void) (Lock != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { (void) (Lock->Lock == EfiLockReleased); } } while (((BOOLEAN)(0==1)));

  Lock->OwnerTpl = CoreRaiseTpl (Lock->Tpl);
  Lock->Lock = EfiLockAcquired;
}
# 79 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Library/Library.c"
void
CoreReleaseLock (
  EFI_LOCK *Lock
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (Lock != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { (void) (Lock->Lock == EfiLockAcquired); } } while (((BOOLEAN)(0==1)));

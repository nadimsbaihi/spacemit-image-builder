# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Pool.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Pool.c"
# 9 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Pool.c"
...
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Pool.c" 2
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Pool.c" 2
...
# 12 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Pool.c" 2

static EFI_LOCK mPoolMemoryLock = {16, 4, EfiLockReleased };
...
# 51 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Pool.c"
static const UINT16 mPoolSizeTable[] = {
  128, 256, 384, 640, 1024, 1664, 2688, 4352, 7040, 11392, 18432, 29824
};
# 67 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Pool.c"
typedef struct {
  INTN Signature;
  UINTN Used;
  EFI_MEMORY_TYPE MemoryType;
  LIST_ENTRY FreeList[((sizeof (mPoolSizeTable) / sizeof ((mPoolSizeTable)[0])))];
  LIST_ENTRY Link;
} POOL;
...
LIST_ENTRY mPoolHeadList = {&(mPoolHeadList), &(mPoolHeadList)};
# 93 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Pool.c"
static
UINTN
  ...
  )
{
  ...
  for (Index = 0; Index < ((sizeof (mPoolSizeTable) / sizeof ((mPoolSizeTable)[0]))); Index++) {
    if (mPoolSizeTable[Index] >= Size) {
      return Index;
    }
  }

  return ((sizeof (mPoolSizeTable) / sizeof ((mPoolSizeTable)[0])));
}
...
# 140 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Pool.c"
POOL *
LookupPoolHead (
  EFI_MEMORY_TYPE MemoryType
  )
{
  ...
  if ((UINT32)MemoryType >= MEMORY_TYPE_OEM_RESERVED_MIN) {
    for (Link = mPoolHeadList.ForwardLink; Link != &mPoolHeadList; Link = Link->ForwardLink) {
      Pool = (((POOL *) (void *) ((CHAR8 *) (Link) - ((UINTN) __builtin_offsetof(POOL, Link))))->Signature != ((('p') | ('l' << 8)) | ((('s') | ('t' << 8)) << 16))) ? ((void *) 0) : ((POOL *) (void *) ((CHAR8 *) (Link) - ((UINTN) __builtin_offsetof(POOL, Link))));
      if (Pool->MemoryType == MemoryType) {
        return Pool;
      }
    }

    Pool = CoreAllocatePoolI (EfiBootServicesData, sizeof (POOL), ((BOOLEAN)(0==1)));
    if (Pool == ((void *) 0)) {
      return ((void *) 0);
    }

    Pool->Signature = ((('p') | ('l' << 8)) | ((('s') | ('t' << 8)) << 16));
    Pool->Used = 0;
...
# 201 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Pool.c"
EFI_STATUS
  ...
  )
{
  ...
  *Buffer = ((void *) 0);
  ...
  if (Size > (0xFFFFFFFFFFFFFFFFULL - (((UINTN) __builtin_offsetof(POOL_HEAD, Data)) + sizeof(POOL_TAIL)))) {
  ...
  *Buffer = CoreAllocatePoolI (PoolType, Size, NeedGuard);
  ...
  return (*Buffer != ((void *) 0)) ? (RETURN_STATUS)(0) : ((RETURN_STATUS)(0x8000000000000000ULL | (9)));
}
# 265 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Pool.c"
EFI_STATUS
...
# 303 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Pool.c"
static
void *
...
# 350 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Pool.c"
void *
CoreAllocatePoolI (
  EFI_MEMORY_TYPE PoolType,
  UINTN Size,
...
# 390 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Pool.c"
  if (Granularity != 0x00001000) {
  ...
  HasPoolTail = !(NeedGuard &&
                  ((_gPcd_FixedAtBuild_PcdHeapGuardPropertyMask & 0x00000080) == 0));
  PageAsPool = (IsHeapGuardEnabled (0x00000010) && !mOnGuarding);
  ...
  Size = (((Size)) + (((sizeof (UINTN)) - ((Size))) & ((sizeof (UINTN)) - 1U)));

  Size += (((UINTN) __builtin_offsetof(POOL_HEAD, Data)) + sizeof(POOL_TAIL));
  Index = (GetPoolIndexFromSize (Size));
  ...
  if ((Index >= (GetPoolIndexFromSize (Granularity))) || NeedGuard || PageAsPool) {
    if (!HasPoolTail) {
      Size -= sizeof (POOL_TAIL);
    }

    NoPages = (((Size) >> 12) + (((Size) & 0xFFF) ? 1 : 0)) + (((Granularity) >> 12) + (((Granularity) & 0xFFF) ? 1 : 0)) - 1;
    NoPages &= ~(UINTN)((((Granularity) >> 12) + (((Granularity) & 0xFFF) ? 1 : 0)) - 1);
  ...
  if (IsListEmpty (&Pool->FreeList[Index])) {
    Offset = (mPoolSizeTable [Index]);
    MaxOffset = Granularity;




    while (++Index < (GetPoolIndexFromSize (Granularity))) {
      if (!IsListEmpty (&Pool->FreeList[Index])) {
        Free = (((POOL_FREE *) (void *) ((CHAR8 *) (Pool->FreeList[Index].ForwardLink) - ((UINTN) __builtin_offsetof(POOL_FREE, Link))))->Signature != ((('p') | ('f' << 8)) | ((('r') | ('0' << 8)) << 16))) ? ((void *) 0) : ((POOL_FREE *) (void *) ((CHAR8 *) (Pool->FreeList[Index].ForwardLink) - ((UINTN) __builtin_offsetof(POOL_FREE, Link))));
        RemoveEntryList (&Free->Link);
        NewPage = (void *)Free;
        MaxOffset = (mPoolSizeTable [Index]);
        goto Carve;
      }
    }
    ...
    NewPage = CoreAllocatePoolPagesI (
                PoolType,
                (((Granularity) >> 12) + (((Granularity) & 0xFFF) ? 1 : 0)),
                Granularity,
                NeedGuard
                );
    if (NewPage == ((void *) 0)) {
...
Carve:
    ...
    while (Offset < MaxOffset) {
      do { if (((BOOLEAN)(0==1))) { (void) (Index < ((sizeof (mPoolSizeTable) / sizeof ((mPoolSizeTable)[0])))); } } while (((BOOLEAN)(0==1)));
      FSize = (mPoolSizeTable [Index]);

      while (Offset + FSize <= MaxOffset) {
        Free = (POOL_FREE *)&NewPage[Offset];
        Free->Signature = ((('p') | ('f' << 8)) | ((('r') | ('0' << 8)) << 16));
    ...
    do { if (((BOOLEAN)(0==1))) { (void) (Offset == MaxOffset); } } while (((BOOLEAN)(0==1)));
    goto Done;
  }
...
Done:
  ...
  if (Head != ((void *) 0)) {
    ...
    Head->Signature = (PageAsPool) ? ((('p') | ('h' << 8)) | ((('d') | ('1' << 8)) << 16)) : ((('p') | ('h' << 8)) | ((('d') | ('0' << 8)) << 16));
    Head->Size = Size;
    Head->Type = (EFI_MEMORY_TYPE)PoolType;
    Buffer = Head->Data;

    if (HasPoolTail) {
      Tail = ((POOL_TAIL *) (((CHAR8 *) (Head)) + (Head)->Size - sizeof(POOL_TAIL)));;
      Tail->Signature = ((('p') | ('t' << 8)) | ((('a') | ('l' << 8)) << 16));
      Tail->Size = Size;

      Size -= (((UINTN) __builtin_offsetof(POOL_HEAD, Data)) + sizeof(POOL_TAIL));
    } else {
      Size -= ((UINTN) __builtin_offsetof(POOL_HEAD, Data));
    }

    do { if (DebugClearMemoryEnabled ()) { DebugClearMemory (Buffer, Size); } } while (((BOOLEAN)(0==1)));

    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000010)) { DebugPrint (0x00000010, "AllocatePoolI: Type %x, Addr %p (len %lx) %,ld\n", PoolType, Buffer, (UINT64)Size, (UINT64)Pool->Used); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
    ...
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000 | 0x00000010)) { DebugPrint (0x80000000 | 0x00000010, "AllocatePool: failed to allocate %ld bytes\n", (UINT64)Size); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  }

  return Buffer;
}
# 561 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Pool.c"
EFI_STATUS
...
# 589 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Pool.c"
EFI_STATUS
...
# 622 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Pool.c"
static
void
CoreFreePoolPagesI (
  EFI_MEMORY_TYPE PoolType,
...
# 651 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Pool.c"
static
void
...
# 690 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Core/Dxe/Mem/Pool.c"
EFI_STATUS
CoreFreePoolI (
  void *Buffer,
  EFI_MEMORY_TYPE *PoolType
  )
{
  ...
  Head = ((POOL_HEAD *) (void *) ((CHAR8 *) (Buffer) - ((UINTN) __builtin_offsetof(POOL_HEAD, Data))));
  do { if (((BOOLEAN)(0==1))) { (void) (Head != ((void *) 0)); } } while (((BOOLEAN)(0==1)));

  if ((Head->Signature != ((('p') | ('h' << 8)) | ((('d') | ('0' << 8)) << 16))) &&
      (Head->Signature != ((('p') | ('h' << 8)) | ((('d') | ('1' << 8)) << 16))))
  {
    do { if (((BOOLEAN)(0==1))) { (void) (Head->Signature == ((('p') | ('h' << 8)) | ((('d') | ('0' << 8)) << 16)) || Head->Signature == ((('p') | ('h' << 8)) | ((('d') | ('1' << 8)) << 16))); } } while (((BOOLEAN)(0==1)))
  ...
  HasPoolTail = !(IsGuarded &&
                  ((_gPcd_FixedAtBuild_PcdHeapGuardPropertyMask & 0x00000080) == 0));
  PageAsPool = (Head->Signature == ((('p') | ('h' << 8)) | ((('d') | ('1' << 8)) << 16)));

  if (HasPoolTail) {
    Tail = ((POOL_TAIL *) (((CHAR8 *) (Head)) + (Head)->Size - sizeof(POOL_TAIL)));;
    do { if (((BOOLEAN)(0==1))) { (void) (Tail != ((void *) 0)); } } while (((BOOLEAN)(0==1)));




    do { if (((BOOLEAN)(0==1))) { (void) (Tail->Signature == ((('p') | ('t' << 8)) | ((('a') | ('l' << 8)) << 16))); } } while (((BOOLEAN)(0==1)));
    do { if (((BOOLEAN)(0==1))) { (void) (Head->Size == Tail->Size); } } while (((BOOLEAN)(0==1)));

    if (Tail->Signature != ((('p') | ('t' << 8)) | ((('a') | ('l' << 8)) << 16))) {
      return ((RETURN_STATUS)(0x8000000000000000ULL | (2)));
    }
  ...
  Pool->Used -= Size;
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000010)) { DebugPrint (0x00000010, "FreePool: %p (len %lx) %,ld\n", Head->Data, (UINT64)(Head->Size - (((UINTN) __builtin_offsetof(POOL_HEAD, Data)) + sizeof(POOL_TAIL))), (UINT64)Pool->Used); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  ...
  Index = (GetPoolIndexFromSize (Size));
  do { if (DebugClearMemoryEnabled ()) { DebugClearMemory (Head, Size); } } while (((BOOLEAN)(0==1)));




  if ((Index >= (GetPoolIndexFromSize (Granularity))) || IsGuarded || PageAsPool) {
    ...
    Free = (POOL_FREE *)Head;
    do { if (((BOOLEAN)(0==1))) { (void) (Free != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
    Free->Signature = ((('p') | ('f' << 8)) | ((('r') | ('0' << 8)) << 16));
    Free->Index = (UINT32)Index;
    InsertHeadList (&Pool->FreeList[Index], &Free->Link);
    ...
    if (Free->Signature == ((('p') | ('f' << 8)) | ((('r') | ('0' << 8)) << 16))) {
      AllFree = ((BOOLEAN)(1==1));
      Offset = 0;
      ...
      while ((Offset < Granularity) && (AllFree)) {
        ...
        Offset += (mPoolSizeTable [Free->Index]);
      }

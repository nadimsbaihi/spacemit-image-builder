# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Console/TerminalDxe/TerminalConOut.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Console/TerminalDxe/TerminalConOut.c"
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Console/TerminalDxe/TerminalConOut.c"
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Console/TerminalDxe/TerminalConOut.c" 2
...
CHAR16 mSetModeString[] = { 27, '[', '=', '3', 'h', 0 };
CHAR16 mSetAttributeString[] = { 27, '[', '0', 'm', 27, '[', '4', '0', 'm', 27, '[', '4', '0', 'm', 0 };
CHAR16 mClearScreenString[] = { 27, '[', '2', 'J', 0 };
CHAR16 mSetCursorPositionString[] = { 27, '[', '0', '0', ';', '0', '0', 'H', 0 };
CHAR16 mCursorForwardString[] = { 27, '[', '0', '0', 'C', 0 };
CHAR16 mCursorBackwardString[] = { 27, '[', '0', '0', 'D', 0 };
# 103 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Console/TerminalDxe/TerminalConOut.c"
EFI_STATUS
  ...
  )
{
  ...
  TerminalDevice = (((TERMINAL_DEV *) (void *) ((CHAR8 *) (This) - ((UINTN) __builtin_offsetof(TERMINAL_DEV, SimpleTextOutput))))->Signature != ((('t') | ('m' << 8)) | ((('n') | ('l' << 8)) << 16))) ? ((void *) 0) : ((TERMINAL_DEV *) (void *) ((CHAR8 *) (This) - ((UINTN) __builtin_offsetof(TERMINAL_DEV, SimpleTextOutput))));
...
# 167 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Console/TerminalDxe/TerminalConOut.c"
EFI_STATUS
    ...
    switch (*WString) {
      ...
      default:
        if (Mode->CursorColumn < (INT32)(MaxColumn - 1)) {
          ...
          {
# 325 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Console/TerminalDxe/TerminalConOut.c"
            CrLfStr[0] = '\r';
            CrLfStr[1] = '\n';
...
OutputError:
  (ReportProgressCodeEnabled() && ((0x00000002 | 0x40000000) & 0x000000FF) == 0x00000001) ? ReportStatusCodeWithDevicePath(0x00000002 | 0x40000000,((0x01000000 | 0x00040000) | 0x00000008),TerminalDevice->DevicePath) : (ReportErrorCodeEnabled() && ((0x00000002 | 0x40000000) & 0x000000FF) == 0x00000002) ? ReportStatusCodeWithDevicePath(0x00000002 | 0x40000000,((0x01000000 | 0x00040000) | 0x00000008),TerminalDevice->DevicePath) : (ReportDebugCodeEnabled() && ((0x00000002 | 0x40000000) & 0x000000FF) == 0x00000003) ? ReportStatusCodeWithDevicePath(0x00000002 | 0x40000000,((0x01000000 | 0x00040000) | 0x00000008),TerminalDevice->DevicePath) : ((RETURN_STATUS)(0x8000000000000000ULL | (3)))
...
# 377 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Console/TerminalDxe/TerminalConOut.c"
EFI_STATUS
...
# 427 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Console/TerminalDxe/TerminalConOut.c"
EFI_STATUS
...
# 467 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Console/TerminalDxe/TerminalConOut.c"
EFI_STATUS
  ...
  )
{
  ...
  TerminalDevice->OutputEscChar = ((BOOLEAN)(1==1));
  Status = This->OutputString (This, mSetModeString);
  TerminalDevice->OutputEscChar = ((BOOLEAN)(0==1));
...
# 523 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Console/TerminalDxe/TerminalConOut.c"
EFI_STATUS
  ...
  )
{
  ...
  mSetAttributeString[2] = (CHAR16)('0' + BrightControl);
  mSetAttributeString[6 + 0] = (CHAR16)('0' + (ForegroundControl / 10));
  mSetAttributeString[6 + 1] = (CHAR16)('0' + (ForegroundControl % 10));
  mSetAttributeString[11 + 0] = (CHAR16)('0' + (BackgroundControl / 10));
  mSetAttributeString[11 + 1] = (CHAR16)('0' + (BackgroundControl % 10));
...
# 694 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Console/TerminalDxe/TerminalConOut.c"
EFI_STATUS
...
# 734 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Console/TerminalDxe/TerminalConOut.c"
EFI_STATUS
...
# 780 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Console/TerminalDxe/TerminalConOut.c"
  if ((TerminalDevice->TerminalType == TerminalTypeTtyTerm) &&
      ((UINTN)Mode->CursorRow == Row))
  {
    if ((UINTN)Mode->CursorColumn > Column) {
      mCursorBackwardString[2 + 0] = (CHAR16)('0' + ((Mode->CursorColumn - Column) / 10));
      mCursorBackwardString[2 + 1] = (CHAR16)('0' + ((Mode->CursorColumn - Column) % 10));
      String = mCursorBackwardString;
    } else if (Column > (UINTN)Mode->CursorColumn) {
      mCursorForwardString[2 + 0] = (CHAR16)('0' + ((Column - Mode->CursorColumn) / 10));
      mCursorForwardString[2 + 1] = (CHAR16)('0' + ((Column - Mode->CursorColumn) % 10));
      String = mCursorForwardString;
    } else {
      String = L"";
    }
  } else {
    mSetCursorPositionString[2 + 0] = (CHAR16)('0' + ((Row + 1) / 10));
    mSetCursorPositionString[2 + 1] = (CHAR16)('0' + ((Row + 1) % 10));
    mSetCursorPositionString[5 + 0] = (CHAR16)('0' + ((Column + 1) / 10));
    mSetCursorPositionString[5 + 1] = (CHAR16)('0' + ((Column + 1) % 10));
...
# 833 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Console/TerminalDxe/TerminalConOut.c"
EFI_STATUS
...
# 859 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Console/TerminalDxe/TerminalConOut.c"
BOOLEAN
TerminalIsValidTextGraphics (
  CHAR16 Graphic,
  CHAR8 *PcAnsi ,
...
# 902 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Console/TerminalDxe/TerminalConOut.c"
BOOLEAN
TerminalIsValidAscii (
  CHAR16 Ascii
  )
...
# 926 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Console/TerminalDxe/TerminalConOut.c"
BOOLEAN
TerminalIsValidEfiCntlChar (
  CHAR16 CharC
  )

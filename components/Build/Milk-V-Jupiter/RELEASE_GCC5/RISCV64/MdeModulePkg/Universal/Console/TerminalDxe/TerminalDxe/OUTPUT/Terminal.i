# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Console/TerminalDxe/Terminal.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Console/TerminalDxe/Terminal.c"
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Console/TerminalDxe/Terminal.c"
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Console/TerminalDxe/Terminal.c" 2
...
# 130 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Console/TerminalDxe/Terminal.c"
TERMINAL_TYPE
  ...
  )
{
  ...
  for (Type = 0; Type < (sizeof (mTerminalType) / sizeof ((mTerminalType)[0])); Type++) {
...
# 159 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Console/TerminalDxe/Terminal.c"
EFI_STATUS
  ...
  )
{
  ...
  if (RemainingDevicePath != ((void *) 0)) {
    ...
    if (!IsDevicePathEnd (RemainingDevicePath)) {
      ...
      if ((Node->Header.Type != 0x03) ||
          (Node->Header.SubType != 0x0a) ||
      ...
      if (TerminalTypeFromGuid (&Node->Guid) == (sizeof (mTerminalType) / sizeof ((mTerminalType)[0]))) {
        return ((RETURN_STATUS)(0x8000000000000000ULL | (3)));
      }
    }
  }
...
# 278 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Console/TerminalDxe/Terminal.c"
EFI_STATUS
TerminalFreeNotifyList (
  LIST_ENTRY *ListHead
  )
{
  ...
  while (!IsListEmpty (ListHead)) {
    NotifyNode = (((TERMINAL_CONSOLE_IN_EX_NOTIFY *) (void *) ((CHAR8 *) (ListHead->ForwardLink) - ((UINTN) __builtin_offsetof(TERMINAL_CONSOLE_IN_EX_NOTIFY, NotifyEntry))))->Signature != ((('t') | ('m' << 8)) | ((('e') | ('n' << 8)) << 16))) ? ((void *) 0) : ((TERMINAL_CONSOLE_IN_EX_NOTIFY *) (void *) ((CHAR8 *) (ListHead->ForwardLink) - ((UINTN) __builtin_offsetof(TERMINAL_CONSOLE_IN_EX_NOTIFY, NotifyEntry))))
...
# 314 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Console/TerminalDxe/Terminal.c"
TERMINAL_CONSOLE_MODE_DATA *
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (TextModeCount != ((void *) 0)); } } while (((BOOLEAN)(0==1)));

  TextModeData = AllocateCopyPool (sizeof (mTerminalConsoleModeData), mTerminalConsoleModeData);
  if (TextModeData == ((void *) 0)) {
    return ((void *) 0);
  }

  *TextModeCount = (sizeof (mTerminalConsoleModeData) / sizeof ((mTerminalConsoleModeData)[0]));

  do { if (DebugCodeEnabled ()) { do { } while (((BOOLEAN)(0==1)));
  INT32 Index;

  for (Index = 0; Index < *TextModeCount; Index++) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Terminal - Mode %d, Column = %d, Row = %d\n", Index, TextModeData[Index].Columns, TextModeData[Index].Rows); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
...
# 414 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Console/TerminalDxe/Terminal.c"
EFI_STATUS
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (TerminalType < (sizeof (mTerminalType) / sizeof ((mTerminalType)[0]))); } } while (((BOOLEAN)(0==1)));
  Table = ((void *) 0);
...
# 468 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Console/TerminalDxe/Terminal.c"
EFI_STATUS
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) ((Status == (RETURN_STATUS)(0)) || (Status == ((RETURN_STATUS)(0x8000000000000000ULL | (20))))); } } while (((BOOLEAN)(0==1)));
    ...
    if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
      ...
      for (Index = 0; Index < EntryCount; Index++) {
        if ((OpenInfoBuffer[Index].Attributes & 0x00000008) != 0) {
          ...
          if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
            TerminalDevice = (((TERMINAL_DEV *) (void *) ((CHAR8 *) (SimpleTextInput) - ((UINTN) __builtin_offsetof(TERMINAL_DEV, SimpleInput))))->Signature != ((('t') | ('m' << 8)) | ((('n') | ('l' << 8)) << 16))) ? ((void *) 0) : ((TERMINAL_DEV *) (void *) ((CHAR8 *) (SimpleTextInput) - ((UINTN) __builtin_offsetof(TERMINAL_DEV, SimpleInput))));
  ...
  if (RemainingDevicePath == ((void *) 0)) {
    ...
    TerminalDevice->TerminalType = _gPcd_FixedAtBuild_PcdDefaultTerminalType;
  } else {



    do { if (((BOOLEAN)(0==1))) { (void) (!IsDevicePathEnd (RemainingDevicePath)); } } while (((BOOLEAN)(0==1)));
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (TerminalDevice->TerminalType < (sizeof (mTerminalType) / sizeof ((mTerminalType)[0]))); } } while (((BOOLEAN)(0==1)));
  ...
  if (TerminalDevice->TerminalConsoleModeData == ((void *) 0)) {
    goto FreeResources;
  }
  ...
  SimpleTextOutput->Mode->CursorVisible = ((BOOLEAN)(1==1));
  Status = SimpleTextOutput->SetAttribute (SimpleTextOutput, (((0x01 | 0x02 | 0x04)) | ((0x00) << 4)));
  if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    Status = SimpleTextOutput->Reset (SimpleTextOutput, ((BOOLEAN)(0==1)));
  }
  ...
  Status = SimpleTextInput->Reset (SimpleTextInput, ((BOOLEAN)(0==1)));
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    goto ReportError;
  }
...
ReportError:
  (ReportProgressCodeEnabled() && ((0x00000002 | 0x40000000) & 0x000000FF) == 0x00000001) ? ReportStatusCodeWithDevicePath(0x00000002 | 0x40000000,((0x01000000 | 0x00040000) | 0x00000006),ParentDevicePath) : (ReportErrorCodeEnabled() && ((0x00000002 | 0x40000000) & 0x000000FF) == 0x00000002) ? ReportStatusCodeWithDevicePath(0x00000002 | 0x40000000,((0x01000000 | 0x00040000) | 0x00000006),ParentDevicePath) : (ReportDebugCodeEnabled() && ((0x00000002 | 0x40000000) & 0x000000FF) == 0x00000003) ? ReportStatusCodeWithDevicePath(0x00000002 | 0x40000000,((0x01000000 | 0x00040000) | 0x00000006),ParentDevicePath) : ((RETURN_STATUS)(0x8000000000000000ULL | (3)))
...
FreeResources:
  do { if (((BOOLEAN)(0==1))) { (void) (TerminalDevice != ((void *) 0)); } } while (((BOOLEAN)(0==1)));

  if (TerminalDevice->SimpleInput.WaitForKey != ((void *) 0)) {
    gBS->CloseEvent (TerminalDevice->SimpleInput.WaitForKey);
  }

  if (TerminalDevice->SimpleInputEx.WaitForKeyEx != ((void *) 0)) {
    gBS->CloseEvent (TerminalDevice->SimpleInputEx.WaitForKeyEx);
  }

  if (TerminalDevice->KeyNotifyProcessEvent != ((void *) 0)) {
  ...
  if (TerminalDevice->ControllerNameTable != ((void *) 0)) {
    FreeUnicodeStringTable (TerminalDevice->ControllerNameTable);
  }

  if (TerminalDevice->DevicePath != ((void *) 0)) {
...
# 902 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Console/TerminalDxe/Terminal.c"
EFI_STATUS
  ...
  )
{
  ...
  for (Index = 0; Index < NumberOfChildren; Index++) {
    ...
    if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
      TerminalDevice = (((TERMINAL_DEV *) (void *) ((CHAR8 *) (SimpleTextOutput) - ((UINTN) __builtin_offsetof(TERMINAL_DEV, SimpleTextOutput))))->Signature != ((('t') | ('m' << 8)) | ((('n') | ('l' << 8)) << 16))) ? ((void *) 0) : ((TERMINAL_DEV *) (void *) ((CHAR8 *) (SimpleTextOutput) - ((UINTN) __builtin_offsetof(TERMINAL_DEV, SimpleTextOutput))));
...
# 1040 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Console/TerminalDxe/Terminal.c"
BOOLEAN
MatchDevicePaths (
...
# 1079 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Console/TerminalDxe/Terminal.c"
void
TerminalUpdateConsoleDevVariable (
  CHAR16 *VariableName,
  EFI_DEVICE_PATH_PROTOCOL *ParentDevicePath
  )
{
  ...
  Status = GetEfiGlobalVariable2 (VariableName, (void **)&Variable, ((void *) 0));
  ...
  for (TerminalType = 0; TerminalType < (sizeof (mTerminalType) / sizeof ((mTerminalType)[0])); TerminalType++) {
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    ...
    if (SetVariableStatus != ((void *) 0)) {
      ...
      SetVariableStatus->Attributes = 0x00000002 | 0x00000004;
      CopyMem (SetVariableStatus + 1, VariableName, NameSize);
      CopyMem (((UINT8 *)(SetVariableStatus + 1)) + NameSize, Variable, VariableSize);

      (ReportProgressCodeEnabled() && ((0x00000002) & 0x000000FF) == 0x00000001) ? ReportStatusCodeEx(0x00000002,_gPcd_FixedAtBuild_PcdErrorCodeSetVariable,0,((void *) 0),&gEdkiiStatusCodeDataTypeVariableGuid,SetVariableStatus,sizeof (EDKII_SET_VARIABLE_STATUS) + NameSize + VariableSize) : (ReportErrorCodeEnabled() && ((0x00000002) & 0x000000FF) == 0x00000002) ? ReportStatusCodeEx(0x00000002,_gPcd_FixedAtBuild_PcdErrorCodeSetVariable,0,((void *) 0),&gEdkiiStatusCodeDataTypeVariableGuid,SetVariableStatus,sizeof (EDKII_SET_VARIABLE_STATUS) + NameSize + VariableSize) : (ReportDebugCodeEnabled() && ((0x00000002) & 0x000000FF) == 0x00000003) ? ReportStatusCodeEx(0x00000002,_gPcd_FixedAtBuild_PcdErrorCodeSetVariable,0,((void *) 0),&gEdkiiStatusCodeDataTypeVariableGuid,SetVariableStatus,sizeof (EDKII_SET_VARIABLE_STATUS) + NameSize + VariableSize) : ((RETURN_STATUS)(0x8000000000000000ULL | (3)))
...
# 1177 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Console/TerminalDxe/Terminal.c"
void
TerminalRemoveConsoleDevVariable (
  CHAR16 *VariableName,
  EFI_DEVICE_PATH_PROTOCOL *ParentDevicePath
  )
{
  ...
  GetEfiGlobalVariable2 (VariableName, (void **)&Variable, ((void *) 0));
  if (Variable == ((void *) 0)) {
    return;
  }

  FoundOne = ((BOOLEAN)(0==1));
...
# 1298 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Console/TerminalDxe/Terminal.c"
EFI_STATUS
SetTerminalDevicePath (
  TERMINAL_TYPE TerminalType,
  EFI_DEVICE_PATH_PROTOCOL *ParentDevicePath,
  ...
  )
{
  ...
  *TerminalDevicePath = AppendDevicePathNode (
  ...
  if (*TerminalDevicePath == ((void *) 0)) {
    return ((RETURN_STATUS)(0x8000000000000000ULL | (9)));
  }

  return (RETURN_STATUS)(0);
}
# 1338 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Console/TerminalDxe/Terminal.c"
EFI_STATUS
...
# 1375 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Console/TerminalDxe/Terminal.c"
BOOLEAN
IsHotPlugDevice (
  EFI_DEVICE_PATH_PROTOCOL *DevicePath
  )
{
  ...
  while (!IsDevicePathEnd (CheckDevicePath)) {
    ...
    if ((DevicePathType (CheckDevicePath) == 0x03) &&
        ((DevicePathSubType (CheckDevicePath) == 0x05) ||
         (DevicePathSubType (CheckDevicePath) == 0x0f) ||
         (DevicePathSubType (CheckDevicePath) == 0x10)))
    {
    ...
    if ((DevicePathType (CheckDevicePath) == 0x01) &&
        (DevicePathSubType (CheckDevicePath) == 0x02))
    {

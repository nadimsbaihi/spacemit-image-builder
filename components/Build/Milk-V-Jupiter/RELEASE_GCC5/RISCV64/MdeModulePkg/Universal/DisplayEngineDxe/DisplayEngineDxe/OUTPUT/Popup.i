# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/DisplayEngineDxe/Popup.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/DisplayEngineDxe/Popup.c"
# 9 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/DisplayEngineDxe/Popup.c"
...
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/DisplayEngineDxe/Popup.c" 2
  ...
  )
{
  ...
  while (!IsListEmpty (OptionList)) {
    ...
    SelectableOption = (((USER_SELECTABLE_OPTION *) (void *) ((CHAR8 *) (Link) - ((UINTN) __builtin_offsetof(USER_SELECTABLE_OPTION, Link))))->Signature != ((('u') | ('s' << 8)) | ((('s') | ('o' << 8)) << 16))) ? ((void *) 0) : ((USER_SELECTABLE_OPTION *) (void *) ((CHAR8 *) (Link) - ((UINTN) __builtin_offsetof(USER_SELECTABLE_OPTION, Link))));
    RemoveEntryList (&SelectableOption->Link);
    FreePool (SelectableOption);
  }
}
# 46 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/DisplayEngineDxe/Popup.c"
void
...
# 73 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/DisplayEngineDxe/Popup.c"
EFI_STATUS
  ...
  )
{
  ...
  if (UserSelectableOption == ((void *) 0)) {
  ...
  UserSelectableOption->Signature = ((('u') | ('s' << 8)) | ((('s') | ('o' << 8)) << 16));
...
# 152 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/DisplayEngineDxe/Popup.c"
EFI_STATUS
  ...
  )
{
  ...
  OptionRow = gPopupDimensions.BottomRow - 1;
  ...
  switch (PopupType) {
    case EfiHiiPopupTypeOk:
      ...
      OptionCol = StartCol + (ColDimension - StrLen (gOkOption)) / 2;
    ...
    case EfiHiiPopupTypeOkCancel:
      ...
      OptionCol = StartCol + (ColDimension - (StrLen (gOkOption) + StrLen (gCancelOption))) / 3;
      Status = AddOneSelectableOption (PopupType, EfiHiiPopupSelectionOk, gOkOption, OptionCol, OptionRow);
      OptionCol = EndCol - (ColDimension - (StrLen (gOkOption) + StrLen (gCancelOption))) / 3 - (GetStringWidth (gCancelOption) -2) / 2 + 1;
    ...
    case EfiHiiPopupTypeYesNo:
      ...
      OptionCol = StartCol + (ColDimension - (StrLen (gYesOption) + StrLen (gNoOption))) / 3;
      Status = AddOneSelectableOption (PopupType, EfiHiiPopupSelectionYes, gYesOption, OptionCol, OptionRow);
      OptionCol = EndCol - (ColDimension - (StrLen (gYesOption) + StrLen (gNoOption))) / 3 - (GetStringWidth (gNoOption)- 2) / 2 + 1;
    ...
    case EfiHiiPopupTypeYesNoCancel:
      ...
      OptionCol = StartCol + (ColDimension - (StrLen (gYesOption) + StrLen (gNoOption) + StrLen (gCancelOption))) / 4;
      Status = AddOneSelectableOption (PopupType, EfiHiiPopupSelectionYes, gYesOption, OptionCol, OptionRow);
      OptionCol = StartCol + (ColDimension - (GetStringWidth (gNoOption) -2) / 2) / 2;
      Status = AddOneSelectableOption (PopupType, EfiHiiPopupSelectionNo, gNoOption, OptionCol, OptionRow);
      OptionCol = EndCol - (ColDimension - (StrLen (gYesOption) + StrLen (gNoOption) + StrLen (gCancelOption))) / 4 - (GetStringWidth (gCancelOption) - 2) / 2 + 1;
      Status = AddOneSelectableOption (PopupType, EfiHiiPopupSelectionCancel, gCancelOption, OptionCol, OptionRow);
      break;
    default:
      break;
...
# 223 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/DisplayEngineDxe/Popup.c"
void
GetUserSelection (
  EFI_HII_POPUP_TYPE PopupType,
  EFI_HII_POPUP_SELECTION *UserSelection
  )
{
  ...
  do {
    ...
    HighlightOption = (((USER_SELECTABLE_OPTION *) (void *) ((CHAR8 *) (HighlightPos) - ((UINTN) __builtin_offsetof(USER_SELECTABLE_OPTION, Link))))->Signature != ((('u') | ('s' << 8)) | ((('s') | ('o' << 8)) << 16))) ? ((void *) 0) : ((USER_SELECTABLE_OPTION *) (void *) ((CHAR8 *) (HighlightPos) - ((UINTN) __builtin_offsetof(USER_SELECTABLE_OPTION, Link))));
...
# 324 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/DisplayEngineDxe/Popup.c"
void
  ...
  )
{
  ...
  for (StrOffset = 0; String[StrOffset] != 0x0000; StrOffset++) {
...
# 373 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/DisplayEngineDxe/Popup.c"
UINTN
ParseMessageString (
  CHAR16 *InputString,
  CHAR16 **OutputString,
  ...
  )
{
  ...
  *OutputStrWidth = 0;
  ...
  for (StrOffset = 0;
       InputString[*Index + StrOffset] != 0x000D && InputString[*Index + StrOffset] != 0x000A && InputString[*Index + StrOffset] != 0x0000;
       StrOffset++
       )
  {
  }
  ...
  *OutputStrWidth = (GetStringWidth (*OutputString) -2) / 2;
  ...
  if (InputString[*Index + StrOffset] == 0x000A) {
...
# 452 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/DisplayEngineDxe/Popup.c"
void
CalculatePopupPosition (
  EFI_HII_POPUP_TYPE PopupType,
  EFI_SCREEN_DESCRIPTOR *ScreenForPopup
  )
{
  CHAR16 *OutputString;
  UINTN StringIndex;
  ...
  if (PopupType == EfiHiiPopupTypeOk) {
    OptionRowWidth = 2 *2 + StrLen (gOkOption);
  } else if (PopupType == EfiHiiPopupTypeOkCancel) {
    OptionRowWidth = 2 *3 + (StrLen (gOkOption) + StrLen (gCancelOption));
  } else if (PopupType == EfiHiiPopupTypeYesNo) {
    OptionRowWidth = 2 *3 + (StrLen (gYesOption) + StrLen (gNoOption));
  } else if (PopupType == EfiHiiPopupTypeYesNoCancel) {
    OptionRowWidth = 2 *4 + (StrLen (gYesOption) + StrLen (gNoOption) + StrLen (gCancelOption));
  }

  if (OptionRowWidth > gMaxRowWidth) {
    gMaxRowWidth = OptionRowWidth;
  }
# 504 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/DisplayEngineDxe/Popup.c"
  gST->ConOut->QueryMode (gST->ConOut, gST->ConOut->Mode->Mode, &Columns, &Rows);
  gMaxRowWidth = (((gMaxRowWidth) < (Columns - 2 * 1)) ? (gMaxRowWidth) : (Columns - 2 * 1));
  gMesStrLineNum = (((gMesStrLineNum) < (Rows -1 - (1 + 1 + 1) - (1 + 1 + 1))) ? (gMesStrLineNum) : (Rows -1 - (1 + 1 + 1) - (1 + 1 + 1)));




  ScreenForPopup->LeftColumn = (Columns -2 * 1 - gMaxRowWidth) / 2;
  ScreenForPopup->RightColumn = ScreenForPopup->LeftColumn + gMaxRowWidth + 2 * 1 - 1;
  ScreenForPopup->TopRow = (Rows - 1 - (1 + 1 + 1) - (1 + 1 + 1) - gMesStrLineNum) / 2;
  ScreenForPopup->BottomRow = ScreenForPopup->TopRow + gMesStrLineNum + (1 + 1 + 1) + (1 + 1 + 1) - 1;
}
# 530 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/DisplayEngineDxe/Popup.c"
EFI_STATUS
DrawMessageBox (
  EFI_HII_POPUP_STYLE PopupStyle
  )
...
# 686 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/DisplayEngineDxe/Popup.c"
EFI_STATUS
  ...
  )
{
  ...
  if ((HiiHandle == ((void *) 0)) || (Message == 0)) {
    return ((RETURN_STATUS)(0x8000000000000000ULL | (2)));
  }

  gMessageString = HiiGetString (HiiHandle, Message, ((void *) 0));
  if (gMessageString == ((void *) 0)) {
    return ((RETURN_STATUS)(0x8000000000000000ULL | (2)));
  }

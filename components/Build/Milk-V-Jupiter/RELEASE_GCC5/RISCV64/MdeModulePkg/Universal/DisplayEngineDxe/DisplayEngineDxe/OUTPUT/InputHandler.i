# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/DisplayEngineDxe/InputHandler.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/DisplayEngineDxe/InputHandler.c"
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/DisplayEngineDxe/InputHandler.c"
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/DisplayEngineDxe/InputHandler.c" 2
# 20 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/DisplayEngineDxe/InputHandler.c"
void
GetFieldFromOp (
  EFI_IFR_OP_HEADER *OpCode,
  UINTN *Minimum,
...
# 55 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/DisplayEngineDxe/InputHandler.c"
EFI_STATUS
ReadString (
  UI_MENU_OPTION *MenuOption,
  CHAR16 *Prompt,
  ...
  )
{
  ...
  if (Question->OpCode->OpCode == 0x08) {
    IsPassword = ((BOOLEAN)(1==1));
  } else {
    IsPassword = ((BOOLEAN)(0==1));
  }
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (BufferedString); } } while (((BOOLEAN)(0==1)));
  ...
  gST->ConOut->SetAttribute (gST->ConOut, ((0x00) | (((0x01 | 0x02 | 0x04)) << 4)));
    ...
    switch (Key.UnicodeChar) {
      case 0x0000:
        switch (Key.ScanCode) {
          ...
          case 0x0008:
            for (Index = CurrentCursor; StringPtr[Index] != 0x0000; Index++) {
              StringPtr[Index] = StringPtr[Index + 1];
              PrintCharAt (Start + Index + 1, Top + 3, IsPassword && StringPtr[Index] != 0x0000 ? L'*' : StringPtr[Index]);
            }
      ...
      case 0x000D:
        if (GetStringWidth (StringPtr) >= ((Minimum + 1) * sizeof (CHAR16))) {
          ...
          do {
            CreateDialog (&Key, &NullCharacter, gMiniString, gPressEnter, &NullCharacter, ((void *) 0));
      ...
      case 0x0008:
        if ((StringPtr[0] != 0x0000) && (CurrentCursor != 0)) {
      ...
      default:
        ...
        if ((StringPtr[0] == 0x0000) && (Key.UnicodeChar != 0x0008)) {
          StrnCpyS (StringPtr, MaxLen, &Key.UnicodeChar, 1);
          CurrentCursor++;
        } else if ((GetStringWidth (StringPtr) < ((Maximum + 1) * sizeof (CHAR16))) && (Key.UnicodeChar != 0x0008)) {
...
# 324 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/DisplayEngineDxe/InputHandler.c"
void
AdjustQuestionValue (
...
# 391 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/DisplayEngineDxe/InputHandler.c"
void
GetValueFromNum (
  EFI_IFR_OP_HEADER *OpCode,
  BOOLEAN IntInput,
...
# 486 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/DisplayEngineDxe/InputHandler.c"
EFI_STATUS
GetNumericInput (
  UI_MENU_OPTION *MenuOption
  )
{
  ...
  UINTN Row;
  CHAR16 InputText[24];
  CHAR16 FormattedNumber[24 - 1];
  UINT64 PreviousNumber[24 - 3];
  UINTN Count;
  UINTN Loop;
  BOOLEAN ManualInput;
  BOOLEAN HexInput;
  ...
  Maximum = 0;
  NumericOp = ((void *) 0);
  IntInput = ((BOOLEAN)(0==1));
  HexInput = ((BOOLEAN)(0==1));
  Negative = ((BOOLEAN)(0==1));
  ValidateFail = ((BOOLEAN)(0==1));

  Question = MenuOption->ThisTag;
  QuestionValue = &Question->CurrentValue;
  ZeroMem (InputText, 24 * sizeof (CHAR16));





  ManualInput = (BOOLEAN)(gDirection == 0 ? ((BOOLEAN)(1==1)) : ((BOOLEAN)(0==1)));

  if ((Question->OpCode->OpCode == 0x1A) || (Question->OpCode->OpCode == 0x1B)) {
    DateOrTime = ((BOOLEAN)(1==1));
  } else {
    DateOrTime = ((BOOLEAN)(0==1));
  }
  ...
  EraseLen = 0;
  EditValue = 0;
  if (Question->OpCode->OpCode == 0x1A) {
    Step = 1;
    Minimum = 1;
  ...
  } else if (Question->OpCode->OpCode == 0x1B) {
    Step = 1;
    Minimum = 0;
    ...
    do { if (((BOOLEAN)(0==1))) { (void) (Question->OpCode->OpCode == 0x07); } } while (((BOOLEAN)(0==1)));
    NumericOp = (EFI_IFR_NUMERIC *)Question->OpCode;
    GetValueFromNum (Question->OpCode, (NumericOp->Flags & 0x30) == 0, QuestionValue, &EditValue, &Minimum, &Maximum, &Step, &StorageWidth);
    EraseLen = gOptionBlockWidth;
  }

  if ((Question->OpCode->OpCode == 0x07) && (NumericOp != ((void *) 0))) {
    if ((NumericOp->Flags & 0x30) == 0x20) {
      HexInput = ((BOOLEAN)(1==1));
    } else if ((NumericOp->Flags & 0x30) == 0) {



      IntInput = ((BOOLEAN)(1==1));
    }
  }
  ...
  if (ManualInput) {
    if (Question->OpCode->OpCode == 0x07) {
      if (HexInput) {
      ...
      do { if (((BOOLEAN)(0==1))) { (void) (InputWidth + 2 < 24); } } while (((BOOLEAN)(0==1)));
      InputText[InputWidth + 1] = L']';
    ...
    if (Question->OpCode->OpCode == 0x1B) {
      InputWidth = 2;
          ...
          case 0x0003:
            ...
            if ((Step != 0) && !ManualInput) {
              ...
              if (Question->OpCode->OpCode == 0x1A) {
                ...
                if (MenuOption->Sequence == 0) {
                  do { if (((BOOLEAN)(0==1))) { (void) (EraseLen >= 2); } } while (((BOOLEAN)(0==1)));
                  FormattedNumber[EraseLen - 2] = L'/';
                } else if (MenuOption->Sequence == 1) {
                  do { if (((BOOLEAN)(0==1))) { (void) (EraseLen >= 1); } } while (((BOOLEAN)(0==1)));
                  FormattedNumber[EraseLen - 1] = L'/';
                }
              } else if (Question->OpCode->OpCode == 0x1B) {
                UnicodeSPrint (FormattedNumber, 21 * sizeof (CHAR16), L"%02d", (UINT8)EditValue);
              ...
              if (MenuOption->Sequence == 0) {
                PrintCharAt (MenuOption->OptCol, Row, L'[');
...
EnterCarriageReturn:
      ...
      case 0x000D:
        ...
        if (IntInput) {
          ...
          if (Negative) {
            ValidateFail = (INT64)EditValue > (INT64)Maximum ? ((BOOLEAN)(1==1)) : ((BOOLEAN)(0==1));
          } else {
            ValidateFail = (INT64)EditValue < (INT64)Minimum ? ((BOOLEAN)(1==1)) : ((BOOLEAN)(0==1));
          }

          if (ValidateFail) {
            UpdateStatusBar (1, ((BOOLEAN)(1==1)));
            break;
          }
        } else if (EditValue < Minimum) {
          UpdateStatusBar (1, ((BOOLEAN)(1==1)));
      ...
      default:
        if (ManualInput) {
          ...
          if (IntInput) {
            ...
            if (ValidateFail) {
              UpdateStatusBar (1, ((BOOLEAN)(1==1)));
              do { if (((BOOLEAN)(0==1))) { (void) (Count < (sizeof (PreviousNumber) / sizeof ((PreviousNumber)[0]))); } } while (((BOOLEAN)(0==1)));
...
# 1132 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/DisplayEngineDxe/InputHandler.c"
EFI_STATUS
AdjustOptionOrder (
  FORM_DISPLAY_ENGINE_STATEMENT *Question,
  ...
  )
{
  ...
  *PopUpMenuLines = Index;
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (HiiValueArray != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
...
# 1201 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/DisplayEngineDxe/InputHandler.c"
BOOLEAN
IsValuesEqual (
  EFI_IFR_TYPE_VALUE *Value1,
  EFI_IFR_TYPE_VALUE *Value2,
  UINT8 Type
  )
{
  switch (Type) {
...
# 1236 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/DisplayEngineDxe/InputHandler.c"
void
SetValuesByType (
  EFI_IFR_TYPE_VALUE *Dest,
  EFI_IFR_TYPE_VALUE *Source,
  UINT8 Type
  )
{
  switch (Type) {
...
# 1279 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/DisplayEngineDxe/InputHandler.c"
EFI_STATUS
GetSelectionInputPopUp (
  UI_MENU_OPTION *MenuOption
  )
{
  ...
  ShowDownArrow = ((BOOLEAN)(0==1));
  ShowUpArrow = ((BOOLEAN)(0==1));
  ...
  if (Question->OpCode->OpCode == 0x23) {
    ...
    ValueArray = Question->CurrentValue.Buffer;
    ValueType = OneOfOption->OptionOpCode->Type;
    OrderedList = ((BOOLEAN)(1==1));
    OrderList = (EFI_IFR_ORDERED_LIST *)Question->OpCode;
  } else {
    OrderedList = ((BOOLEAN)(0==1));
    OrderList = ((void *) 0);
  }
  ...
  for (Index = 0; Index < PopUpMenuLines; Index++) {
    ...
    if (!OrderedList && (CompareHiiValue (&Question->CurrentValue, &HiiValue, &Result, ((void *) 0)) == (RETURN_STATUS)(0)) && (Result == 0)) {
  ...
  if ((PopUpWidth + 2) > DimensionsWidth) {
    PopUpWidth = DimensionsWidth - 2;
  }

  Start = (DimensionsWidth - PopUpWidth - 2) / 2 + gStatementDimensions.LeftColumn;
  ...
  do {
    ...
    for (Index = TopOptionIndex; (Index < PopUpMenuLines) && (Index2 < Bottom); Index++) {
      ...
      if (StrLen (StringPtr) > (PopUpWidth - 1)) {
        ...
        do { if (((BOOLEAN)(0==1))) { (void) (TempStringPtr != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
    ...
    Key.UnicodeChar = 0x0000;
    if ((gDirection == 0x0001) || (gDirection == 0x0002)) {
      Key.ScanCode = gDirection;
      gDirection = 0;
      goto TheKey;
    }
    ...
    switch (Key.UnicodeChar) {
      ...
      case 0x000D:
        ...
        if (OrderedList) {
          ...
          do { if (((BOOLEAN)(0==1))) { (void) (ReturnValue != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
          Index = 0;
          Link = GetFirstNode (&Question->OptionListHead);
          while (!IsNull (&Question->OptionListHead, Link)) {
            OneOfOption = (((DISPLAY_QUESTION_OPTION *) (void *) ((CHAR8 *) (Link) - ((UINTN) __builtin_offsetof(DISPLAY_QUESTION_OPTION, Link))))->Signature != ((('Q') | ('O' << 8)) | ((('P') | ('T' << 8)) << 16))) ? ((void *) 0) : ((DISPLAY_QUESTION_OPTION *) (void *) ((CHAR8 *) (Link) - ((UINTN) __builtin_offsetof(DISPLAY_QUESTION_OPTION, Link))));

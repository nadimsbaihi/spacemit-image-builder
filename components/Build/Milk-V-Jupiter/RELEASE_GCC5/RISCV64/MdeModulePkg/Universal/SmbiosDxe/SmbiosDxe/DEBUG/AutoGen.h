...
#define STACK_COOKIE_VALUE 0x8025A67E0186E6DBULL
...
#define _PCD_TOKEN_PcdSmbiosVersion  9U
...
#define _PCD_TOKEN_PcdSmbiosDocRev  7U
...
#define _PCD_TOKEN_PcdSmbiosEntryPointProvideMethod  8U
#define _PCD_GET_MODE_32_PcdSmbiosEntryPointProvideMethod  LibPcdGet32(_PCD_TOKEN_PcdSmbiosEntryPointProvideMethod)
#define _PCD_GET_MODE_SIZE_PcdSmbiosEntryPointProvideMethod  LibPcdGetSize(_PCD_TOKEN_PcdSmbiosEntryPointProvideMethod)
#define _PCD_SET_MODE_32_PcdSmbiosEntryPointProvideMethod(Value)  LibPcdSet32(_PCD_TOKEN_PcdSmbiosEntryPointProvideMethod, (Value))
#define _PCD_SET_MODE_32_S_PcdSmbiosEntryPointProvideMethod(Value)  LibPcdSet32S(_PCD_TOKEN_PcdSmbiosEntryPointProvideMethod, (Value))

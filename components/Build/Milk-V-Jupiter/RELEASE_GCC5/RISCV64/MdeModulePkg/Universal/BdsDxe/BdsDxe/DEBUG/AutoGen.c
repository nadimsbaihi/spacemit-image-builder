...
#define _PCD_SIZE_PcdEscEnterBootMenu 1
#define _PCD_GET_MODE_SIZE_PcdEscEnterBootMenu  _PCD_SIZE_PcdEscEnterBootMenu 
#define _PCD_VALUE_PcdEscEnterBootMenu  ((BOOLEAN)0U)
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdEscEnterBootMenu = _PCD_VALUE_PcdEscEnterBootMenu;

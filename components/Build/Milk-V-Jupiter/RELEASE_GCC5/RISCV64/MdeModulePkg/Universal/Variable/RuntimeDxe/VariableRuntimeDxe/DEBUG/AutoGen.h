...
#define STACK_COOKIE_VALUE 0xAABEDDFA407AB5D3ULL
...
#define _PCD_TOKEN_PcdEmuVariableNvModeEnable  3U
#define _PCD_GET_MODE_BOOL_PcdEmuVariableNvModeEnable  LibPcdGetBool(_PCD_TOKEN_PcdEmuVariableNvModeEnable)
#define _PCD_GET_MODE_SIZE_PcdEmuVariableNvModeEnable  LibPcdGetSize(_PCD_TOKEN_PcdEmuVariableNvModeEnable)
#define _PCD_SET_MODE_BOOL_PcdEmuVariableNvModeEnable(Value)  LibPcdSetBool(_PCD_TOKEN_PcdEmuVariableNvModeEnable, (Value))
#define _PCD_SET_MODE_BOOL_S_PcdEmuVariableNvModeEnable(Value)  LibPcdSetBoolS(_PCD_TOKEN_PcdEmuVariableNvModeEnable, (Value))

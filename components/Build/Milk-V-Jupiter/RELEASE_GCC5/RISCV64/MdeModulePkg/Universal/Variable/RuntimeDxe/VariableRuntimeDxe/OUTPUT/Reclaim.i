# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Variable/RuntimeDxe/Reclaim.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Variable/RuntimeDxe/Reclaim.c"
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Variable/RuntimeDxe/Reclaim.c"
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Variable/RuntimeDxe/Reclaim.c" 2
# 29 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Variable/RuntimeDxe/Reclaim.c"
EFI_STATUS
  ...
  )
{
  ...
  *Offset = 0;
  ...
  Status = GetFvbInfoByAddress (Address, ((void *) 0), &Fvb);
...
# 103 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Variable/RuntimeDxe/Reclaim.c"
EFI_STATUS
FtwVariableSpace (
  EFI_PHYSICAL_ADDRESS VariableBase,
  VARIABLE_STORE_HEADER *VariableBuffer
  )
{
  ...
  Status = GetFvbInfoByAddress (VariableBase, &FvbHandle, ((void *) 0));
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    return Status;
  }
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (FtwBufferSize == VariableBuffer->Size); } } while (((BOOLEAN)(0==1)));

# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Variable/RuntimeDxe/VariableLockRequestToLock.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Variable/RuntimeDxe/VariableLockRequestToLock.c"
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Variable/RuntimeDxe/VariableLockRequestToLock.c"
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdePkg/Include/Uefi.h" 1
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Variable/RuntimeDxe/VariableLockRequestToLock.c" 2
...
# 12 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Variable/RuntimeDxe/VariableLockRequestToLock.c" 2
...
# 13 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Variable/RuntimeDxe/VariableLockRequestToLock.c" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Include/Library/VariablePolicyLib.h" 1
# 12 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Include/Library/VariablePolicyLib.h"
...
extern EFI_GUID gEdkiiVariablePolicyProtocolGuid;
# 13 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Include/Library/VariablePolicyLib.h" 2
...
# 14 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Variable/RuntimeDxe/VariableLockRequestToLock.c" 2
...
# 15 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Variable/RuntimeDxe/VariableLockRequestToLock.c" 2
...
extern EFI_GUID gEdkiiVariableLockProtocolGuid;
# 16 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Variable/RuntimeDxe/VariableLockRequestToLock.c" 2
# 40 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Variable/RuntimeDxe/VariableLockRequestToLock.c"
EFI_STATUS
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000002)) { DebugPrint (0x00000002, "!!! DEPRECATED INTERFACE !!! %a() will go away soon!\n", __func__); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000002)) { DebugPrint (0x00000002, "!!! DEPRECATED INTERFACE !!! Please move to use Variable Policy!\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000002)) { DebugPrint (0x00000002, "!!! DEPRECATED INTERFACE !!! Variable: %g %s\n", VendorGuid, VariableName); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  ...
  if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    ...
    if (Status == ((RETURN_STATUS)(0x8000000000000000ULL | (20)))) {
      Status = ValidateSetVariable (VariableName, VendorGuid, 0, 0, ((void *) 0));
      if (Status == ((RETURN_STATUS)(0x8000000000000000ULL | (8)))) {
        do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000002)) { DebugPrint (0x00000002, "  Variable: %g %s is already locked!\n", VendorGuid, VariableName); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
        Status = (RETURN_STATUS)(0);
      } else {
        do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "  Variable: %g %s can not be locked!\n", VendorGuid, VariableName); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "%a - Failed to lock variable %s! %r\n", __func__, VariableName, Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  }

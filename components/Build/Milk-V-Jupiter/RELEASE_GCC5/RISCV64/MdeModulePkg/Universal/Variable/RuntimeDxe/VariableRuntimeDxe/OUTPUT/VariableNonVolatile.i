# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Variable/RuntimeDxe/VariableNonVolatile.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Variable/RuntimeDxe/VariableNonVolatile.c"
# 9 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Variable/RuntimeDxe/VariableNonVolatile.c"
...
# 12 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Variable/RuntimeDxe/VariableNonVolatile.h"
...
# 13 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Variable/RuntimeDxe/VariableNonVolatile.h" 2
...
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Variable/RuntimeDxe/VariableNonVolatile.c" 2
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Variable/RuntimeDxe/VariableNonVolatile.c" 2
  ...
  )
{
  if (_gPcd_FixedAtBuild_PcdHwErrStorageSize != 0) {
    return ((((((_gPcd_FixedAtBuild_PcdMaxVariableSize) > (_gPcd_FixedAtBuild_PcdMaxAuthVariableSize)) ? (_gPcd_FixedAtBuild_PcdMaxVariableSize) : (_gPcd_FixedAtBuild_PcdMaxAuthVariableSize))) > (_gPcd_FixedAtBuild_PcdMaxHardwareErrorVariableSize)) ? ((((_gPcd_FixedAtBuild_PcdMaxVariableSize) > (_gPcd_FixedAtBuild_PcdMaxAuthVariableSize)) ? (_gPcd_FixedAtBuild_PcdMaxVariableSize) : (_gPcd_FixedAtBuild_PcdMaxAuthVariableSize))) : (_gPcd_FixedAtBuild_PcdMaxHardwareErrorVariableSize))


              ;
  } else {
    return (((_gPcd_FixedAtBuild_PcdMaxVariableSize) > (_gPcd_FixedAtBuild_PcdMaxAuthVariableSize)) ? (_gPcd_FixedAtBuild_PcdMaxVariableSize) : (_gPcd_FixedAtBuild_PcdMaxAuthVariableSize));
  }
}
# 44 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Variable/RuntimeDxe/VariableNonVolatile.c"
EFI_STATUS
InitEmuNonVolatileVariableStore (
  EFI_PHYSICAL_ADDRESS *VariableStoreBase
  )
{
  ...
  FullyInitializeStore = ((BOOLEAN)(1==1));

  VariableStoreLength = _gPcd_FixedAtBuild_PcdVariableStoreSize;
  do { if (((BOOLEAN)(0==1))) { (void) (sizeof (VARIABLE_STORE_HEADER) <= VariableStoreLength); } } while (((BOOLEAN)(0==1)));




  if (_gPcd_FixedAtBuild_PcdEmuVariableNvStoreReserved == 0) {
    VariableStore = (VARIABLE_STORE_HEADER *)AllocateRuntimePool (VariableStoreLength);
    if (VariableStore == ((void *) 0)) {
    ...
    VariableStore =
      ...
      _gPcd_FixedAtBuild_PcdEmuVariableNvStoreReserved;
    if ((VariableStore->Size == VariableStoreLength) &&
        ...
        (VariableStore->Format == 0x5a) &&
        (VariableStore->State == 0xfe))
    {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Variable Store reserved at %p appears to be valid\n", VariableStore); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))



          ;
      FullyInitializeStore = ((BOOLEAN)(0==1));
    }
  }
  ...
  *VariableStoreBase = (EFI_PHYSICAL_ADDRESS)(UINTN)VariableStore;
  ...
  HwErrStorageSize = _gPcd_FixedAtBuild_PcdHwErrStorageSize;
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (HwErrStorageSize < (VariableStoreLength - sizeof (VARIABLE_STORE_HEADER))); } } while (((BOOLEAN)(0==1)));
...
# 133 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Variable/RuntimeDxe/VariableNonVolatile.c"
EFI_STATUS
InitRealNonVolatileVariableStore (
  EFI_PHYSICAL_ADDRESS *VariableStoreBase
  )
{
  ...
  mVariableModuleGlobal->FvbInstance = ((void *) 0);
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (NvStorageBase != 0); } } while (((BOOLEAN)(0==1)));
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    ...
    if (GuidHob != ((void *) 0)) {
      FtwLastWriteData = (FAULT_TOLERANT_WRITE_LAST_WRITE_DATA *)(void *)(*(UINT8 **)&(GuidHob) + sizeof (EFI_HOB_GUID_TYPE));
      if (FtwLastWriteData->TargetAddress == NvStorageBase) {
        do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Variable: NV storage is backed up in spare block: 0x%x\n", (UINTN)FtwLastWriteData->SpareAddress); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
                 ...
                 (FtwLastWriteData->TargetAddress < (NvStorageBase + NvStorageSize)))
      {
        ...
        do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Variable: High partial NV storage from offset: %x is backed up in spare block: 0x%x\n", BackUpOffset, (UINTN)FtwLastWriteData->SpareAddress); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  ...
  if ((FvHeader->Signature != ((('_') | ('F' << 8)) | ((('V') | ('H' << 8)) << 16))) || (!CompareGuid (&gEfiSystemNvDataFvGuid, &FvHeader->FileSystemGuid))) {
    FreePool (NvStorageData);
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "Firmware Volume for Variable Store is corrupted\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (sizeof (VARIABLE_STORE_HEADER) <= VariableStoreLength); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { (void) (VariableStore->Size == VariableStoreLength); } } while (((BOOLEAN)(0==1)));
  ...
  if (GetVariableStoreStatus (VariableStore) != EfiValid) {
    FreePool (NvStorageData);
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "Variable Store header is corrupted\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    return ((RETURN_STATUS)(0x8000000000000000ULL | (10)));
  }
  ...
  *VariableStoreBase = (EFI_PHYSICAL_ADDRESS)(UINTN)VariableStore;
  ...
  HwErrStorageSize = _gPcd_FixedAtBuild_PcdHwErrStorageSize;
  MaxUserNvVariableSpaceSize = _gPcd_FixedAtBuild_PcdMaxUserNvVariableSpaceSize;
  BoottimeReservedNvVariableSpaceSize = _gPcd_FixedAtBuild_PcdBoottimeReservedNvVariableSpaceSize;
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (MaxUserNvVariableSpaceSize < (VariableStoreLength - sizeof (VARIABLE_STORE_HEADER) - HwErrStorageSize)); } } while (((BOOLEAN)(0==1)));




  do { if (((BOOLEAN)(0==1))) { (void) (BoottimeReservedNvVariableSpaceSize < (VariableStoreLength - sizeof (VARIABLE_STORE_HEADER) - HwErrStorageSize)); } } while (((BOOLEAN)(0==1)));
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Variable driver common space: 0x%x 0x%x 0x%x\n", mVariableModuleGlobal->CommonVariableSpace, mVariableModuleGlobal->CommonMaxUserVariableSpace, mVariableModuleGlobal->CommonRuntimeVariableSpace); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (GetNonVolatileMaxVariableSize () < (VariableStoreLength - sizeof (VARIABLE_STORE_HEADER))); } } while (((BOOLEAN)(0==1)));

  return (RETURN_STATUS)(0);
}
# 293 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Variable/RuntimeDxe/VariableNonVolatile.c"
EFI_STATUS
InitNonVolatileVariableStore (
  void
  )
{
  ...
  if (LibPcdGetBool(3U)) {
    ...
    mVariableModuleGlobal->VariableGlobal.EmuNvMode = ((BOOLEAN)(1==1));
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Variable driver will work at emulated non-volatile variable mode!\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  } else {
    ...
    mVariableModuleGlobal->VariableGlobal.EmuNvMode = ((BOOLEAN)(0==1));
  }
  ...
  mVariableModuleGlobal->MaxVariableSize = _gPcd_FixedAtBuild_PcdMaxVariableSize;
  mVariableModuleGlobal->MaxAuthVariableSize = ((_gPcd_FixedAtBuild_PcdMaxAuthVariableSize != 0) ? _gPcd_FixedAtBuild_PcdMaxAuthVariableSize : mVariableModuleGlobal->MaxVariableSize);
  ...
  while (IsValidVariableHeader (Variable, GetEndPointer (mNvVariableCache))) {
    ...
    if ((Variable->Attributes & (0x00000001 | 0x00000008)) == (0x00000001 | 0x00000008)) {

# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Variable/RuntimeDxe/Measurement.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Variable/RuntimeDxe/Measurement.c"
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Variable/RuntimeDxe/Measurement.c"
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Variable/RuntimeDxe/Measurement.c" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdePkg/Include/Guid/DeviceAuthentication.h" 1
# 21 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdePkg/Include/Guid/DeviceAuthentication.h"
extern EFI_GUID gEfiDeviceSignatureDatabaseGuid;
# 12 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Variable/RuntimeDxe/Measurement.c" 2
...
#pragma pack()
# 13 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Variable/RuntimeDxe/Measurement.c" 2
...
# 15 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Variable/RuntimeDxe/Measurement.c" 2
...
# 16 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Variable/RuntimeDxe/Measurement.c" 2
...
# 17 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Variable/RuntimeDxe/Measurement.c" 2
...
# 18 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Variable/RuntimeDxe/Measurement.c" 2
...
# 19 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Variable/RuntimeDxe/Measurement.c" 2
...
# 20 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Variable/RuntimeDxe/Measurement.c" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Include/Library/TpmMeasurementLib.h" 1
# 27 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Include/Library/TpmMeasurementLib.h"
EFI_STATUS
...
# 21 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Variable/RuntimeDxe/Measurement.c" 2
...
# 23 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Variable/RuntimeDxe/Measurement.c" 2
...
VARIABLE_TYPE mVariableType[] = {
  ...
  { L"devdb", &gEfiDeviceSignatureDatabaseGuid },
};
...
UINT8 *mSecureBootVarData = ((void *) 0);
UINTN mSecureBootVarDataSize = 0;
# 55 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Variable/RuntimeDxe/Measurement.c"
BOOLEAN
...
# 87 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Variable/RuntimeDxe/Measurement.c"
EFI_STATUS
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) ((VarSize == 0 && VarData == ((void *) 0)) || (VarSize != 0 && VarData != ((void *) 0))); } } while (((BOOLEAN)(0==1)));
  ...
  if (CompareGuid (VendorGuid, &gEfiDeviceSignatureDatabaseGuid)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "VariableDxe: MeasureVariable (Pcr - %x, EventType - %x, ", 7, (UINTN)(((TCG_EVENTTYPE) 0x80000000) + 0xE3)); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "VariableName - %s, VendorGuid - %g)\n", VarName, VendorGuid); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));

    Status = TpmMeasureAndLogData (
               7,
               (((TCG_EVENTTYPE) 0x80000000) + 0xE3),
               VarLog,
               VarLogSize,
               VarLog,
               VarLogSize
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "VariableDxe: MeasureVariable (Pcr - %x, EventType - %x, ", (UINTN)7, (UINTN)(((TCG_EVENTTYPE) 0x80000000) + 1)); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "VariableName - %s, VendorGuid - %g)\n", VarName, VendorGuid); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));

  Status = TpmMeasureAndLogData (
             7,
             (((TCG_EVENTTYPE) 0x80000000) + 1),
             VarLog,
             VarLogSize,
             VarLog,
             VarLogSize
...
# 177 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Variable/RuntimeDxe/Measurement.c"
EFI_STATUS
InternalGetVariable (
  const CHAR16 *Name,
  const EFI_GUID *Guid,
...
# 234 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Variable/RuntimeDxe/Measurement.c"
void
  ...
  )
{
  ...
  if (CompareGuid (VendorGuid, &gEfiDeviceSignatureDatabaseGuid)) {
    if ((_gPcd_FixedAtBuild_PcdTcgPfpMeasurementRevision < 106) ||
        (_gPcd_FixedAtBuild_PcdEnableSpdmDeviceAuthentication == 0))
    {
      return;
    }
  }
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    ...
    if ((StrCmp (VariableName, L"dbt") == 0) &&
        CompareGuid (VendorGuid, &gEfiImageSecurityDatabaseGuid))
    {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Skip measuring variable %s since it's deleted\n", L"dbt"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
      return;
    } else {
      VariableData = ((void *) 0);
      VariableDataSize = 0;
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "MeasureBootPolicyVariable - %r\n", Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
      ...
      CompareGuid (VendorGuid, &gEfiGlobalVariableGuid))
  {
    ...
    do { if (((BOOLEAN)(0==1))) { (void) (mSecureBootVarData != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
    ...
    if (CompareMem (mSecureBootVarData, VariableData, VariableDataSize) != 0) {
      ...
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "%s variable updated according to PK change. Remeasure the value!\n", L"SecureBoot"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
      Status = MeasureVariable (
                 L"SecureBoot",
                 &gEfiGlobalVariableGuid,
                 mSecureBootVarData,
  ...
  )
{
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    ...
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "RecordSecureBootPolicyVarData GetVariable %s Status %x\n", L"SecureBoot", Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  }
}

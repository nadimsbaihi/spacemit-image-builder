# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Variable/RuntimeDxe/VariableRuntimeCache.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Variable/RuntimeDxe/VariableRuntimeCache.c"
# 15 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Variable/RuntimeDxe/VariableRuntimeCache.c"
...
# 16 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Variable/RuntimeDxe/VariableRuntimeCache.c" 2
...
# 17 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Variable/RuntimeDxe/VariableRuntimeCache.c" 2

extern VARIABLE_MODULE_GLOBAL *mVariableModuleGlobal;
extern VARIABLE_STORE_HEADER *mNvVariableCache;
# 28 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Variable/RuntimeDxe/VariableRuntimeCache.c"
EFI_STATUS
FlushPendingRuntimeVariableCacheUpdates (
  void
  )
{
  ...
  if ((VariableRuntimeCacheContext->VariableRuntimeNvCache.Store == ((void *) 0)) ||
      (VariableRuntimeCacheContext->VariableRuntimeVolatileCache.Store == ((void *) 0)) ||
      (VariableRuntimeCacheContext->PendingUpdate == ((void *) 0)))
  {
    return ((RETURN_STATUS)(0x8000000000000000ULL | (3)));
  }

  if (*(VariableRuntimeCacheContext->PendingUpdate)) {
    if ((VariableRuntimeCacheContext->VariableRuntimeHobCache.Store != ((void *) 0)) &&
    ...
    *(VariableRuntimeCacheContext->PendingUpdate) = ((BOOLEAN)(0==1));
  }

  return (RETURN_STATUS)(0);
}
# 113 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Variable/RuntimeDxe/VariableRuntimeCache.c"
EFI_STATUS
SynchronizeRuntimeVariableCache (
  VARIABLE_RUNTIME_CACHE *VariableRuntimeCache,
  UINTN Offset,
...
{
  if (VariableRuntimeCache == ((void *) 0)) {
    return ((RETURN_STATUS)(0x8000000000000000ULL | (2)));
  } else if (VariableRuntimeCache->Store == ((void *) 0)) {


    return (RETURN_STATUS)(0);
  }

  if ((mVariableModuleGlobal->VariableGlobal.VariableRuntimeCacheContext.PendingUpdate == ((void *) 0)) ||
      (mVariableModuleGlobal->VariableGlobal.VariableRuntimeCacheContext.ReadLock == ((void *) 0)))
  {
    return ((RETURN_STATUS)(0x8000000000000000ULL | (3)));
  }
      ...
      (VariableRuntimeCache->PendingUpdateLength > 0))
  {
    VariableRuntimeCache->PendingUpdateLength =
      (UINT32)(
               ((((UINTN)(VariableRuntimeCache->PendingUpdateOffset + VariableRuntimeCache->PendingUpdateLength)) > (Offset + Length)) ? ((UINTN)(VariableRuntimeCache->PendingUpdateOffset + VariableRuntimeCache->PendingUpdateLength)) : (Offset + Length))


                   - ((((UINTN)VariableRuntimeCache->PendingUpdateOffset) < (Offset)) ? ((UINTN)VariableRuntimeCache->PendingUpdateOffset) : (Offset))
               );
    VariableRuntimeCache->PendingUpdateOffset =
      (UINT32)((((UINTN)VariableRuntimeCache->PendingUpdateOffset) < (Offset)) ? ((UINTN)VariableRuntimeCache->PendingUpdateOffset) : (Offset));
  } else {
    VariableRuntimeCache->PendingUpdateLength = (UINT32)Length;
    VariableRuntimeCache->PendingUpdateOffset = (UINT32)Offset;
  }

  *(mVariableModuleGlobal->VariableGlobal.VariableRuntimeCacheContext.PendingUpdate) = ((BOOLEAN)(1==1));

  if (*(mVariableModuleGlobal->VariableGlobal.VariableRuntimeCacheContext.ReadLock) == ((BOOLEAN)(0==1))) {

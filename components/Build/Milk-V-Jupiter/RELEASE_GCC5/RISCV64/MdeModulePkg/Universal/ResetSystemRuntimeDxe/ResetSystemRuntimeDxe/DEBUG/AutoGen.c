...
#define _PCD_VALUE_PcdSpacemitWDTRegBase  0xd4080000ULL
GLOBAL_REMOVE_IF_UNREFERENCED const UINT64 _gPcd_FixedAtBuild_PcdSpacemitWDTRegBase = _PCD_VALUE_PcdSpacemitWDTRegBase;

# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/PCD/Dxe/Pcd.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/PCD/Dxe/Pcd.c"
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/PCD/Dxe/Pcd.c"
...
# 12 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/PCD/Dxe/Pcd.c" 2




EFI_LOCK mPcdDatabaseLock = {16, 4, EfiLockReleased };
...
EFI_HANDLE mPcdHandle = ((void *) 0);
UINTN mVpdBaseAddress = 0;
# 119 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/PCD/Dxe/Pcd.c"
EFI_STATUS
...
# 184 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/PCD/Dxe/Pcd.c"
  mVpdBaseAddress = (UINTN)DxePcdGet64Ex (&gEfiMdeModulePkgTokenSpaceGuid, 196614U);
  if (mVpdBaseAddress == 0) {



    mVpdBaseAddress = (UINTN)_gPcd_FixedAtBuild_PcdVpdBaseAddress;
  }

  return Status;
}
# 208 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/PCD/Dxe/Pcd.c"
EFI_STATUS
...
{
  return DxeGetPcdInfo (((void *) 0), TokenNumber, PcdInfo);
}
# 232 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/PCD/Dxe/Pcd.c"
EFI_STATUS
...
# 250 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/PCD/Dxe/Pcd.c"
UINTN
...
# 280 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/PCD/Dxe/Pcd.c"
void
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "PcdDxe - SkuId 0x%lx is to be set.\n", (SKU_ID)SkuId); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));

  if (SkuId == mPcdDatabase.DxeDb->SystemSkuId) {



    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "PcdDxe - SkuId is same to current system Sku.\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    return;
  }

  if (mPcdDatabase.DxeDb->SystemSkuId != (SKU_ID)0) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "PcdDxe - The SKU Id could be changed only once."); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "PcdDxe - The SKU Id was set to 0x%lx already, it could not be set to 0x%lx any more.", mPcdDatabase.DxeDb->SystemSkuId, (SKU_ID)SkuId); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
  ...
  for (Index = 0; Index < SkuIdTable[0]; Index++) {
    if (SkuId == SkuIdTable[Index + 1]) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "PcdDxe - SkuId is found in SkuId table.\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
      Status = UpdatePcdDatabase (SkuId, ((BOOLEAN)(1==1)));
      if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
        mPcdDatabase.DxeDb->SystemSkuId = (SKU_ID)SkuId;
        do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "PcdDxe - Set current SKU Id to 0x%lx.\n", (SKU_ID)SkuId); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
        return;
      }
    }
  }
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "PcdDxe - Invalid input SkuId, the default SKU Id will be still used.\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  return;
}
# 343 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/PCD/Dxe/Pcd.c"
UINT8
...
# 363 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/PCD/Dxe/Pcd.c"
UINT16
...
# 383 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/PCD/Dxe/Pcd.c"
UINT32
...
# 403 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/PCD/Dxe/Pcd.c"
UINT64
...
# 425 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/PCD/Dxe/Pcd.c"
void *
...
# 447 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/PCD/Dxe/Pcd.c"
BOOLEAN
...
# 467 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/PCD/Dxe/Pcd.c"
UINTN
  ...
  )
{
  ...
  Size = (LocalTokenNumberTable[TokenNumber] & ((0x0U << 24) | (0x1U << 24) | (0x2U << 24) | (0x4U << 24) | (0x8U << 24))) >> 24;
...
# 533 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/PCD/Dxe/Pcd.c"
UINT8
...
# 557 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/PCD/Dxe/Pcd.c"
UINT16
...
# 581 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/PCD/Dxe/Pcd.c"
UINT32
...
# 605 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/PCD/Dxe/Pcd.c"
UINT64
...
# 629 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/PCD/Dxe/Pcd.c"
void *
...
# 653 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/PCD/Dxe/Pcd.c"
BOOLEAN
...
# 675 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/PCD/Dxe/Pcd.c"
UINTN
...
# 702 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/PCD/Dxe/Pcd.c"
EFI_STATUS
...
# 729 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/PCD/Dxe/Pcd.c"
EFI_STATUS
...
# 756 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/PCD/Dxe/Pcd.c"
EFI_STATUS
...
# 783 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/PCD/Dxe/Pcd.c"
EFI_STATUS
...
# 814 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/PCD/Dxe/Pcd.c"
EFI_STATUS
...
{
  return SetWorker (TokenNumber, Buffer, SizeOfBuffer, ((BOOLEAN)(1==1)));
}
# 842 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/PCD/Dxe/Pcd.c"
EFI_STATUS
...
# 870 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/PCD/Dxe/Pcd.c"
EFI_STATUS
...
# 899 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/PCD/Dxe/Pcd.c"
EFI_STATUS
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (!(CompareGuid (Guid, &gEfiMdeModulePkgTokenSpaceGuid) && (ExTokenNumber == 196612U))); } } while (((BOOLEAN)(0==1)))


     ;
  return ExSetValueWorker (ExTokenNumber, Guid, &Value, sizeof (Value));
}
# 935 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/PCD/Dxe/Pcd.c"
EFI_STATUS
...
# 964 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/PCD/Dxe/Pcd.c"
EFI_STATUS
...
# 997 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/PCD/Dxe/Pcd.c"
EFI_STATUS
...
{
  return ExSetWorker (ExTokenNumber, Guid, Buffer, SizeOfBuffer, ((BOOLEAN)(1==1)));
}
# 1027 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/PCD/Dxe/Pcd.c"
EFI_STATUS
...
# 1050 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/PCD/Dxe/Pcd.c"
EFI_STATUS
...
# 1088 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/PCD/Dxe/Pcd.c"
EFI_STATUS
...
# 1140 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/PCD/Dxe/Pcd.c"
EFI_STATUS
...
# 1233 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/PCD/Dxe/Pcd.c"
EFI_GUID **
GetDistinctTokenSpace (
  UINTN *ExMapTableSize,
  DYNAMICEX_MAPPING *ExMapTable,
  EFI_GUID *GuidTable
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (DistinctTokenSpace != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
...
# 1296 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/PCD/Dxe/Pcd.c"
EFI_STATUS
  ...
  )
{
  ...
  if (TmpTokenSpaceBuffer[0] == ((void *) 0)) {

# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Disk/PartitionDxe/Udf.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Disk/PartitionDxe/Udf.c"
# 19 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Disk/PartitionDxe/Udf.c"
...
# 20 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Disk/PartitionDxe/Udf.c" 2
# 31 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Disk/PartitionDxe/Udf.c"
typedef struct {
...
UDF_DEVICE_PATH gUdfDevicePath = {
  {
    ...
    { 0xC5BD4D42, 0x1A76, 0x4996, { 0x89, 0x56, 0x73, 0xCD, 0xA3, 0x26, 0xCD, 0x0A } }
  },
  { 0x7f, 0xFF,
        { sizeof (EFI_DEVICE_PATH_PROTOCOL), 0 }
  }
};
# 69 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Disk/PartitionDxe/Udf.c"
EFI_STATUS
...
# 104 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Disk/PartitionDxe/Udf.c"
  ...
  *LastRecordedBlock = EndLBA;
  ...
  if (BlockSize < sizeof (UDF_ANCHOR_VOLUME_DESCRIPTOR_POINTER)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "%a: Media block size 0x%x unable to hold an AVDP.\n", __func__, BlockSize); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
  ...
  if (DescriptorTag->TagIdentifier == UdfAnchorVolumeDescriptorPointer) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "%a: found AVDP at block %d\n", __func__, 256); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    AvdpsCount++;
  }
  ...
  if ((DescriptorTag->TagIdentifier == UdfAnchorVolumeDescriptorPointer) &&
      (++AvdpsCount == 2))
  {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "%a: found AVDP at block %Ld\n", __func__, EndLBA - 256); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
...
# 212 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Disk/PartitionDxe/Udf.c"
  Size = 512u * BlockSize;

  AnchorPoints = AllocateZeroPool (Size);
  if (AnchorPoints == ((void *) 0)) {
  ...
  Status = DiskIo->ReadDisk (
                     DiskIo,
                     BlockIo->Media->MediaId,
                     MultU64x32 ((UINT64)EndLBA - 512u, BlockSize),
                     Size,
                     AnchorPoints
                     );
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
  ...
  for (Index = 512u - 2; Index >= 0; Index--) {
    ...
    if (DescriptorTag->TagIdentifier == UdfAnchorVolumeDescriptorPointer) {
      ...
      LastAvdpBlockNum = EndLBA - (512u - Index);
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000002)) { DebugPrint (0x00000002, "%a: found AVDP at block %Ld\n", __func__, LastAvdpBlockNum); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))




          ;
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000002)) { DebugPrint (0x00000002, "%a: correcting last block from %Ld to %Ld\n", __func__, EndLBA, LastAvdpBlockNum); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
...
# 293 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Disk/PartitionDxe/Udf.c"
EFI_STATUS
  ...
  )
{
  ...
  for (Offset = ((UINT64)(16ULL << 11)); Offset < EndDiskOffset;
       Offset += ((UINT64)(1ULL << 11)))
  {
...
# 431 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Disk/PartitionDxe/Udf.c"
BOOLEAN
...
# 465 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Disk/PartitionDxe/Udf.c"
...
# 491 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Disk/PartitionDxe/Udf.c"
EFI_STATUS
FindLogicalVolumeLocation (
  ...
  UDF_ANCHOR_VOLUME_DESCRIPTOR_POINTER *AnchorPoint,
  EFI_LBA LastRecordedBlock,
  UINT64 *MainVdsStartBlock,
  UINT64 *MainVdsEndBlock
  )
{
  EFI_STATUS Status;
  UINT32 BlockSize;
...
# 525 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Disk/PartitionDxe/Udf.c"
...
# 588 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Disk/PartitionDxe/Udf.c"
  ...
  if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) && (LvdsCount == 1)) {
...
# 672 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Disk/PartitionDxe/Udf.c"
EFI_STATUS
FindUdfFileSystem (
  EFI_BLOCK_IO_PROTOCOL *BlockIo,
  EFI_DISK_IO_PROTOCOL *DiskIo,
...
# 737 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Disk/PartitionDxe/Udf.c"
EFI_STATUS
PartitionInstallUdfChildHandles (
  EFI_DRIVER_BINDING_PROTOCOL *This,
  EFI_HANDLE Handle,
  ...
  )
{
  ...
  if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "PartitionDxe: El Torito standard found on handle 0x%p.\n", Handle); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    ChildCreated = ((BOOLEAN)(1==1));
  }
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    return (ChildCreated ? (RETURN_STATUS)(0) : ((RETURN_STATUS)(0x8000000000000000ULL | (14))));
  }
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    return (ChildCreated ? (RETURN_STATUS)(0) : Status);
  }

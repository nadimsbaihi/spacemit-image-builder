# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Disk/PartitionDxe/ElTorito.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Disk/PartitionDxe/ElTorito.c"
# 10 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Disk/PartitionDxe/ElTorito.c"
...
# 11 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Disk/PartitionDxe/ElTorito.c" 2
# 29 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Disk/PartitionDxe/ElTorito.c"
EFI_STATUS
PartitionInstallElToritoChildHandles (
  EFI_DRIVER_BINDING_PROTOCOL *This,
  EFI_HANDLE Handle,
  ...
  )
{
  ...
  VolSpaceSize = 0;
# 70 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Disk/PartitionDxe/ElTorito.c"
  if (((0x00000800 % Media->BlockSize) != 0) || (Media->BlockSize > 0x00000800)) {
    return ((RETURN_STATUS)(0x8000000000000000ULL | (14)));
  }

  VolDescriptor = AllocatePool ((UINTN)0x00000800);

  if (VolDescriptor == ((void *) 0)) {
    return ((RETURN_STATUS)(0x8000000000000000ULL | (14)));
  }
  ...
  for (VolDescriptorOffset = 0x00008000;
       VolDescriptorOffset <= MultU64x32 (Media->LastBlock, Media->BlockSize);
       VolDescriptorOffset += 0x00000800)
  {
    ...
    if ((VolDescriptor->Unknown.Type == 0xFF) ||
        (CompareMem (VolDescriptor->Unknown.Id, "CD001", sizeof (VolDescriptor->Unknown.Id)) != 0)
        )
    {
    ...
    if (VolDescriptor->PrimaryVolume.Type == 0x1) {
    ...
    if (CompareMem (VolDescriptor->BootRecordVolume.SystemId, "EL TORITO SPECIFICATION", sizeof ("EL TORITO SPECIFICATION") - 1) != 0) {
      continue;
    }
    ...
    Lba2KB = (INT32)( (((UINT8 *) VolDescriptor->BootRecordVolume.EltCatalog)[0] << 0) | (((UINT8 *) VolDescriptor->BootRecordVolume.EltCatalog)[1] << 8) | (((UINT8 *) VolDescriptor->BootRecordVolume.EltCatalog)[2] << 16) | (((UINT8 *) VolDescriptor->BootRecordVolume.EltCatalog)[3] << 24) );

    if (Lba2KB * (0x00000800 / Media->BlockSize) > Media->LastBlock) {
      continue;
    }
    ...
    Status = DiskIo->ReadDisk (
                       DiskIo,
                       Media->MediaId,
                       MultU64x32 (Lba2KB, 0x00000800),
                       0x00000800,
                       Catalog
                       );
    if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "EltCheckDevice: error reading catalog %r\n", Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
      continue;
    }
    ...
    if ((Catalog->Catalog.Indicator != 0x01) || (Catalog->Catalog.Id55AA != 0xAA55)) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "EltCheckBootCatalog: El Torito boot catalog header IDs not correct\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
      continue;
    }
    ...
    if ((Check & 0xFFFF) != 0) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "EltCheckBootCatalog: El Torito boot catalog header checksum failed\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
      continue;
    }
    ...
    for (Index = 1, BootEntry = 1; Index < MaxIndex; Index += 1) {
      ...
      if ((Catalog->Boot.Indicator != 0x88) || (Catalog->Boot.Lba == 0)) {
        continue;
      }
      ...
      switch (Catalog->Boot.MediaType) {
        ...
        default:
          do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000001)) { DebugPrint (0x00000001, "EltCheckDevice: unsupported El Torito boot media type %x\n", Catalog->Boot.MediaType); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
          SectorCount = 0;
          SubBlockSize = Media->BlockSize;
          break;
      }
      ...
      CdDev.Header.Type = 0x04;
      CdDev.Header.SubType = 0x02;
      ...
      BootEntry++;
      CdDev.PartitionStart = Catalog->Boot.Lba * (0x00000800 / Media->BlockSize);
      if (SectorCount < 2) {



        if (VolSpaceSize * (0x00000800 / Media->BlockSize) > (Media->LastBlock + 1)) {
          CdDev.PartitionSize = (UINT32)(Media->LastBlock - Catalog->Boot.Lba * (0x00000800 / Media->BlockSize) + 1);
        } else {
          CdDev.PartitionSize = (UINT32)(VolSpaceSize - Catalog->Boot.Lba) * (0x00000800 / Media->BlockSize);
        }
      } else {
        CdDev.PartitionSize = DivU64x32 (
                                MultU64x32 (
                                  SectorCount * (0x00000800 / Media->BlockSize),
                                  SubBlockSize
                                  ) + Media->BlockSize - 1,
                                Media->BlockSize
                                );
      ...
      Status = PartitionInstallChildHandle (
                 ...
                 &PartitionInfo,
                 Catalog->Boot.Lba * (0x00000800 / Media->BlockSize),
                 Catalog->Boot.Lba * (0x00000800 / Media->BlockSize) + CdDev.PartitionSize - 1,
                 SubBlockSize,
                 ((void *) 0)
                 );
      if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {

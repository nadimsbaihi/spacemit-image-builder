# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Disk/UdfDxe/File.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Disk/UdfDxe/File.c"
# 10 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Disk/UdfDxe/File.c"
...
# 11 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Disk/UdfDxe/File.c" 2
...
# 51 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Disk/UdfDxe/File.c"
EFI_STATUS
  ...
  )
{
  ...
  if ((This == ((void *) 0)) || (Root == ((void *) 0))) {
    Status = ((RETURN_STATUS)(0x8000000000000000ULL | (2)));
    goto Error_Invalid_Params;
  }

  PrivFsData = (((PRIVATE_UDF_SIMPLE_FS_DATA *) (void *) ((CHAR8 *) (This) - ((UINTN) __builtin_offsetof(PRIVATE_UDF_SIMPLE_FS_DATA, SimpleFs))))->Signature != ((('U') | ('d' << 8)) | ((('f') | ('s' << 8)) << 16))) ? ((void *) 0) : ((PRIVATE_UDF_SIMPLE_FS_DATA *) (void *) ((CHAR8 *) (This) - ((UINTN) __builtin_offsetof(PRIVATE_UDF_SIMPLE_FS_DATA, SimpleFs))));
...
# 162 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Disk/UdfDxe/File.c"
EFI_STATUS
  ...
  )
{
  ...
  if ((This == ((void *) 0)) || (NewHandle == ((void *) 0)) || (FileName == ((void *) 0))) {
    Status = ((RETURN_STATUS)(0x8000000000000000ULL | (2)));
    goto Error_Invalid_Params;
  }

  if (OpenMode != 0x0000000000000001ULL) {
    Status = ((RETURN_STATUS)(0x8000000000000000ULL | (8)));
    goto Error_Invalid_Params;
  }

  PrivFileData = (((PRIVATE_UDF_FILE_DATA *) (void *) ((CHAR8 *) (This) - ((UINTN) __builtin_offsetof(PRIVATE_UDF_FILE_DATA, FileIo))))->Signature != ((('U') | ('d' << 8)) | ((('f') | ('f' << 8)) << 16))) ? ((void *) 0) : ((PRIVATE_UDF_FILE_DATA *) (void *) ((CHAR8 *) (This) - ((UINTN) __builtin_offsetof(PRIVATE_UDF_FILE_DATA, FileIo))));

  PrivFsData = (((PRIVATE_UDF_SIMPLE_FS_DATA *) (void *) ((CHAR8 *) (PrivFileData->SimpleFs) - ((UINTN) __builtin_offsetof(PRIVATE_UDF_SIMPLE_FS_DATA, SimpleFs))))->Signature != ((('U') | ('d' << 8)) | ((('f') | ('s' << 8)) << 16))) ? ((void *) 0) : ((PRIVATE_UDF_SIMPLE_FS_DATA *) (void *) ((CHAR8 *) (PrivFileData->SimpleFs) - ((UINTN) __builtin_offsetof(PRIVATE_UDF_SIMPLE_FS_DATA, SimpleFs))));




  if (*FileName == L'\\') {
    StrCpyS (FilePath, 512, FileName);
  } else {
    StrCpyS (FilePath, 512, PrivFileData->AbsoluteFileName);
    StrCatS (FilePath, 512, L"\\");
    StrCatS (FilePath, 512, FileName);
  }
  ...
  Status = FindFile (
             ...
             FilePath,
             (PrivFileData)->Root,
             ((PrivFileData)->IsRootDirectory ? (PrivFileData)->Root : &(PrivFileData)->File),
             &((PrivFileData)->IsRootDirectory ? (PrivFileData)->Root : &(PrivFileData)->File)->FileIdentifierDesc->Icb,
             &File
             );
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
  ...
  NewPrivFileData->IsRootDirectory = ((BOOLEAN)(0==1));

  StrCpyS (NewPrivFileData->AbsoluteFileName, 512, FilePath);
  FileName = NewPrivFileData->AbsoluteFileName;

  while ((TempFileName = StrStr (FileName, L"\\")) != ((void *) 0)) {
    FileName = TempFileName + 1;
  }

  StrCpyS (NewPrivFileData->FileName, 128, FileName);
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "%a: GetFileSize() fails with status - %r.\n", __func__, Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
...
# 315 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Disk/UdfDxe/File.c"
EFI_STATUS
  ...
  )
{
  ...
  if ((This == ((void *) 0)) || (BufferSize == ((void *) 0)) || ((*BufferSize != 0) &&
                                                 (Buffer == ((void *) 0))))
  {
    Status = ((RETURN_STATUS)(0x8000000000000000ULL | (2)));
    goto Error_Invalid_Params;
  ...
  NewFileIdentifierDesc = ((void *) 0);
  NewFileEntryData = ((void *) 0);

  Parent = ((PrivFileData)->IsRootDirectory ? (PrivFileData)->Root : &(PrivFileData)->File);

  Status = ((RETURN_STATUS)(0x8000000000000000ULL | (10)));

  if ((BOOLEAN)(!(BOOLEAN)((Parent->FileIdentifierDesc)->FileCharacteristics & (1 << 1)) && !(BOOLEAN)((Parent->FileIdentifierDesc)->FileCharacteristics & (1 << 3)))) {
    ...
    do { if (((BOOLEAN)(0==1))) { (void) (BufferSizeUint64 <= ((UINTN)0xFFFFFFFFFFFFFFFFULL)); } } while (((BOOLEAN)(0==1)));
    *BufferSize = (UINTN)BufferSizeUint64;
  } else if ((BOOLEAN)((Parent->FileIdentifierDesc)->FileCharacteristics & (1 << 1))) {
...
# 429 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Disk/UdfDxe/File.c"
      do { if (((BOOLEAN)(0==1))) { (void) (NewFileIdentifierDesc != ((void *) 0)); } } while (((BOOLEAN)(0==1)));

      if (!(BOOLEAN)((NewFileIdentifierDesc)->FileCharacteristics & (1 << 3))) {
        break;
      }
    ...
    do { if (((BOOLEAN)(0==1))) { (void) (NewFileEntryData != ((void *) 0)); } } while (((BOOLEAN)(0==1)));

    if ((UDF_FILE_ENTRY_TYPE)( ((UDF_DESCRIPTOR_TAG *)(NewFileEntryData))->TagIdentifier == UdfFileEntry ? ((UDF_FILE_ENTRY *)(NewFileEntryData))->IcbTag.FileType : ((UDF_EXTENDED_FILE_ENTRY *)(NewFileEntryData))->IcbTag.FileType) == UdfFileEntrySymlink) {
      ...
      Status = GetFileNameFromFid (NewFileIdentifierDesc, (sizeof (FileName) / sizeof ((FileName)[0])), FileName);
      if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
      ...
      Status = GetFileNameFromFid (FoundFile.FileIdentifierDesc, (sizeof (FileName) / sizeof ((FileName)[0])), FileName);
      if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
        goto Error_Get_FileName;
      }
    }
    ...
    PrivFileData->FilePosition++;
    Status = (RETURN_STATUS)(0);
  } else if ((BOOLEAN)((Parent->FileIdentifierDesc)->FileCharacteristics & (1 << 2))) {
...
Error_Resolve_Symlink:
  if (NewFileEntryData != ((void *) 0)) {
    FreePool (NewFileEntryData);
  }

Error_Find_Fe:
  if (NewFileIdentifierDesc != ((void *) 0)) {
    FreePool ((void *)NewFileIdentifierDesc);
  }
...
# 546 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Disk/UdfDxe/File.c"
EFI_STATUS
  ...
  )
{
  ...
  if (!PrivFileData->IsRootDirectory) {
    ...
    if (PrivFileData->ReadDirInfo.DirectoryData != ((void *) 0)) {
...
# 593 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Disk/UdfDxe/File.c"
EFI_STATUS
...
# 631 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Disk/UdfDxe/File.c"
EFI_STATUS
...
# 652 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Disk/UdfDxe/File.c"
EFI_STATUS
  ...
  )
{
  ...
  if ((This == ((void *) 0)) || (Position == ((void *) 0))) {
    return ((RETURN_STATUS)(0x8000000000000000ULL | (2)));
  }
  ...
  if ((BOOLEAN)((PrivFileData->File.FileIdentifierDesc)->FileCharacteristics & (1 << 1))) {
    return ((RETURN_STATUS)(0x8000000000000000ULL | (3)));
  }
...
# 693 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Disk/UdfDxe/File.c"
EFI_STATUS
  ...
  )
{
  ...
  FileIdentifierDesc = ((PrivFileData)->IsRootDirectory ? (PrivFileData)->Root : &(PrivFileData)->File)->FileIdentifierDesc;
  do { if (((BOOLEAN)(0==1))) { (void) (FileIdentifierDesc != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
  if ((BOOLEAN)((FileIdentifierDesc)->FileCharacteristics & (1 << 1))) {
  ...
  } else if ((BOOLEAN)(!(BOOLEAN)((FileIdentifierDesc)->FileCharacteristics & (1 << 1)) && !(BOOLEAN)((FileIdentifierDesc)->FileCharacteristics & (1 << 3)))) {
...
# 762 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Disk/UdfDxe/File.c"
EFI_STATUS
  ...
  )
{
  ...
  if ((This == ((void *) 0)) || (InformationType == ((void *) 0)) || (BufferSize == ((void *) 0)) ||
      ((*BufferSize != 0) && (Buffer == ((void *) 0))))
  {
    return ((RETURN_STATUS)(0x8000000000000000ULL | (2)));
  }
  ...
  if (CompareGuid (InformationType, &gEfiFileInfoGuid)) {
    ...
    Status = GetVolumeLabel (&PrivFsData->Volume, (sizeof (VolumeLabel) / sizeof ((VolumeLabel)[0])), VolumeLabel);
    if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
      return Status;
    }
    ...
    StrCpyS (
      ...
      (*BufferSize - ((UINTN) __builtin_offsetof(EFI_FILE_SYSTEM_INFO, VolumeLabel))) / sizeof (CHAR16),
      VolumeLabel
      );
    ...
    FileSystemInfo->ReadOnly = ((BOOLEAN)(1==1));
    ...
    *BufferSize = FileSystemInfoLength;
    ...
    StrCpyS (
      ...
      (*BufferSize - ((UINTN) __builtin_offsetof(EFI_FILE_SYSTEM_VOLUME_LABEL, VolumeLabel))) / sizeof (CHAR16),
      VolumeLabel
      );
    Status = (RETURN_STATUS)(0);
  }
...
# 883 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Disk/UdfDxe/File.c"
EFI_STATUS
...
# 910 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Disk/UdfDxe/File.c"
EFI_STATUS

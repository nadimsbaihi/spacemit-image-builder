# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Disk/PartitionDxe/Mbr.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Disk/PartitionDxe/Mbr.c"
# 21 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Disk/PartitionDxe/Mbr.c"
...
# 22 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Disk/PartitionDxe/Mbr.c" 2
# 33 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Disk/PartitionDxe/Mbr.c"
BOOLEAN
PartitionValidMbr (
  ...
  )
{
  ...
  MbrValid = ((BOOLEAN)(0==1));
  for (Index1 = 0; Index1 < 4; Index1++) {
    if ((Mbr->Partition[Index1].OSIndicator == 0x00) || ((UINT32)( (((UINT8 *) Mbr->Partition[Index1].SizeInLBA)[0] << 0) | (((UINT8 *) Mbr->Partition[Index1].SizeInLBA)[1] << 8) | (((UINT8 *) Mbr->Partition[Index1].SizeInLBA)[2] << 16) | (((UINT8 *) Mbr->Partition[Index1].SizeInLBA)[3] << 24) ) == 0)) {
      continue;
    }

    MbrValid = ((BOOLEAN)(1==1));
    StartingLBA = (UINT32)( (((UINT8 *) Mbr->Partition[Index1].StartingLBA)[0] << 0) | (((UINT8 *) Mbr->Partition[Index1].StartingLBA)[1] << 8) | (((UINT8 *) Mbr->Partition[Index1].StartingLBA)[2] << 16) | (((UINT8 *) Mbr->Partition[Index1].StartingLBA)[3] << 24) );
    EndingLBA = StartingLBA + (UINT32)( (((UINT8 *) Mbr->Partition[Index1].SizeInLBA)[0] << 0) | (((UINT8 *) Mbr->Partition[Index1].SizeInLBA)[1] << 8) | (((UINT8 *) Mbr->Partition[Index1].SizeInLBA)[2] << 16) | (((UINT8 *) Mbr->Partition[Index1].SizeInLBA)[3] << 24) ) - 1;
    if (EndingLBA > LastLba) {
# 75 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Disk/PartitionDxe/Mbr.c"
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "PartitionValidMbr: Bad MBR partition size EndingLBA(%1x) > LastLBA(%1x)\n", EndingLBA, LastLba); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));

      return ((BOOLEAN)(0==1));
    }

    for (Index2 = Index1 + 1; Index2 < 4; Index2++) {
      if ((Mbr->Partition[Index2].OSIndicator == 0x00) || ((UINT32)( (((UINT8 *) Mbr->Partition[Index2].SizeInLBA)[0] << 0) | (((UINT8 *) Mbr->Partition[Index2].SizeInLBA)[1] << 8) | (((UINT8 *) Mbr->Partition[Index2].SizeInLBA)[2] << 16) | (((UINT8 *) Mbr->Partition[Index2].SizeInLBA)[3] << 24) ) == 0)) {
        continue;
      }

      NewEndingLBA = (UINT32)( (((UINT8 *) Mbr->Partition[Index2].StartingLBA)[0] << 0) | (((UINT8 *) Mbr->Partition[Index2].StartingLBA)[1] << 8) | (((UINT8 *) Mbr->Partition[Index2].StartingLBA)[2] << 16) | (((UINT8 *) Mbr->Partition[Index2].StartingLBA)[3] << 24) ) + (UINT32)( (((UINT8 *) Mbr->Partition[Index2].SizeInLBA)[0] << 0) | (((UINT8 *) Mbr->Partition[Index2].SizeInLBA)[1] << 8) | (((UINT8 *) Mbr->Partition[Index2].SizeInLBA)[2] << 16) | (((UINT8 *) Mbr->Partition[Index2].SizeInLBA)[3] << 24) ) - 1;
      if ((NewEndingLBA >= StartingLBA) && ((UINT32)( (((UINT8 *) Mbr->Partition[Index2].StartingLBA)[0] << 0) | (((UINT8 *) Mbr->Partition[Index2].StartingLBA)[1] << 8) | (((UINT8 *) Mbr->Partition[Index2].StartingLBA)[2] << 16) | (((UINT8 *) Mbr->Partition[Index2].StartingLBA)[3] << 24) ) <= EndingLBA)) {
...
# 117 "/home/kapoagaeming/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/Disk/PartitionDxe/Mbr.c"
EFI_STATUS
PartitionInstallMbrChildHandles (
  EFI_DRIVER_BINDING_PROTOCOL *This,
  EFI_HANDLE Handle,
  ...
  )
{
  ...
  Found = ((RETURN_STATUS)(0x8000000000000000ULL | (14)));
  ...
  if (LastDevicePathNode != ((void *) 0)) {
    if ((DevicePathType (LastDevicePathNode) == 0x04) &&
        (DevicePathSubType (LastDevicePathNode) == 0x01)
        )
    {
  ...
  if (LastDevicePathNode == ((void *) 0)) {
    ...
    for (Index = 0; Index < 4; Index++) {
      if ((Mbr->Partition[Index].OSIndicator == 0x00) || ((UINT32)( (((UINT8 *) Mbr->Partition[Index].SizeInLBA)[0] << 0) | (((UINT8 *) Mbr->Partition[Index].SizeInLBA)[1] << 8) | (((UINT8 *) Mbr->Partition[Index].SizeInLBA)[2] << 16) | (((UINT8 *) Mbr->Partition[Index].SizeInLBA)[3] << 24) ) == 0)) {
      ...
      HdDev.PartitionStart = (UINT32)( (((UINT8 *) Mbr->Partition[Index].StartingLBA)[0] << 0) | (((UINT8 *) Mbr->Partition[Index].StartingLBA)[1] << 8) | (((UINT8 *) Mbr->Partition[Index].StartingLBA)[2] << 16) | (((UINT8 *) Mbr->Partition[Index].StartingLBA)[3] << 24) );
      HdDev.PartitionSize = (UINT32)( (((UINT8 *) Mbr->Partition[Index].SizeInLBA)[0] << 0) | (((UINT8 *) Mbr->Partition[Index].SizeInLBA)[1] << 8) | (((UINT8 *) Mbr->Partition[Index].SizeInLBA)[2] << 16) | (((UINT8 *) Mbr->Partition[Index].SizeInLBA)[3] << 24) );
      ...
      PartitionInfo.Type = 0x01;
      if (Mbr->Partition[Index].OSIndicator == 0xEF) {
      ...
      Status = PartitionInstallChildHandle (
                 ...
                 512,
                 ((Mbr->Partition[Index].OSIndicator == 0xEF) ? &gEfiPartTypeSystemPartGuid : ((void *) 0))
                 );

      if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
        Found = (RETURN_STATUS)(0);
      }
    }
  } else {
    ...
    do {
      ...
      if ((UINT32)( (((UINT8 *) Mbr->Partition[0].SizeInLBA)[0] << 0) | (((UINT8 *) Mbr->Partition[0].SizeInLBA)[1] << 8) | (((UINT8 *) Mbr->Partition[0].SizeInLBA)[2] << 16) | (((UINT8 *) Mbr->Partition[0].SizeInLBA)[3] << 24) ) == 0) {
        break;
      }

      if ((Mbr->Partition[0].OSIndicator == 0x05) ||
          (Mbr->Partition[0].OSIndicator == 0x0F))
      {
        ExtMbrStartingLba = (UINT32)( (((UINT8 *) Mbr->Partition[0].StartingLBA)[0] << 0) | (((UINT8 *) Mbr->Partition[0].StartingLBA)[1] << 8) | (((UINT8 *) Mbr->Partition[0].StartingLBA)[2] << 16) | (((UINT8 *) Mbr->Partition[0].StartingLBA)[3] << 24) );
      ...
      HdDev.PartitionStart = (UINT32)( (((UINT8 *) Mbr->Partition[0].StartingLBA)[0] << 0) | (((UINT8 *) Mbr->Partition[0].StartingLBA)[1] << 8) | (((UINT8 *) Mbr->Partition[0].StartingLBA)[2] << 16) | (((UINT8 *) Mbr->Partition[0].StartingLBA)[3] << 24) ) + ExtMbrStartingLba + ParentHdDev.PartitionStart;
      HdDev.PartitionSize = (UINT32)( (((UINT8 *) Mbr->Partition[0].SizeInLBA)[0] << 0) | (((UINT8 *) Mbr->Partition[0].SizeInLBA)[1] << 8) | (((UINT8 *) Mbr->Partition[0].SizeInLBA)[2] << 16) | (((UINT8 *) Mbr->Partition[0].SizeInLBA)[3] << 24) );
      ...
      *((UINT32 *)&HdDev.Signature[0]) = 0;
      ...
      PartitionInfo.Revision = 0x0001000;
      PartitionInfo.Type = 0x01;
      if (Mbr->Partition[0].OSIndicator == 0xEF) {
        PartitionInfo.System = 1;
      }
      ...
      Status = PartitionInstallChildHandle (
                 ...
                 512,
                 ((Mbr->Partition[0].OSIndicator == 0xEF) ? &gEfiPartTypeSystemPartGuid : ((void *) 0))
                 );
      if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
        Found = (RETURN_STATUS)(0);
      }

      if ((Mbr->Partition[1].OSIndicator != 0x05) &&
          (Mbr->Partition[1].OSIndicator != 0x0F)
          )
      {
        break;
      }

      ExtMbrStartingLba = (UINT32)( (((UINT8 *) Mbr->Partition[1].StartingLBA)[0] << 0) | (((UINT8 *) Mbr->Partition[1].StartingLBA)[1] << 8) | (((UINT8 *) Mbr->Partition[1].StartingLBA)[2] << 16) | (((UINT8 *) Mbr->Partition[1].StartingLBA)[3] << 24) );

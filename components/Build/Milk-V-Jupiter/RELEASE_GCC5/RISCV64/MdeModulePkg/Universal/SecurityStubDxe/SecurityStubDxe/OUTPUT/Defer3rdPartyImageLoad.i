# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/SecurityStubDxe/Defer3rdPartyImageLoad.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/SecurityStubDxe/Defer3rdPartyImageLoad.c"
...
# 19 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/SecurityStubDxe/Defer3rdPartyImageLoad.h" 2
...
# 23 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/SecurityStubDxe/Defer3rdPartyImageLoad.h" 2
...
# 9 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/SecurityStubDxe/Defer3rdPartyImageLoad.c" 2
...
BOOLEAN mImageLoadedAfterEndOfDxe = ((BOOLEAN)(0==1));
...
# 47 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/SecurityStubDxe/Defer3rdPartyImageLoad.c"
BOOLEAN
FileFromFv (
  const EFI_DEVICE_PATH_PROTOCOL *File
  )
...
# 91 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/SecurityStubDxe/Defer3rdPartyImageLoad.c"
DEFERRED_3RD_PARTY_IMAGE_INFO *
LookupImage (
  const EFI_DEVICE_PATH_PROTOCOL *ImageDevicePath,
  BOOLEAN BootOption
  )
{
  UINTN Index;
  ...
  for (Index = 0; Index < mDeferred3rdPartyImage.Count; Index++) {
    if (CompareMem (ImageDevicePath, mDeferred3rdPartyImage.ImageInfo[Index].ImageDevicePath, DevicePathSize) == 0) {
      do { if (((BOOLEAN)(0==1))) { (void) (mDeferred3rdPartyImage.ImageInfo[Index].BootOption == BootOption); } } while (((BOOLEAN)(0==1)));
...
# 119 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/SecurityStubDxe/Defer3rdPartyImageLoad.c"
void
QueueImage (
  const EFI_DEVICE_PATH_PROTOCOL *ImageDevicePath,
  BOOLEAN BootOption
  )
{
  ...
  if (ImageInfo->ImageDevicePath == ((void *) 0)) {
    return;
  }

  ImageInfo->BootOption = BootOption;
  ImageInfo->Loaded = ((BOOLEAN)(0==1));
  mDeferred3rdPartyImage.Count++;
}
# 182 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/SecurityStubDxe/Defer3rdPartyImageLoad.c"
EFI_STATUS
  ...
  )
{
  ...
  if ((This == ((void *) 0)) || (ImageSize == ((void *) 0)) || (Image == ((void *) 0))) {
    return ((RETURN_STATUS)(0x8000000000000000ULL | (2)));
  }

  if ((ImageDevicePath == ((void *) 0)) || (BootOption == ((void *) 0))) {
    return ((RETURN_STATUS)(0x8000000000000000ULL | (2)));
  }
...
# 245 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/SecurityStubDxe/Defer3rdPartyImageLoad.c"
void
...
# 267 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/SecurityStubDxe/Defer3rdPartyImageLoad.c"
void
  ...
  )
{
  ...
  Status = gBS->LocateProtocol (&gEfiDxeSmmReadyToLockProtocolGuid, ((void *) 0), &Interface);
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    return;
  }
  ...
  if (mImageLoadedAfterEndOfDxe) {
    ...
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "[Security] 3rd party images must be dispatched after DxeSmmReadyToLock Protocol installation!\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))


        ;
    (ReportProgressCodeEnabled() && ((0x00000002 | 0x90000000) & 0x000000FF) == 0x00000001) ? ReportStatusCode(0x00000002 | 0x90000000,((0x03000000 | 0x00050000) | 0x00000007)) : (ReportErrorCodeEnabled() && ((0x00000002 | 0x90000000) & 0x000000FF) == 0x00000002) ? ReportStatusCode(0x00000002 | 0x90000000,((0x03000000 | 0x00050000) | 0x00000007)) : (ReportDebugCodeEnabled() && ((0x00000002 | 0x90000000) & 0x000000FF) == 0x00000003) ? ReportStatusCode(0x00000002 | 0x90000000,((0x03000000 | 0x00050000) | 0x00000007)) : ((RETURN_STATUS)(0x8000000000000000ULL | (3)))
...
# 313 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/SecurityStubDxe/Defer3rdPartyImageLoad.c"
EFI_STATUS
Defer3rdPartyImageLoad (
  const EFI_DEVICE_PATH_PROTOCOL *File,
  BOOLEAN BootPolicy
  )
{
  ...
  DevicePathStr = ConvertDevicePathToText (File, ((BOOLEAN)(0==1)), ((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "[Security] 3rd party image[%p] %s EndOfDxe: %s.\n", ImageInfo, mEndOfDxe ? L"can be loaded after" : L"is deferred to load before", DevicePathStr); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
  ...
  if (mEndOfDxe) {
    mImageLoadedAfterEndOfDxe = ((BOOLEAN)(1==1));




    if (ImageInfo != ((void *) 0)) {
      ImageInfo->Loaded = ((BOOLEAN)(1==1));
    }

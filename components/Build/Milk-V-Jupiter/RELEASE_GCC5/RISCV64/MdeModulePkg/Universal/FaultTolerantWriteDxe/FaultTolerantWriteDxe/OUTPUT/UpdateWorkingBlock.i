# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/FaultTolerantWriteDxe/UpdateWorkingBlock.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/FaultTolerantWriteDxe/UpdateWorkingBlock.c"
# 10 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/FaultTolerantWriteDxe/UpdateWorkingBlock.c"
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/FaultTolerantWriteDxe/UpdateWorkingBlock.c" 2

EFI_FAULT_TOLERANT_WORKING_BLOCK_HEADER mWorkingBlockHeader = { { 0x0, 0x0, 0x0, {0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0} }, 0, 0, 0, 0, { 0, 0, 0 }, 0 };
# 23 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/FaultTolerantWriteDxe/UpdateWorkingBlock.c"
void
InitializeLocalWorkSpaceHeader (
  UINTN WorkSpaceLength
  )
...
# 61 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/FaultTolerantWriteDxe/UpdateWorkingBlock.c"
  mWorkingBlockHeader.Crc = FtwCalculateCrc32 (
                              &mWorkingBlockHeader,
                              sizeof (EFI_FAULT_TOLERANT_WORKING_BLOCK_HEADER)
                              );

  mWorkingBlockHeader.WorkingBlockValid = 0;
  mWorkingBlockHeader.WorkingBlockInvalid = 1;
}
# 80 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/FaultTolerantWriteDxe/UpdateWorkingBlock.c"
BOOLEAN
IsValidWorkSpace (
  EFI_FAULT_TOLERANT_WORKING_BLOCK_HEADER *WorkingHeader
  )
{
  if (WorkingHeader == ((void *) 0)) {
    return ((BOOLEAN)(0==1));
  }
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Ftw: Work block header check mismatch\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  return ((BOOLEAN)(0==1));
}
# 106 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/FaultTolerantWriteDxe/UpdateWorkingBlock.c"
EFI_STATUS
InitWorkSpaceHeader (
  EFI_FAULT_TOLERANT_WORKING_BLOCK_HEADER *WorkingHeader
  )
...
# 134 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/FaultTolerantWriteDxe/UpdateWorkingBlock.c"
EFI_STATUS
ReadWorkSpaceData (
  EFI_FIRMWARE_VOLUME_BLOCK_PROTOCOL *FvBlock,
  UINTN BlockSize,
...
# 198 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/FaultTolerantWriteDxe/UpdateWorkingBlock.c"
EFI_STATUS
WriteWorkSpaceData (
  EFI_FIRMWARE_VOLUME_BLOCK_PROTOCOL *FvBlock,
  UINTN BlockSize,
...
# 257 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/FaultTolerantWriteDxe/UpdateWorkingBlock.c"
EFI_STATUS
WorkSpaceRefresh (
  EFI_FTW_DEVICE *FtwDevice
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Ftw: Remaining work space size - %x\n", RemainingSpaceSize); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) || (RemainingSpaceSize < sizeof (EFI_FAULT_TOLERANT_WRITE_HEADER) + sizeof (EFI_FAULT_TOLERANT_WRITE_RECORD))) {



    Status = FtwReclaimWorkSpace (FtwDevice, ((BOOLEAN)(1==1)));
    if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "Ftw: Reclaim workspace - %r\n", Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
      return ((RETURN_STATUS)(0x8000000000000000ULL | (21)));
    }
...
# 365 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/FaultTolerantWriteDxe/UpdateWorkingBlock.c"
EFI_STATUS
FtwReclaimWorkSpace (
  EFI_FTW_DEVICE *FtwDevice,
  BOOLEAN PreserveRecord
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Ftw: start to reclaim work space\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  ...
  SetMem (Ptr, FtwDevice->FtwWorkSpaceSize, ((UINT8) (255)));
  ...
  if (PreserveRecord) {
    ...
    if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) && (Header != ((void *) 0)) && (Header->Complete != 0) && (Header->HeaderAllocated == 0)) {
      CopyMem (
        Ptr + sizeof (EFI_FAULT_TOLERANT_WORKING_BLOCK_HEADER),
        FtwDevice->FtwLastWriteHeader,
        ( sizeof (EFI_FAULT_TOLERANT_WRITE_HEADER) + (UINTN) (Header->NumberOfWrites) * (sizeof (EFI_FAULT_TOLERANT_WRITE_RECORD) + (UINTN) Header->PrivateDataSize) )
        );
    }
  }
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Ftw: reclaim work space successfully\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));

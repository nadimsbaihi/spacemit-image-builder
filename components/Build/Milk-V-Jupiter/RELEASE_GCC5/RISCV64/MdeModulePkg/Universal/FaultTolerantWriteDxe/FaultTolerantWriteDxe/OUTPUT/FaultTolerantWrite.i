# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/FaultTolerantWriteDxe/FaultTolerantWrite.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/FaultTolerantWriteDxe/FaultTolerantWrite.c"
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/FaultTolerantWriteDxe/FaultTolerantWrite.c"
...
# 12 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/FaultTolerantWriteDxe/FaultTolerantWrite.c" 2
# 28 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/FaultTolerantWriteDxe/FaultTolerantWrite.c"
EFI_STATUS
  ...
  )
{
  ...
  FtwDevice = (((EFI_FTW_DEVICE *) (void *) ((CHAR8 *) (This) - ((UINTN) __builtin_offsetof(EFI_FTW_DEVICE, FtwInstance))))->Signature != ((('F') | ('T' << 8)) | ((('W') | ('D' << 8)) << 16))) ? ((void *) 0) : ((EFI_FTW_DEVICE *) (void *) ((CHAR8 *) (This) - ((UINTN) __builtin_offsetof(EFI_FTW_DEVICE, FtwInstance))));

  *BlockSize = FtwDevice->SpareAreaLength;

  return (RETURN_STATUS)(0);
}
# 69 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/FaultTolerantWriteDxe/FaultTolerantWrite.c"
EFI_STATUS
  ...
  )
{
  ...
  if (( sizeof (EFI_FAULT_TOLERANT_WRITE_HEADER) + (UINTN) (NumberOfWrites) * (sizeof (EFI_FAULT_TOLERANT_WRITE_RECORD) + (UINTN) PrivateDataSize) ) > FtwDevice->FtwWorkSpaceHeader->WriteQueueSize) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "Ftw: Allocate() request exceed Workspace, Caller: %g\n", CallerId); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  ...
  if ((FtwHeader->HeaderAllocated == 0) || (FtwHeader->WritesAllocated == 0)) {
  ...
  if (Offset + ( sizeof (EFI_FAULT_TOLERANT_WRITE_HEADER) + (UINTN) (NumberOfWrites) * (sizeof (EFI_FAULT_TOLERANT_WRITE_RECORD) + (UINTN) PrivateDataSize) ) > FtwDevice->FtwWorkSpaceSize) {
  ...
  FtwHeader->WritesAllocated = 1;
  FtwHeader->Complete = 1;
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Ftw: Allocate() success, Caller:%g, # %d\n", CallerId, NumberOfWrites); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
...
# 185 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/FaultTolerantWriteDxe/FaultTolerantWrite.c"
EFI_STATUS
FtwWriteRecord (
  EFI_FAULT_TOLERANT_WRITE_PROTOCOL *This,
  ...
  )
{
  ...
  if (IsWorkingBlock (FtwDevice, Fvb, Record->Lba)) {
    ...
    NumberOfWriteBlocks = ((UINTN) (((UINTN)(Record->Offset + Record->Length)) / (BlockSize) + ((((UINTN)(Record->Offset + Record->Length)) & ((BlockSize) - 1)) ? 1 : 0)));
...
# 311 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/FaultTolerantWriteDxe/FaultTolerantWrite.c"
EFI_STATUS
  ...
  )
{
  ...
  if (IsErasedFlashBuffer ((UINT8 *)Header, sizeof (EFI_FAULT_TOLERANT_WRITE_HEADER))) {
    if (PrivateData == ((void *) 0)) {
      ...
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "Ftw: no allocates space for write record!\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "Ftw: Allocate service should be called before Write service!\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  ...
  if (((UINTN)Record - (UINTN)Header) > ( sizeof (EFI_FAULT_TOLERANT_WRITE_HEADER) + (UINTN) (Header->NumberOfWrites - 1) * (sizeof (EFI_FAULT_TOLERANT_WRITE_RECORD) + (UINTN) Header->PrivateDataSize) )) {
    return ((RETURN_STATUS)(0x8000000000000000ULL | (15)));
  }
  ...
  if (Record->DestinationComplete == 0) {
    return ((RETURN_STATUS)(0x8000000000000000ULL | (15)));
  }

  if ((Record->SpareComplete == 0) && (Record->DestinationComplete != 0)) {
    return ((RETURN_STATUS)(0x8000000000000000ULL | (6)));
  }
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "Ftw: Write(), Get FVB physical address - %r\n", Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    return ((RETURN_STATUS)(0x8000000000000000ULL | (21)));
  }
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "Ftw: Write(), Get block size - %r\n", Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    return ((RETURN_STATUS)(0x8000000000000000ULL | (21)));
  }

  NumberOfWriteBlocks = ((UINTN) ((Offset + Length) / (BlockSize) + (((Offset + Length) & ((BlockSize) - 1)) ? 1 : 0)));
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Ftw: Write(), BlockSize - 0x%x, NumberOfWriteBlock - 0x%x\n", BlockSize, NumberOfWriteBlocks); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  ...
  if (IsBootBlock (FtwDevice, Fvb)) {
    Record->BootBlockUpdate = 0;



    do { if (((BOOLEAN)(0==1))) { (void) ((BlockSize == FtwDevice->SpareBlockSize) && (NumberOfWriteBlocks == FtwDevice->NumberOfSpareBlock)); } } while (((BOOLEAN)(0==1)));
  }
  ...
  MyLength = (sizeof (EFI_FAULT_TOLERANT_WRITE_RECORD) + (UINTN) Header->PrivateDataSize);
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "Ftw: Write() success, (Lba:Offset)=(%lx:0x%x), Length: 0x%x\n", Lba, Offset, Length); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
...
# 655 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/FaultTolerantWriteDxe/FaultTolerantWrite.c"
EFI_STATUS
  ...
  )
{
  ...
  Status = Fvb->GetBlockSize (Fvb, 0, &BlockSize, &NumberOfBlocks);
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "Ftw: Restart(), Get block size - %r\n", Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    return ((RETURN_STATUS)(0x8000000000000000ULL | (21)));
  }
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "%a(): success\n", __func__); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  return (RETURN_STATUS)(0);
}
# 748 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/FaultTolerantWriteDxe/FaultTolerantWrite.c"
EFI_STATUS
  ...
  )
{
  ...
  FtwDevice->FtwLastWriteHeader->Complete = 0;

  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "%a(): success\n", __func__); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  return (RETURN_STATUS)(0);
}
# 817 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdeModulePkg/Universal/FaultTolerantWriteDxe/FaultTolerantWrite.c"
EFI_STATUS
  ...
  )
{
  ...
  if (Record->SpareComplete != 0) {
    ...
    do { if (((BOOLEAN)(0==1))) { (void) (Record != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
  }
  ...
  *Complete = (BOOLEAN)(Record->DestinationComplete == 0);

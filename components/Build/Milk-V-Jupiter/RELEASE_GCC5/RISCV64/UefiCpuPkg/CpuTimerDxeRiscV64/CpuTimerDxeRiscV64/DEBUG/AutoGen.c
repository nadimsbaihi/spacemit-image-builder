...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x055DDAC6, 0x9142, 0x4013, {0xBF, 0x20, 0xFC, 0x2E, 0x5B, 0xC3, 0x25, 0xC9}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "CpuTimerDxeRiscV64";

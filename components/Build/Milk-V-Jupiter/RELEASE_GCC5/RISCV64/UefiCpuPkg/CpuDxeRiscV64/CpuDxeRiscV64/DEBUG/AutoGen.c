...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xBDEA19E2, 0x778F, 0x473C, {0xBF, 0x82, 0x5E, 0x38, 0xD6, 0xA2, 0x77, 0x65}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "CpuDxeRiscV64";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gRiscVEfiBootProtocolGuid = { 0xccd15fec, 0x6f73, 0x4eec, { 0x83, 0x95, 0x3e, 0x69, 0xe4, 0xb9, 0x40, 0xbf }};

# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/NetworkPkg/Library/DxeNetLib/NetBuffer.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/NetworkPkg/Library/DxeNetLib/NetBuffer.c"
...
# 9 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/NetworkPkg/Library/DxeNetLib/NetBuffer.c" 2
...
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/NetworkPkg/Library/DxeNetLib/NetBuffer.c" 2
...
# 13 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/NetworkPkg/Library/DxeNetLib/NetBuffer.c" 2
...
# 15 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/NetworkPkg/Library/DxeNetLib/NetBuffer.c" 2
...
# 16 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/NetworkPkg/Library/DxeNetLib/NetBuffer.c" 2
# 31 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/NetworkPkg/Library/DxeNetLib/NetBuffer.c"
NET_BUF *
NetbufAllocStruct (
  UINT32 BlockNum,
  UINT32 BlockOpNum
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (BlockOpNum >= 1); } } while (((BOOLEAN)(0==1)));




  Nbuf = AllocateZeroPool ((sizeof (NET_BUF) + ((BlockOpNum) - 1) * sizeof (NET_BLOCK_OP)));

  if (Nbuf == ((void *) 0)) {
    return ((void *) 0);
  }

  Nbuf->Signature = ((('n') | ('b' << 8)) | ((('u') | ('f' << 8)) << 16));
  Nbuf->RefCnt = 1;
  Nbuf->BlockOpNum = BlockOpNum;
  InitializeListHead (&Nbuf->List);

  if (BlockNum != 0) {
    Vector = AllocateZeroPool ((sizeof (NET_VECTOR) + ((BlockNum) - 1) * sizeof (NET_BLOCK)));

    if (Vector == ((void *) 0)) {
      goto FreeNbuf;
    }

    Vector->Signature = ((('n') | ('v' << 8)) | ((('e') | ('c' << 8)) << 16));
    Vector->RefCnt = 1;
...
# 87 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/NetworkPkg/Library/DxeNetLib/NetBuffer.c"
NET_BUF *
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (Len > 0); } } while (((BOOLEAN)(0==1)));
...
# 141 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/NetworkPkg/Library/DxeNetLib/NetBuffer.c"
void
NetbufFreeVector (
  NET_VECTOR *Vector
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (Vector != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { (void) (((Vector) != ((void *) 0)) && ((Vector)->Signature == (((('n') | ('v' << 8)) | ((('e') | ('c' << 8)) << 16))))); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { (void) (Vector->RefCnt > 0); } } while (((BOOLEAN)(0==1)));
  ...
  if (Vector->Free != ((void *) 0)) {





    if ((Vector->Flag & 0x01) != 0) {
...
# 193 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/NetworkPkg/Library/DxeNetLib/NetBuffer.c"
void
...
{
  do { if (((BOOLEAN)(0==1))) { (void) (Nbuf != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { (void) (((Nbuf) != ((void *) 0)) && ((Nbuf)->Signature == (((('n') | ('b' << 8)) | ((('u') | ('f' << 8)) << 16))))); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { (void) (Nbuf->RefCnt > 0); } } while (((BOOLEAN)(0==1)));
...
# 227 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/NetworkPkg/Library/DxeNetLib/NetBuffer.c"
NET_BUF *
  ...
  )
{
  ...
  Clone = AllocatePool ((sizeof (NET_BUF) + ((Nbuf->BlockOpNum) - 1) * sizeof (NET_BLOCK_OP)));

  if (Clone == ((void *) 0)) {
    return ((void *) 0);
  }

  Clone->Signature = ((('n') | ('b' << 8)) | ((('u') | ('f' << 8)) << 16));
  Clone->RefCnt = 1;
  ...
  CopyMem (Clone->ProtoData, Nbuf->ProtoData, 64);
...
# 278 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/NetworkPkg/Library/DxeNetLib/NetBuffer.c"
NET_BUF *
  ...
  )
{
  ...
  CopyMem (Duplicate->ProtoData, Nbuf->ProtoData, 64);
  NetbufReserve (Duplicate, HeadSpace);

  Dst = NetbufAllocSpace (Duplicate, Nbuf->TotalSize, 0);
  ...
  )
{
  ...
  for(Entry = (Head)->ForwardLink, Next = Entry->ForwardLink; Entry != (Head); Entry = Next, Next = Entry->ForwardLink ) {
    Nbuf = ((NET_BUF *) (void *) ((CHAR8 *) (Entry) - ((UINTN) __builtin_offsetof(NET_BUF, List))));
    do { if (((BOOLEAN)(0==1))) { (void) (((Nbuf) != ((void *) 0)) && ((Nbuf)->Signature == (((('n') | ('b' << 8)) | ((('u') | ('f' << 8)) << 16))))); } } while (((BOOLEAN)(0==1)));
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (IsListEmpty (Head)); } } while (((BOOLEAN)(0==1)));
}
# 357 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/NetworkPkg/Library/DxeNetLib/NetBuffer.c"
UINT8 *
...
# 409 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/NetworkPkg/Library/DxeNetLib/NetBuffer.c"
void
NetbufSetBlock (
  NET_BUF *Nbuf,
  UINT8 *Bulk,
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (((Nbuf) != ((void *) 0)) && ((Nbuf)->Signature == (((('n') | ('b' << 8)) | ((('u') | ('f' << 8)) << 16))))); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { (void) (((Nbuf->Vector) != ((void *) 0)) && ((Nbuf->Vector)->Signature == (((('n') | ('v' << 8)) | ((('e') | ('c' << 8)) << 16))))); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { (void) (Index < Nbuf->BlockOpNum); } } while (((BOOLEAN)(0==1)));
...
# 449 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/NetworkPkg/Library/DxeNetLib/NetBuffer.c"
void
NetbufSetBlockOp (
  NET_BUF *Nbuf,
  UINT8 *Bulk,
...
# 479 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/NetworkPkg/Library/DxeNetLib/NetBuffer.c"
void
...
# 508 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/NetworkPkg/Library/DxeNetLib/NetBuffer.c"
NET_BUF *
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (Last >= First); } } while (((BOOLEAN)(0==1)));
  ...
  CopyMem (Child->ProtoData, Nbuf->ProtoData, 64);
  return Child;
...
# 691 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/NetworkPkg/Library/DxeNetLib/NetBuffer.c"
NET_BUF *
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) ((ExtFragment != ((void *) 0)) && (ExtNum > 0) && (ExtFree != ((void *) 0))); } } while (((BOOLEAN)(0==1)));

  SavedFragment.Bulk = ((void *) 0);
  SavedFragment.Len = 0;
  ...
  if (HeadLen != 0) {
    ...
    for (Index = 0; Index < ExtNum; Index++) {
      if (Len >= ExtFragment[Index].Len) {
        ...
        Copied += Len;
        TotalLen += Len;
# 794 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/NetworkPkg/Library/DxeNetLib/NetBuffer.c"
        SavedIndex = Index;
  ...
  Vector->Free = ExtFree;
  Vector->Arg = Arg;
  Vector->Flag = ((FirstBlockLen != 0) ? 0x01 : 0);
...
# 864 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/NetworkPkg/Library/DxeNetLib/NetBuffer.c"
EFI_STATUS
...
# 912 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/NetworkPkg/Library/DxeNetLib/NetBuffer.c"
NET_BUF *
...
# 982 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/NetworkPkg/Library/DxeNetLib/NetBuffer.c"
void
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) ((Nbuf->BlockOpNum == 1) && (Nbuf->TotalSize == 0)); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { (void) ((Nbuf->Vector->Free == ((void *) 0)) && (Nbuf->Vector->Len >= Len)); } } while (((BOOLEAN)(0==1)));

  Nbuf->BlockOp[0].Head += Len;
  Nbuf->BlockOp[0].Tail += Len;

  do { if (((BOOLEAN)(0==1))) { (void) (Nbuf->BlockOp[0].Tail <= Nbuf->BlockOp[0].BlockTail); } } while (((BOOLEAN)(0==1)));
}
# 1013 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/NetworkPkg/Library/DxeNetLib/NetBuffer.c"
UINT8 *
  ...
  )
{
  ...
  if (FromHead) {
    ...
    if (Nbuf->TotalSize == 0) {
      ...
      if ((Index != 0) && (((UINTN)((&(Nbuf->BlockOp[Index]))->Head) - (UINTN)((&(Nbuf->BlockOp[Index]))->BlockHead)) < Len)) {
        Index--;
      }
    }
    ...
    if (((UINTN)((BlockOp)->Head) - (UINTN)((BlockOp)->BlockHead)) < Len) {
      return ((void *) 0);
    }
    ...
    if (Nbuf->TotalSize == 0) {
      ...
      if ((((UINTN)((&(Nbuf->BlockOp[Index]))->BlockTail) - (UINTN)((&(Nbuf->BlockOp[Index]))->Tail)) < Len) &&
    ...
    if (((UINTN)((BlockOp)->BlockTail) - (UINTN)((BlockOp)->Tail)) < Len) {
      return ((void *) 0);
    }
...
# 1102 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/NetworkPkg/Library/DxeNetLib/NetBuffer.c"
void
NetblockTrim (
  NET_BLOCK_OP *BlockOp,
  UINT32 Len,
...
{
  do { if (((BOOLEAN)(0==1))) { (void) ((BlockOp != ((void *) 0)) && (BlockOp->Size >= Len)); } } while (((BOOLEAN)(0==1)));
...
# 1132 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/NetworkPkg/Library/DxeNetLib/NetBuffer.c"
UINT32
...
# 1161 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/NetworkPkg/Library/DxeNetLib/NetBuffer.c"
  Trimmed = 0;
  Nbuf->TotalSize -= Len;
...
# 1204 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/NetworkPkg/Library/DxeNetLib/NetBuffer.c"
UINT32
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (((Nbuf) != ((void *) 0)) && ((Nbuf)->Signature == (((('n') | ('b' << 8)) | ((('u') | ('f' << 8)) << 16))))); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { (void) (Dest); } } while (((BOOLEAN)(0==1)));
  ...
  BlockOp = Nbuf->BlockOp;
# 1240 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/NetworkPkg/Library/DxeNetLib/NetBuffer.c"
  Cur = 0;
...
{
  NbufQue->Signature = ((('n') | ('b' << 8)) | ((('q') | ('u' << 8)) << 16));
  NbufQue->RefCnt = 1;
...
# 1320 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/NetworkPkg/Library/DxeNetLib/NetBuffer.c"
NET_BUF_QUEUE *
...
# 1348 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/NetworkPkg/Library/DxeNetLib/NetBuffer.c"
void
...
{
  do { if (((BOOLEAN)(0==1))) { (void) (NbufQue != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { (void) (((NbufQue) != ((void *) 0)) && ((NbufQue)->Signature == (((('n') | ('b' << 8)) | ((('q') | ('u' << 8)) << 16))))); } } while (((BOOLEAN)(0==1)));
...
# 1372 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/NetworkPkg/Library/DxeNetLib/NetBuffer.c"
void
...
# 1397 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/NetworkPkg/Library/DxeNetLib/NetBuffer.c"
NET_BUF *
  ...
  )
{
  ...
  First = ((NET_BUF *) (void *) ((CHAR8 *) (NbufQue->BufList.ForwardLink) - ((UINTN) __builtin_offsetof(NET_BUF, List))));
...
# 1436 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/NetworkPkg/Library/DxeNetLib/NetBuffer.c"
UINT32
  ...
  )
{
  ...
  for(Entry = (&NbufQue->BufList)->ForwardLink; Entry != (&NbufQue->BufList); Entry = Entry->ForwardLink) {
    Nbuf = ((NET_BUF *) (void *) ((CHAR8 *) (Entry) - ((UINTN) __builtin_offsetof(NET_BUF, List))));
...
# 1535 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/NetworkPkg/Library/DxeNetLib/NetBuffer.c"
UINT32
  ...
  )
{
  ...
  for(Entry = (&NbufQue->BufList)->ForwardLink, Next = Entry->ForwardLink; Entry != (&NbufQue->BufList); Entry = Next, Next = Entry->ForwardLink ) {
    Nbuf = ((NET_BUF *) (void *) ((CHAR8 *) (Entry) - ((UINTN) __builtin_offsetof(NET_BUF, List))));
...
# 1613 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/NetworkPkg/Library/DxeNetLib/NetBuffer.c"
UINT16
...
# 1656 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/NetworkPkg/Library/DxeNetLib/NetBuffer.c"
UINT16
...
# 1685 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/NetworkPkg/Library/DxeNetLib/NetBuffer.c"
UINT16
...
# 1738 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/NetworkPkg/Library/DxeNetLib/NetBuffer.c"
UINT16
  ...
  )
{
  ...
  Hdr.DstIp = Dst;
  Hdr.Protocol = Proto;
  Hdr.Len = SwapBytes16 (Len);

  return NetblockChecksum ((UINT8 *)&Hdr, sizeof (Hdr));
}
# 1775 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/NetworkPkg/Library/DxeNetLib/NetBuffer.c"
UINT16
  ...
  )
{
  ...
  (CopyMem ((&Hdr.SrcIp), (Src), sizeof (EFI_IPv6_ADDRESS)));
  (CopyMem ((&Hdr.DstIp), (Dst), sizeof (EFI_IPv6_ADDRESS)));

  Hdr.NextHeader = NextHeader;
  Hdr.Len = SwapBytes32 (Len);

  return NetblockChecksum ((UINT8 *)&Hdr, sizeof (Hdr));
}
# 1811 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/NetworkPkg/Library/DxeNetLib/NetBuffer.c"
void
NetIpSecNetbufFree (
  NET_BUF *Nbuf
  )
{
  ...
  if (Nbuf->RefCnt == 0) {
    ...
    do { if (((BOOLEAN)(0==1))) { (void) (((Nbuf->Vector) != ((void *) 0)) && ((Nbuf->Vector)->Signature == (((('n') | ('v' << 8)) | ((('e') | ('c' << 8)) << 16))))); } } while (((BOOLEAN)(0==1)));
    do { if (((BOOLEAN)(0==1))) { (void) (Nbuf->Vector->RefCnt > 0); } } while (((BOOLEAN)(0==1)));

# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/FdtLib/fdt_rw.c"
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/EmbeddedPkg/Library/FdtLib/FdtLib//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/riscv64-linux-gnu/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/EmbeddedPkg/Library/FdtLib/FdtLib/DEBUG/AutoGen.h" 1
# 16 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/EmbeddedPkg/Library/FdtLib/FdtLib/DEBUG/AutoGen.h"
...
# 17 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/EmbeddedPkg/Library/FdtLib/FdtLib/DEBUG/AutoGen.h" 2
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/FdtLib/fdt_rw.c"
# 51 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/FdtLib/fdt_rw.c"
...
# 52 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/FdtLib/fdt_rw.c" 2
...
# 54 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/FdtLib/fdt_rw.c" 2
...
# 55 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/FdtLib/fdt_rw.c" 2

# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/FdtLib/libfdt_internal.h" 1
# 66 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/FdtLib/libfdt_internal.h"
int
...
# 57 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/FdtLib/fdt_rw.c" 2
...
{
  return (((fdt32_to_cpu(((const struct fdt_header *)(fdt))->off_mem_rsvmap))) < (((sizeof (struct fdt_header)) + (8) - 1) & ~((8) - 1)))
         || (((fdt32_to_cpu(((const struct fdt_header *)(fdt))->off_dt_struct))) <
             (((fdt32_to_cpu(((const struct fdt_header *)(fdt))->off_mem_rsvmap))) + mem_rsv_size))
         || (((fdt32_to_cpu(((const struct fdt_header *)(fdt))->off_dt_strings))) <
             (((fdt32_to_cpu(((const struct fdt_header *)(fdt))->off_dt_struct))) + struct_size))
         || (((fdt32_to_cpu(((const struct fdt_header *)(fdt))->totalsize))) <
             (((fdt32_to_cpu(((const struct fdt_header *)(fdt))->off_dt_strings))) + ((fdt32_to_cpu(((const struct fdt_header *)(fdt))->size_dt_strings)))));
}
...
{
  { int __err; if ((__err = fdt_check_header(fdt)) != 0) return __err; };

  if (((fdt32_to_cpu(((const struct fdt_header *)(fdt))->version))) < 17) {
    return -10;
  }
  ...
  if (_fdt_blocks_misordered (
        ...
        ((fdt32_to_cpu(((const struct fdt_header *)(fdt))->size_dt_struct)))
        ))
  {
    return -12;
  }
...
# 108 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/FdtLib/fdt_rw.c"
static inline int
_fdt_data_size (
  void *fdt
  )
{
  return ((fdt32_to_cpu(((const struct fdt_header *)(fdt))->off_dt_strings))) + ((fdt32_to_cpu(((const struct fdt_header *)(fdt))->size_dt_strings)));
}
  ...
  )
{
  ...
  if ((end - oldlen + newlen) > ((char *)fdt + ((fdt32_to_cpu(((const struct fdt_header *)(fdt))->totalsize))))) {
    return -3;
  }
  ...
  )
{
  ...
  fdt_set_off_dt_struct (fdt, ((fdt32_to_cpu(((const struct fdt_header *)(fdt))->off_dt_struct))) + delta);
  fdt_set_off_dt_strings (fdt, ((fdt32_to_cpu(((const struct fdt_header *)(fdt))->off_dt_strings))) + delta);
  return 0;
}
  ...
  )
{
  ...
  fdt_set_size_dt_struct (fdt, ((fdt32_to_cpu(((const struct fdt_header *)(fdt))->size_dt_struct))) + delta);
  fdt_set_off_dt_strings (fdt, ((fdt32_to_cpu(((const struct fdt_header *)(fdt))->off_dt_strings))) + delta);
  return 0;
}
  ...
  )
{
  ...
  fdt_set_size_dt_strings (fdt, ((fdt32_to_cpu(((const struct fdt_header *)(fdt))->size_dt_strings))) + newlen);
  return 0;
}
...
{
  char *strtab = (char *)fdt + ((fdt32_to_cpu(((const struct fdt_header *)(fdt))->off_dt_strings)));
  const char *p;
  char *new;
  int len = strlen (s) + 1;
  int err;

  p = _fdt_find_string (strtab, ((fdt32_to_cpu(((const struct fdt_header *)(fdt))->size_dt_strings))), s);
  if (p) {

    return (p - strtab);
  }

  new = strtab + ((fdt32_to_cpu(((const struct fdt_header *)(fdt))->size_dt_strings)));
  ...
  )
{
  ...
  { int __err; if ((__err = _fdt_rw_check_header(fdt)) != 0) return __err; };
  ...
  re->address = fdt64_to_cpu(address);
  re->size = fdt64_to_cpu(size);
  return 0;
}
  ...
  )
{
  ...
  *prop = _fdt_offset_ptr_w (fdt, nextoffset);
  ...
  (*prop)->tag = fdt32_to_cpu(0x3);
  (*prop)->nameoff = fdt32_to_cpu(namestroff);
  (*prop)->len = fdt32_to_cpu(len);
  return 0;
}
  ...
  )
{
  ...
  err = _fdt_splice_struct (
          fdt,
          namep,
          (((((oldlen+1)) + (sizeof(fdt32_t)) - 1) & ~((sizeof(fdt32_t)) - 1))),
  ...
  )
{
  ...
  memmove (new + mem_rsv_off, old + ((fdt32_to_cpu(((const struct fdt_header *)(old))->off_mem_rsvmap))), mem_rsv_size);
  fdt_set_off_mem_rsvmap (new, mem_rsv_off);

  memmove (new + struct_off, old + ((fdt32_to_cpu(((const struct fdt_header *)(old))->off_dt_struct))), struct_size);
  fdt_set_off_dt_struct (new, struct_off);
  fdt_set_size_dt_struct (new, struct_size);

  memmove (
    new + strings_off,
    old + ((fdt32_to_cpu(((const struct fdt_header *)(old))->off_dt_strings))),
    ((fdt32_to_cpu(((const struct fdt_header *)(old))->size_dt_strings)))
    );
  fdt_set_off_dt_strings (new, strings_off);
  fdt_set_size_dt_strings (new, ((fdt32_to_cpu(((const struct fdt_header *)(old))->size_dt_strings))));
}
  ...
  )
{
  ...
  const char *fdtend = fdtstart + ((fdt32_to_cpu(((const struct fdt_header *)(fdt))->totalsize)));
  char *tmp;
  ...
  if (((fdt32_to_cpu(((const struct fdt_header *)(fdt))->version))) >= 17) {
    struct_size = ((fdt32_to_cpu(((const struct fdt_header *)(fdt))->size_dt_struct)));
  } else {
    struct_size = 0;
  ...
  newsize = (((sizeof (struct fdt_header)) + (8) - 1) & ~((8) - 1)) + mem_rsv_size
            + struct_size + ((fdt32_to_cpu(((const struct fdt_header *)(fdt))->size_dt_strings)));
  ...
  fdt_set_boot_cpuid_phys (buf, ((fdt32_to_cpu(((const struct fdt_header *)(fdt))->boot_cpuid_phys))));
  ...
  )
{
  ...
  mem_rsv_size = (fdt_num_mem_rsv (fdt)+1)
                 * sizeof (struct fdt_reserve_entry);
  _fdt_packblocks (fdt, fdt, mem_rsv_size, ((fdt32_to_cpu(((const struct fdt_header *)(fdt))->size_dt_struct))));

# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/FdtLib/fdt.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/FdtLib/fdt.c"
# 51 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/FdtLib/fdt.c"
...
# 52 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/FdtLib/fdt.c" 2
...
# 54 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/FdtLib/fdt.c" 2
...
# 55 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/FdtLib/fdt.c" 2
...
# 57 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/FdtLib/fdt.c" 2
  ...
  )
{
  if (((fdt32_to_cpu(((const struct fdt_header *)(fdt))->magic))) == 0xd00dfeed) {
    ...
    if (((fdt32_to_cpu(((const struct fdt_header *)(fdt))->version))) < 0x10) {
      return -10;
    }

    if (((fdt32_to_cpu(((const struct fdt_header *)(fdt))->last_comp_version))) > 0x11) {
      return -10;
    }
  } else if (((fdt32_to_cpu(((const struct fdt_header *)(fdt))->magic))) == (~0xd00dfeed)) {

    if (((fdt32_to_cpu(((const struct fdt_header *)(fdt))->size_dt_struct))) == 0) {
      return -7;
    }
  } else {
    return -9;
...
{
  unsigned absoffset = offset + ((fdt32_to_cpu(((const struct fdt_header *)(fdt))->off_dt_struct)));

  if ( (absoffset < offset)
     || ((absoffset + len) < absoffset)
     || ((absoffset + len) > ((fdt32_to_cpu(((const struct fdt_header *)(fdt))->totalsize)))))
  {
    return ((void *) 0);
  }

  if (((fdt32_to_cpu(((const struct fdt_header *)(fdt))->version))) >= 0x11) {
    if ( ((offset + len) < offset)
       || ((offset + len) > ((fdt32_to_cpu(((const struct fdt_header *)(fdt))->size_dt_struct)))))
    {
      return ((void *) 0);
    }
  }
  ...
  )
{
  ...
  if (((fdt32_to_cpu(((const struct fdt_header *)(fdt))->totalsize))) > bufsize) {
    return -3;
  }

  memmove (buf, fdt, ((fdt32_to_cpu(((const struct fdt_header *)(fdt))->totalsize))));
  return 0;
}

# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/FdtLib/fdt_sw.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/FdtLib/fdt_sw.c"
# 51 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/FdtLib/fdt_sw.c"
...
# 52 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/FdtLib/fdt_sw.c" 2
...
# 54 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/FdtLib/fdt_sw.c" 2
...
# 55 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/FdtLib/fdt_sw.c" 2
...
# 57 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/FdtLib/fdt_sw.c" 2
...
{
  if (((fdt32_to_cpu(((const struct fdt_header *)(fdt))->magic))) != (~0xd00dfeed)) {
    return -9;
  }
...
# 78 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/FdtLib/fdt_sw.c"
static void *
_fdt_grab_space (
  void *fdt,
  size_t len
...
{
  int offset = ((fdt32_to_cpu(((const struct fdt_header *)(fdt))->size_dt_struct)));
  int spaceleft;

  spaceleft = ((fdt32_to_cpu(((const struct fdt_header *)(fdt))->totalsize))) - ((fdt32_to_cpu(((const struct fdt_header *)(fdt))->off_dt_struct)))
              - ((fdt32_to_cpu(((const struct fdt_header *)(fdt))->size_dt_strings)));
  ...
  )
{
  ...
  fdt_set_last_comp_version (fdt, 0x10);
  fdt_set_totalsize (fdt, bufsize);

  fdt_set_off_mem_rsvmap (
    fdt,
    (((sizeof (struct fdt_header)) + (sizeof (struct fdt_reserve_entry)) - 1) & ~((sizeof (struct fdt_reserve_entry)) - 1))



    );
  fdt_set_off_dt_struct (fdt, ((fdt32_to_cpu(((const struct fdt_header *)(fdt))->off_mem_rsvmap))));
  ...
  )
{
  ...
  { int err; if ((err = _fdt_sw_check_header(fdt)) != 0) return err; };

  headsize = ((fdt32_to_cpu(((const struct fdt_header *)(fdt))->off_dt_struct)));
  tailsize = ((fdt32_to_cpu(((const struct fdt_header *)(fdt))->size_dt_strings)));

  if ((headsize + tailsize) > bufsize) {
    return -3;
  }

  oldtail = (char *)fdt + ((fdt32_to_cpu(((const struct fdt_header *)(fdt))->totalsize))) - tailsize;
  ...
  )
{
  ...
  if (((fdt32_to_cpu(((const struct fdt_header *)(fdt))->size_dt_struct)))) {
    return -7;
  }

  offset = ((fdt32_to_cpu(((const struct fdt_header *)(fdt))->off_dt_struct)));
  if ((offset + sizeof (*re)) > ((fdt32_to_cpu(((const struct fdt_header *)(fdt))->totalsize)))) {
    return -3;
  }

  re = (struct fdt_reserve_entry *)((char *)fdt + offset);
  re->address = fdt64_to_cpu(addr);
  ...
  )
{
  ...
  nh = _fdt_grab_space (fdt, sizeof (*nh) + (((((namelen)) + (sizeof(fdt32_t)) - 1) & ~((sizeof(fdt32_t)) - 1))));
  if (!nh) {
    return -3;
  }
  ...
  )
{
  ...
  en = _fdt_grab_space (fdt, sizeof(fdt32_t));
  if (!en) {
    return -3;
  }
...
{
  char *strtab = (char *)fdt + ((fdt32_to_cpu(((const struct fdt_header *)(fdt))->totalsize)));
  const char *p;
  int strtabsize = ((fdt32_to_cpu(((const struct fdt_header *)(fdt))->size_dt_strings)));
  int len = strlen (s) + 1;
  ...
  struct_top = ((fdt32_to_cpu(((const struct fdt_header *)(fdt))->off_dt_struct))) + ((fdt32_to_cpu(((const struct fdt_header *)(fdt))->size_dt_struct)));
  if (((fdt32_to_cpu(((const struct fdt_header *)(fdt))->totalsize))) + offset < struct_top) {
    return 0;
  }
  ...
  )
{
  ...
  prop = _fdt_grab_space (fdt, sizeof (*prop) + (((((len)) + (sizeof(fdt32_t)) - 1) & ~((sizeof(fdt32_t)) - 1))));
  if (!prop) {
    return -3;
  }

  prop->tag = fdt32_to_cpu(0x3);
  prop->nameoff = fdt32_to_cpu(nameoff);
  ...
  )
{
  ...
  *end = fdt32_to_cpu(0x9);


  oldstroffset = ((fdt32_to_cpu(((const struct fdt_header *)(fdt))->totalsize))) - ((fdt32_to_cpu(((const struct fdt_header *)(fdt))->size_dt_strings)));
  newstroffset = ((fdt32_to_cpu(((const struct fdt_header *)(fdt))->off_dt_struct))) + ((fdt32_to_cpu(((const struct fdt_header *)(fdt))->size_dt_struct)));
  memmove (p + newstroffset, p + oldstroffset, ((fdt32_to_cpu(((const struct fdt_header *)(fdt))->size_dt_strings))));
  ...
  while ((tag = fdt_next_tag (fdt, offset, &nextoffset)) != 0x9) {
    if (tag == 0x3) {
      ...
      nameoff += ((fdt32_to_cpu(((const struct fdt_header *)(fdt))->size_dt_strings)));
      prop->nameoff = fdt32_to_cpu(nameoff);
    }
  ...
  fdt_set_totalsize (fdt, newstroffset + ((fdt32_to_cpu(((const struct fdt_header *)(fdt))->size_dt_strings))));
  fdt_set_magic (fdt, 0xd00dfeed);
  return 0;
}

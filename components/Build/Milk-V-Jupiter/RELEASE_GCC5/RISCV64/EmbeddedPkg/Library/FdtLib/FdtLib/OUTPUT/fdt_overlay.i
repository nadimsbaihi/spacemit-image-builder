# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/FdtLib/fdt_overlay.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/FdtLib/fdt_overlay.c"
# 52 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/FdtLib/fdt_overlay.c"
...
# 53 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/FdtLib/fdt_overlay.c" 2
...
# 55 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/FdtLib/fdt_overlay.c" 2
...
# 56 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/FdtLib/fdt_overlay.c" 2
...
# 58 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/FdtLib/fdt_overlay.c" 2
# 73 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/FdtLib/fdt_overlay.c"
static uint32_t
...
# 109 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/FdtLib/fdt_overlay.c"
static int
overlay_get_target (
  const void *fdt,
  const void *fdto,
...
# 147 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/FdtLib/fdt_overlay.c"
  if ((ret < 0) && (path_len == -1)) {
    ret = -16;
  }
...
# 178 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/FdtLib/fdt_overlay.c"
static int
...
# 227 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/FdtLib/fdt_overlay.c"
static int
...
# 271 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/FdtLib/fdt_overlay.c"
static int
...
# 302 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/FdtLib/fdt_overlay.c"
static int
  ...
  )
{
  ...
  for (fixup_prop = fdt_first_property_offset(fdto, fixup_node); fixup_prop >= 0; fixup_prop = fdt_next_property_offset(fdto, fixup_prop)) {
    ...
    for (i = 0; i < (fixup_len / sizeof (uint32_t)); i++) {
      ...
      adj_val = fdt32_to_cpu(fdt32_to_cpu (adj_val) + delta);
...
# 432 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/FdtLib/fdt_overlay.c"
static int
...
# 484 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/FdtLib/fdt_overlay.c"
static int
  ...
  )
{
  ...
  phandle_prop = fdt32_to_cpu(phandle);
...
# 574 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/FdtLib/fdt_overlay.c"
static int
...
# 682 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/FdtLib/fdt_overlay.c"
static int
...
# 738 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/FdtLib/fdt_overlay.c"
static int
overlay_apply_node (
  void *fdt,
  int target,
  ...
  )
{
  ...
  for (subnode = fdt_first_subnode(fdto, node); subnode >= 0; subnode = fdt_next_subnode(fdto, subnode)) {
    const char *name = fdt_get_name (fdto, subnode, ((void *) 0));
    int nnode;
    int ret;
...
# 816 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/FdtLib/fdt_overlay.c"
static int
overlay_merge (
  void *fdt,
  void *fdto
  )
{
  ...
  for (fragment = fdt_first_subnode(fdto, 0); fragment >= 0; fragment = fdt_next_subnode(fdto, fragment)) {
    ...
    target = overlay_get_target (fdt, fdto, fragment, ((void *) 0));
    if (target < 0) {
      return target;
    }
...
# 910 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/FdtLib/fdt_overlay.c"
static int
  ...
  )
{
  ...
  { int __err; if ((__err = fdt_check_header(fdt)) != 0) return __err; };
  { int __err; if ((__err = fdt_check_header(fdto)) != 0) return __err; };

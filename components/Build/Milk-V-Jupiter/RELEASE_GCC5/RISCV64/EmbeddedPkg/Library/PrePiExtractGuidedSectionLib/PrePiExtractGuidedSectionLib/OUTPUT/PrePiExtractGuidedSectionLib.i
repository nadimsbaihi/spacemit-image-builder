# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/PrePiExtractGuidedSectionLib/PrePiExtractGuidedSectionLib.c"
# 1 "/home/kapoagaeming/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/EmbeddedPkg/Library/PrePiExtractGuidedSectionLib/PrePiExtractGuidedSectionLib//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/riscv64-linux-gnu/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/EmbeddedPkg/Library/PrePiExtractGuidedSectionLib/PrePiExtractGuidedSectionLib/DEBUG/AutoGen.h" 1
# 16 "/home/kapoagaeming/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/EmbeddedPkg/Library/PrePiExtractGuidedSectionLib/PrePiExtractGuidedSectionLib/DEBUG/AutoGen.h"
...
# 17 "/home/kapoagaeming/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/EmbeddedPkg/Library/PrePiExtractGuidedSectionLib/PrePiExtractGuidedSectionLib/DEBUG/AutoGen.h" 2
...
# 18 "/home/kapoagaeming/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/EmbeddedPkg/Library/PrePiExtractGuidedSectionLib/PrePiExtractGuidedSectionLib/DEBUG/AutoGen.h" 2
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/PrePiExtractGuidedSectionLib/PrePiExtractGuidedSectionLib.c"
# 9 "/home/kapoagaeming/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/PrePiExtractGuidedSectionLib/PrePiExtractGuidedSectionLib.c"
...
# 10 "/home/kapoagaeming/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/PrePiExtractGuidedSectionLib/PrePiExtractGuidedSectionLib.c" 2
...
# 11 "/home/kapoagaeming/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/PrePiExtractGuidedSectionLib/PrePiExtractGuidedSectionLib.c" 2
...
# 12 "/home/kapoagaeming/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/PrePiExtractGuidedSectionLib/PrePiExtractGuidedSectionLib.c" 2
...
# 13 "/home/kapoagaeming/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/PrePiExtractGuidedSectionLib/PrePiExtractGuidedSectionLib.c" 2
...
# 18 "/home/kapoagaeming/spacemit-image-builder/components/edk2/EmbeddedPkg/Include/Guid/ExtractSection.h"
typedef struct {
...
# 15 "/home/kapoagaeming/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/PrePiExtractGuidedSectionLib/PrePiExtractGuidedSectionLib.c" 2
  ...
  )
{
  ...
  GUID SavedDataGuid = { 0x385A982C, 0x2F49, 0x4043, { 0xA5, 0x1E, 0x49, 0x01, 0x02, 0x5C, 0x8B, 0x6B }};
  ...
  )
{
  ...
  if (SavedData->NumberOfExtractHandler >= _gPcd_FixedAtBuild_PcdMaximumGuidedExtractHandler) {
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (ExtractHandlerGuidTable != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (OutputBufferSize != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { (void) (ScratchBufferSize != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { (void) (SectionAttribute != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (OutputBuffer != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { (void) (AuthenticationStatus != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
...
{
  PRE_PI_EXTRACT_GUIDED_SECTION_DATA SavedData;
  GUID HobGuid = { 0x385A982C, 0x2F49, 0x4043, { 0xA5, 0x1E, 0x49, 0x01, 0x02, 0x5C, 0x8B, 0x6B }};




  SavedData.ExtractHandlerGuidTable = (GUID *)AllocatePool (_gPcd_FixedAtBuild_PcdMaximumGuidedExtractHandler * sizeof (GUID));
  if (SavedData.ExtractHandlerGuidTable == ((void *) 0)) {
    return ((RETURN_STATUS)(0x8000000000000000ULL | (9)));
  }

  SavedData.ExtractDecodeHandlerTable = (EXTRACT_GUIDED_SECTION_DECODE_HANDLER *)AllocatePool (_gPcd_FixedAtBuild_PcdMaximumGuidedExtractHandler * sizeof (EXTRACT_GUIDED_SECTION_DECODE_HANDLER));
  if (SavedData.ExtractDecodeHandlerTable == ((void *) 0)) {
    return ((RETURN_STATUS)(0x8000000000000000ULL | (9)));
  }

  SavedData.ExtractGetInfoHandlerTable = (EXTRACT_GUIDED_SECTION_GET_INFO_HANDLER *)AllocatePool (_gPcd_FixedAtBuild_PcdMaximumGuidedExtractHandler * sizeof (EXTRACT_GUIDED_SECTION_GET_INFO_HANDLER));
  if (SavedData.ExtractGetInfoHandlerTable == ((void *) 0)) {
    return ((RETURN_STATUS)(0x8000000000000000ULL | (9)));
  }

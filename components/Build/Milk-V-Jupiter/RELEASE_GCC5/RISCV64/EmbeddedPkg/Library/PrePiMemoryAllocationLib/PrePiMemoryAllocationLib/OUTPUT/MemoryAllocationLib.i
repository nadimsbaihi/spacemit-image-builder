# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/PrePiMemoryAllocationLib/MemoryAllocationLib.c"
# 1 "/home/kapoagaeming/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/EmbeddedPkg/Library/PrePiMemoryAllocationLib/PrePiMemoryAllocationLib//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/riscv64-linux-gnu/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/EmbeddedPkg/Library/PrePiMemoryAllocationLib/PrePiMemoryAllocationLib/DEBUG/AutoGen.h" 1
# 16 "/home/kapoagaeming/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/EmbeddedPkg/Library/PrePiMemoryAllocationLib/PrePiMemoryAllocationLib/DEBUG/AutoGen.h"
...
# 17 "/home/kapoagaeming/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/EmbeddedPkg/Library/PrePiMemoryAllocationLib/PrePiMemoryAllocationLib/DEBUG/AutoGen.h" 2
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/PrePiMemoryAllocationLib/MemoryAllocationLib.c"
# 13 "/home/kapoagaeming/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/PrePiMemoryAllocationLib/MemoryAllocationLib.c"
...
# 14 "/home/kapoagaeming/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/PrePiMemoryAllocationLib/MemoryAllocationLib.c" 2
...
# 15 "/home/kapoagaeming/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/PrePiMemoryAllocationLib/MemoryAllocationLib.c" 2
...
# 16 "/home/kapoagaeming/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/PrePiMemoryAllocationLib/MemoryAllocationLib.c" 2
  ...
  )
{
  ...
  NewTop = Hob.HandoffInformationTable->EfiFreeMemoryTop & ~(EFI_PHYSICAL_ADDRESS)0xFFF;
  NewTop -= Pages * 0x00001000;
...
# 70 "/home/kapoagaeming/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/PrePiMemoryAllocationLib/MemoryAllocationLib.c"
void *
...
# 92 "/home/kapoagaeming/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/PrePiMemoryAllocationLib/MemoryAllocationLib.c"
void *
...
# 117 "/home/kapoagaeming/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/PrePiMemoryAllocationLib/MemoryAllocationLib.c"
void *
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (Pages <= (0xFFFFFFFFFFFFFFFFULL - (((Alignment) >> 12) + (((Alignment) & 0xFFF) ? 1 : 0)))); } } while (((BOOLEAN)(0==1)));



  Memory = (void *)(UINTN)AllocatePages (Pages + (((Alignment) >> 12) + (((Alignment) & 0xFFF) ? 1 : 0)));
  if (Alignment == 0) {
...
# 170 "/home/kapoagaeming/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/PrePiMemoryAllocationLib/MemoryAllocationLib.c"
void
...
# 193 "/home/kapoagaeming/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/PrePiMemoryAllocationLib/MemoryAllocationLib.c"
void *
...
# 232 "/home/kapoagaeming/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/PrePiMemoryAllocationLib/MemoryAllocationLib.c"
void *
...
# 264 "/home/kapoagaeming/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/PrePiMemoryAllocationLib/MemoryAllocationLib.c"
void
...
# 294 "/home/kapoagaeming/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/PrePiMemoryAllocationLib/MemoryAllocationLib.c"
void *
  ...
  )
{
  ...
  if (OldBuffer != ((void *) 0)) {
    ...
    do { if (((BOOLEAN)(0==1))) { (void) (((EFI_PHYSICAL_ADDRESS)(UINTN)OldBuffer >= HandOffHob->EfiMemoryBottom)); } } while (((BOOLEAN)(0==1)));
    do { if (((BOOLEAN)(0==1))) { (void) (((EFI_PHYSICAL_ADDRESS)((UINTN)OldBuffer + OldSize) <= HandOffHob->EfiFreeMemoryBottom)); } } while (((BOOLEAN)(0==1)));
  }

  } } while (((BOOLEAN)(0==1)));


  if ((OldBuffer != ((void *) 0)) && (OldSize >= NewSize)) {
    return OldBuffer;
  }

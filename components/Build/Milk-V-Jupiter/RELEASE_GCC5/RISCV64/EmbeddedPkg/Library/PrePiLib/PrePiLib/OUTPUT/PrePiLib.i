# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/PrePiLib/PrePiLib.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/PrePiLib/PrePiLib.c"
# 9 "/home/kapoagaeming/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/PrePiLib/PrePiLib.c"
...
# 10 "/home/kapoagaeming/spacemit-image-builder/components/edk2/EmbeddedPkg/Library/PrePiLib/PrePiLib.c" 2
  ...
  )
{
  ...
  while (Hob.Raw != ((void *) 0)) {
    ...
    Hob.Raw = GetNextHob (0x0002, ((Hob).Raw + ((Hob).Header->HobLength)));
  }
  ...
  )
{
  ...
  Buffer = AllocateCodePages (((((UINT32)ImageContext.ImageSize) >> 12) + ((((UINT32)ImageContext.ImageSize) & 0xFFF) ? 1 : 0)));
  do { if (((BOOLEAN)(0==1))) { (void) (Buffer != 0); } } while (((BOOLEAN)(0==1)));
  ...
  )
{
  ...
  Status = FfsFindSectionDataWithHook (0x10, ((void *) 0), FileHandle, &PeCoffImage);
  ...
  BuildModuleHob (&FvFileInfo.FileName, (EFI_PHYSICAL_ADDRESS)(UINTN)ImageAddress, ((((UINT32)ImageSize) >> 12) + ((((UINT32)ImageSize) & 0xFFF) ? 1 : 0)) * 0x00001000, EntryPoint);

  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040 | 0x00000004)) { DebugPrint (0x00000040 | 0x00000004, "Loading DxeCore at 0x%10p EntryPoint=0x%10p\n", (void *)(UINTN)ImageAddress, (void *)(UINTN)EntryPoint); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  ...
  if (StackSize == 0) {
    ...
    BaseOfStack = AllocatePages ((((StackSize) >> 12) + (((StackSize) & 0xFFF) ? 1 : 0)));
    do { if (((BOOLEAN)(0==1))) { (void) (BaseOfStack != ((void *) 0)); } } while (((BOOLEAN)(0==1)));





    TopOfStack = (void *)((UINTN)BaseOfStack + (((StackSize) >> 12) + (((StackSize) & 0xFFF) ? 1 : 0)) * 0x00001000 - 16);
    TopOfStack = ((void *) ((((UINTN)(TopOfStack)) + ((((16)) - ((UINTN)(TopOfStack))) & (((16)) - 1U)))));
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "DxeCore returned\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { (void) (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  ...
  )
{
  EFI_STATUS Status;
  EFI_PEI_FV_HANDLE VolumeHandle;
  EFI_PEI_FILE_HANDLE FileHandle = ((void *) 0);

  if (FvInstance != ((void *) 0)) {



    Status = FfsFindNextVolume (*FvInstance, &VolumeHandle);
    if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
      Status = FfsFindNextFile (0x05, VolumeHandle, &FileHandle);
    }
  } else {
    Status = FfsAnyFvFindFirstFile (0x05, &VolumeHandle, &FileHandle);
  }
  ...
  )
{
  ...
  Status = FfsAnyFvFindFirstFile (0x0B, &VolumeHandle, &FileHandle);
  if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {

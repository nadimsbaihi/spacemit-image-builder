# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/OpenVolume.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/OpenVolume.c"
# 9 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/OpenVolume.c"
...
# 10 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/OpenVolume.c" 2
# 23 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/OpenVolume.c"
EFI_STATUS
  ...
  )
{
  ...
  Volume = (((FAT_VOLUME *) (void *) ((CHAR8 *) (This) - ((UINTN) __builtin_offsetof(FAT_VOLUME, VolumeInterface))))->Signature != ((('f') | ('a' << 8)) | ((('t') | ('v' << 8)) << 16))) ? ((void *) 0) : ((FAT_VOLUME *) (void *) ((CHAR8 *) (This) - ((UINTN) __builtin_offsetof(FAT_VOLUME, VolumeInterface))));;
  FatAcquireLock ();




  Status = FatOpenDirEnt (((void *) 0), &Volume->RootDirEnt);
...
Done:
  ...
  Status = FatCleanupVolume (Volume, Volume->Root, Status, ((void *) 0));
  FatReleaseLock ();

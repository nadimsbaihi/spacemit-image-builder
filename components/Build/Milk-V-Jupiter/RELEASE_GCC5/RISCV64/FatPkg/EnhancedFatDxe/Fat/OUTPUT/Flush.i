# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Flush.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Flush.c"
# 10 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Flush.c"
...
# 11 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Flush.c" 2
# 25 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Flush.c"
EFI_STATUS
  ...
  )
{
  ...
  if ((((RETURN_STATUS)(OFile->Error)) >= 0x8000000000000000ULL)) {
    return OFile->Error;
  }
...
# 109 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Flush.c"
EFI_STATUS
...
{
  return FatFlushEx (FHand, ((void *) 0));
}
# 127 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Flush.c"
EFI_STATUS
  ...
  )
{
  ...
  FatCleanupVolume (Volume, OFile, (RETURN_STATUS)(0), ((void *) 0));
  FatReleaseLock ();
...
# 172 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Flush.c"
EFI_STATUS
FatIFileClose (
  FAT_IFILE *IFile
  )
{
  ...
  if (OFile->CheckLink.ForwardLink == ((void *) 0)) {
...
# 217 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Flush.c"
EFI_STATUS
FatOFileFlush (
  FAT_OFILE *OFile
  )
{
  ...
  do {
    ...
    if (OFile->Dirty) {
      ...
      OFile->PreserveLastModification = ((BOOLEAN)(0==1));
      if (OFile->Archive) {
        DirEnt->Entry.Attributes |= 0x20;
        OFile->Archive = ((BOOLEAN)(0==1));
      }




      if ((Parent != ((void *) 0)) && !DirEnt->Invalid) {
...
# 294 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Flush.c"
BOOLEAN
FatCheckOFileRef (
  FAT_OFILE *OFile
  )
{
  ...
  if (OFile->CheckLink.ForwardLink != ((void *) 0)) {
    ...
    OFile->CheckLink.ForwardLink = ((void *) 0);
  }
...
# 335 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Flush.c"
static
void
FatCheckVolumeRef (
  FAT_VOLUME *Volume
  )
{
  ...
  while (!IsListEmpty (&Volume->CheckRef)) {
    ...
    Parent = (((FAT_OFILE *) (void *) ((CHAR8 *) (Volume->CheckRef.ForwardLink) - ((UINTN) __builtin_offsetof(FAT_OFILE, CheckLink))))->Signature != ((('f') | ('a' << 8)) | ((('t') | ('o' << 8)) << 16))) ? ((void *) 0) : ((FAT_OFILE *) (void *) ((CHAR8 *) (Volume->CheckRef.ForwardLink) - ((UINTN) __builtin_offsetof(FAT_OFILE, CheckLink))));
...
# 381 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Flush.c"
EFI_STATUS
FatCleanupVolume (
  FAT_VOLUME *Volume,
  FAT_OFILE *OFile,
  ...
  )
{
  ...
  if ((Volume->Root == ((void *) 0)) && !Volume->Valid) {
...
# 458 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Flush.c"
void
FatSetVolumeError (
  FAT_OFILE *OFile,
  EFI_STATUS Status
  )
{
  ...
  for (Link = OFile->ChildHead.ForwardLink; Link != &OFile->ChildHead; Link = Link->ForwardLink) {
    ChildOFile = (((FAT_OFILE *) (void *) ((CHAR8 *) (Link) - ((UINTN) __builtin_offsetof(FAT_OFILE, ChildLink))))->Signature != ((('f') | ('a' << 8)) | ((('t') | ('o' << 8)) << 16))) ? ((void *) 0) : ((FAT_OFILE *) (void *) ((CHAR8 *) (Link) - ((UINTN) __builtin_offsetof(FAT_OFILE, ChildLink))));

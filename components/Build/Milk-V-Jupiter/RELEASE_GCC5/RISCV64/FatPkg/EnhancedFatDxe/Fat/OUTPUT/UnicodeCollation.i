# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/UnicodeCollation.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/UnicodeCollation.c"
# 10 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/UnicodeCollation.c"
...
# 11 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/UnicodeCollation.c" 2

EFI_UNICODE_COLLATION_PROTOCOL *mUnicodeCollationInterface = ((void *) 0);
# 29 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/UnicodeCollation.c"
EFI_STATUS
InitializeUnicodeCollationSupportWorker (
  EFI_HANDLE AgentHandle,
  EFI_GUID *ProtocolGuid,
  const CHAR16 *VariableName,
  const CHAR8 *DefaultLanguage
  )
{
  ...
  GetEfiGlobalVariable2 (VariableName, (void **)&Language, ((void *) 0));

  ReturnStatus = ((RETURN_STATUS)(0x8000000000000000ULL | (3)));
...
# 119 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/UnicodeCollation.c"
EFI_STATUS
InitializeUnicodeCollationSupport (
  EFI_HANDLE AgentHandle
  )
{
  ...
  Status = InitializeUnicodeCollationSupportWorker (
             ...
             L"PlatformLang",
             (const CHAR8 *)_gPcd_FixedAtBuild_PcdUefiVariableDefaultPlatformLang
             );
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    Status = InitializeUnicodeCollationSupportWorker (
               ...
               L"Lang",
               (const CHAR8 *)_gPcd_FixedAtBuild_PcdUefiVariableDefaultLang
               );
  }

  return Status;
}
# 163 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/UnicodeCollation.c"
INTN
FatStriCmp (
  CHAR16 *S1,
  CHAR16 *S2
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (StrSize (S1) != 0); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { (void) (StrSize (S2) != 0); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { (void) (mUnicodeCollationInterface != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
...
# 191 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/UnicodeCollation.c"
void
FatStrUpr (
  CHAR16 *String
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (StrSize (String) != 0); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { (void) (mUnicodeCollationInterface != ((void *) 0)); } } while (((BOOLEAN)(0==1)));

  mUnicodeCollationInterface->StrUpr (mUnicodeCollationInterface, String);
}
# 213 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/UnicodeCollation.c"
void
FatStrLwr (
  CHAR16 *String
  )
...
# 238 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/UnicodeCollation.c"
void
FatFatToStr (
  UINTN FatSize,
  CHAR8 *Fat,
...
{
  do { if (((BOOLEAN)(0==1))) { (void) (Fat != ((void *) 0)); } } while (((BOOLEAN)(0==1)));




  do { if (((BOOLEAN)(0==1))) { (void) (String != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { (void) (((UINTN)String & 0x01) == 0); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { (void) (mUnicodeCollationInterface != ((void *) 0)); } } while (((BOOLEAN)(0==1)));

  mUnicodeCollationInterface->FatToStr (mUnicodeCollationInterface, FatSize, Fat, String);
}
# 268 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/UnicodeCollation.c"
BOOLEAN
FatStrToFat (
  CHAR16 *String,
  UINTN FatSize,

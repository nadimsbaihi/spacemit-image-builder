# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/FileName.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/FileName.c"
# 9 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/FileName.c"
...
# 10 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/FileName.c" 2
# 24 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/FileName.c"
BOOLEAN
FatCheckIs8Dot3Name (
  CHAR16 *FileName,
  CHAR8 *File8Dot3Name
  )
{
  ...
  if (FatStrToFat (ExtendName, ExtendNameLen, File8Dot3Name + 8)) {
    PossibleShortName = ((BOOLEAN)(0==1));
  }

  return PossibleShortName;
}
# 110 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/FileName.c"
static
UINTN
...
# 135 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/FileName.c"
void
FatNameToStr (
  CHAR8 *FatName,
  UINTN Len,
...
# 168 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/FileName.c"
void
FatCreate8Dot3Name (
  FAT_OFILE *Parent,
  FAT_DIRENT *DirEnt
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (Parent->ODir->EndOfDir); } } while (((BOOLEAN)(0==1)));
  ShortName = DirEnt->Entry.FileName;




  BaseTagLen = FatTrimAsciiTrailingBlanks (ShortName, 8);
  if (BaseTagLen > 6) {
    BaseTagLen = 6;
  }
  ...
  *ShortNameChar = '1';
  Retry = 0;
  while (*FatShortNameHashSearch (Parent->ODir, ShortName) != ((void *) 0)) {
    *ShortNameChar = (CHAR8)(*ShortNameChar + 1);
    if (++Retry == 4) {



      do { if (((BOOLEAN)(0==1))) { (void) (DirEnt->FileString != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
...
# 248 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/FileName.c"
static
UINT8
FatCheckNameCase (
  CHAR16 *Str,
...
# 292 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/FileName.c"
void
FatSetCaseFlag (
  FAT_DIRENT *DirEnt
  )
{
  CHAR16 LfnBuffer[8 + 1 + 3 + 1];
  CHAR16 *TempCharPtr;
  CHAR16 *ExtendName;
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (StrSize (DirEnt->FileString) <= sizeof (LfnBuffer)); } } while (((BOOLEAN)(0==1)));
  ...
  CaseFlag = 0;
  if (ExtendName != ((void *) 0)) {
    *ExtendName = 0;
    ExtendName++;
    CaseFlag = (UINT8)(CaseFlag | FatCheckNameCase (ExtendName, 0x10));
  }

  CaseFlag = (UINT8)(CaseFlag | FatCheckNameCase (LfnBuffer, 0x08));
  if ((CaseFlag & 0x01) == 0) {
...
# 347 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/FileName.c"
void
FatGetFileNameViaCaseFlag (
  FAT_DIRENT *DirEnt,
  CHAR16 *FileString,
  ...
  )
{
  ...
  FatNameToStr (File8Dot3Name, 8, CaseFlag & 0x08, FileString);
  FatNameToStr (File8Dot3Name + 8, 3, CaseFlag & 0x10, &TempExt[1]);
  if (TempExt[1] != 0) {
    TempExt[0] = L'.';
    StrCatS (FileString, FileStringMax, TempExt);
  }
}
# 381 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/FileName.c"
UINT8
FatCheckSum (
  CHAR8 *ShortNameString
  )
{
  ...
  Sum = 0;
  for (ShortNameLen = (8 + 3); ShortNameLen != 0; ShortNameLen--) {
    Sum = (UINT8)((((Sum & 1) != 0) ? 0x80 : 0) + (Sum >> 1) + *ShortNameString++);
  }

  return Sum;
}
# 409 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/FileName.c"
CHAR16 *
FatGetNextNameComponent (
  CHAR16 *Path,
  CHAR16 *Name
...
# 443 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/FileName.c"
BOOLEAN
FatFileNameIsValid (
  CHAR16 *InputFileName,
  CHAR16 *OutputFileName
  )
{
  ...
  *TempNamePointer = 0;
  ...
  if (TempNamePointer - OutputFileName > 255) {
    return ((BOOLEAN)(0==1));
  }

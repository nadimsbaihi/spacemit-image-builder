# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Misc.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Misc.c"
# 10 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Misc.c"
...
# 11 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Misc.c" 2
UINT8 mMonthDays[] = { 31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31 };
# 23 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Misc.c"
FAT_TASK *
FatCreateTask (
  FAT_IFILE *IFile,
  EFI_FILE_IO_TOKEN *Token
...
# 50 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Misc.c"
void
FatDestroyTask (
  FAT_TASK *Task
  )
{
  ...
  while (!IsNull (&Task->Subtasks, Link)) {
    Subtask = (((FAT_SUBTASK *) (void *) ((CHAR8 *) (Link) - ((UINTN) __builtin_offsetof(FAT_SUBTASK, Link))))->Signature != ((('f') | ('a' << 8)) | ((('t') | ('S' << 8)) << 16))) ? ((void *) 0) : ((FAT_SUBTASK *) (void *) ((CHAR8 *) (Link) - ((UINTN) __builtin_offsetof(FAT_SUBTASK, Link))));
    Link = FatDestroySubtask (Subtask);
  }

  FreePool (Task);
}
# 74 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Misc.c"
void
FatWaitNonblockingTask (
  FAT_IFILE *IFile
  )
...
# 97 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Misc.c"
LIST_ENTRY *
FatDestroySubtask (
  FAT_SUBTASK *Subtask
  )
...
# 123 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Misc.c"
EFI_STATUS
FatQueueTask (
  FAT_IFILE *IFile,
  FAT_TASK *Task
  )
{
  ...
  if (IsListEmpty (&Task->Subtasks)) {
    Task->FileIoToken->Status = (RETURN_STATUS)(0);
...
# 157 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Misc.c"
...
# 229 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Misc.c"
EFI_STATUS
FatAccessVolumeDirty (
  FAT_VOLUME *Volume,
  IO_MODE IoMode,
  ...
  )
{
  ...
  return FatDiskIo (Volume, IoMode, Volume->FatPos + WriteCount, WriteCount, DirtyValue, ((void *) 0));
}
# 250 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Misc.c"
void
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (EfiGetCurrentTpl () == FatTaskLock.Tpl); } } while (((BOOLEAN)(0==1)));

  Subtask = (FAT_SUBTASK *)Context;
  Task = Subtask->Task;
  Status = Subtask->DiskIo2Token.TransactionStatus;

  do { if (((BOOLEAN)(0==1))) { (void) (Task->Signature == ((('f') | ('a' << 8)) | ((('t') | ('T' << 8)) << 16))); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { (void) (Subtask->Signature == ((('f') | ('a' << 8)) | ((('t') | ('S' << 8)) << 16))); } } while (((BOOLEAN)(0==1)));
  ...
  if (Task->FileIoToken != ((void *) 0)) {
    if (IsListEmpty (&Task->Subtasks) || (((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
...
# 314 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Misc.c"
EFI_STATUS
FatDiskIo (
  FAT_VOLUME *Volume,
  IO_MODE IoMode,
  ...
  )
{
  ...
  if (Offset + BufferSize <= Volume->VolumeSize) {
    if (((IoMode) >= 2)) {
      ...
      Status = FatAccessCache (Volume, ((CACHE_DATA_TYPE)((IoMode) >> 2)), ((IO_MODE)((IoMode) & 0x1)), Offset, BufferSize, Buffer, Task);
    } else {
      ...
      if (Task == ((void *) 0)) {
        ...
        if (Subtask == ((void *) 0)) {
          ...
          Subtask->Signature = ((('f') | ('a' << 8)) | ((('t') | ('S' << 8)) << 16));
          Subtask->Task = Task;
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    Volume->DiskError = ((BOOLEAN)(1==1));
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "FatDiskIo: error %r\n", Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  }
...
# 412 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Misc.c"
EFI_STATUS
FatAcquireLockOrFail (
  void
  )
...
# 440 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Misc.c"
void
FatFreeDirEnt (
  FAT_DIRENT *DirEnt
  )
...
# 459 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Misc.c"
void
FatFreeVolume (
  FAT_VOLUME *Volume
  )
...
# 486 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Misc.c"
void
FatEfiTimeToFatTime (
  EFI_TIME *ETime,
  FAT_DATE_TIME *FTime
  )
{
  ...
  if (ETime->Year >= 1980 + 0x7f) {
    FTime->Date.Year = 0x7f;
  }
...
# 518 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Misc.c"
void
FatFatTimeToEfiTime (
  FAT_DATE_TIME *FTime,
  EFI_TIME *ETime
  )
{
  ...
  ETime->Nanosecond = 0;
  ETime->TimeZone = 0x07FF;
  ETime->Daylight = 0;
}
# 542 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Misc.c"
void
FatGetCurrentFatTime (
...
# 572 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Misc.c"
BOOLEAN
FatIsValidTime (
  EFI_TIME *Time
  )

# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Open.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Open.c"
# 9 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Open.c"
...
# 10 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Open.c" 2
# 23 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Open.c"
EFI_STATUS
FatAllocateIFile (
  FAT_OFILE *OFile,
  FAT_IFILE **PtrIFile
  )
{
  ...
  IFile->Signature = ((('f') | ('a' << 8)) | ((('t') | ('i' << 8)) << 16));
  ...
  if (OFile->Volume->DiskIo2 != ((void *) 0)) {
    IFile->Handle.Revision = 0x00020000;
  } else {
    IFile->Handle.Revision = 0x00010000;
  }
...
# 84 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Open.c"
EFI_STATUS
FatOFileOpen (
  FAT_OFILE *OFile,
  FAT_IFILE **NewIFile,
  ...
  )
{
  ...
  Volume = OFile->Volume;
  ;
  WriteMode = (BOOLEAN)(OpenMode & 0x0000000000000002ULL);
  ...
  if (*NewFileName != 0) {
    ...
    if ((OpenMode & 0x8000000000000000ULL) == 0) {
    ...
    do { if (((BOOLEAN)(0==1))) { (void) (DirEnt != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
  ...
  if (((FileAttributes & 0x0000000000000001ULL) != 0) && ((FileAttributes & 0x10) == 0) && WriteMode) {
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "FSOpen: Open '%S' %r\n", FileName, Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  return FatOFileFlush (OFile);
}
# 198 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Open.c"
EFI_STATUS
  ...
  )
{
  ...
  switch (OpenMode) {
    ...
    case 0x0000000000000001ULL | 0x0000000000000002ULL:
    case 0x0000000000000001ULL | 0x0000000000000002ULL | 0x8000000000000000ULL:
      break;
  ...
  if (((OpenMode & 0x8000000000000000ULL) != 0) && ((Attributes & (0x0000000000000001ULL | (~0x0000000000000037ULL))) != 0)) {
    return ((RETURN_STATUS)(0x8000000000000000ULL | (2)));
  }
  ...
  Status = FatCleanupVolume (OFile->Volume, ((void *) 0), Status, Task);
  FatReleaseLock ();
...
# 316 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Open.c"
EFI_STATUS
...
{
  return FatOpenEx (FHand, NewHandle, FileName, OpenMode, Attributes, ((void *) 0));
}

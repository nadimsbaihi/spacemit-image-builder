# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/DiskCache.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/DiskCache.c"
# 9 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/DiskCache.c"
...
# 10 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/DiskCache.c" 2
...
{
  if (CacheTag == ((void *) 0)) {
    do { if (((BOOLEAN)(0==1))) { (void) (CacheTag != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
    return;
  }

  ZeroMem (CacheTag->DirtyBlocks, sizeof (CacheTag->DirtyBlocks));
  CacheTag->Dirty = ((BOOLEAN)(0==1));
}
# 40 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/DiskCache.c"
static
void
SetBitInDirtyBlock (
  UINTN BitNumber,
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (BitNumber < ((1 << 16) / (1 << 9))); } } while (((BOOLEAN)(0==1)));

  BlockIndex = BitNumber / ((sizeof (DIRTY_BLOCKS) * 8));
  BitIndex = BitNumber % ((sizeof (DIRTY_BLOCKS) * 8));
  DirtyBlocks[BlockIndex] |= LShiftU64 (1ull, BitIndex);
}
# 69 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/DiskCache.c"
static
BOOLEAN
IsBitInBlockDirty (
  UINTN BitNumber,
...
# 96 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/DiskCache.c"
static
void
SetCacheTagDirty (
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (Bit <= LastBit); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { (void) (LastBit <= ((1 << 16) / (1 << 9))); } } while (((BOOLEAN)(0==1)));

  do {
    SetBitInDirtyBlock (Bit, CacheTag->DirtyBlocks);
  } while (++Bit <= LastBit);

  CacheTag->Dirty = ((BOOLEAN)(1==1));
}
# 144 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/DiskCache.c"
static
EFI_STATUS
CacheFatDiskIo (
  CACHE_TAG *CacheTag,
  CACHE_DATA_TYPE DataType,
  FAT_VOLUME *Volume,
  IO_MODE IoMode,
  UINT64 Offset,
  UINTN BufferSize,
  ...
  )
{
  ...
  if ((IoMode == WriteDisk) && (CacheTag->RealSize != 0)) {
    ...
    do { if (((BOOLEAN)(0==1))) { (void) (WriteSize == 0); } } while (((BOOLEAN)(0==1)));
  } else {
...
# 230 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/DiskCache.c"
static
void
...
# 296 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/DiskCache.c"
static
EFI_STATUS
  ...
  )
{
  ...
  if (IoMode == ReadDisk) {
    ...
    if (MaxSize < RealSize) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000040)) { DebugPrint (0x00000040, "FatDiskIo: Cache Page OutBound occurred! \n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
...
# 368 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/DiskCache.c"
static
EFI_STATUS
FatGetCachePage (
  FAT_VOLUME *Volume,
  ...
  )
{
  ...
  if ((CacheTag->RealSize > 0) && CacheTag->Dirty) {
    Status = FatExchangeCachePage (Volume, CacheDataType, WriteDisk, CacheTag, ((void *) 0));
    if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
      return Status;
    }
  }
  ...
  Status = FatExchangeCachePage (Volume, CacheDataType, ReadDisk, CacheTag, ((void *) 0));

  return Status;
}
# 424 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/DiskCache.c"
static
EFI_STATUS
...
# 492 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/DiskCache.c"
EFI_STATUS
FatAccessCache (
  FAT_VOLUME *Volume,
  CACHE_DATA_TYPE CacheDataType,
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (Volume->CacheBuffer != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
  ...
  if (AlignedPageCount > 0) {
    ...
    do { if (((BOOLEAN)(0==1))) { (void) (CacheDataType == CacheData); } } while (((BOOLEAN)(0==1)));
...
# 594 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/DiskCache.c"
EFI_STATUS
FatVolumeFlushCache (
  FAT_VOLUME *Volume,
  FAT_TASK *Task
...
# 648 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/DiskCache.c"
EFI_STATUS
FatInitializeDiskCache (
  FAT_VOLUME *Volume
  )
{
  ...
  if (Volume->FatType == Fat12) {
    FatCacheGroupCount = 1;
    DiskCache[CacheFat].PageAlignment = 13;
    DiskCache[CacheData].PageAlignment = 13;
  } else {
    FatCacheGroupCount = 16;
    DiskCache[CacheFat].PageAlignment = 15;
    DiskCache[CacheData].PageAlignment = 16;
  }

  DiskCache[CacheData].GroupMask = 64 - 1;
  ...
  DataCacheSize = 64 << DiskCache[CacheData].PageAlignment;



  CacheBuffer = AllocateZeroPool (FatCacheSize + DataCacheSize);
  if (CacheBuffer == ((void *) 0)) {

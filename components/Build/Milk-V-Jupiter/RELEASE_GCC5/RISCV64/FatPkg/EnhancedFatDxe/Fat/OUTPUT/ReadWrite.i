# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/ReadWrite.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/ReadWrite.c"
# 10 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/ReadWrite.c"
...
# 11 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/ReadWrite.c" 2
# 25 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/ReadWrite.c"
EFI_STATUS
  ...
  )
{
  ...
  if (OFile->Error == ((RETURN_STATUS)(0x8000000000000000ULL | (14)))) {
...
# 62 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/ReadWrite.c"
EFI_STATUS
...
# 121 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/ReadWrite.c"
EFI_STATUS
FatIFileReadDir (
  FAT_IFILE *IFile,
  UINTN *BufferSize,
  ...
  )
{
  ...
  do {
    ...
    if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) || (DirEnt == ((void *) 0))) {
...
# 198 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/ReadWrite.c"
EFI_STATUS
FatIFileAccess (
  EFI_FILE_PROTOCOL *FHand,
  IO_MODE IoMode,
  ...
  )
{
  ...
  if ((OFile->ODir != ((void *) 0)) && (IoMode == WriteData)) {
    return ((RETURN_STATUS)(0x8000000000000000ULL | (3)));
  }
...
Done:
# 335 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/ReadWrite.c"
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    Status = FatCleanupVolume (Volume, OFile, Status, ((void *) 0));
  }

  FatReleaseLock ();
  return Status;
}
# 358 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/ReadWrite.c"
EFI_STATUS
...
{
  return FatIFileAccess (FHand, ReadData, BufferSize, Buffer, ((void *) 0));
}
# 382 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/ReadWrite.c"
EFI_STATUS
...
# 409 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/ReadWrite.c"
EFI_STATUS
...
{
  return FatIFileAccess (FHand, WriteData, BufferSize, Buffer, ((void *) 0));
}
# 433 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/ReadWrite.c"
EFI_STATUS
...
# 459 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/ReadWrite.c"
EFI_STATUS
FatAccessOFile (
  FAT_OFILE *OFile,
  IO_MODE IoMode,
  ...
  )
{
  ...
  while (BufferSize > 0) {
    ...
    do { if (((BOOLEAN)(0==1))) { (void) (Position <= OFile->FileSize); } } while (((BOOLEAN)(0==1)));
  }
...
# 536 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/ReadWrite.c"
EFI_STATUS
FatExpandOFile (
  FAT_OFILE *OFile,
  UINT64 ExpandedSize
...
# 566 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/ReadWrite.c"
EFI_STATUS
FatWriteZeroPool (
  FAT_OFILE *OFile,
  UINTN WritePos
  )
{
  ...
  do {
    ...
    Status = FatAccessOFile (OFile, WriteData, WritePos, &WriteSize, ZeroBuffer, ((void *) 0));
    if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
      break;
    }
...
# 621 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/ReadWrite.c"
EFI_STATUS
FatTruncateOFile (
  FAT_OFILE *OFile,
  UINTN TruncatedSize

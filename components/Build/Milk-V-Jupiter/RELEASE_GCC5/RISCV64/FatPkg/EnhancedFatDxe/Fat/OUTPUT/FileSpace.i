# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/FileSpace.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/FileSpace.c"
# 11 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/FileSpace.c"
...
# 12 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/FileSpace.c" 2
# 23 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/FileSpace.c"
static
void *
FatLoadFatEntry (
  FAT_VOLUME *Volume,
...
# 83 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/FileSpace.c"
static
UINTN
FatGetFatEntry (
  FAT_VOLUME *Volume,
  ...
  )
{
  ...
  switch (Volume->FatType) {
    case Fat12:
      ...
      Accum = (((Index) & 1) != 0) ? (Accum >> 4) : (Accum & 0xFFF);
      Accum = Accum | ((Accum >= 0xFF7) ? (((UINTN)0xFFFFFFFFFFFFFFFFULL) & (~0xF)) : 0);
      break;

    case Fat16:
      En16 = Pos;
      Accum = *En16;
      Accum = Accum | ((Accum >= 0xFFF7) ? (((UINTN)0xFFFFFFFFFFFFFFFFULL) & (~0xF)) : 0);
      break;

    default:
      En32 = Pos;
      Accum = *En32 & 0x0FFFFFFF;
      Accum = Accum | ((Accum >= 0x0FFFFFF7) ? (((UINTN)0xFFFFFFFFFFFFFFFFULL) & (~0xF)) : 0);
  }

  return Accum;
}
# 138 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/FileSpace.c"
static
EFI_STATUS
FatSetFatEntry (
  FAT_VOLUME *Volume,
  ...
  )
{
  ...
  switch (Volume->FatType) {
    ...
    default:
      En32 = Pos;
      *En32 = (*En32 & 0xF0000000) | (UINT32)(Value & 0x0FFFFFFF);
  }
...
# 239 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/FileSpace.c"
static
EFI_STATUS
FatFreeClusters (
  FAT_VOLUME *Volume,
  ...
  )
{
  ...
  while (!((Cluster) > ((((((UINTN)0xFFFFFFFFFFFFFFFFULL) & (~0xF))) | 0x07)))) {
    if ((Cluster == 0) || (Cluster >= (((((UINTN)0xFFFFFFFFFFFFFFFFULL) & (~0xF))) | 0x07))) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000001 | 0x80000000)) { DebugPrint (0x00000001 | 0x80000000, "FatShrinkEof: cluster chain corrupt\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
      return ((RETURN_STATUS)(0x8000000000000000ULL | (10)));
    }

    LastCluster = Cluster;
    Cluster = FatGetFatEntry (Volume, Cluster);
    FatSetFatEntry (Volume, LastCluster, 0);
  }

  return (RETURN_STATUS)(0);
}
# 271 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/FileSpace.c"
static
UINTN
FatAllocateCluster (
  FAT_VOLUME *Volume
  ...
  for ( ; ;) {
    ...
    if (Volume->FatInfoSector.FreeInfo.NextCluster > (Volume->MaxCluster + 1)) {
      if (Volume->FreeInfoValid && (0 < (INT32)(Volume->FatInfoSector.FreeInfo.ClusterCount))) {
        Volume->FreeInfoValid = ((BOOLEAN)(0==1));
      }
...
# 327 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/FileSpace.c"
static
UINTN
FatSizeToClusters (
  FAT_VOLUME *Volume,
...
# 354 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/FileSpace.c"
EFI_STATUS
FatShrinkEof (
  FAT_OFILE *OFile
  )
{
  ...
  if (NewSize != 0) {
    ...
    FatSetFatEntry (Volume, LastCluster, (UINTN)(-1));
  } else {
  ...
  OFile->Dirty = ((BOOLEAN)(1==1));



  return FatFreeClusters (Volume, Cluster);
}
# 428 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/FileSpace.c"
EFI_STATUS
FatGrowEof (
  FAT_OFILE *OFile,
  UINT64 NewSizeInBytes
  )
{
  ...
  if (CurSize < NewSize) {
    ...
    if ((OFile->FileCluster != 0) && (OFile->FileLastCluster == 0)) {
      ...
      while (!((Cluster) > ((((((UINTN)0xFFFFFFFFFFFFFFFFULL) & (~0xF))) | 0x07)))) {
        if ((Cluster < 2) || (Cluster > Volume->MaxCluster + 1)) {
          do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000001 | 0x80000000)) { DebugPrint (0x00000001 | 0x80000000, "FatGrowEof: cluster chain corrupt\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
      ...
      if (ClusterCount != CurSize) {
        do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000001 | 0x80000000)) { DebugPrint (0x00000001 | 0x80000000, "FatGrowEof: cluster chain size does not match file size\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
    ...
    while (CurSize < NewSize) {
      ...
      if (((NewCluster) > ((((((UINTN)0xFFFFFFFFFFFFFFFFULL) & (~0xF))) | 0x07)))) {
        if (LastCluster != 0) {
          FatSetFatEntry (Volume, LastCluster, (UINTN)(-1));
          OFile->FileLastCluster = LastCluster;
        }

        Status = ((RETURN_STATUS)(0x8000000000000000ULL | (11)));
        goto Done;
      }

      if ((NewCluster < 2) || (NewCluster > Volume->MaxCluster + 1)) {
        Status = ((RETURN_STATUS)(0x8000000000000000ULL | (10)));
        goto Done;
      }
      ...
      CurSize += 1;
# 534 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/FileSpace.c"
      FatSetFatEntry (Volume, LastCluster, (UINTN)(-1));
      OFile->FileLastCluster = LastCluster;
    }
  }
...
# 561 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/FileSpace.c"
EFI_STATUS
FatOFilePosition (
  FAT_OFILE *OFile,
  UINTN Position,
...
# 599 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/FileSpace.c"
    ...
    while (StartPos + ClusterSize <= Position) {
      ...
      if ((Cluster == 0) || (Cluster >= (((((UINTN)0xFFFFFFFFFFFFFFFFULL) & (~0xF))) | 0x07))) {
        do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000001 | 0x80000000)) { DebugPrint (0x00000001 | 0x80000000, "FatOFilePosition:" " cluster chain corrupt\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
        return ((RETURN_STATUS)(0x8000000000000000ULL | (10)));
      }
    ...
    OFile->PosDisk = Volume->FirstClusterPos +
                     LShiftU64 (Cluster - 2, Volume->ClusterAlignment) +
                     Position - StartPos;
    ...
    if (!((Cluster) > ((((((UINTN)0xFFFFFFFFFFFFFFFFULL) & (~0xF))) | 0x07)))) {
...
# 653 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/FileSpace.c"
UINTN
FatPhysicalDirSize (
  FAT_VOLUME *Volume,
  UINTN Cluster
  )
{
  ...
  if (Cluster != 0) {
    while (!((Cluster) > ((((((UINTN)0xFFFFFFFFFFFFFFFFULL) & (~0xF))) | 0x07)))) {
      if ((Cluster == 0) || (Cluster >= (((((UINTN)0xFFFFFFFFFFFFFFFFULL) & (~0xF))) | 0x07))) {
        do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000001 | 0x80000000)) { DebugPrint (0x00000001 | 0x80000000, "FATDirSize: cluster chain corrupt\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
...
# 698 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/FileSpace.c"
UINT64
FatPhysicalFileSize (
  FAT_VOLUME *Volume,
  UINTN RealSize
...
# 719 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/FileSpace.c"
void
FatComputeFreeInfo (
  FAT_VOLUME *Volume
  )
{
  ...
  if (!Volume->FreeInfoValid) {
    ...
    for (Index = Volume->MaxCluster + 1; Index >= 2; Index--) {
      if (Volume->DiskError) {
        break;
      }

      if (FatGetFatEntry (Volume, Index) == 0) {
        Volume->FatInfoSector.FreeInfo.ClusterCount += 1;
        Volume->FatInfoSector.FreeInfo.NextCluster = (UINT32)Index;
      }
    }

    Volume->FatInfoSector.Signature = 0x41615252;

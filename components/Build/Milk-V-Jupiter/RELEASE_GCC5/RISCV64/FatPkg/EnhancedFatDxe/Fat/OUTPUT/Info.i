# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Info.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Info.c"
# 11 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Info.c"
...
# 12 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Info.c" 2
# 25 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Info.c"
EFI_STATUS
FatGetVolumeInfo (
  FAT_VOLUME *Volume,
  UINTN *BufferSize,
...
# 46 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Info.c"
EFI_STATUS
FatSetVolumeInfo (
  FAT_VOLUME *Volume,
  UINTN BufferSize,
...
# 67 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Info.c"
EFI_STATUS
FatSetOrGetInfo (
  BOOLEAN IsSet,
  EFI_FILE_PROTOCOL *FHand,
...
# 88 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Info.c"
EFI_STATUS
FatGetFileInfo (
  FAT_OFILE *OFile,
  UINTN *BufferSize,
...
# 110 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Info.c"
EFI_STATUS
FatGetVolumeInfo (
  FAT_VOLUME *Volume,
  UINTN *BufferSize,
  ...
  )
{
  ...
  Size = ((UINTN) __builtin_offsetof(EFI_FILE_SYSTEM_INFO, VolumeLabel));
  ...
  if (*BufferSize >= ResultSize) {
    ...
    Info = Buffer;
    ZeroMem (Info, ((UINTN) __builtin_offsetof(EFI_FILE_SYSTEM_INFO, VolumeLabel)));
...
# 170 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Info.c"
EFI_STATUS
  ...
  )
{
  ...
  Size = ((UINTN) __builtin_offsetof(EFI_FILE_SYSTEM_VOLUME_LABEL, VolumeLabel));
  Status = FatGetVolumeEntry (Volume, Name);
  NameSize = StrSize (Name);
  ResultSize = Size + NameSize;
...
# 212 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Info.c"
EFI_STATUS
FatSetVolumeInfo (
  FAT_VOLUME *Volume,
  UINTN BufferSize,
  ...
  )
{
  ...
  if ((BufferSize < ((UINTN) __builtin_offsetof(EFI_FILE_SYSTEM_INFO, VolumeLabel)) + 2) || (Info->Size > BufferSize)) {
    return ((RETURN_STATUS)(0x8000000000000000ULL | (4)));
  }

  return FatSetVolumeEntry (Volume, Info->VolumeLabel);
}
# 244 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Info.c"
EFI_STATUS
  ...
  )
{
  ...
  if (BufferSize < ((UINTN) __builtin_offsetof(EFI_FILE_SYSTEM_VOLUME_LABEL, VolumeLabel)) + 2) {
    return ((RETURN_STATUS)(0x8000000000000000ULL | (4)));
  }

  return FatSetVolumeEntry (Volume, Info->VolumeLabel);
}
# 286 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Info.c"
EFI_STATUS
FatSetFileInfo (
  FAT_VOLUME *Volume,
  FAT_IFILE *IFile,
  ...
  )
{
  ...
  NewInfo = Buffer;
  if ((BufferSize < ((UINTN) __builtin_offsetof(EFI_FILE_INFO, FileName)) + 2) || (NewInfo->Size > BufferSize)) {
    return ((RETURN_STATUS)(0x8000000000000000ULL | (4)));
  }

  ReadOnly = (BOOLEAN)(IFile->ReadOnly || (DirEnt->Entry.Attributes & 0x0000000000000001ULL));
  ...
  if (CompareMem (&ZeroTime, &NewInfo->ModificationTime, sizeof (EFI_TIME)) != 0) {
    ...
    OFile->PreserveLastModification = ((BOOLEAN)(1==1));
  }

  if (NewInfo->Attribute & (~0x0000000000000037ULL)) {
    return ((RETURN_STATUS)(0x8000000000000000ULL | (2)));
  }
  ...
  if ((NewAttribute ^ DirEnt->Entry.Attributes) & 0x0000000000000010ULL) {
    return ((RETURN_STATUS)(0x8000000000000000ULL | (15)));
  }
  ...
  DirEnt->Entry.Attributes = (UINT8)((DirEnt->Entry.Attributes &~0x0000000000000037ULL) | NewAttribute);
  ...
  if (*NewFileName != 0) {
    ...
    if (OFile->ODir != ((void *) 0)) {
      ...
      do { if (((BOOLEAN)(0==1))) { (void) (OFile->Parent != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
      for (DotOFile = OFile; DotOFile != OFile->Parent->Parent; DotOFile = DotOFile->Parent) {
        Status = FatGetNextDirEnt (OFile, &DirEnt);
        if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL) || (DirEnt == ((void *) 0)) || !FatIsDotDirEnt (DirEnt)) {
...
# 486 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Info.c"
EFI_STATUS
FatSetOrGetInfo (
  BOOLEAN IsSet,
  EFI_FILE_PROTOCOL *FHand,
  ...
  )
{
  ...
  IFile = (((FAT_IFILE *) (void *) ((CHAR8 *) (FHand) - ((UINTN) __builtin_offsetof(FAT_IFILE, Handle))))->Signature != ((('f') | ('a' << 8)) | ((('t') | ('i' << 8)) << 16))) ? ((void *) 0) : ((FAT_IFILE *) (void *) ((CHAR8 *) (FHand) - ((UINTN) __builtin_offsetof(FAT_IFILE, Handle))));
  OFile = IFile->OFile;
  Volume = OFile->Volume;
  ...
  if (!(((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    ...
    if (IsSet) {
      if (CompareGuid (Type, &gEfiFileInfoGuid)) {
        Status = Volume->ReadOnly ? ((RETURN_STATUS)(0x8000000000000000ULL | (8))) : FatSetFileInfo (Volume, IFile, OFile, *BufferSize, Buffer);
      }

      if (CompareGuid (Type, &gEfiFileSystemInfoGuid)) {
        Status = Volume->ReadOnly ? ((RETURN_STATUS)(0x8000000000000000ULL | (8))) : FatSetVolumeInfo (Volume, *BufferSize, Buffer);
      }

      if (CompareGuid (Type, &gEfiFileSystemVolumeLabelInfoIdGuid)) {
        Status = Volume->ReadOnly ? ((RETURN_STATUS)(0x8000000000000000ULL | (8))) : FatSetVolumeLabelInfo (Volume, *BufferSize, Buffer);
      }
    } else {
      if (CompareGuid (Type, &gEfiFileInfoGuid)) {
  ...
  Status = FatCleanupVolume (Volume, ((void *) 0), Status, ((void *) 0));

  FatReleaseLock ();
  return Status;
}
# 567 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Info.c"
EFI_STATUS
...
{
  return FatSetOrGetInfo (((BOOLEAN)(0==1)), FHand, Type, BufferSize, Buffer);
}
# 592 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Info.c"
EFI_STATUS
...
{
  return FatSetOrGetInfo (((BOOLEAN)(1==1)), FHand, Type, &BufferSize, Buffer);
}

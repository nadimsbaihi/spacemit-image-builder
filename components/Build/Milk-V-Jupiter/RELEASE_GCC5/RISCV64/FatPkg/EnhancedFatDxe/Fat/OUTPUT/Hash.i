# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Hash.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Hash.c"
# 9 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Hash.c"
...
# 10 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Hash.c" 2
# 20 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Hash.c"
static
UINT32
FatHashLongName (
  CHAR16 *LongNameString
...
{
  UINT32 HashValue;
  CHAR16 UpCasedLongFileName[260];
  ...
  return (HashValue & (0x400 - 1));
}
# 49 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Hash.c"
static
UINT32
FatHashShortName (
  CHAR8 *ShortNameString
  )
{
  ...
  gBS->CalculateCrc32 (ShortNameString, (8 + 3), &HashValue);
  return (HashValue & (0x400 - 1));
}
# 71 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Hash.c"
FAT_DIRENT **
FatLongNameHashSearch (
  FAT_ODIR *ODir,
  CHAR16 *LongNameString
...
# 102 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Hash.c"
FAT_DIRENT **
FatShortNameHashSearch (
  FAT_ODIR *ODir,
  CHAR8 *ShortNameString
  )
{
  ...
  {
    if (CompareMem (ShortNameString, (*PreviousHashNode)->Entry.FileName, (8 + 3)) == 0) {
      break;
    }
  }
...
# 131 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Hash.c"
void
FatInsertToHashTable (
  FAT_ODIR *ODir,
  FAT_DIRENT *DirEnt
...
# 164 "/home/kapoagaeming/spacemit-image-builder/components/edk2/FatPkg/EnhancedFatDxe/Hash.c"
void
FatDeleteFromHashTable (
  FAT_ODIR *ODir,
  FAT_DIRENT *DirEnt

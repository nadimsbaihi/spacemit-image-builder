# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Directory.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Directory.c"
# 9 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Directory.c"
...
# 10 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Directory.c" 2
...
# 12 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Directory.c" 2
# 23 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Directory.c"
EFI_STATUS
Ext4GetUcs2DirentName (
  EXT4_DIR_ENTRY *Entry,
  CHAR16 Ucs2FileName[255 + 1]
  )
{
  ...
  Status = StrCpyS (Ucs2FileName, 255 + 1, Str);

  FreePool (Str);

  return Status;
}
# 69 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Directory.c"
static
BOOLEAN
Ext4ValidDirent (
  const EXT4_DIR_ENTRY *Dirent
  )
{
  UINTN RequiredSize;

  RequiredSize = Dirent->name_len + 8;

  if (Dirent->rec_len < RequiredSize) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "[ext4] dirent size %lu too small (compared to %lu)\n", Dirent->rec_len, RequiredSize); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    return ((BOOLEAN)(0==1));
  }
...
# 102 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Directory.c"
EFI_STATUS
Ext4RetrieveDirent (
  EXT4_FILE *Directory,
  const CHAR16 *Name,
  ...
  )
{
  ...
  DirInoSize = (LShiftU64(Inode->i_size_hi, 32) | Inode->i_size_lo);
  ...
  while (Off < DirInoSize) {
    ...
    for (BlockOffset = 0; BlockOffset < Partition->BlockSize; ) {
      ...
      {
        ToCopy = (((Entry->rec_len) < (sizeof (EXT4_DIR_ENTRY))) ? (Entry->rec_len) : (sizeof (EXT4_DIR_ENTRY)));
...
# 230 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Directory.c"
EFI_STATUS
Ext4OpenDirent (
  EXT4_PARTITION *Partition,
  UINT64 OpenMode,
  ...
  )
{
  ...
  if (StrCmp (FileName, L".") == 0) {
    ...
    do { if (((BOOLEAN)(0==1))) { (void) (File->Dentry != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
...
# 332 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Directory.c"
EFI_STATUS
Ext4OpenFile (
  EXT4_FILE *Directory,
  const CHAR16 *Name,
...
# 378 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Directory.c"
EFI_STATUS
  ...
  )
{
  ...
  Status = Ext4ReadInode (Partition, 2, &RootInode);

  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "[ext4] Could not open root inode - error %r\n", Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    return Status;
  }
  ...
  *Root = &RootDir->Protocol;
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (Partition->RootDentry != ((void *) 0)); } } while (((BOOLEAN)(0==1)));
...
# 442 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Directory.c"
EFI_STATUS
Ext4ReadDir (
  EXT4_PARTITION *Partition,
  EXT4_FILE *File,
  ...
  )
{
  ...
  DirIno = File->Inode;
  Status = (RETURN_STATUS)(0);
  DirInoSize = (LShiftU64(DirIno->i_size_hi, 32) | DirIno->i_size_lo);
  ...
  while (((BOOLEAN)(1==1))) {
    ...
    if (!Ext4ValidDirent (&Entry)) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "[ext4] Invalid dirent at offset %lu\n", Offset); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
      Status = ((RETURN_STATUS)(0x8000000000000000ULL | (10)));
      goto Out;
    }


    if (Len < (UINTN)(8 + Entry.name_len)) {
      Status = ((RETURN_STATUS)(0x8000000000000000ULL | (10)));
      goto Out;
    }
# 518 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Directory.c"
    ...
    Status = Ext4OpenDirent (Partition, 0x0000000000000001ULL, &TempFile, &Entry, File);
...
Ext4RemoveDentry (
  EXT4_DENTRY *Parent,
  EXT4_DENTRY *ToBeRemoved
  )
{
  do { if (((BOOLEAN)(0==1))) { (void) (IsNodeInList (&ToBeRemoved->ListNode, &Parent->Children)); } } while (((BOOLEAN)(0==1)));
  RemoveEntryList (&ToBeRemoved->ListNode);
}
# 592 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Directory.c"
static
void
Ext4AddDentry (
  EXT4_DENTRY *Parent,
  EXT4_DENTRY *ToBeAdded
  )
{
...
# 613 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Directory.c"
EXT4_DENTRY *
Ext4CreateDentry (
  const CHAR16 *Name,
  EXT4_DENTRY *Parent
  )
{
  ...
  Status = StrCpyS (Dentry->Name, (sizeof (Dentry->Name) / sizeof ((Dentry->Name)[0])), Name);
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000008)) { DebugPrint (0x00000008, "[ext4] Created dentry %s\n", Name); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (OldRef < Dentry->RefCount); } } while (((BOOLEAN)(0==1)));
}
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000008)) { DebugPrint (0x00000008, "[ext4] Deleted dentry %s\n", Dentry->Name); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  FreePool (Dentry);
}
# 695 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Directory.c"
BOOLEAN
Ext4UnrefDentry (
  EXT4_DENTRY *Dentry
  )

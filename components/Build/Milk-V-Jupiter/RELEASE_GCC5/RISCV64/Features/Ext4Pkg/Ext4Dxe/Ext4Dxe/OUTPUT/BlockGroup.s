...
.Ltext0:
	...
	.file 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/Features/Ext4Pkg/Ext4Dxe/Ext4Dxe" "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/BlockGroup.c"
	.section	.text.Ext4GetBlockGroupDesc,"ax",@progbits
	.align	1
	.globl	Ext4GetBlockGroupDesc
	.type	Ext4GetBlockGroupDesc, @function
Ext4GetBlockGroupDesc:
.LFB0:
	.file 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/BlockGroup.c"
	.loc 1 25 1
	.cfi_startproc
	addi	sp,sp,-32
	...
	.cfi_endproc
.LFE0:
	.size	Ext4GetBlockGroupDesc, .-Ext4GetBlockGroupDesc
	.section	.text.Ext4ReadInode,"ax",@progbits
	.align	1
	.globl	Ext4ReadInode
	.type	Ext4ReadInode, @function
Ext4ReadInode:
.LFB1:
	.loc 1 45 1
	.cfi_startproc
...
.L8:
	...
	.loc 1 79 149
	beq	a5,zero,.L9
	.loc 1 79 81 discriminator 1
	ld	a5,-64(s0)
	lw	a5,8(a5)
	slli	s1,a5,32
	srli	s1,s1,32
	.loc 1 79 123 discriminator 1
	ld	a5,-64(s0)
	lw	a5,40(a5)
	.loc 1 79 103 discriminator 1
	slli	a5,a5,32
	srli	a5,a5,32
	li	a1,32
	mv	a0,a5
	call	LShiftU64@plt
	mv	a5,a0
	.loc 1 79 19 discriminator 3
	or	a5,s1,a5
	sd	a5,-40(s0)
	j	.L10
.L9:
	.loc 1 79 161 discriminator 2
	ld	a5,-64(s0)
	lw	a5,8(a5)
	.loc 1 79 19 discriminator 2
	slli	a5,a5,32
	srli	a5,a5,32
	sd	a5,-40(s0)
.L10:
...
.L11:
	...
	ld	a1,-56(s0)
	ld	a0,-88(s0)
	call	Ext4CheckInodeChecksum@plt
	mv	a5,a0
...
.L13:
	...
	.cfi_endproc
.LFE1:
	.size	Ext4ReadInode, .-Ext4ReadInode
	.section	.text.Ext4CalculateBlockGroupDescChecksumMetadataCsum,"ax",@progbits
	.align	1
	.type	Ext4CalculateBlockGroupDescChecksumMetadataCsum, @function
...
.LFB2:
	...
	.cfi_endproc
.LFE2:
	.size	Ext4CalculateBlockGroupDescChecksumMetadataCsum, .-Ext4CalculateBlockGroupDescChecksumMetadataCsum
	.section	.text.Ext4CalculateBlockGroupDescChecksumGdtCsum,"ax",@progbits
	.align	1
	.type	Ext4CalculateBlockGroupDescChecksumGdtCsum, @function
...
.LFB3:
	...
	.cfi_endproc
.LFE3:
	.size	Ext4CalculateBlockGroupDescChecksumGdtCsum, .-Ext4CalculateBlockGroupDescChecksumGdtCsum
	.section	.text.Ext4VerifyBlockGroupDescChecksum,"ax",@progbits
	.align	1
	.globl	Ext4VerifyBlockGroupDescChecksum
	.type	Ext4VerifyBlockGroupDescChecksum, @function
...
.LFB4:
	...
	.loc 1 200 6
	bne	a5,zero,.L19
	.loc 1 200 74 discriminator 1
	ld	a5,-24(s0)
	lw	a5,1076(a5)
	.loc 1 200 93 discriminator 1
	andi	a5,a5,16
	sext.w	a5,a5
	.loc 1 200 59 discriminator 1
	bne	a5,zero,.L19
	.loc 1 201 12
	li	a5,1
	j	.L20
.L19:
	...
	ld	a1,-32(s0)
	ld	a0,-24(s0)
	call	Ext4CalculateBlockGroupDescChecksum
	mv	a5,a0
	mv	a4,a5
	.loc 1 204 106 discriminator 1
	ld	a5,-32(s0)
	lhu	a5,30(a5)
...
.L20:
	...
	.cfi_endproc
.LFE4:
	.size	Ext4VerifyBlockGroupDescChecksum, .-Ext4VerifyBlockGroupDescChecksum
	.section	.text.Ext4CalculateBlockGroupDescChecksum,"ax",@progbits
	.align	1
	.globl	Ext4CalculateBlockGroupDescChecksum
	.type	Ext4CalculateBlockGroupDescChecksum, @function
...
.LFB5:
	...
	ld	a1,-32(s0)
	ld	a0,-24(s0)
	call	Ext4CalculateBlockGroupDescChecksumMetadataCsum
	mv	a5,a0
	j	.L23
.L22:
	.loc 1 224 25
	...
	ld	a1,-32(s0)
	ld	a0,-24(s0)
	call	Ext4CalculateBlockGroupDescChecksumGdtCsum
	mv	a5,a0
	j	.L23
.L24:
	.loc 1 228 10
...
.L23:
	...
	.cfi_endproc
.LFE5:
	.size	Ext4CalculateBlockGroupDescChecksum, .-Ext4CalculateBlockGroupDescChecksum
	.text
.Letext0:
...
.LASF332:
	.string	"Ext4CalculateBlockGroupDescChecksumMetadataCsum"
.LASF240:
...
.LASF331:
	.string	"Ext4CalculateBlockGroupDescChecksumGdtCsum"
.LASF313:
	.string	"DescSize"
.LASF311:
	.string	"NumberBlocks"
...
.LASF329:
	.string	"Ext4CalculateBlockGroupDescChecksum"
.LASF61:
...
.LASF0:
	.string	"/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/BlockGroup.c"

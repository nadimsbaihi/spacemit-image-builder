# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/BlockMap.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/BlockMap.c"
...
# 9 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/BlockMap.c" 2
...
# 28 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/BlockMap.c"
static
EXT4_LOGICAL_BLOCK_TYPE
Ext4DetectBlockType (
  UINT32 LogicalBlock,
  ...
  )
{
  ...
  MinQuadBlock = Entries * Entries * Entries + MinTreblyBlock;
...
# 69 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/BlockMap.c"
UINTN
Ext4GetBlockPath (
  const EXT4_PARTITION *Partition,
  UINT32 LogicalBlock,
  EXT2_BLOCK_NR BlockPath[4]
  )
{
# 86 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/BlockMap.c"
  UINT32 Entries;
...
# 141 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/BlockMap.c"
void
Ext4GetExtentInBlockMap (
  const UINT32 *Buffer,
  const UINT32 IndEntries,
  UINT32 StartIndex,
  EXT4_EXTENT *Extent
  )
{
  ...
  for (Index = StartIndex + 1; Index < IndEntries; Index++) {
    ...
    if ((Buffer[Index] == LastBlock + 1) && (Buffer[Index] != 0)) {
      Count++;
    } else {
      break;
    }
...
# 212 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/BlockMap.c"
EFI_STATUS
Ext4GetBlocks (
  EXT4_PARTITION *Partition,
  EXT4_FILE *File,
  ...
  )
{
  ...
  if (BlockPathLength == 1) {
    ...
    Ext4GetExtentInBlockMap (Inode->i_data, 12, BlockPath[0], Extent);

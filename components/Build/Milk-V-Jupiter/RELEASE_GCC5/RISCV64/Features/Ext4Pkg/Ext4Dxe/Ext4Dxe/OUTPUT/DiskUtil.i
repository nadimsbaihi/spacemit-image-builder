# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/DiskUtil.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/DiskUtil.c"
...
# 8 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/DiskUtil.c" 2
# 19 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/DiskUtil.c"
EFI_STATUS
Ext4ReadDiskIo (
  EXT4_PARTITION *Partition,
  void *Buffer,
...
{
  return Partition->DiskIo->ReadDisk (
                                     Partition->DiskIo,
                                     Partition->BlockIo->Media->MediaId,
                                     Offset,
                                     Length,
                                     Buffer
                                     );
}
# 46 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/DiskUtil.c"
EFI_STATUS
Ext4ReadBlocks (
  EXT4_PARTITION *Partition,
  void *Buffer,
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (NumberBlocks != 0); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { (void) (BlockNumber != 0); } } while (((BOOLEAN)(0==1)));
  ...
  if (DivU64x64Remainder (Offset, BlockNumber, ((void *) 0)) != Partition->BlockSize) {
...
# 88 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/DiskUtil.c"
void *
Ext4AllocAndReadBlocks (
  EXT4_PARTITION *Partition,
  UINTN NumberBlocks,
  ...
  )
{
  ...
  if ((NumberBlocks == 0) || (BlockNumber == 0)) {
    return ((void *) 0);
  }
  ...
  if (Ext4ReadBlocks (Partition, Buf, NumberBlocks, BlockNumber) != (RETURN_STATUS)(0)) {
    FreePool (Buf);
    return ((void *) 0);
  }

# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/BlockGroup.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/BlockGroup.c"
# 10 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/BlockGroup.c"
...
# 11 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/BlockGroup.c" 2
# 20 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/BlockGroup.c"
EXT4_BLOCK_GROUP_DESC *
Ext4GetBlockGroupDesc (
  EXT4_PARTITION *Partition,
  UINT32 BlockGroup
...
# 39 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/BlockGroup.c"
EFI_STATUS
Ext4ReadInode (
  EXT4_PARTITION *Partition,
  EXT4_INO_NR InodeNum,
  ...
  )
{
  ...
  if (!(((InodeNum) > 0) && (InodeNum) <= (Partition->SuperBlock.s_inodes_count))) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "[ext4] Error reading inode: inode number %lu isn't valid\n", InodeNum); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  ...
  InodeTableStart = ((Partition->FeaturesIncompat & 0x00080) != 0) ? (BlockGroup->bg_inode_table_lo | LShiftU64(BlockGroup->bg_inode_table_hi, 32)) : BlockGroup->bg_inode_table_lo
  ...
  Status = Ext4ReadDiskIo (
             ...
             Inode,
             Partition->InodeSize,
             MultU64x32(InodeTableStart, Partition->BlockSize) + MultU64x32 (InodeOffset, Partition->InodeSize)
             );

  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "[ext4] Error reading inode: status %x; inode offset %lx" " inode table start %lu block group %lu\n", Status, InodeOffset, InodeTableStart, BlockGroupNumber); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
  ...
  if (!Ext4CheckInodeChecksum (Partition, Inode, InodeNum)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "[ext4] Inode %llu has invalid checksum (calculated %x)\n", InodeNum, Ext4CalculateInodeChecksum (Partition, Inode, InodeNum)); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
...
# 129 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/BlockGroup.c"
static
UINT16
  ...
  )
{
  ...
  Csum = Ext4CalculateChecksum (Partition, BlockGroupDesc, ((UINTN) __builtin_offsetof(EXT4_BLOCK_GROUP_DESC, bg_checksum)), Csum);
  Csum = Ext4CalculateChecksum (Partition, &Dummy, sizeof (Dummy), Csum);
  Csum =
    Ext4CalculateChecksum (
      Partition,
      &BlockGroupDesc->bg_block_bitmap_hi,
      Partition->DescSize - ((UINTN) __builtin_offsetof(EXT4_BLOCK_GROUP_DESC, bg_block_bitmap_hi)),
      Csum
      );
  return (UINT16)Csum;
}
# 163 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/BlockGroup.c"
static
UINT16
  ...
  )
{
  ...
  Csum = CalculateCrc16Ansi (Partition->SuperBlock.s_uuid, 16, 0xffff);
  Csum = CalculateCrc16Ansi (&BlockGroupNum, sizeof (BlockGroupNum), Csum);
  Csum = CalculateCrc16Ansi (BlockGroupDesc, ((UINTN) __builtin_offsetof(EXT4_BLOCK_GROUP_DESC, bg_checksum)), Csum);
  Csum =
    CalculateCrc16Ansi (
      &BlockGroupDesc->bg_block_bitmap_hi,
      Partition->DescSize - ((UINTN) __builtin_offsetof(EXT4_BLOCK_GROUP_DESC, bg_block_bitmap_hi)),
...
# 193 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/BlockGroup.c"
BOOLEAN
Ext4VerifyBlockGroupDescChecksum (
  const EXT4_PARTITION *Partition,
  const EXT4_BLOCK_GROUP_DESC *BlockGroupDesc,
...
{
  if (!((Partition->FeaturesRoCompat & 0x0400) == 0x0400) && !((Partition->FeaturesRoCompat & 0x0010) == 0x0010)) {
    return ((BOOLEAN)(1==1));
  }

  return Ext4CalculateBlockGroupDescChecksum (Partition, BlockGroupDesc, BlockGroupNum) == BlockGroupDesc->bg_checksum;
}
# 215 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/BlockGroup.c"
UINT16
Ext4CalculateBlockGroupDescChecksum (
  const EXT4_PARTITION *Partition,
  const EXT4_BLOCK_GROUP_DESC *BlockGroupDesc,
  ...
  )
{
  ...
  } else if (((Partition->FeaturesRoCompat & 0x0010) == 0x0010)) {

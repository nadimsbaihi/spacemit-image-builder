# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Superblock.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Superblock.c"
...
# 9 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Superblock.c" 2

static const UINT32 gSupportedCompatFeat = 0x08;

static const UINT32 gSupportedRoCompatFeat =
  0x0020 | 0x0040 |
  0x0008 | 0x0002 |
  0x0010 | 0x0400 | 0x0001;

static const UINT32 gSupportedIncompatFeat =
  0x00080 | 0x01000 |
  0x00200 | 0x00002 |
  0x00040 | 0x04000 |
  0x00100 | 0x00004 | 0x02000;
# 45 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Superblock.c"
BOOLEAN
Ext4SuperblockCheckMagic (
  EFI_DISK_IO_PROTOCOL *DiskIo,
  EFI_BLOCK_IO_PROTOCOL *BlockIo
  )
{
  ...
  Status = DiskIo->ReadDisk (
                     ...
                     1024U + ((UINTN) __builtin_offsetof(EXT4_SUPERBLOCK, s_magic)),
                     sizeof (Magic),
                     &Magic
                     );
...
# 79 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Superblock.c"
BOOLEAN
  ...
  )
{
  ...
  if ((Sb->s_rev_level != 1) && (Sb->s_rev_level != 0)) {
    return ((BOOLEAN)(0==1));
  }

  if ((Sb->s_state & 0x1) == 0) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000002)) { DebugPrint (0x00000002, "[ext4] Filesystem was not unmounted cleanly\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  }

  return ((BOOLEAN)(1==1));
}
# 107 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Superblock.c"
static
UINT32
  ...
  )
{
  ...
  Checksum = Ext4CalculateChecksum (
               Partition,
               Sb,
               ((UINTN) __builtin_offsetof(EXT4_SUPERBLOCK, s_checksum)),
               ~0U
               );

  return Checksum;
}
# 136 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Superblock.c"
static
BOOLEAN
...
# 157 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Superblock.c"
EFI_STATUS
Ext4OpenSuperblock (
  EXT4_PARTITION *Partition
  )
{
  ...
  if (Partition->FeaturesIncompat & ~gSupportedIncompatFeat) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "[ext4] Unsupported features %lx\n", Partition->FeaturesIncompat & ~gSupportedIncompatFeat); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
  ...
  if (((Partition->FeaturesIncompat & 0x00004) == 0x00004)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000002)) { DebugPrint (0x00000002, "[ext4] Needs journal recovery, mounting read-only\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    Partition->ReadOnly = ((BOOLEAN)(1==1));
  }


  if (((Partition->FeaturesRoCompat & 0x0400) == 0x0400) && (Sb->s_checksum_type != 0x1)) {
    return ((RETURN_STATUS)(0x8000000000000000ULL | (3)));
  }

  if (((Partition->FeaturesIncompat & 0x02000) == 0x02000)) {
  ...
  if (UnsupportedRoCompat != 0) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000002)) { DebugPrint (0x00000002, "[ext4] Unsupported ro compat %x\n", UnsupportedRoCompat); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    Partition->ReadOnly = ((BOOLEAN)(1==1));
  }
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000008)) { DebugPrint (0x00000008, "Read only = %u\n", Partition->ReadOnly); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));

  if (Sb->s_inodes_per_group == 0) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "[ext4] Inodes per group can not be zero\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    return ((RETURN_STATUS)(0x8000000000000000ULL | (10)));
  }

  if (Sb->s_log_block_size > 11) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "[ext4] SuperBlock s_log_block_size %lu is too big\n", Sb->s_log_block_size); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    return ((RETURN_STATUS)(0x8000000000000000ULL | (3)));
  }
  ...
  Partition->NumberBlocks = ((Partition->FeaturesIncompat & 0x00080) != 0) ? (Sb->s_blocks_count | LShiftU64(Sb->s_blocks_count_hi, 32)) : Sb->s_blocks_count;
  Partition->NumberBlockGroups = DivU64x32 (Partition->NumberBlocks, Sb->s_blocks_per_group);

  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000008)) { DebugPrint (0x00000008, "[ext4] Number of blocks = %lu\n[ext4] Number of block groups: %lu\n", Partition->NumberBlocks, Partition->NumberBlockGroups); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
  ...
  if (((Partition->FeaturesIncompat & 0x00080) != 0)) {


    if (((Sb->s_desc_size % 4) != 0) || (Sb->s_desc_size < 64)) {
      return ((RETURN_STATUS)(0x8000000000000000ULL | (10)));
    }

    Partition->DescSize = Sb->s_desc_size;
  } else {
    Partition->DescSize = 32;
  }

  if (!Ext4VerifySuperblockChecksum (Partition, Sb)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "[ext4] Bad superblock checksum %lx\n", Ext4CalculateSuperblockChecksum (Partition, Sb)); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    return ((RETURN_STATUS)(0x8000000000000000ULL | (10)));
  }
  ...
  if (Partition->BlockGroups == ((void *) 0)) {
  ...
  for (Index = 0; Index < Partition->NumberBlockGroups; Index++) {
    ...
    if (!Ext4VerifyBlockGroupDescChecksum (Partition, Desc, Index)) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "[ext4] Block group descriptor %u has an invalid checksum\n", Index); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  ...
  Partition->RootDentry = Ext4CreateDentry (L"\\", ((void *) 0));

  if (Partition->RootDentry == ((void *) 0)) {
    FreePool (Partition->BlockGroups);
    return ((RETURN_STATUS)(0x8000000000000000ULL | (9)));
  }
...
# 343 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Superblock.c"
UINT32
Ext4CalculateChecksum (
  const EXT4_PARTITION *Partition,
  const void *Buffer,

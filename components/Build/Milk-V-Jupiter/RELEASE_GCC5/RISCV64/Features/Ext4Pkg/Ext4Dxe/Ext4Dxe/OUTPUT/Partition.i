# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Partition.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Partition.c"
...
# 9 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Partition.c" 2
# 21 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Partition.c"
EFI_STATUS
Ext4OpenPartition (
  EFI_HANDLE DeviceHandle,
  EFI_DISK_IO_PROTOCOL *DiskIo,
  ...
  )
{
  ...
  Part->Interface.Revision = 0x00010000;
  ...
  )
{
  ...
  File->Protocol.Revision = 0x00010000;
...
# 103 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Partition.c"
EFI_STATUS
Ext4UnmountAndFreePartition (
  EXT4_PARTITION *Partition
  )
{
  ...
  Partition->Unmounting = ((BOOLEAN)(1==1));
  Ext4CloseInternal (Partition->Root);

  for(Entry = (&Partition->OpenFiles)->ForwardLink, NextEntry = Entry->ForwardLink; Entry != (&Partition->OpenFiles); Entry = NextEntry, NextEntry = Entry->ForwardLink) {
    File = ((EXT4_FILE *) (void *) ((CHAR8 *) (Entry) - ((UINTN) __builtin_offsetof(EXT4_FILE, OpenFilesListNode))));
  ...
  if (!DeletedRootDentry) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "[ext4] Failed to delete root dentry - resource leak present.\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  }

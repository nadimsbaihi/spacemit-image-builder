# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Symlink.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Symlink.c"
...
# 9 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Symlink.c" 2
# 17 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Symlink.c"
static
BOOLEAN
...
{
# 32 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Symlink.c"
  UINT32 FileAcl;
  UINT32 ExtAttrBlocks;

  if ((File->Inode->i_flags & 0x00200000) == 0) {
    FileAcl = File->Inode->i_file_acl;
    if (((File->Partition->FeaturesIncompat & 0x00080) != 0)) {
  ...
  return (LShiftU64(File->Inode->i_size_hi, 32) | File->Inode->i_size_lo) <= 15 * sizeof(UINT32);
}
# 64 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Symlink.c"
static
EFI_STATUS
Ext4ReadFastSymlink (
  EXT4_PARTITION *Partition,
  ...
  )
{
  ...
  SymlinkSize = (UINT32)((((LShiftU64(File->Inode->i_size_hi, 32) | File->Inode->i_size_lo)) < (15 * sizeof(UINT32))) ? ((LShiftU64(File->Inode->i_size_hi, 32) | File->Inode->i_size_lo)) : (15 * sizeof(UINT32)));

  AsciiSymlinkTmp = AllocatePool (SymlinkSize + 1);
  if (AsciiSymlinkTmp == ((void *) 0)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "[ext4] Failed to allocate symlink ascii string buffer\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
...
# 114 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Symlink.c"
static
EFI_STATUS
Ext4ReadSlowSymlink (
  EXT4_PARTITION *Partition,
  ...
  )
{
  ...
  SymlinkSizeTmp = (LShiftU64(File->Inode->i_size_hi, 32) | File->Inode->i_size_lo);




  if (SymlinkSizeTmp >= 4096) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000002)) { DebugPrint (0x00000002, "[ext4] Warn: symlink path maximum length was hit!\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
  ...
  if (SymlinkTmp == ((void *) 0)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000008)) { DebugPrint (0x00000008, "[ext4] Failed to allocate symlink ascii string buffer\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    return ((RETURN_STATUS)(0x8000000000000000ULL | (9)));
  }
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000008)) { DebugPrint (0x00000008, "[ext4] Failed to read symlink from blocks with status %r\n", Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    FreePool (SymlinkTmp);
    return Status;
  }

  if (SymlinkSizeTmp != ReadSize) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000008)) { DebugPrint (0x00000008, "[ext4] Error! The size of the read block doesn't match the value from the inode!\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
...
# 191 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Symlink.c"
EFI_STATUS
Ext4ReadSymlink (
  EXT4_PARTITION *Partition,
  EXT4_FILE *File,
  ...
  )
{
  ...
  if ((File->Inode->i_flags & 0x00000800) != 0) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000002)) { DebugPrint (0x00000002, "[ext4] Warn: symlink is encrypted\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000008)) { DebugPrint (0x00000008, "[ext4] Symlink read error with Status %r\n", Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    return Status;
  }

  Symlink16Tmp = AllocatePool (SymlinkSize * sizeof (CHAR16));
  if (Symlink16Tmp == ((void *) 0)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000008)) { DebugPrint (0x00000008, "[ext4] Failed to allocate symlink unicode string buffer\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    FreePool (SymlinkTmp);
    return ((RETURN_STATUS)(0x8000000000000000ULL | (9)));
  }
  ...
  if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000008)) { DebugPrint (0x00000008, "[ext4] Failed to convert ascii symlink to unicode with Status %r\n", Status); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))

# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Inode.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Inode.c"
# 13 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Inode.c"
...
# 14 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Inode.c" 2
# 23 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Inode.c"
UINT32
Ext4CalculateInodeChecksum (
  const EXT4_PARTITION *Partition,
  const EXT4_INODE *Inode,
  ...
  )
{
  ...
  HasSecondChecksumField = (Inode->i_extra_isize + 128U >= ((UINTN) __builtin_offsetof(EXT4_INODE, i_checksum_hi)) + sizeof(((EXT4_INODE *)((void *) 0))->i_checksum_hi));
  ...
  Crc = Ext4CalculateChecksum (
          Partition,
          Inode,
          ((UINTN) __builtin_offsetof(EXT4_INODE, i_osd2.data_linux.l_i_checksum_lo)),
          Crc
          );
  ...
  RestOfInodeLength = Partition->InodeSize - ((UINTN) __builtin_offsetof(EXT4_INODE, i_osd2.data_linux.l_i_reserved));

  if (HasSecondChecksumField) {
    Length = ((UINTN) __builtin_offsetof(EXT4_INODE, i_checksum_hi)) - ((UINTN) __builtin_offsetof(EXT4_INODE, i_osd2.data_linux.l_i_reserved));

    Crc = Ext4CalculateChecksum (Partition, &Inode->i_osd2.data_linux.l_i_reserved, Length, Crc);
    Crc = Ext4CalculateChecksum (Partition, &Dummy, sizeof (Dummy), Crc);


    RestOfInodeLength = Partition->InodeSize - 128U - 4;
...
# 83 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Inode.c"
EFI_STATUS
Ext4Read (
  EXT4_PARTITION *Partition,
  EXT4_FILE *File,
  ...
  )
{
  ...
  Inode = File->Inode;
  InodeSize = (LShiftU64(Inode->i_size_hi, 32) | Inode->i_size_lo);
  CurrentSeek = Offset;
  RemainingRead = *Length;
  BeenRead = 0;

  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000008)) { DebugPrint (0x00000008, "[ext4] Ext4Read(%s, Offset %lu, Length %lu)\n", File->Dentry->Name, Offset, *Length); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
  ...
  while (RemainingRead != 0) {
    ...
    if ((Status != (RETURN_STATUS)(0)) && (Status != ((RETURN_STATUS)(0x8000000000000000ULL | (17))))) {
      return Status;
    }

    HasBackingExtent = Status != ((RETURN_STATUS)(0x8000000000000000ULL | (17)));

    if (!HasBackingExtent || ((&Extent)->ee_len > (1 << 15))) {
      HoleOff = BlockOff;
      ...
      if ((((RETURN_STATUS)(Status)) >= 0x8000000000000000ULL)) {
        do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "[ext4] Error %r reading [%lu, %lu]\n", Status, ExtentStartBytes + ExtentOffset, ExtentStartBytes + ExtentOffset + WasRead - 1); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
...
# 207 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Inode.c"
EXT4_INODE *
Ext4AllocateInode (
  EXT4_PARTITION *Partition
  )
{
  ...
  NeedsToZeroRest = ((BOOLEAN)(0==1));
  InodeSize = Partition->InodeSize;
# 226 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Inode.c"
  if (InodeSize < sizeof (EXT4_INODE)) {
    InodeSize = sizeof (EXT4_INODE);
    NeedsToZeroRest = ((BOOLEAN)(1==1));
  }
...
{
  return (File->Inode->i_mode & 0x4000) == 0x4000;
}
# 265 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Inode.c"
BOOLEAN
Ext4FileIsSymlink (
  const EXT4_FILE *File
  )
{
  return (File->Inode->i_mode & 0xA000) == 0xA000;
}
...
{
  return (File->Inode->i_mode & 0x8000) == 0x8000;
}
  ...
  )
{
  ...
  HugeFile = ((File->Partition->FeaturesRoCompat & 0x0008) == 0x0008);
  ...
  if (HugeFile) {
    ...
    if ((File->Inode->i_flags & 0x00040000) != 0) {
...
# 328 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Inode.c"
static
void
...
# 411 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Inode.c"
void Ext4FileATime ( EXT4_FILE *File, EFI_TIME *Time) { EXT4_INODE *Inode = File->Inode; UINT64 SecondsEpoch = Inode->i_atime; UINT32 Nanoseconds = 0; if ((Inode->i_extra_isize + 128U >= ((UINTN) __builtin_offsetof(EXT4_INODE, i_atime_extra)) + sizeof(((EXT4_INODE *)((void *) 0))->i_atime_extra))) { SecondsEpoch |= LShiftU64 ((UINT64)(Inode->i_atime_extra & ((1 << 2) - 1)), 32); Nanoseconds = Inode->i_atime_extra >> 2; } EpochToEfiTime ((UINTN)SecondsEpoch, Time); Time->Nanosecond = Nanoseconds; };
...
void Ext4FileMTime ( EXT4_FILE *File, EFI_TIME *Time) { EXT4_INODE *Inode = File->Inode; UINT64 SecondsEpoch = Inode->i_mtime; UINT32 Nanoseconds = 0; if ((Inode->i_extra_isize + 128U >= ((UINTN) __builtin_offsetof(EXT4_INODE, i_mtime_extra)) + sizeof(((EXT4_INODE *)((void *) 0))->i_mtime_extra))) { SecondsEpoch |= LShiftU64 ((UINT64)(Inode->i_mtime_extra & ((1 << 2) - 1)), 32); Nanoseconds = Inode->i_mtime_extra >> 2; } EpochToEfiTime ((UINTN)SecondsEpoch, Time); Time->Nanosecond = Nanoseconds; };
...
static
void Ext4FileCrTime ( EXT4_FILE *File, EFI_TIME *Time) { EXT4_INODE *Inode = File->Inode; UINT64 SecondsEpoch = Inode->i_crtime; UINT32 Nanoseconds = 0; if ((Inode->i_extra_isize + 128U >= ((UINTN) __builtin_offsetof(EXT4_INODE, i_crtime_extra)) + sizeof(((EXT4_INODE *)((void *) 0))->i_crtime_extra))) { SecondsEpoch |= LShiftU64 ((UINT64)(Inode->i_crtime_extra & ((1 << 2) - 1)), 32); Nanoseconds = Inode->i_crtime_extra >> 2; } EpochToEfiTime ((UINTN)SecondsEpoch, Time); Time->Nanosecond = Nanoseconds; }


   ;
# 438 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Inode.c"
void
Ext4FileCreateTime (
  EXT4_FILE *File,
  EFI_TIME *Time
  )
{
  ...
  if (!(Inode->i_extra_isize + 128U >= ((UINTN) __builtin_offsetof(EXT4_INODE, i_crtime)) + sizeof(((EXT4_INODE *)((void *) 0))->i_crtime))) {
...
# 464 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Inode.c"
BOOLEAN
Ext4CheckInodeChecksum (
  const EXT4_PARTITION *Partition,
  const EXT4_INODE *Inode,
  ...
  )
{
  ...
  if (!((Partition->FeaturesRoCompat & 0x0400) == 0x0400)) {
    return ((BOOLEAN)(1==1));
  }
  ...
  if ((Inode->i_extra_isize + 128U >= ((UINTN) __builtin_offsetof(EXT4_INODE, i_checksum_hi)) + sizeof(((EXT4_INODE *)((void *) 0))->i_checksum_hi))) {

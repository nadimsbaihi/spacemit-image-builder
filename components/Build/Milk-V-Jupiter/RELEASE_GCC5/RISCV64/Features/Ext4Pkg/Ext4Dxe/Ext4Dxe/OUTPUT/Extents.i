# 0 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Extents.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Extents.c"
...
# 9 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Extents.c" 2
# 17 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Extents.c"
BOOLEAN
Ext4CheckExtentChecksum (
  const EXT4_EXTENT_HEADER *ExtHeader,
  const EXT4_FILE *File
  );
# 30 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Extents.c"
UINT32
Ext4CalculateExtentChecksum (
  const EXT4_EXTENT_HEADER *ExtHeader,
  const EXT4_FILE *File
  );
# 43 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Extents.c"
void
Ext4CacheExtents (
  EXT4_FILE *File,
  const EXT4_EXTENT *Extents,
  UINT16 NumberExtents
  );
# 58 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Extents.c"
EXT4_EXTENT *
Ext4GetExtentFromMap (
  EXT4_FILE *File,
  UINT32 Block
  );
# 71 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Extents.c"
static
EXT4_EXTENT_HEADER *
...
# 87 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Extents.c"
static
BOOLEAN
Ext4ExtentHeaderValid (
  const EXT4_EXTENT_HEADER *Header,
  UINT16 MaxEntries
  )
{
  if (Header->eh_depth > 5) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "[ext4] Invalid extent header depth %u\n", Header->eh_depth); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    return ((BOOLEAN)(0==1));
  }

  if (Header->eh_magic != 0xF30A) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "[ext4] Invalid extent header magic %x\n", Header->eh_magic); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
    return ((BOOLEAN)(0==1));
  }


  if (Header->eh_max > MaxEntries) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "[ext4] Invalid extent header max entries (%u eh_max, " "theoretical max is %u) (larger than permitted)\n", Header->eh_max, MaxEntries); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
  ...
  if (Header->eh_max < Header->eh_entries) {
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "[ext4] Invalid extent header num entries %u max entries %u\n", Header->eh_entries, Header->eh_max); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
...
# 138 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Extents.c"
static
EXT4_EXTENT_INDEX *
...
# 179 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Extents.c"
static
EXT4_EXTENT *
...
# 220 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Extents.c"
static
EXT4_BLOCK_NR
...
# 242 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Extents.c"
EFI_STATUS
Ext4GetExtent (
  EXT4_PARTITION *Partition,
  EXT4_FILE *File,
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00000008)) { DebugPrint (0x00000008, "[ext4] Looking up extent for block %lu\n", LogicalBlock); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));


  if (LogicalBlock > (UINT32)-1) {
    return ((RETURN_STATUS)(0x8000000000000000ULL | (17)));
  }



  if ((Ext = Ext4GetExtentFromMap (File, (UINT32)LogicalBlock)) != ((void *) 0)) {
    *Extent = *Ext;
  ...
  if (!Ext4ExtentHeaderValid (ExtHeader, 4)) {
  ...
  while (ExtHeader->eh_depth != 0) {
    ...
    if (!Ext4CheckExtentChecksum (ExtHeader, File)) {
      do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "[ext4] Invalid extent checksum\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)));
      FreePool (Buffer);
      return ((RETURN_STATUS)(0x8000000000000000ULL | (10)));
    }
...
# 410 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Extents.c"
static
INTN
...
# 443 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Extents.c"
static
INTN
...
# 474 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Extents.c"
EFI_STATUS
Ext4InitExtentsMap (
  EXT4_FILE *File
  )
  ...
  )
{
  ...
  while ((MinEntry = OrderedCollectionMin (File->ExtentsMap)) != ((void *) 0)) {
    OrderedCollectionDelete (File->ExtentsMap, MinEntry, (void **)&Ext);
    FreePool (Ext);
  }

  do { if (((BOOLEAN)(0==1))) { (void) (OrderedCollectionIsEmpty (File->ExtentsMap)); } } while (((BOOLEAN)(0==1)));

  OrderedCollectionUninit (File->ExtentsMap);
  File->ExtentsMap = ((void *) 0);
}
# 523 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Extents.c"
void
Ext4CacheExtents (
  EXT4_FILE *File,
  const EXT4_EXTENT *Extents,
  ...
  )
{
  ...
  for (Idx = 0; Idx < NumberExtents; Idx++, Extents++) {
    ...
    Status = OrderedCollectionInsert (File->ExtentsMap, ((void *) 0), Extent);
...
# 569 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Extents.c"
EXT4_EXTENT *
Ext4GetExtentFromMap (
  EXT4_FILE *File,
  UINT32 Block
...
# 593 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Extents.c"
UINT32
Ext4CalculateExtentChecksum (
  const EXT4_EXTENT_HEADER *ExtHeader,
  const EXT4_FILE *File
...
# 620 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Extents.c"
BOOLEAN
Ext4CheckExtentChecksum (
  const EXT4_EXTENT_HEADER *ExtHeader,
  const EXT4_FILE *File
...
# 647 "/home/kapoagaeming/spacemit-image-builder/components/edk2-platforms/Features/Ext4Pkg/Ext4Dxe/Extents.c"
EXT4_BLOCK_NR
Ext4GetExtentLength (
  const EXT4_EXTENT *Extent
  )
{
  ...
  if (((Extent)->ee_len > (1 << 15))) {
    return Extent->ee_len - (1 << 15);
  }

# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdePkg/Library/BaseMemoryLib/ScanMem64Wrapper.c"
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdePkg/Library/BaseMemoryLib/ScanMem64Wrapper.c"
# 20 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdePkg/Library/BaseMemoryLib/ScanMem64Wrapper.c"
...
# 21 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdePkg/Library/BaseMemoryLib/ScanMem64Wrapper.c" 2
# 43 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdePkg/Library/BaseMemoryLib/ScanMem64Wrapper.c"
void *
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) (((UINTN)Buffer & (sizeof (Value) - 1)) == 0); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { (void) ((Length - 1) <= (0xFFFFFFFFFFFFFFFFULL - (UINTN)Buffer)); } } while (((BOOLEAN)(0==1)));
  do { if (((BOOLEAN)(0==1))) { (void) ((Length & (sizeof (Value) - 1)) == 0); } } while (((BOOLEAN)(0==1)));

# 0 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdePkg/Library/BaseCacheMaintenanceLib/RiscVCache.c"
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/MdePkg/Library/BaseCacheMaintenanceLib/BaseCacheMaintenanceLib//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/riscv64-linux-gnu/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/MdePkg/Library/BaseCacheMaintenanceLib/BaseCacheMaintenanceLib/DEBUG/AutoGen.h" 1
# 16 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/MdePkg/Library/BaseCacheMaintenanceLib/BaseCacheMaintenanceLib/DEBUG/AutoGen.h"
...
# 17 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/MdePkg/Library/BaseCacheMaintenanceLib/BaseCacheMaintenanceLib/DEBUG/AutoGen.h" 2
...
# 18 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/Build/Milk-V-Jupiter/RELEASE_GCC5/RISCV64/MdePkg/Library/BaseCacheMaintenanceLib/BaseCacheMaintenanceLib/DEBUG/AutoGen.h" 2
...
# 0 "<command-line>" 2
# 1 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdePkg/Library/BaseCacheMaintenanceLib/RiscVCache.c"
# 11 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdePkg/Library/BaseCacheMaintenanceLib/RiscVCache.c"
...
# 12 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdePkg/Library/BaseCacheMaintenanceLib/RiscVCache.c" 2
...
# 13 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdePkg/Library/BaseCacheMaintenanceLib/RiscVCache.c" 2
# 25 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdePkg/Library/BaseCacheMaintenanceLib/RiscVCache.c"
typedef enum {
  CacheOpClean,
  CacheOpFlush,
  CacheOpInvld,
  ...
  )
{
  ...
  return ((_gPcd_FixedAtBuild_PcdRiscVFeatureOverride & 0x1) != 0);
}
# 62 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdePkg/Library/BaseCacheMaintenanceLib/RiscVCache.c"
static
void
CacheOpCacheRange (
  void *Address,
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { (void) ((Length - 1) <= (0xFFFFFFFFFFFFFFFFULL - (UINTN)Address)); } } while (((BOOLEAN)(0==1)));
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00400000)) { DebugPrint (0x00400000, "CacheOpCacheRange: Performing Cache Management Operation %d \n", Op); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
...
# 125 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdePkg/Library/BaseCacheMaintenanceLib/RiscVCache.c"
void
...
# 153 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdePkg/Library/BaseCacheMaintenanceLib/RiscVCache.c"
void *
...
{
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00400000)) { DebugPrint (0x00400000, "InvalidateInstructionCacheRange: RISC-V unsupported function.\n" "Invalidating the whole instruction cache instead.\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
...
# 180 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdePkg/Library/BaseCacheMaintenanceLib/RiscVCache.c"
void
  ...
  )
{
  ...
  do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x80000000)) { DebugPrint (0x80000000, "WriteBackInvalidateDataCache: RISC-V unsupported function.\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))


      ;
}
# 219 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdePkg/Library/BaseCacheMaintenanceLib/RiscVCache.c"
void *
...
# 245 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdePkg/Library/BaseCacheMaintenanceLib/RiscVCache.c"
void
...
# 276 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdePkg/Library/BaseCacheMaintenanceLib/RiscVCache.c"
void *
...
# 303 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdePkg/Library/BaseCacheMaintenanceLib/RiscVCache.c"
void
...
# 336 "/home/kapoagaeming/Downloads/spacemit-image-builder/components/edk2/MdePkg/Library/BaseCacheMaintenanceLib/RiscVCache.c"
void *
  ...
  )
{
  if (RiscVIsCMOEnabled ()) {
    ...
    do { if (((BOOLEAN)(0==1))) { do { if (DebugPrintLevelEnabled (0x00400000)) { DebugPrint (0x00400000, "InvalidateDataCacheRange: Zicbom not supported.\n" "Invalidating the whole Data cache instead.\n"); } } while (((BOOLEAN)(0==1))); } } while (((BOOLEAN)(0==1)))
